...
Получение списка контейнеров, которые можно перенести в указанном общем доступе.
...
### -Имя_общего_ресурса
Имя общего доступа, содержащее контейнеры хранилища.
...
### -StartIndex
Начальный индекс для Get Containers.
