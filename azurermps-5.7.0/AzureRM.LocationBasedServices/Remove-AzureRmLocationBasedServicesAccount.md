...
## КРАТКИй обзор
Удаление учетной записи служб на основе расположения.
...
## NОПИСАНИЕ
Командлет **Remove-AzureRmLocationBasedServicesAccount** удаляет указанную учетную запись служб на основе расположения.
...
Удаляет указанную учетную запись служб на основе расположения.
