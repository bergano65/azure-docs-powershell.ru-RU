...
## NОПИСАНИЕ
Командлет New-AzureRmContainerRegistryWebhook создает веб-перехватчик реестра контейнера.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание веб-перехватчика реестра контейнера.
```
...
### -Location
Расположение веб-перехватчика.
По умолчанию — расположение реестра.
...
### -Status (состояние)
Состояние веб-перехватчика, значение по умолчанию — Enabled
