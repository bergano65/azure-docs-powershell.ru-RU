...
{{Введите Add-AzureRmLoadBalancerInboundNatPoolConfig описание вручную}}
...
{{Введите Get-AzureRmBgpServiceCommunity описание вручную}}
...
{{Введите Get-AzureRmLoadBalancerInboundNatPoolConfig описание вручную}}
...
Возвращает монитор подключений.

### [Get-AzureRmNetworkWatcherConnectionMonitorReport](Get-AzureRmNetworkWatcherConnectionMonitorReport.md)
Получает моментальный снимок самых последних состояний подключения.
...
{{Введите Get-AzureRmVirtualNetworkGatewayConnectionSharedKey описание вручную}}
...
Позволяет пользователям легко загрузить пакет профиля VPN, созданный с помощью New-AzureRmVpnClientConfiguration unifiedgroup.
...
{{Введите New-AzureRmLoadBalancerInboundNatPoolConfig описание вручную}}
...
Создание нового ресурса монитора подключений.
...
{{Введите New-AzureRmVirtualNetworkGatewayConnection описание вручную}}
...
{{Введите Remove-AzureRmLoadBalancerInboundNatPoolConfig описание вручную}}
...
{{Введите Remove-AzureRmVirtualNetworkGatewayIpConfig описание вручную}}

### [Remove-AzureRmVirtualNetworkPeering](Remove-AzureRmVirtualNetworkPeering.md)
{{Введите Remove-AzureRmVirtualNetworkPeering описание вручную}}
...
{{Введите Reset-AzureRmVirtualNetworkGateway описание вручную}}

### [Сброс — AzureRmVirtualNetworkGatewayConnectionSharedKey](Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey.md)
{{Введите Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey описание вручную}}
...
Задает состояние цели SSL-сертификата.
...
{{Введите Set-AzureRmLoadBalancerInboundNatPoolConfig описание вручную}}
...
Задает состояние цели для таблицы маршрутов.
...
Настраивает состояние цели для конфигурации подсети в виртуальной сети.
...
Остановка работы монитора подключений
...
{{Введите Test-AzureRmDnsAvailability описание вручную}}
