...
## NОПИСАНИЕ
Командлет **New-AzureRmSnapshotUpdateConfig** создает настраиваемый объект обновления моментального снимка.
...
### -CreateOption
Указывает, создает ли этот командлет снимок на виртуальной машине из платформы или пользовательского образа, создает пустой диск или прикрепляет существующий диск.
...
### -ImageReference
Указывает ссылку на изображение в снимке.
...
### System. Nullable "1 [[Microsoft. Azure. Management. COMPUTE. Model. StorageAccountTypes, Microsoft. Azure. Management. COMPUTE, Version = 14.0.0.0, культура =" нейтрально ", PublicKeyToken = 31bf3856ad364e35]]
...
System.Nullable` 1 [[System. Boolean, mscorlib, Version = 4.0.0.0, культура = нейтраль, PublicKeyToken = b77a5c561934e089]] Microsoft. Azure. Management. COMPUTE. Models. KeyVaultAndSecretReference Microsoft. Azure. System. COMPUTE. Models. KeyVaultAndKeyReference
