...
Возвращает сертификаты управления API.
...
{{Введите Get-AzureRmApiManagementProperty описание вручную}}
...
Импорт сертификата в формате PFX для службы управления API.
...
Изменение сертификата управления API.
