...
## NОПИСАНИЕ
Командлет **Get-AzureRmApiManagementUser** получает указанного пользователя или всех пользователей, если не указан ни один пользователь.
...
### Пример: получение имен пользователей по фамилии
```
PS C:\>$apimContext = New-AzureRmApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Сведения о пользователе в службе управления API.

### IList<Microsoft. Azure. Commands. ApiManagement. ServiceManagement. Models. PsApiManagementUser>
Список пользователей в службе управления API.
