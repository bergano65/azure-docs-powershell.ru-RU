...
### -AzureToAzure
Параметр Switch, указывающий на то, что политика репликации, используемая для репликации виртуальных машин Azure между двумя областями Azure, будет обновлена.
...
### -AzureToVMware
Параметр Switch, указывающий на то, что политика specfied используется для репликации отказов на виртуальные машины, запущенные в Azure, обратно на локальный сайт VMware.
...
### -HyperVToAzure
Параметр Switch, указывающий на то, что для репликации виртуальных машин Hyper-V в Azure используется политика specfied.
...
### -VMwareToAzure
Параметр Switch, указывающий на то, что для репликации виртуальных машин VMware в Azure используется политика specfied.
...
### -VmmToVmm
Параметр Switch, указывающий, что политика specfied используется для репликации виртуальных машин Hyper-V, управляемых VMM, между двумя сайтами Hyper-V.
