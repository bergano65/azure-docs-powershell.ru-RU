...
## NОПИСАНИЕ
Командлет **New-AzureRmRecoveryServicesAsrvCenter** добавляет сервер vCenter, чтобы найти защищаемые элементы из. Этот командлет регистрирует vCenter Server для обнаружения с помощью сервера конфигурации.
...
Учетная запись пользователя для входа в creadential.
