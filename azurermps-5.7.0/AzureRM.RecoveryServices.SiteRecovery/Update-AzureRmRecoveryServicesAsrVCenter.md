...
## NОПИСАНИЕ
Командлет **Update-AzureRmRecoveryServicesAsrvCenter** обновляет сведения о обнаружении зарегистрированного vCenter.
...
учетные данные для входа в vCenter.
...
### -InputObject
Объект сервера vCenter, для которого нужно обновить сведения о обнаружении.
