...
## NОПИСАНИЕ
Командлет **Get-AzureRmSiteRecoveryNetwork** получает сведения об сетях Azure Site Recovery для текущего хранилища Azure Site Recovery.
...
### -FriendlyName
Указывает понятное имя сети виртуальной машины.
...
### -Name (имя)
Указывает имя сети виртуальной машины.
...
### Подстрок
Параметр "FriendlyName" принимает значение типа String из конвейера.
