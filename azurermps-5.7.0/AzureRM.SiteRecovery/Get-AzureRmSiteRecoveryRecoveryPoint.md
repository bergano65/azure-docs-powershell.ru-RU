...
## NОПИСАНИЕ
Командлет **Get-AzureRmSiteRecoveryRecoveryPoint** получает список доступных точек восстановления для элемента, защищенного репликацией.
...
### -Name (имя)
Указывает имя точки восстановления, которую получает этот командлет.
...
Указывает объект защищенного элемента для репликации Azure Site Recovery.
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. Commands. SiteRecovery. ASRRecoveryPoint, Microsoft. Azure. Commands. SiteRecovery, Version = 2.0.1.0, культура = нейтральная, PublicKeyToken = NULL]]
