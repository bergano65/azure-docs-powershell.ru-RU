...
## NОПИСАНИЕ
Командлет **Start-AzureRmSiteRecoveryPolicyAssociationJob** инициирует задание связи для связывания политики репликации с контейнером защиты Azure Site Recovery.
