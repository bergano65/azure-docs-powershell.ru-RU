...
## NОПИСАНИЕ
Командлет **New-AzureRmSiteRecoveryPolicy** создает политику репликации восстановления сайта Azure.
...
Указывает частоту для моментального снимка, совместимого с приложением, в часах.
...
### -Name (имя)
Задает понятное имя, идентифицирующее политику репликации восстановления сайта.
...
Указывает идентификатор учетной записи хранилища Azure целевого объекта репликации.
...
### -ReplicationProvider
Указывает поставщика репликации.
Допустимые значения:
