...
## NОПИСАНИЕ
Командлет **Get-AzureRmSiteRecoveryRecoveryPlan** получает план восстановления в Azure Site Recovery.
...
### -FriendlyName
Указывает понятное имя плана восстановления, который получает этот командлет.
...
### -Name (имя)
Указывает имя плана восстановления, который получает этот командлет.
...
### -Path
Указывает путь к файлу, в который этот командлет сохраняет план восстановления.
