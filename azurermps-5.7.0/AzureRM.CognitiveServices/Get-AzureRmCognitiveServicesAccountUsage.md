...
## NОПИСАНИЕ
Командлет **Get-AzureRmCognitiveServicesAccountUsage** получает текущее использование для учетной записи службы.
...
### -InputObject
Объект учетной записи самообслуживания служб.
```yaml
...
### -ResourceId
Идентификатор ресурса для учетной записи службы.
```yaml
Type: String
