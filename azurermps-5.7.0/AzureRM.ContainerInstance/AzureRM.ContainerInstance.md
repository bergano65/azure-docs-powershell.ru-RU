...
---
# Модуль AzureRM. ContainerInstance
## Nописание
В этом разделе отображаются разделы справки для командлетов экземпляров контейнера Azure.

## Командлеты AzureRM. ContainerInstance
