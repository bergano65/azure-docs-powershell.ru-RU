...
---
# Модуль AzureRM. UsageAggregates
## Nописание
В этом разделе отображаются разделы справки по статистическим командлетам использования Azure.

## Командлеты AzureRM. UsageAggregates
