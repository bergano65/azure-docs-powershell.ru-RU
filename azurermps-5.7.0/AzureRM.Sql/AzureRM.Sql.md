...
Возвращает политику безопасного подключения для базы данных.

### [Get-AzureRmSqlDatabaseThreatDetectionPolicy](Get-AzureRmSqlDatabaseThreatDetectionPolicy.md)
Возвращает политику обнаружения угроз для базы данных.
...
Возвращает серверное хранилище долгосрочного хранения.
...
Возвращает политику обнаружения угроз для сервера.
...
Получает состояние обновления сервера базы данных Azure SQL.
...
Удаление политики обнаружения угроз из базы данных.
...
### [Остановить-AzureRmSqlDatabaseActivity](Stop-AzureRmSqlDatabaseActivity.md)
...
### [Остановить-AzureRmSqlElasticPoolActivity](Stop-AzureRmSqlElasticPoolActivity.md)
Отмените асинхронную операцию обновления в пуле эластичных БД.
