...
## NОПИСАНИЕ
Командлет **New-AzureRmSqlDatabaseRestorePoint** создает новую точку восстановления, из которой можно восстановить базу данных SQL Azure.
...
Эта команда создает точку восстановления для базы данных SQL Azure и возвращает сведения о точке восстановления.
