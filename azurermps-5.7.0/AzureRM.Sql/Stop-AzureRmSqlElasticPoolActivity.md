...
## NОПИСАНИЕ
Командлет **Stop-AzureRmSqlElasticPoolActivity** отменяет асинхронную операцию обновления в пуле эластичных БД.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Отмена асинхронной операции обновления для пула эластичных БД
```
...
Эта команда отменяет операцию асинхронных обновлений в пуле эластичных БД.
