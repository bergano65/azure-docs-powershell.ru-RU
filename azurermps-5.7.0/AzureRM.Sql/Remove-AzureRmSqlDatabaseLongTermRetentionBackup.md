...
## NОПИСАНИЕ
Командлет **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** удаляет указанную резервную копию.

## ИЛЛЮСТРИРУЮТ

### Пример 1: удаление одной резервной копии
```powershell
...
### Пример 2: удаление всех резервных копий для местоположения
```powershell
