...
## NОПИСАНИЕ
Командлет **New-AzureRmSqlDatabase** создает базу данных Azure SQL.
...
Эта команда создает базу данных с именем Database01 в пуле эластичных БД с именем ElasticPool01 на сервере Server01.
...
### -Теги
Задает словарь пар "ключ-значение" в виде хэш-таблицы, которую этот командлет свяжет с новой базой данных. Например:
