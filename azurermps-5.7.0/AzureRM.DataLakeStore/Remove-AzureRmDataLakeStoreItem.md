...
## NОПИСАНИЕ
Командлет **Remove-AzureRmDataLakeStoreItem** удаляет файл или папку в Data Lake Store.
...
### -Clean
Показывает, что пользователь хочет удалить все содержимое папки, но не саму папку
...
Если вы не укажете параметр *Clean* , Целевая папка также будет удалена.
...
### логических
Если указана функция PassThru, возвращает результат операции.
