...
## NОПИСАНИЕ
Командлет **Import-AzureRmDataLakeStoreItem** отправляет локальный файл или каталог в Data Lake Store.
...
### -ConcurrentFileCount
Указывает максимальное количество файлов, которые нужно добавить параллельно для отправки папки.  По умолчанию будет вычислено для наилучшей работы с учетом размера папки и файла
...
### подстрок
Полный путь в учетной записи Data Lake Store к выгруженному файлу или папке.
