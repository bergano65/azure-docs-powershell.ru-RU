...
## NОПИСАНИЕ
Командлет **Set-AzureRmDataLakeStoreTrustedIdProvider** изменяет указанный доверенный поставщик удостоверений в указанном Data Lake Store.

## ИЛЛЮСТРИРУЮТ

### Пример 1: обновление доверенной конечной точки поставщика удостоверений
```
...
Это обновление поставщика endpoing для правила межсетевого экрана "MyProvider" в учетной записи "ContosoADL" на " https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 "

## ПАРАМЕТРЫ

### -Account (учетная запись)
Учетная запись Data Lake Store для добавления доверенного поставщика удостоверений
...
### -ProviderEndpoint
Правильная конечная точка доверенного поставщика в формате: https://sts.windows.net/\<provider identity\>
...
### -ResourceGroupName
Указывает имя группы ресурсов, которая содержит учетную запись, для которой нужно обновить доверенный поставщик удостоверений.
...
Обновленный доверенный поставщик удостоверений.
