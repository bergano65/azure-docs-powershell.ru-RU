...
## NОПИСАНИЕ
Командлет **Get-AzureRmServiceBusOperation** содержит список поддерживаемых операций servicebus.
...
### System. Collections. Generic. List ' 1 [Microsoft. Azure. OperationAttributes]
