...
## NОПИСАНИЕ
Командлет **Remove-AzureRmServiceBusQueue** Удаляет очередь из указанного пространства имен служебной шины.
...
Удаляет очередь `SB-Queue_exampl1` из пространства имен `SB-Example1` .
