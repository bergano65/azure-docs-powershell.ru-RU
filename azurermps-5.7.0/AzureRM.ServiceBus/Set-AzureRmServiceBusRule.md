...
## NОПИСАНИЕ
Командлет **Set-AzureRmServiceBusRule** обновляет описание указанного правила данной подписки.
...
обновляет sqlexpression **mysqlexpression = "Condition"** правила `SBEule` подписки `SBSubscription` в разделе `SBTopic`
