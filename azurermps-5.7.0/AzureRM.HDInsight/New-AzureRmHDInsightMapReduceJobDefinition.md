...
## NОПИСАНИЕ
Командлет **New-AzureRmHDInsightMapReduceJobDefinition** определяет новое задание MapReduce для использования с кластером Azure HDInsight.
...
### -ClassName
Указывает класс задания в JAR – файле.
...
### -JarFile
Указывает JAR — файл, который будет использоваться для задания.
...
### -LibJars
Указывает для задания JARS lib.
