...
## NОПИСАНИЕ
Командлет **Add-AzureRmHDInsightMetastore** добавляет куст или Oozie MetaStore в объект конфигурации HDInsight, созданный командлетом New-AzureRmHDInsightClusterConfig.
