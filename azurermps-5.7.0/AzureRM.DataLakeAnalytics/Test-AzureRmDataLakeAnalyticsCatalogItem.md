...
## NОПИСАНИЕ
Командлет **Test-AzureRmDataLakeAnalyticsCatalogItem** проверяет наличие элемента каталога Azure Data Lake Analytics.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Проверка наличия элемента каталога
```
PS C:\>Test-AzureRmDataLakeAnalyticsCatalogItem -Account "ContosoAdlAccount" -ItemType Schema -Path "databaseName.schemaName"
```

Эта команда проверяет, существует ли указанный элемент схемы.
...
### -ItemType
Указывает тип элемента каталога для элемента, который нужно проверить.
...
### -Path
Задает путь к извлекаемому элементу или путь к родительскому элементу для списка элементов.
...
### логических
Истина или ложь, указывающие, существует ли указанный элемент каталога или нет.
