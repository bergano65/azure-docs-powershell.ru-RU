...
## NОПИСАНИЕ
Командлет Get-AzureRmRecoveryServicesBackupRPMountScript загружает сценарий, который подключает тома точки восстановления на компьютере, на котором она выполняется.
