...
## NОПИСАНИЕ
New-AzureRmOperationalInsightsAzureActivityLogDataSource включения аналитики журнала для сбора журнала активности Azure из данной подписки.
...
### -BackfillStartTime
Вы можете отказаться от записи журнала за неделю назад.
