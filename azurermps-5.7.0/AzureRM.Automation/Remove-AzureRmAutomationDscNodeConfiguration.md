...
## NОПИСАНИЕ
Командлет **Remove-AzureRmAutomationDscNodeConfiguration** удаляет метаданные из точек доступа к нужной конфигурации узла (DSC) в службе автоматизации Azure.
...
[Командлеты службы автоматизации Azure](./AzureRM.Automation.md)
