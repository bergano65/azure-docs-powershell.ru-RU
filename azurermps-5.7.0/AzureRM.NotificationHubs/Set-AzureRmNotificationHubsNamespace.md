...
Чтобы получить актуальный список местоположений Azure, выполните следующую команду:
...
Чтобы добавить несколько тегов в одной команде, разделяйте их запятыми, используя следующие Теги:
