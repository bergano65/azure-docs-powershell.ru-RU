...
### -SettingSpec
Указывает объект **AutoscaleSetting** .
Чтобы получить объект **AutoscaleSetting** , можно использовать командлет Get-AzureRmAutoscaleSetting или создать его в сценарии Windows PowerShell.
