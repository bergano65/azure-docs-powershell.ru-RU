...
Первая команда получает зону с именем myzone.com из указанной группы ресурсов, а затем сохраняет ее в $Zone переменной.
...
### Пример 3. Связывание частной зоны с виртуальной сетью путем указания ее ИД
```
...
### Пример 4. Связывание частной зоны с виртуальной сетью путем указания объекта сети.
```
PS C:\>$vnet = Get-AzVirtualNetwork -ResourceGroupName "MyResourceGroup" -Name "myvnet"
PS C:\>Set-AzDNSZone -ResourceGroupName "MyResourceGroup" -Name "myprivatezone.com" -RegistrationVirtualNetwork @($vnet)
```

Эта команда связывает частную зону DNS myprivatezone.com с виртуальной сетевой myvnet в качестве сети регистрации, передавая командлету виртуальный объект сети, $vnet переменной Set-AzDnsZone сетью.
...
Вы также можете указать зону с помощью объекта DnsZone с параметром *Зоны* или конвейером.
