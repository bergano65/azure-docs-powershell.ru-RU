...
## ОПИСАНИЕ
Новый Set-AzConsumptionBudget обновляет бюджет в подписке или группе ресурсов.

## ПРИМЕРЫ

### Пример 1. Обновление бюджета на новую сумму с названием бюджета на уровне подписки
```powershell
...
### Пример 2. Обновление бюджета с помощью уведомления, когда затраты или использование достигает порогового значения в 90 процентов от суммы на уровне подписки
```powershell
...
### Пример 3. Обновление бюджета на новую сумму с названием бюджета на уровне группы ресурсов
```powershell
...
### -EndDate
Дата окончания периода времени для бюджета (ММ-ММ-ММ в UTC).
...
Если не указано, уведомление по умолчанию отключено.
...
### -NotificationKey
Ключ уведомления, связанного с бюджетом, необходимого для создания уведомления с переключателем с поддержкой уведомлений, порогового значения уведомления, сообщений контактов, групп контактов или ролей контактов.
