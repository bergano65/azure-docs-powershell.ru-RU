...
## ОПИСАНИЕ
Подробные сведения об использовании подписки получает **cmdlet Get-AzConsumptionUsageDetail.** 

## ПРИМЕРЫ

### Пример 1. Подробные сведения об использовании с помощью расширения сведений о лимитных данных
```powershell
...
### Пример 2. Подробные сведения об использовании с диапазоном дат
```powershell
...
### Пример 3. Получите сведения об использовании BillingPeriodName с помощью фильтра InstanceName
```powershell
...
### -BillingPeriodName
Название определенного периода вы выставления счета для получения сведений об использовании, которые с ним связываются.
...
### -EndDate
Дата окончания фильтруемой информации (в UTC).
...
### -Развернуть
Развяжите список использования на основе meterDetails или AdditionalInfo.
...
Включить дополнительные свойства в использование.
...
### -IncludeMeterDetails
Включить сведения о метре в использование.
...
### -InstanceId
ИД экземпляра фильтруемого пользования.
...
### -ResourceGroup
Группа ресурсов, в которые нужно отфильтровать данные.
...
### -StartDate
Дата начала фильтруемой информации (в UTC).
...
### -Tag
Тег фильтруемого использования.
