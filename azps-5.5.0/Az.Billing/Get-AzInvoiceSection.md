...
## ОПИСАНИЕ
Для этого вы можете получить **разделы** счетов в указанном профиле выставления счетов. 
...
Получить все разделы счетов в указанном профиле выставления счетов.
...
### -Name
Имя определенного раздела счета.
