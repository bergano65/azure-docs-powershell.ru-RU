...
## Описание
В этой теме представлены разделы справки по службам восстановления Azure.
...
Остановка и отключение репликации для защищенного элемента восстановления сайта Azure.
