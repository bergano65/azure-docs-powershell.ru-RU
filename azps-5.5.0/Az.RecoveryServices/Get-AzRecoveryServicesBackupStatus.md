...
## ОПИСАНИЕ
Если указанный ресурс не защищен ни в каких хранилищах служб восстановления в подписке, команда возвращает пустое или пустое NULL. Если она защищена, возвращаются сведения о соответствующем сейфе.
