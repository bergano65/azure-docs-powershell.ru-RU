...
## ОПИСАНИЕ
Командлет **Get-AzRecoveryServicesAsrNetwork** получает сведения о сетях восстановления сайтов Azure для текущего хранилища восстановления сайтов Azure.
...
Все известные сети в указанном материале.
