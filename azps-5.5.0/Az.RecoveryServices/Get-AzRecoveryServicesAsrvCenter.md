...
## ОПИСАНИЕ
С **помощью cmdlet get-AzRecoveryServicesAsrvCenter** можно получить сведения о серверах vCenter, зарегистрированных для обнаружения на сервере Конфигурации, который указан в структуре ASR.
...
Получите центр восстановления сайта Azure по имени и имени vCenter.
...
Получить список vCenter восстановления сайта Azure по имени ткань.
...
### -Ткань
Объект "Материал ASR", представляющий сервер Configuration Server.
