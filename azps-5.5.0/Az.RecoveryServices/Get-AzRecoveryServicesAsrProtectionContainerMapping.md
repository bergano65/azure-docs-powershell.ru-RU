...
## ОПИСАНИЕ
Для  указанного контейнера защиты ASR в хранилище можно получить сведения о контейнере защиты для сопоставлений (сопоставлений) политики репликации в хранилище.
...
Список сопоставлений контейнеров защиты для контейнера.
...
Возвращает все сопоставления контейнера защиты для указанного контейнера защиты.
...
### -Name
Имя сопоставления контейнера защиты, которое нужно получить.
...
### -ProtectionContainer
Получите сопоставления контейнеров защиты, соответствующие указанному объекту контейнера защиты ASR.
