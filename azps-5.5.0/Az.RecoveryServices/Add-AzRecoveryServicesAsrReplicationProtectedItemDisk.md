...
## ОПИСАНИЕ
Для защиты уже защищенной виртуальной машины Azure добавляется диск для **add-AzRecoveryServicesAsrReplicationProtectedItemDisk.**
...
Начните операцию по добавлению указанной конфигурации диска для защиты.
...
Начните операцию по добавлению указанной конфигурации диска для защиты. Пункт, защищенный репликацией входных данных для piping.

## PARAMETERS

### -AzureToAzureDiskReplicationConfiguration
Определяет конфигурацию диска, используемую для защиты диска от Azure до сценария аварийного восстановления Azure.
...
### -InputObject
Объект ввода для cmdlet: объект, защищенный репликацией ASR, для которого требуется защитить новый диск.
