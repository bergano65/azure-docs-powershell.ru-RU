...
### -ProtectableItem
Определяет объект, защищенный от asR. Он получает защищенный элемент, защищенный репликацией ASR, соответствующий указанному защищенму элементу ASR, если он защищен.
...
### -ProtectionContainer
Определяет объект контейнера защиты ASR, соответствующий элементу, защищенного репликацией. 
