...
Начало удаления указанного сопоставления сети ASR и возврат задания ASR, используемого для отслеживания операции.
...
### -InputObject
Объект ввода для cmdlet: объект сетевого сопоставления ASR, соответствующий удаляемой схеме сети ASR.
