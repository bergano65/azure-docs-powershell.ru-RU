...
## ОПИСАНИЕ
С помощью **cmdlet Update-AzRecoveryServicesAsrRecoveryPlan** содержимое плана восстановления обновляется с использованием содержимого указанного объекта плана восстановления ASR или JSON-файла определения плана восстановления ASR.
