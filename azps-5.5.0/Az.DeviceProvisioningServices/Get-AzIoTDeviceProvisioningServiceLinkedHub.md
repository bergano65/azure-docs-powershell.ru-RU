...
Перечислите все связанные концентраторы IoT в списке myiotdps.
...
Откажите сведения о связанном центре IoT "myiothub1" в службе по подготовка устройств для Azure IoT Hub.
