...
Удалите связанный центр IoT "myiothub" в службе по подготовка устройств для Azure IoT Hub.
...
Удалите связанный концентратор IoT "myiothub" в службе подготовка устройств в Azure IoT Hub с помощью конвейера.
