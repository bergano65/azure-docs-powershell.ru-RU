...
## ОПИСАНИЕ
Этот код проверки используется для подтверждения сертификата. Используйте этот код проверки в качестве CN нового сертификата, подписанного с закрытым ключом корневых сертификатов.
