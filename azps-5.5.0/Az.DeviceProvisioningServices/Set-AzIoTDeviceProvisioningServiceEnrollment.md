...
## ОПИСАНИЕ
Обновив регистрацию устройства в службе регистрации устройств на концентраторе Azure IoT.
...
Обновив политику выделения и концентраторы для записи о регистрации.
...
Обновив начальное состояние регистрации.
