...
Обновление связанного концентратора IoT "myiothub.azure-devices.net" в службе по подготовкам устройств в Azure IoT Hub.
...
Применение политики выделения к центру IoT
