...
### Пример 3. Подробные сведения об определенных ресурсах в коллекции Move с помощью таких фильтров, как SourceResourceName, SourceId, MoveState, IsResolveRequired, ProvisioningState
```powershell
