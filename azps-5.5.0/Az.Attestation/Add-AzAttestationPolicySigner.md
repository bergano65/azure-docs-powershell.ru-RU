...
## ОПИСАНИЕ
Этот Add-AzAttestationPolicySigner добавляет в Azure Attestation надежного подписывателя политики для клиента.
...
Добавьте надежного подписываемго для поставщика услуг atteestation с именем *pshtest.*
...
### -Signer
Определяет веб-токен JSON RFC7519, содержащий претензию maa-policyCertificate, значением которой является веб-ключ RFC7517 JSON, который содержит новый надежный ключ подписи, который нужно добавить.
