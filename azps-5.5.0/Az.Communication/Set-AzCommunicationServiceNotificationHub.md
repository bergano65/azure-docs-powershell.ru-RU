...
### Пример 1. Интерактивное предоставление сведений из концентратора уведомлений
```powershell
...
Связанный центр уведомлений позволяет ресурсу ACS отправлять уведомления об определенных событиях.
...
Описание концентратора уведомлений Azure, связываемого со службой связи "Создать", см. раздел "ПРИМЕЧАНИЯ" для свойств LINKNOTIFICATIONHUBPARAMETER и создание hash table.
...
ИД ресурса в центре уведомлений
...
LINKNOTIFICATIONHUBPARAMETER: описание концентратора уведомлений Azure для связи <ILinkNotificationHubParameters> со службой связи
  - `ConnectionString <String>`: строка подключения для концентратора уведомлений
  - `ResourceId <String>`: ИД ресурса в центре уведомлений
