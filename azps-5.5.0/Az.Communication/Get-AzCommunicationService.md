...
### Пример 1. Список существующих служб CommunicationServices для подписки
```powershell
...
Возвращает список всех ресурсов ACS в этой подписке.

### Пример 2. Получить сведения о указанном информационном ресурсе Azure
```powershell
...
Возвращает сведения о ресурсе ACS, если найден один совпадающий предоставленный параметр.
