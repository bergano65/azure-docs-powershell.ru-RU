...
## ОПИСАНИЕ
Для  AzureSQL Server, действующей в текущей подписке, для azureSQL Server отключена только проверка подлинности Azure Active Directory (Azure AD).
...
Эта команда отключает только требования проверки подлинности Azure Active Directory (Azure AD) для сервера AzureSQL Server01, связанного с группой ресурсов ResourceGroup01.
...
### -ServerName
Имя Azure SQL Server только для проверки подлинности Azure Active Directory.
