...
## ОПИСАНИЕ
Новый Add-AzSqlElasticJobStep добавляет задание в задание с его Add-AzSqlElasticJobStep.

## ПРИМЕРЫ

### Пример 1. Добавляет шаг в задание
```powershell
...
Множитель, отс множитель, возвращаясь назад
