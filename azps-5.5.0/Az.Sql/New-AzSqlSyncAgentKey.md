...
## ОПИСАНИЕ
Для создания ключа агента синхронизации Azure SQL **AzSqlSyncAgentKey.**
...
Эта команда создает ключ агента синхронизации для агента синхронизации Azure SQL синхронизации.
