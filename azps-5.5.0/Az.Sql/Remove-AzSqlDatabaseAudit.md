...
## ОПИСАНИЕ
Для **удаления azSqlDatabaseAudit** удаляются параметры аудита базы данных Azure SQL.
...
### Пример 1. Удаление параметров аудита базы данных Azure SQL
```
PS C:\>Remove-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

### Пример 2. Удаление через канал параметров аудита базы данных Azure SQL
```
