...
## ОПИСАНИЕ
Для Get-AzSqlElasticJobStepExecution выполнения задания возвращается один или несколько этапов выполнения задания.
...
### Пример 2. Получает одно или несколько выполнения шага задания из выполнения задания с фильтрацией по имени шага
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
