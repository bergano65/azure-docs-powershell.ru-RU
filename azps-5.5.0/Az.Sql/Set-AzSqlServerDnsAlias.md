...
## ОПИСАНИЕ
Эта команда обновляет сервер, на который указывают псевдонимы. Эта команда должна быть выдана при входе в подписку на новом сервере, на который будет размещен псевдоним.
...
### -TargetServerName
Имя azure Sql Server, на который должен указывают псевдонимы.
