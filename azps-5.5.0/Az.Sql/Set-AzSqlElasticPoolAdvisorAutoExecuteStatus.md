...
## ОПИСАНИЕ
Для помощника по автоматическому выполнению задач Azure SQL устойства" задает свойство **Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.**
...
Эта команда задает состояние автоматического выполнения помощника CreateIndex.
...
### -AutoExecuteStatus
Указывает новое значение, для которого этот cmdlet обновляет состояние автоматического выполнения.
...
## ПРИМЕЧАНИЯ
* Ключевые слова: azure, azurerm, arm, ресурс, управление, руководитель, sql, эластичный пул, mssql, консультант
