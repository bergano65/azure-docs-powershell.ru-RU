...
## ОПИСАНИЕ
Для этого можно использовать указанный SQL экземпляра базы данных **Get-AzSqlDeletedInstanceDatabaseBackup,** который можно восстановить, или все удаленные резервные копии, которые можно восстановить.
