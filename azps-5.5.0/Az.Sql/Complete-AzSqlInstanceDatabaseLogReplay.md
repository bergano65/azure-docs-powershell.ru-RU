...
## ОПИСАНИЕ
**Полный-AzSqlInstanceDatabaseLogReplay** завершает службу воспроизведения журнала в данной базе данных.
...
Эта команда завершит службу воспроизведения журнала для данной базы данных после восстановления последней резервной копии.
