...
Эта команда получает список всех консультантов для сервера Wi-runner-australia-east, который принадлежит к группе ресурсов WIRunnersProd.
...
Эта команда получает список всех консультантов для сервера Wi-run-australia-east, который принадлежит к группе ресурсов WIRunnersProd, которые начинаются с буквы "d".
