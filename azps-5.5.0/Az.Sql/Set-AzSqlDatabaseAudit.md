...
### Пример 3. Применение политики аудита хранилища BLOB-SQL базы данных Azure с использованием SQL предиката T-SQL.
```powershell
...
### Пример 6. Отключение политики аудита концентратора событий для базы данных Azure SQL
```powershell
...
### -EventHubName
Имя концентратора событий. Если при предоставлении EventHubAuthorizationRuleResourceId ничего не указано, будет выбран центр событий по умолчанию.
...
### -PredicateExpression
Предика T-SQL (предложение WHERE), используемая для фильтрации журналов аудита.
