...
## ОПИСАНИЕ
Новый Remove-AzSqlElasticJobStep удаляет из задания шаг задания

## ПРИМЕРЫ

### Пример 1. Удаление шага задания из задания
```powershell
...
Удаление шага задания из задания
