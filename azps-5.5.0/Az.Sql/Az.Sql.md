...
# Модуль Az.Sql
## Описание
В этой теме представлены разделы справки по SQL базы данных Azure.

## Az.Sql Cmdlets
### [Add-AzSqlDatabaseToFailoverGroup](Add-AzSqlDatabaseToFailoverGroup.md)
Добавляет одну или несколько баз данных в группу отбойных SQL Azure.

### [Add-AzSqlElasticJobStep](Add-AzSqlElasticJobStep.md)
Добавляет задание в задание

### [Add-AzSqlElasticJobTarget](Add-AzSqlElasticJobTarget.md)
Добавляет целевой объект в целевую группу

### [Add-AzSqlInstanceKeyVaultKey](Add-AzSqlInstanceKeyVaultKey.md)
Добавляет ключ сейфа в предоставленный управляемый экземпляр. 
...
Включает рекомендации по конфиденциальности для столбцов (они включены по умолчанию для всех столбцов) в базе данных azure SQL управляемых экземпляров.

### [Enable-AzSqlServerActiveDirectoryOnlyAuthentication](Enable-AzSqlServerActiveDirectoryOnlyAuthentication.md)
Включает проверку подлинности Azure AD только для определенного SQL Server.
...
Включает Advanced Threat Protection на сервере.

### [Get-AzSqlCapability](Get-AzSqlCapability.md)
Возвращает SQL базы данных для текущей подписки.

### [Get-AzSqlDatabase](Get-AzSqlDatabase.md)
Получает одну или несколько баз данных.
...
Получает дополнительные параметры защиты от угроз для базы данных.

### [Get-AzSqlDatabaseAdvisor](Get-AzSqlDatabaseAdvisor.md)
Получает одного или несколько консультантов для базы данных Azure SQL.

### [Get-AzSqlDatabaseAudit](Get-AzSqlDatabaseAudit.md)
Параметры аудита для базы данных Azure SQL.
...
Получает резервную копию краткого срока хранения.
...
Получает правила маскровки данных из базы данных.

### [Get-AzSqlDatabaseExpanded](Get-AzSqlDatabaseExpanded.md)
Получает базу данных и значения ее расширенных свойств.
...
Сведения об импорте или экспорте базы данных Azure SQL.

### [Get-AzSqlDatabaseIndexRecommendation](Get-AzSqlDatabaseIndexRecommendation.md)
Возвращает рекомендуемые операции индекса для сервера или базы данных.

### [Get-AzSqlDatabaseInstanceFailoverGroup](Get-AzSqlDatabaseInstanceFailoverGroup.md)
Возвращает или перечисляет группы отбойных экземпляров.

### [Get-AzSqlDatabaseLongTermRetentionBackup](Get-AzSqlDatabaseLongTermRetentionBackup.md)
Получает одну или несколько резервных копий хранения в течение длительного времени.

### [Get-AzSqlDatabaseRecommendedAction](Get-AzSqlDatabaseRecommendedAction.md)
Получает одно или несколько рекомендуемых действий для помощника по SQL базы данных Azure.

### [Get-AzSqlDatabaseReplicationLink](Get-AzSqlDatabaseReplicationLink.md)
Возвращает связи геокопивации между базой данных Azure SQL и группой ресурсов или SQL Server.

### [Get-AzSqlDatabaseRestorePoint](Get-AzSqlDatabaseRestorePoint.md)
Извлекает отдельные точки восстановления, из которых SQL можно восстановить хранилище данных.
...
Возвращает рекомендуемые типы данных и метки конфиденциальности для столбцов в базе данных.
...
Возвращает ход сканирования базы данных по TDE.
...
Получает агент a Azure SQL эластичного задания

### [Get-AzSqlElasticJobCredential](Get-AzSqlElasticJobCredential.md)
Получает одну или несколько учетных данных
...
Одно или несколько действий с заданием
...
Возвращает одно или несколько целевых выполнения задания

### [Get-AzSqlElasticJobTargetGroup](Get-AzSqlElasticJobTargetGroup.md)
Получает одну или несколько целевых групп задания
...
Получает одного или несколько консультантов по пулу Azure SQL.

### [Get-AzSqlElasticPoolDatabase](Get-AzSqlElasticPoolDatabase.md)
Получает эластичные базы данных в эластичном пуле и значениях их свойств.
...
Получает одно или несколько рекомендуемых действий для помощника по SQL azure.

### [Get-AzSqlInstance](Get-AzSqlInstance.md)
Возвращает сведения об экземпляре управляемой базы SQL Azure.
...
Получает политику advanced Data Security для управляемого экземпляра.

### [Get-AzSqlInstanceDatabase](Get-AzSqlInstanceDatabase.md)
Возвращает сведения о базе данных azure SQL Managed Instance.

### [Get-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy](Get-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
Возвращает политику долгосрочного хранения управляемой базы данных.
...
Возвращает сведения о том, SQL базе данных управляемого экземпляра Azure является избыточным резервное копирование.
...
Поддержка долгосрочных резервных копий хранения.

### [Get-AzSqlInstanceDatabaseSensitivityClassification](Get-AzSqlInstanceDatabaseSensitivityClassification.md)
Возвращает текущие типы данных и метки конфиденциальности столбцов в базе SQL Azure.

### [Get-AzSqlInstanceDatabaseSensitivityRecommendation](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
Возвращает рекомендуемые типы данных и метки конфиденциальности для столбцов в базе данных azure SQL экземпляра.
...
Возвращает все записи о проверке уязвимости, связанные с заданной управляемой базой данных.

### [Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting](Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
Возвращает параметры оценки уязвимости в управляемой базе данных.

### [Get-AzSqlInstanceKeyVaultKey](Get-AzSqlInstanceKeyVaultKey.md)
Возвращает SQL ключа экземпляра.

### [Get-AzSqlInstanceOperation](Get-AzSqlInstanceOperation.md)
Возвращает SQL операций управляемого экземпляра.

### [Get-AzSqlInstancePool](Get-AzSqlInstancePool.md)
Возвращает сведения о пуле экземпляров Azure SQL Azure.
...
Возвращает параметры оценки уязвимости управляемого экземпляра.

### [Get-AzSqlServer](Get-AzSqlServer.md)
Возвращает сведения о серверах SQL базы данных.

### [Get-AzSqlServerActiveDirectoryAdministrator](Get-AzSqlServerActiveDirectoryAdministrator.md)
Сведения о администраторе Azure AD для SQL Server.

### [Get-AzSqlServerActiveDirectoryOnlyAuthentication](Get-AzSqlServerActiveDirectoryOnlyAuthentication.md)
Получает проверку подлинности Azure AD только для определенного SQL Server.

### [Get-AzSqlServerAdvancedDataSecurityPolicy](Get-AzSqlServerAdvancedDataSecurityPolicy.md)
Получает на сервере расширенные политики безопасности данных.
...
Настраивает параметры аудита на сервере Azure SQL.
...
Получает параметры аудита операций поддержки Microsoft для azure SQL сервера.

### [Get-AzSqlServerDisasterRecoveryConfiguration](Get-AzSqlServerDisasterRecoveryConfiguration.md)
Получает конфигурацию восстановления системы сервера базы данных.

### [Get-AzSqlServerDisasterRecoveryConfigurationActivity](Get-AzSqlServerDisasterRecoveryConfigurationActivity.md)
Возвращает действие для конфигурации восстановления сервера базы данных.
...
Получает правила брандмауэра для SQL базы данных.
...
Получает одно или несколько рекомендуемых действий для помощника по SQL Server Azure.

### [Get-AzSqlServerServiceObjective](Get-AzSqlServerServiceObjective.md)
Получает цели обслуживания для сервера базы данных Azure SQL.
...
Получает или перечисляет правило виртуальной SQL Server Azure.

### [Get-AzSqlServerVulnerabilityAssessmentSetting](Get-AzSqlServerVulnerabilityAssessmentSetting.md)
Получает параметры оценки уязвимости на сервере.

### [Get-AzSqlSyncAgent](Get-AzSqlSyncAgent.md)
Возвращает сведения об агентах синхронизации Azure SQL.
...
Возвращает журналы группы синхронизации баз SQL Azure.

### [Get-AzSqlSyncMember](Get-AzSqlSyncMember.md)
Возвращает сведения об участниками синхронизации баз SQL Azure.

### [Get-AzSqlSyncSchema](Get-AzSqlSyncSchema.md)
Возвращает сведения о схеме синхронизации базы данных участника или центральной базы данных.
...
Создает копию базы данных SQL, в которой в данный момент используется моментальный снимок.
...
Импорт файла BACPAC и создание базы данных на сервере.
...
Создает новую точку восстановления, из SQL базы данных.

### [New-AzSqlDatabaseSecondary](New-AzSqlDatabaseSecondary.md)
Создает вторичную базу данных для существующей базы данных и запускает репликацию данных.
...
Создание учетных данных задания
...
Создает экземпляр управляемой базы SQL Azure.

### [New-AzSqlInstanceDatabase](New-AzSqlInstanceDatabase.md)
Создает базу данных azure SQL Managed Instance.

### [New-AzSqlInstancePool](New-AzSqlInstancePool.md)
Создает пул экземпляров SQL Azure.

### [New-AzSqlServer](New-AzSqlServer.md)
Создается SQL базы данных.

### [New-AzSqlServerCommunicationLink](New-AzSqlServerCommunicationLink.md)
Создает связь для эластичных транзакций базы данных между SQL базами данных.

### [New-AzSqlServerDisasterRecoveryConfiguration](New-AzSqlServerDisasterRecoveryConfiguration.md)
Создает конфигурацию восстановления системы сервера базы данных.

### [New-AzSqlServerDnsAlias](New-AzSqlServerDnsAlias.md)
Эта команда создает новый псевдоним DNS для Azure SQL Server Azure.
...
Создает правило виртуальной SQL Server Azure. 

### [New-AzSqlSyncAgent](New-AzSqlSyncAgent.md)
Создает агент синхронизации Azure SQL Azure.

### [New-AzSqlSyncAgentKey](New-AzSqlSyncAgentKey.md)
Создает ключ агента синхронизации SQL Azure.
...
Создает участник синхронизации базы SQL Azure.

### [Remove-AzSqlDatabase](Remove-AzSqlDatabase.md)
Удаляет базу данных Azure SQL.

### [Remove-AzSqlDatabaseAudit](Remove-AzSqlDatabaseAudit.md)
Удаляет параметры аудита базы данных Azure SQL.

### [Remove-AzSqlDatabaseDataMaskingRule](Remove-AzSqlDatabaseDataMaskingRule.md)
Удаляет правило маскровки данных из базы данных.
...
Удаляет группу отбойных экземпляров.

### [Remove-AzSqlDatabaseLongTermRetentionBackup](Remove-AzSqlDatabaseLongTermRetentionBackup.md)
Удаляет резервную копию хранения в течение длительного времени.

### [Remove-AzSqlDatabaseRestorePoint](Remove-AzSqlDatabaseRestorePoint.md)
Удаляет заданную точку восстановления из SQL базы данных.
...
Удаляется эластичный пул баз данных.

### [Remove-AzSqlInstance](Remove-AzSqlInstance.md)
Удаляет экземпляр управляемой SQL Azure.
...
Удаляет базу данных azure SQL Управляемый экземпляр.
...
Удаляет агент синхронизации Azure SQL.

### [Remove-AzSqlSyncGroup](Remove-AzSqlSyncGroup.md)
Удаляет группу синхронизации SQL баз данных Azure.

### [Remove-AzSqlSyncMember](Remove-AzSqlSyncMember.md)
Удаляет участник синхронизации базы SQL Azure.

### [Remove-AzSqlVirtualCluster](Remove-AzSqlVirtualCluster.md)
Удаляет виртуальный кластер Azure SQL Azure.
...
Восстановление базы данных azure SQL Управляемый экземпляр.

### [Resume-AzSqlDatabase](Resume-AzSqlDatabase.md)
Возобновление базы SQL хранилища данных.
...
Изменяет состояние автоматического выполнения помощника по SQL базы данных Azure.

### [Set-AzSqlDatabaseAudit](Set-AzSqlDatabaseAudit.md)
Изменяет параметры аудита для базы данных Azure SQL.
...
Задает политику хранения для резервного копирования в течение краткого срока.

### [Set-AzSqlDatabaseDataMaskingPolicy](Set-AzSqlDatabaseDataMaskingPolicy.md)
Задает маску данных для базы данных.
...
Обновляет состояние автоматического выполнения помощника по SQL Azure.

### [Set-AzSqlElasticPoolRecommendedActionState](Set-AzSqlElasticPoolRecommendedActionState.md)
Обновляет состояние рекомендуемого SQL Azure.

### [Set-AzSqlInstance](Set-AzSqlInstance.md)
Задает свойства экземпляра, управляемого базой SQL Azure.

### [Set-AzSqlInstanceActiveDirectoryAdministrator](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
Подготовка администратора Azure AD для SQL управляемым экземпляром.
...
Задает типы данных и метки конфиденциальности столбцов в базе SQL Azure.
...
Задает свойства для пула экземпляров Azure SQL Azure.

### [Set-AzSqlInstanceTransparentDataEncryptionProtector](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
Задает прозрачный защита шифрования данных (TDE) для SQL управляемого экземпляра.
...
Изменяет правило брандмауэра в Azure SQL database server.

### [Set-AzSqlServerMSSupportAudit](Set-AzSqlServerMSSupportAudit.md)
Изменение параметров аудита операций поддержки Майкрософт для базы данных Azure SQL.

### [Set-AzSqlServerRecommendedActionState](Set-AzSqlServerRecommendedActionState.md)
Обновляет состояние рекомендуемого действия Azure SQL Server.

### [Set-AzSqlServerTransparentDataEncryptionProtector](Set-AzSqlServerTransparentDataEncryptionProtector.md)
Задает прозрачный защита шифрования данных (TDE) для SQL сервера.

### [Set-AzSqlServerVirtualNetworkRule](Set-AzSqlServerVirtualNetworkRule.md)
Изменяет конфигурацию правила виртуальной сети Azure SQL Server.
...
Запускает синхронизацию группы синхронизации.

### [Stop-AzSqlDatabaseActivity](Stop-AzSqlDatabaseActivity.md)
Отменяет операцию асинхронного обновления базы данных.

### [Stop-AzSqlDatabaseExecuteIndexRecommendation](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
Остановка рабочего процесса, который выполняет рекомендуемую операцию индексации.
...
Отмена асинхронного обновления для эластичного пула.

### [Stop-AzSqlInstanceDatabaseLogReplay](Stop-AzSqlInstanceDatabaseLogReplay.md)
Отменяет службу воспроизведения журнала, переоценив базу данных.

### [Stop-AzSqlInstanceOperation](Stop-AzSqlInstanceOperation.md)
Остановка SQL операций управляемого экземпляра.

### [Stop-AzSqlSyncGroupSync](Stop-AzSqlSyncGroupSync.md)
Остановка синхронизации группы синхронизации.
...
Выполняет отбой для группы отбойных экземпляров.
...
Обновляет параметры оценки уязвимости на сервере.

### [Update-AzSqlSyncGroup](Update-AzSqlSyncGroup.md)
Обновляет группу синхронизации SQL баз данных Azure.

### [Update-AzSqlSyncMember](Update-AzSqlSyncMember.md)
Обновляет участник синхронизации базы SQL Azure.

### [Update-AzSqlSyncSchema](Update-AzSqlSyncSchema.md)
Обновив схему синхронизации для базы данных ее участника или концентратора синхронизации.
Он получит последнюю схему базы данных из настоящей базы данных, а затем будет использовать ее для обновления схемы, кэш которой используется в базе данных синхронизации метаданных.
Если задана команда SyncMemberName, будет обновлена схема базы данных участника. Если нет, будет обновлена схема базы данных концентратора.
