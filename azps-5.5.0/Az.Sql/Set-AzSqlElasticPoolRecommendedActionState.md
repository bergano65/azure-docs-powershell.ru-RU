...
Этот cmdlet применяет рекомендуемое действие, возвращает его в состояние "Отменено" или "Отменено" в зависимости от нового состояния.
...
Эта команда обновляет состояние рекомендуемого бинастика с именем IR_ \[ test_schema \] _ \[ test_table_0.0361551 \] _6C7AE8CC9C87E7FD5893 ожиданию.
