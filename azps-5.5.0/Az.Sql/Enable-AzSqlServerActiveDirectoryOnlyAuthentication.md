...
Эта команда позволяет azure Active Directory (Azure AD) проверить подлинность только для сервера AzureSQL Server01, связанного с группой ресурсов ResourceGroup01.
