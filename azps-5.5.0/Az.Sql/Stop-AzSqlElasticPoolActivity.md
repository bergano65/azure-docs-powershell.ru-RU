...
## ОПИСАНИЕ
Cmdlet **Stop-AzSqlElasticPoolActivity** отменяет асинхронное обновление в эластичном пуле.

## ПРИМЕРЫ

### Пример 1. Отмена асинхронного обновления для эластичного пула
```
...
Эта команда отменяет операцию асинхронного обновления для эластичного пула.
