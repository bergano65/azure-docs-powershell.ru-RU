...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzSqlServerFirewallRule** вы удаляете правило брандмауэра с указанного сервера базы данных Azure SQL.
...
Эта команда удаляет правило брандмауэра с именем Rule01 на сервере Server01.
...
### -FirewallRuleName
Указывает имя правила брандмауэра, которое удаляет этот cmdlet.
