...
## ОПИСАНИЕ
Для создания новой точки восстановления, из SQL Azure можно восстановить хранилище данных **New-AzSqlDataBaseRestorePoint.**
Этот cmdlet в настоящее время поддерживается для azure SQL хранилища данных.

## ПРИМЕРЫ

### Пример 1. Создание точки восстановления
```
...
Эта команда создает точку восстановления для Azure SQL хранилища данных и возвращает сведения о точке восстановления.
...
### -RestorePointLabel
Указывает метку точки восстановления для удобной идентификации.
