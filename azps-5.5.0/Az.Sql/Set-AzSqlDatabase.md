...
Эта команда добавляет базу данных "База данных01" в эластичный пул Под названием "ЭластичнаяPool01", который содержится на сервере Server01.
...
### -MaxSizeBytes
Максимальный размер базы данных Azure SQL вбавь.
