...
## ОПИСАНИЕ
Cmdlet **Stop-AzSqlDatabaseActivity** отменяет операцию асинхронного обновления базы данных.

## ПРИМЕРЫ

### Пример 1. Отмена асинхронного обновления базы данных
```
...
Эта команда отменяет операцию асинхронного обновления базы данных.

## PARAMETERS

### -DatabaseName
Указывает имя базы данных, для которой этот cmdlet получает состояние.
...
### -ElasticPoolName
Имя эластичного пула Azure SQL.
