...
## ОПИСАНИЕ
Чтобы восстановить удаленную резервную копию SQL базы данных **Get-AzSqlDeletedDatabaseBackup,** можно восстановить указанную резервную копию базы данных, которую можно восстановить, или все удаленные резервные копии.
...
### -DeletionDate
Дата удаления базы данных в качестве объекта **даты** и времени.
