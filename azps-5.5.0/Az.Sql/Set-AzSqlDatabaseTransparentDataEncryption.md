...
## ОПИСАНИЕ
Для свойства Transparent Data Encryption (TDE) базы данных Azure SQL используется свойство **Set-AzSqlDataTransparentDataEncryption.**
...
### Пример 1. Включить TDE для базы данных
```
...
Эта команда включает TDE для базы данных Database01 на сервере с именем Server01.

## PARAMETERS

### -DatabaseName
Имя базы данных, которую изменяет этот cmdlet.
...
### -State
Определяет значение свойства TDE.
