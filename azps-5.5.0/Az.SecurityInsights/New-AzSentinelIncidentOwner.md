...
## ОПИСАНИЕ
Для **обновления инцидента новый-AzSentinelIncidentOwner** создает объект "Владелец инцидента" в памяти.
...
В этом примере создается **владелец инцидентов,** который обновляет инцидент для нового владельца.
