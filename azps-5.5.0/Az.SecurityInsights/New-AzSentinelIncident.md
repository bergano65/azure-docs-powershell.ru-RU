...
## ОПИСАНИЕ
**Новый-AzSentinelIncident** создает инцидент из указанной рабочей области.
...
В этом примере создается **инцидент** в указанной рабочей области, а затем он сохраняется в переменной $Incident безопасности.

## PARAMETERS

### -ClassificationComment
Комментарий к классу инцидентов.
