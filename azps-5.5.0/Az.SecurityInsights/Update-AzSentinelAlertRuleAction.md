...
## ОПИСАНИЕ
Для обновления закладки в указанной рабочей области будет обновлена **cmdlet Update-AzSentinelAlertRuleAction.**
Объект **AlertRuleAction** можно передать в качестве параметра или с помощью оператора конвейера. Кроме того, можно указать *параметры AlertRuleId* и *ActionId.*
...
Этот пример обновляет действие **AlertRuleAction,** заменяя существующее действие *новыми* свойствами.
...
В этом примере **оповещениеRuleAction** обновляется с помощью объекта InputObject, заменяя существующее действие *новыми* свойствами.
