...
## ОПИСАНИЕ
Cmdlet **Get-AzSentinelAlertRuleAction** получает действие "Автоматизированный ответ" (действие правила оповещения) из указанной рабочей области.
...
В этом примере для указанного правила оповещения в указанной рабочей области возвращается правило **alertRuleAction,** а затем оно сохраняется в переменной $AlertRuleAction оповещения.
