...
## ОПИСАНИЕ
Чтобы **получить одну или** несколько частных групп зон DNS, можно получить одну или несколько закрытых групп зоны DNS.

## ПРИМЕРЫ

### Пример 1. Извлечение закрытой группы зон DNS
```powershell
...
В примере выше в группу ресурсов возвращается частная группа зоны DNS с именем dnsgroup1.
