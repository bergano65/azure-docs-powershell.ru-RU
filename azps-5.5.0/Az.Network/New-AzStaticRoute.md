...
## SYNOPSIS
Создает объект StaticRoute, который затем можно добавить к объекту RoutingConfiguration.
...
С этой командой создается объект StaticRoute, который затем можно добавить к объекту RoutingConfiguration.
