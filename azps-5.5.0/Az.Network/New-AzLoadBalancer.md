...
Для развертывания балансировки нагрузки необходимо сначала создать несколько объектов, а первые семь команд покажут, как их создать.
С ее названием создается балансировка нагрузки MyLoadBalancer в группе ресурсов MyResourceGroup.
...
### -Размассив
Определяет список товаров, которые нужно связать с балансировой нагрузкой.
...
### -ResourceGroupName
Указывает имя группы ресурсов, в которой нужно создать баланс нагрузки.
