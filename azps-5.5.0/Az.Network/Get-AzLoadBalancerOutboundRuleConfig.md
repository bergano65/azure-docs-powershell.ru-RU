...
## ОПИСАНИЕ
Для **этого можно** получить конфигурацию исходящие правил или список конфигураций правил исходящие в балансе нагрузки.

## ПРИМЕРЫ

### Пример 1. Настройка исходящие правил в балансире нагрузки
```powershell
...
Вторая команда получает конфигурацию исходящие правила MyRule, связанную с этим балансировом нагрузки.
