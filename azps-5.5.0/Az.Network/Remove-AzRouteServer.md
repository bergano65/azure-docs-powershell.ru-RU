...
## ОПИСАНИЕ
**Из-за настройки Remove-AzRouteServer** удаляется azure RouteServer.
...
### -InputObject
Объект ввода сервера маршрутов.
...
### -ResourceId
ИД ресурса сервера маршрутных маршрутов.
