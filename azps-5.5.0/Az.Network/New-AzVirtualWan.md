...
Выше будет создаваться группа ресурсов testRG в регионе "West US" и виртуальная сеть Azure с ветвью на ветвь трафика, разрешенным в этой группе ресурсов в Azure.
