...
Выше будет создаваться группа ресурсов, виртуальная сеть, виртуальная сеть и виртуальный концентратор. Затем мы создадим VpnGateway в этом виртуальном центре. Затем создайте новое правило NAT, связанное с созданным VpnGateway.
...
### -IpConfigurationId
ID конфигурации IP,применяемая к этому правилу NAT
