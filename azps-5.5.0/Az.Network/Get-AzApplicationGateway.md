...
## ОПИСАНИЕ
Для **получения шлюза приложения возвращается cmdlet Get-AzApplicationGateway.**
...
Эта команда получает шлюз приложения ApplicationGateway01, который принадлежит к группе ресурсов ResourceGroup01, и сохраняет его в переменной $AppGw ресурса.
...
Эта команда получает список всех шлюзов приложений в группе ресурсов ResourceGroup01 и сохраняет ее в переменной $AppGwList ресурса.
...
Эта команда получает список всех шлюзов приложения в подписке и сохраняет его в переменной $AppGwList параметрами.
...
Эта команда получает список всех шлюзов приложений в подписке, которые начинаются с ApplicationGateway01, и сохраняет их в переменной $AppGwList.
