...
## ОПИСАНИЕ
С  его учетом можно получить сводку данных о соседних BGP-данных для конкретного контекста маршрутки. Эти сведения полезны для определения времени установления контекста маршрутки и количества префиксов маршрутов, объявленных маршрутизатором пиринга.
...
### Microsoft.Azure.Commands.Network.Models.PSExpressRouteCrossConnectionRoutesSummary
