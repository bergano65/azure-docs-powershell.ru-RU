...
## ОПИСАНИЕ
Для локального объекта Azure ExpressRoutePort с его использованием обновляется объект **Set-AzExpressRoutePortIdentity.** Используйте **Set-AzExpressRoutePort,** чтобы назначить его ExpressRoutePort.
