...
## ОПИСАНИЕ
**Cmdlet Set-AzApplicationGatewayFirewallPolicy** обновляет политику брандмауэра шлюза приложения Azure.
...
Эта команда обновляет политику брандмауэра шлюза приложения с параметрами в переменной $AppGwFirewallPolicy и сохраняет обновленный шлюз в $UpdatedAppGwFirewallPolicy переменной.
...
### -ManagedRule
ManagedRules политики брандмауэра
...
### -PolicySetting
Политика настройки политики брандмауэра
