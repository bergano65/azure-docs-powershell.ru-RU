...
## ОПИСАНИЕ
Для **этого создается** таблица маршрутов Azure.
...
Первая команда создает маршрут Route07 с New-AzRouteConfig командлета, а затем сохраняет его в $Route переменной. Этот маршрут передает пакеты в локализованную виртуальную сеть.
