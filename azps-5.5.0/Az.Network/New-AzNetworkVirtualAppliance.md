...
## SYNOPSIS
Создайте ресурс сетевого виртуального устройства.
...
## ОПИСАНИЕ
Команда New-AzNetworkVirtualAppliance создает ресурс сетевого виртуального устройства в Azure.
...
Создает новый ресурс сетевого виртуального устройства в группе ресурсов Testrg.
...
URL-адрес BLOB-сайта конфигурации Bootstrap.
...
Конфигурация Cloudinit в виде обычного текста.
...
URL-адрес хранилища BLOB-то конфигурации Cloudinit.
...
### -Location
Расположение общедоступных IP-адресов.
