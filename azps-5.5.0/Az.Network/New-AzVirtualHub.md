...
Выше будет создаваться группа ресурсов TestRG, виртуальная WAN и виртуальный концентратор на западной части США в этой группе ресурсов в Azure. В виртуальном центре будет адресная площадь 10.0.1.0/24.
...
Этот пример похож на пример 1, но использует ИД ресурса для ссылки на виртуальную WAN, необходимую для создания виртуального концентратора.
...
Выше будет создаваться группа ресурсов TestRG, виртуальная WAN и виртуальный концентратор на западной части США в этой группе ресурсов в Azure. Виртуальный концентратор будет иметь адресную площадь "10.0.1.0/24" и подключенную таблицу маршрутов.

Этот пример похож на пример 2, но прикрепит таблицу маршрутов к виртуальному центру.
...
### -VirtualWan
Объект виртуальной wan, с который связан этот центр.
...
### -VirtualWanId
ИД объекта виртуальной wan, с который связан этот центр.
