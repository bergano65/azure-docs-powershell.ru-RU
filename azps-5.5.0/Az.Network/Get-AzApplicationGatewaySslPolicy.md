...
## ОПИСАНИЕ
Для шлюза приложения политика SSL возвращается стебом **Get-AzApplicationGatewaySslPolicy.**
...
Вторая команда получает политику ssl из шлюза приложения, храняного в переменной с $AppGW.

## PARAMETERS

### -ApplicationGateway
Указывает шлюз приложения для политики SSL, которую получает этот cmdlet.
