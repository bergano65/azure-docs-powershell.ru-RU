...
## SYNOPSIS
Создает правило NAT в VpnGateway, которое может быть связано с VpnSiteLinkConnection.
...
## ОПИСАНИЕ
Создает правило NAT для VpnGateway, которое может быть связано с VpnGateway.
...
Выше будет создаваться группа ресурсов, виртуальная сеть, виртуальная сеть и виртуальный концентратор. Затем мы создадим VpnGateway в этом виртуальном центре. Затем, используя эту команду: New-AzVpnGatewayNatRule, можно создать правило NAT и связанное с созданным VpnGateway.
...
### -ParentObject
Родительское правило VPNGateway для этого правила NAT.
...
### -ParentResourceId
ИД ресурса родительского VPNGateway для этого правила NAT.
