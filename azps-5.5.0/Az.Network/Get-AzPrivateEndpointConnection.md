...
В этом примере возвращается список всех подключений частных конечных точек, принадлежащих SQL-серверу Mysql.
...
Ид диспетчера ресурсов Azure для ресурса закрытой ссылки, к которой относится подключение к закрытой конечной точке.
