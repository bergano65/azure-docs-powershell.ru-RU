...
## ОПИСАНИЕ
Для получения одной или более **частных** служб ссылок можно получить одну или несколько личных служб.
...
Этот командлет получает частную службу ссылок в группе ресурсов.
