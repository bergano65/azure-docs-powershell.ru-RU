...
## ОПИСАНИЕ
С **помощью cmdlet New-AzFirewallPolicyThreatIntelWhitelist** создается объект из списка угроз Intel, который можно использовать при создании или настройке политики брандмауэра Azure.
...
В этом примере создается белый список intel угроз, содержащий белый список FQDN из одной записи и список IP-адресов из двух записей.
