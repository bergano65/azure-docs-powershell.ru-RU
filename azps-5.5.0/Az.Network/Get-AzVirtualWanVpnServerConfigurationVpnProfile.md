...
## ОПИСАНИЕ
С  помощью VirtualWan-VpnServerConfiguration-профиля Point to site можно создать и скачать профиль Vpn на уровне VirtualWan-VpnServerConfiguration. Это необходимо для подключения point к сайту от Point к клиенту сайта к Azure P2SVpnGateway.
...
VpnServerConfiguration, с которой связана эта виртуальная сеть.
