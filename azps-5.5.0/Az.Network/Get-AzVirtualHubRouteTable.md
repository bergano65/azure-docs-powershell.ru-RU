...
Этот cmdlet извлекает ресурс таблицы маршрутов, используя имя группы ресурсов, имя концентратора и имя таблицы маршрутов.
...
Этот cmdlet lists all route tables present in a virtual hub using resource group name and the hub name.
