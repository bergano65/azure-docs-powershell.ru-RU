...
Сначала мы создадим объект Virtual Hub Route и используем его для создания ресурса виртуальной таблицы маршрутов концентратора. Затем мы перенастроим этот ресурс таблицы маршрутов на виртуальный концентратор с помощью Set-AzVirtualHub управления.
