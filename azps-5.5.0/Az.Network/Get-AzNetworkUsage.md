...
## ОПИСАНИЕ
С Get-AzNetworkUsage и текущим использованием сетевых ресурсов.
...
Возвращает данные об использовании ресурсов в регионе westcentralus
...
### -Location
Место, в котором запрашивается использование ресурсов.
