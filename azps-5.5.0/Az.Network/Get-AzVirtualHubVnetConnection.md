...
Выше будет создание группы ресурсов, виртуальной WAN, виртуальной сети, виртуального концентратора в центральной части США в этой группе ресурсов в Azure. После этого будет создано виртуальное сетевое подключение, которое приместит виртуальную сеть к виртуальному концентратору.

После создания виртуального сетевого подключения концентратор получает виртуальное сетевое подключение, используя имя группы ресурсов, имя концентратора и имя подключения.
...
После создания виртуального сетевого подключения концентратора в списке перечислены все его виртуальные сетевые подключения с использованием имени группы ресурсов и имени концентратора.
...
Этот cmdlet lists all the hub virtual network connections starting with test using its resource group name and the hub name.
