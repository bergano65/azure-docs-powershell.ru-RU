...
Команда создает новую конфигурацию разрядки подключения с включенным подключением с установленным для функции True и DrainTimeoutInSec 42 секундами и сохраняет его в $connectionDraining.
