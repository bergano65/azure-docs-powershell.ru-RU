...
Следующая команда создаст объект VHubRoute со nextHop в качестве указанного брандмауэра, который затем можно добавить на ресурс VHubRouteTable.
...
Следующая команда создаст объект VHubRoute с nextHop в качестве указанного концентратораVnetConnection, который затем можно будет добавить к ресурсу VHubRouteTable.
