...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzFirewallPolicyRuleCollectionGroup** группа коллекции правил удаляется из политики брандмауэра Azure.
...
В этом примере удаляется группа colelction правил брандмауэра с именем testRcGroup в объекте политики брандмауэра $fp
...
В этом примере удаляется colelction rule firewall rule colelction group "testRcGroup" в брандмауэре fpName, frpm the resourcegroup names "testRg"
...
### -InputObject
Объект группы «Правила брандмауэра политики»
...
### -ResourceId
ИД ресурса группы коллекций правил
