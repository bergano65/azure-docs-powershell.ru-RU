...
## ОПИСАНИЕ
Для шлюза приложения сконфигурироваться автоматически будет **cmdlet Get-AzApplicationGatewayAutoscaleConfiguration.**
...
Вторая команда извлекает конфигурацию автомасштабы из шлюза приложения.
