...
## SYNOPSIS
Возвращает правило NAT, связанное с VpnGateway.
...
Выше будет создание группы ресурсов, виртуальной WAN, виртуальной сети, виртуального концентратора и VpnGateway & правила NAT, связанного с Vpngateway.
Затем правило NAT получает с использованием имени правила NAT.
...
### -ParentObject
Родительская vpnGateway для этого VPNGatewayNatRule.
...
### -ParentResourceId
ИД ресурса родительского VPNGateway для этого VPNGatewayNatRule.
