...
## ОПИСАНИЕ
Для балансиента нагрузки Azure конфигурацию правил добавляет **add-AzLoadBalancerRuleConfig.**

## ПРИМЕРЫ

### Пример 1. Добавление конфигурации правил для балансировки нагрузки
```
...
Вторая команда передает балансиру нагрузки в $slb **add-AzLoadBalancerRuleConfig,** который добавляет конфигурацию правил с именем NewRule.
Третья команда обновляет балансировку нагрузки в Azure с помощью нового config для балансиров нагрузки.

## PARAMETERS

### -BackendAddressPool
Определяет пул адресов для загрузки, который нужно связать с конфигурацией правил балансиров нагрузки.
...
### -BackendPort
Определяет порт для трафика, который соответствует конфигурации правила балансиров нагрузки.
...
Этот cmdlet добавляет конфигурацию правил к балансе нагрузки, указанному этим параметром.
...
### -Name
Указывает имя конфигурации правила балансиров нагрузки.
