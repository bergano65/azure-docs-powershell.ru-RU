...
## ОПИСАНИЕ
С Set-AzApplicationGatewayProbeConfig настраивает конфигурацию засвещающую конфигурацию в существующем шлюзе приложения.
...
Эта команда задает конфигурацию для шлюза приложения "Шлюз" с именем "Проект05".
