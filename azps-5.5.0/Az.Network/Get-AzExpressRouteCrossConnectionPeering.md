...
## ОПИСАНИЕ
Cmdlet **Get-AzExpressRouteCrossConnectionPeering** извлекает конфигурацию отношения пиринга для перекрестного подключения ExpressRoute.

## ПРИМЕРЫ

### Пример 1. Отображение конфигурации пиринга для перекрестного подключения ExpressRoute
```
...
Объект перекрестного подключения ExpressRoute, содержащий конфигурацию пиринга.
...
### -Name
Имя извлекаемой конфигурации пиринга.
