...
В этом примере создается виртуальная сеть в группе ресурсов, а затем сразу удаляется. Чтобы скрыть запрос при удалении виртуальной сети, используйте флаг -Force.
...
### -Name
Указывает имя виртуальной сети, которую удаляет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, которая содержит виртуальную сеть, которую удаляет этот cmdlet.
