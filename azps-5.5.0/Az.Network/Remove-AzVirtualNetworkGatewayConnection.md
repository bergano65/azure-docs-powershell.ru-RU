...
Командлет **Remove-AzVirtualNetworkGatewayConnection** удаляет объект подключения по имени и имени группы ресурсов.

## ПРИМЕРЫ

### Пример 1. Удаление подключения виртуального сетевого шлюза
```powershell
Remove-AzVirtualNetworkGatewayConnection -Name myTunnel -ResourceGroupName myRG
```

Удаляет объект подключения виртуального сетевого шлюза с именем myTunnel в группе ресурсов myRG.
...
### -Name
Указывает имя подключения виртуального сетевого шлюза, которое удаляет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, которая содержит подключение виртуального сетевого шлюза.
