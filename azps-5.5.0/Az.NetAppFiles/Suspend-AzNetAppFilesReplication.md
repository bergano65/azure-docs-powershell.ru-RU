...
Эта команда приостанавливать подключение репликации ANF для тома "MyDestinationAnfVolume".

## PARAMETERS

### -AccountName
Имя учетной записи ANF тома репликации
...
### -ForceBreak
Если репликация находится в состоянии и вы хотите принудительно нарушить репликацию, установите для этого истина.
...
### -InputObject
Объект назначения тома ANF с разрывом репликации
...
### -PassThru
Возвращает, был ли выполнен разрыв указанной репликации громкости.
...
### -PoolName
Имя пула ANF для тома репликации
