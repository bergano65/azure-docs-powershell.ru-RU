...
## ОПИСАНИЕ
Восстановление или восстановление громкости для моментального снимка, указанного в параметре SnapshotId
...
Эта команда восстанавливает/возвращает громкость MyVolume к одному из моментальных снимков со снимкомId 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -PassThru
Возвращает, была ли указанная громкость успешно восстановлена или восстановлена.
...
### -PoolObject
Объект пула, содержащий удаляемую громкость
...
### -SnapshotId
SnapshotId моментального снимка.
UUID версия 4, используемая для определения моментального снимка
