...
## ОПИСАНИЕ
Для **обновления-AzNetAppFilesBackupPolicy** будет модименовна политика резервного копирования ANF.
...
### -AccountObject
Объект Account, содержащий политику резервного копирования для обновления
