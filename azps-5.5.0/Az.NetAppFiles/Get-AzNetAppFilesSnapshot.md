...
## ОПИСАНИЕ
Для получения подробных сведений о снимке ANF возвращается **cmdlet Get-AzNetAppFilesSnapshot.**

## ПРИМЕРЫ

### Пример 1. Получить снимок ANF
```
...
### -VolumeObject
Объект громкости, содержащий моментальный снимок, который нужно вернуть
