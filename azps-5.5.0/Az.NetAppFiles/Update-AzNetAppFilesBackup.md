...
## SYNOPSIS
Обновление резервной копии файлов Azure NetApp Files (ANF) с помощью необязательных модификаторов.
...
## ОПИСАНИЕ
Для резервной копии ANF будет обновлена **cmdlet Update-AzNetAppFilesBackup.**
...
Эта команда выполняет обновление резервной копии, внося изменения в имя пользователя в предоставленном резервном копировании.
...
### -Label
Метка для резервного копирования
...
### -VolumeObject
Объект громкости, содержащий резервную копию, возвращаемую
