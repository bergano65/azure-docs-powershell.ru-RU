...
## ОПИСАНИЕ
Возобновление/resync подключение к громкости назначения
...
Эта команда возобновляет подключение репликации ANF для тома "MyDestinationAnfVolume".
...
### -InputObject
Объект тома назначения репликации ANF для повторного перенаправления
...
### -PassThru
Возвращает, выполняется ли повторение указанного тома репликации.
