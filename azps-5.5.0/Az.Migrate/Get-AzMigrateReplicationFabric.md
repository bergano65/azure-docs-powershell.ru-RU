...
### Пример 1. Получить все ткань по названию группы ресурсов и хранилища
```powershell
...
Получить все ткань в группе и хранилище ресурсов

### Пример 2. Получить материал по группе ресурсов, имени сейфа и имени ткань
```powershell
...
Получить определенный материал
