...
### -InputObject
Указывает сервер репликации, для которого нужно инициировать миграцию.
...
### -TargetObjectID
Указывает реплицирующий сервер, для которого нужно инициировать миграцию.
...
### -TurnOffSourceServer
Определяет, следует ли отключить исходный сервер после миграции.
...
INPUTOBJECT: определяет сервер репликации, для которого <IMigrationItem> нужно инициировать миграцию. Объект сервера можно извлечь с помощью Get-AzMigrateServerReplication..
