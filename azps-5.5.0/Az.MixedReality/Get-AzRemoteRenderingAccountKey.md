...
## SYNOPSIS
Получить ключи от учетной записи удаленной отрисовки
...
Получите ключи разработчика для удаленной отрисовки "example" из текущей подписки и группы ресурсов "rg1".
...
Получите ключи разработчика "example" учетной записи удаленной отрисовки из текущей подписки и группы ресурсов "rg1" с piping.
