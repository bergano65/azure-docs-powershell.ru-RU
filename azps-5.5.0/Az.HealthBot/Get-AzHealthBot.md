...
### Пример 1. Получить всех HealthBot
```powershell
...
Получить всех HealthBot

### Пример 2. Получить всех HealthBot по ResourceGroupName
```powershell
...
Получить всех HealthBot по ResourceGroupName

### Пример 3. Получить HealthBot по ResourceGroupName и Name
```powershell
...
Получить HealthBot по resourceGroupName и Name

### Пример 4. Получить HealthBot by InputObject
```powershell
...
Получить HealthBot по InputObject
...
INPUTOBJECT <IHealthBotIdentity> : Параметр identity
  - `[BotName <String>]`: Название ресурса-бота.
