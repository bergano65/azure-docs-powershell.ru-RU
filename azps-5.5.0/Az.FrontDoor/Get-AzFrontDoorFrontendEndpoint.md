...
### Пример 1. Получить все конечные точки переднего входа в front door "frontdoor1", который входит в группу ресурсов "rg1".
```powershell
...
Получить все конечные точки переднего входа в front door "frontdoor1", который входит в группу ресурсов "rg1".
