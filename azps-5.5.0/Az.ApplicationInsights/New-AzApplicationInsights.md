...
### Пример 1. Создание нового ресурса для анализа приложений
```
...
Добавление нового ресурса аналитики приложений с именем "тест" в группе ресурсов "testgroup" с типом "java"
...
Тип сетевого доступа для доступа к анализу приложений. Значение должно быть включено или отключено
...
Тип доступа к сети для запроса Application Insights. Значение должно быть включено или отключено
...
### -RetentionInDays
Хранение в днях, 90 по умолчанию.
