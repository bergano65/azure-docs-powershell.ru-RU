...
Удаляет метаданные из конфигураций узлов DSC в автоматизации. (autogenerated)
...
Имя учетной записи автоматизации, которая содержит конфигурации узлов DSC, для которых этот cmdlet удаляет метаданные.
