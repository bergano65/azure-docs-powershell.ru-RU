...
Эта команда получает метаданные для всех конфигураций узлов DSC в учетной записи автоматизации Contoso17, которую создает конфигурация DSC с именем ContosoConfiguration.
...
Указывает имя учетной записи автоматизации, которая содержит конфигурации узлов DSC, для которых этот cmdlet получает метаданные.
