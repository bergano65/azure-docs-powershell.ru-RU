...
## ОПИСАНИЕ
Создает объект запросов Azure для обновления программного обеспечения, который будет использоваться для создания конфигурации обновления программного обеспечения, которая будет работать по расписанию для обновления списка динамически урегулированных списков виртуальных машин Azure.
