...
## ОПИСАНИЕ
Обновление правила оповещения журнала с помощью семантики PUT

## ПРИМЕРЫ

### Пример 1. Настройка по имени правила
```powershell
...
### Пример 3. Настройка по ИД ресурса
```powershell
...
### -Action
Действие оповещения для запланированного правила запроса
...
### -Расписание
Расписание запланированного правила запроса
...
### -Source
Источник правил для запланированного запроса
