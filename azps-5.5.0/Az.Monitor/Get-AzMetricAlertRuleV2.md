...
## ОПИСАНИЕ
Для этого с помощью **cmdlet Get-AzMetricAlertRuleV2** можно получить правило метрического оповещения по имени или URI либо все правила метрических оповещений для указанной группы ресурсов или подписки.
...
### Пример 3. По имени получите правило метрических оповещений
