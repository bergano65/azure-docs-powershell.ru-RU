...
## ОПИСАНИЕ
На замену существующего правила сбора данных можно использовать **cmdlet Set-AzDataCollectionRule.**
...
Также поддерживается вывод dcR, отреализованного с помощью ConvertTo-Json (пример #2).
