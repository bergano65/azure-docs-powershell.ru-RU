...
Обновив область приватных ссылок с помощью имени "scope_name" в группе ресурсов "rg_name", чтобы использовать тег "key:value"
...
Обновление области личной ссылки с помощью ИД ресурса, чтобы использовать тег "key:value"
...
Обновление области приватных ссылок с использованием объекта входной частной области ссылки для использования тега "key:value"
