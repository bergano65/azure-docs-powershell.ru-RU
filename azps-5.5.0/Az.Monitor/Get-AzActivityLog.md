...
Эта команда содержит не более 1000 событий, связанных с указанным ид корреляции, которые произошли в 2017-05-22T04:30:00 локального времени, если время начала не старше 90 дней с текущей даты и времени.
**ПРИМЕЧАНИЕ.** Обычно это только одно событие.
...
### Пример 10. Получить журнал событий для группы ресурсов с максимальным количеством событий
```
...
Эта команда содержит не более 1000 событий, связанных с указанным ИД ресурса, которые были заданы за 7 дней от текущей даты/времени.
...
### -Status
Состояние событий для получения
