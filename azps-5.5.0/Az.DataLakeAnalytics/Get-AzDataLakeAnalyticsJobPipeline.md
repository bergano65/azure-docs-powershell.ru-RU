...
## ОПИСАНИЕ
**Get-AzDataLakeAnalyticsJobPipeline** получает определенный конвейер azure Data Lake Analytics или список конвейеров.
...
### -Account
Имя учетной записи Data Lake Analytics, под которой вы хотите получить канал задания.
...
### -SubmittedBefore
Необязательный фильтр, который возвращает конвейеры задания, отправленные только до указанного времени.
