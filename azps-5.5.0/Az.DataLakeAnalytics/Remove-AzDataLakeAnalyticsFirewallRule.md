...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzDataLakeAnalyticsFirewallRule** правило брандмауэра удаляется из учетной записи Azure Data Lake Analytics.

## ПРИМЕРЫ

### Пример 1. Удаление правила брандмауэра
```
PS C:\>Remove-AzDataLakeAnalyticsFirewallRule -Account "ContosoAdlAcct" -Name "My firewall rule"
```

Эта команда удаляет правило брандмауэра под названием "Правило брандмауэра" из учетной записи ContosoAdlAcct.

## PARAMETERS

### -Account
Учетная запись Data Lake Analytics для удаления правила брандмауэра из
...
### -ResourceGroupName
Имя группы ресурсов, под которой нужно получить учетную запись.
