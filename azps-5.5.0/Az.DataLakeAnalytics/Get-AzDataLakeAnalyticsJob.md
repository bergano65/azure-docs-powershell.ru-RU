...
## SYNOPSIS
Получает задание анализа для data Lake Analytics.
...
### -Include
Определяет параметры, которые указывают на тип дополнительных сведений, которые необходимо получить о задаче.
...
### -Name
Указывает имя, которое будет использовать для фильтрации результатов списка задания.
Допустимыми значениями для этого параметра являются:
- Нет
- DebugInfo
- Статистика
