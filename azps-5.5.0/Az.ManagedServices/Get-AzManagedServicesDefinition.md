...
Получает все определения регистрации по умолчанию.
...
Получает определение регистрации по имени по умолчанию.
...
Получает все определения регистрации в заданной области.
...
### -Scope
Область создания определения регистрации.
