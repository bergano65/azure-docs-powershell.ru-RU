...
## ОПИСАНИЕ
Для удаления конвейера из фабрики данных Azure удаляется **cmdlet Remove-AzDataFactoryPipeline.**
...
Этот cmdlet удаляет конвейер под названием DPWikisample из фабрики данных с именем WikiADF.
...
Этот cmdlet удаляет канал из фабрики данных, указанной этим параметром.
...
Этот cmdlet удаляет канал из фабрики данных, заданной этим параметром.
...
### -Force
Указывает на то, что этот cmdlet удаляет канал без запроса подтверждения.
...
Этот cmdlet удаляет канал из группы, указанной этим параметром.
