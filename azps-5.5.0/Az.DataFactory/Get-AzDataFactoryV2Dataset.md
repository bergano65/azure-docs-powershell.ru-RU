...
## ОПИСАНИЕ
Этот Get-AzDataFactoryV2Dataset получает сведения об наборе данных в фабрике данных Azure.
...
### -Name
Определяет имя наборов данных, сведения о которых необходимо получить.
