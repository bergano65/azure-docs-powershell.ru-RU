...
## ОПИСАНИЕ
**Cmdlet Get-AzDataFactoryV2IntegrationRuntimeNode** получает подробные сведения об узле интеграции runtime.

## ПРИМЕРЫ

### Пример 1. Получает подробные сведения об узле времени запуска интеграции.
```
...
Он получает сведения узла Node_1 в режиме самостоятельной интеграции "test-selfhost-ir" в фабрике данных test-df-eu2.

### Пример 2. Получает подробные сведения об узле интеграции runtime вместе с IP-адресом.
```
...
Cmdlet gets information of node named 'Node_1' in self-hosted integration runtime 'test-selfhost-ir' in data factory 'test-df-eu2', including the IP address.
...
### -IpAddress
IP-адрес узла интеграции runtime.
