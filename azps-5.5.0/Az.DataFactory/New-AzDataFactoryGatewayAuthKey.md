...
## ОПИСАНИЕ
Для указанного шлюза фабрики данных Azure создается ключ проверка безопасности шлюза **New-AzDataFactoryGatewayAuthKey.**
...
Эта команда создает ключ строгой защиты шлюза Key1 для шлюза фабрики данных MyGateway.
...
### -KeyName
Имя сгенерированной части шлюза (key1 или key2).
