...
## ОПИСАНИЕ
Для создания шлюза в фабрике данных Azure **создается cmdlet New-AzDataFactoryGateway.**
...
Эта команда создает шлюз ContosoGateway в фабрике данных с именем WikiADF в группе ресурсов ADF.

## PARAMETERS

### -DataFactory
Указывает объект **PSDataFactory.**
Этот cmdlet создает шлюз для фабрики данных, указанной этим параметром.
...
### -Name
Указывает имя созда создаемого шлюза.
...
Этот cmdlet создает шлюз, который принадлежит к группе, указанной этим параметром.
