...
Эта команда останавливает запуск триггера с помощью id '08586002468005888497807248799CU16' на заводском wikiADF.
...
### -PassThru
Если для указанного cmdlet задано написание истина в случае успешной операции.
