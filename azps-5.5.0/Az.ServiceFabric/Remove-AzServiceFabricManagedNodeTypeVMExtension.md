...
## ОПИСАНИЕ
Удалите расширение VM из типа узла по имени. Используйте [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) и взгляните на свойство VmExtensions, чтобы увидеть текущее расширение для типа узла.
...
Удаление расширения из типа узла по имени с помощью перенастройки.
