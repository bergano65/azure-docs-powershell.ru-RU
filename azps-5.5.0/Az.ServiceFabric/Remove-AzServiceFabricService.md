...
## SYNOPSIS
Удалите службу из кластера. Поддерживаются только ARM развернутые службы.
...
## ОПИСАНИЕ
Этот cmdlet removes a service form the cluster.
...
В этом примере удаляется служба testApp~testService1.
