...
Эта команда создает самозаверяяный сертификат в хранилище ключей Azure и обновляет кластер, чтобы использовать его в качестве дополнительного сертификата кластера.
