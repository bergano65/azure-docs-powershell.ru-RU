...
Конфигурация уровня resourceGroup: для каждой группы ресурсов может быть только одна конфигурация. С помощью этого cmdlet можно обновить только свойство Exclude.
