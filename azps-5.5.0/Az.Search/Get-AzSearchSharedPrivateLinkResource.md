...
## ОПИСАНИЕ
Для получения общих ресурсов по личным ссылкам службы интеллектуального поиска Azure возвращается **cmdlet Get-AzSearchSharedPrivateLinkResource.**
...
В этом примере перечислены все общие ресурсы по закрытым ссылкам службы Azure Cognitive Search.
...
В этом примере перечислены определенные ресурсы общей частной ссылки по имени службы Azure Cognitive Search.
...
### -ResourceId
ИД ресурса общей личной ссылки
