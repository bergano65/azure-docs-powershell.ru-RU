...
## ОПИСАНИЕ
**Cmdlet Set-AzSearchService** изменяет службу azure Cognitive Search.
...
В этом примере количество разделов и количество репликации службы azure Cognitive Search изменяется на 2.
...
### -ReplicaCount
Количество репликации службы поиска.
