...
## ОПИСАНИЕ
Служба **Remove-AzSearchPrivateEndpointConnection** удаляет частное подключение конечной точки из службы azure Cognitive Search.
...
В этом примере подключение к частной конечной точке удаляется из службы поиска по имени.
