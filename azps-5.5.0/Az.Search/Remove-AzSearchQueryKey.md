...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzSearchQueryKey** клавиша запроса удаляется из службы поиска когнитивных функций Azure.
...
В этом примере ключ запроса удаляется из службы поиска когнитивных функций Azure.
...
### -KeyValue
Значение ключа запроса службы поиска Azure.
