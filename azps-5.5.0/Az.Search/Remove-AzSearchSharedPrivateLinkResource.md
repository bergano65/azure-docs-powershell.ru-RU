...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzSearchSharedPrivateLinkResource** ресурс общей частной ссылки удаляется из службы azure Cognitive Search.
...
В этом примере удаляется ресурс общей частной ссылки по имени службы Azure Cognitive Search.
