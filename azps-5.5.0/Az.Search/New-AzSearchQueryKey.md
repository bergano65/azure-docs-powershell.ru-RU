...
## ОПИСАНИЕ
Для **службы azure Cognitive** Search создается новый ключ запроса.
...
В этом примере создается новый ключ запроса для службы azure Cognitive Search.
...
### -Name
Имя ключа запроса службы поиска Azure.
