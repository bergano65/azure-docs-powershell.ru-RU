...
## ОПИСАНИЕ
Для получения ключей запроса от службы azure Cognitive Search возвращается ключ запроса **get-azSearchQueryKey.**
...
В этом примере выберем все клавиши запросов службы поиска когнитивных функций Azure.
