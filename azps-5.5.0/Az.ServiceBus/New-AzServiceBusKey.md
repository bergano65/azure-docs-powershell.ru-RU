...
## ОПИСАНИЕ
Для указанного пространства имен, очереди или темы и правила авторизации с его нажатием создается новая строка основного или дополнительного подключения **New-AzServiceBusKey.**
...
Повторное сгенерирует строки основного или дополнительного подключения с задамым значением ключа для пространства имен.
...
Повторное сгенерирует строки основного или дополнительного подключения для очереди.
...
Повторное сгенерирует строки основного или дополнительного подключения с задамым значением ключа для очереди.
...
Повторное сгенерирует строки основного или дополнительного подключения для этого раздела.
...
Повторное сгенерирует строки основного или дополнительного подключения с заданной ключевой строкой для данной темы.
