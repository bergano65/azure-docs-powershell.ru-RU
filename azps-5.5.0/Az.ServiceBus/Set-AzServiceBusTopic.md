...
## ОПИСАНИЕ
Для объекта описания темы "Шина обслуживания" в указанном пространстве имен "Автобус обслуживания" обновляется объект **Set-AzServiceBusTopic.**
...
Обновляет указанный раздел с новым описанием в указанном пространстве имен. В этом примере свойство **EnableExpress** обновляется до **true.** 
