...
## ОПИСАНИЕ
Для **создания нового псевдонима (конфигурация аварийного восстановления) new-AzServiceBusGeoDRConfiguration** создается новый псевдоним (конфигурация аварийного восстановления).
...
Создание псевдонима SampleDRConfigName с основным пространством имен "SampleNamespace_Primary" и дополнительным пространством имен "SampleNamespace_Secondary"
...
### -PartnerNamespace
DR Configuration PartnerNamespace (ARM ИД PartnerNamespace [дополнительное пространство имен])
