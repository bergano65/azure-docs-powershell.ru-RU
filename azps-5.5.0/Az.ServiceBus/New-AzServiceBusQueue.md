...
Создание очереди "Автобус обслуживания" в указанном пространстве доменных имен "Автобус обслуживания". (autogenerated)
...
### -AutoDeleteOnIdle
Указывает [неавтомительный интервал timeSpan,](https://msdn.microsoft.com/library/system.timespan.aspx) после которого очередь автоматически удаляется. Минимальная длительность — 5 минут.
