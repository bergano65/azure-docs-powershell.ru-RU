...
## ОПИСАНИЕ
Для **этой темы в** указанном пространстве доменных имен "Номер обслуживания" обновляется описание подписки на раздел "Автобус обслуживания".
...
Обновляет описание указанной подписки по указанному разделу. В этом примере свойство **DeadLetteringOnMessageExpiration** обновляется с true до 9, а **MaxDeliveryCount** — до 9. 
