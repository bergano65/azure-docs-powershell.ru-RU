...
## ОПИСАНИЕ
Для **удаления подписки из** указанного пространства имен автобусов обслуживания удаляется подписка на определенный раздел.
...
Удаляет подписку на раздел, указанный в указанном пространстве имен `SB-TopicSubscription-Example1` `SB-Topic_exampl1` автобусов `SB-Example1` обслуживания.
...
Удаляет подписку, предоставленную с ARM в параметре $resourceid/string для -ResourceId. 
