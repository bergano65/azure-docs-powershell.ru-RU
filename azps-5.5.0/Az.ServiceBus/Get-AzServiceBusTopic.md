...
## ОПИСАНИЕ
Для **указанного пространства имен в автобусе** служинного возвращается описание темы с его описанием.
...
Возвращает описание указанного раздела для данного пространства имен автобусов обслуживания.
...
Возвращает список из первых 150 разделов, задав для данного пространства имен автобусов обслуживания.
