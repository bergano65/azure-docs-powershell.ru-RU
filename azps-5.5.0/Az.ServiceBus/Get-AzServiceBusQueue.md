...
Возвращает список очередей для заданного пространства имен. По умолчанию возвращается 100 очередей, если возвращается более 100 очередей, используйте параметр -MaxCount.
...
Возвращает список первых 150 очередей для заданного пространства имен.
...
### -MaxCount
Определите максимальное количество очередей, которые нужно вернуть.
