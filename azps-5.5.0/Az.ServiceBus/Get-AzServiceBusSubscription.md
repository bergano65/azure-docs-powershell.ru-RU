...
## ОПИСАНИЕ
Чтобы получить описание подписки для указанного раздела "Служни", можно получить описание подписки на **Get-AzServiceBusSubscription.**
...
Возвращает описание подписки для указанного раздела "Автобус обслуживания".
...
Возвращает список подписок по указанному разделу "Автобус обслуживания". По умолчанию возвращается 100 подписок, для нескольких подписок используйте параметр -MaxCount
...
Возвращает список из первых 150 подписок по указанному разделу "Автобусная обслуживание".
...
### -MaxCount
Определите максимальное число возвращаемых подписок.
