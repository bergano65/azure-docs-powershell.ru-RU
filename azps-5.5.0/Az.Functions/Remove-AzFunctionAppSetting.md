...
## ОПИСАНИЕ
Удаляет параметры приложения из приложения с функцией.

## ПРИМЕРЫ

### Пример 1. Удаление параметров приложения в приложении с функцией.
```powershell
...
Эта команда удаляет параметры приложения в приложении с функцией.

## PARAMETERS

### -AppSettingName
Список параметров приложения функций, удаляемого из приложения этой функции.
...
### -Force
Позволяет удалить параметр приложения функции, не запросив подтверждение.
