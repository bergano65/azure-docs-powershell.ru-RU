...
Эта команда получает приложение функции по имени и перезапускает его.
...
Эта команда перезапустит приложение функции по имени.
...
### -Force
Этот пуск позволяет перезапустить приложение функции без запроса на подтверждение.
