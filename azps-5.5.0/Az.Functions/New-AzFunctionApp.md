...
### Пример 1. Создание приложения с дополнительными функциями PowerShell в Центральной части США.
```powershell
...
Эта команда создает приложение функции с использованием личного изображения ACR.
...
Отключать создание ресурса статистики приложения во время создания приложения с функцией.
