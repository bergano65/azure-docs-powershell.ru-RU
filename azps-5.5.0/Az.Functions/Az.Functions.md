...
# Модуль Az.Functions
## Описание
Microsoft Azure PowerShell — это команды для диспетчера ресурсов Azure в Windows PowerShell и PowerShell Core.\n\nFor о функциях Azure. Посетите следующие веб-сайты: https://docs.microsoft.com/azure/azure-functions/
...
Получает приложения функций в подписке.

### [Get-AzFunctionAppAvailableLocation](Get-AzFunctionAppAvailableLocation.md)
Расположение, в котором доступно приложение функции для данного ос и типа плана.
...
Возвращает объект systemAssignedIdentity, доступный в указанной области действия RP.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Описание функций "Получить клавиши" для функции на веб-сайте или в слоте развертывания.
...
Описание параметра "Получает справочные параметры и состояние приложения"

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Описание для этого — разрешить вызовы с помощью powershell и ARM шаблона.
...
### [Move-Az](Move-Az.md)
Описание для перемещения ресурсов между группами ресурсов.
...
Создает приложение с функцией.

### [New-AzFunctionAppPlan](New-AzFunctionAppPlan.md)
Создает план обслуживания приложения для функций.
...
Описание функции "Синхронизация" активирует метаданные в базе данных управления

### [Test-Az](Test-Az.md)
Описание для проверки того, можно ли создать ресурс.
...
Обновляет приложение с функцией.
...
Добавляет или обновляет параметры приложения в приложении с функцией.
...
### [ValidatePlanSwcompatibility](ValidatePlanSwitchCompatibility.md)
