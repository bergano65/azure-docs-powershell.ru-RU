...
Получить историю изменений для определенного резервирования
...
### -Резервирование
Параметр "Объект-труба" для `Reservation` s
...
### -ReservationOrderId
ReservationOrderId для `ReservationOrder` того, что содержит `Reservation`
