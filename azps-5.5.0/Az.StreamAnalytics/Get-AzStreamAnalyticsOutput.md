...
## ОПИСАНИЕ
В **этом cmdlet** выведется список всех выходных данных, определенных в указанном заданиях аналитики StreamAnalytics или которые получают сведения о конкретном выходе.
...
### Пример 2. Просмотр сведений о конкретных результатах задания
```powershell
...
### -Name
Указывает имя результата Azure Stream Analytics, который нужно извлечь.
