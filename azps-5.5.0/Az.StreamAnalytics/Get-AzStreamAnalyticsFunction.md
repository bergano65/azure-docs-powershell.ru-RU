...
Эта команда возвращает функции, определенные для задания StreamJob22.
...
Эта команда получает сведения о функции ScoreTweet, определенной в задаче StreamJob22.
