...
Если вы указали входные данные, которые уже существуют и не указали параметр *Force,* будет указано, следует ли заменить существующие входные данные.
...
Если уже определен существующий вход с этим именем, будет выводить запрос на его замену.
...
### -ResourceGroupName
Имя группы ресурсов, для которой нужно создать потоковую передачу Azure.
