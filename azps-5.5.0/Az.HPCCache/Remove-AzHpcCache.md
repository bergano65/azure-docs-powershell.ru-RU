...
## ОПИСАНИЕ
С **его использованием удаляется** кэш HPC Azure.
...
### -Force
Указывает на то, что при этом не будет предложено подтвердить запрос. По умолчанию этот cmdlet запросит подтверждение удаления кэша.
...
### -ResourceGroupName
Имя группы ресурсов, для которой вы хотите удалить кэш.
