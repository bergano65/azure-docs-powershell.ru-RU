...
## ОПИСАНИЕ
Для **этого можно** получить один кэш, кэш в определенной группе ресурсов или список кэшов в масштабе подписки.
...
### -ResourceGroupName
Имя группы ресурсов, в которую вы хотите перечислить кэш.
