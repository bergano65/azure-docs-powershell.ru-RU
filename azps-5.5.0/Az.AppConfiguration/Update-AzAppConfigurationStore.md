...
Эта команда позволяет шифровать данные с помощью ключа, храняного в хранилище ключей Azure, с помощью управляемого удостоверения, назначенного системе.
...
Эта команда позволяет шифровать данные с помощью ключа, храняного в хранилище ключей Azure, с использованием управляемого удостоверения, назначенного пользователем.
Удостоверение, назначенное пользователю, должно быть настроено с `-UserAssignedIdentity` помощью.
В хранилище должно быть включено soft-delete и purge-protection, а у управляемого удостоверения должны быть такие основные разрешения: get, wrapKey, unw ключkey.
...
URI ключа хранилища ключа, используемого для шифрования данных.
