...
## ОПИСАНИЕ
При указании имени cmdlet **Get-AzDataShareDataSetMapping** получает сведения об определенном сопоставлении наборов данных. В противном случае он получает сведения обо всех сопоставлениях для наборов данных в подписке на совместное использования. 
