...
## ОПИСАНИЕ
Для удаления подписки на совместное использования удаляется списатель **Remove-AzDataShareSubscription**
...
Эти команды удаляют из учетной записи WikiAds ссылку AdsShareSubscription с именем AdsShareSubscription. 
