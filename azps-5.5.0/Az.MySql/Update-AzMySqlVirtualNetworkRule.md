...
### Пример 1. Обновление правила виртуальной сети MySql по имени
```powershell
...
Этот cmdlet обновляет по имени виртуальное правило сети MySql.

### Пример 2. Обновление виртуальных сетевых правил MySql по удостоверениям.
```powershell
...
Эти cmdlets обновляют виртуальное правило сети MySql по удостоверениям.
