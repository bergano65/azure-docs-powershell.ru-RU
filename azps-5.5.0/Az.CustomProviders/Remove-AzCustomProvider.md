...
## SYNOPSIS
Удаляет поставщика настраиваемой службы ресурсов.
...
## ОПИСАНИЕ
Удаляет поставщика ресурсов.

## ПРИМЕРЫ

### Пример 1. Удаление пользовательского поставщика.
```powershell
PS C:\> PS C:\> Remove-AzCustomProvider -ResourceGroupName myRg -Name Namespace.Type
```

Удаление поставщика настраиваемой службы

### Пример 2. Удаление пользовательского поставщика с помощью passThru
```powershell
...
Удалите поставщика, указать успех или неудачу с помощью функции PassThru.
