...
Чтобы построить новую схему, см. раздел "ЗАМЕТКИ" для свойств DIGITALTWINSINSTANCECHECKNAME и создание hash table.
...
DIGITALTWINSINSTANCECHECKNAME: результат, возвращенный запросом на доступность имени проверки <ICheckNameRequest> базы данных.
