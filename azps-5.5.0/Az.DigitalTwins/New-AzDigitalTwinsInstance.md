...
### Пример 1. Создание по умолчанию azDigitalTwinsInstance.
```powershell
...
Создание azDigitalTwinsInstance по умолчанию

### Пример 2. Создание объекта AzDigitalTwinsInstance объектом AzDigitalTwins.
```powershell
...
Создание объекта AzDigitalTwinsInstance от AzDigitalTwins
...
Чтобы построить новую таблицу, см. раздел "ЗАМЕТКИ" для свойств DIGITALTWINSCREATE и создание hash table.
...
DIGITALTWINSCREATE: <IDigitalTwinsDescription> описание службы DigitalTwins.
  - `Location <String>`: Расположение ресурса.
  - `[Tag <IDigitalTwinsResourceTags>]`Теги ресурсов.
