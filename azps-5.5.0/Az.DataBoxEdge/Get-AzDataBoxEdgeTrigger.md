...
## ОПИСАНИЕ
**Cmdlet Get-AzDataBoxEdgeTriger** получает триггеры для устройства. Вы можете указать имя в качестве параметра в cmdlet для получения сведений об определенных триггерах.
