...
### InvokeScanForUpdateParameterSet (по умолчанию)
```
...
## ОПИСАНИЕ
**Cmdlet Invoke-AzDataBoxEdgeDevice** вызывает действия для сканирования, скачивания и установки обновлений на устройстве Edge Data Box. На устройстве ежедневно выполняется автоматическое сканирование, которое можно активировать явным образом с помощью этого cmdlet.
...
### -FetchUpdate
Скачивает обновления на устройстве с полем данных или шлюзом.
...
### -InstallUpdate
Устанавливает обновления на устройстве с полем данных или шлюзом.
...
### -PassThru
Возвращает "Истина" в случае успеха.
...
### -ScanForUpdate
Проверяет, нет ли обновлений на устройстве с полем данных или шлюзом.
