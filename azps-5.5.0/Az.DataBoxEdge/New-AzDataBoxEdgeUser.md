...
## ОПИСАНИЕ
С **новыми данными AzDataBoxEdgeUser** создается новый пользователь для устройства Edge Box Data Box. Поддерживается создание только пользователей `Share` разных типов.
