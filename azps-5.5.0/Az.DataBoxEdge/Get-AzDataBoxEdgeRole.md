...
## ОПИСАНИЕ
Для получения доступных ролей IoT на устройстве Edge data Box можно получить доступ к ролям **Get-AzDataBoxEdgeRole.** Вы можете упомянуть параметр Name, чтобы получить сведения о конкретной роли IoT.
