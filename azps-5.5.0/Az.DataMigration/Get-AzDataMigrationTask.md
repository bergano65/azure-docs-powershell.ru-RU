...
## ОПИСАНИЕ
Он Get-AzDataMigrationTask извлекает свойства, связанные с задачей миграции службы миграции баз данных Azure.
...
В примере выше показано использование Get-AzDataMigrationTask для извлечения свойств, связанных с задачей миграции службы миграции баз данных Azure, на основе имени задачи, переданной в качестве входного параметра.
...
В примере выше показано использование Get-AzDataMigrationTask для получения всех задач миграции, связанных с объектом PSProject, который передается в качестве входного параметра
...
### -ResultType
Развернуть выходные данные заданного типа результатов.
