...
## ОПИСАНИЕ
С New-AzDataMigrationSelectedDB создается объект сведений базы данных, содержащий сведения об исходных и целевых базах данных, а также сопоставления таблиц для миграции. Этот cmdlet можно использовать в качестве параметра с New-AzDataMigrationTask.
