...
## ОПИСАНИЕ
С Suspend-AzPowerBIEmbeddedCapacity-за отключения экземпляра внедренной емкости PowerBI
...
Приостановка активной емкости с именем testcapacity в тестовой группе ресурсов
