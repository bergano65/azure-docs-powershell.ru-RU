...
## ОПИСАНИЕ
С Get-AzPowerBIEmbeddedCapacity управления получают сведения о внедренной емкости PowerBI.

## ПРИМЕРЫ

### Пример 1. Группировка ресурсов
```
...
Эта команда получает все внедренные мощности Azure PowerBI в группе ресурсов TestRG

### Пример 2. Получить емкость
```
...
Эта команда получает встроенную мощность Azure PowerBI Testcapacity в группе ресурсов TestRG.
