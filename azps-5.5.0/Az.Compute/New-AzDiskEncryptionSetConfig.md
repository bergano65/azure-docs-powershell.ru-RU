...
### -EncryptionType
Этот код используется для того, чтобы настроить тип шифрования набора шифрования диска. Доступны такие значения: EncryptionAtRestWithPlatformKey, "EncryptionAtRestWithCustomerKey".
...
### -IdentityType
Тип управляемого удостоверения, используемого набором DiskEncryptionSet. Поддерживается только systemAssigned.
...
### -KeyUrl
URL-адрес, на который указывают активные клавиши в KeyVault
...
### -SourceVaultId
ИД ресурса keyVault, содержащего активный ключ.
