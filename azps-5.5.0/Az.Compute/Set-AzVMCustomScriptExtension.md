...
### -FileName
Указывает имя файла сценария. Если файл хранится в хранилище BLOB-файлов Azure, в имени файла в этом случае внося важные данные. Имена файлов, хранимых в хранилище файлов Azure, нечувствительны к делу.
...
### -StorageAccountName
Указывает имя учетной записи хранилища Azure, в которой этот cmdlet хранит сценарий.
