...
## ОПИСАНИЕ
Для настройки расширения Windows PowerShell DSC на виртуальной машине в группе ресурсов будет настроено расширение **Set-AzVMDscExtension.**
...
Команда конфигурации "ИмяКонфигуры" и указывает данные конфигурации и аргументы.
Файл Sample.ps1.zip ранее был добавлен с помощью **Publish-AzVMDscConfiguration.**
...
Эта команда также обеспечивает автоматическое обновление обработера расширений до последней версии.
Данные Sample.ps1.zip были ранее добавлены с помощью **Publish-AzVMDscConfiguration.**
...
Указывает имя учетной записи хранилища Azure, используемой для скачивания ArchiveBlobName.
