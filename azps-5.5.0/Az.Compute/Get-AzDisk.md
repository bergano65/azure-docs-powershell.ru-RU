...
## ОПИСАНИЕ
Для управляемого диска свойства управляемого диска получает **cmdlet Get-AzDisk.**
...
Эта команда получает свойства диска "Диск01" в группе ресурсов "Группа ресурсов01".
...
Эта команда получает свойства всех дисков группы ресурсов "Группа ресурсов01".
...
Эта команда получает свойства всех дисков под именем подписки, начиная с win1_OsDisk.
