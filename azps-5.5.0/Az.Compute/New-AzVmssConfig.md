...
Шаблон HealthProbeId имеет форму '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/10/12/{имяФокнамя}".
