...
## ОПИСАНИЕ
С **помощью cmdlet Set-AzVMDiskEncryptionExtension** можно шифровать запущенную инфраструктуру как виртуальную машину (IaaS) в Azure.  Оно включает шифрование, устанавливая расширение шифрования диска на виртуальную машину. 
...
### Пример 5. Включить шифрование с использованием ИД клиента Azure AD, секрета клиента и ключа шифрования диска с помощью ключа шифрования ключа
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
...
### Пример 6. Включить шифрование с помощью ключа шифрования Azure AD, печати эскиза клиента cert и ключа шифрования диска
```
$RGName = "MyResourceGroup"
$VMName = "MyTestVM"
#The KeyVault must have enabledForDiskEncryption property set on it
