...
## ОПИСАНИЕ
С **помощью cmdlet Set-AzVmssDiskEncryptionExtension** можно использовать шифрование в наборе масштаба VM. Этот cmdlet включает шифрование, устанавливая расширение шифрования диска в наборе масштаба VM.
...
Эта команда позволяет шифровать на всех дисках всех ВМ-файлов Windows в наборе масштаба VM.
...
Windows: параметр **VolumeType** при его отобразить должен быть задан в параметре All или OS. Если параметр **VolumeType** опущен, по умолчанию он имеет значение "Все".
