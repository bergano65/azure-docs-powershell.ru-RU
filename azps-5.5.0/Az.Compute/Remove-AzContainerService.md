...
## ОПИСАНИЕ
С **использованием cmdlet Remove-AzContainerService** служба контейнера удаляется из вашей учетной записи Azure.

## ПРИМЕРЫ

### Пример 1. Удаление службы контейнера
```
PS C:\> Remove-AzContainerService -ResourceGroupName "ResourceGroup17" -Name "CSResourceGroup17"
```

Эта команда удаляет службу контейнеров cSResourceGroup17.
...
### -Name
Указывает имя службы контейнеров, которую удаляет этот cmdlet.
...
### -ResourceGroupName
Определяет группу ресурсов службы контейнеров, которую удаляет этот cmdlet.
