...
## ОПИСАНИЕ
**Cmdlet Set-AzImageOsDisk** задает свойства диска операционной системы для изображения объекта.
...
Следующие три команды назначают пути диска оси и два диска данных переменным $osDiskVhdUri, $dataDiskVhdUri 1 и $dataDiskVhdUri 2.
...
### -StorageAccountType
Тип учетной записи хранения диска образа Ос
