...
## ОПИСАНИЕ
**Cmdlet Revoke-AzSnapshotAccess** отзывает доступ к снимку.
...
Отощут доступ к моментального снимку с именем "Моментальный снимок01" в группе ресурсов "Группа ресурсов01"
