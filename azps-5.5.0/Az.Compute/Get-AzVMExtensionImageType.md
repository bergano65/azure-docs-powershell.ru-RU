...
## ОПИСАНИЕ
Для получения расширения Azure возвращается тип расширения **Get-AzVMExtensionImageType.**
...
Этот cmdlet возвращает тип расширения от издателя, указанного для этого параметра.
