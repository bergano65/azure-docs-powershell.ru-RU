...
Эта команда задает конфигурацию автоматической шкалы на основе загрузки кластера Azure HDInsight.
...
### Пример 3. Настройка конфигурации кластера HDInsight на основе другого кластера с настройкой авто шкалы
```powershell
