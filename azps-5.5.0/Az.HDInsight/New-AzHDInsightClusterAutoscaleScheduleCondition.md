...
Эта команда создает условие для автоматической шкалы кластера до 5 рабочих узлов в 09:00 каждый понедельник, среда.
...
### -WorkerNodeCount
Возвращает или задает количество сотрудников календарного плана для условий расписания с автоматическим масштабом.
