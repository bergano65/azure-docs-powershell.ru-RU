...
## ОПИСАНИЕ
Для кластера Azure HDInsightPersistedScriptAction сохраняются действия сценария **Get-AzHDInsistedScriptAction,** которые перечислены в хронологическом порядке, или подробные сведения об указанном действии сохраняемого сценария.

## ПРИМЕРЫ

### Пример 1. Просмотр сохраняемой группы действий сценариев
```
PS C:\>Get-AzHDInsightPersistedScriptAction -ClusterName "your-hadoop-001"
```

Эта команда сохраняется в кластере под названием "ваш-hadoop-001".
...
### -Name
Указывает имя сохраняемого действия сценария.
