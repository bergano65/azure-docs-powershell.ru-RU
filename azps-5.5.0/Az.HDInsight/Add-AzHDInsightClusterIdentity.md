...
Эта команда добавляет сведения о кластере удостоверений в кластер под названием "ваш-hadoop-001", позволяя кластеру получать доступ к Azure Data Lake Store.
