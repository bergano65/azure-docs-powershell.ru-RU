...
## ОПИСАНИЕ
Для **этого можно получить** состояние мониторинга установки в кластере Azure HDInsight. Если мониторинг включен, возвращается также id рабочей области для аналитики журналов.
