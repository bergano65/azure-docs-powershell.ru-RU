...
Создает источник артефакта в группе ContosoResourceGroup с именем ContosoArtifactSource, где ресурс находится в Центральной части США. Свойство SasUri обеспечивает Uri хранилища Azure в контейнере хранилища, где хранятся артефакты.
