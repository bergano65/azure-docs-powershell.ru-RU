...
## SYNOPSIS
Создает новый столбец "Дискеты" Вадима Климова.
...
## ОПИСАНИЕ
Новая **столбец AzCosmosDBCassandraColumn** создает новый столбец Вадима Кузьмина (Егоры).
...
### Microsoft.Azure.Commands.ВацыDB.Models.PSColumn
