...
## ОПИСАНИЕ
Для **удаления SQL-триггера AzCosmosDBSqlTrigger** удаляется Sql Trigger, соответствующий заданным названиям группы ресурсов, AccountName и DatabaseName.
