...
## ОПИСАНИЕ
При этом удаляется база данных Sql " **ВадимБазыБ.AZCosmosDBSqlDatabase,** соответствующая заданной базе данных ResourceGroupName, AccountName и DatabaseName.
