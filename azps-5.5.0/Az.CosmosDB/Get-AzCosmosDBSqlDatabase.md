...
## ОПИСАНИЕ
Cmdlet **Get-AzCosmosDBSqlDatabase** получает список всех существующих SQL-баз данныхDB для заданной базы данных ResourceGroupName, AccountName и получает одну базу данных SqlББ для заданного имени ресурса ResourceGroupName, AccountName, DatabaseName и ContainerName.
