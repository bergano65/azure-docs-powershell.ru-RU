...
## SYNOPSIS
Создание объекта Sql UniqueKey в SqlDb.
...
## ОПИСАНИЕ
Для создания объекта psUniqueKey нового типа создается новый объект **psCosmosDBSqlUniqueKey.**
...
### Microsoft.Azure.Commands.ЯsDB.Models.PSSqlUniqueKey
