...
## SYNOPSIS
Создание объекта типа PSCompositePath. Его можно передать в качестве значения параметра для Set-AzCosmosDBSqlContainer.
...
## ОПИСАНИЕ
Объект, соответствующий Sql API CompositePath.
