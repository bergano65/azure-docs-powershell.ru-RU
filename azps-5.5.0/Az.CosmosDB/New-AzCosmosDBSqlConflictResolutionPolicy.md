...
## SYNOPSIS
Создание объекта типа PSSqlConflictResolutionPolicy. Его можно передать в качестве значения параметра для Set-AzCosmosDBSqlContainer.
...
## ОПИСАНИЕ
Объект, соответствующий полю ConflictResolutionPolicy В Sql API.
