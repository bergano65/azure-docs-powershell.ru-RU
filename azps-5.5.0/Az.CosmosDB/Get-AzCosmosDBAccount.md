...
## ОПИСАНИЕ
С его учетной записью **Get-AzCosmosDBAccount** можно получить список всех существующих учетных записей "Перезапись" для заданной базы ресурсов ResourceGroupName и AccountName.
