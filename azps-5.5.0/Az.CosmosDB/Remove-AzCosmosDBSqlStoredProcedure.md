...
## SYNOPSIS
УдаляетБЕт Sql StoredProcedure.
...
## ОПИСАНИЕ
С  его учетной записью удаляются данные Sql StoredProcedure, соответствующие заданным ресурсам ResourceGroupName, AccountName и DatabaseName.
