...
## ОПИСАНИЕ
Этот Get-AzIotSecurityAnalyticsAggregatedAlert возвращает одну или несколько обобщенных рекомендаций на устройствах концентратора iot. Агрегированная рекомендация имеет тип
