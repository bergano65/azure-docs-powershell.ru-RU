...
## ОПИСАНИЕ
С Remove-AzIotSecuritySolution удаляется определенное решение для защиты iOT-данных. Решение для защиты IoT собирает данные безопасности и события с IOT-устройств и iot-концентратора для предотвращения и обнаружения угроз.
...
Удаление решения безопасности IoT "MySample" с группой ресурсов "MyResourceGroup"
