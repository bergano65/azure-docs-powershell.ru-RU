...
## SYNOPSIS
Возвращает список ресурсов, имеющих адаптивные сетевые закаления, в области действия расширенного ресурса.
...
```
## ОПИСАНИЕ
Адаптивные затенения сети автоматически вычисляются Центром безопасности Azure. Используйте этот cmdlet, чтобы получить список ресурсов адаптивной сетевых заявок в области расширенного ресурса.
