...
## ОПИСАНИЕ
Этот Get-AzDeviceSecurityGroup возвращает группу безопасности устройств, определенное в решении для защиты iot.
...
Получить группу безопасности устройств "MySecurityGroup" в центре IoT с перенастройками Id "/subscriptions/XXXXXXXX-XXXXX-XXXXX-XXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
...
Получить список группы безопасности устройств в центре IoT с новым идом "/subscriptions/XXXXXXXX-XXXXX-XXXXX-XXXX-XXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
