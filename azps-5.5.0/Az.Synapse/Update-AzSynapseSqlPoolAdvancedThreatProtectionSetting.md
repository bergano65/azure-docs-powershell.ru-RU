...
## ОПИСАНИЕ
Для пула Azure Synapse Analytics задаются дополнительные параметры защиты от угроз с SQL **Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting.**
Чтобы включить дополнительные параметры защиты от SQL, в этом SQL должны быть SQL параметры аудита.
...
Эта команда задает дополнительные параметры защиты от угроз для SQL ContosoSqlPool в рабочей области ContosoWorkspace.
