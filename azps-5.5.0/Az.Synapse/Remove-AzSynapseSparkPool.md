...
## ОПИСАНИЕ
**Спарклет Remove-AzSynapseSparkPool** окончательно удаляет пул спаркпарков Azure Synapse Analytics.
...
Эта команда удаляет пул спаркпарков Azure Synapse Analytics.
...
Эта команда удаляет пул спаркпарков Azure Synapse Analytics через канал.
...
Эта команда удаляет пул спаркпарков Azure Synapse Analytics с ИД ресурса.
