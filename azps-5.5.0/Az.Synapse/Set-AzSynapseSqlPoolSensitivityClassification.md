...
## ОПИСАНИЕ
Этот Set-AzSynapseSqlPoolSensitivityClassification задает типы информации и метки конфиденциальности столбцов в SQL пуле.

## ПРИМЕРЫ

### Пример 1. Настройка типа информации и метки конфиденциальности столбца в пуле Azure Synapse SQL.
```powershell
...
### Пример 2. Настройка рекомендуемых типов данных и меток конфиденциальности для столбцов в SQL Azure Synapse.
```powershell
...
### Пример 3. Настройка типа данных и метки конфиденциальности столбца в пуле Azure Synapse SQL с помощью piping.
```powershell
