...
## ОПИСАНИЕ
Cmdlet **Remove-AzSynapseRoleAssignment** окончательно удаляет назначение ролей Azure Synapse Analytics.
...
Эта команда удаляет назначение ролей Azure Synapse Analytics с помощью ИД назначения роли.
