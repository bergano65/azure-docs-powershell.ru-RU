...
## ОПИСАНИЕ
Для параметра аудита рабочей области Azure Synapse Analytics задаются параметры аудита для **cmdlet Get-AzSynapseSqlAuditSetting.**
...
Параметры аудита рабочей области с именем ContosoWorkspace проходят через канал.
