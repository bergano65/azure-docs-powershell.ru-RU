...
## SYNOPSIS
Удаляет типы данных и метки конфиденциальности столбцов в SQL столбцов.
...
## ОПИСАНИЕ
Этот Remove-AzSynapseSqlPoolSensitivityClassification удаляет типы информации и метки конфиденциальности столбцов в SQL пуле.

## ПРИМЕРЫ

### Пример 1. Удаление метки типа данных и конфиденциальности столбца в SQL Azure Synapse.
```powershell
...
### Пример 2. Удаление текущих типов данных и меток конфиденциальности столбцов в пуле Azure Synapse SQL с помощью Piping.
```powershell
...
### Пример 3. Удаление метки типа данных и конфиденциальности столбца в пуле Azure Synapse SQL с помощью Piping.
```powershell
