...
## ОПИСАНИЕ
Cmdlet **Get-AzSynapseActivityRun** получает сведения о запусках в рабочей области для указанного запуска конвейера, который произошел в указанный период времени. Кроме того, вы можете указать фильтры для имени действия и состояния запуска.
...
Эта команда получает сведения обо всех действиях, которые выполняется в конвейере ContosoPipeline с ИД "f288712d-fb08-4cb8-96ef-82d3b9b30621" между "2018-09-01T21:00" и "2018-09-30T21:00".
...
Эта команда получает сведения обо всех действиях, которые выполняется в конвейере ContosoPipeline с ИД "f288712d-fb08-4cb8-96ef-82d3b9b3 0621" между каналами "09.09.2018" и "2018-09-30T21:00".
