...
## ОПИСАНИЕ
Для **запуска триггера Start-AzSynapseTrigger** в рабочей области запускается триггер. Если триггер находится в состоянии "Остановлено", запускается триггер и в конечном итоге запускается канал на основе его определения. Если триггер уже находится в состоянии "Запущено", этот cmdlet не будет действовать.
