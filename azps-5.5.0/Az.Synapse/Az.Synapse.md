...
Возвращает сведения об узле для интеграции со временем запуска.
...
Параметры аудита пула Azure Synapse Analytics SQL.
...
Удаляет время интеграции со временем запуска.
...
Обновляет параметры оценки уязвимости в SQL пула.
