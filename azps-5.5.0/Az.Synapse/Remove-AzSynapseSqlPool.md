...
## ОПИСАНИЕ
Cmdlet **Remove-AzSynapseSqlPool** окончательно удаляет пул аналитики Azure Synapse SQL.
...
Эта команда удаляет пул azure Synapse Analytics SQL.
...
Эта команда удаляет пул Azure Synapse Analytics SQL через канал.
...
Эта команда удаляет пул azure Synapse Analytics SQL с указанным ИД ресурса.
