...
## ОПИСАНИЕ
Для пула Azure Synapse Analytics можно получить расширенные параметры защиты от SQL Synapse Analytics, который можно получить с SQL **Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting.**
...
Эта команда получает расширенные параметры защиты от угроз для SQL contosoSqlPool в рабочей области с именем ContosoWorkspace.
