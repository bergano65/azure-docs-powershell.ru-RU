...
## ОПИСАНИЕ
Для удаления из рабочей области конвейер удаляется из нее степенный **cmdlet Remove-AzSynapsePipeline.**
...
Этот командлет удаляет канал ContosoPipeline из рабочей области ContosoWorkspace.
...
Этот командлет удаляет канал ContosoPipeline из рабочей области ContosoWorkspace через канал.
