...
## ОПИСАНИЕ
Для **этого с** его триггера будут отписаны указанные события внешней службы.
...
Эта команда отпишет триггер ContosoTrigger на указанные события из триггера в именах.
...
Эта команда отпишет триггер ContosoTrigger на указанные события из триггера в канале связи.
