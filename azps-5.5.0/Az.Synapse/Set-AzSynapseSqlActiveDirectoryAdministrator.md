...
## ОПИСАНИЕ
Для рабочей области Azure Synapse Analytics, которая в текущей подписке является администратором **Set-AzSynapseSqlActiveDirectoryAdministrator,** устанавливается администратор Azure Active Directory (Azure AD).
