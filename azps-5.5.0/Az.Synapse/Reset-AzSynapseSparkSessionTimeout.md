...
### ResetByNameParameterSet (по умолчанию)
```
...
## ОПИСАНИЕ
Для сброса времени сеанса спарк-сеанса Synapse Analytics сбрасывается время спарк-сеанса **Remove-AzSynapseSparkSessionTimeout.**
...
Эта команда сбрасывает время истечении времени сеанса спарк-аналитики Synapse с указанным livy ID.
...
Эта команда сбрасывает время сеанса спарк-аналитики Synapse с указанным livy ID через канал.
