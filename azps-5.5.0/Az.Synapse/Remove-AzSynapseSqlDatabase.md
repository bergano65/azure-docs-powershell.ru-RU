...
## SYNOPSIS
Удаляет базу данных Synapse Analytics SQL.
...
## ОПИСАНИЕ
Cmdlet **Remove-AzSynapseSqlPool** окончательно удаляет базу данных Azure Synapse Analytics SQL.
...
Эта команда удаляет базу данных Azure Synapse Analytics SQL.
...
Эта команда удаляет базу данных Azure Synapse Analytics SQL по конвейеру.
...
Эта команда удаляет базу данных Azure Synapse Analytics SQL с указанным ИД ресурса.
...
### -InputObject
SQL ввода базы данных обычно передается по конвейеру.
