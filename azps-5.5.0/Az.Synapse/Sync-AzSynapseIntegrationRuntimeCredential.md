...
## ОПИСАНИЕ
Cmdlet **Sync-AzSynapseIntegrationRuntimeCredential** синхронизирует учетные данные на локальном устройстве с узлами времени интеграции, что не только является одинаковым для всех узлов.
