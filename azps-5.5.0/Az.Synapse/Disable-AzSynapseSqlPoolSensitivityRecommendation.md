...
## ОПИСАНИЕ
Этот Disable-AzSynapseSqlPoolSensitivityRecommendation отключает (отклоняет) рекомендации по конфиденциальности для столбцов в SQL пуле.

## ПРИМЕРЫ

### Пример 1. Отключать рекомендации по конфиденциальности для данного столбца в SQL Azure Synapse.
```powershell
...
### Пример 2. Отключать рекомендации по конфиденциальности для столбцов, которые имеют рекомендации по конфиденциальности в пуле Azure Synapse SQL с помощью Piping.
```powershell
...
### Пример 3. Отключать рекомендации по конфиденциальности для данного столбца в пуле Azure Synapse SQL с помощью Piping.
```powershell
...
### -InputObject
Объект, представляющий классификацию SQL пула.
