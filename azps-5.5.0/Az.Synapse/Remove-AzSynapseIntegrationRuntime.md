...
## ОПИСАНИЕ
Для удаления интегрированного времени запуска удаляется **cmdlet Remove-AzSynapseIntegrationRuntime.**
...
Эта команда удаляет время интеграции с именем test-reserved-ir из рабочей области ContosoWorkspace.
