...
## ОПИСАНИЕ
Чтобы удалить записную книжку из рабочей области, можно использовать **cmdlet Remove-AzSynapseNotebook.**
...
Удалите записную книжку ContosoNotebook из рабочей области ContosoWorkspace.
...
Удалите записную книжку ContosoNotebook из рабочей области ContosoWorkspace через канал.
