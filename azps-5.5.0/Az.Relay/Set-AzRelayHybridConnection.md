...
## ОПИСАНИЕ
Командлет Set-AzRelayHybridConnection обновляет описание гибридного подключения в указанном пространстве имен ретрансляторов.
...
Обновляет указанное гибридное подключение с новым описанием в указанном пространстве имен.
В этом примере свойство UserMetadata обновляется с новым значением.
