...
## ОПИСАНИЕ
Удаляет план обязательств по машинным обучению Azure. Обратите внимание на то, что планы обязательств, которые имеют связи с обязательствами, удалить невозможно. Связи обязательств можно удалить только для целевого ресурса. Например, при удалении веб-службы машинного обучения Azure связь обязательств, которая связывает веб-службу с планом обязательств, также будет удалена.

## ПРИМЕРЫ

### Пример 1. Удаление плана обязательств
```
