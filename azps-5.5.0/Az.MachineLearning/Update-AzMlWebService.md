...
### -Keys
Обновляет один или оба ключа доступа, используемые для проверки подлинности звонков на API службы во время работы.
...
### -Package
Определение пакета графа, который определяет эту веб-службу.
...
### -ServiceUpdates
Набор обновлений, которые нужно применять к веб-службе, предоставленной в качестве экземпляра определения веб-службы.
