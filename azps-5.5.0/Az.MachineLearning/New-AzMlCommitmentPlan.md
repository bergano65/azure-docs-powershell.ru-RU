...
Если в группе ресурсов имеется план обязательств с таким же именем, вызов является операцией обновления, а существующий план обязательств перезаписывается.
...
### -Location
Расположение плана обязательств Azure ML.
