...
### Пример 1. Удаление существующей базы данных "Кузто" PrincipalAssignment по имени
```powershell
...
С этой командой удаляется principalAssignment kustoprincipal1 из базы данных Кузто "mykustodatabase".
