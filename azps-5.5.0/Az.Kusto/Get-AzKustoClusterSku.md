...
### Пример 1. Списки соответствующих skus
```powershell
...
В этой команде перечислены соответствующие skUs.

### Пример 2. Списки соответствующих skus для определенного кластера
```powershell
...
В этой команде перечислены соответствующие skUs для определенного кластера
