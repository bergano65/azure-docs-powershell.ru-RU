...
### Пример 1. Проверка доступности имени кластера principalassignment, которое используется
```powershell
...
Она возвращает, существует ли в кластере testnewkustocluster имя PrincipalAssignment myprincipal.

### Пример 2. Проверка доступности имени кластера principalassignment, которое не используется
```powershell
...
Она возвращает, существует ли в кластере "testnewkustocluster" пункт PrincipalAssignment с именем newprincipal.
...
### -Type
Тип ресурса: Microsoft.Kusto/Clusters/principalAssignments.
