...
С этой команды создается новая база данных "Кузто" с именем "mykustodatabase" в существующем кластере "testnewkustocluster", найденная в группе ресурсов "testrg".
