...
### Пример 1. Все службы Windows IoT по подписке
```powershell
...
Эта команда получает все службы Windows IoT в рамках подписки.

### Пример 2. Получить все службы Windows IoT в группе ресурсов
```powershell
...
Эта команда получает все службы Windows IoT в группе ресурсов.

### Пример 3. Получить службу Windows IoT по имени
```powershell
...
Эта команда получает службу Windows IoT по имени.

### Пример 4. Получить службу Windows IoT по объектам
```powershell
...
Эта команда получает службу Windows IoT по объектам.

### Пример 4. Получить службу Windows IoT по конвейеру
```powershell
...
Эта команда получает службу Windows IoT по конвейеру.
