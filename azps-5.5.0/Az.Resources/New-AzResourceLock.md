...
## ОПИСАНИЕ
Для **этого создается** блокировка ресурса.
...
### Пример 2. Создание блокировки ресурса для базы данных
```
...
Эта команда создает блокировку ресурса для базы данных Azure.
...
### -LockLevel
Уровень блокировки.
В настоящее время допустимые значения: CanNotDelete и ReadOnly.
...
### -ResourceGroupName
Имя группы ресурсов, для которой применяется блокировка, или группы ресурсов, для которой применяется блокировка.
