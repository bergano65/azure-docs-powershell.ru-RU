...
### -IncludeDescendent
Вызывает список возвращаемых назначений политики, включив в него все назначения, связанные с заданной областью, в том числе из областей предшественника и из областей по убытию.
