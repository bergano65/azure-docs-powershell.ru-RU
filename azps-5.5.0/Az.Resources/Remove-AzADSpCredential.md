...
Получает главную службу с ид объекта "7663d3fb-6f86-4352-9e6d-cf9d50d5ee82" и вертет к Remove-AzADSpCredential- и удаляют все учетные данные этого основного обслуживания.
...
### -Force
Перейти к удалите учетные данные без подтверждения.
...
Имя (SPN) директора-службы, с которого удаляются учетные данные.
