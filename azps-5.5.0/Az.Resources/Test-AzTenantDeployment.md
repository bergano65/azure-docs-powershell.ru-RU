...
## ОПИСАНИЕ
Для определения текущей области клиента шаблон развертывания и его значения параметров определяется **cmdlet Test-AzTenantDeployment.**
...
Эта команда проверяет развертывание в текущей области клиента, используя файл шаблона и файл параметров.
...
Эта команда проверяет развертывание в текущей области клиента с использованием в памяти файла шаблона и файла параметров.
