...
Если задан соответствующий пункт, возвращается запрет на назначение, непосредственно назначенное пользователю и группам, участником которых является пользователь (при переходе).
