...
Ресурс Azure — это объект Azure, управляемый пользователем. Ресурс может быть в группе ресурсов, например на сервере базы данных, базе данных, веб-сайте, виртуальной машине или учетной записи хранения.
...
Чтобы добавить развертывание по подписке, укажите расположение и шаблон.
...
Эта команда создает развертывание в текущей области действия подписки с помощью настраиваемого шаблона и файла шаблона на диске с определенным параметром тегов.
