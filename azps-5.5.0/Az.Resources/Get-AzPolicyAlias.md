...
## SYNOPSIS
Get-AzPolicyAlias извлекает и выводит типы ресурсов поставщика Azure, для которые определены псевдонимы и которые соответствуют заданным значениям параметров. Если параметры не заданы, будут выводться все типы ресурсов поставщика, содержащие псевдоним.
...
## ОПИСАНИЕ
Для **получения псевдонимов** политик вы получаете список псевдонимов политики.
...
Заданное значение совпадает, если целевая строка содержит его с учетом значения дела.
...
В этой списке перечислены все типы ресурсов поставщиков, тип которых соответствует типу "виртуальный", включая те, которые не указаны псевдонимами.
...
### -ApiVersion
Указывает версию API поставщика ресурсов. Если он не задан, версия API будет автоматически определена как наиболее последняя из доступных.
