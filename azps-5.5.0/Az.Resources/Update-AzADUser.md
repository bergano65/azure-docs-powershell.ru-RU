...
Отображает имя пользователя с именем основного пользователя foo@domain.com '' на "MyNewDisplayName".
...
Возвращает пользователя с ид объекта '155a5c10-93a9-4941-a0df-96d83ab5ab24' и трубами к Update-AzADUser, чтобы обновить отображаемого имени пользователя на "MyNewDisplayName".
