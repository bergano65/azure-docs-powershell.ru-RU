...
## ОПИСАНИЕ
Удаляет указанный шаблон спецификации. Если указан параметр version **-Version,** будет удалена только указанная версия. Если конкретные версии не предоставляются, шаблон спецификации и все его версии будут удалены. Если флаг **-Force** присутствует, запрос на удаление не выведется.
...
Удаляет версию "1.0" спецификации шаблона "MyTemplateSpec" в группе ресурсов myRG из подид \{ \} подписки.
