...
## ОПИСАНИЕ
Cmdlet **New-AzEventHubGeoDRConfiguration** создает новый псевдоним (конфигурация аварийного восстановления)
...
### -AlternateName
Имя, требуемая, если имя конфигурации DR такое же, как в основном пространстве имен
