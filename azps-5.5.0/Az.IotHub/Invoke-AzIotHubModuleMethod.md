...
## ОПИСАНИЕ
Вызов метода модуля Edge. Дополнительные https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods сведения см. в этой информации.
...
### -Name
Имя метода, вызываемого в этом модуле устройства.
...
### -Payload
Гружа для метода, вызываемого в этом модуле устройства.
...
### -ResponseTimeOut
Количество секунд, в течение первых нескольких секунд после получения результата непосредственного метода.
Значение по умолчанию — 10.
