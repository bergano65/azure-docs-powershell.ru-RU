...
Возвращает стрелки подключения для всех клавиш iothub под названием "myiothub".
...
Возвращает клавиши connectionstrings для ключа mykey для iothub под названием "myiothub".
