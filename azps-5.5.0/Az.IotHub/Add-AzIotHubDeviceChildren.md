...
## ОПИСАНИЕ
Добавьте указанный список не edge-ids устройств с разделиями-запятой как дети указанного edgeного устройства.
...
Добавляйте не edge-устройства в качестве детей на устройство, независимо от того, что устройство с другими краями устройства уже является ребенком другого edge устройства.
