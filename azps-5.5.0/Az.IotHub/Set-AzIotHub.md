...
### Пример 1. Обновление SKU
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName S1 -Units 5
```

Обновление SKU на S1 и единиц до 5 для IotHub с именем "myiothub"

### Пример 2. Обновление свойств eventhub
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -EventHubRetentionTimeInDays 4
```

Обновление времени хранения телеметрии в днях до 4 для IotHub с именем myiothub

## PARAMETERS

### -CloudToDevice
Свойства облачной очереди команд на устройство. 
...
Флаг, который указывает, следует ли включить уведомления для отправки файла. 
...
### -FallbackRoute
Fallback Route для маршрутинга
...
Имя контейнера, в который нужно отправить файлы.
...
Максимальное количество доставки для уведомлений о добавлении файлов.  
...
Время жизни для сообщений в очереди уведомлений о отправке файлов. 
...
### -FileUploadSasUriTtl
Время жизни для URI SAS, сгенерированного для отправки файла. 
...
Строка подключения к хранилищу, в который нужно отправить файлы. 
...
### -Routes
Маршруты, которые нужно добавить для маршрутов
...
### -RoutingProperties
Свойства маршрутинга сообщений во внешние конечные точки 
