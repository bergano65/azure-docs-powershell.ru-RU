...
## ОПИСАНИЕ
Обновляет или заменяет устройство. Дополнительные https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twins сведения см. в этой области.
...
Возвращает обновленный объект module для устройства.
...
Возвращает объект модуля устройства с обновленными нужными свойствами.
...
Возвращает объект модуля устройства с обновленным свойством тегов.
...
Возвращает объект replaced device module .
...
### -Desired
Добавьте или обновйте нужное свойство в модуле.
...
### -Partial
Позволяет обновить теги и нужные свойства модуля лишь частично.
...
### -Tag
Добавьте или обновйте свойство тегов в модуле.
