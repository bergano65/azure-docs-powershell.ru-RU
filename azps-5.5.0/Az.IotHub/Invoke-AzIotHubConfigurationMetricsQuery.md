...
## ОПИСАНИЕ
Оценка целевой настраиваемой или системной метрик, определенной в конфигурации устройства под управлением IoT.
Существуют предопределяемые системные метрики, которые рассчитываются центром Iot и не могут быть настроены.
