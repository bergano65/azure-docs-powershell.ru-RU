...
## ОПИСАНИЕ
Подробное описание обогащения сообщений в Azure IoT Hub см. в https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Обновляет значение обогащения на значение updatedValue для ключа "newKey".
Подробное описание обогащения сообщений в Azure IoT Hub см. в https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Обновляет конечную точку обогащения на "конечная точка1, конечная точка2, конечная точка3" для ключа "newKey".
Подробное описание обогащения сообщений в Azure IoT Hub см. в https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
