...
Создайте модуль на целевом устройстве ioT в концентраторе IoT.
...
Здесь перечислены все или конкретная конфигурация автоматического управления устройствами в режиме IoT.
...
Здесь перечислены все или определенные развертывания IoT Edge.
...
Создание задания для устройств импорта.
...
Обновив неавтные поля регистрации конфигурации.
