...
## ОПИСАНИЕ
Создание нового IotHub.
Вы можете создать IotHub со свойствами по умолчанию или указать входные свойства.
...
Создает новый IotHub под названием "myiothub" SKU "S1", емкость 1 и расположение "northeurope", включаемого в теги.

### Пример 2. Создание нового IotHub с переменной MaxDeliveryCount в очереди CloudToDevice, которая имеет 20
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Создает новый IotHub под названием "myiothub" SKU "S1", мощность 1 и расположение "northeurope" с расширенными входными свойствами, представленными $properties.
...
### -Location
Расположение, в котором необходимо создать концентратор IoT. 
...
### -Tag
Теги экземпляров концентратора IoT. Пакет свойств в парах значений ключа в виде hash table.
