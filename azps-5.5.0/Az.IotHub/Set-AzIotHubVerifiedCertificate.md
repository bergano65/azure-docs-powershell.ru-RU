...
## ОПИСАНИЕ
Проверяет сертификат, загружая сертификат проверки, содержащий код проверки, полученный cmdlet Get-AzIotHubCertificateVerificationCode. Это последний шаг в процессе проверки связи.
