...
### Пример 1. Создание нового участника
```powershell
...
Эта команда создает нового участника группы.
...
### -Consortium
Получает или задает в качестве участника-участника от компании-участника или задает его для него.
...
Задает пароль учетной записи для управления управляемым консорциумом.
...
Возвращает отображаемую имя участника в составе отл.
...
### -ConsortiumRole
Получает роль участника в консорциуме.
...
### -FirewallRule
Получает или устанавливает правила брандмауэра Для создания, см. раздел "ЗАМЕТКИ" для свойств FIREWALLRULE и создание hash table.
...
### -Location
Расположение службы GEO службы-службы.
...
### -Password
Задает базовый пароль для пароля участника группы.
...
### -Protocol
Возвращает или устанавливает протокол протокола-протокола.
...
### -SkuTier
Получает или задает уровень SKU
...
### -Tag
Теги службы, которые являются списком пар ключевых значений, описывают ресурс.
...
Получает или задает емкость узлов.
...
### Microsoft.Azure.PowerShell.Cmdlets.Models.Api20180601Preview.IBlockchainMember
...
FIREWALLRULE <IFirewallRule[]>: получает или устанавливает правила брандмауэра
  - `[EndIPAddress <String>]`. Возвращает или устанавливает конечный IP-адрес диапазона правил брандмауэра.
  - `[RuleName <String>]`: получает или задает имя правил брандмауэра.
  - `[StartIPAddress <String>]`: получает или устанавливает IP-адрес запуска в диапазоне правил брандмауэра.
