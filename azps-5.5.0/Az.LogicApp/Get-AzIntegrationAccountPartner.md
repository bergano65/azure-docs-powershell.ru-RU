...
## ОПИСАНИЕ
Для получения партнеров по учетной записи из группы ресурсов возвращается партнерская учетная запись **Get-AzIntegrationAccountPartner.**
...
### Пример 1. Получить партнера по интеграции с учетной записью
```
...
Эта команда возвращает партнера по интеграции с именем IntegrationAccountPartner22.

### Пример 2. Получить партнеров по интеграции с учетной записью с помощью имени учетной записи интеграции
```
...
Эта команда возвращает партнеров по интеграции с учетной записью IntegrationAccount31.
