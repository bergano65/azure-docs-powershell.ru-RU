...
## ОПИСАНИЕ
Для **работы с помощью cmdlet Get-AzLogicApp** можно выбрать приложение логики.
...
### Пример 1. Получить приложение логики из группы ресурсов
```
...
Эта команда получает приложение логики из группы ресурсов ResourceGroup11.
...
### -Name
Указывает имя приложения логики, которое получает этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, в которой этот cmdlet получает приложение логики.
...
### -Версия
Указывает версию приложения логики.
