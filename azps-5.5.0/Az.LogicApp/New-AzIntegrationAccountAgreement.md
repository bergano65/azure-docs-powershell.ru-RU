...
### -AgreementType
Тип соглашения об учетной записи интеграции. Допустимыми значениями для этого параметра являются:
- X12 
- AS2
- Edifact
...
Значение гостевого удостоверения, установленное соглашением для учетной записи интеграции.
