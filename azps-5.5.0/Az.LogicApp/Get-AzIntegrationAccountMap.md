...
Эта команда получает интеграцию с именем IntegrationAccountMap47 в указанной группе ресурсов.
...
Эта команда получает карты учетной записи интеграции по имени учетной записи интеграции.
