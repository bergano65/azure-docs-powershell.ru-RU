...
## ОПИСАНИЕ
Для получения соглашения об учетной записи **Get-AzIntegrationAccountAgreement** от группы ресурсов Azure требуется соглашение об учетной записи интеграции.
...
### Пример 1. Получить соглашение об интеграции с учетной записью
```
...
Эта команда получает соглашение об интеграции с учетной записью IntegrationAccountAgreement06.

### Пример 2. Соглашения об интеграции с учетной записью по имени группы ресурсов
```
...
Эта команда получает соглашения об интеграции с учетной записью по имени группы ресурсов.

## PARAMETERS

### -AgreementName
Указывает имя соглашения об интеграции с учетной записью.
