...
## ОПИСАНИЕ
Чтобы **удалить сертификат учетной** записи интеграции из группы ресурсов, удалите из нее сертификат учетной записи интеграции.
...
Эта команда удаляет сертификат учетной записи интеграции IntegrationAccount31.
