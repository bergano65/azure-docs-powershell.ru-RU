...
## ОПИСАНИЕ
**Cmdlet Get-AzIntegrationAccountBatchConfiguration** создает новую пакетную конфигурацию в учетной записи интеграции.

## ПРИМЕРЫ

### Пример 1. Создание новой пакетной конфигурации с помощью локального файла
```powershell
...
Создает новую пакетную конфигурацию, используя локальный файл, расположенный по пути к файлу, который содержится в $batchConfigurationFilePath.

### Пример 2. Создание новой пакетной конфигурации с помощью строки JSON
```powershell
...
Создает новую пакетную конфигурацию, используя строку JSON, содержаную в $batchConfigurationContent.

### Пример 3. Создание новой пакетной конфигурации с использованием параметров
```powershell
...
Создает новую пакетную конфигурацию, вручную предоставляя все необходимые параметры.
