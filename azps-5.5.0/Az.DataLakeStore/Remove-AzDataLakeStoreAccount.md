...
## SYNOPSIS
Удаляет учетную запись Data Lake Store навсегда.
...
## ОПИСАНИЕ
При **этом учетная** запись Компании Data Lake Store удаляется окончательно.

## ПРИМЕРЫ

### Пример 1. Удаление учетной записи Data Lake Store
```
PS C:\>Remove-AzDataLakeStoreAccount -Name "ContosoADL"
```

Эта команда удаляет учетную запись ContosoADL из магазина Data Lake Store.
...
### -Name
Указывает имя удаляемой учетной записи.
...
### -ResourceGroupName
Определяет группу ресурсов, которая содержит учетную запись, которую нужно удалить.
