...
## ОПИСАНИЕ
Cmdlet **Add-AzDataLakeStoreTrustedIdProvider** добавляет надежного поставщика удостоверений в указанную учетную запись Data Lake Store.
...
Добавляет поставщика "MyProvider" к учетной записи "ContosoADL" с конечной точкой поставщика https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 "

## PARAMETERS

### -Account
Имя учетной записи Для добавления указанного надежного поставщика удостоверений.
...
### -Name
Имя добавляемого поставщика доверенных удостоверений
...
### -ResourceGroupName
Имя группы ресурсов, для которой нужно добавить учетную запись надежного поставщика удостоверений.
