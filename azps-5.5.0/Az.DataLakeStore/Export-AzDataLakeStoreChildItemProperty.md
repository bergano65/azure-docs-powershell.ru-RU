...
Получите данные об использовании диска и использовании ACL для всех поднаправленных файлов и файлов в папке /a. IncludeFile гарантирует, что файл будет также включен в данные об использовании
...
Получите использование ACL для всех поднаправленных библиотек и файлов в /a. IncludeFile гарантирует, что файл будет также включен в данные об использовании. HideconsistentAcl в этом случае будет показывать acl из /a, а не дети, так как у всех детей то же самое, что и /a. Этот флажок пропускает выход из подпотока, если все это и есть acls, то же самое, что и корневой.
