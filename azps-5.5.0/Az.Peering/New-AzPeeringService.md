...
Создание объекта службы пиринга с поставщиком и расположением пиринга. Используйте в наряду `Get-AzPeeringServiceProvider` с и `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Физическое расположение, отличаее от региона Azure. Использование Get-AzPeeringServiceLocation [-Country <country> ]
...
Использование Get-AzPeeringServiceProvider для списка
...
### -Tag
Теги, которые нужно связать со службой Microsoft InputObject.
