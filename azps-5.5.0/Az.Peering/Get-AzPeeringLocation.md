...
## ОПИСАНИЕ
Позволяет получить средства пиринга, в которых пользователи могут подключаться к ARM.
...
Длинный список местоположений. Все объекты прямого пиринга.
...
Получает расположение пиринга по обмену для Гонолулу. 
...
Получает расположение пиринга exchange для объекта пиринга id 71. 
...
### -DirectPeeringType
Выберите пункты "Edge", "CDN" и "Transit".
