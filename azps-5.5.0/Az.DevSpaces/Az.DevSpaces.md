...
# Модуль Az.DevSpaces
## Описание
Команды для взаимодействия с контроллером Azure DevSpaces.

## Az.DevSpaces Cmdlets
### [Get-AzDevSpacesController](Get-AzDevSpacesController.md)
Получить или перечислить контроллер Azure DevSpaces.
...
Обновив контроллер DevSpaces, добавьте теги. 
