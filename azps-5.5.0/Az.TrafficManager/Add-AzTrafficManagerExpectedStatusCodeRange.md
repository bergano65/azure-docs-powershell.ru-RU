...
## ОПИСАНИЕ
Чтобы добавить диапазон ожидаемых кодов состояния в локальный объект профиля Azure Traffic Manager, можно использовать **cmdlet Add-AzTrafficManagerExpectedStatusCodeRange.**
