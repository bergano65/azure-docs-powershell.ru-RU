...
## ОПИСАНИЕ
Если **параметр RuleName** указан, в кэше **Azure Redis Cache** вы получаете подробные данные о заданном правиле брандмауэра. Если для **этой операции** задано только имя, в кэше Redis доступны все правила брандмауэра.
