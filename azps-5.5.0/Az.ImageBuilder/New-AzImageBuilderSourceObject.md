...
### Пример 1. Создание управляемого источника изображений
```powershell
...
### -Offer
Предложение для изображений из [коллекции Изображений Azure.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
### -Publisher
Изображение Publisher в [коллекции изображений Azure.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
### -SKU
SKU изображений из [коллекции изображений Azure.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
Описание источника изображений из коллекции [изображений Azure.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
В статье описан источник изображений, который является версией изображения из общей коллекции изображений.
...
### -Версия
Версия изображения из [коллекции изображений Azure.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
