...
Эта команда создает окно с обновлением windows.
...
Эта команда создает настраиваемый оболочки.
...
### -FileCustomizer
Отправка файлов на VMs (Linux, Windows).
...
Можно укастить точно один из сценариевUri или inline.
...
Соответствует пакету для перезапуска windows.
...
Соответствует пакете для предварительной версии Windows Update https://github.com/rgl/packer-provisioner-windows-update) (.
