...
### Пример 1. Создание правила брандмауэра PostgreSql server
```powershell
...
Эти cmdlets создают правило брандмауэра PostgreSql server.

### Пример 2. Создание правила брандмауэра PostgreSql с помощью -ClientIPAddress.
```powershell
...
Эти cmdlets создают правило брандмауэра PostgreSql с помощью -ClientIPAddress.

### Пример 3. Создание правила брандмауэра PostgreSql для разрешение всех IPS
```powershell
...
С помощью этих cmdlets можно создать новое правило брандмауэра PostgreSql, разрешив все IP-сообщения.

## PARAMETERS

### -AllowAll
Позволяет использовать все IPS диапазона от 0.0.0.0 до 255.255.255.255.
...
Если он не указан, значение по умолчанию не определено.
Если в этом случае значение AllowAll имеет значение AllowAll_yyyy-MM-dd_HH-mm-ss.
