...
* Учетные данные необходимы, если пользователь администратора для реестра источника отключен.
...
При работе с NoForce все существующие целевые теги не будут работать до начала копирования.
