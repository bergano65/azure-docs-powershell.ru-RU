...
## ОПИСАНИЕ
С New-AzContainerRegistryWebhook создается веб-сайт реестра контейнеров.

## ПРИМЕРЫ

### Пример 1. Создание веб-приложения реестра контейнеров.
```
...
Создайте веб-сайт реестра контейнеров.
...
### -Header
Настраиваемые headers, которые будут добавлены в уведомления веб-службы.
...
### -Location
Расположение Webhook.
Значение по умолчанию для расположения реестра.
...
### -Status
Состояние Webhook, значение по умолчанию включено
