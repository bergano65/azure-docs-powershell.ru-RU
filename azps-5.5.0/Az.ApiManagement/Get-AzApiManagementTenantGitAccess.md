...
## ОПИСАНИЕ
Для клиента конфигурации доступа Git возвращается cmdlet **Get-AzApiManagementTenantGitAccess.**
Ключи не включаются в сведения о результатах. Чтобы получить секрет клиента, используйте **Get-AzApiManagementTenantGitAccessSecret.**
...
Эта команда получает конфигурацию доступа GIT для указанного контекста.
