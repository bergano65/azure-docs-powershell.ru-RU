...
Для **удаления существующего** набора версий API удаляется существующий набор версий API.

## ПРИМЕРЫ

### Пример 1. Удаление набора версий API
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiVersionSet -Context $apimContext -ApiVersionSetId "query-param-set"
```

Эта команда удаляет набор версий API с указанным ApiVersionSetId.
...
### -ResourceId
Arm ResourceId of ApiVersionSet. Этот параметр является required(обязательно).
