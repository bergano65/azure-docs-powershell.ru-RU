...
## ОПИСАНИЕ
Для удаления существующего продукта управления API будет удаляем существующий **cmdlet AzApiManagementProduct.**
...
Если этот параметр не задан и подписки существуют, высылается исключение.
...
### -PassThru
Указывает на то, что этот $True возвращает значение $True, если он успешно, или значение $False в случае сбой.
