...
## ОПИСАНИЕ
Команда-помощник для создания экземпляра PsApiManagementRegion.
...
Создает службу ApiManagement external VpnType в западной части США с дополнительным регионом в центральной части США.

## PARAMETERS

### -Capacity
SKU дополнительного региона для службы управления API Azure.
...
### -VirtualNetwork
Конфигурация виртуальной сети для региона развертывания управления API Azure.
