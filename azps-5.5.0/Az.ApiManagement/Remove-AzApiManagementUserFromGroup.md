...
## ОПИСАНИЕ
Для удаления пользователя из существующей группы будет использовать cmdlet **Remove-AzApiManagementUserFromGroup.**
...
### -GroupId
Определяет ИД группы, из которой нужно удалить пользователя.
...
### -UserId
Определяет ИД пользователя, который нужно удалить из группы.
