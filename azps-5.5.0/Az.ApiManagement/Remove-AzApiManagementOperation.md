...
## ОПИСАНИЕ
Для удаления существующей операции будет отключена операция **Remove-AzApiManagementOperation.**
...
### -ApiRevision
Идентификатор изменения API. Этот параметр является необязательным. Если не указано, операция будет удалена из активной редакции API.
