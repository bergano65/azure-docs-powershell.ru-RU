...
## ОПИСАНИЕ
С **его учетной** записью будет удалена существующая подписка.
...
Эта команда удаляет существующую подписку.
...
### -ResourceId
Arm ResourceId подписки. Этот параметр является required(обязательно).
