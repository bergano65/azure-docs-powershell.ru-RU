...
## ОПИСАНИЕ
Из-за выполнения **cmdlet Remove-AzApiManagementAuthorizationServer** удаляется сервер авторизации управления API Azure.
...
### -ServerId
Определяет ID сервера авторизации, который нужно удалить.
