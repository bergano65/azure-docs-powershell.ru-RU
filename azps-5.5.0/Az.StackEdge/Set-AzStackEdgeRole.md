...
## ОПИСАНИЕ
Для **устройства с Stack Edge роль** IoT обновляется с его набором. Старые установленные акции будут заменены новыми предоставленными в параметре ShareName.
