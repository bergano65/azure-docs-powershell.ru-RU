...
## ОПИСАНИЕ
**Новый-AzOperationalInsightsWindowsPerformanceCounterDataSource** добавляет источник данных счетчика производительности Windows для подключенных компьютеров, на которые работает операционная система Windows.
...
### -UseLegacyCollector
Используйте устаревший или стандартный сборщик.
