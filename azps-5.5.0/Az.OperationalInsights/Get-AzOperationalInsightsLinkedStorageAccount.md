...
## ОПИСАНИЕ
Получить связанную учетную запись хранения, перечислить все связанные учетные записи хранения, если не указан "-DataSourceType"
...
список связанных accoounts хранилища для рабочей области {workspace-name}

## PARAMETERS

### -DataSourceType
Тип источника данных должен быть одним из типов CustomLogs и AzureWatson.
