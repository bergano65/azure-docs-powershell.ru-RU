...
Если состояние "Ожидание утверждения", то поиск не завершен, и результаты будут отданы из архива.
...
После вызова запроса $queryResults.Результаты будут содержать все строки, полученные из запроса.
