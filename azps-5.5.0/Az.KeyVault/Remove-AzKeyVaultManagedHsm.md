...
Если имя группы ресурсов не указано, выполняется поиск управляемой HSM-службы, удаляемой в текущей подписке.
...
### -Name
Имя управляемой службы HSM, которая будет удаляться.
