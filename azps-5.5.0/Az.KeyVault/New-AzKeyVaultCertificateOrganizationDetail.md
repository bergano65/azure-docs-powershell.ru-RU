...
Вторая команда создает объект сведений о организации сертификата, а затем сохраняет его в переменной $OrgDetails сертификата.

## PARAMETERS

### -AdministratorDetails
Указывает администраторов организации сертификатов.
