...
## ОПИСАНИЕ
Для восстановления ранее удаленного сейфа ключа с его можно будет восстановить сжатие **Undo-AzKeyVaultRemoval.** Восстановленный сейф будет активен после восстановления
...
Эта команда восстановит ключевое хранилище MyKeyVault, ранее удаленное из области eastus2 и группы ресурсов MyResourceGroup, в активное и можное состояние. Теги также будут заменяться новыми.
...
### -Location
Определяет удаленный сейф в исходном регионе Azure.
