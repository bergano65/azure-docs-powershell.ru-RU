...
- Используется `Add-AzKeyVaultCertificate` для создания запроса на подпись сертификата и его отправки в орган сертификации. См. https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
- Используйте существующий файл пакета сертификата, например PFX- или P12-файл, содержащий сертификат и закрытый ключ.

## ПРИМЕРЫ

### Пример 1. Импорт сертификата хранилища ключа
```powershell
