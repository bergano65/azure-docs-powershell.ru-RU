...
Вторая команда создает программный пароль в хранилище ключей Contoso. Команда определяет расположение ключа и пароля, которые хранятся в $Password.
...
### -Name
Указывает имя ключа, который нужно добавить в хранилище. Этот проектлет определяет полное доменное имя ключа на основе имени, указанного этим параметром, имени хранилища ключа и текущей среды. Имя должно быть строкой от 1 до 63 символов длины, которая содержит только 0–9, a-z, A-Z и - (символ тире).
