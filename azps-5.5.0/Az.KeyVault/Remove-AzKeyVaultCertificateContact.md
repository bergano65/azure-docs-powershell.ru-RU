...
Эта команда удаляет Комси Полномер как контакт сертификата для хранилища ключей Contoso01.  Если задан passThru, cmdlet возвращает список оставшихся контактов сертификата.
