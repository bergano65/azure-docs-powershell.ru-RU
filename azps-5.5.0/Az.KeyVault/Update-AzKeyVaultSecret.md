...
Если не указано, существующее значение состояния секретного состояния (включено или отключено) не изменяется.
...
Если не указано, существующее значение срока действия секретного секрета не изменяется.
