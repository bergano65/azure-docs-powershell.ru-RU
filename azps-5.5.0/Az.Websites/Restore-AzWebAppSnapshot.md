...
Получает последний снимок веб-приложения ContosoApp с слотом "Промежуточное обновление" в группе ресурсов Default-Web-WestUS. Восстановление моментального снимка в слоте "Восстановление" веб-приложения.
