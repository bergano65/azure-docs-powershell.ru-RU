...
# Модуль Az.Websites
## Описание
ARM (Azure Resource Manager) Web App и App Service Plan.
...
Добавьте правило маршрутки в слот.
...
Открытие удаленного сеанса PowerShell в контейнере Windows, указанном на определенном сайте или в слоте и заданной группе ресурсов
...
Получает Azure Web Apps в указанную группу ресурсов.

### [Get-AzWebAppAccessRestrictionConfig](Get-AzWebAppAccessRestrictionConfig.md)
Получает конфигурацию рестикции Access для Azure Web App.
...
Get-AzWebAppContainerContinuousDeploymentUrl возвращает URL-адрес непрерывного развертывания контейнера

### [Get-AzWebAppPublishingProfile](Get-AzWebAppPublishingProfile.md)
Получает профиль публикации Azure Web App.

### [Get-AzWebAppSlot](Get-AzWebAppSlot.md)
Получает слот Azure Web App.

### [Get-AzWebAppSlotConfigName](Get-AzWebAppSlotConfigName.md)
Получить список имен веб-приложений slot Config

### [Get-AzWebAppSlotPublishingProfile](Get-AzWebAppSlotPublishingProfile.md)
Получает профиль публикации слота Azure Web App.

### [Get-AzWebAppSnapshot](Get-AzWebAppSnapshot.md)
Позволяет получить снимки, доступные в веб-приложении.

### [Get-AzWebAppSSLBinding](Get-AzWebAppSSLBinding.md)
Получает SSL-привязку сертификата Azure Web App.

### [Get-AzWebAppTrafficRouting](Get-AzWebAppTrafficRouting.md)
Получите правило маршрутинга для заданного имени слота.

### [New-AzAppServicePlan](New-AzAppServicePlan.md)
Создает план службы приложений Azure в заданном географическом расположении.

### [New-AzWebApp](New-AzWebApp.md)
Создает Azure Web App.

### [New-AzWebAppAzureStoragePath](New-AzWebAppAzureStoragePath.md)
Создает объект, который представляет собой путь хранилища Azure, который будет установлен в веб-приложении. Он предназначен для использования в качестве параметра (AzureStoragePath) для Set-AzWebApp и Set-AzWebAppSlot

### [New-AzWebAppBackup](New-AzWebAppBackup.md)


### [New-AzWebAppContainerPSSession](New-AzWebAppContainerPSSession.md)
New-AzWebAppContainerPSSession создает удаленный сеанс PowerShell в контейнере Windows, указанном на сайте или в слоте и группе ресурсов

### [New-AzWebAppDatabaseBackupSetting](New-AzWebAppDatabaseBackupSetting.md)


### [New-AzWebAppSlot](New-AzWebAppSlot.md)
Создает слот Azure Web App.
...
Удаляет план службы приложений Azure.

### [Remove-AzWebApp](Remove-AzWebApp.md)
Удаляет Azure Web App.
...
Удаление правила маршрутки из слота.
