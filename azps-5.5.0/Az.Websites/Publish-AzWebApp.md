...
Загружает содержимое app.zip в веб-приложение MyApp, принадлежащее группе ресурсов Default-Web-WestUS.
...
Загружает содержимое javaproject.war в слот промежуточного ресурса веб-приложения ContosoApp, принадлежащего группе ресурсов ContosoRG.
