...
Первая команда начинает копировать BLOB-объект "ContosoPlanning2015" в "ContosoPlanning2015_copy" и выводит объект BLOB-объекта destiantion. Второй канал команд— объект BLOB-объекта destiantion для Get-AzStorageBlobCopyState, который получит состояние копирования BLOB-объектов. 
