...
Эта команда создает учетную запись хранения с включенным пространством имен с иерархической структурой.
...
- Standard_RAGRS. Чтение гео избыточных хранилищ в Access.
