...
## ОПИСАНИЕ
С **его** использованием создается политика доступа для хранилища Azure.

## ПРИМЕРЫ

### Пример 1. Создание политики хранимого доступа в области
```
PS C:\>New-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

Эта команда создает хранимую политику доступа с полными разрешениями на доступ.
...
### -Permission
Определяет разрешения в хранимой политике доступа на доступ к папке или файлам в хранилище.
