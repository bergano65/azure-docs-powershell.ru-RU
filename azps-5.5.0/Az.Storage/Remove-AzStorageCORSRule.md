...
## ОПИСАНИЕ
Для службы хранилища Azure общий доступ к ресурсам в разных источниках удаляется с использованием cmdlet **Remove-AzStorageCORSRule.**
Этот cmdlet удаляет все правила CORS для типа службы хранилища.
Для этого cmdlet могут быть службы хранилища BLOB-файлов, Table, Queue и File.

## ПРИМЕРЫ

### Пример 1. Удаление правил CORS для службы BLOB-lob
```
PS C:\>Remove-AzStorageCORSRule -ServiceType Blob
```

Эта команда удаляет правила CORS для типа службы BLOB-типов.
...
Чтобы получить контекст хранилища, New-AzStorageContext его.
...
### -ServiceType
Указывает тип службы хранилища Azure, для которой этот cmdlet удаляет правила.
