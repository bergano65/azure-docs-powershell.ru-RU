...
## SYNOPSIS
Сохраняет политики доступа для хранилища.
...
## ОПИСАНИЕ
Для share Storage Share Azure сохраняются политики доступа для **cmdlet Get-AzStorageShareStoredAccessPolicy.**
Чтобы получить определенную политику, укажите ее по имени.

## ПРИМЕРЫ

### Пример 1. Получить хранимую политику доступа в обет
```
PS C:\>Get-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy"
```

Эта команда получает хранимую политику доступа с именем GeneralPolicy в ContosoShare.

### Пример 2. Все хранимые политики доступа
```
PS C:\>Get-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare"
```

Эта команда получает все хранимые политики доступа в ContosoShare.
...
### -Политика
Указывает имя хранимой политики доступа, которая получает этот cmdlet.
...
### -ShareName
Указывает имя хранилища, для которого этот cmdlet получает политики.
