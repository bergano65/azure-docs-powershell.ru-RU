...
## ОПИСАНИЕ
Для выполнения политики управления учетной записи хранилища Azure возвращается **cmdlet Get-AzStorageAccountManagementPolicy.**

## ПРИМЕРЫ

### Пример 1. Получите политику управления учетной записью хранения.
```
...
Эта команда получает политику управления учетной записью хранения.
