...
Эта команда создает объект правило ManagementPolicy с объектом группы действий ManagementPolicy, который содержит 4 действия, объект фильтра правила ManagementPolicy, а затем настроит правило на учетную запись хранения.
