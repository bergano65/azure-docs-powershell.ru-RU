...
## ОПИСАНИЕ
**Cmdlet Set-AzStorageContainerStoredAccessPolicy** задает политику доступа для контейнера хранилища Azure.

## ПРИМЕРЫ

### Пример 1. Настройка политики хранимого доступа в контейнере хранилища с полными разрешениями
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Эта команда задает политику доступа с именем Policy06 для контейнера хранилища MyContainer.
...
### -Permission
Определяет разрешения в хранимой политике доступа на доступ к контейнеру хранилища.
