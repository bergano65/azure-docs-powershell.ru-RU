...
Конечная команда получает содержимое текущей папки и передает каждую из них в Where-Object с помощью оператора конвейера.
...
Если указать папку, с его можно будет создать файл с тем же именем, что и у источника.
