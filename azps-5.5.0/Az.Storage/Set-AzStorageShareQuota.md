...
## ОПИСАНИЕ
Для указанной доли заданный объем хранилища, заданный для **cmdlet Set-AzStorageShareQuota.**

## ПРИМЕРЫ

### Пример 1. Настройка емкости хранилища для одной акции
```
PS C:\>Set-AzStorageShareQuota -ShareName "ContosoShare01" -Quota 1024
```

Эта команда задает для хранилища ContosoShare01 объем 1024 ГБ.
...
### -Quota
Квота в гигабайтах (ГБ).
См. ограничение квоты в https://docs.microsoft.com/en-us/azure/azure-subscription-service-limits#azure-files-limits . 
...
### -Share
Задает объект **CloudFileShare,** представляюща долю, для которой этот cmdlets задает квоту.
...
### -ShareName
Имя папки, для которой нужно установить квоту.
