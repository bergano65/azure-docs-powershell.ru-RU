...
## ОПИСАНИЕ
Для получения учетной записи **Get-AzStorageAccount** вы получаете указанную учетную запись хранения или все учетные записи хранения в группе ресурсов или подписке.

## ПРИМЕРЫ

### Пример 1. Получить указанную учетную запись хранения
```
...
### Пример 2. Получить все учетные записи хранения в группе ресурсов
```
PS C:\>Get-AzStorageAccount -ResourceGroupName "RG01"
```

Эта команда получает все учетные записи хранилища в группе ресурсов.

### Пример 3. Получить все учетные записи хранения в подписке
```
...
### Пример 4. Получить учетные записи хранения с состоянием восстановления BLOB-хранилищ
```
...
Эта команда получает учетные записи хранения с состоянием восстановления BLOB-команд и показывает их состояние.
...
Получите BlobRestoreStatus учетной записи хранения.
...
### -Name
Имя учетной записи хранения, которая нужно получить.
...
### -ResourceGroupName
Имя группы ресурсов, которая содержит учетную запись хранения, которую нужно получить.
