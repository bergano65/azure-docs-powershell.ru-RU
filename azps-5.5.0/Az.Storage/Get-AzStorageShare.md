...
### Пример 4. Снимок файла с конкретным именем и моментальный снимок
```
...
Этот командлет возвращает файлы в папки, которые соответствуют префиксу, указанному этим параметром, или не должны совпадать с указанным префиксом.
