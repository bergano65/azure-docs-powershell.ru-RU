...
### -Ошибка
Одна или несколько записей ошибок, которые нужно устранить.  Если параметры не указаны, все ошибки в сеансе будут устранены.
