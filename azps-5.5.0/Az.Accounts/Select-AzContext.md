...
## ОПИСАНИЕ
Выберите подписку, которая будет целевой (или учетной записи или клиента) в azure PowerShell.  После этого cmdlet,future cmdlets will target the selected context.
