...
## ОПИСАНИЕ
Новый Get-AzEnvironment получает конечные точки и метаданные для экземпляра служб Azure.

## ПРИМЕРЫ

### Пример 1. Получение среды AzureCloud
```
...
### Пример 2. Получение среды AzureChinaCloud
```
...
### Пример 3. Получение среды AzureUSGovernment
```
...
### -Name
Указывает имя экземпляра Azure, который нужно получить.
