...
## SYNOPSIS
Создание объекта в памяти для ReplicaSet
...
## ОПИСАНИЕ
Создание в памяти объекта для ReplicaSet

## ПРИМЕРЫ

### Пример 1. Создание репликации для AdDomain
```powershell
...
Create ReplicaSet для AdDomain

## PARAMETERS

### -Location
Виртуальное расположение в сети.
...
### -SubnetId
Имя виртуальной сети, в которую будут развернуты доменные службы.
Id подсеть, в которую будут развернуты доменные службы.
