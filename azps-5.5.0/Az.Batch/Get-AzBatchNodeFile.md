...
### Пример 6. Получить файлы из корневой папки узла вычислений
```
...
### -PoolId
Определяет ИД пула, содержаного узел вычислений, из которого можно получить свойства файлов узла.
