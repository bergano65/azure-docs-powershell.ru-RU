...
Указанная команда выполняется с повышенными разрешениями.
...
Следующие две команды создают **объекты PSCloudTask** с помощью New-Object командлета.
Команды сохраняют задачи в переменных $Task 01 и $Task 02.
Конечная команда добавляет задачи, хранимые в $Task 01 и $Task 02, под заданием, которое имеет задание 0000001.
...
Сведения о том, как выполнить задачу с несколькими экземплярами.
