...
### Пример 1. Подгонять пул к 12 узлам
```
PS C:\>Start-AzBatchPoolResize -Id "ContosoPool06" -TargetDedicatedComputeNodes 12 -BatchContext $Context
```

Эта команда запускает операцию по переупорядованию пула с ИД ContosoPool06.
Целевой аудиторией операции является 12 выделенных вычислительных узлов.
...
Команда определяет период времени ожидания на один час.
