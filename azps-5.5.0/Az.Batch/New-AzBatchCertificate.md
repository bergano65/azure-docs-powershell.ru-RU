...
## ОПИСАНИЕ
**Новый-AzBatchCertificate** добавляет сертификат в указанную учетную запись Пакета Azure.
...
### -Kind
Тип создаемого сертификата. Если он не указан, предполагается, что все сертификаты без пароля являются CER, а все сертификаты с паролем — PFX.
