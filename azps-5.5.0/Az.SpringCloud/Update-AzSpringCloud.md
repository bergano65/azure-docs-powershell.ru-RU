...
### Пример 1. Обновление службы "Весенние облачные службы" по имени.
```powershell
...
Обновление названия службы "Весенние облачные службы".

### Пример 2. Обновление службы "Весенние облачные службы" из трубы.
```powershell
...
Обновим весенние облачные службы по трубе.
...
### -Tag
Теги службы, которые являются списком пар ключевых значений, которые описывают ресурс.
...
### -TraceAppInsightInstrumentationKey
Ключ анализа целевого приложения
...
### -TraceEnabled
Указывает на то, следует ли включить функцию трасситуры.
