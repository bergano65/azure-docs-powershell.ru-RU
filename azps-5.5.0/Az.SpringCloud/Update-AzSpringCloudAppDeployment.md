...
### Пример 1. Обновление названия службы "Весенний облачный развертывание".
```powershell
...
Обновление названия для развертывания в весенних облачных решениях.

### Пример 2. Обновление весенних облачных развертыванию из трубы.
```powershell
...
Обновив весенний облачный развертывание из трубы.
...
### -MemoryInGb
Необходимый размер памяти в ГБ
...
### -SourceArtifactSelector
Селектор артефакта, который будет использоваться для развертывания проектов с несколькими модулями.
Это должен быть относительный путь к целевому модуле или проекту.
