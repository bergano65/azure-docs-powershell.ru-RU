...
Чтобы создать подписку на событие для группы ресурсов, в дополнение к имени подписки на событие и конечной конечной точке укажите имя группы ресурсов.
...
### -ResourceId
Идентификатор ресурса, для которого должна быть создана подписка на событие.
