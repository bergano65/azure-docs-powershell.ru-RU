...
## ОПИСАНИЕ
Для получения состояния доступности конечной точки сети доставки содержимого (CDN) Azure возвращается состояние доступности для **cmdnEndpointNameAvailability.**
