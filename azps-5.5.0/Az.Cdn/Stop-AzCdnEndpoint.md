...
## ОПИСАНИЕ
Для остановки конечной точки сети доставки содержимого (CDN) Azure будет выбрана конечная точка **Stop-AzCdnEndpoint.**
...
### -CdnEndpoint
Определяет объект конечной точки, который останавливает этот cmdlet.
...
### -EndpointName
Указывает имя конечной точки, которая останавливается этим cmdlet.
