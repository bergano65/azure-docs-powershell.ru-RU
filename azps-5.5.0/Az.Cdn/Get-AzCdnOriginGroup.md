...
## ОПИСАНИЕ
Новый Get-AzCdnOriginGroup извлекает группу источников CDN.
...
Эта команда будет получать группу источника в указанной конечной точке.
...
### -ResourceId
ИД ресурса для группы источника
