...
## ОПИСАНИЕ
Set-AzCdnOriginGroup будет обновлять указанную группу источника в пределах указанной конечной точки. 
...
```
Этот cmdlet обно в группе "Источник" свойство "РазномеренныеВПродажахInSeconds" обновляется. 
