...
### -MatchValue
Список возможных значений совпадений.
...
### -MatchVariable
Соответствует переменной условия.
...
### -NegateCondition
В нем описывается, следует ли ото всех результатов этого условия отрицать.
...
### -Selector
Имя области выбора, которая должна быть совме же
...
### -Transform
Преобразуются для применения перед соответствием.
Возможные значения: нижний и верхний регистры
