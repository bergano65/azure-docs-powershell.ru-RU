...
## ОПИСАНИЕ
Новая New-AzCdnOriginGroup будет создаваться в указанной конечной точке. Если это первая группа источника для конечной точки, необходимо также настроить свойство DefaultOriginGroup.
