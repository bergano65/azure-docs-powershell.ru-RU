...
## ОПИСАНИЕ
Для получения источника источник данных сети доставки содержимого (CDN) Azure и его данных конфигурации с его использованием можно получить набор данных **Get-AzCdnOrigin.**
