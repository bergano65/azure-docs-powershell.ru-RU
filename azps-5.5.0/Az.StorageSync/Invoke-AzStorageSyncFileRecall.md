...
## ОПИСАНИЕ
Если на сервере (определенном расположении на зарегистрированном сервере) включено облачное многоуровневое размещение, эту команду можно использовать для отзыва всех многоуровневых файлов на локальный диск. Перед отзывом настоятельно рекомендуется отключить многоуровневый уровень облака на этой конечной точке сервера. Если это не по-прежнему происходит, отзыв может привести к переупополнение других файлов, из-за чего не получается достичь нужной цели для всего содержимого, которое находится на локальном диске.
...
Эта команда рекурсивно отзывает все многоуровневые файлы, расположенные в корневом пути к указанной конечной точке сервера.
