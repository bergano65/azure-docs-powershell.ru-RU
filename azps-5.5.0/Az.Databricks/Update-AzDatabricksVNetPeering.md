...
### Пример 2. Обновление allowForwardedTraffic пиринга vnet по объектам
```powershell
...
[System.Management.Automation.SwitchParameter] Будет ли в удаленной виртуальной сети разрешен и запрещен трафик, переадрекованный из виртуальных м-карт в локальной виртуальной сети.
...
[System.Management.Automation.SwitchParameter] Позволяет ли виртуальным виртуальным мс в локальном виртуальном сетевом пространстве получать доступ к виртуальным пространствам.
