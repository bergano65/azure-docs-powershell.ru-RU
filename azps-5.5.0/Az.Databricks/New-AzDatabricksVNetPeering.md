...
### Пример 1. Создание пиринга vnet для datab ветвей
```powershell
...
Эта команда создает пиринг vnet для datab ветвей.

## PARAMETERS

### -AllowForwardedTraffic
Будет ли разрешен/запрещен трафик, переадверляемый виртуальными сетями в удаленной виртуальной сети.
...
### -AllowGatewayTransit
Если связи шлюза можно использовать в удаленной виртуальной сети для связи с этой виртуальной сетью.
...
Могут ли виртуальные системы получать доступ к виртуальным сетям в удаленном сетевом пространстве.
...
### -DatabdresssAddressSpacePrefix
Список адресных блоков, зарезервированных для этой виртуальной сети, в нотации CIDR.
...
### -DatabvirtualNetworkId
ИД виртуальной сети datab ветвей.
...
### -Name
Имя пиринга vNet рабочей области.
...
### -UseRemoteGateway
Если в этой виртуальной сети можно использовать удаленные шлюзы.
