...
### Пример 1. Обновление имени виртуального рабочего стола Windows
```powershell
...
Эта команда обновляет виртуальный рабочий стол SessionHost Windows в пуле хостов.

## PARAMETERS

### -AllowNewSession
Разрешить новый сеанс.
...
### -AssignedUser
Пользователь, назначенный sessionHost.
