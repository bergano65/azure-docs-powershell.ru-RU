...
### Пример 1. Регистрация группы виртуальных классических приложений Windows
```powershell
...
Эта команда регистрирует группу приложений виртуального рабочего стола Windows в рабочей области.
