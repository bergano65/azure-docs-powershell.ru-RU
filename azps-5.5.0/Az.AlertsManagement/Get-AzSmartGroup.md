...
## ОПИСАНИЕ
**Для получения сведений из смарт-групп в Get-AzSmartGroup** требуется информация из интеллектуальных групп.
...
Получите сведения о смарт-группе по ИД (GUID) или ид ресурса (ARM завершения)
