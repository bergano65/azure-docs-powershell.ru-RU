...
### -ResourceId
Идентификатор ресурса ARM для внутреннего сервера. Если задано значение, это попытается найти сервер по идентификатору. Этот параметр является обязательным.
