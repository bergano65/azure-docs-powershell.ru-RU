...
## NОПИСАНИЕ
Командлет **Get-AzApiManagementProduct** получает список или конкретный продукт.
...
### -ApiId
ApiId API для поиска соответствующих продуктов. Этот параметр является необязательным.
