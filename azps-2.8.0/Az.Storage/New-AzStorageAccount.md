...
### Пример 6: создание учетной записи хранения с помощью Azure Files аутентификация в доменных службах AAD.
```
...
Эта команда создает учетную запись хранения с проверкой подлинности в службе каталогов AAD DS.
