...
## NОПИСАНИЕ
Командлет **New-AzOperationalInsightsWindowsEventDataSource** добавляет источник данных, который собирает журналы событий Windows из подключенных компьютеров, работающих под управлением операционной системы Windows в Azure Operational Insights.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание источника данных системных событий Windows
```
$EventLogNames       = @()
...
### -CollectInformation
Указывает, что оперативная аналитика собирает информационные сообщения.
...
### -CollectWarnings
Указывает, что оперативная аналитика собирает предупреждающие сообщения.
