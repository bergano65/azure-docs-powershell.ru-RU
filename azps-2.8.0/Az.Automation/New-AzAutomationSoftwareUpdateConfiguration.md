...
## NОПИСАНИЕ
Создание конфигурации обновления программного обеспечения, которая запускается по расписанию для обновления списка компьютеров. Компьютеры включают как виртуальные машины Azure, так и компьютеры без AZ.
...
### -AzureQuery
Запрос на динамическую группу Azure.
...
### -NonAzureQuery
Динамическая группа: запрос не Azure.
...
Параметр предварительной задачи.
...
### -RebootOnly
Указывает на то, что в конфигурации обновления программного обеспечения будут перезагружены только компьютеры.
