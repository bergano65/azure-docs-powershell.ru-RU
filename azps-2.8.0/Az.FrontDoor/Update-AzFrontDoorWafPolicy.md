...
## NОПИСАНИЕ
Командлет **Update-AzFrontDoorWafPolicy** обновляет СУЩЕСТВУЮЩУЮ политику WAF. Если входные параметры не предоставлены, будут использоваться старые параметры существующей политики WAF.
