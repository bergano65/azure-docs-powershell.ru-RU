...
## NОПИСАНИЕ
Командлет **Start-AzDataFactoryV2IntegrationRuntime** запускает управляемую выделенную среду выполнения интеграции. Ресурс подготовлен к работе и после операции с состоянием "начато".
...
[Остановить-AzDataFactoryV2IntegrationRuntime]()
