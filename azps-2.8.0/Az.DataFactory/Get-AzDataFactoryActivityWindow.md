...
## NОПИСАНИЕ
Командлет **Get-AzDataFactoryActivityWindow** получает сведения о окнах действий, связанных с фабрикой данных.
...
- Начать
- Ошибкой
- Пропущен этот командлет получает окна действия, которые находятся в состоянии, указанном этим параметром.
...
- Cancel
- timedOut
- Проверка этого командлета получает окна действия, которые находятся в подсостоянии, указанном этим параметром.
...
### Microsoft. Azure. Commands. Factoring. Models. PSActivityWindow

## Пуск

## ДОПОЛНИТЕЛЬНЫЕ ССЫЛКИ

[Командлеты фабрики данных Azure](./Az.DataFactory.md)
