...
## NОПИСАНИЕ
Командлет **Get-AzDataFactoryLinkedService** получает сведения о связанных службах в фабрике данных Azure.
...
Первая команда использует командлет Get-AzDataFactory для получения фабрики данных с именем ContosoFactory, а затем сохраняет ее в переменной $DataFactory.
