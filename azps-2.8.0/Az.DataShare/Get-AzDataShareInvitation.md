...
## NОПИСАНИЕ
Командлет **Get-AzDataShareInvitation** получает сведения о приглашениях, добавленных в общий доступ к данным. Если вы задаете имя приглашения, этот командлет получает сведения о приглашении. Если имя не задано, этот командлет получает сведения обо всех приглашениях в общем доступе.
...
Эти команды предоставляют сведения о приглашении AdsInvitation в общем доступе к данным AdsShare.
...
### -Name (имя)
Имя приглашения на предоставление данных Azure
...
### -ResourceId
Идентификатор ресурса для приглашения на доступ к данным Azure.
