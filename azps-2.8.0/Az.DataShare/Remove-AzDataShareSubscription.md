...
## NОПИСАНИЕ
Командлет **Remove-AzDataShareSubscription** удаляет подписку на общий доступ
...
Эти команды удаляют sharesubscription с именем AdsShareSubscription из учетной записи WikiAds. 
