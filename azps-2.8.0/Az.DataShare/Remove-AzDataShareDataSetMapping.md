...
## NОПИСАНИЕ
Командлет **Remove-AzDataShareDataSetMapping** Удаляет сопоставления наборов данных.
...
Эти команды удаляют набор данных с именем DSM из sharesubscription WikiAds. 
...
### -InputObject
Объект сопоставления наборов данных Azure
