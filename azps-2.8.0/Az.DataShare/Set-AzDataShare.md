...
## NОПИСАНИЕ
Командлет **Set-AzDataShare** обновляет общий доступ к данным, который находится в указанной учетной записи для общего доступа к данным Azure.
...
Эта команда обновляет существующий общий доступ к данным с именем AdsShare
...
### -Описание
Описание общего доступа к данным
...
### -InputObject
Объект общего доступа к данным Azure
...
### -TermsOfUse
Условия использования общего доступа к данным
