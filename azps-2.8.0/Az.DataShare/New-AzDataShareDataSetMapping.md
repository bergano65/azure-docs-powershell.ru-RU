...
## NОПИСАНИЕ
Командлет **New-AzDataShareDataSetMapping** создает сопоставление набора данных между исходными наборами данных и учетной записью хранения приемников в подписке "общий доступ".
...
Эта команда создает сопоставление AdsDataSetMapping с учетной записью хранения AdsStorage для предоставления общего доступа к подписке, AdsShareSubscription в учетной записи общего доступа к данным WikiAdsAccount.
...
### -Container
Имя контейнера учетной записи службы хранилища Azure
...
### -DataSetId
Идентификатор множества данных потребителей
...
### -FileSystem
Имя файловой системы для Azure ADLS Gen2
...
### -Name (имя)
Имя сопоставления для наборов данных Azure
...
ResourceId для учетной записи хранения Azure
