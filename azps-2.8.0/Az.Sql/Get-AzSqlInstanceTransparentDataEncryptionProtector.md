...
## NОПИСАНИЕ
Командлет Get-AzSqlInstanceTransparentDataEncryptionProtector получает предохранитель TDE для указанного управляемого экземпляра SQL.
...
Эта команда получает предохранитель TDE для управляемого экземпляра с именем ContosoManagedInstanceName в группе ресурсов с именем ContosoResourceGroup.
