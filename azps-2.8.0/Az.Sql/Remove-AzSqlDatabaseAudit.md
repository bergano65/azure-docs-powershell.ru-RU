...
## NОПИСАНИЕ
Командлет **Remove-AzSqlDatabaseAudit** удаляет параметры аудита для базы данных SQL Azure.
...
### Пример 1: удаление параметров аудита для базы данных SQL Azure
```
PS C:\>Remove-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

### Пример 2: удаление с помощью конвейера параметры аудита для базы данных SQL Azure
```
