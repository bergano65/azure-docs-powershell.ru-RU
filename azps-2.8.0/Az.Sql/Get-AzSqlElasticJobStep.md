...
## NОПИСАНИЕ
Командлет Get-AzSqlElasticJobStep получает один или несколько шагов задания из задания.

## ИЛЛЮСТРИРУЮТ

### Пример 1 — получение шага задания из задания
```
...
Получает шаг задания из задания
