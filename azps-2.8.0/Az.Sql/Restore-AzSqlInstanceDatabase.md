...
## NОПИСАНИЕ
Командлет **RESTORE-AzSqlInstanceDatabase** восстанавливает базу данных экземпляра из резервной копии с геоизбыточной учетной записью или на момент времени в действующей базе данных.
