...
## NОПИСАНИЕ
Командлет **Add-AzHDInsightScriptAction** добавляет действия сценария к объекту конфигурации HDInsight, созданному с помощью командлета New-AzHDInsightClusterConfig.
