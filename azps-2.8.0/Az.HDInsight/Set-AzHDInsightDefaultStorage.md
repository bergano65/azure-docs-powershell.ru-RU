...
## NОПИСАНИЕ
Командлет **Set-AzHDInsightDefaultStorage** задает параметры учетной записи хранения по умолчанию в объекте конфигурации кластера Azure HDInsight, созданном с помощью командлета New-AzHDInsightClusterConfig.
