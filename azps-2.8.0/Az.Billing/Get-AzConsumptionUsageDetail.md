...
## NОПИСАНИЕ
Командлет **Get-AzConsumptionUsageDetail** получает сведения об использовании подписки. 

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение сведений об использовании с развернутым MeterDetails
```powershell
...
### Пример 2: получение сведений об использовании с диапазоном дат
```powershell
...
### Пример 3: получение подробных сведений об использовании BillingPeriodName с фильтром InstanceName
```powershell
...
### -EndDate
Конечная дата (в формате UTC) использований для фильтрации.
...
### -Expand
Расширьте использование на основе MeterDetails или AdditionalInfo.
...
### -InstanceId
Идентификатор экземпляра используемых фильтров.
...
### -InstanceName
Имя экземпляра используемых фильтров.
...
### -ResourceGroup
Группа ресурсов для фильтрации использований.
...
### -StartDate
Начальная дата (в формате UTC) использований для фильтрации.
...
### Microsoft. Azure. Commands. потребление. Models. PSUsageDetail
