...
## NОПИСАНИЕ
Командлет **Set-AzImageOsDisk** задает свойства диска операционной системы для объекта Image.
...
### System. Nullable "1 [[Microsoft. Azure. Management. COMPUTE. Model. OperatingSystemStateTypes, Microsoft. Azure. Management. COMPUTE, Version = 23.0.0.0, культура =" нейтрально ", PublicKeyToken = 31bf3856ad364e35]]
