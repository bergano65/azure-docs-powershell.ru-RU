...
### -Priority (приоритет)
Приоритет для установленной шкалы виртуальных машин.  Поддерживаются только значения "Regular" и "Low".
...
Имя или идентификатор ресурса группы размещения близкого взаимодействия, используемой с этим набором масштабов.
