...
## NОПИСАНИЕ
Командлет **Add-AzVMSshPublicKey** добавляет открытые ключи, которые можно использовать для подключения к виртуальной машине Linux по защищенной оболочке (SSH).
