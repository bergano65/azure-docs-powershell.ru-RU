...
## NОПИСАНИЕ
Создает объект условия триггера типа.
Этот объект передается команде, которая создает объект действия оповещения
...
### -MetricTrigger
Условие запуска для правила запроса метрики
...
### — Threshold (порог)
Пороговое значение, над которым генерируется оповещение
...
### -ThresholdOperator
Пороговый оператор: GreaterThan, LessThan или Equals
