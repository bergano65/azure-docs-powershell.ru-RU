...
## NОПИСАНИЕ
Обновляет правило оповещения журнала, в этой команде поддерживается только изменение свойства Enabled.
Чтобы обновить другие свойства, ознакомьтесь с командой "Set-AzScheduledQueryRule".
...
### Пример 3: обновление по идентификатору ресурса
```powershell
