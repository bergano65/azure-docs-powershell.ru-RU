...
Изменить политику доступа "mypolicy" в службе подготовки устройств центра Azure IoT с EnrollmentWrite справа.
...
Обновите политику доступа "mypolicy" в службе подготовки устройств центра для Azure IoT с EnrollmentWrite справа с помощью конвейера.
