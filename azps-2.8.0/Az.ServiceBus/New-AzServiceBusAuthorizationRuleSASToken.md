...
## КРАТКИй обзор
Создание правила авторизации tolen для Azure servicebus для пространства имен/очереди/темы. 
...
## NОПИСАНИЕ
Командлет New-AzServiceBusAuthorizationRuleSASToken создает маркер подписи общего доступа (SAS) для Azure Eventhub Namesapce или Azure Eventhub.
