...
### Пример 1 получение ключей API для ресурса Application Insights
```
...
Получение ключей API Application Insights для ресурсов "тест" в группе ресурсов "testGroup".

### Пример 2. получить конкретный ключ API для ресурса Application Insights
```
...
Получить конкретный ключ API Application Insights с идентификатором "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" для ресурса "тест" в группе ресурсов "testGroup".

## ПАРАМЕТРЫ

### -ApiKeyId
Идентификатор ключа API Application Insights.
