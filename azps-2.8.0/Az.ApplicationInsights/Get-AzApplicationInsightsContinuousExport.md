...
### Пример 1. Получение непрерывного экспорта для ресурса Application Insights
```
...
Получение конфигураций непрерывного экспорта данных Application Insights для ресурса с именем "Test" в группе ресурсов "testgroup"

### Пример 2 Получение непрерывного экспорта для ресурса Application Insights
```
...
Получение конфигурации "непрерывное экспорт" для Application Insights с идентификатором экспорта "ZJrfffySPdtG3ESn3iRxVIEFuNY =" для ресурса с именем "Test" в группе ресурсов "testgroup"
...
### -ExportId
Идентификатор непрерывного экспорта Application Insights.
