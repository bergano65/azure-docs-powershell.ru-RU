...
Возвращает VPN-подключение к виртуальной сети для подключения VPN-клиента.
...
Создание политики выбора трафика IPSec.
...
Проверяет, является ли служба частной ссылки видимой для текущего использования.
