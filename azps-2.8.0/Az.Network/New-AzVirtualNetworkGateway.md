...
Создание для этого VirtualNetwork VPN-шлюза. Если GatewayType не является VPN, должно быть значение None (нет). После установки это свойство нельзя изменить на время существования шлюза.
