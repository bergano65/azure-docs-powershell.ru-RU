...
Вторая команда добавляет новый доверенный корневой сертификат в шлюз приложения, который принимает путь корневого сертификата в качестве входных данных.
