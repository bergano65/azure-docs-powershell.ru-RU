...
### Пример 1: получение определенного набор правил для перезаписи
```
...
Вторая команда получает наборы правил перезаписи с именем RuleSet01 из шлюза приложения, который хранится в переменной с именем $AppGW.
