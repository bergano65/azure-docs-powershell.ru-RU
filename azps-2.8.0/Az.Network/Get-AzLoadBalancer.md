...
### Пример 2: перечисление подсистем балансировки нагрузки с помощью фильтрации
```
...
Эта команда получает все подсистемы балансировки нагрузки с именем, которое начинается с "MyLoadBalancer".
