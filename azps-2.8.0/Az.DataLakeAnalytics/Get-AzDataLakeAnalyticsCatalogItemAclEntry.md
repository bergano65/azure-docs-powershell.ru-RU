...
## NОПИСАНИЕ
Командлет **Get-AzDataLakeAnalyticsCatalogItemAclEntry** возвращает список записей (ACE) в списке управления доступом (ACL) для каталога или элемента каталога в Data Lake Analytics.
