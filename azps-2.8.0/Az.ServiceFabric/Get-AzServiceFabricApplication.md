...
## NОПИСАНИЕ
Этот командлет получает сведения о приложении в заданной группе ресурсов и кластере.
...
В этом примере показано получение сведений о ресурсах приложения для приложения "testApp".
...
В этом примере показано получение списка приложений в кластере "testCluster".
