...
## NОПИСАНИЕ
Командлет New-AzMapsAccountKey повторно создает ключ API для учетной записи карт Azure.
...
Повторно создает вторичный ключ API для указанной учетной записи Azure Maps.
