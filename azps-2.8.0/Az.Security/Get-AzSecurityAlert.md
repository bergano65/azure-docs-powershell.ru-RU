...
Возвращает все оповещения системы безопасности, обнаруженные для ресурсов в подписке.
...
Возвращает все оповещения системы безопасности, обнаруженные в ресурсах, которые находятся в группе ресурсов "myService1".
...
Получает особое предупреждение системы безопасности, обнаруженное в ресурсах, которые находятся в группе ресурсов "myService1".
