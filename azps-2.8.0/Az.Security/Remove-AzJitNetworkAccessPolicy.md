...
## NОПИСАНИЕ
Удаление политики сетевого доступа по времени.
После этого пользователь не сможет запросить временное сетевое подключение на виртуальных машинах, настроенных в удаленной политике.
