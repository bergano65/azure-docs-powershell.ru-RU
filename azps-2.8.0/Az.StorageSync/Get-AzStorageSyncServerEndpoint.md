...
## NОПИСАНИЕ
Эта команда перечисляет все конечные точки сервера в заданной группе синхронизации. Также можно использовать для перечисления атрибутов каждой конечной точки сервера.
...
Эта команда получает все конечные точки сервера, содержащиеся в указанной группе синхронизации. Укажите-ServerEndpointName, чтобы вернуть определенную единицу.
