...
### ResourceGroupAndNameParameterSet (по умолчанию)
```
...
## NОПИСАНИЕ
Средство **Remove-AzUserAssignedIdentity** Удаляет указанного пользователя, которому назначено удостоверение.
...
В этом примере командлет удаляет удостоверение **id1** в разделе "Группа ресурсов" **PSRG**.
Задан
...
### -ResourceId
Идентификатор ресурса удостоверения.
