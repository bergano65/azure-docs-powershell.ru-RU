...
---
# <a name="log-in-with-azure-powershell"></a><span data-ttu-id="43adc-103">Вход с помощью Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="43adc-103">Log in with Azure PowerShell</span></span>
...
## <a name="interactive-log-in"></a><span data-ttu-id="43adc-106">Интерактивный вход</span><span class="sxs-lookup"><span data-stu-id="43adc-106">Interactive log in</span></span>
...
## <a name="log-in-with-a-service-principal"></a><span data-ttu-id="43adc-111">Вход с использованием субъекта-службы</span><span class="sxs-lookup"><span data-stu-id="43adc-111">Log in with a service principal</span></span>
...
## <a name="log-in-to-another-cloud"></a><span data-ttu-id="43adc-118">Вход в другое облако</span><span class="sxs-lookup"><span data-stu-id="43adc-118">Log in to another Cloud</span></span>
...
## <a name="learn-more-about-managing-azure-role-based-access"></a><span data-ttu-id="43adc-123">Узнайте больше об управлении доступом на основе ролей Azure</span><span class="sxs-lookup"><span data-stu-id="43adc-123">Learn more about managing Azure role-based access</span></span>
