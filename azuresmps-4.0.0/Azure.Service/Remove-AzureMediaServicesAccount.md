...
## КРАТКИй обзор
Удаляет указанную учетную запись служб мультимедиа Azure.
...
Командлет **Remove-AzureMediaServicesAccount** удаляет учетную запись служб мультимедиа.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Удаление учетной записи служб мультимедиа
```
...
### -Force
Если указан параметр *Force* , удаление не подтверждено.
