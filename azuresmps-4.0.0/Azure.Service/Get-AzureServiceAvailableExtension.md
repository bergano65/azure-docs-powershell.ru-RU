...
## КРАТКИй обзор
Возвращает сведения о доступных расширениях для размещенных служб.
...
## NОПИСАНИЕ
Командлет **Get-AzureServiceAvailableExtension** получает сведения о последних доступных расширениях для размещенных служб.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение доступных расширений
```
...
Эта команда получает все доступные расширения.

### Пример 2: получение расширений в указанном пространстве имен
```
...
Эта команда получает расширения с указанным именем в указанном пространстве имен.

### Пример 3: получение определенной версии расширения
```
...
Эта команда получает сведения о конкретной версии расширения.

## ПАРАМЕТРЫ

### -AllVersions
Указывает на то, что этот командлет получает все версии расширения.
