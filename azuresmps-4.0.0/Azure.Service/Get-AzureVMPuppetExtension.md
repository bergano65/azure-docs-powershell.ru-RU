...
## КРАТКИй обзор
Получает расширение Puppet, примененное на виртуальной машине.
...
## NОПИСАНИЕ
Командлет **Get-AzureVMPuppetExtension** получает расширение Puppet, примененное на виртуальной машине.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение расширения Puppet, примененного на виртуальной машине
```
PS C:\> Get-AzureVMPuppetExtension -VM $VM
```

Эта команда получает расширение Puppet, примененное на виртуальной машине.
