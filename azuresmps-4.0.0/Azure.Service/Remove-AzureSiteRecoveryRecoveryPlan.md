...
## NОПИСАНИЕ
Командлет **Remove-AzureSiteRecoveryRecoveryPlan** удаляет план восстановления сайта из текущего восстановления сайта Azure.
...
Первая команда использует командлет **Get-AzureSiteRecoveryRecoveryPlan** для получения плана восстановления сайта и сохраняет его в переменной $RecoveryPlan.
...
### -ID
Указывает идентификатор удаляемого плана восстановления.
...
### -RecoveryPlan
Указывает план восстановления, который нужно удалить.
