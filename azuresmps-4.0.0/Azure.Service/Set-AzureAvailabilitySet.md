...
## КРАТКИй обзор
Задает имя группы доступности на виртуальной машине Azure.
...
## NОПИСАНИЕ
Командлет **Set-AzureAvailabilitySet** задает имя группы доступности на виртуальной машине Azure после развертывания.

## ИЛЛЮСТРИРУЮТ

### Пример 1: изменение имени группы доступности
```
...
Этот командлет изменяет имя группы доступности для этой виртуальной машины.
Эта команда обновляет виртуальную машину.

## ПАРАМЕТРЫ

### -AvailabilitySetName
Указывает имя группы доступности, в которую входит виртуальная машина.
...
### -VM
Указывает конфигурацию виртуальной машины, которую изменяет этот командлет.
