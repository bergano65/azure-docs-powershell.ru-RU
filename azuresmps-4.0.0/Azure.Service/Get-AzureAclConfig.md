...
## КРАТКИй обзор
Получает объект конфигурации ACL из виртуальной машины Azure.
...
## NОПИСАНИЕ
Командлет **Get-AzureAclConfig** получает объект конфигурации списка управления доступом (ACL) с существующей виртуальной машины Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение объекта конфигурации ACL для конечной точки виртуальной машины
```
...
### -EndpointName
Указывает имя конечной точки, для которой этот командлет получает ACL.
...
### -VM
Указывает объект виртуальной машины, для которого этот командлет получает конфигурацию ACL.
