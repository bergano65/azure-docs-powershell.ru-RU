...
## КРАТКИй обзор
Переносит зарезервированный IP-адрес в стек диспетчера ресурсов Azure.
...
## NОПИСАНИЕ
Командлет **Move-AzureReservedIP** переносит зарезервированный IP-адрес в группу ресурсов в стеке диспетчера ресурсов Azure.
...
### -Abort
Указывает на то, что этот командлет отменяет зарезервированную миграцию IP-адресов.
...
### -Commit
Указывает на то, что этот командлет запускает зарезервированную миграцию IP-адреса.
...
### -Подготовка
Указывает на то, что этот командлет подготавливает зарезервированный IP-адрес для миграции.
...
### -ReservedIPName
Задает зарезервированный IP-адрес, на который переносится этот командлет.
...
### -Проверка
Указывает, что этот командлет проверит зарезервированный IP-адрес для миграции.
