...
online version: ''
schema: 2.0.0
ms.openlocfilehash: ca794633932dd0d2b8c119a602de98da6b78fd4f
ms.sourcegitcommit: 6f0b6059d096600ebff1c8514c35c467d2f482d8
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104717762"
---
# Grant-AzureHDInsightHttpServicesAccess

## SYNOPSIS
Предоставляет доступ HTTP к кластеру.
...
С помощью cmdlet **Grant-AzureHDInsightHttpServicesAccess** http предоставляет http доступ к кластеру Azure HDInsight с помощью ODBC, Ambari, Oozie и веб-служб.
...
### -Credential
Указывает имя пользователя и пароль для доступа по протоколу HTTP.
...
### -Name
Название кластера.
Этот cmdlet предоставляет HTTP доступ к кластеру, указанному этим параметром.
