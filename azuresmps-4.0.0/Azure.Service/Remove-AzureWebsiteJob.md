...
## КРАТКИй обзор
Удаление существующего веб-задания для веб-сайта.
...
### Пример 1: удаление существующего веб-задания для веб-сайта
```
PS C:\> Remove-AzureWebsiteJob -Name MyWebsite -JobName MyWebJob -JobType Continuous
```

Удаление веб-задания с именем MyWebJob для MyWebSite.

## ПАРАМЕТРЫ

### -Force
Указывает на то, что этот командлет удаляет веб-задание без запроса подтверждения.
