...
Командлет **Get-AzureSBNamespace** возвращает пространства имен служб служебной шины, связанные с текущей подпиской.

[!INCLUDE [sb-deprecation.md](../include/sb-deprecation.md)]

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение пространства имен служебной шины
```
PS C:\> Get-AzureSBNamespace
```

В этом примере показано получение пространств имен служб служебной шины, связанных с текущей подпиской.

## ПАРАМЕТРЫ

### -Name (имя)
Указывает имя пространства имен служебной шины для поиска.
