...
## КРАТКИй обзор
Задает свойства диска данных для образа виртуальной машины.
...
## NОПИСАНИЕ
Командлет **Set-AzureVMImageDataDiskConfig** задает свойства диска данных в образе виртуальной машины.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Настройка свойств диска для данных в образе виртуальной машины
```
...
Эта команда задает свойства диска для данных на виртуальной машине и обновляет образ виртуальной машины.

## ПАРАМЕТРЫ

### -DataDiskName
Указывает имя диска данных, который настраивает этот командлет.
