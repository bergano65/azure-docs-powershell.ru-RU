...
## КРАТКИй обзор
Задает расширения ресурсов для виртуальных машин.

## Максимальное

### SetByExtensionName (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет **Set-AzureVMExtension** задает расширения ресурсов для виртуальных машин.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание виртуальной машины с примененными расширениями ресурсов
```
...
Эта команда создает виртуальную машину с примененными расширениями ресурсов.
...
### -PrivateConfigKey
Задает закрытый ключ конфигурации.
...
### -PrivateConfigPath
Указывает частный путь конфигурации.
...
### -PublicConfigKey
Указывает открытый ключ конфигурации.
...
### -PublicConfigPath
Указывает путь к общедоступной конфигурации.
...
Это определяемая пользователем строка, которую можно использовать для ссылки на расширение.
Вы должны указать его, когда расширение добавляется на виртуальную машину в первый раз.
...
### -Удаление
Указывает, что этот командлет удаляет расширение ресурса с виртуальной машины.
