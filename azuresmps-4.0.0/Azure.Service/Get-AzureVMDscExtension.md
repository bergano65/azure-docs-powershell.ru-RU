...
## КРАТКИй обзор
Получает параметры расширения DSC на виртуальной машине.
...
## NОПИСАНИЕ
Командлет **Get-AzureVMDscExtension** получает параметры расширения DSC на виртуальной машине.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение значения расширения DSC на виртуальной машине
```
...
Эта команда получает параметры расширения DSC на виртуальной машине.
