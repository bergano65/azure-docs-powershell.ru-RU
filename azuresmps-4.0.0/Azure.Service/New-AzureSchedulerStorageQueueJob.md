...
## КРАТКИй обзор
Создает задание планировщика с действием хранилища.
...
Командлет **New-AzureSchedulerStorageQueueJob** создает задание планировщика с действием хранилища Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание задания хранилища, которое выполняется один раз
```
...
Эта команда создает задание хранилища планировщика в составе коллекции с именем JobCollection01.
Команда задает учетную запись хранения, имя очереди и маркер SAS.
Задание запускается один раз сразу.

### Пример 2: создание задания хранилища, которое выполняется указанное количество появлений.
```
...
Эта команда создает задание хранилища планировщика в составе коллекции с именем JobCollection01.
Команда задает учетную запись хранения, имя очереди и маркер SAS.
Задание выполняется 20 раз в общее время, дважды каждый час.
...
### -JobName
Указывает имя задания планировщика.
...
### -StorageQueueMessage
Указывает сообщение очереди для задания хранения.
