...
## NОПИСАНИЕ
Командлет **New-AzureVirtualNetworkGateway** создает шлюз виртуальной сети Azure.
...
### -Force
Не подтверждать Создание шлюза виртуальной сети Azure
...
### -VnetId
Указывает идентификатор виртуальной сети.
...
[Изменить размер — AzureVirtualNetworkGateway](./Resize-AzureVirtualNetworkGateway.md)
