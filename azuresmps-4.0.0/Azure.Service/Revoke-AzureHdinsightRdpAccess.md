...
online version: ''
schema: 2.0.0
ms.openlocfilehash: 00805736c616fb808528a95f86f66eceba2f0e30
ms.sourcegitcommit: 6f0b6059d096600ebff1c8514c35c467d2f482d8
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104713469"
---
# Revoke-AzureHDInsightRdpAccess

## SYNOPSIS
Отключает доступ RDP к кластеру HDInsight.
...
С **помощью cmdlet Revoke-AzureHDInsightRdpAccess** можно отключить доступ к кластеру Azure HDInsight.
...
### -Подписка
Указывает подписку.
Этот cmdlet отзывает доступ к протоколу RDP для подписки, указанной этим параметром.
