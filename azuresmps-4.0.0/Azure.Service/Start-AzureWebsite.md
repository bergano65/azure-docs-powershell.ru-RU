...
Командлет **Start-AzureWebsite** запускает указанный веб-сайт, который работает в Azure.
...
### -Name (имя)
Указывает имя веб-сайта, который нужно запустить.
