...
## КРАТКИй обзор
Создание шлюза локальной сети Azure.
...
## NОПИСАНИЕ
Командлет **New-AzureLocalNetworkGateway** создает шлюз локальной сети Azure.
...
### -AddressSpace
Указывает адресное пространство.
...
### -ASN
Задает номер автономной системы (ASN).
...
### -BgpPeeringAddress
Указывает адрес пиринга протокола пограничного шлюза (BGP).
...
[Сброс — AzureLocalNetworkGateway](./Reset-AzureLocalNetworkGateway.md)
