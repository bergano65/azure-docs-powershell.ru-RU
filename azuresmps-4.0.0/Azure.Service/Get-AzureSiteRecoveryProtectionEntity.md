...
## КРАТКИй обзор
Получает защищаемые или защищенные объекты в хранилище сайта для восстановления.
...
## NОПИСАНИЕ
Командлет **Get-AzureSiteRecoveryProtectionEntity** получает защищаемые или защищенные объекты, например виртуальные машины, в текущем хранилище Azure Site Recovery.

## ИЛЛЮСТРИРУЮТ

### Пример 1: отображение защищенной виртуальной машины в контейнере
```
...
Вторая команда получает защищенную виртуальную машину, которая входит в контейнер в $Container, и выводит ее на экран.

## ПАРАМЕТРЫ

### -ID
Указывает идентификатор получаемой сущности защиты.
...
### -Name (имя)
Указывает имя получаемой сущности защиты.
