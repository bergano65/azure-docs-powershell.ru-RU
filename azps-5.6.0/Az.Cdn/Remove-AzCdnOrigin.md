...
## ОПИСАНИЕ
Remove-AzCdnOrigin удалит источник CDN из данной конечной точки. Если источник является единственным в пределах указанной конечной точки, удаление завершится сбой, так как требуется хотя бы один источник. 
