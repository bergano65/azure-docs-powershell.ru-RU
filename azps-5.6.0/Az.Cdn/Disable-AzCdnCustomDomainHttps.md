...
## ОПИСАНИЕ
Cmdlet **Disable-AzCdnCustomDomainHttps** отключает защищенную доставку HTTPS пользовательского домена CDN.
...
Отключать безопасную доставку настраиваемого домена.
