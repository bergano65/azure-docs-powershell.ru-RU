...
## ОПИСАНИЕ
**Cmdlet Get-AzCdnCustomDomain** получает настраиваемый домен сети доставки содержимого (CDN) Azure и связанные с ним параметры.
...
### -CdnEndpoint
Определяет объект конечной точки CDN, к которому является настраиваемый домен.
...
Имя пользовательского домена отличается от имени его хоста.
...
### -ProfileName
Имя профиля, к которому принадлежит настраиваемый домен.
...
### -ResourceGroupName
Имя группы ресурсов, к которой принадлежит настраиваемый домен.
