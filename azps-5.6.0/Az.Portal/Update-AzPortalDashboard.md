...
## SYNOPSIS
Обновляет существующую информационную панель.
...
Обновив теги на панели мониторинга.
Теги представлены как вмещаемые.
...
Обновите теги на панели мониторинга, искомые с помощью Get-AzPortalDashboard.
Это может использоваться для обновления тегов на одной панели мониторинга или нескольких панелях мониторинга.
