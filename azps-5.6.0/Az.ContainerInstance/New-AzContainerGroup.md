...
Эта команда создает группу контейнеров с использованием настраиваемой картинки из настраиваемой реестра изображений контейнера.
...
Эта команда создает группу контейнеров с системой, назначенной удостоверением, используя последнее изображение nginx, и запрашивает общедоступный IP-адрес с открытием порта 8000.
...
Эта команда создает группу контейнеров с системой, назначенной системе и удостоверением пользователя, используя последнее nginx-изображение, и запрашивает общедоступный IP-адрес с открытием порта 8000.
