...
### Пример 1. Создание объекта расширения Для Нее
```powershell
...
Эта команда создает объект расширения Ветвь, который используется для создания или обновления облачной службы.
