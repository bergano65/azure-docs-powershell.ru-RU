...
Эта команда получает RDP-файл для экземпляра роли ContosoFrontEnd IN 0 облачной службы ContosoCS, которая принадлежит к группе ресурсов \_ \_ ContosOrg.
