...
Создайте новый чертеж определения схемы в указанной подписке, используя определенный словарь параметров и групп ресурсов с использованием указанного идентификатора, назначенного `$blueprintObject` пользователю.
...
Создайте чертеж с помощью файла задания. Формат файла задания можно найти в примерах запросов и ответов: https://github.com/Azure/azure-rest-api-specs/tree/master/specification/blueprint/resource-manager/Microsoft.Blueprint/preview/2018-11-01-preview/examples
...
Создайте новый чертеж, определяющий указанную подписку в указанной группе управления, с использованием `$blueprintObject` указанного параметра.
