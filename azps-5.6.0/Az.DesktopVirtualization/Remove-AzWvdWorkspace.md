...
### Пример 1. Удаление рабочей области виртуального рабочего стола Windows по имени
```powershell
PS C:\> Remove-AzWvdWorkspace -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Эта команда удаляет рабочее пространство Виртуального рабочего стола Windows в группе ресурсов.
