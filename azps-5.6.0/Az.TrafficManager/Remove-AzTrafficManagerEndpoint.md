...
Чтобы удалить несколько конечных точек из локального объекта профиля Диспетчера трафика и зафиксировать изменения за одну операцию, используйте Remove-AzTrafficManagerEndpointConfig управления.
