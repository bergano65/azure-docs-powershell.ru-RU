...
## SYNOPSIS
Остановка репликации для перенесенного сервера.
...
### Пример 2. Удаление объекта ввода
```powershell
...
### -ForceRemove
Указывает, требуется ли принудительно удалить репликацию.
...
### -TargetObjectID
Указывает сервер повторяющихся данных, для которого требуется отключить репликацию.
