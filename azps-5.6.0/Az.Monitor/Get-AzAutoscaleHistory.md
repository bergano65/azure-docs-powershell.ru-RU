...
### Пример 1. Все события, связанные с подпиской
```
...
Эта команда возвращает все события, связанные с авто шкалой, связанные с определенным ресурсом, определенным его ИД (по сути, ResourceUri).
