...
Эта команда отключает правило метрических оповещений. Здесь мы перенаправляем выход [get-AzMetricAlertRuleV2](https://docs.microsoft.com/powershell/module/az.monitor/get-azmetricalertrulev2) на [Add-AzMetricAlertRuleV2.](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) 
...
### -Severity
Серьезность правила метрических оповещений
