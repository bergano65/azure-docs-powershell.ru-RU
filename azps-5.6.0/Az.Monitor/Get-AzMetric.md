...
### -DetailedOutput
Указывает на то, что этот cmdlet отображает подробные выходные данные.
...
Дополнительные сведения о поддерживаемых показателях можно найти по https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported
