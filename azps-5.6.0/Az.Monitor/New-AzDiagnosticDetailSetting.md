...
## ОПИСАНИЕ
Создание объекта PSMetricSettings или PSLogSettings. Категории можно получить с помощью `Get-AzDiagnosticSettingCategory` .
...
Создание объекта PSMetricSettings.
...
Создание объекта PSLogSettings.
...
### -RetentionInDays
Дни хранения для политики хранения
