...
## SYNOPSIS
Обновление (полная замена) правила сбора данных.
...
## ОПИСАНИЕ
Для замены существующего правила сбора данных можно использовать **cmdlet Set-AzDataCollectionRule.**
...
Также поддерживается вывод dcr, отреализованного с ConvertTo-Json (пример #2).

## ПРИМЕРЫ

### Пример 1. Обновление правила сбора данных JSON из Rest API
```powershell
...
Эта команда заменяет существующие правила сбора данных для текущей подписки.

### Пример 2. Обновление правила сбора данных, JSON от PSDataCollectionRuleResource
```powershell
PS C:\>Set-AzDataCollectionRule -Location 'East US 2 EUAP'
...
### Пример 3. Обновление правила сбора данных из объекта
```powershell
