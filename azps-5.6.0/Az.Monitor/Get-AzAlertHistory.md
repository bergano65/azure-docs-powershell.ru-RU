...
ms.openlocfilehash: 659ba1cda1e85f69fbdfa857f71b11e55d711ce3
ms.sourcegitcommit: 6f0b6059d096600ebff1c8514c35c467d2f482d8
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104719096"
---
# Get-AzAlertHistory

## SYNOPSIS
Возвращает историю классических правил оповещения.
...
## ОПИСАНИЕ
С **помощью cmdlet get-AzAlertHistory** можно получить историю классических правил оповещения, если они включены, отключены, отключены, устранены и так далее.
...
### Пример 2. Получить историю оповещений для указанного ресурса
```
