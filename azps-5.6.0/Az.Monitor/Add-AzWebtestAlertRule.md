...
## ОПИСАНИЕ
Для **параметра Add-AzWebtestAlertRule** добавляется или обновляется правило оповещения метрики, события или типа webtest.
...
### Пример 1. Добавление правила оповещения веб-тестирование
```
...
Эта команда добавляет или обновляет правило оповещения веб-тестирование.
...
### -FailedLocationCount
Определяет количество сбойных расположений для правил веб-тестирование.
Это аналогично пороговому значению в правилах других типов.
...
### -MetricNamespace
Указывает пространство имен метрики для правила.
...
### -TargetResourceUri
Определяет ИД ресурса веб-части "Вебтест".
...
### -WindowSize
Определяет размер окна времени, заданный правилом для вычисления данных.
