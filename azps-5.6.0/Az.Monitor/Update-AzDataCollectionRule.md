...
## SYNOPSIS
Обновляет свойство тегов правил сбора данных.
...
## ОПИСАНИЕ
Командлет **Update-AzDataCollectionRule** обновляет свойство "Теги" правила сбора данных.
...
### Пример 1. Обновление тегов правил сбора данных
```
...
Эта команда обновляет свойство тегов для заданного правила сбора данных.

### Пример 2. Обновление тегов правил сбора данных
```
...
### Пример 3. Обновление тегов правил сбора данных
```
...
### -RuleId
ИД ресурса правила сбора данных
...
### -Tag
Свойство "Теги" правила сбора данных
