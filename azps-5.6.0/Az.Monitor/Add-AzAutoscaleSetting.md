...
Первые две команды используют [команду New-AzAutoscaleRule,](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscalerule) чтобы создать два правила для $Rule 1 и $Rule 2.
Третья и четвертая команды используют [new-AzAutoscaleProfile](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscaleprofile) для создания профилей автомасштабы $Profile 1 и $Profile 2 с помощью $Rule 1 и $Rule 2.
Конечная команда создает параметр автомасштабы с использованием профилей в $Profile 1 и $Profile 2.
...
### -ResourceGroupName
Имя группы ресурсов для ресурса, связанного с параметром автомасштаби.
