...
Эта команда обновляет базу данных с именем Database01, устанавливая максимальный размер 1 ТБ.
...
Эта команда обновляет базу данных "База данных01" с уровня службы "Общее назначение" на уровень службы "Hyperscale".
...
### -RequestedServiceObjectiveName
Указывает имя цели обслуживания, которая будет назначаться базе данных. Сведения о задачах обслуживания см. в SQL и уровнях производительности службы баз данных [Azure](https://docs.microsoft.com/azure/sql-database/sql-database-dtu-resource-limits-single-databases) Microsoft Developer Network.
