...
## ОПИСАНИЕ
Для этой базы данных с учетом краткого срока политики хранения зарегистрируется политика хранения **Set-AzSqlDatabaseBackupShortTermRetentionPolicy.**
...
Эта команда задает кратковременную политику хранения для базы данных01 (35 дней) путем прокажиния в объекте базы данных.
