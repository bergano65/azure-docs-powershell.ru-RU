...
### Пример 8. Отключать отправку записей аудита для операций поддержки Майкрософт на сервере Azure SQL для хранения BLOB-приложений и включить отправку их для аналитики журналов.
```powershell
...
### Пример 9. Отправка записей аудита для операций поддержки Майкрософт на сервере Azure SQL для хранения BLOB-приложений, центра событий и аналитики журналов.
```powershell
