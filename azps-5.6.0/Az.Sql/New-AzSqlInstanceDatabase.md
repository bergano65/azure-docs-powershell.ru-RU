...
## SYNOPSIS
Создает базу данных azure SQL Управляемый экземпляр.
...
## ОПИСАНИЕ
Для создания базы данных управляемых экземпляров Azure SQL **AzSqlInstanceDatabase.**

## ПРИМЕРЫ

### Пример 1. Создание базы данных в указанном экземпляре
```
...
Эта команда создает базу данных экземпляра Database01 для экземпляра ManagedInstance1.
...
### -Collation
Разлиновка разной разлиновки SQL экземпляра базы данных Azure.
...
### -Name
Имя создаемой базы SQL экземпляра Azure.
...
### -Tag
Теги, которые нужно связать с базой данных экземпляра Azure Sql
