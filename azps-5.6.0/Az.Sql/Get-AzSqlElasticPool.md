...
Эта команда получает эластичный пул с именем "ЭластичныйPool0127" на сервере с именем Server01.

### Пример 3. Получите метрики для пула SQL azure SQL базы данных
```
