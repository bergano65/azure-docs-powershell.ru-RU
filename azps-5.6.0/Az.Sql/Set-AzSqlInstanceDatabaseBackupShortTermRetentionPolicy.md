...
Эта команда задает краткосрочную политику хранения для всех удаленных баз данных с именем DB1 путем прокавки в удаленном объекте базы данных. Имейте в виду, что срок хранения удаленных баз данных можно сократить.
