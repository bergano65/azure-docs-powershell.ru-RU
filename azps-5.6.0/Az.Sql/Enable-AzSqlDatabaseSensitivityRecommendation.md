...
## ОПИСАНИЕ
Этот Enable-AzSqlDatabaseSensitivityRecommendation обеспечивает рекомендации по конфиденциальности для столбцов в базе данных.

## ПРИМЕРЫ

### Пример 1. Рекомендации по конфиденциальности для данного столбца в базе данных Azure SQL.
```powershell
...
### Пример 2. В качестве рекомендации по конфиденциальности для столбца Azure SQL с помощью Piping.
```powershell
...
### -InputObject
Объект, представляющий SQL классификации конфиденциальности базы данных.
