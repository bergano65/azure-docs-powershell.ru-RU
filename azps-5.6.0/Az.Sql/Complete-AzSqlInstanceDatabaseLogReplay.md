...
## ОПИСАНИЕ
**Полный-AzSqlInstanceDatabaseLogReplay** завершит службу воспроизведения журнала в данной базе данных.
...
Эта команда завершит службу воспроизведения журнала для заданной базы данных после восстановления последней резервной копии.
