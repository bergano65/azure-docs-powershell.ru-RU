...
## ОПИСАНИЕ
При наступлении cmdlet **Remove-AzSqlServerActiveDirectoryAdministrator** удаляется администратор Azure Active Directory (Azure AD) для AzureSQL Server в текущей подписке.
...
Эта команда удаляет администратор Azure AD для сервера Server01, связанного с группой ресурсов ResourceGroup01.
...
### -ServerName
Указывает имя учетной записи SQL Server для которой этот cmdlet удаляет администратора.
