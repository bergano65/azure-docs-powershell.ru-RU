...
Возвращает использование экземпляра экземпляра экземпляра Azure SQL Azure.
...
Возвращает использование экземпляра экземпляра экземпляра Azure SQL Azure с помощью объекта пула экземпляров.
...
### -Expand Темы
Флаг, указывающий, следует ли расширить использование этого пула экземпляра с использованием детей.
