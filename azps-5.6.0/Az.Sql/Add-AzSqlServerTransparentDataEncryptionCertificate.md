...
## ОПИСАНИЕ
В Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate добавляется прозрачный сертификат шифрования данных для SQL Server экземпляра.
...
Добавление сертификата TDE на SQL-сервер с использованием имени группы ресурсов и имени SQL Server ресурса
...
Добавление сертификата TDE на серверы с помощью ид ресурса сервера
...
Добавление сертификата TDE на все SQL-серверы в группе ресурсов
...
### -Password
Пароль для прозрачного сертификата шифрования данных
...
### -PrivateBlob
Частный BLOB-проект для прозрачного сертификата шифрования данных
