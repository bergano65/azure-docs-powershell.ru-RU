...
## ОПИСАНИЕ
Для хранения местоположения, сервера или базы данных с функцией **Get-AzSqlDataBaseLongTermRetentionBackup** в течение долгого времени можно получить резервную копию.
...
Эта команда получает все долгосрочные резервные копии хранения для всех баз данных (которые могут быть живы или удалены) в northeurope, группа ресурсов будет настроена только при условии, что сервер находится в прямом эфире.
