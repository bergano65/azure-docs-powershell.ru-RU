...
## ОПИСАНИЕ
Для этой базы данных с недолгой политикой хранения регистрируется политика хранения **Get-AzSqlDatabaseBackupShortTermRetentionPolicy.**
...
Объект базы данных, для которой нужно получить политику.
