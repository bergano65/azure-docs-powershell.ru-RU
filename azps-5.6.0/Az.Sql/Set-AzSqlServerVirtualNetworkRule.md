...
## ОПИСАНИЕ
Эта команда изменяет конфигурацию правила виртуальной сети Azure SQL Server.
Для управления набором виртуальных правил сети на сервере используйте add-AzSqlServerVirtualNetworkRule и Remove-AzSqlServerVirtualNetworkRule.
...
Изменяет существующее правило виртуальной сети с помощью нового id виртуальной сети подсети, который содержит сведения о новой виртуальной сети.
...
Создайте правило брандмауэра, прежде чем в виртуальной сети будет включена конечная точка службы VNET.
...
Имя правила виртуальной сети Azure Sql Server.
...
Виртуальный ИД подсети сети для правила.
