...
Все долгосрочные резервные копии хранения для конкретной базы данных.  Группа ресурсов необязательна. 
...
### -DatabaseName
Имя управляемой базы данных, под которой находятся резервные копии.
...
### -InstanceName
Имя управляемого экземпляра, под которым находятся резервные копии.
