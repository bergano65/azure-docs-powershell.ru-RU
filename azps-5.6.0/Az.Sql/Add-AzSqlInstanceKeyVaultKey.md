...
Эта команда добавляет ключ сейфа с ИД ' в управляемый экземпляр https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ContosoManagedInstanceName в группе ресурсов ContosoResourceGroup. SQL 
