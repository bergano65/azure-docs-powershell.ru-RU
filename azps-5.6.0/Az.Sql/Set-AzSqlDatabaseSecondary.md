...
Этот командлет предназначен как общая команда конфигурации, но в настоящее время ограничена возможностью инициации отбойного управления.
...
### -DatabaseName
Имя дополнительной базы данных Azure SQL Azure.
