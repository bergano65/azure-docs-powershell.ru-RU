...
## ОПИСАНИЕ
При этом из базы данных Azure SQL удаляется SQL **AzSqlDatabase.**
Этот cmdlet также поддерживается службой SQL Server Stretch Database в Azure.

## ПРИМЕРЫ

### Пример 1. Удаление базы данных с сервера Azure SQL
```
PS C:\>Remove-AzSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Эта команда удаляет базу данных с именем Database01 с сервера Server01.

## PARAMETERS

### -DatabaseName
Указывает имя базы данных, которую удаляет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов Azure, которой назначена база данных.
