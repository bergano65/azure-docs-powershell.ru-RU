...
## ОПИСАНИЕ
С **использованием cmdlet Remove-AzSqlInstancePool** удаляется пул экземпляров Azure SQL.
...
### Пример 2. Удаление пула экземпляров по идентификатору ресурса
```powershell
...
### -InputObject
Объект пула экземпляров, который нужно удалить.
