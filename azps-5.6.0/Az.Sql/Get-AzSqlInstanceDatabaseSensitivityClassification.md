...
## ОПИСАНИЕ
Этот Get-AzSqlInstanceDatabaseSensitivityClassification возвращает текущие типы данных и метки конфиденциальности столбцов в базе SQL Azure.

## ПРИМЕРЫ

### Пример 1. Получите текущие типы данных и метки конфиденциальности для базы данных azure SQL экземпляра.
```powershell
...
### Пример 2. Получите текущие типы данных и метки конфиденциальности для базы данных Azure SQL Экземпляра с Piping.
```powershell
...
### Пример 3. Получите текущий тип данных и метку конфиденциальности для определенного столбца базы данных SQL Azure.
```powershell
...
### Пример 4. Получите текущий тип данных и метку конфиденциальности для определенного столбца базы данных azure SQL экземпляра с помощью Piping.
```powershell
