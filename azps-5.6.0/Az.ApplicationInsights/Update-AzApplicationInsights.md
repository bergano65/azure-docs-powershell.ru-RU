...
### Пример 1. Компонент "Обновление статистики приложения"
```powershell
...
Тип сетевого доступа для доступа к анализу приложений.
...
Тип доступа к сети для запроса Application Insights.
Значение должно быть включено или отключено
