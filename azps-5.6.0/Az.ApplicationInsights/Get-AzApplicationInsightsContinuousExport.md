...
### Пример 1. Непрерывный экспорт для ресурса, анализируемго приложением
```
...
Получение статистики приложения для непрерывного экспорта для ресурса с именем "тест" в группе ресурсов "testgroup"

### Пример 2. Непрерывный экспорт для ресурса, анализируемго приложением
```
...
Настройка непрерывного экспорта аналитики приложений с именем "ZJrfffySPdtG3ESn3iRxЯFUNY=" для ресурса с именем "тест" в группе ресурсов "testgroup"
