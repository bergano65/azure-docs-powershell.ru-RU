...
## ОПИСАНИЕ
Для использования с кластером Azure **HDInsightMapReduceJobDefinition** определено новое задание MapReduce.

## ПРИМЕРЫ

### Пример 1. Создание определения задания MapReduce
```
PS C:\># Cluster info
...
Эта команда создает определение задания MapReduce.
...
### -JarFile
Указывает JAR-файл, который будет использовать для задания.
...
### -LibJars
Определяет, является ли lib JARS для задания.
