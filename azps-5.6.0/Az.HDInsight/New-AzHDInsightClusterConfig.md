...
## ОПИСАНИЕ
С **его** использованием создается объект, который не сохраняется, в описании конфигурации кластера Azure HDInsight.
...
### -OozieMetastore
Указывает метасхранилище, в который будут храниться метаданные Oozie.
