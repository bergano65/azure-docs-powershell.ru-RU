...
## ОПИСАНИЕ
С помощью **cmdlet add-AzHDInsightMetastore** можно добавить метасхему "Гоголь" или "Oozie" в объект конфигурации HDInsight, созданный New-AzHDInsightClusterConfig.
