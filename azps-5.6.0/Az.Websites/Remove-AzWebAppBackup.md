...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzWebAppBackup** удаляется указанная резервная копия Azure Web App.
...
Эта команда удаляет резервную копию с ИД "12345" из веб-приложения WebAppStandard, которое принадлежит к группе ресурсов Default-Web-WestUS.
