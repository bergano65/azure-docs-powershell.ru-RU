...
### -UseDisasterRecovery
Используется для восстановления удаленного приложения из единицы, которая работает в автономном режиме.
