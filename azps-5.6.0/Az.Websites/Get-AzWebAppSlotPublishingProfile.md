...
Эта команда получает профиль публикации в формате Ftp для slot Slot001, связанный с web App ContosoWebApp, связанным с группой ресурсов Default-Web-WestUS, и сохраняет его в указанном выходном файле.
