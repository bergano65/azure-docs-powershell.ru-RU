...
## SYNOPSIS
"Удалить среду службы приложений".
...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzAppServiceEnvironment** удаляется среда службы приложений. Перед удалением ASE необходимо удалить любой план обслуживания приложений.

## ПРИМЕРЫ

### Пример 1. Удаление среды службы приложений
```powershell
...
### -InputObject
Объект среды службы приложений
