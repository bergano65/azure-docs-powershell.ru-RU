...
### -DefaultMoveCost
Укажите стандартные затраты на перемещение.
...
Некоторые распространенные примеры полей данных, используемых в качестве именовых ключей раздела, — регионы, почтовые индексы, группы клиентов и другие границы бизнеса.
