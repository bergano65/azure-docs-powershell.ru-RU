...
INPUTOBJECT: <IServerAutoGenerated> исходный сервер, из который нужно восстановить.
  ...
  - `[AdministratorLoginPassword <SecureString>]`: пароль для входа администратора (требуется для создания сервера).
