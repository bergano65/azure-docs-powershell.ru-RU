...
### Пример 1. Восстановление сервера MySql с помощью geoReplica Restore
```powershell
...
Этот cmdlet restores MySql server using GeoReplica Restore.

### Пример 2. Восстановление сервера MySql с помощью восстановления PointInTime
```powershell
...
### -UseGeoRestore
Восстановление с помощью георежима
...
INPUTOBJECT: <IServer> исходный сервер, из который нужно восстановить.
