...
### Пример 1. Обновление базы данных Сервера MySql по имени
```powershell
...
Обновление базы данных по имени ресурса.

### Пример 2. Обновление базы данных MySql с помощью параметра.
```powershell
...
Обновление базы данных по параметрам
