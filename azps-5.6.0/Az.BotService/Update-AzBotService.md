...
### Пример 1. Обновление бота по имени и ресурсу ResourceGroupName
```powershell
...
Обновление бота по имени и ресурсуGroupName

### Пример 2. Обновление бота с помощью InputObject
```powershell
...
Обновление бота с помощью InputObject
...
ИД приложения Application Insights
...
### -Tag
Содержит теги ресурсов, определенные как пары ключей и значений.
...
INPUTOBJECT <IBotServiceIdentity> : Параметр identity
  ...
  - `[ResourceName <String>]`: название бота.
