...
### Пример 1. Публикация службы BotService в Azure
```powershell
PS C:\> Publish-AzBotServiceApp -ResourceGroupName youriBotTest -CodeDir D:\zips\MyEchoBot -Name youriechobottest

```

Публикация botService в Azure по коду

## PARAMETERS

### -CodeDir
Этот параметр определяет путь к ZIP-индексу.
...
### -Name
Этот параметр определяет имя бота.
