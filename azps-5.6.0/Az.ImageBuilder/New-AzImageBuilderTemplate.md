...
Чтобы построить таблицу, см. раздел "ЗАМЕТКИ" для свойств DISTRIBUTE и создание hash table.
...
SOURCE <IImageTemplateSource> : Описание источника изображений виртуальной машины для создания, настройки и распространения.
  - `Type <String>`: тип изображения источника, с который вы хотите начать.
