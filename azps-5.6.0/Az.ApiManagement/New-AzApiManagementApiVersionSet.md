...
## ОПИСАНИЕ
Cmdlet **New-AzApiManagementApiVersionSet** создает сущность набора версий API в контексте управления API Azure.
...
Эта команда создает набор версий API, схему управления версиями `Query` и параметр `api-version` Query.
