...
## ОПИСАНИЕ
Чтобы **получить список или определенный** продукт, можно получить список или конкретный продукт.
...
Эта команда получит все продукты управления API.

### Пример 2. Получить продукт по ИД
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementProduct -Context $apimContext -ProductId "0123456789"
```

Эта команда получит продукт для управления API по ИД.

## PARAMETERS

### -ApiId
ApiId Api для поиска корреляции продуктов. Этот параметр является необязательным.
...
### -ProductId
Определяет идентификатор продукта, который нужно найти.
...
### -Title
Название продукта, который нужно найти.
При этом будет предпринята попытка получить продукт по заголовку.
