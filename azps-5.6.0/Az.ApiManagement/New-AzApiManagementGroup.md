...
### -Type
Тип группы. Настраиваемая группа — это пользовательская группа. В состав system Group входят администратор, разработчики и гости. Создать или обновить группу системы невозможно.  Внешняя группа — это группы от внешнего поставщика удостоверений, например Azure Active Directory. Этот параметр является необязательным и по умолчанию считается настраиваемой группой.
