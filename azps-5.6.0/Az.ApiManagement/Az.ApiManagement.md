...
Подробные сведения о всех изменениях API в API.

### [Get-AzApiManagementApiSchema](Get-AzApiManagementApiSchema.md)
Подробные сведения о схеме API
...
Получает секрет клиента авторизации управления API.
...
Получает сертификаты управления API, настроенные для mutual Authentication с backend в службе.
...
Возвращает всю или определенную конфигурацию имени для существующего шлюза.

### [Get-AzApiManagementGatewayKey](Get-AzApiManagementGatewayKey.md)
Ключи существующего шлюза

### [Get-AzApiManagementGroup](Get-AzApiManagementGroup.md)
Возвращает все или конкретные группы управления API.
...
Возвращает указанную политику области.

### [Get-AzApiManagementProduct](Get-AzApiManagementProduct.md)
Возвращает список или определенный продукт.

### [Get-AzApiManagementSoToken](Get-AzApiManagementSsoToken.md)
Получает ссылку с маркером SSO на развернутый портал управления службой управления API.
...
Получает ключи конфигурации доступа для клиента.

### [Get-AzApiManagementTenantGitAccess](Get-AzApiManagementTenantGitAccess.md)
Получает конфигурацию доступа Git для клиента.
...
### [Get-AzApiManagementUserSoUrl](Get-AzApiManagementUserSsoUrl.md)
Создает URL-адрес SSO для пользователя.

### [Import-AzApiManagementApi](Import-AzApiManagementApi.md)
Импорт API из файла или URL-адреса.
...
Создание выпуска API для изменения его редакции.
...
Создание схемы API в службе ApiManagement
...
Создание нового контракта с учетными данными backend.
...
Создает объект `PsApiManagementServiceFabric`
...
Создает новую диагностику в глобальной области или области Api.
...
Создает конфигурацию hostname для существующего шлюза.
...
Создание экземпляра **PsApiManagementHttpMessageDiagnostic,** который является параметром диагностики http-сообщения

### [New-AzApiManagementIdentityProvider](New-AzApiManagementIdentityProvider.md)
Создает конфигурацию поставщика удостоверений.
...
Создание диагностических параметров для входящих и исходяющих HTTP-сообщений шлюзу.
...
Создать новый контракт с расположением ресурса (используется в шлюзах).
...
Публикует изменения, вносяые в базу данных конфигурации из ветви Git.
...
Удаляет поставщика OpenID Connect.
...
Изменяет сервер авторизации.

### [Set-AzApiManagementBackend](Set-AzApiManagementBackend.md)
Обновляет backend.

### [Set-AzApiManagementCertificate](Set-AzApiManagementCertificate.md)
Изменяет сертификат управления API, настроенный для совместной проверки подлинности.
...
Задает сведения о существующей подписке.

### [Set-AzApiManagementTenantAccess](Set-AzApiManagementTenantAccess.md)
Включает или отключает клиентский доступ.
...
Обновляет определенный выпуск API.
...
Настраивает шлюз управления API.
