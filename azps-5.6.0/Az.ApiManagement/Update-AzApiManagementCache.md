...
### -PassThru
Если задан этот экземпляр, экземпляр Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementCache, представляющий измененный кэш, будет записан для вывода.
