...
## ОПИСАНИЕ
Состояние сети службы управления Api
...
Возвращает состояние подключения для различных ресурсов, от которых зависит служба ApiManagement.

## PARAMETERS

### -ApiManagementObject
Экземпляр PsApiManagement. Этот параметр является required(обязательно).
...
### -Location
Расположение службы управления API.
...
### -ResourceGroupName
Имя группы ресурсов, в которой существует управление API.
