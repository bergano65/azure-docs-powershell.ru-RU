...
## ОПИСАНИЕ
Для текущей подписки удаляется политика WAF, удаляемая из-за нее с ее начертателем **Remove-AzFrontDoorWafPolicy.**
...
Удалите политику WAF, которая $policyName в $resourceGroupName.
...
Удалите все политики WAF в $resourceGroupName.
...
### -ResourceId
ИД ресурса политики WAF, удаляемой
