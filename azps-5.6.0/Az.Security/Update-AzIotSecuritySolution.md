...
## ОПИСАНИЕ
Командлет Update-AzIotSecuritySolution с рабочими днями одно или несколько из следующих свойств в определенном решении для защиты IoT: теги, конфигурация рекомендации, ресурсы, определенные пользователем.
В решении безопасности iOT будут обновлены только указанные свойства.
Решение для защиты IoT собирает данные безопасности и события с устройств iot и iot-концентратора для предотвращения и обнаружения угроз.
...
Обновление решения для безопасности iot "MySample" из группы ресурсов "MyResourceGroup" с помощью конфигурации рекомендации и ресурсов, определенных пользователем
...
### -UserDefinedResource
Ресурсы, определенные пользователем.
