...
## ОПИСАНИЕ
Обеспечивает соответствие требованиям к безопасности подписки на основе текущего соотношения здорового и небезопасного ресурсов в этой подписке.
Соответствие требованиям безопасности вычисляется каждый день, а история считывается.
...
Соответствие требованиям безопасности подписки за последние 14 дней
...
Обеспечение соответствия требованиям к безопасности для подписки в определенную дату
