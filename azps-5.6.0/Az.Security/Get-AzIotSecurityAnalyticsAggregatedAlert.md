...
Имя агрегированных оповещений — это сочетание типа оповещений и дат, разделенных на "/".
...
Получить агрегированное оповещение "IoT_Bruteforce_Fail/2019-02-02" (имя из типа оповещения и его даты) в решении "MySolution" и группе ресурсов "MyResourceGroup"
