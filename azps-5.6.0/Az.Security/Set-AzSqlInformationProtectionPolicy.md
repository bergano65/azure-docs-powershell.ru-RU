...
### -FilePath
Путь к JSON-файлу, содержащего SQL определения политики защиты информации.
...
### -Политика
Определяет определение политики SQL защиты информации. Вы можете указать путь к JSON-файлу или строке, определяемой политикой в формате JSON.
