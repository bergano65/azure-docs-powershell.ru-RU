...
## ОПИСАНИЕ
Для учетной записи Edge на устройстве Edge data Box можно получить контейнер хранилища для учетной записи **Get-AzDataBoxEdgeStorageContainer.** Вы можете указать имя в качестве параметра в cmdlet для получения сведений о конкретном контейнере хранилища. 
