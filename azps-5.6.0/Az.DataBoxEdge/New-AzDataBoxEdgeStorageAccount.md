...
## ОПИСАНИЕ
С **новыми данными AzDataBoxEdgeStorageAccount** создается учетная запись edge Storage на устройстве Edge data Box. На устройстве одну учетную запись edge Storage можно как можно соотнося только с одной учетной записью облачного хранилища.
...
Укайм существующее имя ресурса StorageAccountCredential
