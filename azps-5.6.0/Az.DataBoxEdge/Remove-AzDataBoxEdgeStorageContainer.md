...
## ОПИСАНИЕ
С его учетной записью **на** устройстве Edge удаляется связанный контейнер хранилища для учетной записи Edge. В качестве параметра можно указать имя удаляемого контейнера хранилища.
