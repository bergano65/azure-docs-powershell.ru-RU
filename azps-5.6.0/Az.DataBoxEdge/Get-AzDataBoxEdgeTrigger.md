...
## ОПИСАНИЕ
Триггеры для устройства получает **cmdlet Get-AzDataBoxEdgeTriger.** Вы можете указать имя в качестве параметра в cmdlet для получения сведений об определенных триггерах.
