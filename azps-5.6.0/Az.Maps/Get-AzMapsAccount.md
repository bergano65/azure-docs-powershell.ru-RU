...
## ОПИСАНИЕ
Этот Get-AzMapsAccount получает резервную учетную запись Azure Maps по группе ресурсов и имени либо по коду ресурса. Кроме того, можно получить список всех учетных записей в группе ресурсов или всех учетных записей Azure Maps для текущей подписки.
...
Получает учетную запись MyAccount в группе ресурсов MyResourceGroup, если она существует.
