...
## ОПИСАНИЕ
Создание зарегистрированных ASNs для объектов пиринга.

## ПРИМЕРЫ

### Получить пиринг и создать зарегистрированный asN
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Получите пиринг, который вы хотите добавить зарегистрированный asN. Затем передай его командлету.

### Создание зарегистрированного asn с помощью ресурса пиринга
```powershell
...
### -Asn
AsN, который нужно зарегистрировать
