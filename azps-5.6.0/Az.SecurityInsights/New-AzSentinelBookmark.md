...
## ОПИСАНИЕ
Для создания закладки из указанной рабочей области создается **cmdlet New-AzSentinelBookmark.**
...
В этом примере **закладка** создается в указанной рабочей области, а затем сохраняется в $Bookmark переменной.
