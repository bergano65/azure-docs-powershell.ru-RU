...
В этом примере обновление параметра **AlertRule** для параметра *Disabled* и переименования *disabled-AlertRuleDisplayName.*  Все остальные свойства останутся без сухую.
