...
## ОПИСАНИЕ
**Cmdlet Remove-AzDeploymentManagerServiceUnit** удаляет единицу службы в службе.
...
Эта команда удаляет единицу службы, имя которой, имя службы, имя топологии службы и группа ресурсов соответствуют свойствам "Имя Службы", "НазваниеПолулогии" и "ИмяГруппы Ресурсов" $serviceUnitObject соответственно.
