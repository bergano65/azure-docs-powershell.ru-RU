...
Создает источник артефакта в группе ContosoResourceGroup с именем ContosoArtifactSource, в качестве расположения которого расположен центр США. Свойство SasUri обеспечивает URI SAS хранилища Azure в контейнере хранилища, где хранятся артефакты.
