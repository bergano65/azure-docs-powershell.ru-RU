...
### -MaintenanceWindow
Период времени (UTC), назначенный для обслуживания.
Примеры: "Вс:23:30", чтобы запланировать на воскресенье, 23:30 (UTC).
Чтобы вернуться к стандартной сдавли в режиме "Отключено"
...
### -SKU
Название SKU, например Burstable_B1ms, Standard_D2ds_v4
