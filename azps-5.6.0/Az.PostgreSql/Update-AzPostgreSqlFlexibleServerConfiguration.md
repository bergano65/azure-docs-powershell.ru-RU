...
### Пример 1. Updatae, заданная конфигурация PostgreSql по имени
```powershell
...
Этот cmdlet updates specified PostgreSql configuration by name.

### Пример 1. Updatae, заданная конфигурацией PostgreSql по удостоверению
```powershell
...
Этот cmdlet обновляет конфигурацию PostgreSql по удостоверению.
