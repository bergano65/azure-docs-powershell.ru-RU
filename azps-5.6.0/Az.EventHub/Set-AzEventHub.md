...
### Пример 1
Чтобы обновить Е eventhub со свойствами описания захвата, выполните следующие действия: 
...
Обновляет центр событий \` MyEventHubName, представленный объектом \` \` MyCreatedEventHub, задав свойства \` CaptureDescription.
