...
## ОПИСАНИЕ
Этот Set-AzEventHubAuthorizationRule обновляет указанное правило авторизации в этом центре событий.
...
Обновляет правило авторизации MyAuthRuleName, чтобы предоставить управление правами на центр событий \` \` \` MyEventHubName в области имен \` \` MyNamespaceName. \`
