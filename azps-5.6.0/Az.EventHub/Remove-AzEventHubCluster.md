...
## ОПИСАНИЕ
Этот Remove-AzEventHubCluster удаляет имя выделенного кластера естрогов из данной группы ресурсов.
...
Удаляет кластер Eventhub-Cluster-5557 из RSG-Cluster27651 групп ресурсов
