...
## SYNOPSIS
Обновляет существующего пользовательского поставщика ресурсов.
В настоящее время с помощью исправления можно обновлять только теги.
...
### Пример 1. Добавление тегов к пользовательскому поставщику
```powershell
...
Обновление тегов настраиваемого поставщика.

### Пример 2. Обновление пользовательского поставщика с помощью piping
```powershell
...
Обновление пользовательского поставщика с помощью piping.
