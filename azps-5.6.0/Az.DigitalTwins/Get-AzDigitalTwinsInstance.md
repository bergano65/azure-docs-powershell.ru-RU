...
Получить все DigitalTwinsInstance по умолчанию
...
Получить указанный AzDigitalTwinsInstance от ResourceName

### Пример 3. GetViaIdentity
```powershell
...
Получить указанный AzDigitalTwinsInstance по объекту
...
Получить все DigitalTwinsInstance от ResourceGroupName
