...
## ОПИСАНИЕ
Для Resume-AzPowerBIEmbeddedCapacity-управления возобновляется экземпляр внедренной емкости PowerBI.
...
Эта команда возобновляет приостановленную пропускную способность с именем testcapacity в тестовой группе ресурсов
