...
## ОПИСАНИЕ
С его учетной записью в устройстве Stack Edge создается учетная запись хранилища **New-AzStackEdgeStorageAccount.** На устройстве одну учетную запись edge Storage можно как можно соотнося только с одной учетной записью облачного хранилища.
