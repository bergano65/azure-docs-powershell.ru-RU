...
## ОПИСАНИЕ
С **его учетной** записью удаляется связанная учетная запись хранилищ Edge для устройства Stack Edge. Вы можете указать имя учетной записи edge Storage, которая будет удалена в качестве параметра в cmdlet.
