...
## ОПИСАНИЕ
Для учетной записи Edge на устройстве Stack Edge можно получить контейнер хранилища для учетной записи **Get-AzStackEdgeStorageContainer.** Вы можете указать имя в качестве параметра в cmdlet для получения сведений о конкретном контейнере хранилища. 
...
Предоставление существующего объекта EdgeStorageAccount
