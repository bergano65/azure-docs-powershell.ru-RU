...
## SYNOPSIS
Возвращает идентификаторы и удостоверения, которые назначены пользователям.

## СИНТАКСИС

### SuscriptionParameterSet (по умолчанию)
```
...
## ОПИСАНИЕ
Сущность **Get-AzUserAssignedIdentity** получает существующие удостоверения, которые назначены пользователям.

## ПРИМЕРЫ

### Пример 1
В этом примере для группы ресурсов **PSRG** возвращается назначенное пользователю удостоверение с именем **ID1.**
...
### Пример 2
В этом примере в группе ресурсов PSRG находятся все удостоверения пользователей, которые назначены **пользователям.**
...
### Пример 3
В этом примере с его учетными данными в рамках подписки получаются все удостоверения пользователей, которые назначены пользователям.
