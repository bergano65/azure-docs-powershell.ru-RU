...
### Пример 1. Получите приложение Spring Cloud App Deploymeng по имени.
```powershell
...
Получите по имени развертывание приложения Spring Cloud.

### Пример 2. Перечислить все развертывание в заданное весенним облачным приложением.
```powershell
...
Перечислить все развертывание в заданное весенним облачным приложением.
...
### -Версия
Версия развертыванию, которая будет указана в списке
