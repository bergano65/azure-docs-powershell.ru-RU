...
### Пример 1. Получить приложение Spring Cloud По имени.
```powershell
...
Получите приложение Spring Cloud по имени.

### Пример 2. Перечислить все приложение в заданной весенних облачных службах.
```powershell
...
Перечислить все приложение в заданной весенних облачных службах.
