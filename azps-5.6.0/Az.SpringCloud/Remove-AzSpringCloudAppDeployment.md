...
### Пример 1. Удаление источника "Весенний облачный развертывание" по имени.
```powershell
PS C:\> Remove-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Удалить по имени развертывание в облаке "Весенний".

### Пример 2. Удаление источника "Весенние облачные развертывания" из трубы.
```powershell
