...
## ОПИСАНИЕ
Эта команда выполняет предварительный просмотр данных, предварительный просмотр статистики и выражение для различных потоков данных в сеансе отлагления.
