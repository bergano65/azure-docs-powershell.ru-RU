...
## ОПИСАНИЕ
Эта команда прикрепит ресурс потока данных и его зависимости к конкретному сеансу отлагки, в командной последовательности PowerShell для рабочего процесса отлагки должны быть:
...
Добавьте пакет потоков данных в сеанс отладки "550effe4-93a3-485c-8525-eaf25259efbd" фабрики данных "WikiADF".
Pakcage file contains data flow debug resource, list of dataset debug resouce, list of linked service debug resource, debug setting and session ID. Например:
