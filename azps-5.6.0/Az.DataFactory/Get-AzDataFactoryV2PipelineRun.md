...
Эта команда получает сведения о запуске конвейера с помощью ID "61eb095a-fe23-4591-8a97-fade6c65ca72".
...
### -LastUpdatedBefore
Время, в которое или до начала запуска каналов был обновлен формат ISO8601.
