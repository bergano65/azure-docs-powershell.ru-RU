...
По умолчанию порядок — в порядке возрастания (ASC).
...
- Отменено
- timedOut
- При проверке этого cmdlet получаются окна действий, которые находятся в подстате, указанном этим параметром.
