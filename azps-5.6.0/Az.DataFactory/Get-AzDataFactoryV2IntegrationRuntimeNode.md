...
## ОПИСАНИЕ
**Cmdlet Get-AzDataFactoryV2IntegrationRuntimeNode** получает подробные сведения об узле времени запуска интеграции.
...
Он получает сведения узла Node_1 в режиме самостоятельной интеграции "test-selfhost-ir" в фабрике данных test-df-eu2, включая IP-адрес.
