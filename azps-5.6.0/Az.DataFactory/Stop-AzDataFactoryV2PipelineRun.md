...
## ОПИСАНИЕ
**Cmdlet Stop-AzDataFactoryV2PipelineRun** останавливает запуск конвейера в фабрике данных, заданной с кодом запуска конвейера.
...
Эта команда останавливает работу конвейера с помощью id b9730a13-aa12-4926-a8b3-8e3a974ab0bd на заводском wikiADF.
