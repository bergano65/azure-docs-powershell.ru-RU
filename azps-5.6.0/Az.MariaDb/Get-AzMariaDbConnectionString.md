...
### Пример 1. Получить строку подключения для MariaDB
```powershell
...
Эта команда получает строку подключения MariaDB.

### Пример 2. Получить строку подключения для MariaDB
```powershell
