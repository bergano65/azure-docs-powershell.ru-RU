...
### Пример 1. Список всех конфигураций в соответствии с MariaDB
```powershell
...
Эта команда содержит список всех конфигураций в соответствии с MariaDB.

### Пример 2. Настройка MariaDB
```powershell
...
Эта команда получает конфигурацию MariaDB.
