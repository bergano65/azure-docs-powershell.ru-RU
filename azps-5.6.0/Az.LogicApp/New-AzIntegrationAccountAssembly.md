...
Создает сборку с использованием массива, содержатого в $assemblyContent.
...
Создает сборку с помощью byte-данных, расположенных по URL-адресу "$assemblyUrl". Это рекомендуемый способ создания сборок больших размеров.
