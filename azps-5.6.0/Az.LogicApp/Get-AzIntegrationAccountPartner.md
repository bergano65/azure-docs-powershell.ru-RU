...
## ОПИСАНИЕ
Для получения партнеров по учетной записи из группы ресурсов можно получить партнеров по интеграции с **Get-AzIntegrationAccountPartner.**
...
### Пример 2. Интеграция партнеров учетной записи с использованием имени учетной записи интеграции
```
