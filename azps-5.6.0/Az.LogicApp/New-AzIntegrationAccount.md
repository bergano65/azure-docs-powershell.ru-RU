...
## ОПИСАНИЕ
Для этого создается учетная запись интеграции с **New-AzIntegrationAccount.**
Этот cmdlet возвращает объект, который представляет учетную запись интеграции. Укажите имя, расположение, имя группы ресурсов и имя SKU.
...
### Пример 1. Создание учетной записи интеграции
```
...
Эта команда создает учетную запись интеграции с именем IntegrationAccount31 в указанной группе ресурсов.
