...
## SYNOPSIS
Этот cmdlet запускает развертывание обновления для всех расширений с заданным набором масштаба виртуальной машины до последней доступной версии. 
...
## ОПИСАНИЕ
Запускает развертывание обновления для перемещения всех расширений на этом масштабе виртуальной машины до последней доступной версии.
...
В этом примере набор масштаба VM получает "MyVmssName" и добавляет к этому данной шкале расширение. Конечная команда выполняет процесс обновления расширения. 
