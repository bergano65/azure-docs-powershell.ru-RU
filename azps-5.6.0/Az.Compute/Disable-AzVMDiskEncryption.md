...
Так как *параметр VolumeType* не указан, cmdlet задает значение All.
...
Если этот параметр не задан, этот cmdlet по умолчанию имеет значение AzureDiskEncryption для VMs Windows.
