...
## ОПИСАНИЕ
С **его учетом** можно получить доступ к снимку.
...
Предоставить доступ "Чтение" к моментального снимку "Моментальный снимок01" в группе ресурсов "Группа ресурсов01" в течение 60 секунд.
...
### -DurationInSecond
Определяет длительность доступа в секундах.
