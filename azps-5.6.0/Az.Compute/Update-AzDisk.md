...
## ОПИСАНИЕ
Для **диска обновляется cmdlet Update-AzDisk.**
...
Эти команды также обновляют существующий диск с именем "Диск01" в группе ресурсов "Группа ресурсов01" до размера диска 10 ГБ.
