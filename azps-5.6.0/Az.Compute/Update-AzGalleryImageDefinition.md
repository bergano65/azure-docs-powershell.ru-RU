...
### -EndOfLifeDate
Дата окончания жизненного времени в коллекции "Определение изображения"
...
### -InputObject
Объект определения изображения коллекции PS.
...
### -ResourceId
ИД ресурса для определения изображения
