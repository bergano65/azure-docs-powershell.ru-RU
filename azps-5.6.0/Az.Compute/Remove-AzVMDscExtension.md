...
## ОПИСАНИЕ
При этом из виртуальной машины в группе ресурсов удаляется обработчик расширения DSC **.AzVMDscExtension.**
...
Эта команда удаляет расширение DSC на виртуальной машине с именем VM07.
...
### -Name
Указывает имя расширения DSC, которое удаляет этот cmdlet.
Этот Set-AzVMDscExtension задает это имя Microsoft.Powershell.DSC, которое используется по умолчанию для **remove-AzVMDscExtension.**
...
### -VMName
Указывает имя виртуальной машины, с которой этот cmdlet удаляет расширение DSC.
