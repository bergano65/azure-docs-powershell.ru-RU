...
## ОПИСАНИЕ
При этом экспортируется общее количество звонков API, к которые имеет регулирование Microsoft.Compute.
Журналы можно дополнительно агрегировать с помощью пяти параметров: GroupByOperationName, GroupByThrottlePolicy, GroupByResourceName, GroupByUserAgent или GroupByApplicationId.
Обратите внимание, что этот cmdlet собирает только журналы CRP.

Обзор регулирования API поставщика ресурсов для компьютеров см. в этой https://docs.microsoft.com/azure/azure-resource-manager/resource-manager-request-limits теме. 
...
Эта команда хранит итоговые звонки API Microsoft.Compute между 2018-02-20T17:54:14 и 2018-02-22T17:54:17 в URI SAS, агрегированном по имени операции.
...
Эта команда хранит общее регулирование вызовов API Microsoft.Compute между 2018-02-20T17:54:14 и 2018-02-22T17:54:17 в URI SAS, агрегированном по id appliction.
...
Эта команда хранит общее регулирование звонков API Microsoft.Compute между 2018-02-20T17:54:14 и 2018-02-22T17:54:17 в URI SAS, обобщенном агентом пользователя.
