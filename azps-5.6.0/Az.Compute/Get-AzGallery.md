...
Получить все коллекций в подписке.
...
Получите все коллекции в подписке, которые начинаются с "Галерея".
