...
### -SkuTier
Определяет уровень службы VMSS. Допустимыми значениями для этого параметра являются:
- Стандартный
- Базовая
...
Включить запланированные события "Завершить"
