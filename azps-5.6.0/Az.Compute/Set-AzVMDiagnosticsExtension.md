...
Если учетная запись хранения диагностики находится в другой подписке, а не на виртуальной машине, в этой учетной записи можно отправлять диагностические данные, явно указав ее имя и ключ.
