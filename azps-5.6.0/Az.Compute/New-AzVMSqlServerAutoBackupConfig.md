...
Вторая команда создает объект автоматической резервной копии путем указания контекста хранилища в $StorageContext.
Автоматическое резервное копирование включено, и автоматическое резервное копирование хранится в течение 10 дней.
...
Чтобы создать безопасную строку, используйте ConvertTo-SecureString- и безопасную строку.
...
Если этот параметр указан, автоматическое резервное копирование создает расписание резервного копирования для всех текущих и новых баз данных.
...
По умолчанию это учетная запись хранения, связанная с виртуальной SQL Server компьютера.
