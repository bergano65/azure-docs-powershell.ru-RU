...
Получите определение изображения коллекции.
...
Получите определение изображения коллекции, которое начинается с "изображение".
...
Вы можете получить определения изображений из коллекции в коллекции 1.
...
### -ResourceId
ИД ресурса для определения изображения коллекции
