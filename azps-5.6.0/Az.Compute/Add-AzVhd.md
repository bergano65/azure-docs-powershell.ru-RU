...
Если базовый виртуальный жесткий диск уже загружен, вы можете добавить разные диски, в качестве родительского на которые используется базовое изображение.
