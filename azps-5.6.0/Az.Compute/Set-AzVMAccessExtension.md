...
Если в VM-компьютере ввести другое имя, расширение VMAccess добавит учетную запись локального администратора с этим именем и назначит ее указанному парольу. Если на вашем компьютере есть учетная запись локального администратора, пароль будет сброшен, а если учетная запись отключена, то расширение VMAccess включит его.
