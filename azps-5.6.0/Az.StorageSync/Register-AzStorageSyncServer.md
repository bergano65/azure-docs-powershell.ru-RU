...
Команду необходимо выполнить локально на сервере, который нужно зарегистрировать, — непосредственно или в удаленном сеансе PowerShell. Нельзя принять объект удаленного компьютера.
