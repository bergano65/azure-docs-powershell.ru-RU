...
Эта команда удаляет подключение репликации ANF для тома "MyDestinationAnfVolume".
...
### -InputObject
Том назначения ANF с удаляемой репликацией
...
### -PassThru
Возвращает, была ли удалена указанная репликация ANF.
