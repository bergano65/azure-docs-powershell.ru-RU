...
## ОПИСАНИЕ
Для учетной записи ANF создается новая политика резервного копирования Для учетной записи **AzNetAppFilesActiveDirectory.**
...
Эта команда создает новую политику резервного копирования ANF для учетной записи ANF с именем MyAccount.
...
### -AccountObject
Объект Account для новой политики резервного копирования
...
### -DailyBackupsToKeep
Ежедневное количество резервных копий для сохраняемой информации
...
### -Enabled
Свойство, для решаемого, что политика включена или не включена
...
Количество ежемесячных резервных копий для сохраняемого
...
### -WeeklyBackupsToKeep
Количество резервных копий за неделю, количество сохраняемой информации
...
### -YearlyBackupsToKeep
Количество резервных копий за год, необходимое для сохраняемой архивации
