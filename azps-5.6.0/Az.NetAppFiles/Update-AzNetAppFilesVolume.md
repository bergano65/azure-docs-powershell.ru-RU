...
## ОПИСАНИЕ
Для обновления громкости ANF обновляется **cmdlet Update-AzNetAppFilesVolume.**

## ПРИМЕРЫ

### Пример 1. Обновление тома ANF
```
...
Эта команда обновляет том ANF "MyAnfVolume" с новым размером UsageThreshold.
...
### -PoolObject
Объект пула, содержащий объем для обновления
