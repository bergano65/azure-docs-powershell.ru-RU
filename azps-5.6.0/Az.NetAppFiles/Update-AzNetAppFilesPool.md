...
## ОПИСАНИЕ
Для пула ANF будет модификатор **Update-AzNetAppFilesPool.**
...
Эта команда изменяет пул ANF "MyAnfPool" на заданный размер и QosType.
...
### -AccountObject
Объект учетной записи, содержащий пул для обновления
...
### -QosType
Тип qos пула. Возможные значения: "Авто", "Вручную"
