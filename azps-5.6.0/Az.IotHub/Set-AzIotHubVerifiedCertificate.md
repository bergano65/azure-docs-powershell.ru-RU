...
## ОПИСАНИЕ
Проверяет сертификат, загружая сертификат проверки, содержащий код проверки, полученный cmdlet Get-AzIotHubCertificateVerificationCode. Это последний этап процедуры подтверждения связи.
Подробное описание сертификатов ЦС в Azure IoT Hub см. в https://docs.microsoft.com/azure/iot-hub/iot-hub-x509ca-overview
...
Проверяет право собственности на закрытый ключ MyCertificate. 
...
### -Path
Представление файла сертификата X509 (CER- или PEM-файла) base-64.
