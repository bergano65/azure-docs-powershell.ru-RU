...
## ОПИСАНИЕ
Добавьте новую конечную точку в концентраторЕ IoT. Чтобы узнать о поддерживаемых конечных точках, см. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
