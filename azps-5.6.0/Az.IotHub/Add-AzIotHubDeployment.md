...
## ОПИСАНИЕ
Развертывания Edge можно создавать с помощью пользовательских метрик для оценки по запросу.
Дополнительные https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring сведения см. в этой области.
...
Создайте развертывание Edge с метаданными по умолчанию.
...
Создайте развертывание Edge с приоритетом 3, который применяется на условии, если устройство помечено в здании 9 и среда протестирована.
...
Создайте развертывание Edge с метриками пользователей.
...
Создайте развертывание Edge с метами.
...
Создайте развертывание Edge с контентом.
...
### -Label
Карта меток, которые нужно применить к целевому развертыванию.
...
### -Метрическая
Набор запросов для определения метрик развертывания IoT Edge.
...
### -ModulesContent
Содержимое развертывания модулей для устройств IoT Edge.
...
### -Priority
Вес развертывания в случае соревнований по правилам (самые высокие победы).
...
### -TargetCondition
Целевое условие, к которому относится развертывание Edge.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDвслух
