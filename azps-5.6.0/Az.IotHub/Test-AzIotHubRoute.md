...
## ОПИСАНИЕ
Проверьте определенный маршрут.
...
Проверьте весь маршрут с исходным "DeviceMessages".
...
Протестировать определенный маршрут и показать причину сбоя.
...
Протестировать определенный маршрут с помощью AppProperty и SystemProperty.

## PARAMETERS

### -AppProperty
Свойства приложения сообщения о маршруте
...
### -ShowError
Показывать подробные сведения об ошибке, если они существуют
...
### -SystemProperty
Системные свойства сообщения о маршруте
