...
## ОПИСАНИЕ
Чтобы получить список доступных точек восстановления для элемента, защищенного репликацией, можно получить список баллов, доступных для **azRecoveryServicesAsrRecoveryPoint.**
...
### -Name
Указывает имя точки восстановления, которая будет получаться.
...
Указывает объект защищенного элемента восстановления сайта Azure, для которого нужно получить список доступных точек восстановления.
