...
Первый из них получает хранилище в группе ресурсов с заданным именем. Затем мы будем получать доступ к MSI-данным из сейфа.
...
Указывает имя хранилища, для которого нужно получить запрос.
