...
## ОПИСАНИЕ
Cmdlet **Get-AzRecoveryServicesBackupRetentionPolicyObject** получает основание **AzureRMRecoveryServicesRetentionPolicyObject.**
...
Вторая команда задает длительность объекта политики хранения, которая составляет 365 дней.
