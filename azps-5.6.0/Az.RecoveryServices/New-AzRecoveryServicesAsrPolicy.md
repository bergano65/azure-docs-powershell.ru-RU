...
### -HyperVToAzure
Параметр переключения для указания политики будет использоваться для репликации Hyper-V виртуальных машин в Azure
...
### -VmmToVmm
Параметр переключения для указания политики будет использоваться для репликации Hyper-V сайтов, управляемых VMM-сервером.
