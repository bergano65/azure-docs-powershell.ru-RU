...
---
# Модуль Az.RecoveryServices
## Описание
В этой теме вы также можете найти разделы справки по службам восстановления Azure.
...
Добавьте диск для защиты уже защищенной виртуальной машины Azure.
...
Дискетет все файлы точки восстановления.
...
С помощью **cmdlet Enable-AzRecoveryServicesBackupAutoProtection** можно автоматически защитить текущую и будущую SQL DBS в заданном экземпляре с заданной политикой.
...
Настраивает параметры уведомлений о восстановлении сайта Azure для хранилища.

### [Get-AzRecoveryServicesAsrEvent](Get-AzRecoveryServicesAsrEvent.md)
Получает сведения о событиях восстановления сайта Azure в хранилище.

### [Get-AzRecoveryServicesAsrFabric](Get-AzRecoveryServicesAsrFabric.md)
Получите сведения о структуре для восстановления сайта Azure.
...
Получает сведения о сопоставлениях сети восстановления сайта для текущего хранилища.
...
Получите защищенные элементы в контейнере защиты ASR.
...
Получает сопоставления контейнера для защиты от восстановления сайта Azure.

### [Get-AzRecoveryServicesAsrRecoveryPlan](Get-AzRecoveryServicesAsrRecoveryPlan.md)
Получает план восстановления или все планы восстановления в хранилище служб восстановления

### [Get-AzRecoveryServicesAsrRecoveryPoint](Get-AzRecoveryServicesAsrRecoveryPoint.md)
Возвращает доступные точки восстановления для элемента, защищенного репликацией.
...
Возвращает доступные (обнаруженные) классификации хранилища ASR в хранилище служб восстановления.

### [Get-AzRecoveryServicesAsrStorageClassificationMapping](Get-AzRecoveryServicesAsrStorageClassificationMapping.md)
Возвращает сопоставления классификации хранилища ASR.
...
Сведения о серверах vCenter, зарегистрированных для обнаружения на сервере Configuration Server, указанном в материале ASR.

### [Get-AzRecoveryServicesBackupContainer](Get-AzRecoveryServicesBackupContainer.md)
Получает контейнеры резервных копий.

### [Get-AzRecoveryServicesBackupItem](Get-AzRecoveryServicesBackupItem.md)
Элементы из контейнера в архиве.
...
Эта команда извлекает все защищенные элементы в определенном контейнере или во всех зарегистрированных контейнерах. Она будет состоять из всех элементов иерархии приложения. Возвращает DBS и их объекты верхнего уровня, такие как Instance, AvailabilityGroup и т. д.
...
Получает точки восстановления для элемента, который был восстановлен.
...
Возвращает базовый объект политики расписания.
...
Эта команда строит конфигурацию восстановления для такого элемента, как SQL DB. В объекте конфигурации хранится все сведения, такие как режим восстановления, целевые назначения для восстановления и параметры конкретного приложения, например целевые физические пути для SQL.
...
Создает объект сопоставления дисков для реплицируемых дисков виртуальной машины Azure.

### [New-AzRecoveryServicesAsrFabric](New-AzRecoveryServicesAsrFabric.md)
Создает ткань для восстановления сайта Azure.

### [New-AzRecoveryServicesAsrInMageAzureV2DiskInput](New-AzRecoveryServicesAsrInMageAzureV2DiskInput.md)
Создает объект сопоставления дисков для дисковых дисков виртуальной машины vMWare, которые нужно реплицировать.

### [New-AzRecoveryServicesAsrNetworkMapping](New-AzRecoveryServicesAsrNetworkMapping.md)
Создает сопоставление сети ASR между двумя сетями.
...
Создание плана восстановления ASR.
...
Создает сопоставление классификации хранилища ASR в хранилище служб восстановления.
...
Создание нового хранилища служб восстановления.
...
Удаляет указанную ткань восстановления сайта Azure из хранилища служб восстановления.
...
Удаляет указанный контейнер защиты из его ткань.
...
Удаление и удаление указанного поставщика служб восстановления сайтов Azure из хранилища служб восстановления.
...
Восстановление данных и конфигурации элемента резервной копии до точки восстановления.

### [Resume-AzRecoveryServicesAsrJob](Resume-AzRecoveryServicesAsrJob.md)
Возобновление приостановленного задания восстановления сайта Azure.
...
Задает свойства для управления резервными копиями.

### [Set-AzRecoveryServicesBackupProtectionPolicy](Set-AzRecoveryServicesBackupProtectionPolicy.md)
Изменяет политику защиты от резервного копирования.
...
### [Start-AzRecoveryServicesAsrSwserviceProcessServerJob](Start-AzRecoveryServicesAsrSwitchProcessServerJob.md)
Переключение репликации с одного сервера процессов на другой для балансировки нагрузки.

### [Start-AzRecoveryServicesAsrTestFailoverCleanupJob](Start-AzRecoveryServicesAsrTestFailoverCleanupJob.md)
Запускает операцию очистки при отступе тестирования.
...
Остановка задания восстановления сайта Azure.
...
Обновляет политику репликации сайтов Azure.
...
Обновляет направление репликации для указанного элемента, защищенного репликацией, или для плана восстановления. Используется для повторной защиты или репликации сбойного по плану репликации или восстановления.
...
Обновление (сервер обновления) данных, полученных от поставщика служб восстановления сайтов Azure.
