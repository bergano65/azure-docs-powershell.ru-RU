...
### -AzureToVMware
Указывает аварийное восстановление в Azure для vMWare.
...
### -HyperVToAzure
Параметр переключения, указывающий, что указанная политика используется для Hyper-V виртуальных машин в Azure.
...
### -VmmToVmm
Параметр переключения, указывающий, что указанная политика используется для репликации управляемых VMM Hyper-V виртуальных машин между Hyper-V сайтами.
