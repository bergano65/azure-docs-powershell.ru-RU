...
## ОПИСАНИЕ
Для восстановления сайта Azure это задание останавливается с использованием **cmdlet Stop-AzRecoveryServicesAsrJob.**
...
### -InputObject
Объект ввода: задание объекта задания ASR, соответствующего заданиям ASR
...
### -Name
Укажите задание ASR, которое должно быть остановлено по имени задания ASR.
