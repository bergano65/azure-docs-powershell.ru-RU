...
## SYNOPSIS
Удаляет задание для работы с почтовым ящиком
...
## ОПИСАНИЕ
Для удаления завершенного задания в почтовом ящике из списка заданий используется cmdlet **Remove-AzDataBoxJob.**
...
Удаление указанного задания для почтового ящика
...
Принудительно удаляет указанное задание для почтового ящика без подтверждения.
