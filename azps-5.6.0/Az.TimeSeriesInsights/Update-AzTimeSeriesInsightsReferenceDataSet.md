...
### Пример 1. Обновление указанного набора данных ссылки по имени
```powershell
...
Эта команда обновляет указанный набор справочных данных.

### Пример 2. Обновление указанного набора данных ссылки для объекта
```powershell
...
### -Tag
Пары значений ключа с дополнительными свойствами для набора справочных данных.
