...
### Пример 1. Список всех пиринга vnet, которые находятся в списках данных
```powershell
...
Эта команда содержит список всех пиринга vnet, которые находятся под списками данных.

### Пример 2. Получить пиринг vnet
```powershell
...
Эта команда возвращает пиринг vnet.

### Пример 3. Получить пиринг vnet по объекту
```powershell
...
Эта команда получает пиринг vnet по объектам.
