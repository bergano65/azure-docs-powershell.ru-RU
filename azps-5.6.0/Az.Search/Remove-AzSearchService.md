...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzSearchService** удаляется служба azure Cognitive Search с указанными параметрами.
...
В этом примере удаляется служба поиска когнитивных функций Azure.
