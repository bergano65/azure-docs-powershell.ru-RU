...
## ОПИСАНИЕ
Этот **ресурс Set-AzSearchSharedPrivateLinkResource** обновляет ресурс общей частной ссылки для службы Azure Cognitive Search.
...
В этом примере обновляется сообщение запроса для ожидающих ожидания ресурсов общей личной ссылки для службы azure Cognitive Search.
...
### -InputObject
Объект ввода ресурсов общей частной ссылки
