...
## ОПИСАНИЕ
С **помощью cmdlet Get-AzSearchService** можно получить указанную службу поиска когнитивных функций Azure.
...
Получите службу azure Cognitive Search с указанными параметрами.
