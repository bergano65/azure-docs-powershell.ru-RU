...
## ОПИСАНИЕ
С **помощью cmdlet get-AzSearchPrivateLinkResource** можно получить сведения о ресурсах личной ссылки для службы Azure Cognitive Search.
...
В этом примере показано, как получить сведения о ресурсах личной ссылки (в форме JSON для удобства) для службы azure Cognitive Search.
