...
## ОПИСАНИЕ
**Новый-AzSearchAdminKey** повторно сгенерирует ключ администратора службы Azure Cognitive Search.
...
В этом примере повторно сгенерирует первичный ключ службы azure Cognitive Search.
...
### -KeyKind
Ключ администрирования службы поиска Azure (основной или дополнительный).
