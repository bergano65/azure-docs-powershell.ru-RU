...
## ОПИСАНИЕ
Для удаления подписки на share удаляется из подписки **cmdlet Remove-AzDataShareSubscription**
...
Эти команды удаляют из вики-служб учетной записи вики-сайты ссылку AdsShareSubscription с именем AdsShareSubscription. 
