...
## ОПИСАНИЕ
При **настройке Remove-AzDataShareSynchronizationSetting параметр** синхронизации datashare удаляется.
...
Эти команды удаляют параметр синхронизации AdsShareSynchronizationSetting из share AdsShare. 
...
### -InputObject
Параметр синхронизации службы обмена данными Azure.
...
### -ResourceId
ИД ресурса параметра синхронизации
