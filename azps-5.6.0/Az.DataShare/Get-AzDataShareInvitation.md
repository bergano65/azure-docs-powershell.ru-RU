...
## ОПИСАНИЕ
В **этом же проектлете Get-AzDataShareInvitation** можно получить сведения о приглашениях, добавленных в обет данных. Если указать имя приглашения, этот cmdlet получит сведения о приглашении. Если имя не указано, этот cmdlet получает сведения обо всех приглашениях в обет.
...
Эти команды предоставляют сведения о приглашении AdsInvitation в области обмена данными AdsShare.
...
### -Name
Имя приглашения на передачу данных Azure
...
### -ResourceId
ИД ресурса приглашения на передачу данных Azure
