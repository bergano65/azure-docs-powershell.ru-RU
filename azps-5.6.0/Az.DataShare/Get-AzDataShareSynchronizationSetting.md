...
## ОПИСАНИЕ
**Cmdlet Get-AzDataShareSynchronizationSetting** предоставляет сведения о том, включена ли синхронизация в share. 
...
Эта команда предоставляет сведения о синхронизации ShareSynchronization, включенной при совместном доступе AdsShare в share account WikiAds учетной записи.
...
### -ResourceId
ИД ресурса в параметре синхронизации обмена данными Azure
