...
## ОПИСАНИЕ
Чтобы получить сведения об исходных наборах данных в подписке на доступ, можно получить сведения о cmdlet **Get-AzDataShareSourceDataSet.** 
...
Наборы данных, доступные в источнике
