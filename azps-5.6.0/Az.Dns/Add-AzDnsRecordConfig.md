...
Объект **RecordSet** является автономным объектом, и его изменения не изменяют ответы DNS, пока вы не запустите Set-AzDnsRecordSet, чтобы сохранить изменение службы DNS Microsoft Azure.
...
### Пример 5. Добавление NS-записи в набор
```
...
### -RecordSet
Определяет объект **RecordSet,** который нужно изменить.
