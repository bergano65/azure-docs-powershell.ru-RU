...
### -Location
Определяет регион Azure, в котором нужно создать поставщика для проверки. Используйте команду Get-AzResourceProvider параметра ProviderNamespace, чтобы увидеть ваши варианты.
...
Набор ключей надежных подписей для политики выдачи в одном файле сертификата.
