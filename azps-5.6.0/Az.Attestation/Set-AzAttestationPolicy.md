...
Задает определяемую пользователем политику для TEE типа *SgxEnclave* для поставщика attestation Provider *pshtest* с использованием формата политики JWT.
...
### -Политика
Определяет заданный документ политики.  Формат политики может быть текстовым или веб-токеном JSON (JWT).
