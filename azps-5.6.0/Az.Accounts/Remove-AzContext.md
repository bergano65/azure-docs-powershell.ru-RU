...
### RemoveByInputObject (по умолчанию)
```
...
Удаление контекста, названного по умолчанию
...
### -Force
Удаление контекста, даже если он является стандартным
