...
Определяет аудиторию для токенов, которые запрашивают проверку подлинности в конечных точках диспетчера ресурсов Azure или службы управления службами.
...
Суффикс azure Container Registry.
