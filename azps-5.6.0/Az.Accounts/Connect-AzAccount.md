...
ИД учетной записи для маркера доступа в **наборе параметров AccessToken.** ИД учетной записи для управляемой службы в **наборе параметров ManagedService.** Может быть управляемым ИД ресурса службы или связанным с ней ид клиента.
