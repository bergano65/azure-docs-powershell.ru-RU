...
## ОПИСАНИЕ
Cmdlet **Set-AzDtlVMsPerUserPolicy** задает виртуальные машины на пользователя, задав максимальное количество виртуальных машин, разрешенных для каждого пользователя.
