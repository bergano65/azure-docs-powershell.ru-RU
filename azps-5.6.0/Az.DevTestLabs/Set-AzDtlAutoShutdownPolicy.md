...
## ОПИСАНИЕ
Для этого используется поле **Set-AzDtlAutoShutdownPolicy,** которое задает политику автоматического закрытия лаборатории, которая автоматически закрывает все виртуальные машины в заданное время суток.
...
### -Enable
Указывает на то, что с помощью cmdlet можно включить политику в лабораторных условиях.
