...
### Пример 1. Обновление решения для аналитики журналов с именами
```powershell
...
Эта команда обновляет решение для анализа журналов по имени.

### Пример 2. Обновление решения для аналитики журнала журнала с помощью объектов
```powershell
...
Эта команда обновляет решение для анализа журнала журнала за объектом.
