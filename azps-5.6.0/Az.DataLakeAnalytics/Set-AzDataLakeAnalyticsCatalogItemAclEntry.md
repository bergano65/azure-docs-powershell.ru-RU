...
Эта команда изменяет разрешение на чтение каталога ACE дляНси Фукера.
...
Эта команда изменяет ACE базы данных дляБюче с разрешением на чтение.
...
Эта команда задает разрешение владельца базы данных на чтение.
