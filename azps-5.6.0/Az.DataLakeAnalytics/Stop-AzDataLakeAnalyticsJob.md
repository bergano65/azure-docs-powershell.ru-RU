...
## ОПИСАНИЕ
Для отмены задания Azure Data Lake Analytics будет отменено задание **Stop-AzDataLakeAnalyticsJob.**

## ПРИМЕРЫ

### Пример 1. Отмена задания
```
PS C:\>Stop-AzDataLakeAnalyticsJob -Account "ContosoAdlAccout" -JobId "a0a78d72-3fa8-4564-9b18-6becb3fda48a"
```

Эта команда отменяет задание с указанным ИД.
