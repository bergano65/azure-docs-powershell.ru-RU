...
### ByWorkspaceNameByKind (по умолчанию)
```
...
## ОПИСАНИЕ
Для получения источников данных возвращается **cmdlet Get-AzOperationalInsightsDataSource.**
Вы можете указать источник данных, который нужно получить.
Результаты можно фильтровать в зависимости от типа источника данных.
...
### -Kind
Определяет тип источников данных, которые нужно получить.
...
### -Name
Указывает имя источника данных, который нужно получить.
...
### -ResourceGroupName
Имя группы ресурсов, которая содержит источники данных, которые нужно получить.
