...
## ОПИСАНИЕ
Данные New-AzOperationalInsightsAzureActivityLogDataSource позволяют средству аналитики журналов собирать журнал действий Azure из данной подписки.
...
### -BackfillStartTime
Вы можете сделать это неделю назад.
