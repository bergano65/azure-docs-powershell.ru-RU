...
## ОПИСАНИЕ
С **помощью cmdlet New-AzOperationalInsightsSavedSearch** создается новый сохраненный поиск с указанными параметрами рабочей области.

## ПРИМЕРЫ

### Пример 1. Создание сохраненного поиска
```
...
Эта команда создает новый сохраненный поиск.
...
### -DisplayName
Определяет сохраненное отображаемого имя поиска.
...
### -FunctionAlias
Псевдоним функции, если запрос служит функцией.
...
### -FunctionParameter
Необязательные параметры функции, если запрос служит функцией. Значение должно иметь следующий формат: "параметр-имя1:тип1 = default_value1, параметр-имя2:тип2 = default_value2". Дополнительные примеры и синтаксис нужно найти в соответствующем синтаксисе. https://docs.microsoft.com/azure/kusto/query/functions/user-defined-functions
...
### -Query
Определяет выражение запроса для сохраненного поиска.
