...
### -IdentityType
типом удостоверения может быть значение "SystemAssigned", "None".
...
### -Location
Географический регион, в который будет развернут кластер.
...
### -SkuCapacity
Емкость SKU: значение должно быть кратно 100 и в диапазоне от 1000 до 2000.
...
### -SkuName
Название SKU, теперь может быть только "CapacityReservation"
