...
## SYNOPSIS
Включает рекомендации консультанта Azure.
...
## ОПИСАНИЕ
Этот cmdlet включает ранее не подавляемую рекомендацию. Вы также можете удалить все удаления, связанные с рекомендациями.
...
Удаление всех подавляний для данной рекомендации с именем "recommendation_id".
...
Удаление всех подавляний для переданных рекомендаций из конвейера.
...
### -ResourceId
ИД рекомендации, которая должна быть подавляема.
