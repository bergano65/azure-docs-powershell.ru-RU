...
### -EndDate
Конечные данные сводки по резервированиям (ММ-ММ-ММ в UTC), необходимые только для ежедневного анализа.
...
### -Grain
Время, заданная в сводке резервирования, может быть ежедневно или ежемесячно.
