...
### Пример 2. Список таблиц хранилища Azure с использованием поддеревных символов
```
...
Это можно сделать для поиска всех таблиц, которые начинаются с одной и той же строки, например таблицы.
