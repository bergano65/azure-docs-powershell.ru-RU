...
## ОПИСАНИЕ
При **этом файл** или каталог перемещается в другой файл или каталог в той же учетной записи хранения.
...
### Пример 1. Перемещение сгиба в той же filesystem
```
...
Эта команда перемещает каталог dir1 в каталог "dir3" в той же filesystem.

### Пример 2. Перемещение файла по конвейеру в другую систему в той же учетной записи хранения без запроса
```
...
Эта команда перемещает файл dir1/file1 в "filesystem1" в файл dir2/file2 в "filesystem2" в той же учетной записи хранения без запроса.
...
### -Force
Принудительное написания назначения.
...
### -InputObject
Объект элемента Azure Datalake Gen2 для перемещения.
...
### -Path
Путь в указанной Filesystem, из которых следует переходить.
