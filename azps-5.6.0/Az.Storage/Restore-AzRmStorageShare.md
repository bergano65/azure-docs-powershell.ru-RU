...
## ОПИСАНИЕ
С **его учетом** можно восстановить удаленную папку в течение допустимого дня хранения, если совместное удаление включено.
...
### -Name
Удалено имя для обмена, которое будет восстановлено.
