...
## ОПИСАНИЕ
Для таблицы хранилища Azure с его учетной записью создается политика доступа **New-AzStorageTableStoredAccessPolicy.**
...
Важно отметить, что это строка (для `raud` чтения, добавления, обновления и удаления).
