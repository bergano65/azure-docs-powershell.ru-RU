...
### Пример 3. Все учетные записи хранения в подписке
```
...
Эта команда получает учетные записи хранения с состоянием восстановления BLOB-хранилищ и показывает их состояние.
