...
## ОПИСАНИЕ
**Новый-AzStorageBlobSASToken** создает маркер подписи SAS для BLOB-blob-хранилища Azure.
...
### -Permission
Определяет разрешения для BLOB-адреса хранилища. Важно отметить, что это строка (для `rwd` чтения, записи и удаления). 
