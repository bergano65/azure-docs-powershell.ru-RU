...
- "Контейнер".
Обеспечивает полный доступ для чтения к контейнеру и его BLOB-контейнеру.
Клиенты могут с помощью анонимного запроса укаймировать в контейнере BLOB-контейнер, но не могут продумыть контейнеры в учетной записи хранения. 
- BLOB.;
