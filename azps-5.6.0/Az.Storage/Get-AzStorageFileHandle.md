...
### Пример 1. Рекурсивно перечислить все обрабатывающие файлы в папке, а также отсортировать их по ClientIp и OpenTime
```
...
Эта команда содержит данные об обработке файлов в папке и сортировке результатов по ClientIp, а затем по OpenTime.
