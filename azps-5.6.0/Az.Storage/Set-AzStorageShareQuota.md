...
## ОПИСАНИЕ
**Cmdlet Set-AzStorageShareQuota** задает объем хранилища для указанной доли.
...
См. ограничение квоты в https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-files-limits . 
