...
### Пример 2. Запуск операции копирования из BLOB-файла в файл с использованием имени контейнера и имени BLOB-файла
```
...
Вы можете создать объект контейнера облачного BLOB-объекта или использовать Get-AzStorageContainer-проектлет.
...
### -SrcFile
Указывает объект **CloudFile.**
Вы можете создать облачный файл или получить его с помощью **Get-AzStorageFile.**
