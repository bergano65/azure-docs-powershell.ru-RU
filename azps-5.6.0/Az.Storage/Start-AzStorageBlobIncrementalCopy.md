...
## ОПИСАНИЕ
Запуск операции добавоической копии из моментального снимка BLOB-сайта страницы в указанный BLOB-проект страницы.
Дополнительные сведения о функции см. в https://docs.microsoft.com/rest/api/storageservices/fileservices/incremental-copy-blob .
...
### Пример 4. Запуск добавонной операции копирования из объекта CloudPageBlob в объект-объект назначения с именем BLOB-объекта
```
...
### -CloudBlob
Объект CloudBlob из библиотеки клиента хранилища Azure. Вы можете создать его или использовать Get-AzStorageBlob- или Get-AzStorageBlob.
...
### -CloudBlobContainer
Объект CloudBlobContainer из библиотеки клиента хранилища Azure. Вы можете создать его или использовать Get-AzStorageContainer- или Get-AzStorageContainer.
