...
В этом примере операция копирования прекращается, передавая контейнер в конвейере из Get-AzStorageBlob..
...
### -Force
Остановка текущей задачи копирования в указанном BLOB-проекте без запроса на подтверждение.
