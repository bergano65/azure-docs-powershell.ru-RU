...
## ОПИСАНИЕ
Для получения состояния операции копирования файлов хранилища Azure возвращается состояние cmdlet **Get-AzStorageFileCopyState.**
Он должен запускаться в файле назначения для копирования.

## ПРИМЕРЫ

### Пример 1. Просмотр состояния копии по имени файла
```
