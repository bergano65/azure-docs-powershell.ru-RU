...
Эта команда удаляет большой ветвь, который определен по имени.
...
### Пример 5. Удаление одного моментального снимка BLOB-lob
```
...
Определяет профиль Azure для прочитаемого cmdlet.
