...
## ОПИСАНИЕ
Для службы файлов хранилища Azure свойства службы **Update-AzStorageFileServiceProperty** изменяется.

## ПРИМЕРЫ

### Пример 1. Enable File share softdelete
```powershell
...
Эта команда позволяет делиться файлами с softdelete delete, при этом срок хранения составляет 5 дней.
...
Включите совместное хранение для учетной записи хранения, заключив для нее $true, отключите политику хранения удаления, заключив для нее $false.
...
### -ResourceId
Ввести ИД ресурса учетной записи хранения или свойства ресурса службы файлов.
...
### -ShareRetentionDays
Определяет количество дней хранения для share DeleteRetentionPolicy.
Это значение следует устанавливать только в том случае, если включить совместное хранение удаления.
