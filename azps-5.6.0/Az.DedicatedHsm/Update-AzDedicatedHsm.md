...
## SYNOPSIS
Обновление выделенной службы HSM в указанной подписке.
...
### Пример 1. Обновление тега параметра dedicated HSM по имени
```powershell
...
Эта команда обновляет тег параметра "Выделенный HSM по имени"

### Пример 2. Обновление тега параметра "Выделенный HSM по объекту"
```powershell
...
Эта команда обновляет тег параметра "Выделенный HSM по объекту"
