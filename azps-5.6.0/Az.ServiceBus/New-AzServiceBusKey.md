...
## ОПИСАНИЕ
Для указанного пространства имен, очереди или темы и правила авторизации сгенерироваться новые строки основного или дополнительного подключения с новыми строками подключения **New-AzServiceBusKey.**
...
Повторное сгенерирует основные или дополнительные строки подключения для этого раздела.
