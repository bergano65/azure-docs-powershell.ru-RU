...
## ОПИСАНИЕ
Cmdlet **Set-AzServiceBusSubscription** обновляет описание подписки для темы "Шина обслуживания" в указанном пространстве имен "Автобус обслуживания".
...
Обновляет описание указанной подписки по указанному разделу. В этом примере свойство **DeadLetteringOnMessageExpiration** обновляется до true, а **MaxDeliveryCount** — до 9. 
