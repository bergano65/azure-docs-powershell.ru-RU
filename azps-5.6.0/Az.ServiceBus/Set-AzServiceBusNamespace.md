...
## ОПИСАНИЕ
Для этого с его **описанием в** группе ресурсов обновляется описание указанного пространства имен "Автобус обслуживания".
...
Обновляет пространство имен автобусов обслуживания с новым описанием.
...
### -Confirm
Обновляет пространство имен автобусов обслуживания, внося в нее указанные сведения.
