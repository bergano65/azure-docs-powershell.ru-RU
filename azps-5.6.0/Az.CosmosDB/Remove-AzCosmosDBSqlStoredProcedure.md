...
## SYNOPSIS
Удаляет Sql StoredProcedure вБDB.
...
## ОПИСАНИЕ
Для удаления из данных ResourceGroupName, AccountName и DatabaseName с его учетной записью удаляется **cmdDB-AzCosmosDBSqlStoredProcedure.**
