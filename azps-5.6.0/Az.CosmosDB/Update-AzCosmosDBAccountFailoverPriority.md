...
FailoverPolicies обновлены с регионом1 как FailoverPriority 1, region2 как FailoverPriority 2 и region3 как FailoverPriority 3.
...
### -FailoverPolicy
Массив строк с названиями регионов, упорядоченный по приоритету отсказки.
E.g eastus, westus
