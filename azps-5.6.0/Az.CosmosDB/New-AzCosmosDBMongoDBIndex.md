...
## SYNOPSIS
Создание нового индекса :'ДискоссDB MongoDB''
...
## ОПИСАНИЕ
**New-AzCosmosDBMongoDBIndex** создает новый индекс Вадима Ермонова.
...
### -Key
Массив значений ключей в качестве строк.
...
### Microsoft.Azure.Commands.ВацыDB.Models.PSMongoIndex
