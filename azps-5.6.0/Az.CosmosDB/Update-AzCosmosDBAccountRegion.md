...
## ОПИСАНИЕ
Обновление областей учетной записи ВайссDB. Расположение можно указать как объект psLocation типа или как строки с именем расположения, упорядоченным по приоритету от сбойа.
