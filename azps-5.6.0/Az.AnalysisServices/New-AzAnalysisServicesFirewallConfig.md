...
Создает объект брандмауэра с двумя правилами, одновременно предоставляя доступ из службы Power BI.
...
Флаг, позволяющий указать, разрешает ли брандмауэр доступ из Power BI
