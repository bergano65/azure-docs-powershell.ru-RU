...
### Пример 1. Вычисление, устранение и проверка зависимостей ресурсов перемещения в коллекции "Перемещение".
```powershell
...
Вычислять, устранять и проверять зависимости ресурсов перемещения в коллекции Move.
