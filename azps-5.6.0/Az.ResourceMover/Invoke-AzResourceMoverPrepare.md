...
### Пример 1. Проверка зависимовлений перед подготовкой ресурсов. Получите необходимые зависимые ресурсы, которые также должны быть подготовлены.
```powershell
...
Прежде чем приготовить ресурсы, проверьте необходимые проверки.
Получите необходимые зависимые ресурсы, которые также должны быть подготовлены.

### Пример 2. Инициировать подготовку к набору ресурсов в коллекции перемещения, используя в качестве входных данных "Имя MoveResource".
```powershell
