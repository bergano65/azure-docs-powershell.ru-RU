...
### Пример 1. Создание организации с слияниями
```powershell
...
Эта команда создает организацию с слиянием.
...
### -Location
Расположение ресурса организации
...
### -OfferDetailTermUnit
Единица срока действия плана предложения
