...
## ОПИСАНИЕ
Список билетов в службу поддержки. Он получит все билеты в службу поддержки, если не указать параметры. Вы также можете фильтровать билеты в службу поддержки по status или CreatedDate с помощью параметра Filter. Вот несколько примеров значений фильтра, которые можно указать.
...
| Получить билеты, созданные после 20 декабря 2019 г.               | "CreatedDate gt 2019-12-20"                      |
