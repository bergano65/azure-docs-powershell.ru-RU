...
Если указать узел вычислений, но не фильтр, этот cmdlet возвращает свойства для всех файлов узлов для этого узла.
...
Эта команда получает свойства файлов узла, имена которых начинаются с st и связаны с задачей, которая имеет задачу ID Task26 в рамках задания с ИД-00002.
...
Таким образом, выполняется поиск рекурсивного файла и возвращается wd\newFile.txt узла.
...
Эта команда получает все файлы в папке запуска из узла вычислений, который содержит ID ComputeNode01 в пуле, который содержит ID Pool22.
...
Эта команда получает все файлы в корневой папке узла вычислений, который содержит ID ComputeNode01 в пуле, который содержит ID Pool22.
