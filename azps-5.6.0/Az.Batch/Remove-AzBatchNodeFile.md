...
## ОПИСАНИЕ
С **его использованием** удаляется пакетный файл узла Azure для задачи или узла вычислений.
...
Эта команда удаляет файл узла с именем startup\testFile.txt из указанного узла вычислений в пуле, который содержит пул ID Pool07.
...
Этот cmdlet is relevant only if the path is a folder.
