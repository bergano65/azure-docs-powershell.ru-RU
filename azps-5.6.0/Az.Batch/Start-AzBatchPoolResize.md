...
### Пример 1. Переумно до 12 узлов пула
```
PS C:\>Start-AzBatchPoolResize -Id "ContosoPool06" -TargetDedicatedComputeNodes 12 -BatchContext $Context
```

Эта команда запускает операцию по переупорядованию пула с ID ContosoPool06.
...
Если к этому моменту пул не достигнет целевого размера, операция перестанет добиться.
