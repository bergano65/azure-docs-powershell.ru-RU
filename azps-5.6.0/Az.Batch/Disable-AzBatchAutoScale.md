...
## ОПИСАНИЕ
Для отключения автоматического масштабирования указанного пула с его использованием будет отключена функция **disable-AzBatchAutoScale.**
...
Эта команда отключает автоматическое масштабирование для пула MyPool.
