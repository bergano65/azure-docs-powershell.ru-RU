...
## ОПИСАНИЕ
Этот cmdlet собирает файлы журнала пакетной службы Azure с узлов компьютеров, если вы столкнулись с ошибкой и хотите зайти в службу поддержки Azure. Чтобы решить проблемы с обработкой пакетной службы, необходимо делиться файлами журнала пакетных служб Azure с помощью службы Azure. 
...
Журналы службы вычислительных узлов, написанные 1 января 2018 г. в полночь и до полуночи 10 января 2018 г., были получены из объекта вычислительного узла.
