...
## ОПИСАНИЕ
**Cmdlet Set-AzBatchApplication** изменяет параметры указанного пакетного приложения Azure.
...
### -AccountName
Имя учетной записи пакета, для которой этот cmdlet изменяет приложение.
