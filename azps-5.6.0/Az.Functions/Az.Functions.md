...
# Модуль Az.Functions
## Описание
Microsoft Azure PowerShell — команды для диспетчера ресурсов Azure в Windows PowerShell и PowerShell Core.\n\nFor о функциях Azure, посетите следующие веб-сайты: https://docs.microsoft.com/azure/azure-functions/
...
Возвращает объект systemAssignedIdentity, доступный в указанной области RP.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Описание функции "Получить ключи функций" на веб-сайте или в слоте развертывания.
