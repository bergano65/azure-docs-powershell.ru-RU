...
Эта команда получает приложение функции по имени и останавливает его.
...
<ISite>INPUTOBJECT: 
  ...
  - `[CloningInfoCloneSourceControl <Boolean?>]`: <code>true</code> чтобы клонировать управление исходным источником из source app; в противном <code>false</code> случае.
