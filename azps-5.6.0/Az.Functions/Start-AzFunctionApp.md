...
### Пример 1. Получите приложение функции по имени и запустите его.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Эта команда получает приложение функции по имени и запускает его.

### Пример 2. Запуск приложения функции по имени.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Эта команда запускает приложение функции по имени.
