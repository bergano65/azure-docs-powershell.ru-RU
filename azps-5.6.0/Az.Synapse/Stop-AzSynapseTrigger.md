...
## ОПИСАНИЕ
В рабочей области триггер **Stop-AzSynapseTrigger** останавливает триггер. Если триггер находится в состоянии "Запущено", то триггер останавливается и перестает вызывать конвейеры. Если триггер уже находится в состоянии "Остановлено", этот cmdlet не будет действовать.
