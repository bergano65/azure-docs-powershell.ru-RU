...
## SYNOPSIS
Извлекает отдельные точки восстановления, из которых SQL можно восстановить пул средств аналитики Synapse.
...
## ОПИСАНИЕ
Для получения различных точек восстановления, из SQL Azure Synapse Analytics, извлекается **cmdlet Get-AzSynapseSqlPoolRestorePoint.**
...
Эта команда возвращает все доступные точки восстановления для пула Azure Synapse Analytics SQL ContosoSqlPool.
