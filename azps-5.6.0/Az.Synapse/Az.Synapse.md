...
# Модуль Az.Synapse
## Описание
В разделах этой статьи вы также научились в azure PowerShell-cmdlets for Azure Synapse Analytics.
...
Преобразуется в аналитику Synapse Analytics SQL записи о проверке уязвимости пула.
...
Отключает (отключает) рекомендации по конфиденциальности для столбцов в SQL пуле.

### [Enable-AzSynapseSqlAdvancedDataSecurity](Enable-AzSynapseSqlAdvancedDataSecurity.md)
Включает расширенные возможности безопасности данных в рабочей области.

### [Enable-AzSynapseSqlPoolSensitivityRecommendation](Enable-AzSynapseSqlPoolSensitivityRecommendation.md)
Включает рекомендации по конфиденциальности для столбцов (они включены по умолчанию для всех столбцов) в SQL столбцах.

### [Export-AzSynapseNotebook](Export-AzSynapseNotebook.md)
Экспорт notbooks.

### [Get-AzSynapseActivityRun](Get-AzSynapseActivityRun.md)
Сведения о действиях для запуска конвейера.
...
Получает сведения об наборе данных в рабочей области.
...
Получает правило брандмауэра synapse Analytics.

### [Get-AzSynapseIntegrationRuntime](Get-AzSynapseIntegrationRuntime.md)
Сведения о ресурсах интеграции runtime.
...
Получает метрические данные для интеграции с runtime. 

### [Get-AzSynapseIntegrationRuntimeNode](Get-AzSynapseIntegrationRuntimeNode.md)
Возвращает сведения об узле узла для интеграции со временем запуска.

### [Get-AzSynapseLinkedService](Get-AzSynapseLinkedService.md)
Получает сведения о связанных службах в рабочей области.

### [Get-AzSynapseNotebook](Get-AzSynapseNotebook.md)
Получает сведения о записных книжках в рабочей области.

### [Get-AzSynapsePipeline](Get-AzSynapsePipeline.md)
Сведения о конвейерах в рабочей области.
...
Получает назначение роли Synapse Analytics.

### [Get-AzSynapseRoleDefinition](Get-AzSynapseRoleDefinition.md)
Получает определение роли Synapse Analytics.
...
Получает спарк-отчет Synapse Analytics.
...
Получает политику advanced Data Security рабочей области.
...
Эта функция доступна в ограниченном режиме предварительного просмотра и изначально доступна только для определенных подписок. Получает базу данных Synapse Analytics SQL.

### [Get-AzSynapseSqlPool](Get-AzSynapseSqlPool.md)
Получает пул средств аналитики Synapse SQL.

### [Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting](Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting.md)
Получает дополнительные параметры защиты от угроз для SQL пула.

### [Get-AzSynapseSqlPoolAuditSetting](Get-AzSynapseSqlPoolAuditSetting.md)
Настраивает параметры аудита пула azure Synapse Analytics SQL.

### [Get-AzSynapseSqlPoolGeoBackup](Get-AzSynapseSqlPoolGeoBackup.md)
Получает геоархивную резервную копию Sql Synapse Sql.

### [Get-AzSynapseSqlPoolRestorePoint](Get-AzSynapseSqlPoolRestorePoint.md)
Извлекает отдельные точки восстановления, из которых можно восстановить SQL средств аналитики Synapse.

### [Get-AzSynapseSqlPoolSensitivityClassification](Get-AzSynapseSqlPoolSensitivityClassification.md)
Возвращает текущие типы данных и метки конфиденциальности столбцов в SQL пуле.

### [Get-AzSynapseSqlPoolSensitivityRecommendation](Get-AzSynapseSqlPoolSensitivityRecommendation.md)
Возвращает рекомендуемые типы данных и метки конфиденциальности для столбцов в SQL пуле.

### [Get-AzSynapseSqlPoolTransparentDataEncryption](Get-AzSynapseSqlPoolTransparentDataEncryption.md)
Возвращает состояние TDE для SQL пула.
...
Получите состояние подписки для триггера события для указанных событий внешней службы.
...
Повторно сгенерировать ключ времени запуска интеграции для самостоятельной интеграции.

### [New-AzSynapseRoleAssignment](New-AzSynapseRoleAssignment.md)
Создает назначение роли Synapse Analytics.
...
Эта функция доступна в ограниченном режиме предварительного просмотра и изначально доступна только для определенных подписок. Создает базу данных Synapse Analytics SQL.

### [New-AzSynapseSqlPool](New-AzSynapseSqlPool.md)
Создает пул средств аналитики Synapse SQL.

### [New-AzSynapseSqlPoolRestorePoint](New-AzSynapseSqlPoolRestorePoint.md)
Создает новую точку восстановления в пуле аналитики Synapse Analytics SQL Azure.

### [New-AzSynapseWorkspace](New-AzSynapseWorkspace.md)
Создает рабочее пространство synapse Analytics.

### [Remove-AzSynapseDataFlow](Remove-AzSynapseDataFlow.md)
Удаляет поток данных из рабочей области.
...
Возобновление пула средств аналитики Synapse SQL.

### [Set-AzSynapseDataFlow](Set-AzSynapseDataFlow.md)
Создает или обновляет поток данных в рабочей области.

### [Set-AzSynapseDataset](Set-AzSynapseDataset.md)
Создает или обновляет набор данных в рабочей области.

### [Set-AzSynapseIntegrationRuntime](Set-AzSynapseIntegrationRuntime.md)
Обновляет время интеграции.

### [Set-AzSynapseLinkedService](Set-AzSynapseLinkedService.md)
Связывает хранилище данных или облачную службу с рабочей областью.

### [Set-AzSynapseNotebook](Set-AzSynapseNotebook.md)
Создает или обновляет записную книжку в рабочей области.
...
Подготовка администратора Azure AD для пула Synapse Analytics SQL.

### [Set-AzSynapseSqlAuditSetting](Set-AzSynapseSqlAuditSetting.md)
Изменение параметров аудита рабочей области Azure Synapse Analytics.
...
Задает типы данных и метки конфиденциальности столбцов в SQL столбцов.

### [Set-AzSynapseSqlPoolTransparentDataEncryption](Set-AzSynapseSqlPoolTransparentDataEncryption.md)
Изменяет свойство TDE для SQL пула.
...
Проверяет наличие пула спаркпарков Synapse Analytics.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Эта функция доступна в ограниченном режиме предварительного просмотра и изначально доступна только для определенных подписок. Проверяет наличие базы данных Synapse Analytics SQL.

### [Test-AzSynapseSqlPool](Test-AzSynapseSqlPool.md)
Проверяет наличие пула средств аналитики Synapse SQL.
...
Обновляет правило брандмауэра synapse Analytics.
