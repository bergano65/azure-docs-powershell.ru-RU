...
## SYNOPSIS
Получает политику advanced Data Security для рабочей области.
...
## ОПИСАНИЕ
Cmdlet **Get-AzSynapseSqlAdvancedDataSecurityPolicy** извлекает политику Advanced Data Security рабочей области.
