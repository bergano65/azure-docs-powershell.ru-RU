...
## ОПИСАНИЕ
Для пула аналитики Synapse Analytics в Azure SQL состояние шифрования данных (TDE) для cmdlet **Get-AzSynapseSqlPoolTransparentDataEncryption.**
...
Эта команда получает состояние TDE для SQL ContosoSqlPool в рабочей области с именем ContosoWorkspace.
