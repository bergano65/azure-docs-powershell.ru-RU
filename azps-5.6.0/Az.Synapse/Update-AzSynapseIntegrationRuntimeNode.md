...
## ОПИСАНИЕ
Для свойства узла времени самостоятельной интеграции в рабочей области обновляется **cmdlet Update-AzSynapseIntegrationRuntimeNode.** В настоящее время поддерживается только обновление "ConcurrentJobsLimit".
