...
## ОПИСАНИЕ
Этот Enable-AzSynapseSqlPoolSensitivityRecommendation позволяет использовать рекомендации по конфиденциальности для столбцов в SQL пуле.

## ПРИМЕРЫ

### Пример 1. Рекомендации по конфиденциальности для данного столбца в SQL Azure Synapse.
```powershell
...
### Пример 2. Рекомендации по конфиденциальности для столбца Azure Synapse SQL с помощью Piping.
```powershell
