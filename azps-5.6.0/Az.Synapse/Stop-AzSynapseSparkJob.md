...
### StopSparkJobByIdParameterSet (по умолчанию)
```
...
## ОПИСАНИЕ
Для отмены задания спаркинг-аналитики Synapse Analytics будет отменено задание **Stop-AzSynapseSparkJob.**
...
Эта команда отменяет задание synapse Analytics Spark.
...
Эта команда отменяет задание спаркпарка Synapse Analytics через конвейер.
...
### -SparkJobObject
Объект ввода задания спарк-задания, обычно переданный по конвейеру.
