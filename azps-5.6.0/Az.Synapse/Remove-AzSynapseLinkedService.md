...
## ОПИСАНИЕ
Для удаления связанной службы из рабочей области удаляется ее cmdlet **Remove-AzSynapseLinkedService.**
...
Эта команда удаляет связанную службу с именем ContosoLinkedService из рабочей области ContosoWorkspace.
...
Эта команда удаляет связанную службу с именем ContosoLinkedService из рабочей области ContosoWorkspace через канал.
