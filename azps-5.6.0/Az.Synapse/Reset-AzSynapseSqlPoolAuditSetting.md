...
## ОПИСАНИЕ
Для пула аналитики Synapse Azure удаляются параметры аудита, задаваемые SQL Azure **AzSynapseSqlPoolAuditSetting.**
...
Эта команда удаляет параметры аудита для SQL ContosoSqlPool в рабочей области ContosoWorkspace.
