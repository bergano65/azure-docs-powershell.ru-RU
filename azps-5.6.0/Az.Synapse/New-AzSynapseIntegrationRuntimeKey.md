...
## SYNOPSIS
Повторно сгенерировать ключ времени работы интеграции для самостоятельной интеграции.
...
## ОПИСАНИЕ
Cmdlet **New-AzSynapseIntegrationRuntimeKey** повторно сгенерирует ключ времени запуска интеграции с именем ключа, заданным параметром KeyName. Предыдущий ключ недействителен.
