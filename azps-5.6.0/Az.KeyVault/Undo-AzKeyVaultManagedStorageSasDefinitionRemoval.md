...
## ОПИСАНИЕ
Команда **Undo-AzKeyVaultManagedStorageSasDefinitionRemoval** восстанавливает ранее удаленное определение SAS хранилища, если для этого хранилища включено soft delete и что попытка восстановления происходит во время восстановления.
