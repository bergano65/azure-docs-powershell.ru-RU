...
## ОПИСАНИЕ
Cmdlet **Stop-AzKeyVaultCertificateOperation** отменяет операцию сертификата в службе хранилища ключей Azure.
...
Эта команда отменяет операцию сертификата TestCert02.
