...
Эта команда восстановит ключевое хранилище MyKeyVault, ранее удаленное из области eastus2 и группы ресурсов MyResourceGroup, в активное состояние. Теги будут также заменяться новыми.
