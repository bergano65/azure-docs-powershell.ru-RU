...
Обратите внимание, что для добавления правил сети невозможно использовать любой диапазон IP-адресов внутри организации `10.0.0.0-10.255.255.255` (частные IP-адреса).
