...
Эта учетная запись управляемого хранения является копией архивной учетной записи управляемого хранилища во входных файлах и имеет то же имя, что и у исходного файла.
Если в хранилище ключей уже есть учетная запись управляемого хранения с таким же именем, при этом происходит сбой, а не переописывание исходного.
...
Эта команда восстанавливает учетную запись управляемого хранилища, включая все ее версии, из файла резервной копии Backup.blob в хранилище ключа MyKeyVault.
