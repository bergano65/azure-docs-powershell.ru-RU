...
## ОПИСАНИЕ
Для восстановления ранее удаленного сертификата будет восстановлен ранее удаленный cmdlet **Undo-AzKeyVaultCertificateRemoval.**
...
Эта команда восстановит сертификат MyCertificate, который ранее был удален, в активное состояние.
...
### -Name
Имя сертификата.
Cmdlet конструировать FQDN сертификата из имени хранилища, выбранной среды и имени сертификата.
