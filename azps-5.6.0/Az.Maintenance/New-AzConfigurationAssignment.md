...
## SYNOPSIS
Зарегистрируйте конфигурацию ресурса.
...
## ОПИСАНИЕ
Зарегистрируйте конфигурацию обслуживания для ресурса.
...
Зарегистрируйте конфигурацию обслуживания для выделенного хоста.
...
Имя назначения конфигурации должно совпадать с именем MaintenanceConfigurationName.
...
### -Location
Расположение без пробелов для ресурса.
...
Полное обслуживаниеConfiguration.
