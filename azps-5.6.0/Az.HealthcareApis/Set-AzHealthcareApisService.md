...
### Пример 1. Обновляет существующую службу healthcareapis с именем MyService в группе ресурсов MyResourceGroup, задав значение 500 (500) для службы включенной в службу включена надстройка OfferThroughput.
