...
## ОПИСАНИЕ
Командлет Set-AzRelayHybridConnection обновляет описание гибридного подключения в указанном пространстве имен ретрансляции.
...
В этом примере свойство UserMetadata обновляется на новое значение.
