...
## ОПИСАНИЕ
Командлет **Remove-AzRelayAuthorizationRule** удаляет правило авторизации для заданной сущности Relay (Namespace/WcfRelay/HybridConnection).
...
Удаляет правило авторизации `AuthoRule1` пространства `TestNameSpace-Relay1` имен.
...
Удаляет правило авторизации `AuthoRule1` WcfRelay `TestWcfRelay` из пространства `TestNameSpace-Relay1` имен.
...
Удаляет правило авторизации `AuthoRule1` HybridConnection `TestHybridConnection` из пространства `TestNameSpace-Relay1` имен.
