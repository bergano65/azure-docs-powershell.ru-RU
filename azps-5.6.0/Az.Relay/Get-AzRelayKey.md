...
## ОПИСАНИЕ
Командлет **Get-AzRelayKey** возвращает строки основного и дополнительного подключения для заданной сущности Relay (Namespace/WcfRelay/HybridConnection).
...
Строка основного и дополнительного подключения к указанным объектам ретрансляции (Namespace/WcfRelay/HybridConnection).
