...
## ОПИСАНИЕ
С New-AzDataMigrationSelectedDB создается объект сведений базы данных, содержащий сведения об исходных и целевых базах данных, а также сопоставления таблиц для миграции. Его можно использовать в качестве параметра с New-AzDataMigrationTask управления.
...
### -BackupFileShare
Файловая папка, в которой должны быть архивы исходных серверных файлов базы данных.
Используйте этот параметр, чтобы переопределить сведения о доступе к файлам для каждой базы данных.
Используйте для сервера полное доменное имя.
...
Настройка системы для чтения базы данных перед миграцией
...
Заведите тип миграции SQL Server SQL DB.
...
### -MigrateSqlServerSqlDbMi
Заведите тип миграции SQL Server SQL DB MI Migration.
