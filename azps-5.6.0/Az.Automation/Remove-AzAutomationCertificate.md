...
## ОПИСАНИЕ
Чтобы удалить сертификат из автоматизации Azure, удаляется **cmdlet Remove-AzAutomationCertificate.**
...
Эта команда удаляет сертификат с именем Cert01 в учетной записи автоматизации Contoso17.

## PARAMETERS

### -AutomationAccountName
Указывает имя учетной записи автоматизации, для которой этот cmdlet удаляет сертификат.
...
### -Name
Указывает имя сертификата, который удаляет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, для которой этот cmdlet удаляет сертификат.
