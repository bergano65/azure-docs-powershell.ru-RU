...
## ОПИСАНИЕ
**Cmdlet Set-AzAutomationCertificate** изменяет конфигурацию сертификата в автоматизации Azure.
...
Для этой команды используется пароль, $Password.
Эта команда определяет имя учетной записи и путь к файлу, который она загружает.

## PARAMETERS

### -AutomationAccountName
Указывает имя учетной записи автоматизации, для которой этот cmdlet изменяет сертификат.
...
### -Description
Описание сертификата, который изменяет этот cmdlet.
...
### -Name
Указывает имя сертификата, который изменяет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, для которой этот cmdlet изменяет сертификат.
