...
## ОПИСАНИЕ
В Get-AzAutomationSoftwareUpdateConfiguration возвращается список конфигураций обновления программного обеспечения. Чтобы получить определенную конфигурацию обновления программного обеспечения, укажите параметр имени. Вы также можете указать конфигурации обновления программного обеспечения, которые нацелены на конкретную виртуальную машину Azure, указав для нее ИД ресурса Azure.

## ПРИМЕРЫ

### Пример 1
Получите конфигурацию обновления программного обеспечения автоматизации Azure по имени.
