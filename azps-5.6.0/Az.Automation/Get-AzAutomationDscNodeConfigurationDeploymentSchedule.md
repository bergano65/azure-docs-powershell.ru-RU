...
## ОПИСАНИЕ
Чтобы развернуть конфигурацию узла APS Desired State Configuration (DSC) в Azure Automation, можно получить состояние **APSAutomationDscNodeConfigurationDeployment.**

## ПРИМЕРЫ

### Пример 1. Получить все расписания развертывания
```
...
### Пример 2. Просмотр расписания развертывания
```
...
### -JobScheduleId
Определяет id расписания задания для существующего запланированного задания развертывания.
