...
---
# Модуль Az.Automation
## Описание
В этой теме вы можете найти разделы справки по cmdlets автоматизации Azure.

## Az.Automation Cmdlets
### [Export-AzAutomationDscConfiguration](Export-AzAutomationDscConfiguration.md)
Экспорт конфигурации DSC из автоматизации в локальный файл.

### [Export-AzAutomationDscNodeReportContent](Export-AzAutomationDscNodeReportContent.md)
Экспорт необработанных данных отчета DSC, отправленных с узла DSC, в автоматизацию.

### [Export-AzAutomationRunbook](Export-AzAutomationRunbook.md)
Экспорт книги автоматизации.
...
Возвращает потоки ведения журнала в заданиях компиляции DSC автоматизации.
...
Получает развертывания конфигурации узла DSC в автоматизации.

### [Get-AzAutomationDscNodeConfigurationDeploymentSchedule](Get-AzAutomationDscNodeConfigurationDeploymentSchedule.md)
Получает расписание задания развертывания узла DSC в автоматизации.
...
Возвращает задания запуска автоматизации.

### [Get-AzAutomationJobOutput](Get-AzAutomationJobOutput.md)
Возвращает результат задания автоматизации.
...
Получает метаданные модулей от автоматизации.
...
Получает расписание автоматизации.
...
Возвращает список конфигураций обновления программного обеспечения автоматизации Azure.

### [Get-AzAutomationSoftwareUpdateMachineRun](Get-AzAutomationSoftwareUpdateMachineRun.md)
Возвращает список, на который ведется компьютер конфигурации обновления программного обеспечения автоматизации Azure.

### [Get-AzAutomationSoftwareUpdateRun](Get-AzAutomationSoftwareUpdateRun.md)
Возвращает список обновлений программного обеспечения автоматизации Azure.

### [Get-AzAutomationSourceControl](Get-AzAutomationSourceControl.md)
Получает список исходных элементов управления автоматизации Azure.
...
Возвращает результат задания синхронизации источника данных автоматизации Azure.

### [Get-AzAutomationVariable](Get-AzAutomationVariable.md)
Возвращает переменную автоматизации.

### [Get-AzAutomationWebhook](Get-AzAutomationWebhook.md)
Получает веб-сайты из автоматизации.
...
Создает соединение автоматизации.
...
Создает запланированную конфигурацию обновления программного обеспечения автоматизации Azure.

### [New-AzAutomationSourceControl](New-AzAutomationSourceControl.md)
Создает исходный контроль автоматизации.
...
Публикует книгу запуска.

### [Register-AzAutomationDscNode](Register-AzAutomationDscNode.md)
Регистрирует виртуальную машину Azure в качестве узла DSC для учетной записи автоматизации.
...
Удаляет сертификат автоматизации.

### [Remove-AzAutomationConnection](Remove-AzAutomationConnection.md)
Удаляет соединение автоматизации.

### [Remove-AzAutomationConnectionType](Remove-AzAutomationConnectionType.md)
Удаляет тип соединения автоматизации.
...
Гибридная группа сотрудников удаляется из автоматизации.

### [Remove-AzAutomationModule](Remove-AzAutomationModule.md)
Модуль удаляется из автоматизации.
...
Удаляет конфигурацию обновления программного обеспечения автоматизации Azure.

### [Remove-AzAutomationSourceControl](Remove-AzAutomationSourceControl.md)
Удаляет исходный контроль автоматизации Azure.
...
Изменяет учетные данные автоматизации.

### [Set-AzAutomationDscNode](Set-AzAutomationDscNode.md)
Изменяет конфигурацию узла, с которую соедует узел DSC.
...
Изменяет webhook для книги автоматизации.
...
Развертывает конфигурацию узла DSC в автоматизации.

### [Start-AzAutomationRunbook](Start-AzAutomationRunbook.md)
Запускает задание книги.
...
Остановка развертывания конфигурации узла DSC в автоматизации. При этом текущее задание развертывания будет остановиться, но не будет отоменить уже назначенную конфигурацию узла.
