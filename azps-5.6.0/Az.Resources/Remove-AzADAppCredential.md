...
Получает приложение с объектным ид '7663d3fb-6f86-4352-9e6d-cf9d50d5ee82' и вертами, которые до Remove-AzADAppCredential-управления, и удаляет из этого приложения все учетные данные.
