...
Конечная команда назначает политику в $Policy уровне группы ресурсов с использованием объекта параметров политики в $AllowedLocations.
...
### -AssignIdentity
Создать и назначить удостоверение Azure Active Directory для этого назначения политики. Удостоверение будет использоваться при развертывании политик развертыванияIfNotExists. При назначении удостоверения требуется расположение.
...
### -DisplayName
Отображает имя для назначения политики.
