...
## ОПИСАНИЕ
В **результате выполнения команды Update-AzManagementGroup** **обновляется ParentId** или **DisplayName** для группы управления.

## ПРИМЕРЫ

### Пример 1. Обновление отображаемом имени группы управления
```
...
### Пример 2. Обновление родительского группы
```
...
### Пример 3. Обновление группы управления путем перенаправления объектов PSManagementGroup
```
...
### Пример 4. Обновление родительского проекта группы управления с помощью parentObject
```
