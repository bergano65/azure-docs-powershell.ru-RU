...
## ОПИСАНИЕ
При этом развертывание Azure в группе управления и все связанные с ней операции удаляются с использованием команды **Remove-AzManagementGroupDeployment.**
...
Эта команда получает "RolesDeployment" в группе управления myMG и удаляет ее.
