...
Удобное имя директора-службы. Если отображаемого имени нет, по умолчанию для этого значения задается **azure-powershell-MM-dd-yyyy-HH-mm-ss,** где суффикс — время создания приложения.
