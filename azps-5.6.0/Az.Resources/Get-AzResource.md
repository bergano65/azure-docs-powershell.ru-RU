...
Для получения ресурсов Azure можно **использовать cmdlet Get-AzResource.**
...
### Пример 5. Получить все ресурсы, имена которых совпадают с предоставленными поддиавными знаками
...
Эта команда возвращает ресурсу предоставленный ид ресурса — виртуальную машину с искомой машиной testVM в группе ресурсов testRG.
...
### -Name
Имена извлекаемого ресурса. Этот параметр поддерживает поддиавные знаки в начале или в конце строки.
...
### -ResourceGroupName
Группа извлекаемой ресурсов. Этот параметр поддерживает поддиавные знаки в начале или в конце строки.
