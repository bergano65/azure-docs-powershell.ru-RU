...
## ОПИСАНИЕ
**Cmdlet Set-AzManagedApplication** обновляет управляемые приложения.
...
### -Id
Полностью управляемый ИД приложения, включая подписку. Например, /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Kind
Тип управляемого приложения.
Один из marketplace или servicecatalog
...
### -Parameter
Строка параметров в формате JSON для управляемого приложения.
Это может быть путь к имени файла или URI, содержащий параметры, или параметры в качестве строки.
...
### -Plan
Hash table which represents managed application plan properties.
