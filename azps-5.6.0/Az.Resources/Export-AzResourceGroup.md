...
Шаблон будет по-прежнему создан для успешно созданных частей.
...
Эта команда сохраняет два ресурса из группы ресурсов TestGroup в качестве шаблона и сохраняет их в файл JSON в текущем каталоге. Созданный шаблон не содержит созданных параметров.
