...
## ОПИСАНИЕ
Для создания управляемого определения приложения создается **cmdlet New-AzManagedApplicationDefinition.**
...
Эта команда создает управляемое определение приложения.
...
### -CreateUiDefinition
Определение пользовательского интерфейса в определении управляемого приложения
...
### -LockLevel
Уровень блокировки для определения управляемого приложения.
...
### -MainTemplate
Основной шаблон определения управляемого приложения
