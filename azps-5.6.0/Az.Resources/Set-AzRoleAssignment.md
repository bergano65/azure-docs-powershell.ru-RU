...
Версию условия можно обновить с 1.0 до 2.0, но нельзя вернуть к более новой версии. Будьте осторожны, так как число 2,0 не является задним числом с числом 1,0.
