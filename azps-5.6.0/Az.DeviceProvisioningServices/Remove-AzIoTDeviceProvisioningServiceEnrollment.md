...
## ОПИСАНИЕ
Удалите регистрацию устройства в службе регистрации устройств на концентраторе Azure IoT.
...
Удаление указанной записи регистрации.
...
Удалите все записи о регистрации.
