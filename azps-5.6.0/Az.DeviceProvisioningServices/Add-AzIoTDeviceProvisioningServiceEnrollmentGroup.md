...
## ОПИСАНИЕ
Создайте группу регистрации в службе azure IoT Hub Device Provisioning Service.
...
### -ApiVersion
Версия API службы предварительной настройки в настраиваемом запросе на выделение.
...
### -PrimaryKey
Первичный симметричный ключ общего доступа, сохраненный в базовом формате 64.
...
### -RootCertificate
Позволяет создавать проверки X509attestation с использованием корневых сертификатов.
