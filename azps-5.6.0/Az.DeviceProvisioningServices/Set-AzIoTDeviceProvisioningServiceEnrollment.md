...
Обновление основных и дополнительных сертификатов симметричного ключа
...
### -RootCertificate
Переключение на обновление проверки X509attestation с помощью корневых сертификатов.
