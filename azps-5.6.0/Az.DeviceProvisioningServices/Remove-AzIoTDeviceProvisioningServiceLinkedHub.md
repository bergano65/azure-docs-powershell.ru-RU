...
Удалите связанный концентратор IoT "myiothub" в службе по подготовка устройств для Azure IoT Hub.
...
Удалите связанный концентратор IoT "myiothub" в службе подготовка устройства в Azure IoT Hub с помощью конвейера.
