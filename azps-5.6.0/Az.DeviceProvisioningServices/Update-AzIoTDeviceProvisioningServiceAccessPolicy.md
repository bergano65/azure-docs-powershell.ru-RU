...
## ОПИСАНИЕ
Введение в службу по подготовкам устройств через Azure IoT см. в https://docs.microsoft.com/azure/iot-dps/about-iot-dps .
...
### -Разрешения
Разрешения политики доступа к службе подготовка устройств ioT
