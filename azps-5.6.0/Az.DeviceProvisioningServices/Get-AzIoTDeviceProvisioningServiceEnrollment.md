...
## ОПИСАНИЕ
Получите сведения о регистрации устройства или списке регистраций устройств в службе регистрации устройства в Центре IoT Azure.
...
Регистрация устройств в службе azure IoT Hub Device Provisioning Service.
