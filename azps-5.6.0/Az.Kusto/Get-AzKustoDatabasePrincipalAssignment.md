...
Команда выше возвращает все principalAssignment в базе данных "mykustodatabase", найденную в кластере testnewkustocluster.

### Пример 2. Получить определенное имя PrincipalAssignment в базе данных
```powershell
...
Команда выше возвращает все PrincipalAssignment с именем "kustoprincipal1" в базе данных "mykustodatabase", найденной в кластере testnewkustocluster.
