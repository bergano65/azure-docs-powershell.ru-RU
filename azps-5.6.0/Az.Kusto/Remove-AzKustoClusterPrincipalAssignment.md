...
### Пример 1. Удаление существующего кластера "Кузто" principalAssignment по имени
```powershell
...
С этой команды удаляется principalAssignment с именем "kustoprincipal1" в кластере Кузто "testnewkustocluster".
