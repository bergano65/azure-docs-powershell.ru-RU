...
С этой командой обновляется период soft deletion и период кэша базы данных "Mykustodatabase" кисто в кластере testnewkustocluster, который находится в группе ресурсов "testrg".
