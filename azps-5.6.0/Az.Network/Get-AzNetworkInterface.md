...
### Пример 1. Получить все сетевые интерфейсы
```
...
### Пример 2. Получите все сетевые интерфейсы с определенным состоянием подготовка
```
...
Эта команда получает все сетевые интерфейсы в группе ресурсов ResourceGroup1 с состоянием подготовка успешно.

### Пример 3. Использование фильтров для сетевых интерфейсов
```
...
### -Name
Указывает имя сетевого интерфейса, который получает этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, из которой этот cmdlet получает сетевые интерфейсы.
...
### -ResourceId
ИД диспетчера ресурсов Azure в сетевом интерфейсе.
...
### -VirtualMachineIndex
Определяет индекс виртуальной машины для набора масштаба виртуальной машины, из которого этот cmdlet получает сетевые интерфейсы.
...
Определяет имя набора масштаба виртуальной машины, из которого этот cmdlet получает сетевые интерфейсы.
