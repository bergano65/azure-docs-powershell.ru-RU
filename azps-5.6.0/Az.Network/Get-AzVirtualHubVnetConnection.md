...
После создания виртуального сетевого подключения концентратор перечисляет все виртуальное сетевое подключение концентратора, используя имя группы ресурсов и имя концентратора.
