...
## ОПИСАНИЕ
Для получения таблиц маршрутов Azure можно получить таблицы **маршрутов Get-AzRouteTable.**
Вы можете получить одну таблицу маршрутов или все таблицы маршрутов в группе ресурсов или в подписке.
...
Эта команда получает таблицу маршрутов с именем RouteTable01 в группе ресурсов "Группа ресурсов11".

### Пример 2. Список таблиц маршрутов с помощью фильтрации
```
...
Эта команда возвращает все таблицы маршрутов, имена которых начинаются с "RouteTable"
...
### -Name
Указывает имя таблицы маршрутов, которую получает этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, которая содержит таблицы маршрутов, которые получает этот cmdlet.
