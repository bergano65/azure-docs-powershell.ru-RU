...
Команда создает новое условие совпадения с использованием переменной совпадения, определенной в $variable, оператором является "Содержит" и условие отрицания — false, Transfroms (нижний регистр и обрезка), значение совпадения — abc и cde. Новое условие совпадения будет сохранено в $condition.
