...
Эта команда создает сетевой интерфейс NetworkInterface001 с динамически присвоенным личным IP-адресом из подсети1 в виртуальной сети VirtualNetwork1. Команда также назначает два DNS-сервера для сетевого интерфейса. Ребенок IPConfiguration будет создан автоматически с использованием имени IPConfiguration1.
...
Включает ускорение сетевого связи.
