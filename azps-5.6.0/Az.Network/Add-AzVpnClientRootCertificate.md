...
Если у вас нет сертификата X.509, его можно создать в инфраструктуре открытого ключа или использовать генератор сертификатов, например makecert.exe.
