...
## ОПИСАНИЕ
Для массива сопоставлений URL-путей с пулом серверов серверов **set-AzApplicationGatewayUrlPathMapConfig** задает конфигурацию.

## ПРИМЕРЫ

### Пример 1. Обновление сопоставления URL-путей
```
...
Вторая команда обновляет сопоставление URL-адреса с именем map01 в шлюзе приложения.
...
Указывает стандартный пул адресов для перенаправляемого обратного адреса на случай, если ни одно из правил, указанных в параметре *pathRules.*
