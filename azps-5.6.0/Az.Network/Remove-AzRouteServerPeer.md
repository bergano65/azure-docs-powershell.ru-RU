...
## SYNOPSIS
Удаляет одноранг из Azure RouteServer.
...
## ОПИСАНИЕ
Для удаления однорангового узла RouteServer из Azure RouteServer удаляется cmdlet **Remove-AzRouteServerPeerer**
...
### -InputObject
Объект ввода одноранговых серверов маршрутов.
...
### -ResourceId
ИД ресурса одноранговых ресурсов сервера маршрутов.
