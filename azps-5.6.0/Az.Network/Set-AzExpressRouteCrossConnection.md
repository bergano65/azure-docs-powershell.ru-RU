...
## ОПИСАНИЕ
С **его использованием** можно сохранить измененное перекрестное подключение ExpressRoute к Azure.

## ПРИМЕРЫ

### Пример 1. Изменение состояния поставщика услуг для перекрестного подключения ExpressRoute
```
...
Определяет объект **ExpressRouteCrossConnection,** который изменяет этот cmdlet.
...
### -Name
Имя прямого перекрестного подключения.
...
### -Пиринги
Список пирингов для перекрестного подключения
...
Состояние подготовка поставщика услуг
