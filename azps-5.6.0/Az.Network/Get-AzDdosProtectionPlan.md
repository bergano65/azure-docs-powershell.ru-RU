...
## ОПИСАНИЕ
Этот Get-AzDdosProtectionPlan получает план защиты DDoS.

## ПРИМЕРЫ

### Пример 1. Получите определенный план защиты DDoS
```
...
В этом случае нам нужно указать атрибуты **ResourceGroupName** и **Name,** соответствующие группе ресурсов и названию плана защиты DDoS соответственно.

### Пример 2. Все планы защиты DDoS в группе ресурсов
```
...
В этом сценарии для получения списка планов защиты DDoS указывается только параметр **ResourceGroupName.**

### Пример 3. Все планы защиты DDoS в подписке
```
...
Здесь не указаны параметры для получения списка всех планов защиты DDoS в подписке.

### Пример 4. Все планы защиты DDoS в подписке
```
...
Этот cmdlet возвращает все DdosProtectionPlans, которые начинаются с "test".
...
### -ResourceGroupName
Имя группы ресурсов плана защиты DDoS.
