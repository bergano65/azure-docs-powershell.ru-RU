...
## ОПИСАНИЕ
Для удаления набора правил перезаписи из шлюза приложения Azure удаляется набор правил **Remove-AzApplicationGatewayRewriteRuleSet.**
...
Вторая команда удаляет набор правил переописи с именем RuleSet02 из шлюза приложения, $AppGw.
