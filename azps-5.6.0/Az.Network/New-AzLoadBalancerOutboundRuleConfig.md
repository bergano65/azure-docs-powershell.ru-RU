...
### Пример 1. Создание конфигурации исходящие правила для балансиров нагрузки
```powershell
...
Третья команда создает конфигурацию пула адресов с именем BackendAddressPool01 и сохраняет ее в переменной $backend адресов.
