...
## ОПИСАНИЕ
Для создания azure VirtualRouter с его использованием создается новый cmdlet Azure **AzVirtualRouter.**
...
### -HostedSubnet
Подсеть, в которой находится виртуальный маршрутизатор.
