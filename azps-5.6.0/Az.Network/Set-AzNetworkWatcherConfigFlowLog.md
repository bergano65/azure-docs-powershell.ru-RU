...
В этом примере мы настраиваем состояние ведения журнала потоков для группы безопасности сети. В ответе мы видим, что в NSG включено ведение журнала потоков, формат по умолчанию, а политика хранения не настроена.
...
В этом примере мы настроим состояние ведения журнала потоков и аналитику трафика для группы безопасности сети. В ответе мы видим, что в NSG включено ведение журнала потоков и включена аналитика трафика, формат по умолчанию, а политика хранения не задана.
...
В этом примере мы отключаем аналитику трафика для группы безопасности сети, для которой настроены журналы потоков и аналитика трафика. В ответе мы видим, что в NSG включено ведение журнала потоков, но аналитика трафика отключена.
...
Возвращает или задает интервал (в минутах), который определяет, как часто служба TA должна делать анализ потоков. Поддерживаемые значения — 10 и 60 минут.
...
### -WorkspaceGUID
GUID WS, которая используется для хранения данных аналитики трафика.
...
### -WorkspaceResourceId
Подписка на службу WS, которая используется для хранения данных аналитики трафика.
