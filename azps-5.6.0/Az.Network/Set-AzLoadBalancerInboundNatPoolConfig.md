...
## SYNOPSIS
Задает конфигурацию входящий пул NAT для балансиров нагрузки.
...
### -EnableFloatingIP
Настраивает конечную точку виртуальной машины для плавающей возможности IP-адреса, необходимой для настройки группы SQL доступности AlwaysOn. Этот параметр необходим при использовании групп доступности SQL AlwaysOn в SQL сервере. Этот параметр нельзя изменить после создания конечной точки.
...
Время ожидания для неавтного подключения TCP. Это значение можно установить от 4 до 30 минут. Значение по умолчанию — 4 минуты. Этот элемент используется только в том случае, если протокол имеет протокол TCP.
