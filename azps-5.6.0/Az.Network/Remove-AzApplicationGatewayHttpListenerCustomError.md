...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzApplicationGateWayCustomError** пользовательская ошибка удаляется из http-прослушивание шлюза приложения.

## ПРИМЕРЫ

### Пример 1. Удаление пользовательской ошибки http-прослушивание
```powershell
