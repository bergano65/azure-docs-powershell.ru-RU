...
Выше будет создание группы ресурсов, виртуальной WAN, виртуальной сети, виртуального концентратора в Западной центральной части США в группе ресурсов TestRG в Azure. После этого в виртуальном центре будет создан шлюз ExpressRoute с 2-масштабными единицами.

После этого expressRouteGateway получает его имя resourceGroupName и имя шлюза.
...
Эта команда будет получать все expressRouteGateway, которые начинаются с "test"
