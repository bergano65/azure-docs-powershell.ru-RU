...
## ОПИСАНИЕ
С New-AzP2sVpnGateway позволяет создать в VirtualHub новую службу P2SVpnGateway для подключения point к сайту от Point к клиентам сайта к Azure VirtualWan.
...
С New-AzP2sVpnGateway позволяет создать в VirtualHub новую технологию P2SVpnGateway для подключения point к сайту.
...
### -VirtualHub
С виртуальнымHubом должна быть связана эта компания P2SVpnGateway.
...
### -VirtualHubId
С помощью этого P2SVpnGateway должен быть связан ид VirtualHub.
...
Пометить, чтобы включить параметры маршрутации в Этом P2SVpnGateway.
