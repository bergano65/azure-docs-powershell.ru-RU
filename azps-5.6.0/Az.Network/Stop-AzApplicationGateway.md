...
## ОПИСАНИЕ
Для шлюза приложения остановка шлюза приложения будет останавливаться **cmdlet Stop-AzApplicationGateway.**

## ПРИМЕРЫ

### Пример 1. Остановка шлюза приложения
```
PS C:\>Stop-AzApplicationGateway -ApplicationGateway $AppGw
```

Эта команда останавливает шлюз приложения, который хранится в переменной $AppGw приложения.

## PARAMETERS

### -ApplicationGateway
Указывает шлюз приложения, который останавливает этот cmdlet.
