...
### 1. Создание конфигурации IP-адреса с общедоступным IP-адресом для интерфейса сети
```
...
Набор ссылок на входящие правила NAT для балансиента нагрузки, к которым принадлежит это сетевое правило IPConfiguration.
