...
## ОПИСАНИЕ
С New-AzNetworkWatcherConnectionMonitorOutputObject создается объект назначения для выводного монитора подключения.
...
Type : "workspace" WorkspaceSettings : { "WorkspaceResourceId": "MyWSResourceId" }
...
### -OutputType
Тип вывода монитора подключения. В настоящее \" время поддерживается \" только workspace.
...
### -WorkspaceResourceId
ИД ресурса рабочей области журнала аналитических данных.
