...
Создает ManagedRuleSet с типом ruleSetType как $ruleSetType, ruleSetVersion как $ruleSetVersion и RuleGroupOverrides в качестве списка с целиком как $ruleGroupOverride 1, $ruleGroupOverride 2 Новый ManagedRuleSet назначен $managedRuleSet
