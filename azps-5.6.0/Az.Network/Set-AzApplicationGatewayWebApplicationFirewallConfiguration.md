...
Вторая команда включает конфигурацию брандмауэра для шлюза приложения, храняного в $AppGw, и задает для брандмауэра режим "Обнаружение", RuleSetType — "OWASP", а в RuleSetVersion — "3.0".
