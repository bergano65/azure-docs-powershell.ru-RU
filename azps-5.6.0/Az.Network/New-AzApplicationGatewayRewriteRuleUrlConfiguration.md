...
Если вы хотите обновить существующие объекты URLConfiguration, создав новую структуру URLConfiguration и назначив новую ссылку свойству URLConfiguration набора действий rewrite Rule Action Set.
