...
Указывает расположение закрытой конечной точки. С [помощью Get-AzLocation](/powershell/module/az.resources/get-azlocation) можно определить допустимые значения для этого параметра.
