...
## SYNOPSIS
Одноранговая служба RouteServer в Azure RouteServer
...
## ОПИСАНИЕ
**Cmdlet Get-AzRouteServerPeer** получает одноранг в Azure RouteServer
...
### -ResourceId
ResourceId одноранговых серверов маршрутов.
