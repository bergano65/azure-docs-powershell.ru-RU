...
## ОПИСАНИЕ
Для шлюза приложения добавляется набор правил переописи **Add-AzApplicationGatewayRewriteRuleSet.**
...
Вторая команда добавляет набор правил переописи на шлюз приложения.
