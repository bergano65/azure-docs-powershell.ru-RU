...
С **помощью cmdlet Update-AzP2sVpnGateway** можно обновить существующую версию P2SVpnGateway в VirtualHub с использованием нового VPNClientAddressPool. Когда клиент Point to site подключается с помощью этого средства P2SVpnGateway, для него выделяется один из IP-адресов этого vpnClientAddressPool.

### Пример 2

Обновите существующую версию P2SVpnGateway в VirtualHub, чтобы указать на возможность подключения к сайту. (autogenerated)
...
VpnServerConfiguration, которая будет подключена к этой P2SVpnGateway.
