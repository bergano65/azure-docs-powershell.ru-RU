...
## ОПИСАНИЕ
Удаляет указанную таблицу маршрутов, связанную с указанным виртуальным центром.
...
Эта команда удаляет маршрутTable1 виртуального центра Westsub.
...
### -InputObject
Удаляемый ресурс virtualhubroutetable.
