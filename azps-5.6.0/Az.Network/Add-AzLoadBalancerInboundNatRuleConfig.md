...
Последняя команда задает для конфигурации балансировую нагрузку, если не выполнить командную команду Set-AzLoadBalancer, изменения не будут применены к загрузчику.
...
### -Name
Указывает имя добавляемой конфигурации правила NAT.
