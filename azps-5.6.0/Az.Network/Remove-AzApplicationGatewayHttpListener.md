...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzApplicationGatewayHttpListener** можно удалить http-прослушивание из шлюза приложения Azure.
...
### -Name
Указывает имя http-прослушки, удаляемой этим cmdlet.
