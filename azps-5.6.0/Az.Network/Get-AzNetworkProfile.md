...
В этом случае будет извлечен профиль сети np1 в группе ресурсов rg1
...
При этом будут извлекаться профили сети, которые начинаются с "np"
...
### -ResourceId
ИД диспетчера ресурсов Azure в сетевом профиле.
