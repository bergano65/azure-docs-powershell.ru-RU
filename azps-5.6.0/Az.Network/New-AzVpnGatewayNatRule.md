...
Выше будет создание группы ресурсов, виртуальной WAN, виртуальной сети, виртуального концентратора. Затем мы создадим VpnGateway в этом виртуальном центре. Затем, используя эту команду: New-AzVpnGatewayNatRule, можно создать правило NAT и связанное с созданным VpnGateway.
