...
В этом примере удаляется группа colelction правил брандмауэра с именем testRcGroup в брандмауэре fpName, frpm the resourcegroup names "testRg"
...
### -InputObject
Объект группы «Правила политики брандмауэра»
