...
## ОПИСАНИЕ
Для создания такой конфигурации создается конфигурация службы частных ссылок **New-AzPrivateLinkServiceIpConfig.** Эта конфигурация используется для nat-ing источника входящих трафика из закрытой конечной точки. 
