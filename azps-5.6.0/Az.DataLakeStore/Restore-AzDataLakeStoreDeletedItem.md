...
## ОПИСАНИЕ
Для **восстановления удаленных** файлов или папок в хранилище Data Lake Store можно восстановить с их набережной. Требуется путь к удаленному элементу в корзине, возвращенный get-AzDataLakeStoreDeletedItem.
Внимание! Неудачание файлов — это лучший способ работы. После удаления файла его можно восстановить без каких-либо гарантий. Использование этого API включено с помощью списка в списках. Если ваша учетная запись ADL не находится в списке белых, использование этого api позволит не реализовать исключение. Для получения дополнительных сведений и помощи обратитесь в службу поддержки Майкрософт.
