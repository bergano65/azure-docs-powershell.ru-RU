...
## ОПИСАНИЕ
Для получения указанного надежного поставщика удостоверений в указанном магазине data Lake Store возвращается **cmdlet Get-AzDataLakeStoreTrustedIdProvider.**
Если не указан поставщик, перечислены все поставщики для учетной записи.
