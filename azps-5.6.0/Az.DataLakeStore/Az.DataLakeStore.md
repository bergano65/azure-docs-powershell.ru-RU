...
## Описание
В разделах этой статьи подытожаются командылеты Azure PowerShell для Azure Data Lake Store в платформе Azure Resource Manager (ARM). Командлеты существуют в области имен Microsoft.Azure.Commands.DataLakeStore. Эти cmdlets работают только с учетными записьми Azure Data Lake Storage Gen1.
...
Получает содержимое файла в магазине Data Lake Store.
...
Очищает ACL файла или папки в магазине Data Lake Store.
...
Изменяет ACL файла или папки в Data Lake Store.
