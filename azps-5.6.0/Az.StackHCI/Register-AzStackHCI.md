...
### -Регион
Определяет регион, в который нужно создать ресурс.
...
### -RepairRegistration
Восстановление текущей регистрации Azure Stack HCI с помощью облака. Этот cmdlet удаляет локальные сертификаты на узлах с кластером и удаленные сертификаты в приложении Azure AD в облаке и создает новые сертификаты на замену для обоих. Сохраняется группа ресурсов, название ресурса и другие варианты регистрации.
