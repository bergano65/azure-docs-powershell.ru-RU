...
При этом будет создаваться расширение компьютера с использованием удостоверения, предоставленного через канал, и сведений о расширении, переданных в объекте расширения.
Скорее всего, вы не сделаете этого, но это возможно.
