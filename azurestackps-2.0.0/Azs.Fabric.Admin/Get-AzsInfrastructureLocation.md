...
Получение списка всех структурных местоположений.
...
Получение расположения на основе имени.
...
### Microsoft. Azure. PowerShell. командлеты. FabricAdmin. Models. Api20160501. IFabricLocation
