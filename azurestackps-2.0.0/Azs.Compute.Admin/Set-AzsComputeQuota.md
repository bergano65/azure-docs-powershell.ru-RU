...
```
## NОПИСАНИЕ
Обновление вычислительной квоты

## ИЛЛЮСТРИРУЮТ

### Пример 1: Настройка свойств существующей вычислительной квоты
```powershell
...
Задайте параметры, указанные в командной строке.
По умолчанию для всех параметров не установлено значение 0
