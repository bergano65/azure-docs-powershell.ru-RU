...
## NОПИСАНИЕ
Останавливает операцию захвата пакетов на шлюзе виртуальной сети и отправляет результат по данному SasUrl контейнера хранилища.
...
### -Name (имя)
Имя шлюза виртуальной сети, в котором нужно запустить сбор пакетов.
...
### -SasUrl
Захват пакетов URL-адресов SAS на шлюзе виртуальной сети.
