...
### 1: создание частной конечной точки
```
...
В этом примере создается частная конечная точка с определенным ИД службы частной ссылки в конкретной подсети виртуальной сети.
...
Подключение к службе частной ссылки.
