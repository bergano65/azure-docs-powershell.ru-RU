...
## NОПИСАНИЕ
Командлет **New-AzFirewallPolicyNatRuleCollection** создает семейство правил NAT для политики брандмауэра Azure.
...
В этом примере создается набор правил NAT с сетевым правилом

## ПАРАМЕТРЫ

### -Себя
Тип действия правила.
