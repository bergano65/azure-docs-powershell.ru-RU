...
### HostedGatewayParameterSet (по умолчанию)
```
...
### -HostedGateway
Шлюз, на котором должен быть размещен виртуальный маршрутизатор.
...
### -HostedGatewayId
Идентификатор шлюза, на котором должен быть размещен виртуальный маршрутизатор.
