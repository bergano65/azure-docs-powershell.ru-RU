...
Создает запись RuleGroupOverride с именем группы в качестве $ruleName, а правила — $rule 1, $rule 2. Назначает тот же самый $overrideEntry
...
### -RuleGroupName
Укажите ruleGroupName в записи переопределения RuleGroup.
