...
## NОПИСАНИЕ
Командлет **Disconnect-AzP2sVpnGatewayVpnConnection** позволяет отключить текущую точку с подключением к сайту из P2SVpnGateway.
...
### -ResourceId
Идентификатор ресурса шлюза виртуальной сети P2s
