...
### ByVpnServerConfigurationName (по умолчанию)
```
...
Команда, описанная выше, удалит существующий VpnServerConfiguration.
...
### -InputObject
Объект vpnServerConfiguration, который нужно удалить.
...
### -ResourceId
Идентификатор ресурса Azure для vpnServerConfiguration, который нужно удалить.
