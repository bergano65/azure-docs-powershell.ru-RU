...
## NОПИСАНИЕ
Командлет **Remove-AzVirtualRouter** удаляет Azure VirtualRouter
...
### -InputObject
Входной объект виртуального маршрутизатора.
...
### -ResourceId
Идентификатор ресурса виртуального маршрутизатора.
