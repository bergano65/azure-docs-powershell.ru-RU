...
Вторая команда обновляет конфигурацию автомасштабирования с шлюза приложений.
...
### -MaxCapacity
Максимальная емкость для шлюза приложений.
...
### -MinCapacity
Минимальная емкость для шлюза приложений.
