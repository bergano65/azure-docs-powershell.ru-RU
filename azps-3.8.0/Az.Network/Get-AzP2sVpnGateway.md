...
## NОПИСАНИЕ
Командлет **Get-AzP2sVpnGateway** позволяет получить существующий P2SVpnGateway в разделе VirtualHub.
...
Командлет **Get-AzP2sVpnGateway** позволяет получить существующий P2SVpnGateway в разделе VirtualHub, который используется для подключения к сайту.
