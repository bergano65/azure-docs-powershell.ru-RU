...
В приведенном выше примере будет создана таблица маршрутов, состоящая из нескольких маршрутов и подключенных к новому виртуальному концентратору.

Это объект из памяти, который можно использовать для добавления таблицы маршрутов в новую или существующую VirtualHub.
