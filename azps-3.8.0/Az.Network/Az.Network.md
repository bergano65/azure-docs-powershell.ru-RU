...
Обновите ресурс журнала потока.
...
Отключите VPN-подключение к шлюзу виртуальной сети.

### [Разъединить — AzP2sVpnGatewayVpnConnection](Disconnect-AzP2sVpnGatewayVpnConnection.md)
Отключите VPN-соединение P2S VPN Gateway.
