...
## NОПИСАНИЕ
**Новый параметр-AzApplicationGatewayFirewallPolicyManagedRule** создает управляемые правила для политики брандмауэра.
...
Команда создает управляемые правила список ManagedRuleSet с $managedRuleSet и список исключений с записями $exclusion 1, $exclusion 2.
...
### -ManagedRuleSet
Список управляемых наборов правил.
