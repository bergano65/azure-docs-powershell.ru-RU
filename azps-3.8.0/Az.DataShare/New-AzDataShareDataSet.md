...
## NОПИСАНИЕ
Командлет **New-AzDataShareDataSet** добавьте наборы данных в общий доступ к данным Azure учетной записи общего доступа к данным. Вы можете добавлять наборы данных типа BLOB, ADLS Gen2 и ADLS Gen1.
...
Эта команда добавляет набор данных с именем AdsDataSet контейнера больших двоичных объектов в Azure Data Share AdsShare.
...
### -AdlsGen1FolderPath
Путь к папке ADLS Gen1 хранилища Azure
...
### -FileName
ADLS Gen1 имя файла хранилища Azure
