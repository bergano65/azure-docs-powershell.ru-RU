...
## NОПИСАНИЕ
Командлет **Set-AzStackEdgeRole** обновляет роль IOT для краевого устройства стека. Старые смонтированные общие ресурсы будут заменены новыми, предоставленными в параметре ShareName.
...
Общий доступ к именам заменяет старые подключенные общие ресурсы с помощью вновь предоставленных файлов
...
Отключение всех общих ресурсов
