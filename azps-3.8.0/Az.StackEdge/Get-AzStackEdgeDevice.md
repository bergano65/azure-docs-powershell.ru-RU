...
## NОПИСАНИЕ
Командлет **Get-AzStackEdgeDevice** получает сведения о доступных устройствах подбора стеков. Вы можете указать имя устройства вместе с именем группы ресурсов, чтобы получить сведения на конкретном устройстве. 
...
### -Alert (оповещение)
Получение оповещений на пограничном устройстве/шлюзе стека
...
### -ExtendedInfo
Возвращает дополнительные сведения о указанном расположении стека или шлюзе стека.
...
### -NetworkSetting
Возвращает сетевые параметры указанного устройства с краевым интерфейсом или шлюзом стека
