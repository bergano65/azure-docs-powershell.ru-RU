...
## NОПИСАНИЕ
Командлет **Set-AzStackEdgeStorageAccountCredential** обновляет данные учетной записи хранения, соответствующие учетной записи хранения на пограничном устройстве стека.
