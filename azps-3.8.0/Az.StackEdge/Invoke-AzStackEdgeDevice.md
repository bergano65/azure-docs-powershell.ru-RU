...
## NОПИСАНИЕ
Командлет **Invoke-AzStackEdgeDevice** вызывает действия для проверки, скачивания и установки обновлений на пограничном устройстве стека. Функция автоматического сканирования запускается ежедневно на устройстве, и вы можете выполнить проверку явным образом, запустив этот командлет.
...
### -FetchUpdate
Загружает обновления на пограничном устройстве или шлюзе с стеком
...
### -InstallUpdate
Установка обновлений на пограничном устройстве с интерфейсом Edge/Gateway
...
### -ScanForUpdate
Проверка наличия обновлений на пограничном устройстве/шлюзе стека.
