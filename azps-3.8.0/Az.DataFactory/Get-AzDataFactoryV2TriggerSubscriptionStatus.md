...
## NОПИСАНИЕ
Эта команда возвращает состояние подписки для триггера событий с указанными внешними событиями службы. Триггер не может быть запущен, пока не будет возвращено состояние "включено".
...
Эта команда получит состояние триггера subscribtion для BlobEnetTrigger1 внешних событий службы.
