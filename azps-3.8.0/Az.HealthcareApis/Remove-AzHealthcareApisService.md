...
Удаляет существующую службу HealthcareApis с указанным именем в указанной группе ресурсов.
...
Удаляет существующую службу HealthcareApis с указанным ResourceId.
...
Удаляет объект службы HealthcareApis, указанный в списке.
...
### -InputObject
Объект обслуживания HealthcareApis
...
### -PassThru
Если он указан, возвращает значение истина, если операция выполнена успешно
