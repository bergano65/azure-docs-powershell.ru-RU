...
## NОПИСАНИЕ
Командлет **restarting-AzDeploymentManagerRollout** перезапускает сбой и возвращает объект, который представляет собой все подробные сведения о ходе выпуска.
