...
Дополнительная задержка (в миллисекундах), с которой зонды должны попадать в сегмент минимальной задержки. Значение по умолчанию: 0
...
### -SampleSize
Количество примеров для принятия решений об балансировке нагрузки.
...
Количество образцов в периоде выборки, которые должны успешно пройти по умолчанию: 2
