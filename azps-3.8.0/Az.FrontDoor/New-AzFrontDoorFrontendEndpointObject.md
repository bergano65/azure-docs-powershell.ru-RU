...
Создайте объект PSFrontendEndpoint для создания передней дверцы.
...
### -MinimumTlsVersion
Минимальная версия TLS, необходимая на клиентах для установления подтверждения SSL с помощью передней дверцы.
