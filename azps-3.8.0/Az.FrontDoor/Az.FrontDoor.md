...
Создание объекта PSBackendPoolsSettings для создания передней дверцы
...
Создание объекта исключения управляемого правила для наборов управляемых правил WAF, групп или правил
