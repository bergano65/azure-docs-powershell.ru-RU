...
## NОПИСАНИЕ
Командлет **Remove-AzBatchNodeFile** удаляет пакетный файл узла Azure для задачи или вычислительного узла.
...
Чтобы получить **PSNodeFile** , используйте командлет Get-AzBatchNodeFile.
