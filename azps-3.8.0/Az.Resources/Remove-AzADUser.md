...
### Пример 1. Удаление пользователя по имени пользователя
...
Возвращает пользователя с объектным ид '7a9582cf-88c4-4319-842b-7a5d60967a69' и каналами, которые можно Remove-AzADUser, чтобы удалить пользователя из клиента.
...
### -UPNOrObjectId
Имя пользователя или objectId удаляемого пользователя.
