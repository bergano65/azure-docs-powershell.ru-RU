...
## NОПИСАНИЕ
Обновляет существующее приложение Azure Active Directory.
Чтобы обновить учетные данные, связанные с этим приложением, используйте командлет New-AzADAppCredential.
...
Возвращает приложение с идентификатором объекта "fb7b3405-CA44-4b5b-8584-12392f5d96d7" и каналами, которые должны использовать командлет Update-AzADApplication для обновления отображаемого имени приложения на "MyNewDisplayName".
