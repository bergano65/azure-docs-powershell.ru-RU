...
## NОПИСАНИЕ
Командлет **New-AzPolicyDefinition** создает определение политики, включающее правило политики в формате JavaScript Object Notation (JSON).
...
### Пример 5: Создание определения политики в строке "режим"
```
...
Эта команда создает определение политики с именем TagsPolicyDefinition с режимом "indexed", которое указывает, что политика должна оцениваться только для типов ресурсов, поддерживающих Теги и расположение.
