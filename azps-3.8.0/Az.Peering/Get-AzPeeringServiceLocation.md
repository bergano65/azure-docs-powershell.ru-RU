...
## NОПИСАНИЕ
Перечислите расположения для пиринга.
...
Получение местоположений пиринга для Вашингтоне.
...
### Microsoft. Azure. PowerShell. командлеты. Peer (Models. PSPeeringServiceLocation)
