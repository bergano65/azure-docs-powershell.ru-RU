...
## NОПИСАНИЕ
Получает одноранговые элементы из подписки, группы ресурсов или по имени.
...
Получает все ресурсы для подписки.
...
Возвращает пиринг Exchange с именем `myExchangePeering1`
...
Возвращает пиринг Exchange с именем `myExchangePeering1` , зависящим от идентификатора ресурса.
