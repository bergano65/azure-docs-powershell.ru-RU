...
### [Ввод-AzWebAppContainerPSSession](Enter-AzWebAppContainerPSSession.md)
Открытие удаленного сеанса PowerShell в контейнере Windows, указанном на данном сайте или в области, и данной группе ресурсов.
...
Создает объект, представляющий путь к хранилищу Azure, который нужно подключить к веб-приложению. Он предназначен для использования в качестве параметра (-AzureStoragePath) для Set-AzWebApp и Set-AzWebAppSlot

### [New-AzWebAppBackup](New-AzWebAppBackup.md)


### [New-AzWebAppContainerPSSession](New-AzWebAppContainerPSSession.md)
New-AzWebAppContainerPSSession создаст новый сеанс удаленной оболочки PowerShell в контейнере Windows, указанном на данном сайте или в области, и заданной группе ресурсов.
...
Получает параметры ограничения доступа для веб-приложения Azure.

### [Update-AzWebAppAccessRestrictionConfig](Update-AzWebAppAccessRestrictionConfig.md)
Обновите конфигурацию наследования сайтов SCM для веб-приложения Azure.

### [Add-AzWebAppAccessRestrictionRule](Add-AzWebAppAccessRestrictionRule.md)
Добавляет ограничение доступа к веб-приложению Azure.

### [Remove-AzWebAppAccessRestrictionRule](Remove-AzWebAppAccessRestrictionRule.md)
Удаление ограничения на доступ к веб-приложению Azure