...
### -NegateCondition
Указывает, следует ли инвертировать результат этого условия.
...
### -Selector
Имя средства выбора для сопоставления
...
### -Transform
Преобразование для применения перед совпадением.
Допустимые значения — строчные и прописные
