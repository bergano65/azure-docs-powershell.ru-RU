...
## NОПИСАНИЕ
С помощью **Remove-AzServiceFabricSetting** удалите из кластера параметры структуры обслуживания.
...
### -Параметр
Имя параметра в параметре "структура"
...
### -Раздел
Название раздела параметра "структура"
