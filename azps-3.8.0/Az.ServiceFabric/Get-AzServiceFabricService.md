...
## NОПИСАНИЕ
Этот командлет получит сведения о службе в указанном приложении и кластере.
...
В этом примере получает сведения о ресурсе службы для службы "testApp ~ testService".
...
В этом примере показано получение списка служб в приложении "testApp".
