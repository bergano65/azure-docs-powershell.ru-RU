...
## NОПИСАНИЕ
Командлет **Get-AzNetAppFilesPool** получает сведения о пуле ANF.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение пула ANF
```
...
Эта команда получает учетную запись с именем MyAnfPool из учетной записи "MyAnfAccount".
...
### -AccountObject
Объект Account, содержащий пул, который нужно вернуть.
