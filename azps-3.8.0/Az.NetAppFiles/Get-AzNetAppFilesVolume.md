...
## NОПИСАНИЕ
Командлет **Get-AzNetAppFilesVolume** получает сведения о томе ANF.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение ANFого тома
```
...
Эта команда получает том с именем MyAnfVolume из пула "MyAnfPool". 
...
### -PoolObject
Объект пула, содержащий том, который нужно вернуть.
