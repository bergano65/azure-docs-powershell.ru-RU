...
## КРАТКИй обзор
Создает новый объект типа PSIncludedPath. Она может быть передана в качестве значения параметра Set-AzCosmosDBSqlContainer.
...
## NОПИСАНИЕ
Объект, соответствующий IncludedPath API SQL.
