...
## КРАТКИй обзор
Создает новый объект типа PSIndexes. Она может быть передана в качестве значения параметра Set-AzCosmosDBGremlinIncludedPath.
...
## NОПИСАНИЕ
Объект, соответствующий индексам IncludedPath's API Gremlin.
...
Возможные значения: "строка", "число", "точечный", "Многоугольник", "LineString", "Многоугольный"
...
Возможные значения: "хэш", "диапазон", "пространственный"
