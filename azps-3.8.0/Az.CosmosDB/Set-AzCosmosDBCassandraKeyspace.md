...
## КРАТКИй обзор
Задает CosmosDB Cassandra keyspace.
...
## NОПИСАНИЕ
Командлет **Set-AzCosmosDBCassandraKeyspace** задает CosmosDB Cassandra keyspace.
...
Объект Resource (ресурс) включает значения свойств _rid, _ts и _etag.
