...
## КРАТКИй обзор
Создает новый объект типа PSCompositePath. Она может быть передана в качестве значения параметра Set-AzCosmosDBGremlinGraph.
...
## NОПИСАНИЕ
Объект, соответствующий CompositePath API Gremlin.
