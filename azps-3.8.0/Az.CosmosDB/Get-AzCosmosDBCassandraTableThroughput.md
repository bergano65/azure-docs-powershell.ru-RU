...
## КРАТКИй обзор
Возвращает значение пропускной способности таблицы Cassandra.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBCassandraTableThroughput** получает объект пропускной способности, соответствующий заданному keyspace.
