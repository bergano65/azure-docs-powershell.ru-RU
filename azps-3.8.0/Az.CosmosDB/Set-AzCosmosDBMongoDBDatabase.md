...
## КРАТКИй обзор
Задает базу данных CosmosDB MongoDB
...
## NОПИСАНИЕ
Командлет **Set-AzCosmosDBMongoDBDatabase** получает базу данных CosmosDB MongoDB.
...
Объект Resource (ресурс): _rid, _ts _etag свойств.
...
Пропускная способность Mongo базы данных (RU/s).
