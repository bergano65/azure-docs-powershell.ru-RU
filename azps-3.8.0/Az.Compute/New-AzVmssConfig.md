...
Процент (емкость масштабируемости) виртуальных машин, которые будут одновременны восстановлены. По умолчанию используется значение 20%.
