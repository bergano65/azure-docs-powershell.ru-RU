...
Укажите IP-конфигурацию для частного IP-адреса.  По умолчанию используется протокол IPv4.  Возможные значения: "IPv4" и "IPv6".
...
Укажите IP-конфигурацию для общедоступного IP-адреса.  По умолчанию используется протокол IPv4.  Возможные значения: "IPv4" и "IPv6".
