...
Эта команда приостанавливает службу автоматического восстановления на VMSS "vmss1" в группе ресурсов "RG".
...
Эта команда возобновляет службу автоматического восстановления на VMSS "vmss1" в группе ресурсов "RG".

## ПАРАМЕТРЫ

### -Action (действие)
Действие, которое нужно выполнить.  Возможны следующие значения: "возобновить", "приостановить".
...
### -InputObject
Локальный объект для набора шкал виртуальной машины.
