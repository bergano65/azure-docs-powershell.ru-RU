...
## NОПИСАНИЕ
Командлет **Set-AzVMAEMExtension** обновляет конфигурацию виртуальной машины, чтобы включить или обновить поддержку наблюдения для систем SAP, установленных на виртуальной машине.
...
### -InstallNewExtension
Установите новое расширение ВМ для SAP.
...
Задает для доступа удостоверения виртуальной машины индивидуальные ресурсы, например диски с данными, а не полную группу ресурсов.
