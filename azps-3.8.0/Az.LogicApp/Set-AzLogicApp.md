...
## NОПИСАНИЕ
Командлет **Set-AzLogicApp** изменяет приложение логики с помощью функции приложения логики.
...
Вы можете изменить логическое приложение, указав имя, расположение, определение приложения логики, группу ресурсов и план.
...
### Пример 1: изменение логики приложения
```
...
Эта команда изменяет логическое приложение.
...
### -UseConsumptionModel
Указывает на то, что для логики выставления счетов в приложении используется модель на основе потребления.
