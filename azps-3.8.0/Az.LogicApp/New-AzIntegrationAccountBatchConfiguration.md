...
## NОПИСАНИЕ
Командлет **Get-AzIntegrationAccountBatchConfiguration** создает новую конфигурацию пакета в учетной записи интеграции.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание новой конфигурации пакета с помощью локального файла
```powershell
...
Создает новую пакетную конфигурацию с помощью локального файла, расположенного в папке "$batchConfigurationFilePath".

### Пример 2: создание новой конфигурации пакета с помощью строки JSON
```powershell
...
Создает новую пакетную конфигурацию с помощью строки JSON, содержащейся в разделе "$batchConfigurationContent".

### Пример 3: создание новой конфигурации пакета с помощью параметров
```powershell
...
Создает новую конфигурацию пакета, предоставляя все необходимые параметры вручную.
