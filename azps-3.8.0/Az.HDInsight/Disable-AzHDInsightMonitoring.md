...
## NОПИСАНИЕ
Командлет **Disable-AzHDInsightMonitoring** отключает мониторинг в кластере Azure HDInsight.
...
Наблюдение будет отключено в кластере HDInsight, и связанные журналы будут прекращаться в рабочую область Monitoring.
...
### -Name (имя)
Имя кластера для отключения наблюдения.
