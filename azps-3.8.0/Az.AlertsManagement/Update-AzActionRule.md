...
## NОПИСАНИЕ
Командлет **Update-AzActionRule** обновляет свойства правила действия — status и Tags.
...
Этот командлет отключает правило действия. 
...
### -ResourceId
Идентификатор ресурса для правила действия
