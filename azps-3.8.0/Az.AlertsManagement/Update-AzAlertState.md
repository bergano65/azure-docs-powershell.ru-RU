...
## NОПИСАНИЕ
**Update-AzAlertState** . состояние предупреждения обновления командлетов.
...
Этот командлет обновляет состояние предупреждения на Closed.
...
### -State
Обновленное состояние оповещения
