...
## NОПИСАНИЕ
Командлет **Remove-AzActionRule** удаляет правило действия.
...
Этот командлет удаляет правило действия с именем ActionRuleName в группе ресурсов Test-RG
