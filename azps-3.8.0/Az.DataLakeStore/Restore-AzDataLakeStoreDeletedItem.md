...
## NОПИСАНИЕ
Командлет **RESTORE-AzDataLakeStoreDeletedItem** восстанавливает удаленный файл или папку в Data Lake Store. Требуется путь удаленного элемента в корзине, возвращенной функцией Get-AzDataLakeStoreDeletedItem.
