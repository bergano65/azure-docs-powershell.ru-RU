...
## NОПИСАНИЕ
Командлеты **Stop-AzServiceBusMigration** прерывает миграцию между стандартным и расширенным пространством имен
...
Командлет завершает миграцию между стандартным пространством имен и пространством имен Premium, указанным при создании конфигурации миграции.
...
### -InputObject
Объект стандартного пространства имен для настройки миграции служебной шины
...
### -ResourceId
Идентификатор ресурса стандартного пространства имен для настройки миграции служебной шины
