...
## NОПИСАНИЕ
Командлет **Set-AzServiceBusRule** обновляет описание указанного правила данной подписки.
...
Обновляет выражение SQL Expression **mysqlexpression = "Condition"** правила `SBRule` подписки `SBSubscription` в разделе `SBTopic`
