...
## NОПИСАНИЕ
Командлет Get-AzSqlElasticJobAgent получает один или несколько агентов эластичных заданий
...
Получает агент эластичных заданий
