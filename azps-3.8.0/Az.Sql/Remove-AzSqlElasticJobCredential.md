...
## NОПИСАНИЕ
Командлет Remove-AzSqlElasticJobCredential удаляет учетные данные задания
...
Удаление учетных данных задания
...
### -ResourceId
Идентификатор ресурса для учетных данных задания
