...
## NОПИСАНИЕ
Командлет **Get-AzSqlSyncGroup** возвращает сведения о одной или нескольких группах синхронизации базы данных Azure SQL.
...
### Пример 3: получение всех экземпляров группы синхронизации SQL Azure, назначенных базе данных Azure SQL с помощью фильтрации
```
...
Эта команда получает сведения обо всех группах синхронизации базы данных SQL Azure, назначенных базе данных Azure SQL, которые начинаются с "SyncGroup".
