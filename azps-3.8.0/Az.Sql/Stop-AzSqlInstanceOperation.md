...
### StopByNameAndManagedInstanceAndResourceGroupParameterSet (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет Stop-AzSqlInstanceOperation прекращает операцию с указанным именем операции в управляемом экземпляре SQL.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение определенной операции
```powershell
...
Эта команда останавливает операцию с именем "d0f5bef5-e2b1-4ef8-bb42-2e54073874f9" в управляемом экземпляре SQL.

### Пример 2: использование идентификатора ресурса операции
```powershell
...
Эта команда останавливает операцию с идентификатором ресурса $managedInstanceOperation. ID.

### Пример 3: использование объекта Operation
```powershell
...
Эта команда останавливает операцию с объектом $managedInstanceOperation.
...
### -ResourceId
Идентификатор ресурса для объекта Operations, который нужно остановить
