...
## NОПИСАНИЕ
Создание модуля на целевом устройстве IoT с различными типами авторизации в центре Интернета вещей.
...
Создание модуля на целевом устройстве IoT для проверки подлинности по умолчанию (общего закрытого ключа).
