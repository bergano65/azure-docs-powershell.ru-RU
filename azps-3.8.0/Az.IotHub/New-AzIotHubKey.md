...
Повторно создан первичный ключ для политики авторизации "testKey" центра Azure IOT.

### Пример 2 клавиши для замены
```
...
Переключение клавиш для политики авторизации "testKey" центра Azure IOT.
