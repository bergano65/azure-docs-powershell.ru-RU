...
## NОПИСАНИЕ
Добавляйте до 10 обогащенных сообщений на центр Интернета вещей. Они добавляются в виде свойств приложения для сообщений, отправляемых в выбранные конечные точки.
Дополнительные сведения можно найти в разделе https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Добавьте новое обогащение с помощью клавиши "newKey" и значения "newValue". Это новое обогащение применяется к конечным точкам "endpoint1" и "Endpoint2".
...
### -Endpoint
Конечные точки, к которым нужно применить обогащенные элементы.
