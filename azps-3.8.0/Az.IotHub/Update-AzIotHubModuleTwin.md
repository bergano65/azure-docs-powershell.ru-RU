...
## NОПИСАНИЕ
Обновляет или заменяет двойной устройства. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twinsДля получения дополнительных сведений ознакомьтесь с дополнительными сведениями.
...
Возвращает обновленный объект модуля устройства двойной.
...
Возвращает объект двойной модуля устройства с обновленными необходимыми свойствами.
...
Возвращает объект двойной модуля устройства со обновленным свойством Tags.
...
Возвращает заменяющий объект двойной модуля устройства.
...
### -Необходимый
Добавьте или обновите нужное свойство в модуле двойной.
...
### -Partial
Позволяет только частично обновлять Теги и нужные свойства модуля двойной.
...
### -Тег
Добавьте или обновите свойство Tags в модуле двойной.
