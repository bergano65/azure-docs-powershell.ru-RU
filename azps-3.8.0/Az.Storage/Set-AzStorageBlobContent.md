...
Эта команда передает файл с именем ContosoPlanning в контейнер с именем ContosoUploads с указанными свойствами BLOB-объектов и устанавливает StandardBlobTier как круто.
