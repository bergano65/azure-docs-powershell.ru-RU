...
Этот командлет задает для типа метрик службы хранилища Azure значение, которое указывает этот параметр.
...
### Microsoft. Azure. Storage. Sharing. Protocol. MetricsProperties
