...
Первый командлет отключает политику защиты резервных копий.

## ПАРАМЕТРЫ

### -BackupManagementType
Тип управления резервным копированием ресурса (например: MAB, DPM).
...
### -WorkloadType
Тип рабочей нагрузки ресурса (например,: AzureVM, WindowsServer, AzureFiles).
