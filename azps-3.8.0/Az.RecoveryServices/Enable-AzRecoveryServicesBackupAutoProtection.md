...
## NОПИСАНИЕ
Командлет **Enable-AzRecoveryServicesBackupAutoProtection** задает политику защиты автоматической архивации Azure для защищенного элемента.
...
Второй командлет задает политику защиты резервного копирования для AzureWorkload с помощью политики в $Pol.

## ПАРАМЕТРЫ

### -BackupManagementType
Тип резервного управления для ресурса (например, MAB, DPM, AzureWorkload).
...
### -InputItem
Указывает объект с защитой элемента, который можно передать в качестве входных данных.
