...
Использование параметра FriendlyName может привести к возврату нескольких файловых ресурсов Azure. В таких случаях используйте параметр-Name с значением Parameter в качестве свойства Name, возвращаемого в переменной $BackupItem.
