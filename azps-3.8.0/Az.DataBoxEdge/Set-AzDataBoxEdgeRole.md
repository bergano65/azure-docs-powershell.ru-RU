...
## NОПИСАНИЕ
Командлет **Set-AzDataBoxEdgeRole** обновляет роль IOT для поля данных Device Edge. Старые смонтированные общие ресурсы будут заменены новыми, предоставленными в параметре ShareName.
