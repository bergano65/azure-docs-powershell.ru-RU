...
### BandwidthParameterSet (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет **New-AzDataBoxEdgeBandwidthSchedule** создает новое расписание пропускной способности для поля с пограничным устройством, которое помогает управлять использованием пропускной способности.
...
### -UnlimitedBandwidth
Задаст неограниченную пропускную способность, если для параметра "ложь" задано значение по умолчанию 20 Мбит/с
