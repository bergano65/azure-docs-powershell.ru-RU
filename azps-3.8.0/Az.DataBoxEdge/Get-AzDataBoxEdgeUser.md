...
## NОПИСАНИЕ
Командлет **Get-AzDataBoxEdgeUser** содержит список пользователей, настроенных на пограничном устройстве для поля данных. Вы можете упомянуть имя в параметрах, чтобы получить сведения о конкретном пользователе.
