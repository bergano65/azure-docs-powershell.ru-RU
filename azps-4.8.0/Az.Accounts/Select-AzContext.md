...
Выберите подписку и учетную запись, которую необходимо назначить в командлетах PowerShell для Azure в этом сеансе PowerShell. (автоматически сформированные)
