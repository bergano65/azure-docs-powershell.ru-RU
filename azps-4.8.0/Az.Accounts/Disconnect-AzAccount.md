...
### Пример 1: выход из текущей учетной записи
```powershell
...
### Пример 2: выход из учетной записи, связанной с определенным контекстом
```powershell
...
### Пример 3: выход из определенного пользователя
```powershell
