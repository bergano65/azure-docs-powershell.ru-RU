...
## NОПИСАНИЕ
Командлет **Remove-AzDeploymentManagerArtifactSource** удаляет источник артефакта, указав его имя и имя группы ресурсов. Кроме того, можно предоставить объект ArtifactSource или ResourceId.
