...
## NОПИСАНИЕ
Командлет **Update-AzCognitiveServicesAccountNetworkRuleSet** обновляет свойство NetworkRule учетной записи службы.
...
### Пример 3: Очистка правил NetworkRule учетной записи службы
```
...
Эта команда очищает правила для NetworkRule учетной записи службы (другие свойства не изменяются).

## ПАРАМЕТРЫ

### -DefaultAction
Учетная запись службы NetworkRule DefaultAction. Значение по умолчанию `Deny` .
