...
## NОПИСАНИЕ
Поворот ключа шифрования диска для указанного кластера HDInsight. Для этой операции кластер должен иметь доступ к текущему ключу и предполагаемому новому ключу, в противном случае произойдет сбой операции с клавишей "поворот".
...
[Шифрование диска с управляемым ключом пользователя](https://docs.microsoft.com/en-us/azure/hdinsight/disk-encryption)
