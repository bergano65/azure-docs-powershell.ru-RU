...
## NОПИСАНИЕ
New-AzHDInsightCluster создает кластер HDInsight Azure, используя указанные параметры или объект конфигурации, созданный с помощью командлета New-AzHDInsightClusterConfig.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Создание кластера HDInsight Azure
```
...
### Пример 2: Создание кластера с помощью шифрования диска с управляемым пользователем ключом
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Пример 3: Создание кластера HDInsight Azure, который обеспечивает шифрование в пути
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Пример 4: Создание кластера HDInsight для Azure с помощью функции Private Link
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Пример 5: Создание кластера HDInsight Azure, который обеспечивает шифрование на узле
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
### Пример 6: Создание кластера HDInsight Azure, который включает Автомасштабирование.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
Вы также можете использовать командлет Add-AzHDInsightStorage.
...
Доступны следующие варианты: Hadoop, HBase, INTERACTIVEHIVE, Kafka и RServer
...
Этот объект можно создать с помощью командлета New-AzHDInsightClusterConfig.
...
Вы также можете использовать командлет Add-AzHDInsightConfigValues.
...
Вы также можете использовать командлет Set-AzHDInsightDefaultStorage.
...
### -DisksPerWorkerNode
Задает количество дисков для роли узла рабочего процесса в кластере.
...
Возвращает или задает тип исходящего доступа к общедоступной сети.
...
Возвращает или задает тип доступа к общедоступной сети.
...
Вы также можете использовать командлет Add-AzHDInsightSecurityProfile.
