...
## NОПИСАНИЕ
Командлет **New-AzRecoveryServicesAsrPolicy** создает политику репликации восстановления сайта Azure.
...
### -AzureToAzure
Параметр Switch указывает сценарий для создания политики Azure для Azure.
...
### -AzureToVMware
Параметр Switch указывает сценарий для создания политики Azure для vMWare.
