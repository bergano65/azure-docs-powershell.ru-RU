...
## ОПИСАНИЕ
Для защищенных элементов в контейнере Azure Site Recovery Protection возвращается **cmdlet Get-AzRecoveryServicesAsrProtectableItem.**
...
Получите защищенные элементы в указанном контейнере защиты ASR с заданным понятным именем.
...
### -ProtectionContainer
Указывает объект Контейнера для защиты от восстановления сайта Azure.
