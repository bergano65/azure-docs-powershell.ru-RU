...
## NОПИСАНИЕ
Параметр **Get-AzRecoveryServicesAsrEvent** получает список событий в хранилище на основе указанных фильтров выделения.
...
### -ResourceId
Указывает ResourceId события для события.
