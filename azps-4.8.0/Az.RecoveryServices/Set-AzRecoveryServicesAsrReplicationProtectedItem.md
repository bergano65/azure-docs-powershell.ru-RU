...
Начните операцию обновления для указанного элемента, защищенного репликацией, чтобы использовать предоставленную группу размещения близких для отработки отказа виртуальной машины.
...
Указывает идентификатор ресурса группы размещения для восстановления, на которую следует отработка отказа виртуальной машины.
