...
Добавьте CER-файл сертификата ЦС в службу подготовки устройств центра Azure IoT.
...
Обновляет сертификат ЦС в службе подготовки устройств центра Интернета вещей, загружая новый файл CER. 
