...
### -Подписавшего
Указывает веб-токен JSON RFC7519, содержащий утверждение "Maa-policyCertificate", значение которого является веб-ключом RFC7517 JSON, который содержит новый доверенный ключ подписи для добавления.
