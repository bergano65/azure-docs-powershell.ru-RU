...
## КРАТКИй обзор
Создание объекта профиля контакта в службе поддержки.
...
## NОПИСАНИЕ
Это вспомогательный командлет, с помощью которого можно создать объект профиля контакта поддержки при создании или обновлении билета в службу поддержки. Необходимо указать следующие параметры, которые являются обязательными для создания билета службы поддержки. 
