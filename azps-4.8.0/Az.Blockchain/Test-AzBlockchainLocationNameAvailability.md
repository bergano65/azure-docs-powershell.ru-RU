...
### Пример 1: Проверка наличия имени ресурса
```powershell
...
Команда проверяет, доступно ли имя ресурса.

### Пример 2: Проверка наличия имени ресурса
```powershell
...
### -Name (имя)
Возвращает или задает имя для проверки.
...
### -Type (тип)
Возвращает или задает тип ресурса для проверки.
...
### Microsoft. Azure. PowerShell. командлеты. Blockchain. Models. Api20180601Preview. INameAvailability
