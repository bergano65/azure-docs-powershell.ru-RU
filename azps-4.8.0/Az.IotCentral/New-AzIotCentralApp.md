...
Создавайте центральное приложение Интернет вещей в ST2 ценовой категории Standard, в области группы ресурсов.
...
Создавайте центральное приложение IoT с помощью стандартной ценовой категории ST2 в области "westus" с настраиваемым отображаемым именем на основе шаблона IOTC-Default.
