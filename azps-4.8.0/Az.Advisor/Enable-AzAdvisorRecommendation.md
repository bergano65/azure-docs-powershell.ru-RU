...
## КРАТКИй обзор
Включает рекомендации для Azure Advisor (-ы).
...
## NОПИСАНИЕ
Этот командлет включает ранее подавленную рекомендацию. Вы можете также удалить все подавления, связанные с рекомендацией.
...
Удаляет все подавление для указанной рекомендации с именем "recommendation_id".
...
Удаляет все подавление для указанных рекомендаций, переданных из конвейера.
