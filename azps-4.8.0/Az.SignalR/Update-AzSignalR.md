...
### Обновите специальную службу сигнала.
```powershell
...
### -SKU
SKU службы SignalR.
По умолчанию используется значение "Standard_S1".
...
### -UnitCount
Счетчик единиц услуги SignalR имеет значение только от {1, 2, 5, 10, 20, 50, 100}.
