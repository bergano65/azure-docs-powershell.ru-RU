...
## Выкомандлеты AZ. Storage
### [Add-AzRmStorageContainerLegalHold](Add-AzRmStorageContainerLegalHold.md)
Добавляет теги юридических удержаний в контейнер BLOB-объектов хранилища

### [Add-AzStorageAccountManagementPolicyAction](Add-AzStorageAccountManagementPolicyAction.md)
Добавляет действие в объект ManagementPolicy действия группы действий или создает объект группы действий ManagementPolicy с действием. Объект можно использовать в New-AzStorageAccountManagementPolicyRule.
...
### [Закрыть — AzStorageFileHandle](Close-AzStorageFileHandle.md)
...
Отключение политики восстановления больших двоичных объектов для учетной записи хранения.
...
Отключение статического веб-сайта для учетной записи хранения Azure.
...
Включение политики восстановления больших двоичных объектов в учетной записи хранения.
...
Применяет инструкцию SQL для простого структурированного запроса и сохраняет только запрашиваемое подмножество данных в локальном файле.

### [Get-AzStorageBlobServiceProperty](Get-AzStorageBlobServiceProperty.md)
Получение свойств службы для служб больших двоичных объектов хранилища Azure.
...
Выводит список дескрипторов файлов общего доступа, каталогов файлов и файлов.

### [Get-AzStorageFileServiceProperty](Get-AzStorageFileServiceProperty.md)
Получение свойств службы для файловых служб хранилища Azure.
...
Создание файла или папки в файловой системе.
...
Создание общего файлового файла хранилища.
...
Создает объект конфигурации запроса BLOB, который можно использовать в Get-AzStorageBlobQueryResult.
...
Создание правила политики репликации объектов.
...
Удаление политики управления для учетной записи хранения Azure.
...
Восстановление удаленного общего файлового файла.
...
Отмените все ключи делегирования пользователей для учетной записи хранения.
...
Создание или изменение политики управления учетной записи хранения Azure.
...
### [Остановить-AzStorageFileCopy](Stop-AzStorageFileCopy.md)
...
Изменение общего файлового файла хранилища.
...
Изменяет свойства службы для службы больших двоичных объектов хранилища Azure.

### [Update-AzStorageFileServiceProperty](Update-AzStorageFileServiceProperty.md)
Изменение свойств службы в службе файлов хранилища Azure.
