...
## NОПИСАНИЕ
Командлет **Update-AzStorageFileServiceProperty** изменяет свойства службы хранения файлов Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Включение общего доступа к файлам softdelete
```powershell
...
Эта команда включает softdelete "общий доступ к файлам" с днями хранения как 5
...
Включите общий доступ удаление политики хранения для учетной записи хранения, выбрав значение $true, отключите параметр Общий доступ удаление политики хранения с помощью значения $false.
...
### -ResourceId
Введите идентификатор ресурса учетной записи хранилища или идентификатор ресурса свойств службы файлов.
...
### -ShareRetentionDays
Задает количество дней хранения для DeleteRetentionPolicy общего доступа.
Значение должно быть установлено только в том случае, если параметр Включить общий доступ удаление политики хранения.
