...
## NОПИСАНИЕ
Командлет **Get-AzStorageObjectReplicationPolicy** получает или перечисляет политику репликации объектов для учетной записи хранения.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение политики репликации объектов с определенным идентификатором политики и отображение ее правил.
```
...
Эта команда получает политику репликации объектов с определенным идентификатором политики и отображает ее правила.

### Пример 2: список политики репликации объектов List из учетной записи хранения
```
...
Эта команда перечисляет политику репликации объектов из учетной записи хранения.
