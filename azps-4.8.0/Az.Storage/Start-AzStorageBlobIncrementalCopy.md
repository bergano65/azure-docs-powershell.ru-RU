...
### -CloudBlob
Объект CloudBlob из библиотеки клиента хранилища Azure. Вы можете создать его или воспользоваться командлетом Get-AzStorageBlob.
...
### -CloudBlobContainer
Объект CloudBlobContainer из библиотеки клиента хранилища Azure. Вы можете создать его или воспользоваться командлетом Get-AzStorageContainer.
...
### -Context
Контекст исходного хранилища Azure. Вы можете создать его с помощью New-AzStorageContext командлета.
...
### -DestContext
Контекст целевого хранилища Azure. Вы можете создать его с помощью New-AzStorageContext командлета.
