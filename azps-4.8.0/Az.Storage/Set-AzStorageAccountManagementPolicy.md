...
### Пример 1: создание или обновление политики управления учетной записи хранения с помощью объектов правил ManagementPolicy.
```
...
Эта команда сначала создает два объекта правила ManagementPolicy, а затем создает или обновляет политику управления учетной записи хранения с помощью объектов правила 2 ManagementPolicy.
...
Эта команда создает или обновляет политику управления учетной записи хранения с помощью политики формата JSON.

### Пример 3: получение политики управления из учетной записи хранения и назначение другой учетной записи хранения.
```
...
Эта команда сначала получает политику управления из учетной записи хранения, а затем присвойте ей другую учетную запись хранения.
...
### -Policy (политика)
Объект политики управления для настройки
...
### -Правило
Правила политики управления. Получение объекта с помощью New-AzStorageAccountManagementPolicyRule командлета.
