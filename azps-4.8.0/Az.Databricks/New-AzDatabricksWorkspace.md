...
### Пример 1: создание рабочей области для кирпичей
```powershell
...
Эта команда создает рабочую область кирпичей.

### Пример 2: создание рабочей области "кирпичи" с настроенной виртуальной сетью
```powershell
...
Эта команда создает рабочую область кирпичей с настроенной виртуальной сетью в группе ресурсов.

### Пример 3: создание рабочей области данных с включенным шифрованием
```powershell
...
Эта команда создает рабочую область модуля данных и задает ее для подготовки к шифрованию.
Дополнительные параметры шифрования можно найти в примерах Update-AzDatabricksWorkspace.
...
### -PrepareEncryption
Подготовьте рабочую область к шифрованию.
Включает управляемое удостоверение для управляемой учетной записи хранения.
...
### -PublicSubnetName
Имя общедоступной подсети в виртуальной сети.
...
Логическое значение, указывающее, будет ли включена корневая файловая система DBFS с дополнительным уровнем шифрования с управляемыми ключами платформы для данных на других платформах.
...
### -VirtualNetworkId
ИДЕНТИФИКАТОР виртуальной сети, в которой должен быть создан этот кластер модуля данных.
