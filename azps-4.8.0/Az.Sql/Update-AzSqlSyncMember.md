...
## NОПИСАНИЕ
Командлет **Update-AzSqlSyncGroup** изменяет свойства члена синхронизации базы данных SQL Azure.
...
Следует ли использовать частную ссылку при подключении к этому члену синхронизации.
