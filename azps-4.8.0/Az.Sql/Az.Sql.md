...
# AZ. SQL Module
## Nописание
В этом разделе отображаются разделы справки для командлетов базы данных SQL Azure.
...
Добавление целевого объекта в целевую группу

### [Add-AzSqlInstanceKeyVaultKey](Add-AzSqlInstanceKeyVaultKey.md)
Добавляет ключ хранилища ключей к указанному управляемому экземпляру. 
...
Добавляет прозрачный сертификат шифрования данных для заданного управляемого экземпляра.

### [Add-AzSqlServerKeyVaultKey](Add-AzSqlServerKeyVaultKey.md)
Добавляет ключ хранилища ключей на сервер SQL Server.
...
Очищает параметры оценки уязвимости управляемой базы данных.
...
Запрещает (отправку) рекомендации относительно чувствительности к столбцам базы данных.

### [Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication](Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication.md)
Отключение проверки подлинности Azure AD для определенного экземпляра, управляемого SQL.

### [Disable-AzSqlInstanceAdvancedDataSecurity](Disable-AzSqlInstanceAdvancedDataSecurity.md)
Отключение расширенной защиты данных на управляемом экземпляре.

### [Disable-AzSqlInstanceDatabaseSensitivityRecommendation](Disable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
Выключает (закрывает) рекомендации по пометкам для столбцов в базе данных SQL, управляемой службой Azure.

### [Disable-AzSqlServerActiveDirectoryOnlyAuthentication](Disable-AzSqlServerActiveDirectoryOnlyAuthentication.md)
Отключение проверки подлинности Azure AD для определенного сервера SQL Server.

### [Disable-AzSqlServerAdvancedDataSecurity](Disable-AzSqlServerAdvancedDataSecurity.md)
Отключение расширенной защиты данных на сервере.
...
Включает рекомендации по пометкам для столбцов (рекомендации включены по умолчанию во всех столбцах) в базе данных.
...
Включает рекомендации по пометкам для столбцов (рекомендации включены по умолчанию во всех столбцах) в базе данных SQL Server с управляемым экземпляром Azure.
...
Получает параметры расширенной защиты от угроз для базы данных.
...
Возвращает или перечисляет группы отработки отказа для экземпляра.
...
Возвращает одно или несколько рекомендованных действий для помощника по базам данных SQL Azure.
...
Возвращает текущие типы сведений и метки чувствительности к столбцам в базе данных.

### [Get-AzSqlDatabaseSensitivityRecommendation](Get-AzSqlDatabaseSensitivityRecommendation.md)
Получает Рекомендуемые типы сведений и метки чувствительности для столбцов в базе данных.
...
Получает ход выполнения сканирования TDE базы данных.
...
Получает все записи проверки уязвимостей, связанные с указанной базой данных.

### [Get-AzSqlDatabaseVulnerabilityAssessmentSetting](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
Получает параметры оценки уязвимости для базы данных.
...
Возвращает одну или несколько конечных групп заданий.

### [Get-AzSqlElasticPool](Get-AzSqlElasticPool.md)
Возвращает эластичные пулы и значения их свойств в базе данных Azure SQL.
...
Получает одно или несколько рекомендованных действий для советника по пулам эластичных БД SQL Azure.

### [Get-AzSqlInstance](Get-AzSqlInstance.md)
Возвращает сведения о экземпляре управляемой базы данных Azure SQL.

### [Get-AzSqlInstanceActiveDirectoryAdministrator](Get-AzSqlInstanceActiveDirectoryAdministrator.md)
Получение сведений об администраторе Azure AD для управляемого экземпляра SQL.

### [Get-AzSqlInstanceActiveDirectoryOnlyAuthentication](Get-AzSqlInstanceActiveDirectoryOnlyAuthentication.md)
Получает единственную проверку подлинности в Azure AD для определенного управляемого экземпляра SQL.

### [Get-AzSqlInstanceAdvancedDataSecurityPolicy](Get-AzSqlInstanceAdvancedDataSecurityPolicy.md)
Получает расширенную политику безопасности данных управляемого экземпляра.
...
Возвращает сведения об избыточной резервной копии базы данных SQL, управляемой с управлением Azure.
...
Возвращает долгосрочные резервные копии хранения.
...
Получает Рекомендуемые типы сведений и метки чувствительности столбцов в базе данных экземпляра SQL, управляемой с помощью Azure.
...
Возвращает все записи проверки уязвимостей, связанные с данной управляемой базой данных.

### [Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting](Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
Получает параметры оценки уязвимости управляемой базы данных.

### [Get-AzSqlInstanceKeyVaultKey](Get-AzSqlInstanceKeyVaultKey.md)
Получает ключи хранилища ключей управляемого экземпляра SQL.
...
Возвращает сведения об использовании пула экземпляров Azure SQL.

### [Get-AzSqlInstanceTransparentDataEncryptionProtector](Get-AzSqlInstanceTransparentDataEncryptionProtector.md)
Получает предохранитель прозрачного шифрования данных (TDE) для экземпляра, управляемого SQL.

### [Get-AzSqlInstanceVulnerabilityAssessmentSetting](Get-AzSqlInstanceVulnerabilityAssessmentSetting.md)
Получает параметры оценки уязвимости управляемого экземпляра.
...
Получает только Azure AD Authentication для определенного сервера SQL Server.
...
Получает параметры аудита для Azure SQL Server.
...
Возвращает конфигурацию восстановления системы сервера баз данных.
...
Получает или перечисляет DNS-псевдоним Azure SQL Server.

### [Get-AzSqlServerFirewallRule](Get-AzSqlServerFirewallRule.md)
Возвращает правила брандмауэра для сервера базы данных SQL.
...
Получает одно или несколько рекомендованных действий для советника SQL Server Azure.
...
Получает параметры оценки уязвимости для сервера.
...
Возвращает сведения о базах данных SQL Server, связанных агентом синхронизации.
...
Возвращает сведения о членах синхронизации базы данных Azure SQL.
...
Отработка отказа управляемый экземпляр Azure SQL.
...
Импортирует BACPAC-файл и создает на сервере новую базу данных.
...
Создает новую точку восстановления, из которой можно восстановить базу данных SQL.

### [New-AzSqlDatabaseSecondary](New-AzSqlDatabaseSecondary.md)
Создает базу данных-получатель для существующей базы данных и запускает репликацию данных.

### [New-AzSqlElasticJob](New-AzSqlElasticJob.md)
Создание нового задания

### [New-AzSqlElasticJobAgent](New-AzSqlElasticJobAgent.md)
Создание нового агента эластичных заданий
...
Создание новой конечной группы

### [New-AzSqlElasticPool](New-AzSqlElasticPool.md)
Создание пула эластичных баз данных для базы данных SQL.

### [New-AzSqlInstance](New-AzSqlInstance.md)
Создает экземпляр управляемой базы данных SQL для Azure.
...
Создание пула экземпляров Azure SQL.
...
Создает конфигурацию восстановления системы сервера баз данных.

### [New-AzSqlServerDnsAlias](New-AzSqlServerDnsAlias.md)
Эта команда создает новый DNS-псевдоним для Azure SQL Server.
...
Создание правила виртуальной сети для Azure SQL Server. 
...
Создает элемент синхронизации базы данных SQL Azure.

### [Remove-AzSqlDatabase](Remove-AzSqlDatabase.md)
Удаляет базу данных SQL Azure.

### [Remove-AzSqlDatabaseAudit](Remove-AzSqlDatabaseAudit.md)
Удаляет параметры аудита для базы данных SQL Azure.

### [Remove-AzSqlDatabaseDataMaskingRule](Remove-AzSqlDatabaseDataMaskingRule.md)
Удаление правила маскирования данных из базы данных.

### [Remove-AzSqlDatabaseFailoverGroup](Remove-AzSqlDatabaseFailoverGroup.md)
Удаляет группу отработки отказа базы данных Azure SQL.

### [Remove-AzSqlDatabaseFromFailoverGroup](Remove-AzSqlDatabaseFromFailoverGroup.md)
Удаление одной или нескольких баз данных из группы отработки отказа базы данных Azure SQL.

### [Remove-AzSqlDatabaseInstanceFailoverGroup](Remove-AzSqlDatabaseInstanceFailoverGroup.md)
Удаляет группу отработки отказа экземпляра.

### [Remove-AzSqlDatabaseLongTermRetentionBackup](Remove-AzSqlDatabaseLongTermRetentionBackup.md)
Удаление долгосрочной резервной копии хранения.
...
Удаление целевого объекта из целевой группы
...
Удаление администратора Azure AD для управляемого экземпляра SQL.

### [Remove-AzSqlInstanceDatabase](Remove-AzSqlInstanceDatabase.md)
Удаляет базу данных экземпляра SQL, управляемую с помощью Azure.
...
Удаление ключа хранилища ключей из управляемого экземпляра SQL
...
Удаляет администратора Azure Active Directory для SQL Server.

### [Remove-AzSqlServerAudit](Remove-AzSqlServerAudit.md)
Удаляет параметры аудита для Azure SQL Server.
...
Удаляет DNS-псевдоним Azure SQL Server.
...
Удаление ключа хранилища ключей из SQL Server.

### [Remove-AzSqlServerVirtualNetworkRule](Remove-AzSqlServerVirtualNetworkRule.md)
Удаляет правило виртуальной сети Azure SQL Server.

### [Remove-AzSqlSyncAgent](Remove-AzSqlSyncAgent.md)
Удаляет агент Azure SQL Sync.
...
Удаляет элемент синхронизации базы данных SQL Azure.

### [Remove-AzSqlVirtualCluster](Remove-AzSqlVirtualCluster.md)
Удаление виртуального кластера Azure SQL.
...
Возобновляет базу данных хранилища данных SQL.
...
Настройка политики хранения для серверной долгосрочной настройки.
...
Задает политику географического резервного копирования базы данных.
...
Обновляет состояние рекомендуемого действия для базы данных SQL Azure.
...
Задает типы данных и метки чувствительности для столбцов в базе данных.
...
Обновляет агент эластичных заданий
...
Обновляет состояние автоматического выполнения советника по пулам эластичных БД Azure SQL.
...
Командлет **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** задает долгосрочную политику хранения для управляемой базы данных.
...
Задает типы сведений и метки чувствительности для столбцов в базе данных SQL, управляемой службой Azure.
...
Изменяет свойства сервера базы данных SQL.
...
Изменяет сервер, на который указывает DNS-псевдоним Azure SQL Server.
...
Изменение конфигурации правила виртуальной сети для Azure SQL Server.
...
Запуск проверки с помощью оценки уязвимости.

### [Start-AzSqlElasticJob](Start-AzSqlElasticJob.md)
Запускает задание, возвращая идентификатор выполнения задания, который можно опросить, чтобы просмотреть его состояние
...
### [Остановить-AzSqlDatabaseActivity](Stop-AzSqlDatabaseActivity.md)
Отменяет операцию асинхронных обновлений для базы данных.
...
### [Остановить-AzSqlElasticJob](Stop-AzSqlElasticJob.md)
Остановка задания с учетом его идентификатора выполнения задания

### [Остановить-AzSqlElasticPoolActivity](Stop-AzSqlElasticPoolActivity.md)
Отменяет асинхронную операцию обновления в пуле эластичных БД.

### [Остановить-AzSqlInstanceDatabaseLogReplay](Stop-AzSqlInstanceDatabaseLogReplay.md)
Отменяет службу воспроизведения журнала, удаляя базу данных.

### [Остановить-AzSqlInstanceOperation](Stop-AzSqlInstanceOperation.md)
Прекращает выполнение операций управляемого экземпляра SQL.

### [Остановить-AzSqlSyncGroupSync](Stop-AzSqlSyncGroupSync.md)
Останавливает синхронизацию группы синхронизации.

### [Приостановить — AzSqlDatabase](Suspend-AzSqlDatabase.md)
Приостанавливает базу данных хранилища данных SQL.
...
Обновляет параметры оценки уязвимости для сервера.

### [Update-AzSqlSyncGroup](Update-AzSqlSyncGroup.md)
Обновляет группу синхронизации базы данных SQL Azure.
...
Обновите схему синхронизации для базы данных участника синхронизации или базы данных концентратора синхронизации.
Она будет получать последнюю схему базы данных из реальной базы данных, а затем использовать ее для обновления схемы, кэшированной с помощью базы данных метаданных синхронизации.
Если задано значение "SyncMemberName", будет обновлена схема базы данных участника; в противном случае будет обновлена схема базы данных основного сервера.
