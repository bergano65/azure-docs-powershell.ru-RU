...
## NОПИСАНИЕ
Командлет **New-AzSqlInstancePool** создает пул экземпляров Azure SQL.
...
Эта команда создает новый пул экземпляров Azure SQL.
...
### -ComputeGeneration
Вычисленое поколение для пула экземпляров.
...
### -SubnetId
Идентификатор подсети, используемый для создания пула экземпляров.
