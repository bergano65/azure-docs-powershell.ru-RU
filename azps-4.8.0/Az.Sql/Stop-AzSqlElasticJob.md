...
## NОПИСАНИЕ
Командлет Stop-AzSqlElasticJob останавливает выполнение задания с выполнением.
Возвращает текущее состояние выполнения задания.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Остановка задания с выполняющимся выполнением задания
```powershell
...
Останавливает выполняющееся выполнение задания и возвращает его текущее состояние
...
### -ParentObject
Объект базы данных элемента управления агента
