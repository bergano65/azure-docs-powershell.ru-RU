...
## NОПИСАНИЕ
Командлет **Update-AzSqlSyncGroup** изменяет свойства группы синхронизации базы данных SQL Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Обновление группы синхронизации для базы данных SQL Azure.
```
...
Следует ли использовать соединение с частными ссылками при подключении к концентратору этой группы синхронизации.
