...
## NОПИСАНИЕ
Командлет **Get-AzSqlServerActiveDirectoryOnlyAuthentication** получает требование проверки подлинности для службы Azure Active Directory (Azure AD) только для сервера AzureSQL в текущей подписке.
...
Эта команда возвращает Azure Active Directory (Azure AD) только требование проверки подлинности для сервера AzureSQL с именем Server01, связанного с группой ресурсов с именем ResourceGroup01.
