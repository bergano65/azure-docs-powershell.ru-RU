...
## NОПИСАНИЕ
Командлет **Get-AzSqlServerAudit** получает параметры аудита для Azure SQL Server.
...
### Пример 2: Get, с помощью конвейера параметры аудита для Azure SQL Server
```
...
### Пример 3: получение параметров аудита для Azure SQL Server
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
