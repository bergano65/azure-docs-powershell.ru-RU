...
Используйте подключение к частной ссылке при подключении к концентратору этой группы синхронизации.
