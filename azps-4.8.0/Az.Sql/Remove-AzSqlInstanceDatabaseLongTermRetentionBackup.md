...
## NОПИСАНИЕ
Командлет **Remove-AzSqlInstanceDatabaseLongTermRetentionBackup** удаляет указанную резервную копию.
...
Удаление резервной копии с именем 15be823c-7e2c-49d8-819f-a3fdcad92215; 132268250550000000
...
### -DatabaseName
Имя управляемой базы данных, из которой находится резервная копия.
...
### -InstanceName
Имя управляемого экземпляра, на котором находится резервная копия.
...
### -Location
Расположение исходного экземпляра, управляемого с помощью резервных копий.
