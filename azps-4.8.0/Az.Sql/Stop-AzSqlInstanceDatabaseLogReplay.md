...
## NОПИСАНИЕ
Командлет **Stop-AzSqlInstanceDatabaseLogReplay** удаляет базу данных и тем самым отменяет службу воспроизведения журнала.
...
Эта команда будет отменять службу воспроизведения журнала в указанной базе данных.
