...
## NОПИСАНИЕ
Командлет **Get-AzSqlDatabase** получает одну или несколько баз данных SQL Azure с сервера базы данных Azure SQL.
...
### Пример 3: получение всех баз данных на сервере с помощью фильтрации
```
...
Эта команда получает все базы данных на сервере с именем Server01, которые начинаются с Database.
