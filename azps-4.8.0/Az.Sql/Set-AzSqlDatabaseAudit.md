...
### Пример 3: Включение политики аудита хранилища BLOB-объектов для базы данных SQL Azure с расширенной фильтрацией с помощью предиката T-SQL
```powershell
...
### Пример 4: Удаление параметра расширенной фильтрации из политики аудита для базы данных SQL Azure
```powershell
...
### Пример 5: Включение политики аудита центра событий для базы данных SQL Azure
```powershell
...
### Пример 6: отключение политики аудита центра событий для базы данных SQL Azure
```powershell
...
### Пример 7: Включение политики аудита анализа журналов для базы данных Azure SQL
```powershell
...
### Пример 8: отключение политики аудита анализа журналов для базы данных SQL Azure
```powershell
...
### Пример 9: отключение, с помощью конвейера, политика аудита анализа журналов для базы данных Azure SQL
```powershell
...
### Пример 10: отключение отправки записей аудита для базы данных SQL Azure в хранилище BLOB-объектов и разрешение их отправки в службу анализа журнала.
```powershell
...
### Пример 11. разрешите отправку записей аудита для базы данных SQL Azure в хранилище BLOB-объектов, на концентратор событий и в анализ журнала.
```powershell
