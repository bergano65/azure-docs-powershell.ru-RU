...
## NОПИСАНИЕ
Командлет **New-AzSqlDatabaseRestorePoint** создает новую точку восстановления, из которой может быть восстановлено хранилище данных Azure SQL.
Этот командлет в настоящее время поддерживается для хранилища данных Azure SQL.
...
Эта команда создает точку восстановления для хранилища данных Azure SQL и возвращает сведения о точке восстановления.
...
### -RestorePointLabel
Задает метку точки восстановления для упрощения идентификации.
