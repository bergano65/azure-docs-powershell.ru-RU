...
Получает все долгосрочные резервные копии хранения для определенной базы данных.  Группа ресурсов является необязательной. 
...
### -DatabaseName
Имя управляемой базы данных, в которой находятся резервные копии.
