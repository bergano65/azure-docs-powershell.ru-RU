...
## NОПИСАНИЕ
Командлет **Set-AzSqlDatabaseBackupLongTermRetentionPolicy** задает политику долгосрочного хранения, зарегистрированную для этой базы данных.
...
### Пример 5: Удаление политики долгосрочного хранения
```powershell
...
### Пример 6: Удаление политики долгосрочного хранения
```powershell
...
Не менее 7 дней и не более 10 лет.
