...
## NОПИСАНИЕ
Командлет Get-AzSqlElasticJobStepExecution возвращает одно или несколько выполненных шагов задания из выполнения задания.

## ИЛЛЮСТРИРУЮТ

### Пример 1 — получение одного или нескольких выполненных шагов задания из выполнения задания
```
...
### Пример 2 — получение одного или нескольких выполнения шагов задания из выполнения задания с фильтрацией по имени шага
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
