...
## NОПИСАНИЕ
Командлет **Disable-AzSqlServerAdvancedDataSecurity** отключает на сервере расширенную защиту данных.

## ИЛЛЮСТРИРУЮТ

### Пример 1
### Пример 2: отключение расширенной защиты данных сервера
```powershell
...
### Пример 3: отключение расширенной защиты данных сервера от ресурса сервера
```powershell
