...
### Пример 1 обновление компонента Application Insights
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

Обновление компонента Application Insights "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery "отключено"
...
Тип сетевого доступа для получения доступа к Application Insights.
Значение должно быть "включено" или "отключено"
...
Тип сетевого доступа для доступа к запросу Application Insights.
Значение должно быть "включено" или "отключено"
