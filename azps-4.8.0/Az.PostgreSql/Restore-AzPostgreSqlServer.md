...
### Пример 1: восстановление сервера PostgreSql с помощью георепликового восстановления
```powershell
...
Этот командлет восстанавливает сервер PostgreSql с помощью георепликового восстановления.

### Пример 2: восстановление PostgreSql Server с помощью PointInTime Restore
```powershell
...
Эти командлеты восстанавливают сервер PostgreSql с помощью PointInTime Restore.
