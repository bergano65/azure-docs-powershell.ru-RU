...
### Пример 1: Удаление сервера PostgreSql по группе resourceGroup и имени сервера
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Этот командлет удаляет PostgreSql Server по группе resourceGroup и именем сервера.

### Пример 2: Удаление сервера PostgreSql по удостоверению
```powershell
...
Эти командлеты удаляют сервер PostgreSql по идентификаторам.
