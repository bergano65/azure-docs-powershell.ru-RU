...
Этот командлет обновляет правило виртуальной сети PostgreSql по имени.

### Пример 2: обновление правила виртуальной сети PostgreSql по удостоверению.
```powershell
...
Эти командлеты обновляют правило PostgreSql виртуальных сетей по идентификаторам.
