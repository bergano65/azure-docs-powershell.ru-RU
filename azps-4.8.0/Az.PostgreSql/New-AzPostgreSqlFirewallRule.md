...
### Пример 1: Создание правила межсетевого экрана сервера PostgreSql
```powershell
...
Эти командлеты создают правило брандмауэра сервера PostgreSql.

### Пример 2: создание нового правила брандмауэра PostgreSql с помощью ClientIPAddress.
```powershell
...
Эти командлеты создают правило брандмауэра PostgreSql с помощью ClientIPAddress.

### Пример 3: Создание правила брандмауэра PostgreSql, разрешающего все IP-адреса
```powershell
...
Эти командлеты создают новое правило брандмауэра PostgreSql, разрешающее все IP-адреса.
...
### Microsoft. Azure. PowerShell. командлеты. PostgreSql. Models. Api20171201. IFirewallRule
