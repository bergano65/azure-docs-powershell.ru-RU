...
### Пример 1: Удаление правила виртуальной сети PostgreSql Server по имени
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Этот командлет удаляет правило виртуальной сети PostgreSql Server по имени.

### Пример 2: Удаление правила виртуальной сети PostgreSql Server по удостоверению
```powershell
...
Эти командлеты удаляют правило виртуальной сети PostgreSql Server по идентификаторам.
