...
### Пример 1: обновление правила брандмауэра PostgreSql по имени
```powershell
...
Этот командлет обновляет PostgreSql правило брандмауэра по имени.

### Пример 2: обновление правила брандмауэра PostgreSql по удостоверению.
```powershell
...
Эти командлеты обновляют PostgreSql правило брандмауэра с помощью удостоверения.

### Пример 3: обновление правила брандмауэра PostgreSql на ClientIPAddress.
```powershell
...
Эти командлеты обновляют PostgreSql правило брандмауэра на ClientIPAddress.
