...
### Пример 1: Удаление правила брандмауэра PostgreSql по имени
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Этот командлет удаляет правило брандмауэра PostgreSql по имени.

### Пример 2: Удаление правила брандмауэра PostgreSql по удостоверению
```powershell
...
Эти командлеты удаляют правило брандмауэра PostgreSql по идентификаторам.
