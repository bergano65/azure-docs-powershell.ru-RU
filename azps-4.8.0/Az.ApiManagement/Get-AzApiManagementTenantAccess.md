...
## NОПИСАНИЕ
Командлет **Get-AzApiManagementTenantAccess** получает конфигурацию доступа клиента для клиента.
Ключи не будут включены в данные результата. Чтобы получить секрет клиента, используйте **Get-AzApiManagementTenantAccessSecret**.
