...
## NОПИСАНИЕ
Командлет **Add-AzApiManagementApiToProduct** добавляет API управления Azure API для продукта.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Добавление API для продукта
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Add-AzApiManagementApiToProduct -Context $ApiMgmtContext -ProductId "0123456789" -ApiId "0001"
```

Эта команда добавляет указанный API к указанному продукту.

## ПАРАМЕТРЫ

### -ApiId
Указывает идентификатор API для добавления в продукт.
...
### -ProductId
Указывает идентификатор продукта, в который нужно добавить API.
