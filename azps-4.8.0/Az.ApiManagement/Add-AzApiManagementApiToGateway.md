...
## NОПИСАНИЕ
Командлет **Add-AzApiManagementApiToGateway** добавляет API управления Azure API на шлюз.
...
Эта команда добавляет указанный API к указанному шлюзу.
...
### System. Nullable "1 [[Microsoft. Azure. Commands. ApiManagement. ServiceManagement.. PsApiManagementGatewayApiProvisioningState, Microsoft. Azure. PowerShell. командлеты. ApiManagement. ServiceManagement, Version = 2.0.1.0, культура = Neutral, PublicKeyToken = NULL]]
