...
### Пример 1: получение секрета клиента для поставщика удостоверений типа AAD
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\> Get-AzApiManagementIdentityProviderClientSecret -Context $apimContext -Type Aad
```

Получает секретный ключ клиента конфигурации поставщика удостоверений Azure Active Directory.
