...
### Пример 2: создание API-интерфейса путем копирования всех операций, тегов, продуктов и политик из Echo-API и в ApiVersionSet
```powershell
...
Создание API. (автоматически сформированные)
