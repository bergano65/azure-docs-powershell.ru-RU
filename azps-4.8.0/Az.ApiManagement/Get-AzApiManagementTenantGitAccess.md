...
## NОПИСАНИЕ
Командлет **Get-AzApiManagementTenantGitAccess** получает конфигурацию доступа Git для клиента.
Ключи не будут включены в данные результата. Чтобы получить секрет клиента, используйте **Get-AzApiManagementTenantGitAccessSecret**.
