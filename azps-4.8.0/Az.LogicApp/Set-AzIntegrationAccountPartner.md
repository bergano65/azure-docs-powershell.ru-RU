...
## NОПИСАНИЕ
Командлет **Set-AzIntegrationAccountPartner** изменяет партнера учетной записи интеграции.
...
### Пример 1: изменение партнера учетной записи для интеграции
```powershell
...
Эта команда изменяет партнера учетной записи интеграции с именем IntegrationAccountPartner22 в указанной группе ресурсов.

### Пример 2

Изменение партнера учетной записи интеграции. (автоматически сформированные)
