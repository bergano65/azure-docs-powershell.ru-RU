...
## NОПИСАНИЕ
Командлет **Get-AzIntegrationAccountBatchConfiguration** получает пакетную конфигурацию из учетной записи интеграции.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение конфигурации пакета с помощью параметров
```powershell
...
Получить пакетную конфигурацию с именем sampleBatchConfig, расположенную в учетной записи интеграции "sampleIntegrationAccount", которая находится в группе ресурсов "sampleResourceGroup".

### Пример 2: перечисление всех пакетных конфигураций в учетной записи интеграции с помощью параметров
```powershell
...
Получение всех пакетных конфигураций, расположенных в учетной записи интеграции "sampleIntegrationAccount", которая содержится в группе ресурсов "sampleResourceGroup".
