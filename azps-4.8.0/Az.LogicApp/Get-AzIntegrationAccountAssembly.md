...
## NОПИСАНИЕ
Командлет **Get-AzIntegrationAccountAssembly** получает сборку из учетной записи интеграции.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение сборки с помощью параметров
```powershell
...
Получить сборку с именем "sampleAssembly", расположенную в учетной записи интеграции "sampleIntegrationAccount", которая содержится в группе ресурсов "sampleResourceGroup".

### Пример 2: список всех сборок в учетной записи интеграции с помощью параметров
```powershell
...
Получение всех сборок, расположенных в учетной записи интеграции "sampleIntegrationAccount", которая содержится в группе ресурсов "sampleResourceGroup".
