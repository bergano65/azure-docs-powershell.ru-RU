...
## NОПИСАНИЕ
Командлет New-AzAutomationSourceControl создает конфигурацию для связывания моей учетной записи службы автоматизации Azure с приложением VSTS TFVC, VSTS Git или GitHub.

## ИЛЛЮСТРИРУЮТ

### Пример 1
Создайте конфигурацию системы управления версиями, чтобы связать мою учетную запись службы автоматизации Azure с приложением "VSTS TFVC Project". В проектах TFVC отсутствуют ветви, поэтому параметр Branch не указан.
...
### Пример 2
Создайте конфигурацию системы управления версиями, чтобы связать мою учетную запись службы автоматизации Azure с проектом Git из VSTS.
...
### Пример 3
Создайте конфигурацию системы управления версиями, чтобы связать мою учетную запись службы автоматизации Azure с проектом GitHub.
...
### -AccessToken
Маркер доступа к системе управления версиями.
...
### -Branch
Ветвь системы управления версиями.
...
### -Описание
Описание элемента управления исходным кодом.
...
### -DoNotPublishRunbook
Свойство publishRunbook исходного элемента управления.
Если задано значение DoNotPublishRunbook, это означает, что пользовательские runbooks будут импортированы как "черновик".
...
### -EnableAutoSync
Свойство "Автосинхронизация" для системы управления версиями.
