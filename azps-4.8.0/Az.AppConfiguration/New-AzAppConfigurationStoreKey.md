...
## КРАТКИй обзор
Повторно создает клавишу доступа для указанного хранилища конфигураций.
...
### Пример 1: повторное создание ключа из хранилища конфигурации приложения
```powershell
...
Эта команда повторное создание ключа из хранилища конфигурации приложения.

### Пример 2: повторное создание ключа из хранилища конфигурации приложения по объекту
```powershell
...
Эта команда используется для повторного создания ключа хранилища конфигурации приложения по объекту.
...
### -ID
Идентификатор ключа, который нужно повторно создать.
