...
## NОПИСАНИЕ
Получает существующие учетные записи служб healthcareApis fhir, созданные в указанной подписке или группе ресурсов.
...
Получает метаданные для всех служб HealthcareApis в указанной группе ресурсов.
