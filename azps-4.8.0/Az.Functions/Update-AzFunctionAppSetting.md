...
### Пример 1: Добавление нового параметра приложения в приложении функции.
```powershell
PS C:\> Update-AzFunctionAppSetting -Name MyAppName -ResourceGroupName MyResourceGroupName -AppSetting @{"Name1" = "Value1"}
```

Эта команда добавляет новый параметр приложения в приложение функции.

## ПАРАМЕТРЫ

### -AppSetting
Хэш-таблица с ключами и значениями. описывает параметры приложения, которые нужно добавить или обновить в приложении "функция".
...
### -Force
Принудительно обновляет параметр приложения Function без запроса на подтверждение командлета.
...
### Microsoft. Azure. PowerShell. командлеты. functions. Models. Api20190801. IStringDictionary
