...
### Пример 1: получение планов приложений для всех функций.
```powershell
...
Эта команда получает планы приложения для всех функций.

### Пример 2: получение планов приложений функций по названию группы ресурсов.
```powershell
...
Эта команда получает планы приложения для функций по имени группы ресурсов.

### Пример 3: получение планов приложений функций для заданных подписок.
```powershell
...
Эта команда получает планы приложения для заданных подписок.

### Пример 4: получение планов приложений функций по местоположению.
```powershell
...
Эта команда получает планы приложения по расположению.
