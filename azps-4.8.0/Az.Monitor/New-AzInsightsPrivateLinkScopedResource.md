...
## NОПИСАНИЕ
Создание ресурса с областью действия для закрытой ссылки ресурс с областью действия может быть рабочей областью аналитики журнала или компонент Application Insights
...
Создание ресурса с областью "scoped_resource_name", связанного с компонентом Application Insights "ai_name"
...
### -LinkedResourceId
Код ресурса LA/AI для связывания
