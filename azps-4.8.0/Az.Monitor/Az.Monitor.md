...
Получает запланированные ресурсы запроса
...
Создание правила оповещения в журнале (тип правила для запланированных запросов)

### [New-AzScheduledQueryRuleAlertingAction](New-AzScheduledQueryRuleAlertingAction.md)
Создает объект действия оповещения типа
...
Создает объект типа "Расписание".
...
Создает объект условия триггера типа
...
Удаление ресурса с областью личных ссылок
...
Обновляет правило оповещения в журнале
