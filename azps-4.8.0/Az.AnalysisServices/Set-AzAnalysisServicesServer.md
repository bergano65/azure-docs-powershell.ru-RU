...
## NОПИСАНИЕ
Командлет Set-AzAnalysisServicesServer изменяет экземпляр сервера служб Analysis Services.
...
### -DisassociateGateway
Отключение ресурса шлюза от сервера анализа данных
