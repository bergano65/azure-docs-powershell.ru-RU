...
## КРАТКИй обзор
Получает граф Gremlin CosmosDB.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBGremlinGraph** получает свойства CosmosDB Gremlin Graph.
...
Объект Resource включает в себя IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
