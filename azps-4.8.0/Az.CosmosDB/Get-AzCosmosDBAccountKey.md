...
## NОПИСАНИЕ
Получение списка ключей подключения.
...
Список клавиш для учетной записи CosmosDB. Тип ключа может принимать значения от: ConnectionString, Keys и ReadOnlyKeys. По умолчанию — ключи.
...
### -Type (тип)
Значение от: {connectionStrings, Keys, ReadOnlyKeys}.
По умолчанию — ключи.
