...
FailoverPolicies обновил Region1 как FailoverPriority 1, region2 AS FailoverPriority 2 и region3 как FailoverPriority 3.
...
### -FailoverPolicy
Массив строк с именами областей, упорядоченных по приоритету отработки отказа.
Например, eastus, westus
