...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBTable** получает существующую таблицу.
...
Объект Resource (ресурс), содержащий _rid, _ts, _ свойства ETag таблицы.
