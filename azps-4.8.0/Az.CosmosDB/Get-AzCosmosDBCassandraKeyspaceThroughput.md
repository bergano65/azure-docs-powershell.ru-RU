...
## КРАТКИй обзор
Возвращает значение пропускной способности Cassandra keyspace.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBCassandraKeyspaceThroughput** получает объект пропускной способности, соответствующий заданному keyspace.
