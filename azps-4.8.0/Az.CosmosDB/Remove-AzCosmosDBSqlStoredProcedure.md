...
## NОПИСАНИЕ
Командлет **Remove-AzCosmosDBSqlStoredProcedure** удаляет CosmosDB SQL StoredProcedure, соответствующие указанным ResourceGroupName, AccountName и DatabaseName.
