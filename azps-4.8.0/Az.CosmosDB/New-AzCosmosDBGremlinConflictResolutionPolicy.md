...
## КРАТКИй обзор
Создает новый объект типа PSConflictResolutionPolicy. Она может быть передана в качестве значения параметра Set-AzCosmosDBGremlinGraph.
...
## NОПИСАНИЕ
Объект, соответствующий ConflictResolutionPolicy API Gremlin.
