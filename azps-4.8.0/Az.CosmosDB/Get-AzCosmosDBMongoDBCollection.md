...
## КРАТКИй обзор
Возвращает коллекцию MongoDB CosmosDB.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBMongoDBCollection** получает коллекцию CosmosDB MongoDB.
...
В этом примере получается ShardKey извлеченной коллекции.
