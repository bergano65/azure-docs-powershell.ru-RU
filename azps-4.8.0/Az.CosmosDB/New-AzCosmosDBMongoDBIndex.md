...
## КРАТКИй обзор
Создает новый индекс CosmosDB MongoDB.
...
## NОПИСАНИЕ
**New-AzCosmosDBMongoDBIndex** создает новый индекс CosmosDB MongoDB.
...
### Клавиша
Массив значений ключа в виде строк.
...
### -TtlInSeconds
Количество секунд, после которого истекает срок действия индекса.
...
### -Unique
Логическое значение, определяющее, является ли индекс уникальным.
