...
Объект ConflictResolutionPolicy типа PSConflictResolutionPolicy, когда он указан, задается в качестве ConflictResolutionPolicy контейнера.
...
### -IndexingPolicy
Объект политики индексирования типа Microsoft. Azure. Commands. CosmosDB. PSIndexingPolicy.
...
### -PartitionKeyKind
Алгоритм, используемый для секционирования.
Возможные значения: "хэш", "диапазон"
...
### -PartitionKeyPath
Путь к ключу раздела, например "/Address/ZipCode".
...
### -PartitionKeyVersion
Версия определения ключа раздела.
...
Пропускная способность Gremlin графа (RU/s).
...
### -UniqueKeyPolicy
Объект UniqueKeyPolicy типа Microsoft. Azure. Commands. CosmosDB. PSUniqueKeyPolicy.
