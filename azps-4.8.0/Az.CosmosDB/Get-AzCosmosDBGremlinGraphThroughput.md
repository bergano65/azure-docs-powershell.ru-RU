...
## КРАТКИй обзор
Возвращает пропускную способность графа CosmosDB Gremlin.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBGremlinGraphThroughput** возвращает пропускную способность для CosmosDB Gremlin графа.
