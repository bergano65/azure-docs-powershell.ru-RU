...
## КРАТКИй обзор
Получение сводных данных об оповещениях
...
## NОПИСАНИЕ
Командлет **Measure-AzAlertStatistic** Возвращает сводную информацию об оповещениях.
...
Суммарное количество оповещений, сгруппированных по уровню серьезности и состоянию, отфильтрованному по активному состоянию.
