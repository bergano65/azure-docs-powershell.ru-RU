...
## КРАТКИй обзор
Получение сведений о представлении модели или представлении экземпляра гибридного компьютера.
...
### Пример 1: список всех подключенных машин в подписке
```powershell
...
Если подписка не указана, она будет использовать подписку из текущего контекста Azure PowerShell.

### Пример 2: список всех подключенных машин в группе ресурсов
```powershell
...
Перечислите все подключенные машины в группе ресурсов.

### Пример 3: получение имени подключенного компьютера в группе ресурсов
```powershell
...
Получение имени подключенного компьютера в группе ресурсов.
...
### Microsoft. Azure. PowerShell. командлеты. ConnectedMachine. Models. Api20200802. IMachine
