...
### Пример 1: команда "остановить создание шаблона изображения"
```powershell
...
Эта команда останавливает создание шаблона изображения.

### Пример 2: Отмена создания шаблона изображения
```powershell
PS C:\> Start-AzImageBuilderTemplate -ImageTemplateName template-name-sn78hg -ResourceGroupName wyunchi-imagebuilder -AsJob 
