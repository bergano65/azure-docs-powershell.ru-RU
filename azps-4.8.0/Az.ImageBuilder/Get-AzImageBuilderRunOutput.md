...
### Пример 1: список всех результатов выполнения в шаблоне
```powershell
...
Эта команда выводит список всех результатов выполнения в шаблоне.

### Пример 2: получение результата выполнения в шаблоне
```powershell
...
Эта команда получает результат выполнения в шаблоне.

### Пример 3: получение результата выполнения в шаблоне
```powershell
...
### Microsoft. Azure. PowerShell. командлеты. ImageBuilder. Models. IImageBuilderIdentity

## НАПРЯЖЕНИЕ

### Microsoft. Azure. PowerShell. командлеты. ImageBuilder. Models. Api20200214. IRunOutput
...
INPUTOBJECT <IImageBuilderIdentity> : параметр Identity
  ...
  - `[RunOutputName <String>]`: Имя выходных данных запуска
