...
### Пример 1: создание частного облака
```powershell
...
### -NetworkBlock
Блок адресов должен быть уникальным в рамках виртуальной сети в рамках подписки, а также локально.
Убедитесь, что формат CIDR соответствует (A. B. C. D/X), где A, B, C, D — от 0 до 255, а X — между 0 и 22.
...
### -NsxtPassword
При необходимости установите пароль в диспетчере NSX-T, когда вы создаете частное облако
...
### -VcenterPassword
При необходимости задайте пароль администратора vCenter при создании частного облака.
