...
### Пример 1: список Частное облако в подписке
```powershell
...
Список частных облаков в подписке

### Пример 2: список Частное облако в разделе "Группа ресурсов"
```powershell
...
Список Частное облако в разделе "Группа ресурсов"

### Пример 3: получение частного облака
```powershell
