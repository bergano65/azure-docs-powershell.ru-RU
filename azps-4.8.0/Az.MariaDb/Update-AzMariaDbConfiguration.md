...
Используйте Update-AzMariaDbServer, если хотите обновить AdministratorLoginPassword, SKU и т. д.
...
### Пример 1: Обновление конфигурации MariaDB
```powershell
...
Эта команда обновляет конфигурацию MariaDB.
...
### Microsoft. Azure. PowerShell. командлеты. MariaDb. Models. Api20180601Preview. IConfiguration
