...
### Пример 2: обновление правила брандмауэра MariaDB по удостоверению.
```powershell
...
Командлет обновляет MariaDB правило межсетевого экрана с помощью удостоверения.

### Пример 3: обновление правила брандмауэра MariaDB на ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
Командлет обновляет MariaDB правило брандмауэра на ClientIPAddress.
