...
## NОПИСАНИЕ
Создание или обновление метаданных оценки безопасности, которое можно использовать для создания различных свойств оценки и управления ими.
После этого вы сможете получать отчеты о результатах оценки по любому ресурсу в этой подписке.
...
Создание нового типа оценки в подписке.
...
### -Описание
Подробное описание строки, которая поможет пользователям понять смысл этой оценки и способ ее вычисления.
...
### -DisplayName
Удобное для чтения название объекта.
...
Подробное описание строки, которая поможет пользователям понять различные способы устранения и устранения проблем с безопасностью.
...
### -Серьезность
Указывает важность риска нарушения безопасности в случае неработоспособности оценки.
