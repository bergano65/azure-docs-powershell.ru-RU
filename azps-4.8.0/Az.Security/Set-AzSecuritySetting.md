...
## КРАТКИй обзор
Обновление параметров безопасности в центре безопасности Azure

## Максимальное

### GeneralScope (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет Set-AzSecuritySetting обновляет определенный параметр безопасности в центре безопасности Azure.
...
Обновляет параметр экспорта данных MCAS   
...
### -SettingKind
Тип параметра. (DataExportSettings)
