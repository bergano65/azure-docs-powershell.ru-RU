...
## NОПИСАНИЕ
Командлет Remove-AzIotSecuritySolution удаляет конкретное решение для безопасности IOT. Решение для обеспечения безопасности IoT собирает данные о безопасности и события на устройствах Интернет вещей и центре Интернета, которые помогают предотвратить и обнаруживать угрозы.
...
Удаление решения для безопасности IoT "MySample" с группой ресурсов "MyResourceGroup"
