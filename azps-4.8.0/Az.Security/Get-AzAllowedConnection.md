...
## КРАТКИй обзор
Используется для отображения разрешенного трафика между ресурсами для подписки
...
## NОПИСАНИЕ
Получает список всех возможных трафиков между ресурсами для подписки и местоположения на основе типа соединения.
