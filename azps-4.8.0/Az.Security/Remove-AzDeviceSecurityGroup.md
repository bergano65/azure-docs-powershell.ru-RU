...
## NОПИСАНИЕ
Командлет Remove-AzDeviceSecurityGroup удаляет группу безопасности устройств, определенную в решении для безопасности IOT.
...
Удаление группы безопасности устройства "MySecurityGroup" центра Интернета вещей с идентификатором ресурса "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
