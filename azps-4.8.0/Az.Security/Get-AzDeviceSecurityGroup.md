...
## NОПИСАНИЕ
Командлет Get-AzDeviceSecurityGroup возвращает группу безопасности устройства, определенную в решении системы безопасности IOT
...
Получение группы безопасности устройства "MySecurityGroup" в центре IoT с reasource ID "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
...
Получение списка группы безопасности устройства в центре IoT с reasource ID "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
