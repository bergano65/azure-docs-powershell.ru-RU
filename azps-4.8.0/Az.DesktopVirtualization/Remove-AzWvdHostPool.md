...
### Пример 1: Удаление виртуального рабочего стола Windows HostPool по имени
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Эта команда удаляет HostPool виртуальных рабочих столов Windows в группе ресурсов.
...
### -Force
Флажок "принудительно" для удаления sessionHost.
