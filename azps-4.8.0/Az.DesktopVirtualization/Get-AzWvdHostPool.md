...
### Пример 1: получение виртуального рабочего стола Windows HostPool по имени
```powershell
...
Эта команда получает HostPool виртуальных рабочих столов Windows в группе ресурсов.

### Пример 2: список виртуальных рабочих столов Windows HostPools
```powershell
...
Эта команда перечисляет HostPools виртуальных рабочих столов Windows в группе ресурсов.
