...
Эта команда создает HostPool виртуальных рабочих столов Windows в группе ресурсов.
...
### -CustomRdpProperty
Настраиваемое свойство RDP для HostPool.
...
### -DesktopAppGroupName
Имя группы приложений для настольных компьютеров
...
### -ExpirationTime
Срок действия маркера регистрации.
...
### -MaxSessionLimit
Максимальная длина сеанса в HostPool.
...
Тип предпочтительного типа группы приложения, по умолчанию для группы приложений для настольных компьютеров
...
Строка маркера регистрации в кодировке Base64.
...
### -SsoContext
Путь к keyvault, содержащему ssoContext секрет.
...
### -VMTemplate
Шаблон ВМ для конфигурации sessionhosts в hostpool.
...
### Microsoft. Azure. PowerShell. командлеты. DesktopVirtualization. Models. Api20191210Preview. IHostPool
