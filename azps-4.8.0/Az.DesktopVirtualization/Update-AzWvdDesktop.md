...
### Пример 1: обновление рабочего стола Windows для виртуальных рабочих столов
```powershell
...
Эта команда обновляет рабочий стол виртуальных рабочих столов Windows в группе applicaton.
