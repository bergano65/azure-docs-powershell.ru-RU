...
### Пример 1: Удаление виртуального рабочего стола Windows SessionHost по имени
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Эта команда удаляет SessionHost виртуальных рабочих столов Windows в пуле узлов.
...
### -Force
Принудительная установка принудительного удаления sessionHost, даже если userSession существует.
