...
### Пример 2: список элементов меню «Пуск» для виртуальных рабочих столов Windows
```powershell
...
Эта команда перечисляет элементы меню Пуск виртуальных рабочих столов Windows в группе applicaton.
...
### Microsoft. Azure. PowerShell. командлеты. DesktopVirtualization. Models. Api20191210Preview. IStartMenuItem
