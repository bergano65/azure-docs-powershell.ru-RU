...
## КРАТКИй обзор
Это приведет к удалению файла YAML, используемого для настройки конфигурации системы управления версиями, тем самым прекращая дальнейшую синхронизацию из исходного репозитория.
...
### Пример 1: удаление configuation из kubernetes кластера по имени
```powershell
...
Эта команда удаляет configuation из kubernetes кластера по имени.

### Пример 2: удаление configuation из kubernetes кластера по объекту
```powershell
...
Эта команда удаляет configuation из kubernetes кластера по объекту.
