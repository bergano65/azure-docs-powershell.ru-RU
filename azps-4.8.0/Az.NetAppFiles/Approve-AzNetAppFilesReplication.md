...
## NОПИСАНИЕ
Утверждение подключения репликации на исходном томе
...
### -Имя_учетной_записи
Имя учетной записи ANF исходного тома репликации
...
Идентификатор файловой системы конечного тома защиты данных
...
### -InputObject
Объект исходного тома ANF для авторизации места назначения репликации
...
### -Name (имя)
Имя тома источника репликации ANF
...
### -PassThru
Возвращает значение, указывающее, была ли выполнена авторизация репликации заданного тома.
...
### -PoolName
Имя пула ANF исходного тома репликации
...
### -ResourceGroupName
Группа ресурсов для тома источника репликации ANF
...
### -ResourceId
Идентификатор ресурса исходного тома репликации ANF
