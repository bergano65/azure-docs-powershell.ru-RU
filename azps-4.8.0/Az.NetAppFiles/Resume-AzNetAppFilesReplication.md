...
## NОПИСАНИЕ
Возобновление или повторная синхронизация подключения на целевом томе
...
Эта команда возобновляет подключение репликации ANF на томе "MyDestinationAnfVolume".

## ПАРАМЕТРЫ

### -Имя_учетной_записи
Имя учетной записи ANF на томе репликации.
...
### -InputObject
Объект целевого тома репликации ANF для повторной синхронизации
...
### -Name (имя)
Имя тома назначения репликации ANF
...
### -PassThru
Возвращает значение, указывающее, была ли выполнена повторная синхронизация указанного тома репликации
...
### -PoolName
Имя пула ANF на томе репликации
...
### -ResourceGroupName
Группа ресурсов целевого тома репликации ANF
...
### -ResourceId
Идентификатор ресурса целевого тома репликации ANF
