...
## NОПИСАНИЕ
Командлет **Remove-AzNetAppFilesSnapshot** удаляет моментальный снимок ANF.
...
### -ResourceGroupName
Группа "ресурсы" для моментального снимка ANF
...
### -ResourceId
Идентификатор ресурса для моментального снимка ANF
...
### -VolumeObject
Объект Volume, содержащий удаляемый снимок.
