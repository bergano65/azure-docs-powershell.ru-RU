...
## NОПИСАНИЕ
Командлет **Remove-AzNetAppFilesPool** УДАЛЯЕТ пул ANF.
...
Эта команда удаляет пул ANF "MyAnfPool".
...
### -AccountObject
Объект Account, содержащий пул, который нужно удалить.
...
### -InputObject
Объект пула, который нужно удалить.
...
### -PassThru
Возвращает значение, указывающее, был ли указанный пул успешно удален
...
### -ResourceId
Идентификатор ресурса пула ANF
