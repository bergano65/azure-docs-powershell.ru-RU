...
## КРАТКИй обзор
Обновите Специальный HSM в указанной подписке.
...
### Пример 1: обновление тега параметра выделенного HSM по имени
```powershell
...
Эта команда обновляет тег параметра выделенного HSM по имени.

### Пример 2: обновление тега параметра выделенного HSM по объекту
```powershell
...
Эта команда обновляет тег параметра выделенного HSM по объекту.
