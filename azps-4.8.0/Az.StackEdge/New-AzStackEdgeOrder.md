...
## NОПИСАНИЕ
Командлет **New-AzStackEdgeOrder** создает новый заказ для краевого устройства стека. Прежде чем создавать заказ, необходимо сначала создать ресурс с краевым устройством. Вы можете указать такие сведения, как Контактное лицо, название компании, адрес электронной почты и т. д. в качестве параметров создания заказа.
...
### -Электронная почта
Список сообщений электронной почты, чтобы получать обновления, может содержать не более 10 сообщений электронной почты
...
### Microsoft. Azure. PowerShell. командлеты. StackEdge. Models. PSStackEdgeOrder
