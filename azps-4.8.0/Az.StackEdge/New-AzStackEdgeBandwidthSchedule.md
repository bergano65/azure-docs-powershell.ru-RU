...
## NОПИСАНИЕ
Командлет **New-AzStackEdgeBandwidthSchedule** создает новое расписание пропускной способности для краевого устройства стека, что помогает управлять использованием пропускной способности.
...
### -UnlimitedBandwidth
Настройка пропускной способности не ограничена
...
### Microsoft. Azure. PowerShell. командлеты. StackEdge. Models. PSStackEdgeBandWidthSchedule
