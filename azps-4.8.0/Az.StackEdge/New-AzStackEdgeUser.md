...
## NОПИСАНИЕ
Командлет **New-AzStackEdgeUser** создает нового пользователя для краевого устройства стека. Поддерживается создание только пользователей типа `Share` .
...
### -Password (пароль)
Пароль, предоставление в качестве безопасной строки
