...
## NОПИСАНИЕ
Командлет **New-AzStackEdgeRole** создает новую роль для краевого устройства стека.
...
### -IotDeviceAccessKey
Клавиша доступа для устройства IOT
...
Укажите строку подключения для устройства IOT
...
### -IotDeviceId
Код устройства для устройства IOT
...
Клавиша доступа для устройства с EDGE в Интернет вещей
...
Укажите строку соединения с краевым устройством
...
### -IotEdgeDeviceId
Идентификатор устройства EDGE в Интернет вещей
...
### -Platform
Предоставление платформы для ex: Linux
...
### -RoleStatus
Предоставление статуса включения и отключения
...
### Microsoft. Azure. PowerShell. командлеты. StackEdge. Models. PSStackEdgeRole
