...
Получите существующую конфигурацию обработчика правил и добавьте в нее другое правило обработчика правил.
...
### -InputObject
Обновляемый объект обработчика правил.
...
### -ResourceId
ИД ресурса обновляемого RulesEngine
...
### -Правило
Список правил, определяющих определенную конфигурацию обработчика правил.
