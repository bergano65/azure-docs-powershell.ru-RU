...
### -HeaderActionType
Тип манипуляций, применяемых к заголовку.
...
### -HeaderName
Имя верхнего колонтитула, к которому будет применяться это действие.
...
### -Value (значение)
Значение, для которого нужно обновить заданное имя заголовка.
Это значение не используется, если параметр удаления.
