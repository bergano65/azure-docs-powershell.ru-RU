...
## NОПИСАНИЕ
Команда **Get-AzSynapseTriggerRun** возвращает подробные сведения о выполнении триггеров для определенного триггера в течение заданного периода.
...
Эта команда отображает сведения о запусках для ContosoTrigger в рабочей области ContosoWorkspace, которая была запущена между "2018-09-01T21:00" и "2019-09-01T21:00".
...
Эта команда показывает сведения о запусках для ContosoTrigger в рабочей области ContosoWorkspace, которая начинается с "2018-09-01T21:00" и "2019-09-01T21:00" через конвейер.
