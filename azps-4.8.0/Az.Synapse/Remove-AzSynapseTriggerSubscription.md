...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseTriggerSubscription** отменяет подписку триггера событий на указанные внешние события службы из определения триггера.
...
Эта команда отменяет подписку триггера с именем ContosoTrigger на указанные события из определения триггера.
...
Эта команда отменяет подписку триггера с именем ContosoTrigger на указанные события из определения триггера с помощью конвейера.
