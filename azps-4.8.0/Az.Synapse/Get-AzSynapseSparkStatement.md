...
### GetSparkStatementsByIdParameterSet (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет **Get-AzSynapseSparkStatement** получает сведения о инструкции Azure Synapse Analytics Spark.
...
Эта команда получает все инструкции Spark из сеанса Spark.
...
Эта команда получает инструкцию Spark с указанным ИДЕНТИФИКАТОРом Livy.
...
Эта команда получает все инструкции Spark в сеансе Spark по конвейеру.
