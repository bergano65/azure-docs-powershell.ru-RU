...
## NОПИСАНИЕ
Командлет **Test-AzSynapseWorkspace** проверяет наличие рабочей области для аналитики Synapse.
...
Эта команда проверяет наличие рабочей области Analytics Synapse.
