...
## NОПИСАНИЕ
Командлет **Invoke-AzSynapseIntegrationRuntimeUpgrade** обновляет саморазмещенную среду интеграции, если доступна новая версия.
...
Командлет обновляет самостоятельную среду интеграции с именем Test-SelfHost-IR в рабочей области ContosoWorkspace.
