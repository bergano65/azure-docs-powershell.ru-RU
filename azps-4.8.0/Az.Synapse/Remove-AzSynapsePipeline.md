...
## NОПИСАНИЕ
Командлет **Remove-AzSynapsePipeline** удаляет канал из рабочей области.
...
Этот командлет удаляет конвейер с именем ContosoPipeline из рабочей области с именем ContosoWorkspace.
...
Этот командлет удаляет конвейер с именем ContosoPipeline из рабочей области с именем ContosoWorkspace через конвейер.
