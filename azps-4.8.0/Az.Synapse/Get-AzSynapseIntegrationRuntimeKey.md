...
## NОПИСАНИЕ
Командлет **Get-AzSynapseIntegrationRuntimeKey** получает ключи для среды выполнения интеграции. Ключи используются для регистрации узла среды выполнения интеграции.
