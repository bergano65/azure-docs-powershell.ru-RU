...
## КРАТКИй обзор
Создает базу данных SQL Analytics Synapse.
...
## NОПИСАНИЕ
Командлет **Get-AzSynapseSqlDatabase** получает сведения о базе данных Azure SYNAPSE Analytics SQL.
...
Эта команда создает базу данных SQL Azure Synapse Analytics.
