...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseLinkedService** Удаляет связанную службу из рабочей области.
...
Эта команда удаляет связанную службу с именем ContosoLinkedService из рабочей области с именем ContosoWorkspace.
...
Эта команда удаляет связанную службу с именем ContosoLinkedService из рабочей области с именем ContosoWorkspace с помощью конвейера.
