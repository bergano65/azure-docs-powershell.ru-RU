...
## NОПИСАНИЕ
Командлет **Get-AzSynapseRoleDefinition** получает определение роли аналитики Azure Synapse.
Если не указать имя роли или идентификатор роли, этот командлет получает все определения ролей.
...
Эта команда получает определение роли в разделе Рабочая область ContosoWorkspace с именем ContosoRole.
...
Эта команда получает все определения ролей в рабочей области с помощью конвейера.
