...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseNotebook** удаляет записную книжку из рабочей области.
...
Удаление записной книжки с именем ContosoNotebook из ContosoWorkspace рабочей области.
...
Удаление записной книжки с именем ContosoNotebook из рабочей области ContosoWorkspace через конвейер.
