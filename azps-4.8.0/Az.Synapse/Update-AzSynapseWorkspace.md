...
## NОПИСАНИЕ
Командлет **Update-AzSynapseWorkspace** обновляет рабочую область Azure Synapse Analytics.
...
Эта команда обновляет теги для рабочей области specififed Azure Synapse Analytics.
...
Эта команда обновляет теги для рабочей области specififed Azure Synapse Analytics с помощью конвейера.
...
Эта команда обновляет теги для рабочей области specififed Azure Synapse Analytics с помощью конвейера с ИДЕНТИФИКАТОРом ресурса.
...
### -ResourceId
Идентификатор ресурса Synapse рабочей области.
...
Новый пароль администратора SQL для рабочей области.
