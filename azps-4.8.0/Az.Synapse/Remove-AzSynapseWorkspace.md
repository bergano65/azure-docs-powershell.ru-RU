...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseWorkspace** окончательно удаляет рабочую область Azure Synapse Analytics.
...
Эта команда удаляет рабочую область Azure Synapse Analytics.
...
Эта команда удаляет рабочую область Azure Synapse Analytics с помощью конвейера.
...
Эта команда удаляет рабочую область Azure Synapse Analytics через конвейер с указанным ИДЕНТИФИКАТОРом ресурса.
