...
## КРАТКИй обзор
Удаляет базу данных SQL Analytics Synapse.
...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseSqlPool** окончательно удаляет базу данных SQL Azure Synapse Analytics.
...
Эта команда удаляет базу данных SQL Azure Synapse Analytics.
...
Эта команда удаляет базу данных SQL Azure Synapse Analytics с помощью конвейера.
...
Эта команда удаляет базу данных SQL Azure Synapse Analytics с указанным ИДЕНТИФИКАТОРом ресурса.
