...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseDataset** удаляет набор данных из рабочей области.
...
Эта команда удаляет набор данных с именем ContosoDataset из рабочей области с именем ContosoWorkspace.
