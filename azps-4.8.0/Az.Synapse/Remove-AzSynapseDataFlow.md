...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseDataFlow** удаляет поток данных из рабочей области.
...
Эта команда удаляет поток данных с именем ContosoDataFlow из рабочей области с именем ContosoWorkspace.
