...
## NОПИСАНИЕ
Командлет **Set-AzSynapseDataset** создает набор данных или обновляет существующий набор данных в рабочей области.
...
В команде набор данных заосновывается на сведениях в Dataset.jsфайле.
