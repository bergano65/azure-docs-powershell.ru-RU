...
## NОПИСАНИЕ
Командлет **Submit-AzSynapseSparkJob** отправляет задание Synapse Analytics Spark.
...
Эта команда отправляет задание Synapse Analytics Spark.
...
Эта команда отправляет задание Synapse Analytics Spark .NET.
...
Эта команда отправляет задание Synapse Analytics PySpark.

## ПАРАМЕТРЫ

### -CommandLineArgument
Необязательные аргументы для задания. Например, "--Итерация 10000--timeout 20s"
...
### -MainClassName
Полный идентификатор или основной класс, который находится в основном файле определения.
Требуется для задания Spark и .NET Spark.
Например, "org. Apache. Spark. примеры. SparkPi"
