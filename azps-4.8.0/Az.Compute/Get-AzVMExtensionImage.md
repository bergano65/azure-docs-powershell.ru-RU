...
### Пример 2: получение версий изображения расширения с помощью фильтра более ранней версии
```
...
Эта команда получает все версии изображения расширения для указанного местоположения, издателя, типа и версии, начиная с 12.

### Пример 3: получение версий изображения расширения с помощью фильтра для более ранней версии
```
...
Эта команда получает все версии изображения расширения для указанной папки, издателя, типа и версии.
