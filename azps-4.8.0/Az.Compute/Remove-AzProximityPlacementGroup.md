...
## NОПИСАНИЕ
Этот командлет удалит ресурс группы размещения близкого взаимодействия.
...
Эта команда удаляет указанную группу размещения близкого взаимодействия.

### Пример 2

Эта команда удаляет указанную группу размещения близкого взаимодействия. (автоматически сформированные)
...
### -InputObject
Объект группы размещения близкого взаимодействия PS
