...
Создание шифрования диска с помощью заданного активного ключа в хранилище ключей.
...
### -EncryptionType
С помощью этого параметра можно настроить тип шифрования для набора шифрования диска. Доступны следующие значения: "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey".
...
### -KeyUrl
URL-адрес, указывающий на активный ключ в KeyVault
...
### -SourceVaultId
Идентификатор ресурса KeyVault, содержащего активный ключ.
