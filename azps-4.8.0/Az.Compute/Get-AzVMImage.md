...
### Пример 2: получение объекта VMImage
```
...
Эта команда возвращает определенную версию VMImage, совпадающую с указанными значениями.

### Пример 3: получение объектов VMImage
```
...
Эта команда получает все версии VMImage, соответствующие указанным значениям, с фильтрацией по версии.
...
### -OrderBy
Указывает порядок возвращаемых результатов. Отформатированный как запрос OData.
