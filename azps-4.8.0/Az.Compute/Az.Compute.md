...
# AZ. COMPUTE Module
## Nописание
В этом разделе отображаются разделы справки по командлетам COMPUTE для Azure.

## AZ. COMPUTE командлеты
...
Возвращает свойства доступа к диску.

### [Get-AzDiskEncryptionSet](Get-AzDiskEncryptionSet.md)
Получение или перечисление наборов шифрования дисков.
...
Получение и перечисление версий изображений коллекции.
...
Получение или перечисление ресурсов группы размещения близких слов (ов).
...
Получение документа команды "выполнить".
...
Показывает состояние шифрования диска для виртуальных машин в наборе масштабирования виртуальных машин.
...
Предоставление доступа к диску.
...
Оценка состояния исправления виртуальной машины.

### [Invoke-AzVMReimage](Invoke-AzVMReimage.md)
Переобразировать виртуальную машину Azure.
...
Создание набор шифрования диска.

### [New-AzDiskEncryptionSetConfig](New-AzDiskEncryptionSetConfig.md)
Создание настраиваемого объекта с набором шифрования дисков.
...
Создайте определение изображения коллекции.
...
Создайте ресурс группы размещения близких.

### [New-AzSnapshot](New-AzSnapshot.md)
Создание снимка.

### [New-AzSnapshotConfig](New-AzSnapshotConfig.md)
Создание настраиваемого объекта снимка.
...
Создание объекта диска локальных данных для виртуальной машины или Vmss ВМ.
...
Создает объект конфигурации для учетных данных хранилища ключей SQL Server на виртуальной машине.
...
Создает объект-тег IP для сетевого интерфейса VMSS.
...
Удаляет группу доступности из Azure.
...
Удаление определения картинки из коллекции.
...
Удалите ресурс группы размещения близкого взаимодействия.
...
Удаление резервной копии с виртуальной машины.
...
Задает ключевые свойства ключа шифрования для объекта диска.
...
Устанавливает свойства ключа шифрования для объекта обновления диска.
...
Задает свойства ключа шифрования диска для объекта-снимка.
...
Устанавливает свойства ключа шифрования для объекта-снимка.
...
Устанавливает свойства ключа шифрования для объекта обновления моментального снимка.
...
Задает состояние службы оркестрации для VMSS.
...
### [Остановить-AzVmssRollingUpgrade](Stop-AzVmssRollingUpgrade.md)
...
Обновите версию картинки в галерее.
