...
### Пример 1: получение Deploymeng облачного приложения для весны по имени.
```powershell
...
Получение Deploymeng облачного приложения для весны по имени.

### Пример 2: список всех развертываний в соответствии с заданным приложением в облаке весны.
```powershell
...
Перечислите все развертывание в соответствии с заданным приложением в облаке весны.
...
### -Version
Версия указанных развертываний
...
### Microsoft. Azure. PowerShell. командлеты. SpringCloud. Models. Api20190501Preview. IDeploymentResource
