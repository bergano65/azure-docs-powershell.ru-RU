...
## NОПИСАНИЕ
Командлет **Edit-AzWebAppBackupConfiguration** редактирует текущую резервную копию конфигурации для веб-приложения Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1

Командлет Edit-AzWebAppBackupConfiguration изменяет текущий архив конфигурации для веб-приложения Azure. (автоматически сформированные)
