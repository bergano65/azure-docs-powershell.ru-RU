...
## NОПИСАНИЕ
Командлет **Get-AzWebAppCertificate** получает сведения о сертификатах веб-приложения Azure, связанных с определенной группой ресурсов.
...
### Microsoft. Azure. Commands. Apps. WebApp. PSCertificate
