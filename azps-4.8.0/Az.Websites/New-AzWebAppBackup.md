...
## NОПИСАНИЕ
Командлет **New-AzWebAppBackup** создает резервную копию веб-приложения Azure.
...
Создание резервной копии указанного приложения ContosoWebApp, которое находится в группе ресурсов Default-Web-WestUS в https://storageaccount.file.core.windows.net

### Пример 2

Командлет New-AzWebAppBackup создает резервную копию веб-приложения Azure. (автоматически сформированные)
