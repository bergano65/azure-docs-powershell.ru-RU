...
## NОПИСАНИЕ
Командлет **Get-AzDataShareDataSet** получает сведения о наборах данных, добавленных в общий доступ в учетной записи для общего доступа к данным Azure. Если указать имя набора данных, этот командлет получает сведения о наборе данных. Если имя не задано, этот командлет получает сведения обо всех наборах данных в общем доступе. Думаю
...
Эта команда отображает сведения о настройке AdsDataSet в общем доступе AdsShare в учетной записи общего доступа к данным в Azure WikiAdsAccount и группе ресурсов.
...
### -ResourceId
Идентификатор ресурса для набора данных Azure.
