...
## NОПИСАНИЕ
Командлет **Remove-AzDataShareInvitation** удаляет приглашение на доступ к файлам.
...
Эта команда удаляет приглашение с именем ADSInvite из общего доступа AdsShare. 
...
### -InputObject
Объект приглашения на доступ к данным Azure
