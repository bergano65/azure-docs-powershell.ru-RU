...
## NОПИСАНИЕ
Командлет **Stop-AzDataShareSubscriptionSynchronization** останавливает текущую синхронизацию для подписки на общий доступ
...
Останавливает текущую синхронизацию, идентифицированную по идентификатору-20a4416b-b33b-4539-a908-71dc8ef698fb
...
### -InputObject
Объект подписки на общий доступ к данным Azure
...
### -ResourceId
Идентификатор ресурса для подписки на общий доступ Azure
...
### -SynchronizationId
Идентификатор синхронизации, который необходимо остановить
