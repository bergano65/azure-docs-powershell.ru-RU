...
## NОПИСАНИЕ
Командлет **Remove-AzDataShareSynchronizationSetting** удаляет параметр синхронизации для общего доступа к файлам
...
Эти команды удаляют параметр синхронизации с именем AdsShareSynchronizationSetting из общего доступа AdsShare. 
...
### -InputObject
Параметр синхронизации общего доступа к данным Azure.
...
### -ResourceId
Идентификатор ресурса параметра синхронизации
