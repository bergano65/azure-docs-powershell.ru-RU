...
Повторное создание ключа, соответствующего ключу \' Key1 Domain1 домена событий \` \` в группе ресурсов \` MyResourceGroupName \` .
...
Повторное создание ключа, соответствующего ключевому подэлементу \' "domain1 домена" сетки событий, \` \` в группе ресурсов \` MyResourceGroupName \` с использованием полного идентификатора ресурса.
