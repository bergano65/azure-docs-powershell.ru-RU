...
## NОПИСАНИЕ
Командлет **New-AzOperationalInsightsSavedSearch** создает новый сохраненный поиск с заданными параметрами для рабочей области.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание нового сохраненного поиска
```
...
Эта команда создает новый сохраненный поисковый запрос.
...
### -DisplayName
Указывает имя сохраненного отображаемого поиска.
...
### -FunctionAlias
Псевдоним функции, если запрос играет роль функции.
...
### -FunctionParameter
Необязательные параметры функции, если Query используется как функция. Значение должно быть представлено в следующем формате: "param-файл1: тип1 = default_value1, param-имя2: тип2 = default_value2". Дополнительные примеры и правильный синтаксис см https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions .
...
### -Query
Указывает выражение запроса для сохраненного поиска.
