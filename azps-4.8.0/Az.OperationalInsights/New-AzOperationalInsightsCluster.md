...
### -IdentityType
Тип удостоверения — значение "SystemAssigned", "нет".
...
### -Location
Географический регион, в котором будет развернут кластер.
...
### -SkuCapacity
Емкость SKU, значение должно быть кратно 100 и в диапазоне 1000-2000.
