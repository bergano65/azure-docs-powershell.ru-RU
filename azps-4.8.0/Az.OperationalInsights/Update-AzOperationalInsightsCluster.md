...
Обновление кластера с помощью свойств и конфигурации хранилища ключей
...
### -KeyVaultUri
Универсальный код ресурса (URI) для хранилища ключей, "очистить защиту" и "обратимое удаление", должны быть включены для этого keyvault
...
### -SkuName
Имя SKU, теперь может быть только "CapacityReservation"
