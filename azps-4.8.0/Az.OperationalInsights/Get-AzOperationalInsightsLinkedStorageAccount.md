...
## NОПИСАНИЕ
Получение связанной учетной записи хранения, перечисление всех связанных учетных записей хранения, если не указан "-DataSourceType"
...
список связанных хранилищ accoounts для рабочей области {Workspace-Name}
