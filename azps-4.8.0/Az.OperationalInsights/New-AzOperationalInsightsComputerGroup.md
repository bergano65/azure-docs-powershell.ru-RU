...
## NОПИСАНИЕ
Командлет **New-AzOperationalInsightsComputerGroup** создает группу компьютеров в группе ресурсов и расположении.

## ИЛЛЮСТРИРУЮТ

### Пример 1

Создание группы компьютеров. (автоматически сформированные)
