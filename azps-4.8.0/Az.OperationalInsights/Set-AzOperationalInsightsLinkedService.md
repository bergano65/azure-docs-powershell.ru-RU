...
## КРАТКИй обзор
Служба Link для рабочей области
...
кластер связей для рабочей области
...
### -ResourceId
Идентификатор ресурса ресурса, который будет связан с рабочей областью.
Этот способ следует использовать для связывания ресурсов, которым требуется доступ для чтения
...
Идентификатор ресурса ресурса, который будет связан с рабочей областью.
Этот способ следует использовать для связывания ресурсов, которым требуется доступ на запись.
Кластер должен иметь состояние подготовки "успешно" и допустимые свойства keyvault.
