...
## NОПИСАНИЕ
Командлет New-AzNetworkWatcherConnectionMonitorOutputObject создает объект назначения вывода монитора подключений.
...
Тип: "Рабочая область" WorkspaceSettings: {"WorkspaceResourceId": "MyWSResourceId"}
...
### -OutputType
Тип назначения выходных данных монитора подключений. В настоящее время \" поддерживается только Рабочая область \" .
...
### -WorkspaceResourceId
Идентификатор ресурса рабочей области для аналитики журнала.
