...
## NОПИСАНИЕ
Командлет Stop-AzNetworkWatcherConnectionMonitor останавливает указанный монитор подключений.
...
Остановить монитор соединений. (автоматически сформированные)
