...
## КРАТКИй обзор
Извлекает ресурс таблицы маршрута Hub, связанный с VirtualHub.
...
## NОПИСАНИЕ
Получает указанную таблицу маршрутов Hub, связанную с указанным виртуальным концентратором.
...
Эта команда получает таблицу маршрута Hub виртуального концентратора.
...
Эта команда выводит список всех таблиц маршрутизатора Hub в указанном VirtualHub.
...
### -ResourceId
Идентификатор ресурса vhubroutetable ресурса, который требуется получить.
