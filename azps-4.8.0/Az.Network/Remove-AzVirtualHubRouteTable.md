...
### ByVirtualHubRouteTableName (по умолчанию)
```
...
## NОПИСАНИЕ
Удаляет указанную таблицу маршрутов, связанную с указанным виртуальным концентратором.
...
Эта команда удаляет routeTable1 виртуального центра westushub.
...
### -InputObject
Ресурс virtualhubroutetable, который нужно удалить.
...
### -ResourceId
Идентификатор ресурса для ресурса virtualhubroutetable, который нужно удалить.
