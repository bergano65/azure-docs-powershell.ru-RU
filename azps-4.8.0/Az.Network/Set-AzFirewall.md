...
В этом примере Настройка DNS-прокси и DNS-сервера присоединяется к брандмауэру.

### 10: обновление назначения для существующего правила в коллекции правил приложения брандмауэра
```
$azFw = Get-AzFirewall -Name "AzureFirewall" -ResourceGroupName "rg"
...
В этом примере вы обновляете назначение существующего правила в коллекции правил брандмауэра Azure. Это позволяет автоматически обновлять правила при динамическом изменении IP-адресов.

### 11: разрешение активного FTP на брандмауэре Azure
```
$azFw = Get-AzFirewall -Name "AzureFirewall" -ResourceGroupName "rg"
...
В этом примере в брандмауэре разрешено использование активного FTP-сервера.
