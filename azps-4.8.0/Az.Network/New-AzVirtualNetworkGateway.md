...
### Пример 2: Создание шлюза виртуальной сети с внешней конфигурацией RADIUS
```powershell
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
...
### Пример 3: Создание шлюза виртуальной сети с параметрами P2S
```powershell
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
$subnet = New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### Пример 4: Создание шлюза виртуальной сети с конфигурацией проверки подлинности AAD для VpnClient шлюза виртуальной сети.
```powershell
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### Пример 5: Создание шлюза виртуальной сети с помощью VpnGatewayGeneration
```powershell
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
$subnet = New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### Пример 6: Создание шлюза виртуальной сети с помощью IpConfigurationBgpPeeringAddresses
```powershell
...
### -GatewayType
Тип шлюза виртуальной сети: VPN, ExpressRoute
...
### -RadiusServerList
P2S несколько внешних серверных серверов RADIUS.
