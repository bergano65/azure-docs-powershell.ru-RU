...
## КРАТКИй обзор
Запускает операцию захвата пакетов на шлюзе VPN.
...
### -FilterData
Параметры фильтра для запуска захвата пакетов на шлюзе VPN.
...
### -Name (имя)
Имя шлюза VPN, на котором запускается захват пакетов.
...
[Остановить-AzVpnGatewayPacketCapture](./Stop-AzVpnGatewayPacketCapture.md)