...
## NОПИСАНИЕ
Командлет **New-AzApplicationGatewayRewriteRuleActionSet** создает набор действий правила перезаписи для шлюза приложений Azure.
...
Эта команда создает набор действий правила перезаписи и сохраняет результат в переменной с именем $action.
...
Список конфигураций заголовков запросов
...
Список конфигураций заголовков ответов
...
### -UrlConfiguration
Настройка URL-адреса для множества действий
