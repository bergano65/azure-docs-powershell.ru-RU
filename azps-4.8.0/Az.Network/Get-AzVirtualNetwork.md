...
## NОПИСАНИЕ
Командлет **Get-AzVirtualNetwork** получает одну или несколько виртуальных сетей n группы ресурсов.
...
Эта команда получает все виртуальные сети, которые начинаются с "MyVirtualNetwork".
