...
### -FilterData
Параметры фильтра для запуска захвата пакетов на шлюзе виртуальной сети.
...
### -InputObject
Объект шлюза виртуальной сети, в котором запускается сбор пакетов.
...
### -Name (имя)
Имя шлюза виртуальной сети, на котором запускается захват пакетов.
...
### -ResourceId
Идентификатор ресурса Azure VirtualNetworkGateway, в котором запускается захват пакетов.
