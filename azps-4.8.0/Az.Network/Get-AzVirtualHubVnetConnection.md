...
После создания подключения к виртуальной сети Hub оно получает виртуальную сетевую подключение Hub, используя имя группы ресурсов, имя концентратора и имя подключения.
...
После создания подключения к виртуальной сети Hub на нем выводятся все подключения к виртуальной сети Hub с использованием имени группы ресурсов и имени концентратора.
...
Этот командлет выводит список всех подключений к виртуальным сетевым центрам, начиная с "Test", с помощью имени группы ресурсов и имени концентратора.
