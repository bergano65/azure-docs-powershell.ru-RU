...
## NОПИСАНИЕ
Командлет New-AzNetworkWatcherConnectionMonitorTestGroupObject создает тестовую группу монитора подключений.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание тестовой группы с 2 testConfigurations, w Source and 2 конечными точками
...
### -Destination
Список конечных точек назначения.
...
### -Отключение
Флаг, указывающий на то, что группа тестов отключена.
...
### -Source (источник)
Список конечных точек источника.
