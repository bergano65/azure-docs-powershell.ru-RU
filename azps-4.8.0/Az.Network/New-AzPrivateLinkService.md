...
## NОПИСАНИЕ
Командлет **New-AzPrivateLinkService** создает службу частной ссылки

## ИЛЛЮСТРИРУЮТ

### Пример 1

В следующем примере создается служба частной ссылки.
...
Подписка на автоматическое утверждение службы частной ссылки
...
### -EnableProxyProtocol
Включите протокол прокси для службы частной ссылки.
...
IP-конфигурации переднего плана
...
### -Visibility
Подписка на доступность службы частной ссылки
