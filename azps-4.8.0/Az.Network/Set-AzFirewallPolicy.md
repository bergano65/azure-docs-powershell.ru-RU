...
## NОПИСАНИЕ
Командлет **Set-AzFirewallPolicy** обновляет политику брандмауэра Azure.
...
В этом примере для политики брандмауэра задается новое значение политики брандмауэра
...
В этом примере Настройка политики брандмауэра осуществляется с помощью нового режима угроз Intel
...
В этом примере Настройка политики брандмауэра осуществляется с помощью новой угрозы Intel Добавление
...
### -BasePolicy
Базовая политика для наследования от
...
### -ThreatIntelMode
Режим работы для логики операций с угрозами.
