...
## NОПИСАНИЕ
Командлет **Set-AzApplicationGatewayRewriteRuleSet** изменяет правило маршрутизации запросов.
...
Вторая команда изменяет параметр правила перезаписи для шлюза приложения, чтобы использовать правила повторной записи, указанные в переменной $rule.
