...
В описанном выше примере вы создадите группу ресурсов, виртуальную ГЛОБАЛЬную сеть, виртуальную сетевую (Virtual HUB) в группе ресурсов "testRG" в Azure. Шлюз ExpressRoute будет создан на виртуальном концентраторе с двумя единицами масштабирования.

Затем он получает ExpressRouteGateway, используя его resourceGroupName и имя шлюза.
...
Эта команда получит все ExpressRouteGateways, которые начинаются с "Test".
