...
## NОПИСАНИЕ
Командлет **New-AzIpAllocation** создает Azure IpAllocation
...
### -Force
Не запрашивать подтверждение, если вы хотите переопределить ресурс
...
### -IpamAllocationId
КОД выделения IPAM для выделения IP-адресов.
...
### -PrefixLength
Длина префикса для выделения IP-адресов.
