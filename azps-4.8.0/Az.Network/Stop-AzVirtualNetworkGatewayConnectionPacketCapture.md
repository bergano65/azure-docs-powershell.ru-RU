...
## NОПИСАНИЕ
Останавливает операцию захвата пакетов на подключении к шлюзу виртуальной сети и отправляет результат по данному SasUrl контейнера хранилища.
...
### -Name (имя)
Имя подключения к шлюзу виртуальной сети, в котором запускается захват пакетов.
...
### -SasUrl
URL-адрес SAS для захвата остановленных пакетов на шлюзе виртуальной сети.
