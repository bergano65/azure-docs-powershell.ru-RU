...
## КРАТКИй обзор
Получить или просмотреть список сайтов, подключенных к ресурсам виртуального устройства сети (-ов).
...
## NОПИСАНИЕ
Get-AzVirtualApplianceSite возвращает сайты, подключенные к одному или нескольким сетевым ресурсам сетевого устройства, и перечисляет их.
...
Получение ресурса сайта виртуального устройства.
...
Перечислите ресурсы сайта виртуального устройства в сетевом виртуальном устройстве.
...
Виртуальное сетевое устройство, к которому подключен сайт.
...
### -ResourceId
Идентификатор ресурса сайта виртуального устройства.
