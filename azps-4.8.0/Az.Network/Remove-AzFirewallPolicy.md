...
## NОПИСАНИЕ
Командлет **Remove-AzFirewallPolicy** удаляет политику брандмауэра Azure.
...
В этом примере удаляется политика брандмауэра с именем "firewallpolicy" в группе "resourcegroup" TestRg
...
В этом примере удаляется политика брандмауэра по идентификатору.
...
В этом примере удаляется политика брандмауэра $fp
