...
## NОПИСАНИЕ
Командлет **Add-AzApplicationGatewayRedirectConfiguration** добавляет конфигурацию перенаправления в шлюз приложений.
...
Добавляет конфигурацию перенаправления в шлюз приложений. (автоматически сформированные)
