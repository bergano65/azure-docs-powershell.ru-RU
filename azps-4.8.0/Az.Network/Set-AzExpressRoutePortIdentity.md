...
## NОПИСАНИЕ
Командлет **Set-AzExpressRoutePortIdentity** обновляет локальный объект Azure ExpressRoutePort. С помощью **Set-AzExpressRoutePort** назначьте ExpressRoutePort.
