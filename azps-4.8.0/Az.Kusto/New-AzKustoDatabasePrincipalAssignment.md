...
### Пример 1: создание базы данных Kusto кластера principalAssignment
```powershell
...
Вышеприведенная команда создает базу данных Kusto кластера principalAssignment
...
### -PrincipalId
Идентификатор участника, назначенный участнику базы данных.
