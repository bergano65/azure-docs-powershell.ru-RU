...
### Пример 1: удаление существующей базы данных Kusto PrincipalAssignment по имени
```powershell
...
В приведенной выше команде удаляется PrincipalAssignment с именем "kustoprincipal1" в базе данных Kusto "mykustodatabase".
