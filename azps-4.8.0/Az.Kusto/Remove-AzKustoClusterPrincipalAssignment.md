...
### Пример 1: удаление существующей PrincipalAssignment кластера Kusto по имени
```powershell
...
В приведенной выше команде удаляется PrincipalAssignment с именем "kustoprincipal1" в Kusto кластере "testnewkustocluster".
