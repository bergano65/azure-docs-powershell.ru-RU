...
### Пример 1: удаление существующего AttachedDatabaseConfiguration по имени
```powershell
...
Вышеприведенная команда удаляет базу данных, которая определена в AttachedDatabaseConfiguration "myfollowerconfiguration" из кластера "testnewkustoclusterf".
