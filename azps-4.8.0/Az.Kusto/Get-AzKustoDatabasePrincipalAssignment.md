...
### Пример 1: список всех PrincipalAssignment в базе данных по имени
```powershell
...
Вышеприведенная команда возвращает все все PrincipalAssignment в базе данных "mykustodatabase", обнаруженной в кластере "testnewkustocluster".

### Пример 2: получение определенного имени PrincipalAssignment в базе данных
```powershell
...
Вышеприведенная команда возвращает все все PrincipalAssignment с именем "kustoprincipal1" в базе данных "mykustodatabase", обнаруженной в кластере "testnewkustocluster".
...
### Microsoft. Azure. PowerShell. командлеты. Kusto. Models. Api20200614. IDatabasePrincipalAssignment
