...
### Пример 1: создание нового подключения к данным EventHub
```powershell
...
В приведенной выше команде создается новое подключение к данным EventHub с именем "myeventhubdc" для базы данных "mykustodatabase" в кластере "testnewkustocluster".

### Пример 2: создание нового подключения к данным EventGrid
```powershell
...
Вышеприведенная команда создает новое подключение к данным EventGrid с именем "myeventgriddc" для базы данных "mykustodatabase" в кластере "testnewkustocluster".

### Пример 3: создание нового подключения к данным IotHub
```powershell
...
Вышеприведенная команда создает новое подключение к данным IotHub с именем "myiothubdc" для базы данных "mykustodatabase" в кластере "testnewkustocluster".
