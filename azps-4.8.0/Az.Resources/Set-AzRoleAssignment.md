...
## КРАТКИй обзор
Обновление существующего назначения ролей.
...
## NОПИСАНИЕ
Для изменения существующего задания используйте команду "New-AzRoleAssignment".  
Описанием может быть любая допустимая строка, используемая для diferentiate друг от друга.  
Если условие не задано, необходимо также настроить версию Condition, но если вы обновляете условие, которое не требуется.
Версию условия можно обновить с 1,0 на 2,0, но нельзя вернуть обратно. Будьте внимательны, так как 2,0 не retrocompatible с 1,0.
...
### -PassThru
При указании отображается новое назначение роли
