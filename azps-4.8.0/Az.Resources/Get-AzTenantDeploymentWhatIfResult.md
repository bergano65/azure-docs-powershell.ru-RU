...
Эта команда возвращает What-If результат в области клиента с помощью настраиваемого файла шаблона и файла параметров на диске.
...
### Пример 2: получение What-Ifного результата в области клиента с помощью ResourceIdOnly
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
