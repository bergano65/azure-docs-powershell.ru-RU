...
## NОПИСАНИЕ
Командлет **Get-AzResourceProvider** Получает поставщик ресурсов Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение всех поставщиков ресурсов, зарегистрированных в текущей подписке
...
Эта команда получает все поставщики ресурсов из подписки.

### Пример 2: получение всех сведений о поставщике ресурсов из данного ProviderNamespace
...
Эта команда получает все поставщики ресурсов в разделе Microsoft. COMPUTE.

### Пример 3: получение всех сведений о поставщике ресурсов из заданного массива ProviderNamespace
...
Эта команда получает все поставщики ресурсов в разделе "Microsoft. COMPUTE" и "Microsoft. Network".
