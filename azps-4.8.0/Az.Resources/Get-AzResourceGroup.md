...
### Пример 3: получение групп ресурсов на основе тега
```
PS C:\> Get-AzResourceGroup -Tag @{'environment'='prod'}
```

### Пример 4: отображение групп ресурсов по расположению
```
...
### Пример 5: Отображение имен всех групп ресурсов в определенном расположении
```
...
### Пример 6: отображение групп ресурсов, имена которых начинаются с сервера
```
