...
## NОПИСАНИЕ
Командлет **New-AzManagementGroupDeployment** добавляет развертывание в группу управления.

Чтобы добавить развертывание в группе управления, укажите группу управления, расположение и шаблон.
...
Эта команда создает новое развертывание в группе управления "myMG" с помощью настраиваемого шаблона и файла шаблона на диске с параметром "Теги".
...
Эта команда создает новое развертывание в группе управления "myMG" с помощью настраиваемого шаблона и файла шаблона на диске, преобразованного в хэш-таблицу в памяти.
