...
## NОПИСАНИЕ
Командлет **Set-AzManagedApplicationDefinition** обновляет определения управляемых приложений.
...
Обновляет определение управляемого приложения. (автоматически сформированные)
