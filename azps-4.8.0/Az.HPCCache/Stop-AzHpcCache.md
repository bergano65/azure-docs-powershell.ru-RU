...
## NОПИСАНИЕ
Командлет **Stop-AzHpcCache** останавливает кэш Azure HPC.
...
### -Force
Указывает на то, что командлет не запрашивает подтверждение. По умолчанию этот командлет предлагает подтвердить, что вы хотите остановить кэш.
...
### -InputObject
Объект кэша, который нужно остановить.
...
### -ResourceGroupName
Имя группы ресурсов, в которой вы хотите остановить кэширование.
