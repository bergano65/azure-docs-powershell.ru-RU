...
## NОПИСАНИЕ
Командлет **Update-AzHpcCache** обновляет кэш Azure HPC.
...
### -Force
Указывает на то, что командлет не запрашивает подтверждение. По умолчанию этот командлет предлагает подтвердить необходимость обновления кэша.
...
### -ResourceGroupName
Имя группы ресурсов, в которой вы хотите обновить кэш.
