...
## NОПИСАНИЕ
Командлет **Set-AzHpcCacheStorageTarget** обновляет целевую папку хранилища, присоединенную к КЭШУ Azure HPC.
...
### -ResourceGroupName
Имя группы ресурсов, в которой вы хотите обновить целевое хранилище.
