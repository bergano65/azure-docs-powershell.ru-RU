...
Получение сведений о ресурсе типа управляемого узла.
...
### [Restarting-AzServiceFabricManagedNodeType](Restart-AzServiceFabricManagedNodeType.md)
Перезагрузите определенные узлы из типа узла.
