...
## NОПИСАНИЕ
Командлет **Update-AzKeyVaultCertificate** изменяет редактируемые атрибуты сертификата.
...
Изменяет редактируемые атрибуты сертификата. (автоматически сформированные)
...
### -Enable (включить)
Если указано, включите сертификат, если значение равно true.
Отключение сертификата, если значение равно false.
Если не указано, существующее значение состояния Enabled или Disabled сертификата останется неизменным.
...
Если этот параметр указан, возвращают объект сертификата.
...
### -Тег
Хэш-таблица, представляющая Теги сертификата.
Если он не указан, существующие теги Sertificate остаются без изменений.
...
### -Version
Версия сертификата.
Командлет создает полное доменное имя сертификата из имени хранилища, выбранной в данный момент среды, имени сертификата и версии сертификата.
