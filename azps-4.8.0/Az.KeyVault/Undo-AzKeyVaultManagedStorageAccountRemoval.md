...
## NОПИСАНИЕ
Команда **Undo-AzKeyVaultManagedStorageAccountRemoval** восстанавливает ранее удаленную учетную запись хранения, при условии, что для этого хранилища включена функция обратимого удаления и что при восстановлении происходит попытка восстановления.
