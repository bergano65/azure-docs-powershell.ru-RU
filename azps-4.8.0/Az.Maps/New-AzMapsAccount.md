...
## КРАТКИй обзор
Создание учетной записи карт Azure.
...
## NОПИСАНИЕ
Командлет New-AzMapsAccount создает учетную запись карт Azure с указанным SKU.
...
Создает новую учетную запись карт Azure с именем Моя учетная запись в группе ресурсов MyResourceGroup с помощью SKU S0 и тега.
...
### -SkuName
Номер SKU учетной записи карты.
...
### -Тег
Сопоставляет Теги учетной записи.
