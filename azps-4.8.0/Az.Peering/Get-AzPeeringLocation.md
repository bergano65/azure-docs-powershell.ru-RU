...
## NОПИСАНИЕ
Возвращает средства пиринга, к которым пользователи могут подключаться с помощью ARM.
...
Его длинный список местоположений. Получает все прямые средства пиринга.
...
Возвращает расположение пиринга Exchange для Гонолулу. 
...
Возвращает расположение пиринга Exchange для ИД средства пиринга 71. 
...
### Microsoft. Azure. PowerShell. командлеты. Peer (Models. PSPeeringLocation)
