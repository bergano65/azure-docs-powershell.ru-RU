...
### Пример 1: Проверка Dependecies перед фиксацией ресурсов
```powershell
...
Проверка Dependecies перед фиксацией ресурсов.

### Пример 2. Зафиксируйте набор ресурсов в коллекции Move с помощью "MoveResource Name" в качестве входных данных.
```powershell
...
Зафиксируйте набор ресурсов в коллекции Move с помощью "MoveResource Name" в качестве входных данных

### Пример 3. Зафиксируйте набор ресурсов в коллекции Move с помощью "SourceARMID" в качестве входных данных.
```powershell
...
Фиксация набора ресурсов в коллекции Move с использованием "SourceARMID" в качестве входных данных
