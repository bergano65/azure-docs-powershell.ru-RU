...
### Пример 1: Проверка Dependecies перед удалением ресурсов.
```powershell
...
Проверка Dependecies перед удалением ресурсов.

### Пример 2: отмена перемещения ресурсов с помощью "MoveResource Name" в качестве входных данных
```powershell
...
Отменяет перемещение ресурсов, используя в качестве входных данных "MoveResource Name".

### Пример 3: отмена перемещения ресурсов с помощью "SourceARMID" в качестве входных данных
```powershell
...
Отменяет перемещение ресурсов, используя "SourceARMID" в качестве входных данных.
