...
Имя: по умолчанию DefaultAction: Allow ID:/subscriptions/subscriptionId/resourcegroups/ResourceGroup/providers/Microsoft.EventHub/namespaces/EventHub-Namespace-1122/networkRuleSets/default Type: Microsoft. EventHub/Namespaces/NetworkRuleSet IpRules: {4.4.4.4, Allow, 3.3.3.3, Allow} VirtualNetworkRules.

Обновление параметров NetworkRuleSet с помощью IPRule и-VirtualNetworkRule
...
Обновление NetworkRuleSet с помощью-InputObject
...
Обновите NetworkRuleSet с помощью параметра-ResourceId для другого пространства имен.

## ПАРАМЕТРЫ

### -DefaultAction
Действие по умолчанию для NetworkRuleSet
...
### -InputObject
Объект конфигурации NetworkruleSet
...
Указывает, включена ли TrustedServiceAccessEnabled
