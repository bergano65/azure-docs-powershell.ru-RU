...
## КРАТКИй обзор
Обновляет тег для данного кластера.
...
## NОПИСАНИЕ
Командлет Set-AzEventHubCluster обновляет теги в указанном кластере.
...
Обновляет теги данного кластера. 
...
### -Тег
Хэш-таблицы, представляющие тег ресурсов для кластеров
