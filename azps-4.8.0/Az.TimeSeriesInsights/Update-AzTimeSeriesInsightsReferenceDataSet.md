...
### Пример 1: обновление указанного ссылочного значения по имени
```powershell
...
Эта команда обновляет указанный набор эталонных данных.

### Пример 2: обновление указанного объекта ссылочных данных, установленного объектом
```powershell
...
### -Тег
Пары "ключ-значение" дополнительных свойств для набора эталонных данных.
