...
### Пример 1: обновление среды Gen1 Time Series Insights
```powershell
...
Эта команда обновляет среду Gen1 Time Series.

### Пример 2: обновление среды Gen1 Time Series Insights
```powershell
...
### -Тег
Пары "ключ-значение" дополнительных свойств среды.
