...
## КРАТКИй обзор
Создание учетной записи для удаленной отрисовки
...
Создание новой учетной записи удаленной отрисовки "пример" в текущей подписке, группе ресурсов "Rg1" и центральном США.
...
### -Location
Расположение учетной записи удаленной отрисовки.
