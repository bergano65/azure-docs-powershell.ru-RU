...
## КРАТКИй обзор
Повторное создание ключа учетной записи удаленной отрисовки
...
## NОПИСАНИЕ
Повторное создание первичного ключа или вторичного ключа учетной записи удаленной подготовки к просмотру.
...
Повторное создание вторичного ключа учетной записи удаленной отрисовки "пример" в группе ресурсов "Rg1". 
...
Повторное создание вторичного ключа учетной записи удаленной подготовки к просмотру "пример" из текущей подписки и группы ресурсов "Rg1" с помощью конвейера.
...
### -Name (имя)
Имя учетной записи для удаленной отрисовки.
...
### -Primary
Повторное создание первичного ключа учетной записи удаленной отрисовки.
...
### -ResourceId
Идентификатор ресурса для учетной записи удаленной отрисовки.
