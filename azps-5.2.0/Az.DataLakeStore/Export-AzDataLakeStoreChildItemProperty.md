...
## ОПИСАНИЕ
**Export-AzDataLakeStoreChildItemProperty** используется для отчетов об использовании пространства ADLS или /и ACL для данного каталога, а также о его подкадрах и файлах.

## ПРИМЕРЫ

### Пример 1. Использование диска и ACL для всех поднаправлений и файлов
```
...
Получите данные об использовании диска и использовании ACL для всех поднаправленных файлов и файлов в папке /a. IncludeFile гарантирует также, что для файлов сообщается об использовании
...
### -Concurrency
Количество файлов и каталогов, обработанных параллельно.
...
### -MaximumDepth
Максимальная глубина от корневого каталога до тех пор, пока не отобразится значение "Использование диска" или "ACL"
...
### -OutputPath
Путь к выходной файлу. Может быть локальным или Adl Path. По умолчанию он локальный. Если задан путь SaveToAdl, это путь ADL в той же учетной записи
...
В этом случае ДампФайл увяд является путем ADL
