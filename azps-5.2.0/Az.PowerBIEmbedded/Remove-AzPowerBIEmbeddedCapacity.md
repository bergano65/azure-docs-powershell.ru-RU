...
## ОПИСАНИЕ
С Remove-AzPowerBIEmbeddedCapacity-за этого удаляется экземпляр внедренной емкости PowerBI.
...
Эта команда удаляет пропускную способность с именем testcapacity в testRG группы ресурсов
