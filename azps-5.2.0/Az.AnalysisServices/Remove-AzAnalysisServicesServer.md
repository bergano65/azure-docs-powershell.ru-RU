...
## ОПИСАНИЕ
С Remove-AzAnalysisServicesServer-сервера служб Analysis Services удаляется экземпляр
...
Эта команда удаляет сервер testerver из тестовой группы ресурсов
