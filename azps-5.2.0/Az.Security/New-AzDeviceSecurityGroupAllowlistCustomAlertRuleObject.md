...
## ОПИСАНИЕ
С New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject создается новый список разрешенных настраиваемого списка правил оповещения для группы безопасности устройств в решении для системы безопасности IoT.
...
Создание настраиваемого списка оповещений localUserNotAllowed с установленным состоянием отключения
