...
# Модуль Az.Security
## Описание
Центр безопасности Azure обеспечивает контроль над безопасностью подписок Azure и других компьютеров, подключенных к ней за пределами Azure.

## Az.Security Cmdlets
### [Disable-AzIotSecurityAnalyticsAggregatedAlert](Disable-AzIotSecurityAnalyticsAggregatedAlert.md)
Отклонять агрегированное оповещение об IOT-данных

### [Disable-AzSecurityAdvancedThreatProtection](Disable-AzSecurityAdvancedThreatProtection.md)
Отключает политику advanced threat protection для учетной записи хранения или защищенного хранилища.

### [Enable-AzSecurityAdvancedThreatProtection](Enable-AzSecurityAdvancedThreatProtection.md)
Включает политику advanced threat protection для учетной записи storage/zusDB.

### [Get-AzDeviceSecurityGroup](Get-AzDeviceSecurityGroup.md)
Получить группу безопасности устройств (безопасность IoT Hub)

### [Get-AzDiscoveredSecuritySolution](Get-AzDiscoveredSecuritySolution.md)
Получает решения безопасности, которые были выявлены Центром безопасности Azure

### [Get-AzExternalSecuritySolution](Get-AzExternalSecuritySolution.md)
"Получить решение для внешней безопасности" 
...
Получает оповещения системы безопасности, обнаруженные Центром безопасности Azure

### [Get-AzSecurityAutoProvisioningSetting](Get-AzSecurityAutoProvisioningSetting.md)
Параметры автоматической установки системы безопасности

### [Get-AzSecurityCompliance](Get-AzSecurityCompliance.md)
Обеспечение соответствия требованиям к безопасности подписки со временем
...
Сведения о ценах на планы Защитника Azure, включенные в Центре безопасности Azure для подписки.
...
Извлекает эффективную политику защиты информации SQL клиента.

### [New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject](New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject.md)
Создание настраиваемного правила оповещения списка разрешаний для группы безопасности устройств (IoT Security)

### [New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject](New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject.md)
Создание пользовательского правила оповещения списка запретов для группы безопасности устройств (IoT Security)
...
Обновляет параметр автоматической подготовка
...
Задает данные о ценах для планов Защитника Azure, включенных в Центре безопасности Azure для подписки.
...
Задает эффективную политику SQL защиты информации.

### [Start-AzJitNetworkAccessPolicy](Start-AzJitNetworkAccessPolicy.md)
Вызывает запрос на временный сетевой доступ.

### [Update-AzIotSecuritySolution](Update-AzIotSecuritySolution.md)
Обновление одного или двух из следующих свойств в решении для обеспечения безопасности IoT: теги, конфигурация рекомендации, ресурсы, определенные пользователем
...
Получает параметры безопасности в Центре безопасности Azure

### [Set-AzSecuritySetting](Set-AzSecuritySetting.md)
Задает параметр безопасности в Центре безопасности Azure

### [Get-AzSecurityTopology](Get-AzSecurityTopology.md)
Список топологии безопасности для подписки
