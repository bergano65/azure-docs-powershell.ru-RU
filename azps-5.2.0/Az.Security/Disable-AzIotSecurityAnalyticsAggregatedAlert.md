...
## ОПИСАНИЕ
Этот Disable-AzIotSecurityAnalyticsAggregatedAlert отклонить определенное оповещение на устройствах концентратора iot. Имя агрегированных оповещений — это сочетание типа оповещений и дат, разделенных на "/".
...
Отклонение агрегированного оповещения "IoT_SucessfulLocalLogin/2020-03-15" (имя из типа оповещения и даты его обобщения) из решения для безопасности IoT "MySolutionName" в группе ресурсов "MyResourceGroup"
