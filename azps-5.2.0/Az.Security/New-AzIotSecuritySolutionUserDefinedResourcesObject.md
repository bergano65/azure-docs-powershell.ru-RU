...
## SYNOPSIS
Создание пользовательских ресурсов для решения для системы безопасности iOT
...
## ОПИСАНИЕ
Для решения безопасности iOT создается новый объект ресурсов AzIotSecuritySolutionUserDefinedResourcesObject.
...
Создание ресурсов, определенных пользователем
