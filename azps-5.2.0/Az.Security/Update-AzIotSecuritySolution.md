...
Только указанные свойства будут обновлены в решении безопасности iOT.
Решение для защиты IoT собирает данные безопасности и события с IOT-устройств и iot-концентратора для предотвращения и обнаружения угроз.
