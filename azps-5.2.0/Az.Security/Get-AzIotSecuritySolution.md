...
## SYNOPSIS
Получить решение для безопасности IoT
...
## ОПИСАНИЕ
Этот Get-AzIotSecuritySolution возвращает одно или несколько решений безопасности iOT. Решение для защиты IoT собирает данные безопасности и события с устройств iot и iot-концентратора для предотвращения и обнаружения угроз.
...
Получить список всех решений безопасности в группе ресурсов "MyResourceGroup"
