...
## ОПИСАНИЕ
Этот Get-AzIotSecurityAnalyticsAggregatedAlert возвращает одну или несколько обобщенных рекомендаций для устройств iot-концентратора. Агрегированная рекомендация имеет тип
