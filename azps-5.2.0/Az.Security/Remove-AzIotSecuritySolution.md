...
## ОПИСАНИЕ
С Remove-AzIotSecuritySolution удаляется определенное решение для защиты iOT-данных. Решение для защиты IoT собирает данные безопасности и события с устройств iot и iot-концентратора для предотвращения и обнаружения угроз.
