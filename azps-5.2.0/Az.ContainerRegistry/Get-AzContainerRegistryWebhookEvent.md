...
## ОПИСАНИЕ
В Get-AzContainerRegistryWebhookEvent будет перечислены все события веб-приложения.

## ПРИМЕРЫ

### Пример 1. Возвращает все события веб-приложения.
```powershell
...
Возвращает все события веб-приложения.
