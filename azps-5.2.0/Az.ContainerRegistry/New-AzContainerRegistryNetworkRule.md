...
### ByVirtualNetworkRule (по умолчанию)
```
...
## ОПИСАНИЕ
Создайте объект сетевого правила в текущем сеансе Powershell.
...
Создание набора правил виртуальной сети.

## PARAMETERS

### -Action
Действие сетевого правила.
...
### -IPAddressOrRange
Указывает IP- или диапазон IP-адресов в формате CIDR.
Разрешен только IPV4-адрес.
...
### -IPRule
Указать, что нужно создать IPRule.
...
ИД ресурса подсети, например: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
...
### -VirtualNetworkRule
Указать, что нужно создать VirtualNetworkRule.
