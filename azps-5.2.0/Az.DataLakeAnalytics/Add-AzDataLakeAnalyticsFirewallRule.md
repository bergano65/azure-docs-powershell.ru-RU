...
## ОПИСАНИЕ
Для учетной записи Azure Data Lake Analytics добавляется правило брандмауэра **Add-AzDataLakeAnalyticsFirewallRule.**
...
Эта команда добавляет правило брандмауэра под названием "My firewall rule" из учетной записи ContosoAdlAcct с диапазоном IP-адресов: 127.0.0.1 –127.0.0.10

## PARAMETERS

### -Account
Учетная запись Data Lake Analytics для добавления правила брандмауэра в
