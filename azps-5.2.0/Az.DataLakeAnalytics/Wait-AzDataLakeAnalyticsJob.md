...
## ОПИСАНИЕ
Для выполнения задания Azure Data Lake Analytics выполнится cmdlet **Wait-AzDataLakeAnalyticsJob.**
...
Следующая команда ждет завершения задания с указанным ид.
...
### -JobId
Определяет ИД задания, для которого нужно подождать.
...
### -TimeoutInSeconds
Определяет, сколько секунд нужно подождать, прежде чем выйти из операции ожидания.
...
Укажите количество секунд, которое будет отстать от каждой проверки состояния задания.
