...
## ОПИСАНИЕ
Этот Remove-AzDataLakeAnalyticsCatalogCredential удаляет учетные данные каталога Azure Data Lake Analytics.
...
Эта команда удаляет указанные учетные данные каталога Data Lake Analytics.
...
### -DatabaseName
Имя базы данных, в которой хранится учетная данные.
...
### -PassThru
Указывает на то, что этот cmdlet не ждет завершения операции.
...
Это необходимо, если звоните не владельцем учетной записи.
...
### -Recurse
Указывает на то, что при удалении необходимо удалить все ресурсы, зависящие от этих учетных данных, и удалить их.
