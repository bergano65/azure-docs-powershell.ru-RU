...
## SYNOPSIS
Создает виртуальную машину SQL.
...
## ОПИСАНИЕ
С New-AzSqlVM-компьютера создается виртуальная SQL Azure.
...
Создание новой виртуальной машины Azure SQL с именем vm в группе ресурсов ResourceGroup01 
...
### -Location
SQL расположение виртуальной машины.
