...
## ОПИСАНИЕ
С Remove-AzAvailabilityGroupListener-за этого удаляется слушатель группы доступности.
...
Удаляет прослушку Группы доступности AgListener01 в группе доступности AvailabilityGroup01.
...
### -PassThru
Определяет, следует ли вы выводить удаленный ресурс в конце выполнения выполнения cmdlet.
