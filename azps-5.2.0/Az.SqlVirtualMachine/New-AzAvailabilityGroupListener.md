...
## ОПИСАНИЕ
С New-AzAvailabilityGroupListener создается новый слушатель группы доступности.
...
Создает новую группу доступности AgListener01 для группы доступности AvailabilityGroup01 в SQL Virtual Machine Group SqlVmGroup01.
...
### -Port
Номер порта прослушки AG. Значение по умолчанию — 1433.
...
ИД ресурса общедоступных IP-адресов
