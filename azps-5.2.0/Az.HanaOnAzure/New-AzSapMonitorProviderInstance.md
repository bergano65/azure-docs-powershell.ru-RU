...
### Пример 2. Создание экземпляра монитора SAP с ключным хранилищем для HANA
```powershell
...
Эта команда создает экземпляр монитора SAP в словаре для PrometheusHaCluster.
...
ИД ресурса хранилища ключа, который содержит учетные данные HANA.
