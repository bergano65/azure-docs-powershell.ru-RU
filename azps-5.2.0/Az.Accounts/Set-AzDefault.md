...
## ОПИСАНИЕ
Этот Set-AzDefault добавляет или изменяет значения по умолчанию в текущем контексте.
...
Эта команда задает для группы ресурсов по умолчанию группу ресурсов, заданную пользователем.
...
### -Force
Создание группы ресурсов, если указанное значение по умолчанию не существует
...
### -ResourceGroupName
Имя группы ресурсов, за которая устанавливается по умолчанию
