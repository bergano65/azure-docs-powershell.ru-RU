...
## ОПИСАНИЕ
**Новый-AzOperationalInsightsCustomLogDataSource** определяет настраиваемую политику сбора журналов.
...
### -CustomLogRawJson
Настраиваемая политика сбора определяется как необработанные строки нотации объектов JavaScript (JSON).
