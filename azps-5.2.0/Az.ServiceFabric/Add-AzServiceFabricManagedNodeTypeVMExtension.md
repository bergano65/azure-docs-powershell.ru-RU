...
## ОПИСАНИЕ
Добавьте расширение VM к типу узла. Расширение добавит к ресурсу, настроив набор масштаба виртуальной машины.
...
Эта команда добавляет расширение с настройками и защищенными настройками к типу узла.
...
Набор имен расширений, после чего их нужно подготовка.
