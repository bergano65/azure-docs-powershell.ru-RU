...
## SYNOPSIS
Получить сведения о службе "Ткань услуги" в указанном приложении и кластере. Поддерживаются только ARM развернутые службы.
...
В этом примере подробные сведения о ресурсе службы testApp~testService.
