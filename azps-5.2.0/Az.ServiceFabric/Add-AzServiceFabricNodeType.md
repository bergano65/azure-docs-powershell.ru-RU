...
Эта команда добавит новый NodeType "n2" емкостью 5 человек, а имя администратора vm будет "adminName".
...
### -DurabilityLevel
Укажите уровень надежности NodeType.
