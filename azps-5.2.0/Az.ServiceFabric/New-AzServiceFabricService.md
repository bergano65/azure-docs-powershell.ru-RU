...
Некоторые распространенные примеры полей данных, используемых в качестве именовых ключей разделов, — регионы, почтовые индексы, группы клиентов и другие границы бизнеса.
...
Это означает, что каждому разделу принадлежит диапазон ключей int64.
