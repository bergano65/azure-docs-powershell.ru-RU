...
## ОПИСАНИЕ
Используйте **remove-AzServiceFabricNode,** чтобы удалить узлы определенного типа из кластера. Удаление выполняется только в том случае, если оно соответствует показатели эффективности кластера.
...
Количество узлов, которые нужно добавить
