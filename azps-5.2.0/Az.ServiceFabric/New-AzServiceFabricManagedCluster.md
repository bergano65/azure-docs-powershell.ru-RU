...
Используйте этот режим только в режиме обновления вручную.
...
### -SKU
SKU кластера: вариант "Базовый": он будет иметь не менее трех основных узлов и только 1 тип узла и стандартный: он будет иметь не менее 5 основных узлов и допускает несколько типов узлов.
