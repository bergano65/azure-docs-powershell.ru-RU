...
## SYNOPSIS
Сведения о типе версии приложения "Служивная ткань". Поддерживаются только ARM развернутые версии приложений.
...
В этом примере тип приложения TestAppType с версией "v1" возвращается как "testAppType", если ресурс не будет обнаружиться, будет выбрасываться исключение.
...
В этом примере возвращается список версий типа приложения, определенных в указанном кластере и типе.
