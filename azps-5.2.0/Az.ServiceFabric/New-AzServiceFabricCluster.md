...
Эта команда позволит вам создать собственный сертификат и настраиваемый шаблон и создать новый кластер.
...
Укажите имя кластера, если он не задан, будет иметь такое же имя, как имя группы ресурсов.
...
Операционная система ВМ-карт, которые составляют кластер.
