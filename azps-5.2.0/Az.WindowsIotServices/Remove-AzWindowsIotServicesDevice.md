...
### Пример 1. Удаление служб Windows IoT по имени
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Эта команда удаляет службы Windows IoT по имени.

### Пример 2. Удаление служб Windows IoT по конвейеру
```powershell
...
Эта команда удаляет службы Windows IoT по конвейеру.
