...
### -AdministratorLogin
Указывает имя администратора SQL домена.
...
Задайте для параметров *AdministratorLogin* и *AdministratorLoginPassword* имя пользователя и пароль SQL администратора. 
- ADPassword.
