...
## ОПИСАНИЕ
Для AzureSQL Server в текущей подписке с его учетной записью предусмотрены действия администратора **Set-AzSqlServerActiveDirectoryAdministrator.**
...
Эта команда предусматривает предоставление пользователю Azure AD права администратора для сервера с именем Server01.
...
### -DisplayName
Указывает отображаемую имя администратора Azure AD, которое предусмотрено этим cmdlet.
