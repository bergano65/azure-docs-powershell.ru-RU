...
### Пример 3. Политика аудита хранилища BLOB-SQL Azure с расширенными фильтрами с использованием предиката T-SQL.
```powershell
...
### Пример 10. Отключать отправку записей аудита сервера Azure SQL в хранилище BLOB-приложений и включить отправку их для аналитики журналов.
```powershell
...
Указывает, является ли аналитика журнала назначением для записей аудита.
