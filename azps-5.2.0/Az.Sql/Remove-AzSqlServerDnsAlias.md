...
### Удаление псевдонима DNS сервера из параметров ввода для cmdlet
```
...
### Удаление псевдонима DNS сервера из ид ресурса Azure
```
...
## ОПИСАНИЕ
Эти команды удаляют псевдоним DNS Azure SQL Server с сервера, не удаляя сервер.
...
Удаляет псевдоним DNS azure SQL Server с именем сервера с именем сервера.
...
### -InputObject
Объект DNS Alias сервера, который нужно удалить
...
### -ResourceId
ИД ресурса объекта Dns Alias сервера, который нужно удалить
