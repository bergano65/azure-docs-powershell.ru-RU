...
Синхронизация репликации не будет синхронизироваться до прекращения действия.
...
### -DatabaseName
Указывает имя основной базы данных Azure SQL, которая содержит связь репликации, удаляемую этим cmdlet.
