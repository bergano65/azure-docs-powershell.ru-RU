...
## ОПИСАНИЕ
Чтобы получить параметры аудита для azure SQL Server, можно получить параметры аудита для SQL **AzSqlServerAudit.**
Укажите *параметры ResourceGroupName* *и ServerName,* чтобы определить сервер.

## ПРИМЕРЫ

### Пример 1. Настройка параметров аудита для сервера Azure SQL
```
...
### Пример 2. Настройка параметров аудита на сервере Azure SQL
```
...
### Пример 3. Настройка параметров аудита на сервере Azure SQL
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
