...
## ОПИСАНИЕ
Командалет **Update-AzSqlSyncGroup** изменяет свойства группы синхронизации баз данных Azure SQL Azure.

## ПРИМЕРЫ

### Пример 1. Обновление группы синхронизации для базы данных Azure SQL.
```
...
Следует ли использовать ли личную связь при подключении к центру этой группы синхронизации.
