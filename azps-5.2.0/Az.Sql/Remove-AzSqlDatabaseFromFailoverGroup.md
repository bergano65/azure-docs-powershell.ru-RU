...
## ОПИСАНИЕ
Удаляет одну или несколько баз данных из указанной группы отбойных SQL Azure. Базы данных и связи репликации остались без изменений, но больше не будут доступны через конечные точки группы отополн.
