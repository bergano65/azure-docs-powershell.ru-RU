...
Эта команда получает краткое срок политики хранения для всех удаленных баз данных, которые называются database01, путем перенагрывки в удаленном объекте базы данных.
