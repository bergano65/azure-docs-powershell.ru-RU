...
## ОПИСАНИЕ
Для этого создается агент синхронизации Azure SQL **AzSqlSyncAgent.**
...
Эта команда создает агент синхронизации для сервера Azure SQL.
...
### -SyncDatabaseResourceID
ИД ресурса для базы данных метаданных синхронизации.
