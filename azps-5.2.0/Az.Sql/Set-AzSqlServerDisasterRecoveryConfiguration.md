...
## ОПИСАНИЕ
**Cmdlet Set-AzSqlServerDisasterRecoveryConfiguration** изменяет конфигурацию SQL сервера базы данных.
...
### -AllowDataLoss
Указывает на то, что эта операция допускает потерю данных.
...
### -ServerName
Указывает имя сервера SQL базы данных.
