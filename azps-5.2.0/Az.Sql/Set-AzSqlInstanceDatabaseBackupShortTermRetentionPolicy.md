...
### PolicyByResourceInstanceDatabaseSet (по умолчанию)
```
...
## ОПИСАНИЕ
Для этой базы данных зарегистрируется **краткое** политика хранения, зарегистрированная для этой базы данных, с ее учетом.
Политика — это срок хранения резервных копий, которые будут восстанавливаться за несколько дней.
...
Эта команда задает кратковременную политику хранения для базы данных01 в течение 35 дней путем прокажиния в объекте базы данных.
...
Эта команда задает кратковременную политику хранения для всех удаленных баз данных с именем DB1 путем перенагревки в удаленном объекте базы данных. Обратите внимание, что срок хранения только для удаленных баз данных можно сократить.
...
### -InputObject
Прямой или удаленный объект базы данных для получения/изменения политики.
