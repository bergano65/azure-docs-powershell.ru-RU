...
## ОПИСАНИЕ
**Cmdlet Get-AzSqlSyncAgent** возвращает сведения об одном или SQL агентов синхронизации Azure.
Укажите имя агента синхронизации, чтобы увидеть сведения только для этого агента.

## ПРИМЕРЫ

### Пример 1. Получите все экземпляры агента синхронизации Azure SQL, которые назначены azure SQL Server
```
...
Эта команда получает сведения обо всех агентах синхронизации Azure SQL, которые назначены azure SQL Server.

### Пример 2. Сведения об агенте синхронизации Azure SQL
```
...
Эта команда получает сведения об агенте синхронизации базы данных Azure SQL с именем SyncAgent01.

### Пример 3. Получите все экземпляры агента синхронизации Azure SQL, которые назначены azure SQL Server с помощью фильтрации
```
...
Эта команда получает сведения обо всех агентах синхронизации Azure SQL, которые назначены azure SQL Server, которые начинаются с "SyncAgent".
