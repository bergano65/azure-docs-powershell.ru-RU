...
Отключение advanced Data Security для управляемого экземпляра.
...
Получает агент эластичного SQL Azure
...
Получает политику долгосрочного хранения управляемой базы данных
...
Возвращает сведения об агентах синхронизации Azure SQL Azure.
...
Возвращает сведения о группах синхронизации баз SQL Azure.
...
Создание пула экземпляров SQL Azure.
...
Удаление администратора Azure AD для SQL управляемым экземпляром.
...
Удаление ключа сейфа из SQL экземпляра
...
Выполняет отбой от сбой группы отбойных SQL базы данных Azure.
