...
## ОПИСАНИЕ
При **этом удаляется** агент синхронизации Azure SQL Azure.
...
Эта команда удаляет агент синхронизации Azure SQL syncAgent01.
...
### -PassThru
Определяет, возвращает ли удален агент синхронизации
