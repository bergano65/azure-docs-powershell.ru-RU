...
## ОПИСАНИЕ
Cmdlet **Set-AzSqlInstancePool** изменяет свойства пула экземпляров Azure SQL.

## ПРИМЕРЫ

### Пример 1. Настройка типа лицензии пула экземпляров
```powershell
...
### Пример 2. Настройка типа лицензии на экземпляр с помощью объекта пула экземпляров
```powershell
...
### Пример 3. Настройка типа лицензии пула экземпляров с помощью ИД ресурса пула экземпляров
```powershell
