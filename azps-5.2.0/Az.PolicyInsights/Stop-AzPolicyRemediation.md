...
## ОПИСАНИЕ
Из-за выполнения исправлений политика **Stop-AzPolicyRemediation** отменяется. Активные развертывания будут отменены, а новые развертывания не будут созданы.
