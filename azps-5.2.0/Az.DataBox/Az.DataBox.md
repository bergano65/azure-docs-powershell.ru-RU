...
# Модуль Az.DataBox
## Описание
Модуль для создания, отмены, удаления и получения заданий работы с данными
...
Создание задания создания почтового ящика с использованием указанных параметров
