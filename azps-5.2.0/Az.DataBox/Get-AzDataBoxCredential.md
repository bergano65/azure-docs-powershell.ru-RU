...
## ОПИСАНИЕ
**Cmdlet Get-AzDataBoxCredential** получает учетные данные для почтового ящика определенного задания. Внутренние свойства возвращаемого объекта учетных данных отличаются для разных типов SKU.
