...
## ОПИСАНИЕ
**Для получения истории смарт-групп возвращается cmdlet Get-AzSmartGroupHistory.**
...
Возвращает сведения о истории смарт-групп.
...
### -SmartGroupId
Уникальный идентификатор для оповещений SmartGroup и ResourceId.
