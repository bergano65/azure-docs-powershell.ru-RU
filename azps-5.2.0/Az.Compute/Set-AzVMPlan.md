...
Чтобы можно было развернуть изображение Marketplace с помощью командной строки, необходимо включить программный доступ или развернуть виртуальную машину на портале Azure.
...
Это то же значение, которое возвращается Get-AzVMImageSku-управления.
...
### -Publisher
Определяет издателя изображения.
...
Для получения объекта виртуальной Get-AzVM можно использовать Get-AzVM.
