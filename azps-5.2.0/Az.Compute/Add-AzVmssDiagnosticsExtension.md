...
## ОПИСАНИЕ
Cmdlet **Add-AzVmssDiagnosticsExtension** добавляет расширение диагностики к экземпляру набора виртуальных машин (VMSS).
...
Эта команда добавляет к VMSS добавит расширение диагностики.
...
Путь к частному файлу конфигурации.
...
### -SettingFilePath
Путь к файлу общедоступных конфигураций.
...
### -TypeHandlerVersion
Определяет версию расширения, используемого для этой VMSS.
Чтобы получить версию, запустите cmdlet [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) со значением Microsoft.Azure.Diagnostics для параметра *PublisherName* и IaaSDiagnostics для параметра *Type.*
