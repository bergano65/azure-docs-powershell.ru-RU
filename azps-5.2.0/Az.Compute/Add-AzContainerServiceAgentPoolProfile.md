...
Эта команда добавляет профиль пула агентов службы контейнеров в объект локальной службы контейнеров.

## PARAMETERS

### -ContainerService
Определяет объект службы контейнера, к которому этот cmdlet добавляет профиль пула агентов.
Чтобы получить объект **ContainerService,** используйте cmdlet [New-AzContainerServiceConfig.](./New-AzContainerServiceConfig.md)
