...
## ОПИСАНИЕ
Свойства **снимка получает cmdlet Get-AzSnapshot.**
...
Эта команда получает свойства всех моментальных снимков подписки.
...
Эта команда получает свойства всех моментальных снимков в группе ресурсов "ResourceGroupName1"
...
Эта команда получает свойства моментального снимка "SnapshotName1" в группе ресурсов "ResourceGroupName1"
...
Эта команда получает все моментальные снимки, которые начинаются с "SnapshotName"
