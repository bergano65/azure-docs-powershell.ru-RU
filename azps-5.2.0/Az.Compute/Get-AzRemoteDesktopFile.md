...
## ОПИСАНИЕ
Для **этого с помощью cmdlet get-AzRemoteDesktopFile** будет удален RDP-файл.

## ПРИМЕРЫ

### Пример 1. Получить файл удаленного рабочего стола
```
...
Команда сохраняет результат в файле D:\RemoteDesktopFile07.rdp.
...
### -Launch
Указывает на то, что этот cmdlet запускает удаленный рабочий стол после того, как он получает RDP-файл.
...
### -LocalPath
Указывает локальный полный путь, в котором этот cmdlet хранит RDP-файл.
