...
Указывает массив ссылок для резервных адресов пулов балансиры нагрузки.
...
Совмещение метки доменного имени и индекса vm будет меткой доменного имени для созданных ресурсов по общедоступным IP-адресам.
...
Указывает массив ссылок на пулы сетевых адресов для перевода входящих сетевых адресов (NAT) балансиры нагрузки.
