...
## ОПИСАНИЕ
Чтобы получить все версии расширения Azure, можно получить все версии для cmdlet **Get-AzVMExtensionImage.**

## ПРИМЕРЫ

### Пример 1. Просмотр версий расширения
```
...
Эта команда получает все версии изображения расширения для указанного расположения, издателя и типа.

### Пример 2. Просмотр версий изображения расширения с фильтрацией по версии
```
...
Эта команда получает все версии изображения расширения для указанного расположения, издателя, типа и версии, начиная с 12.

### Пример 3. Просмотр версий расширения с фильтрацией по версии
```
...
Эта команда получает все версии изображения расширения для указанного расположения, издателя, типа и версии.
...
### -Type
Определяет тип расширения.
Чтобы получить тип расширения, воспользуйтесь Get-AzVMExtensionImageType..
...
### -Версия
Определяет версию расширения, которое получает этот cmdlet.
...
### Microsoft.Azure.Commands.Compute.Models.PSVirtualMa modelseExtensionImage

### Microsoft.Azure.Commands.Compute.Models.PSVirtualMa modelseExtensionImageDetails
