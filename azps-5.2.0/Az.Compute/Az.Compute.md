...
# Модуль Az.Compute
## Описание
В этой теме представлены разделы справки для cmdlets Azure Compute.
...
Получить или выровнить список ресурсов группы расположения расположения.
...
Возвращает количество основных ядер виртуальных машин для местоположения.
...
Удаляет расширение "Валенка" с виртуальной машины.
...
Задает свойства ссылки на изображение на объекте диска.
...
Добавляет расширение Для ветвей на виртуальную машину.
...
Запускает развертывание обновления, чтобы перенести все экземпляры набора виртуальных машин на последнюю доступную версию ОС платформы image.
