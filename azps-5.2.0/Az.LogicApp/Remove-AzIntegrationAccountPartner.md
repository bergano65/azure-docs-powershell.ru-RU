...
## ОПИСАНИЕ
Для **удаления из группы ресурсов** удаляется партнер учетной записи интеграции.
...
### Пример 1. Удаление партнера учетной записи интеграции
```
...
Эта команда удаляет партнера по учетной записи интеграции IntegrationAccountPartner1.
