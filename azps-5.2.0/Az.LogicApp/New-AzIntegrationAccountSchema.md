...
## ОПИСАНИЕ
Для создания схемы учетной записи создается схема учетной записи **New-AzIntegrationAccountSchema.**
...
Эта команда создает схему учетной записи интеграции IntegrationAccountSchema1 в указанной группе ресурсов.
...
Укажите этот параметр или *параметр SchemaFilePath.*
...
Укажите этот параметр или *параметр SchemaDefinition.*
