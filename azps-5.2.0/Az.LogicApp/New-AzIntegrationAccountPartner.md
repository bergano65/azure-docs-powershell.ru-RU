...
## ОПИСАНИЕ
Для создания партнера по учетной записи **new-AzIntegrationAccountPartner.**
Этот cmdlet возвращает объект, который представляет партнера по учетной записи интеграции.
Укажите имя учетной записи интеграции, имя группы ресурсов, имя партнера и удостоверения партнера.
...
### Пример 1. Создание партнера по интеграции с учетной записью
```
...
Эта команда создает партнера по учетной записи интеграции IntegrationAccountPartner22 в указанной группе ресурсов.

## PARAMETERS

### -BusinessIdentities
Определяет бизнес-удостоверения партнера по интеграции учетной записи.
