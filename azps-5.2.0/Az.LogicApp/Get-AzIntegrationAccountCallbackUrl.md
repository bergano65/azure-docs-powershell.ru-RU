...
## ОПИСАНИЕ
Cmdlet **Get-AzIntegrationAccountCallbackUrl получает URL-адрес** учетной записи для вызова интеграции из группы ресурсов.
Этот cmdlet возвращает объект **CallbackUrl,** который представляет URL-адрес обратного звонка учетной записи интеграции.
...
### Пример 1. Получите URL-адрес вызываемого звонка интеграции
```
...
Эта команда получает URL-адрес вызываемого звонка учетной записи интеграции.
...
### -NotAfter
Указывает дату окончания срока действия URL-адреса для звонка.
