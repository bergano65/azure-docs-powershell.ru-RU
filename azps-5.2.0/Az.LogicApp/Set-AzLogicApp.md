...
## ОПИСАНИЕ
**Cmdlet Set-AzLogicApp** изменяет приложение логики с помощью функции "Приложения логики".
...
Вы можете изменить приложение логики, указав имя, расположение, определение приложения Logic, группу ресурсов и план.
...
### Пример 1. Изменение приложения логики
```
...
Эта команда изменяет приложение логики.
...
### -Parameters
Определяет объект коллекции параметров для приложения Logic.
...
### -UseConsumptionModel
Указывает на то, что при выставлении счета за логику используется модель на основе потребления.
