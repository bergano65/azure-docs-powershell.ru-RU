...
## ОПИСАНИЕ
Используйте эту `Get-AzKeyVaultRoleAssignment` команду для списка всех назначений ролей, которые эффективны по области.
Эта команда возвращает все назначения ролей, присвоенные управляемой функции управления HSM без параметров.
