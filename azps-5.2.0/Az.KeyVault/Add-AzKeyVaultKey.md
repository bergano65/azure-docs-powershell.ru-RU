...
Этот параметр является требоваться при создании нового ключа. Если ключ импортируется с помощью *параметра KeyFilePath,* этот параметр является необязательным:
