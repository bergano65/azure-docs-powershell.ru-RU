...
## ОПИСАНИЕ
Командлет **Add-AzKeyVaultNetworkRule** предоставляет или ограничивает доступ к key vault набору вызываемого адреса, указанному их IP-адресами или виртуальной сетью, к которой он принадлежит. Это правило может ограничивать доступ для других пользователей, приложений и групп безопасности, которым были предоставлены разрешения в политике доступа.

Обратите внимание, что для добавления правил сети невозможно использовать любой диапазон IP-адресов внутри `10.0.0.0-10.255.255.255` организации (частные IP-адреса).
...
Эта команда добавляет правило сети в указанный сейф, позволяя получать доступ к указанному IP-адресу из виртуальной сети, указанной $myNetworkResId.
...
### -VaultName
Указывает имя ключа хранилища, сетевое правило которого было изменено.
