...
Обратите внимание, что хотя при этом не требуется указывать группу ресурсов, для получения одного управляемого HSM необходимо сделать это для улучшения производительности.
...
### -ResourceGroupName
Имя группы ресурсов, связанной с запрашиваемой управляемой службой управления ресурсами.
