...
## SYNOPSIS
Получает основные хранилища, управляемые учетными записями хранилища Azure.
...
## ОПИСАНИЕ
Получает учетную запись хранилища Azure, управлия ключом, если указано имя учетной записи и ключами учетной записи управляет указанный сейф. Если имя учетной записи не указано, будут перечислены все учетные записи, ключами которых управляет указанный сейф.
