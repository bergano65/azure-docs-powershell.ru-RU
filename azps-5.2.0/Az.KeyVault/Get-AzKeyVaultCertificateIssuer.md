...
## ОПИСАНИЕ
Для указанного выпуска сертификата или всех его выпуска в хранилище ключей Azure с его использованием возвращается cmdlet **Get-AzKeyVaultCertificateIssuer.**

## ПРИМЕРЫ

### Пример 1. Получить проблему с сертификатом
```powershell
...
Эта команда получает имя выпуска сертификата TestIssuer01.

### Пример 2. Проблемы с сертификатами списков с использованием фильтрации
```powershell
...
Эта команда возвращает выдачу сертификатов, которые начинаются с "test".
...
### -Name
Указывает имя нужного выпуска сертификата.
