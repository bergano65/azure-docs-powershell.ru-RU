...
Итоговая команда изменяет ключ с именем ITSoftware. Эта команда включает ключ, задает время окончания срока его действия, сохраненное в $Expires, и устанавливает теги, которые хранятся в $Tags.
