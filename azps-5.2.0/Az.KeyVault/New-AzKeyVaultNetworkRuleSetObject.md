...
## ОПИСАНИЕ
Создание объекта, представляющего параметры правил сети, которые можно использовать при создании сейфа.
...
Создание нового хранилища и определяет правила сети, позволяющие получить доступ к указанному IP-адресу из виртуальной сети, указанной $myNetworkResId.
