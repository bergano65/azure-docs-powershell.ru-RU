...
## ОПИСАНИЕ
С **использованием cmdlet Remove-AzKeyVaultAccessPolicy** удаляются все разрешения для пользователя или приложения или всех пользователей и приложений из хранилища ключа.
...
Эта команда удаляет все разрешения, которые есть у приложения в хранилище ключей Contoso03Vault.
...
При указании при создании ресурсов отключается итрица секретов из этого ключевого хранилища поставщиком ресурсов Microsoft.Compute.
...
При этом отключает истику секретов из этого хранилища ключа с помощью шифрования диска Azure.
