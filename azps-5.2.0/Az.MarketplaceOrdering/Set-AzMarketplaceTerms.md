...
## ОПИСАНИЕ
**Cmdlet Set-AzMarketplaceTerms** сохраняет объект условий для заданного id издателя(Publisher), offer id(Product) and plan id(Name) tuple.
...
### Пример 2
Установите для соглашения издателя "Принять". Получите значение параметра "Terms" из cmdlet 'Get-AzMarketplaceTerms'.
