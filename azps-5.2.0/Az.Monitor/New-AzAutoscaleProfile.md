...
Конечная команда создает профиль SecondProfileName с использованием правил в правилах "Правило1" и "Правило2", а затем сохраняет его в переменной $Profile 2.
