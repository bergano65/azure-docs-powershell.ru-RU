...
Эта команда включает все доступные показатели и журналы для Resource01.
...
Эта команда отключает все доступные показатели и журналы для ресурса Resource01.
...
### Пример 5. В этом примере можно включить временную зерну и несколько категорий
```powershell
...
### -Category
Список категорий журнала, которые нужно включить или отключить в соответствии со значением *enabled.*
...
### -InputObject
Входной объект (возможно из конвейера). Имя и ид ресурса будут извлечены из этого объекта.
