...
## SYNOPSIS
Удаление области приватных ссылок
...
Удалить область приватных ссылок с именем "scope_name" в группе ресурсов "rg_name"
...
Удаление области частных связей с помощью ИД ресурса
...
Удалить частную область ссылок с объектом input private link scope
