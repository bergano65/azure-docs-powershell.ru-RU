...
## SYNOPSIS
Создать для ресурса с областью частных связей
...
## ОПИСАНИЕ
Создать для частного ресурса с областью действия ссылки, область действия ресурса может быть рабочей областью аналитики журнала или компонентом Application Insights
...
создание областей ресурса "scoped_resource_name", связанных с компонентом статистики приложения "ai_name"
