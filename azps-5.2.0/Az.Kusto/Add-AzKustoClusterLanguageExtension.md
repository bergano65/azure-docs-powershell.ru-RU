...
### Пример 1. Добавление списка языковых расширений
```powershell
PS C:\> Add-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"}, @{Name="PYTHON"})
```

Вышеуказанная команда добавляет список языковых расширений, которые могут запускаться в запросах KQL
...
VALUE <ILanguageExtension[]>: список языковых расширений.
