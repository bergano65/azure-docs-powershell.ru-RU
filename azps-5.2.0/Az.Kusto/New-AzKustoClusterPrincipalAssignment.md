...
### Пример 1. Создание кластера Кусто
```powershell
...
С этой командой создается principalAssignment кластера Кусто
...
### -PrincipalId
ИД основной суммы, присвоенный основной сумме кластера.
