...
## ОПИСАНИЕ
Для удаления соединения из автоматизации Azure удаляется **cmdlet Remove-AzAutomationConnection.**

## ПРИМЕРЫ

### Пример 1. Удаление подключения
```
PS C:\>Remove-AzAutomationConnection -AutomationAccountName "Contoso17" -Name "ContosoConnection" -ResourceGroupName "ResourceGroup01"
```

Эта команда удаляет сертификат ContosoConnection в учетной записи автоматизации с именем Contoso17.

## PARAMETERS

### -AutomationAccountName
Указывает имя учетной записи автоматизации, для которой этот cmdlet удаляет подключение.
...
### -Name
Указывает имя подключения, которое удаляет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, для которой этот cmdlet удаляет подключение.
