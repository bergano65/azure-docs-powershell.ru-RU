...
## ОПИСАНИЕ
Команда **"Отрегистрировать-AzAutomationScheduledRunbook"** удаляет связь между книгой автоматизации Azure и расписанием.
В расписании запуск книги больше не запускается.

## ПРИМЕРЫ

### Пример 1. Удаление связи между книгой и расписанием
```
...
Эта команда удаляет связь между книгой Runbk01 и расписанием Runbk01Sched.
...
### -JobScheduleId
Определяет ИД запланированной книги запуска.
...
### -RunbookName
Определяет имя книги, которую этот cmdlet отсоединит от расписания.
...
### -ScheduleName
Определяет название расписания, из которого этот cmdlet дисошиацией книги.
