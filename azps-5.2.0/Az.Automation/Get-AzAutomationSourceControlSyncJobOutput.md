...
## ОПИСАНИЕ
Командалет **Get-AzAutomationSourceControlSyncJobOutput** получает выходные данные для задания синхронизации источника данных автоматизации Azure.

## ПРИМЕРЫ

### Пример 1
Эта команда получает результат задания синхронизации управления источником с кодом 08d6d266-27b6-463c-beea-bc48a67ace15 для средства VSTSNative. 
