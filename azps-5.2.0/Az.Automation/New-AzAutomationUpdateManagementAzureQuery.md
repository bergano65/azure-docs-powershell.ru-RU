...
## SYNOPSIS
Создание объекта запроса azure Automation Software Update Configuration Azure.
...
## ОПИСАНИЕ
Создает объект запросов Azure для обновления программного обеспечения, который будет использоваться для создания конфигурации обновления программного обеспечения, которая будет работать по расписанию для обновления списка динамически урегулированного списка виртуальных машин Azure.
...
### -Location
Список мест для виртуальных машин Azure.
