...
## ОПИСАНИЕ
Этот Remove-AzAutomationHybridWorkerGroup удаляет гибридную группу сотрудников из автоматизации.

## ПРИМЕРЫ

### Пример 1
Эта команда удаляет гибридного сотрудника по имени.
...
### -Name
Имя гибридной группы сотрудников.
