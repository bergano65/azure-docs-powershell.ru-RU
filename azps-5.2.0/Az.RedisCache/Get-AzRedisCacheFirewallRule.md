...
## ОПИСАНИЕ
Если **параметр RuleName** указан, то для **azure RedisCacheFirewallRule** можно получить подробные данные о заданном правиле брандмауэра в кэше Azure Redis. Если для **этой операции** задано только имя, в кэше Redis доступны все правила брандмауэра.

## ПРИМЕРЫ

### Пример 1. Получите одно правило брандмауэра
```
...
### Пример 2. Получить все правила брандмауэра
```
...
Эта команда получает все правила брандмауэра из кэша Redis, который называется mycache.
...
### -ResourceGroupName
Имя группы ресурсов, в которой есть кэш.
