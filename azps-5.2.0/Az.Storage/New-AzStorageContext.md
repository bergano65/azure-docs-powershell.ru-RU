...
По умолчанию для контекста хранилища задается проверка подлинности OAuth (Azure AD), если только входная учетная запись хранилища называется.
Подробные сведения о проверке подлинности службы хранилища см. в https://docs.microsoft.com/en-us/rest/api/storageservices/authorization-for-the-azure-storage-services .
...
### Пример 5. Получите контейнер для локальной учетной записи разработчика
```
...
Этот cmdlet создает контекст для ключа, указанного для этого параметра.
