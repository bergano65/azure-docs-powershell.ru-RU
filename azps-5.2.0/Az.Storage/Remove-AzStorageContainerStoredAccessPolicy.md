...
## ОПИСАНИЕ
**Cmdlet Remove-AzStorageContainerStoredAccessPolicy** удаляет хранимую политику доступа из контейнера хранилища Azure.

## ПРИМЕРЫ

### Пример 1. Удаление хранимой политики доступа из контейнера хранилища
```
PS C:\>Remove-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy03"
```

Эта команда удаляет политику доступа с именем Policy03 из хранимого контейнера MyContainer.
