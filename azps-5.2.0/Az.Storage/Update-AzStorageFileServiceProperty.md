...
Эта команда позволяет делиться файлами со softdelete удалить, при этом срок хранения составляет 5 дней.
...
### -ShareRetentionDays
Определяет количество дней хранения для shareRetentionPolicy.
