...
Если имя BLOB-имени не является допустимым для локального компьютера, этот cmdlet автоматически разрешит его, если это возможно.
...
## ПРИМЕЧАНИЯ
* Если имя BLOB-ла недействительно для локального компьютера, этот cmdlet автоматически перезапустит его, если это возможно.
