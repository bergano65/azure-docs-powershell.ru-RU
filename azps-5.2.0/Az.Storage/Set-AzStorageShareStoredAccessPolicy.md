...
## ОПИСАНИЕ
При обновлении политики доступа для хранилища Azure обновляется политика доступа для **cmdlet Set-AzStorageShareStoredAccessPolicy.**

## ПРИМЕРЫ

### Пример 1. Обновление политики хранимого доступа в области хранилища
```
PS C:\>Set-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

Эта команда обновляет хранимую политику доступа с полными разрешениями на доступ.
...
### -NoExpiryTime
Указывает на то, что этот cmdlet очищает свойство **ExpiryTime** в политике хранимого доступа.
...
### -NoStartTime
Указывает на то, что этот cmdlet очищает свойство **StartTime** в политике хранимого доступа.
...
### -Permission
Определяет разрешения в хранимой политике доступа на доступ к папке или файлам в ней.
