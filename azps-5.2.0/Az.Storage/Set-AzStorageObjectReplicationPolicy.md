...
Сначала создайте 2 правила политики репликации объектов и установите политику с 2 правилами для учетной записи назначения. Затем установите политику репликации объектов из учетной записи назначения в учетную запись-источник.
...
Если не ввести ее, будет применяться значение по умолчанию. Это означает, что новая политика будет создана, а ее ИД будет возвращен в созданную политику.
