...
## ОПИСАНИЕ
При **этом из учетной** записи хранилища Azure удаляется одна или несколько таблиц хранилища.
...
В этом примере используется поддиавный знак с параметром *Name* для получения всех таблиц, которые соответствуют шаблонной таблице, а затем передает результат в конвейере для их удаления.
