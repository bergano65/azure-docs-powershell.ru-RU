...
## ОПИСАНИЕ
С **помощью cmdlet Enable-AzStorageBlobDeleteRetentionPolicy** можно удалить политику хранения для службы BLOB-хранилищ Azure.
...
Эта команда позволяет удалить политику хранения для службы BLOB-документов и установить для удаленных дней хранения BLOB-4 дней.
