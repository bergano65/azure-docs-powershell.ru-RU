...
### Пример 5. Настройка keySource для Keyvault
```
...
Эта команда задает для ключей шифрования значение Microsoft.Storage.
...
### -Tag
Пары "значение ключа" в виде hash table, задаваемой на сервере в качестве тегов. Например: @{key0="value0";key1=$null;key2="value2"}
