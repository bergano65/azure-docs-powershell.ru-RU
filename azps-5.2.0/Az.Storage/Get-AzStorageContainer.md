...
## ОПИСАНИЕ
С **помощью cmdlet get-AzStorageContainer** вы можете выбрать контейнеры хранилища, связанные с учетной записью хранилища в Azure.
...
### -Префикс
Указывает префикс, используемый в имени контейнера или контейнера, который вы хотите получить.
