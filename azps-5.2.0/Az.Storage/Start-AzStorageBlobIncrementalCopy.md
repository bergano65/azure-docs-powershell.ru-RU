...
### -Контекст
Контекст источника хранилища Azure. Вы можете создать его с New-AzStorageContext- или с помощью New-AzStorageContext.
...
### -DestContext
Контекст места назначения хранилища Azure. Вы можете создать его с New-AzStorageContext- или с помощью New-AzStorageContext.
