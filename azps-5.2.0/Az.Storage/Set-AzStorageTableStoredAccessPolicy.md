...
## ОПИСАНИЕ
С его использованием можно настроить политику доступа для таблицы хранилища Azure с использованием **cmdlet Set-AzStorageTableStoredAccessPolicy.**
...
Эта команда задает политику доступа с именем Policy08 для таблицы хранения "МояТаблита".
