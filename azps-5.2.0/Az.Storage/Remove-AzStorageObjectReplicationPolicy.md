...
## ОПИСАНИЕ
Для удаления указанной политики репликации объектов из учетной записи хранения удаляется cmdlet **Remove-AzStorageObjectReplicationPolicy.**

## ПРИМЕРЫ

### Пример 1. Удаление политики репликации объектов с определенным ид политики из учетной записи хранения.
```
Remove-AzStorageObjectReplicationPolicy -ResourceGroupName "myresourcegroup" -AccountName "mystorageaccount" -PolicyId $policyId
```

Эта команда удаляет из учетной записи хранения политику репликации объектов с определенным ид политики.
