...
## SYNOPSIS
Учетная запись "Получить пространственные привязки"
...
Перечислить все пространственные привязки в группе ресурсов "rg1". 
...
Получить пространственную привязку "пример" учетной записи в группе ресурсов "rg1". 
