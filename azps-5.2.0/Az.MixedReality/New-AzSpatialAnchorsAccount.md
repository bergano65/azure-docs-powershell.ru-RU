...
## SYNOPSIS
Создание учетной записи пространственой привязки
...
Создайте новый пространственный "пример" учетной записи с привязкой в текущей подписке, группе ресурсов "rg1" и Центральной США.
...
### -Location
Расположение учетной записи с пространственными привязками.
