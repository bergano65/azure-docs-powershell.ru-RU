...
## SYNOPSIS
Получить учетную запись удаленной отрисовки
...
Перечислить все учетные записи удаленной отрисовки в группе ресурсов "rg1". 
...
Получить "пример" учетной записи удаленной отрисовки в группе ресурсов "rg1". 
