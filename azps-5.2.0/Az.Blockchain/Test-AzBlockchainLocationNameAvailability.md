...
### Пример 1. Проверка на наличии имени ресурса
```powershell
...
### Пример 2. Проверка на наличии имени ресурса
```powershell
...
### -Name
Возвращает или устанавливает проверяемую фамилию.
...
### -Type
Возвращает или задает тип проверяемого ресурса.
