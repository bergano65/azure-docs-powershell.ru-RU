...
### Пример 1. Обновление виртуального настольного приложения Windows
```powershell
...
Эта команда обновляет приложение Виртуального рабочего стола Windows в соответствующей группе.
