...
### Пример 1. Unregister a Windows Virtual Desktop Application Group
```powershell
...
Эта команда unregisters a Windows Virtual Desktop Application Group to a Workspace.

## PARAMETERS

### -ApplicationGroupPath
Путь к resourceGroupName
