...
### Пример 1. Удаление пользователя виртуального рабочего стола Windows по имени
```powershell
...
Эта команда удаляет пользователя виртуального рабочего стола Windows на рабочем столе.
...
### -Force
Принудительное пометка для входа пользователя.
...
### -Id
Имя сеанса пользователя в указанном хосте сеанса
