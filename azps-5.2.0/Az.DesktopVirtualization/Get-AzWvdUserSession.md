...
### Пример 1. Get a Windows Virtual Desktop UserSession by name
```powershell
...
Эта команда получает окно userSession виртуального рабочего стола Windows на рабочем столе.

### Пример 2. List Windows Virtual Desktop UserSessions
```powershell
...
Эта команда содержит список userSessions виртуального рабочего стола Windows на рабочем столе.

### Пример 3. List Windows Virtual Desktop UserSessions in host pool
```powershell
...
Эта команда содержит список userSessions виртуального рабочего стола Windows в хост-сеансе в пуле хостов.
...
Допустимые свойства фильтрации: userprincipalname и sessionstate.
...
### -Id
Имя сеанса пользователя в заданном хосте сеанса
...
### -SessionHostName
Имя сеанса в указанном пуле хостов
