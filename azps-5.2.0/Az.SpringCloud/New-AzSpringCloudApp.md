...
### Пример 1. Создание весенних облачных приложений.
```powershell
...
Создайте весенние облачные приложения.
...
### -Location
Географическое расположение приложения всегда одинаковое с родительским ресурсом
