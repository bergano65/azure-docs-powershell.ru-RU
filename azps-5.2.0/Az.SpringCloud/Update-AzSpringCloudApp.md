...
### Пример 1. Обновление приложения "Весенний облако" по имени.
```powershell
...
Обновление приложения Spring Cloud по имени.

### Пример 2. Обновление приложения "Весенние облака" из трубы.
```powershell
...
Обновление приложения Spring Cloud из канала.

## PARAMETERS

### -ActiveDeploymentName
Имя активного развертывания Приложения
...
### -HttpsOnly
Указать, разрешено ли использовать только https.
...
### -Location
Расположение с помощью GEO приложения, всегда одинаковое с родительским ресурсом
...
Размер сохраняемого диска в ГБ
...
### -Public
Указывает на то, является ли приложение общедоступным конечным точкой
