...
### Пример 7. Создайте билет в службу поддержки по квоте, чтобы увеличить квоту активных заданий и расписания для учетной записи пакета. Используйте Get-AzSupportService и Get-AzSupportProblemClassification для получения правильныхGUID для классификации проблемных пакетов квот.
```powershell
...
### Пример 8. Создайте билет в службу поддержки по квоте, чтобы увеличить количество пакетных учетных записей для подписки. Используйте Get-AzSupportService и Get-AzSupportProblemClassification для получения правильныхGUID для классификации проблемных пакетов квот.
```powershell
...
### Пример 11. Создайте билет в службу поддержки по квоте, чтобы увеличить квоту DTUs для SQL хранилища данных. Используйте Get-AzSupportService и Get-AzSupportProblemClassification для получения правильных GUID для классификации SQL хранилища дат.
```powershell
...
### Пример 14. Создайте билет в службу поддержки по квоте, чтобы увеличить квоту ядер VM для конкретной службы VM Для машинного обучения. Используйте Get-AzSupportService и Get-AzSupportProblemClassification для извлечения правильных GUID для классификации проблем службы машинного обучения.
```powershell
...
Это ид ресурса ресурса службы Azure (например, ресурс виртуальной машинной машины или ресурс HDInsight), для которого создается билет в службу поддержки.
