...
## SYNOPSIS
Создайте ключ запроса для службы поиска Azure.
...
## ОПИСАНИЕ
Для **нового ключа** запроса для службы поиска Azure создается новый ключ запроса.
...
В этом примере создается новый ключ запроса для службы поиска Azure.
...
### -Name
Имя ключа запроса службы поиска.
