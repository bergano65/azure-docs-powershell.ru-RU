...
## ОПИСАНИЕ
При **нажатии на клавишу Remove-AzSearchQueryKey** ключ запроса удаляется из службы поиска Azure.
...
В этом примере ключ запроса удаляется из службы поиска Azure.
...
### -KeyValue
Значение ключа запроса службы поиска.
