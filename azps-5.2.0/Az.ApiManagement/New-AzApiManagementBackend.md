...
## SYNOPSIS
Создание новой объектной структуры.
...
### Пример 1. Создание backend 123 с помощью базовой схемы авторизации
```powershell
...
### -Credential
Сведения об учетных данных, которые следует использовать при беседе с backend.
Этот параметр является необязательным.
