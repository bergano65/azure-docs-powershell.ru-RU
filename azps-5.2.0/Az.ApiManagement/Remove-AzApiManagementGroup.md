...
## ОПИСАНИЕ
В **результате выполнения команды Remove-AzApiManagementGroup** удаляется существующая группа управления API.
...
Эта команда удаляет существующую группу управления с именем Group0001 и не будет запросить подтверждение.
