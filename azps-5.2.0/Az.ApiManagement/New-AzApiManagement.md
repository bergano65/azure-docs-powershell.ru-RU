...
Эта команда создает службу управления API премиум-уровня в виртуальной сетевой подсети Azure, в которой есть конечная точка внешнего шлюза с эталонным регионом в западной части США.
...
Эта команда создает стандартную службу управления API SKU и включает TLS 1.0 в клиенте Frontend для шлюза ApiManagement и обратного клиента между ApiManagement Gateway и Backend.
