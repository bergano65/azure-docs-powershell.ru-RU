...
### Пример 1. Создание диагностики глобальной области
```powershell
...
### -BackendSetting
Диагностический параметр для входящих и исходяющих http-сообщений на backend. Этот параметр является необязательным.
