...
## ОПИСАНИЕ
Для получения указанной подписки (или всех подписок, если она не указана) cmdlet **Get-AzApiManagementSubscription.**
...
### Пример 4. Получить все подписки для продукта
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
