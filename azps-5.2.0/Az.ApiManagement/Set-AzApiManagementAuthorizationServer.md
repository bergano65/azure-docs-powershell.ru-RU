...
## ОПИСАНИЕ
Cmdlet **Set-AzApiManagementAuthorizationServer** изменяет сведения о сервере авторизации управления API Azure.
...
Изменяет сервер авторизации. (autogenerated)
...
### -ServerId
Определяет код сервера авторизации, который нужно изменить.
...
### -TokenEndpointUrl
Указывает конечную точку маркера для получения маркеров доступа в exchange для презентации маркеров авторизации или обновления.
