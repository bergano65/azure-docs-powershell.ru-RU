...
Получить текущий ИД партнера по управлению
...
Получите текущий ИД партнера по управлению с помощью его ид, если он не совпадает, он не будет работать
...
### -PartnerId
Номер партнера по управлению — 6 цифр.
