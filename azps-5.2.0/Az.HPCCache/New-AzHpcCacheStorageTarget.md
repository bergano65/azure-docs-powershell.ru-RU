...
## ОПИСАНИЕ
**Новый-AzHpcCacheStorageTarget** добавляет целевой объект хранилища в кэш HPC Azure.
...
### -CLFS
Обновление целевого типа хранилища CLFS.
...
### -Force
Указывает на то, что при этом не будет предложено подтвердить запрос. По умолчанию этот cmdlet запросит подтверждение очистки кэша.
...
### -NFS
Обновление целевого типа хранилища NFS.
...
### -ResourceGroupName
"Имя группы ресурсов, для которой вы хотите создать целевую хранилищу для заданного кэша.
