...
## ОПИСАНИЕ
Для получения целевых объектов хранилища, которые существуют в кэше, получаются целевые объекты хранилища, которые существуют на сайте **Get-AzHpcCacheStorageTarget.**
