...
## ОПИСАНИЕ
На **устройстве Get-AzDataBoxEdgeJob** происходит набор активных заданий на устройстве Edge box data Box. Вы можете упомянуть параметр Name, чтобы получить сведения об определенном заданиях.
