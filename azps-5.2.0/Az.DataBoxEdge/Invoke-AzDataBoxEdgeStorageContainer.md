...
## ОПИСАНИЕ
**Cmdlet Invoke-AzDataBoxEdgeStorageContainer** вызывает действия для обновления данных в контейнере хранилища на устройстве Edge Data Box. 
...
### -RefreshData
Обновление метаданных контейнера с данными из облака
