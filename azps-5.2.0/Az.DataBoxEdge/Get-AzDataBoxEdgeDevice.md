...
## ОПИСАНИЕ
Чтобы получить сведения о доступных устройствах Edge Box, можно получить сведения о **get-AzDataBoxEdgeDevice.** Вы можете указать имя устройства вместе с именем группы ресурсов, чтобы получить сведения о конкретном устройстве. 
...
### -Оповещение
Извлечение оповещений на устройстве границы или шлюза в поле данных
...
### -ExtendedInfo
Получает дополнительные сведения для указанного устройства шлюза Box Box или Data Box.
...
### -NetworkSetting
Получает параметры сети для указанного устройства шлюза Box или Data Box.
