...
## ОПИСАНИЕ
Для создания учетной записи Edge На устройстве Edge с полем данных создается новый набор учетных записей **AzDataBoxEdgeStorageAccount.** На устройстве одну учетную запись edge Storage можно как можно соотнося только с одной учетной записью облачного хранилища.
...
2 EdgeStorageAccounts на устройстве не могут делиться более чем 1 учетной записью облачного хранилища
...
### -Облако
Будет использовать CloudStorageAccount для многоуровневого
