...
Вызов отступа для концентратора IoT в геосопозиционном регионе аварийного восстановления.
...
Удалите устройство концентратора IoT.

### [Remove-AzIotHubDevice Темы](Remove-AzIotHubDeviceChildren.md)
Удаление не edge-устройств как детей с указанного edge-устройства.
