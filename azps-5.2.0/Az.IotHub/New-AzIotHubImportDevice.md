...
## ОПИСАНИЕ
Создает задание для устройств импорта для IotHub.
Все устройства будут импортироваться в IotHub из указанного контейнера. О том, как создать URI SAS, можно узнать в следующей статье.
...
Создает запрос на импорт устройства для IotHub "myiothub".
...
Input BLOB Container Uri для FileUpload
...
Uri, на который нужно вписать выходные данные. 
