...
При этом все устройства будут экспортироваться в указанный контейнер. О том, как создать URI SAS, можно узнать в следующей статье.
