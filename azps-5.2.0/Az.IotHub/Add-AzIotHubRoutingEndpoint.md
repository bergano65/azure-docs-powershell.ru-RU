...
## ОПИСАНИЕ
Добавьте новую конечную точку в концентраторЕ IoT. Чтобы узнать о поддерживаемых конечных точках, см. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
Добавьте новую конечную точку E2 типа EventHub в центр IoT myiothub.
...
Добавьте новую конечную точку "S1" типа AzureStorageContainer в концентратор IoT myiothub.

## PARAMETERS

### -ConnectionString
Строка подключения конечной точки маршрутки
...
### -EndpointName
Имя конечной точки маршрутинга
...
Группа ресурсов ресурса конечной точки
...
SubscriptionId ресурса конечной точки
...
### -EndpointType
Тип конечной точки маршрутинга
...
Выберите формат, в котором вы хотите перена маршрутить данные. Вы можете выбрать JSON или AVRO. По умолчанию установлено значение AVRO.
