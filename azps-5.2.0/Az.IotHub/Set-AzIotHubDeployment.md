...
## ОПИСАНИЕ
Обновление указанных свойств развертывания IoT Edge.
Примечание. Содержимое конфигурации является неавтеринимым. Можно обновлять такие свойства конфигурации, как "метки", "метрики", "приоритет" и "targetCondition".
Дополнительные https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring  сведения см. в этой информации.
...
Измените приоритет развертывания IoT Edge и обновите его целевое условие.
...
Обновите метрики и метки развертывания IoT Edge.
...
### -Force
Позволяет заменить объект развертывания, даже если он был обновлен с момента его последнего получения.
