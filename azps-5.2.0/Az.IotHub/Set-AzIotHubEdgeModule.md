...
## ОПИСАНИЕ
Применяет содержимое конфигурации предоставленных модулей к указанному устройству границы.
Примечание. При выполнении команды будет выводит коллекцию модулей, примененных к устройству.
...
Тестировать модули на время разработки, устанавливая модули на целевое устройство.
...
### -ModulesContent
Содержимое конфигурации модулей для устройств IoT Edge.
