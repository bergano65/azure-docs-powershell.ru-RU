...
Он Edit-AzWebAppBackupConfiguration изменить текущую резервную копию конфигурации для Azure Web App. (autogenerated)
...
Сохранить по крайней мере одну резервную копию
