...
Создает план службы приложения Azure в заданном географическом расположении.
...
New-AzWebAppContainerPSSession создает новый удаленный сеанс PowerShell в контейнере Windows, указанном на определенном сайте или в слоте и заданной группе ресурсов
...
Обновляет наследование для сайта Restiction "Access Restiction" основного сайта для сайта SCM для Azure Web App.
