...
Если есть два удаленных приложения с одинаковым именем (ContosoApp), мы получаем сведения о сайтах и восстанавливаем приложение с именем ContosoRestore с помощью нужного приложения, позвонив на восстановление с помощью ИД.
