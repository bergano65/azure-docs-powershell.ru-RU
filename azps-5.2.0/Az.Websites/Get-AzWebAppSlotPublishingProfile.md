...
## ОПИСАНИЕ
Для указанного слота профиль публикации Web App возвращается с помощью cmdlet **Get-AzWebAppSlotPublishingProfile.**
...
Эта команда получает профиль публикации в формате Ftp для slot Slot001, связанный с web App ContosoWebApp, связанный с группой ресурсов Default-Web-WestUS, и сохраняет его в указанном выходном файле.
