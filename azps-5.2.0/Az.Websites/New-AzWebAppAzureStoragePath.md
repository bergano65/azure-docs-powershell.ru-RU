...
## ОПИСАНИЕ
Создание объекта, представляюного путь хранилища Azure, который должен быть установлен в веб-приложении.
...
### -AccessKey
Ключ доступа к учетной записи хранилища Azure
...
### -MountPath
Путь в контейнере, где будет обначена указанное shareName
...
### -Name
Идентификатор свойства "Хранилище Azure".
Должен быть уникальным в пределах веб-приложения или слота
...
### -ShareName
Имя области для крепления к контейнеру
...
### -Type
Тип учетной записи хранилища Azure.
