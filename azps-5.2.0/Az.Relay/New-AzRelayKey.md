...
## ОПИСАНИЕ
Командлет **New-AzRelayKey** создает строки основного и дополнительного подключения для заданной сущности Relay (Namespace/WcfRelay/HybridConnection).
...
### Пример 1.1. Предоставлено keyValue пространства имен
```
...
создает строки основного или дополнительного подключения для заданного Relay-Namespace с заданным значением ключа.
...
### Пример 2.1. Предоставлено значение ключа для WcfRelay
```
...
создает строки основного или дополнительного подключения для заданного Relay-WcfRelay с заданным значением ключа.

### Пример 3. Гибриднаясоединение
```
...
### Пример 3.1. Предоставлено значение ключа HybridConnection
```
...
создает строки основного или дополнительного подключения для заданного Relay-HybridConnection с заданным значением ключа.
