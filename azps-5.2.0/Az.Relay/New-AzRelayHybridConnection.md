...
## ОПИСАНИЕ
Командлет New-AzRelayHybridConnection создает гибридное подключение в указанном пространстве имен ретрансляции.
...
Создает новое решение HybirdConnection TestHybirdConnection2 в указанной области имен ретрансляции \` \` \` TestNameSpace-HybirdConnection. \`
...
Создает новое решение HybirdConnection TestHybirdConnection1 в указанной области имен ретрансляции \` \` \` TestNameSpace-HybirdConnection. \`
...
true, если для этого подключения HybridConnections требуется авторизация клиента; в противном случае ложь
...
### -UserMetadata
Gets or sets usermetadata — это место для хранения пользовательских строковые данных для конечной точки HybridConnection. его можно использовать для хранения описательных данных, таких как список групп и их контактные данные, а также пользовательские параметры конфигурации.
