...
## ОПИСАНИЕ
Командлет **New-AzRelayAuthorizationRule** создает новое правило авторизации для указанных сущностями Relay (Namespace/WcfRelay/HybridConnection).
...
Создается `AuthoRule1` с **правами на** прослушивание для пространства `TestNameSpace-Relay1` имен.
...
Создает правило авторизации `AuthoRule1` с **правами на** прослушивание для WcfRelay. `TestWCFRelay1`
...
Создается `AuthoRule1` с **правами на прослушивание** для гибридного `TestHybridConnection` подключения.
