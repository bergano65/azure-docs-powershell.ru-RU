...
## ОПИСАНИЕ
Командлет **Remove-AzWcfRelay** удаляет WcfRelay из указанного пространства имен ретрансляции.
...
Удаляет WcfRelay `TestWCFRelay1` из пространства `TestNameSpace-Relay1` имен.
