...
## ОПИСАНИЕ
С **его нарезным проектлетом Get-AzConsumptionMarketplace** вы получаете маркеты подписки.

## ПРИМЕРЫ

### Пример 1. Использование Marketplace
```powershell
...
### Пример 2. Использование marketplace с диапазоном дат
```powershell
...
### Пример 3. Использование BillingPeriodName в Marketplace
```powershell
...
### Пример 4. Использование Marketplace с помощью фильтра InstanceName
```powershell
...
### -BillingPeriodName
Название определенного периода вы выставления счета, чтобы получить магазин, который связывает с ним.
...
### -EndDate
Даты окончания (в UTC) магазинов, которые нужно отфильтровать.
...
### -InstanceId
ИД экземпляра из магазинов, которые нужно отфильтровать.
...
### -InstanceName
Имя фильтруемого экземпляра marketplaces.
...
### -ResourceGroup
Группа ресурсов магазинов, которые нужно отфильтровать.
...
### -StartDate
Начальную дату (в UTC) магазинов, которые нужно отфильтровать.
