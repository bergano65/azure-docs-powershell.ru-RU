...
## ОПИСАНИЕ
Для даты предоставляется подробные сведения о резервированиях **для get-AzConsumptionReservationDetail.**

## ПРИМЕРЫ

### Пример 1. Получите сведения о резервировании с помощью ИД заказа на резервирование для за предоставленного диапазона дат
```powershell
...
### Пример 2. Получите сведения о резервировании с помощью ИД заказа на резервирование и ИД резервирования для за предоставленного диапазона дат
```powershell
...
### -EndDate
Конечные данные для подробных данных о резервировании (ММ-ММ-ДД в UTC).
...
### -StartDate
Начальные данные (ММ-ММ-ДД В UTC) в сведениях о резервировании.
