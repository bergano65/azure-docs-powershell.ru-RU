...
### Обновление ключа проверки подлинности MD5
```powershell
...
Устанавливает флажок "Использовать для пиринга службы"
...
Задает Ipv4-адрес для пиринга Exchange с помощью ResourceId
...
### -DirectConnection
Создайте новое прямое подключение, используя New-AzDirectPeeringConnectionObject и по конвейеру до этой команды.
...
### -ExchangeConnection
Создайте новое подключение Exchange, используя New-AzExchangePeeringConnectionObject и по конвейеру до этой команды.
