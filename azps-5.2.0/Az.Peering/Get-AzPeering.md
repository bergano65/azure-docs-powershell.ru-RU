...
## ОПИСАНИЕ
Возвращает пиринги из подписки, группы ресурсов или по имени.
...
Получает имя пиринга Exchange `myExchangePeering1`
...
Возвращает пиринг Exchange, именующийся `myExchangePeering1` на основе ид ресурса.
