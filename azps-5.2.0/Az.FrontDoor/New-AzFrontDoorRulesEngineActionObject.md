...
Используйте cmdlet "New-AzFrontDoorHeaderActionObject" для создания PSHeaderObjects, которые передаются в параметры "-RequestHeaderActions" и "-ResponseHeaderActions".
...
Список действий с заглавами, которые должны применяться в ответе AFD для клиента.
