...
### -FrontDoorName
Название переднего входа, к которому принадлежит это правило маршрутки.
...
Имя параметров проблемы с состоянием здоровья для этого пула
...
Имя параметров балансировки нагрузки для этого пула
