...
### -NegateCondition
В этой статье описывается, является ли это условием negate или значением по умолчанию не является ложь.
...
### -Transform
Преобразования, которые нужно применить. Возможные значения: Lowercase', 'Uppercase', 'Trim', 'UrlDecode', 'UrlEncode', 'RemoveNulls'.
