...
## ОПИСАНИЕ
В **ресурсе Get-AzFrontDoorFrontendEndpoint** все существующие конечные точки переднего входа в ресурсе Front Door, совпадают с предоставленными сведениями.

## ПРИМЕРЫ

### Пример 1. Получить все конечные точки переднего входа в front door "frontdoor1", которая входит в группу ресурсов "rg1".
```powershell
...
Получить все конечные точки переднего входа на переднем двери "frontdoor1", который входит в группу ресурсов "rg1".

### Пример 2. Получите конечную точку переднего использования с именем "frontdoor1-azurefd-net" в front door "frontdoor1", которая входит в группу ресурсов "rg1"
```powershell
...
Получить переднюю конечную точку с именем frontdoor1-azurefd-net в front door "frontdoor1", который входит в группу ресурсов "rg1"
