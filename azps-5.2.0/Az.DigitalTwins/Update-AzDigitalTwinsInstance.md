...
### Пример 1. UpdateExpanded (по умолчанию)
```powershell
...
Обновление указанного формата DigitalTwinsInstance с помощью Названия Группы ресурсов

### Пример 2. Обновление AzDigitalTwinsInstance другим azDigitalTwinsInstance
```powershell
...
Обновление AzDigitalTwinsInstance другим AzDigitalTwinsInstance
...
Описание службы DigitalTwins.
Чтобы построить новую таблицу, см. раздел "ЗАМЕТКИ" для свойств DIGITALTWINSPATCHDESCRIPTION и создание hash table.
...
DIGITALTWINSPATCHDESCRIPTION: <IDigitalTwinsPatchDescription> описание службы DigitalTwins.
  - `[Tag <IDigitalTwinsPatchDescriptionTags>]`: Теги экземпляра
