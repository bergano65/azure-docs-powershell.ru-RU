...
## ОПИСАНИЕ
С **новыми данными AzDataShareSubscription создается** подписка на обл. в указанной учетной записи обмена данными и код приглашения.
...
Эти команды создают новую подписку на AdsShareSubscription для invitaionId в учетной записи обмена данными WikiAds.
