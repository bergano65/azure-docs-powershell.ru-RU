...
## ОПИСАНИЕ
С **его учетной** записью можно получить сведения о наборах данных, добавленных в обет в учетной записи azure. Если указать имя набора данных, этот cmdlet получит сведения о наборе данных. Если имя не указано, этот cmdlet получает сведения обо всех наборах данных в области. I
