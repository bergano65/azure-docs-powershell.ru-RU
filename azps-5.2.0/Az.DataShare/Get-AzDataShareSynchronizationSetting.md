...
Эта команда предоставляет сведения о синхронизации ShareSynchronization включена при совместном доступе AdsShare в share account WikiAds учетной записи.
