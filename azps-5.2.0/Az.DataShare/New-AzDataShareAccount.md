...
## ОПИСАНИЕ
**Новый-AzDataShareAccount** создает учетную запись datashare в указанной группе ресурсов Azure.
...
Создает учетную запись с именем "WikiADS" в группе ресурсов "ADS"
...
### -Location
Расположение, в котором нужно создать учетную запись для обмена данными.
...
### -ResourceGroupName
Имя группы ресурсов учетной записи azure data share будет создано в.
...
### -Tag
Теги, которые нужно связать с учетной записью azure Data Share.
