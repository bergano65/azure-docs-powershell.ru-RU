...
## ОПИСАНИЕ
Для **получения сведений о** приглашениях, добавленных в обл. Если указать имя приглашения, этот cmdlet получит сведения о приглашении. Если имя не указано, этот cmdlet получает сведения обо всех приглашениях в обет.
