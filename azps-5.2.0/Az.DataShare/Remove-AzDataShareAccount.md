...
## ОПИСАНИЕ
Для удаления учетной записи datashare удаляется **cmdlet Remove-AzDataShareAccount.**
...
Эта команда удаляет учетную запись datashare с именем WikiADS из группы ресурсов ADS.
...
### -InputObject
Объект учетной записи для обмена данными Azure.
