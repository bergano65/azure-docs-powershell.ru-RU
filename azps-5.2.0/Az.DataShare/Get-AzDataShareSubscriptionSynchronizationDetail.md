...
## ОПИСАНИЕ
Cmdlet **Get-AzDataShareSubscriptionSynchronizationDetail** предоставляет подробные сведения о синхронизации, начатой для подписки на доступ.
...
Эта команда содержит сведения о синхронизации, инициализированной для share subscription AdsShareSubscription, в учетной записи обмена данными WikiAds.
