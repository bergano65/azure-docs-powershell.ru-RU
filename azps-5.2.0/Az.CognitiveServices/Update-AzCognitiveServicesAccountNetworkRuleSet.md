...
Это свойство "Обход команд" NetworkRule (другие свойства не изменяются).

### Пример 3. Очистка правил NetworkRule для учетной записи службы когнитивных функций
```
...
Эта команда очищает правила NetworkRule учетной записи Службы восприятия (другие свойства не изменяются).

## PARAMETERS

### -DefaultAction
Учетная запись учетной записи NetworkRule DefaultAction. Значение по `Deny` умолчанию.
