...
## ОПИСАНИЕ
Для этой подписки доступны типы учетных записей Учетных записей **Get-AzCognitiveServicesAccountType.**
...
Получить список доступных типов на westus.
...
### -TypeName
Имя типа учетной записи службы когнитивных функций.
