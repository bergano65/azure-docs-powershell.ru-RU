...
## ОПИСАНИЕ
Этот Remove-AzEventHubConsumerGroup удаляет указанную группу потребителей из данного Концентратора событий.
...
Удаляет группу пользователей \` MyConsumerGroupName из Концентратора событий \` \` MyEventHubName в области имен \` \` MyNamespaceName. \`
...
### Пример 4. Использование переменной ResourceId
```powershell
PS C:\> $resourceid = Get-AzEventHubConsumerGroup <params>
PS C:\> Remove-AzEventHubConsumerGroup -ResourceId $resourceid.Id
```

### Пример 5. Строка "ИД Ресурса"
```powershell
