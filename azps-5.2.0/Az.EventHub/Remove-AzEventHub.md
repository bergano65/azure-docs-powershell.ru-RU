...
## ОПИСАНИЕ
Этот Remove-AzEventHub удаляет указанный центр событий из указанного пространства имен.
...
Удаляет Центр событий \` MyEventHubName. \`
...
### Пример 3. InputObject с помощью piping:
```powershell
