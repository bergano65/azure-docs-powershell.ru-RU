...
Перечислите все службы по обеспечению на устройствах Azure IoT в подписке.
...
Перечислите все службы по предоставлению устройств Azure IoT Hub в группе ресурсов myresourcegroup.
...
Откажитесь от сведений о службе "myiotdps" для устройства в Azure IoT Hub.
