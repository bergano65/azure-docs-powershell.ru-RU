...
## ОПИСАНИЕ
Подробные сведения о группе регистрации или списке всех групп регистрации в службе регистрации для устройств на концентраторе Azure IoT.
...
Получить группу регистрации устройств в службе azure IoT Hub Device Provisioning Service.
...
Перечислите все группы регистрации устройств в службе регистрации устройств в центре IoT Azure.
