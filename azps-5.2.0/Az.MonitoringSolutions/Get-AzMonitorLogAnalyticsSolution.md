...
### Пример 1. Получить решение для аналитики журналов с отслеживанием по имени
```powershell
...
Эта команда получает решение для аналитики журналов с отслеживанием по ИД ресурсов.
