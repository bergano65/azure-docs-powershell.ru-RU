...
### Пример 1. Список всех MariaDB в рамках подписок
```powershell
...
Эта команда содержит список всех mariaDB в рамках подписки.
...
Эта команда содержит список всех mariaDB в группе ресурсов.

### Пример 3. Получить MariaDB
```powershell
