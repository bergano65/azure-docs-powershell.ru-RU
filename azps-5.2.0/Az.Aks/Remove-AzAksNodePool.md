...
### Удаление указанного пула узлов
```powershell
...
### -Force
Удаление пула узлов без запроса
...
### -Id
ИД пула узлов в кластере Managed Kubernetes
...
### -InputObject
Объект PSAgentPool, который обычно проходит через конвейер.
