...
Установите число узлов в кластере "Кубберсети" на 5.
...
### -DnsNamePrefix
Префикс имени DNS для кластера.
...
ИД клиента и секрет клиента, связанные с приложением AAD и главой службы.
