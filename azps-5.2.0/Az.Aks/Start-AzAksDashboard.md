...
## ОПИСАНИЕ
Создайте SSH-туннель Kubectl на панели мониторинга управляемого кластера. SSH-туннель настроен в задание PowerShell Kubectl-Tunnel и его можно найти с помощью `Get-Job` запуска. Туннель должен быть доступен через [http://127.0.0.1:8001](http://127.0.0.1:8001) .

## ПРИМЕРЫ

### Запуск SSH-туннель и открытие браузера на панели мониторинга Kubernetes
```
