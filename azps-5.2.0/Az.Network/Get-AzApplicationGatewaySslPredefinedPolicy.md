...
## ОПИСАНИЕ
С **помощью cmdlet Get-AzApplicationGatewaySslPredefinedPolicy** можно получить предопределять политики SSL, предоставляемые шлюзом приложения.
...
Эти команды возвращают все предопределные политики SSL.
...
Эта команда возвращает предопределена политику с именем AppGwSslPolicy20170401.
...
Эта команда возвращает предопределена политику с именем, которое начинается с "AppGwSslPolicy2017".
