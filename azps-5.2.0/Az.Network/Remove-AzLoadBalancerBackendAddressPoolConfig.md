...
Эта команда получает балансировку нагрузки MyLoadBalancer и передает ее **в remove-AzLoadBalancerBackendAddressPoolConfig,** который удаляет конфигурацию BackendAddressPool02 из MyLoadBalancer.
...
### -LoadBalancer
Указывает балансировую нагрузку, которая содержит пул адресов для загрузки, который нужно удалить.
