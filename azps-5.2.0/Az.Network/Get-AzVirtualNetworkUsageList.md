...
## ОПИСАНИЕ
Командлет **Get-AzVirtualNetworkUsageList** получает данные об использовании подсети для указанной виртуальной сети.
...
Возвращает текущие значения использования для подсети для виртуальной сети usagetest.
...
### -Name
Указывает имя виртуальной сети, для которого нужно показать использование.
