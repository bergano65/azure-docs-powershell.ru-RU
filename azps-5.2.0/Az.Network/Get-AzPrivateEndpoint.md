...
## ОПИСАНИЕ
Для получения одной или более частных конечных точек **возвращается cmdlet Get-AzPrivateEndpoint.**

## ПРИМЕРЫ

### Пример 1. Извлечение закрытой конечной точки
```powershell
...
Эта команда получает частную конечную точку MyPrivateEndpoint1 в группе ресурсов TestResourceGroup.

### Пример 2. Список всех частных конечных точек в группе ресурсов
```powershell
...
Эта команда получает все личные конечные точки в группе ресурсов TestResourceGroup
...
### -ExpandResource
Ссылка на ресурсы, которая будет расширена.
