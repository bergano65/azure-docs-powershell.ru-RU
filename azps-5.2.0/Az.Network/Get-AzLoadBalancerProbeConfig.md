...
## ОПИСАНИЕ
Для **балансиров нагрузки** с его стороны возвращается одна или несколько конфигураций, задаваемая с его стороны.
...
Вторая команда получает связанную конфигурацию с именем MyProbe из балансира нагрузки в $slb.
