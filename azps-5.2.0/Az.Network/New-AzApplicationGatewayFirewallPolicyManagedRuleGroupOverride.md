...
## ОПИСАНИЕ
**New-AzApplicationGatewayFirewallPolicyManagedRuleGroupOverride** создает запись ruleGroupOverride в managedRuleSet для политики брандмауэра.
...
Создание записи RuleGroupOverride с именем группы в качестве $ruleName и правилами $rule 1, $rule 2. Назначает то же самое $overrideEntry
...
### -RuleGroupName
Укажите имягруппы правил в переопределеемом записи RuleGroup.
