...
### Пример 1. Создание коллекции сетей с двумя правилами
```powershell
...
В этом примере создается коллекция сетевых правил с одним правилом, которое затем получает правило по имени, методу вызова GetRuleByName для объекта коллекции правил. Имя правила для метода GetRuleByName нечувствительно к делу.
