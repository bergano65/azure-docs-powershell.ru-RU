...
Четвертая команда получает сетевой интерфейс nic1, связанный с конфигурацией IP-адреса, которую необходимо обновить. Этот Set-AzNetworkInterfaceIpConfig задает частный IP-адрес основного IP-адреса конфигурации ipconfig1 10.0.0.11 и создает связь с извлеченной группой безопасности приложения.
