...
С этой командой создается объект RoutingConfiguration, который затем можно добавить к ресурсу подключения. Статические маршруты разрешены только для объекта HubVirtualNetworkConnection. 
...
Таблица маршрутов концентратора, связанная с этой конфигурацией маршрутации.
...
### -Id
Список ids ресурсов всех таблиц маршрутов концентратора для объявления маршрутов для свойства PropagatedRouteTables.
...
### -Label
Список меток для свойства "РаспространениеRouteTables".
...
### -StaticRoute
Список маршрутов, которые контролируют маршрутику из VirtualHub в виртуальное сетевое подключение.
