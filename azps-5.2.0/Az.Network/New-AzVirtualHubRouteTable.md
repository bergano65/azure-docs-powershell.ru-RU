...
Выше будет создаваться таблица маршрутов, состоящая из нескольких маршрутов и присоединенная к новому виртуальному центру.

Это объект в памяти, который можно использовать для добавления таблицы Route в новый или существующий VirtualHub.
...
### -Route
Список виртуальных маршрутов концентратора.
