...
## ОПИСАНИЕ
Для политики брандмауэра **Azure** создается правило NAT для политики брандмауэра Azure.
...
В этом примере создается правило NAT с исходным адресом, протоколом, адресом назначения, портом назначения, переведенным адресом и переведенным портом.
...
В этом примере создается правило NAT с исходным адресом, протоколом, адресом назначения, портом назначения, переведенным fqdn и переведенным портом.
...
### -DestinationAddress
Адреса назначения правила. Это должен быть общедоступный IP-адрес брандмауэра.
...
### -TranslatedAddress
Переведенный адрес для этого правила NAT
...
### -TranslatedPort
Переведенный порт для этого правила NAT
