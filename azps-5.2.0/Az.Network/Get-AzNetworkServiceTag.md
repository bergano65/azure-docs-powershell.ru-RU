...
Обратите внимание, что указанная вами информация о регионе Azure будет использоваться в качестве ссылки на версию (а не как фильтр по расположению). Например, даже если вы укадрите службу, вы получите список тегов служб с префиксами во всех регионах, но сможете получить доступ только к облаку, к которой принадлежит ваша подписка (например, общедоступный, государственные правительственные службы США, Китай или `-Location eastus2` Германия).
