...
## SYNOPSIS
Создание объекта фильтра пакетов.
...
### -Protocol
Протокол, по который нужно фильтровать. Допустимые значения :TCP,"UDP","Any"
...
### -RemoteIPAddress
Определяет удаленный IP-адрес, по который нужно отфильтровать.
Пример входных данных: "127.0.0.1" для одной записи адреса.
"127.0.0.1-127.0.0.255" для диапазона.
"127.0.0.1:127.0.0.5;" для нескольких записей.
