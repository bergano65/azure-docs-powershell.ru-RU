...
```
Выше будет создаваться новая конфигурация маршрутинга и статические маршруты в конфигурации маршрутинга со следующим переходом в качестве указанного IP-адреса. Эту конфигурацию маршрутизации затем можно передать команде New-AzVirtualHubVnetConnection параметра RoutingConfiguration.
