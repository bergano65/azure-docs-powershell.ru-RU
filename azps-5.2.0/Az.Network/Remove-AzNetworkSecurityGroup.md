...
## ОПИСАНИЕ
Командлет **Remove-AzNetworkSecurityGroup** удаляет группу безопасности сети Azure.
...
Эта команда удаляет группу безопасности с NSG-FrontEnd в группе ресурсов TestRG.
...
### -Name
Указывает имя группы безопасности сети, которую удаляет этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, из которого этот cmdlet удаляет группу безопасности сети.
