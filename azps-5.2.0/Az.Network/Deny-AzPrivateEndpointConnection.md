...
## ОПИСАНИЕ
**Cmdlet Deny-AzPrivateEndpointConnection** отрицает подключение к закрытой конечной точке.
...
В этом примере отказано в под соединениех частных конечных точек.
