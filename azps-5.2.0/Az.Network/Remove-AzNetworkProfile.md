...
## ОПИСАНИЕ
Командлет **Remove-AzNetworkProfile** удаляет профиль сети, если не созданы интерфейсы контейнеров (в отличие от конфигурации интерфейса контейнера). 
...
### -ResourceId
ИД ресурса диспетчера ресурсов Azure в сетевом профиле.
