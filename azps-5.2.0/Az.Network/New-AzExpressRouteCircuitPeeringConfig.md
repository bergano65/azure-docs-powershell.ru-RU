...
## ОПИСАНИЕ
Cmdlet **New-AzExpressRouteCircuitPeeringConfig** добавляет конфигурацию пиринга в канал ExpressRoute. С помощью каналов ExpressRoute ваша локальной сети подключается к Облаку Майкрософт с помощью поставщика услуг подключения, а не открытого Интернета.
