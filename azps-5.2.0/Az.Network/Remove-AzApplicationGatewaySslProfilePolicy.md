...
## SYNOPSIS
Удаляет SSL-политику из профиля SSL шлюза приложения Azure.
...
## ОПИСАНИЕ
Этот Remove-AzApplicationGatewaySslProfilePolicy удаляет SSL-политику из профиля SSL шлюза приложения Azure.
...
### -SslProfile
Профиль SSL applicationGateway
