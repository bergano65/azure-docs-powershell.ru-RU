...
## ОПИСАНИЕ
**Set-AzNetworkInterfaceTapConfig** обновляет конфигурацию касания для сетевого интерфейса.

## ПРИМЕРЫ

### Пример 1. Настройка TapConfiguration с обновленным именем TapConfig
```
...
Конфигурация NetworkInterface Tap
