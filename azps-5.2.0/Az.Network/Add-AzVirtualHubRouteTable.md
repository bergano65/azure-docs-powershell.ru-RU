...
С этой командой создается ресурс виртуальной таблицы маршрутов концентратора из маршрутов, переданных ему, и этот объект может использоваться для маршрутистики трафика в виртуальном центре.  
