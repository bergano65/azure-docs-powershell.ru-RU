...
## ОПИСАНИЕ
Для шлюза приложения Azure создается набор действий для правила перезаписи **New-AzApplicationGatewayRewriteRuleActionSet.**
...
Эта команда создает набор действий для изменения правил и сохраняет результат в переменной с именем $action.
