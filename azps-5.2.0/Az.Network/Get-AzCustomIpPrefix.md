...
## ОПИСАНИЕ
Для получения одного или более параметров CustomIpPrefix с учетом набора входных параметров возвращается один или несколько cmdlet **Get-AzCustomIpPrefix.**
