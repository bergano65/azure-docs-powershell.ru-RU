...
## ОПИСАНИЕ
С Remove-AzApplicationGatewayProbeConfig- и тепловые загона из существующего шлюза приложения.
...
### -ApplicationGateway
Указывает шлюз приложения, для которого этот cmdlet удаляет заросля.
