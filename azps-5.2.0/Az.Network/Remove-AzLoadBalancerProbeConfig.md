...
## ОПИСАНИЕ
Для **этого из балансиров нагрузки** удаляется конфигурация загромождения.
...
### -LoadBalancer
Определяет балансировую нагрузку, которая содержит конфигурацию, которую удаляет этот cmdlet.
