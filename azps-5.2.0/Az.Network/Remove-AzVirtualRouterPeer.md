...
## ОПИСАНИЕ
Для удаления однорангового узла VirtualRouter из azure VirtualRouter удаляется cmdlet **Remove-AzVirtualRouterPeer.**
...
### -ResourceId
Виртуальный маршрутизатор с одноранговой инициалами ресурса.
