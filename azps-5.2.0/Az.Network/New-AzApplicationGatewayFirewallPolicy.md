...
## ОПИСАНИЕ
С **помощью cmdlet New-AzApplicationGatewayFirewallPolicy** создается политика брандмауэра шлюза приложения.
...
Эта команда создает новую политику брандмауэра шлюза приложения Azure с именем wafResource1 в группе ресурсов "rg1" в расположении "westus" с настраиваемой политикой, заданной в переменной $customRule.
