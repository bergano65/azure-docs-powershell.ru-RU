...
В этом примере создаются группы ресурсов, виртуальные WAN, виртуальные концентраторы, масштабируемые шлюзы ExpressRoute в центральной части США, а затем сразу удаляются. Чтобы скрыть запрос при удалении виртуального шлюза, используйте флаг -Force.
