...
## ОПИСАНИЕ
С New-AzNetworkWatcherConnectionMonitorTestGroupObject создается группа для проверки подключения.

## ПРИМЕРЫ

### Пример 1. Создание тестовой группы с 2 testConfigurations, w source и 2 конечными точками
...
### -Disable
Флаг, указывающий, отключена ли тестовая группа.
...
### -Source
Список исходных конечных точек.
