...
## ОПИСАНИЕ
Cmdlet **Get-AzVirtualWanVpnServerConfiguration** возвращает список всех буклетов VpnServerConfiguration, связанных с этой виртуальной сетью. Т. е. Все vpnServerConfigurations, которые прикреплены к любым P2SVpnGateways в VirutalHubs этой виртуальнойwan.
