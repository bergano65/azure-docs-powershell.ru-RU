...
## ОПИСАНИЕ
**Cmdlet Set-AzApplicationGatewayRewriteRuleSet** изменяет правило маршрутизации запросов.
...
Вторая команда изменяет правило переописи, заданное шлюзом приложения, для использования правил переописи, указанных в переменной $rule.
