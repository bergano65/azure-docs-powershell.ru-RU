...
В этом примере мы создадим удостоверение, назначенное пользователю, и будем ссылаться на него в объекте удостоверения, который используется со шлюзом приложения.
