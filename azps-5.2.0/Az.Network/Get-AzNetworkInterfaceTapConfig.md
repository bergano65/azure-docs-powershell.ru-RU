...
## ОПИСАНИЕ
Командлет **Get-AzNetworkInterfaceTapConfig** получает конфигурацию Azure Tap для данной группы ресурсов, сетевого интерфейса и имени конфигурации tap или списка конфигураций tap в группе ресурсов и сетевом интерфейсе.
...
### -Name
Имя конфигурации для конкретного касания.
