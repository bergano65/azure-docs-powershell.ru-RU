...
Выше будет создаваться группа ресурсов TestRG, виртуальная WAN и виртуальный концентратор в западной части США в этой группе ресурсов в Azure. Виртуальный концентратор будет иметь адресную площадь "10.0.1.0/24" и подключенную таблицу маршрутов.
...
### -VirtualWanId
Id объекта виртуальной wan, с который связан этот центр.
