...
## SYNOPSIS
Создание ресурса CustomIpPrefix
...
## ОПИСАНИЕ
Для **создания пользовательского ресурса CustomIpPrefix создается cmdlet New-AzCustomIpPrefix.**
...
Эта команда создает новый ресурс CustomIpPrefix с именем $prefixName в группе ресурсов $rgName со ссылкой 40.40.40.0/24 in westus
