...
## ОПИСАНИЕ
С помощью **cmdlet get-AzP2sVpnGatewayDetailedConnectionHealth** можно получить подробные сведения о текущих точках подключения к сайтам из P2SVpnGateway. Клиенту необходимо пройти URL-адрес SAS, в который мы можем вложить эти подробные сведения о состоянии здоровья.
...
С помощью **cmdlet get-AzP2sVpnGatewayDetailedConnectionHealth** можно получить подробные сведения о текущих точках подключения к сайтам из P2SVpnGateway. Клиент может скачать сведения о состоянии здоровья с url-адреса, который прошел через SAS. При этом будут отсвечены сведения о каждой точке подключения к сайту с именами пользователей, в которых указываются bytes in, bytes out, allocated ip address и т. д.
...
### -OutputBlobSasUrl
Url-адрес OutputBlob Sas, на который будет записано vpn-подключение p2s.
...
### -VpnUserNamesFilter
Список имен пользователей vpn P2S, которые нужно отфильтровать.
