...
## ОПИСАНИЕ
Для **получения одного или** более правил перевода сетевых адресов (NAT) в балансе нагрузки Azure возвращается одно или несколько правил перевода сетевых адресов (NAT).
...
Вторая команда получает связанное правило NAT myInboundNatRule1 из балансира нагрузки в $slb.
