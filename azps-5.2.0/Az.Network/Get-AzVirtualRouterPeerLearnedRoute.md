...
## SYNOPSIS
Списки маршрутов, усвояемые определенным виртуальным маршрутизатором
...
## ОПИСАНИЕ
Проуммировать маршруты, усвоимые виртуальным маршрутизатором из других источников.
...
### -InputObject
Объект ввода виртуального маршрутизатора (peer-router).
