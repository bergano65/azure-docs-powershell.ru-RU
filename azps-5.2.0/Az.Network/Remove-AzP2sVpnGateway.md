...
## ОПИСАНИЕ
С помощью cmdlet **Remove-AzP2sVpnGateway** можно удалить существующий проект P2SVpnGateway в VirtualHub. При удалении P2SVpnGateway соединение с клиентами сайтов будет сбой.
...
### -ResourceId
ИД ресурсов Azure для p2sVpnGateway, который нужно удалить.
