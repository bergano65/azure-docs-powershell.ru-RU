...
Указанная выше команда создает и возвращает URL-адрес SAS для клиента, чтобы скачать профиль VPN на VirtualWan-VpnServerConfiguration уровне для настройки клиента Point на сайте.
