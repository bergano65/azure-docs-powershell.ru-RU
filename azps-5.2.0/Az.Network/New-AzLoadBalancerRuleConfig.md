...
Первые три команды настроили общедоступный IP-адрес, передний и другие команды для настройки правил. С помощью этой команды создается новое правило "МойLBrule" с определенными спецификациями.
...
### -BackendPort
Определяет порт для трафика, который соответствует конфигурации этого правила балансировации нагрузки.
