...
## ОПИСАНИЕ
Для извлечения объекта схемы ExpressRoute из вашей подписки используется **cmdlet Get-AzExpressRouteCircuit.** Возвращаемый объект схемы может использоваться в качестве входных данных для других cmdlets, которые работают по схемам ExpressRoute.
