...
## ОПИСАНИЕ
Для **создания службы IpAllocation** в Azure создается cmdlet New-AzIpAllocation.
...
### -Force
Не спрашивайте подтверждения, если вы хотите переопреировать ресурс
...
### -IpAllocationTag
Теги выделения для выделения IP-адресов
...
### -IpamAllocationId
Ipam allocation ID of the IP allocation
...
### -PrefixLength
Длина префикса выделения IP-адресов
...
### -PrefixType
Тип префикса выделения IP-адресов
