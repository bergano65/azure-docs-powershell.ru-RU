...
## SYNOPSIS
Возвращает значение пропускной способности таблицы Александры.
...
## ОПИСАНИЕ
С **помощью cmdlet get-AzCosmosDBCassandraTableThroughput** можно получить объект пропускной способности, соответствующий заданной области клавиш.
