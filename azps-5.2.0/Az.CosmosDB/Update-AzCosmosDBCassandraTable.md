...
Используйте New-AzCosmosDBCassandraSchema для создания этого объекта.
...
### -Throughput
Пропускная способность Клавиши Русланы (RU/s).
...
### Microsoft.Azure.Commands.ЯsDB.Models.PSCassandraSchema
