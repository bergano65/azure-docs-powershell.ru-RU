...
## SYNOPSIS
Получает свойства пропускной способности "ЕгоСDB" в коллекции MongoDB.
...
## ОПИСАНИЕ
С помощью cmdlet **get-AzCosmosDBMongoDBCollectionThroughput** можно получить свойства пропускной способности коллекции MongoDB.
...
### -InputObject
При этом он возвращает коллекцию с соответствующей пропускной способностью.
