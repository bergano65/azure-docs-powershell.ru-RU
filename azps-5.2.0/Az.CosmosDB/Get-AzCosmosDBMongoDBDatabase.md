...
## SYNOPSIS
Получает базу данных "ВайсDB МонгоDB"
...
## ОПИСАНИЕ
Cmdlet **Get-AzCosmosDBMongoDBDatabase** получает базу данныхЦыDB MongoDB.
...
Объект ресурсов содержит свойства _rid, _ts, _etag ресурсов.
