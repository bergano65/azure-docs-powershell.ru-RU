...
Обновляет базу данных SQLDb. Выполняет обновление на стороне клиента, считыв существующую базу данных.

### [Update-AzCosmosDBSqlDatabaseThroughput](Update-AzCosmosDBSqlDatabaseThroughput.md)
Обновляет значение пропускной способности базы данных SqlDb.

### [Update-AzCosmosDBSqlStoredProcedure](Update-AzCosmosDBSqlStoredProcedure.md)
Обновляет Sql StoredProcedure вНося изменения вБОКDB. Выполняет обновление на стороне клиента, считыв существующее исправление StoredProcedure.

### [Update-AzCosmosDBSqlTrigger](Update-AzCosmosDBSqlTrigger.md)
Обновляет триггер SQL -2016. Выполняет обновление на стороне клиента, считыв существующий триггер.

### [Update-AzCosmosDBSqlUserDefinedFunction](Update-AzCosmosDBSqlUserDefinedFunction.md)
Обновляет Точки Sql UserDefinedFunction в SqlDb. Выполняет обновление на стороне клиента с помощью существующей userDefinedFunction.

### [Update-AzCosmosDBTable](Update-AzCosmosDBTable.md)
Обновляет таблицу "Приобр". Выполняет клиентскую операцию исправления на стороне клиента, читая существующую таблицу.

### [Update-AzCosmosDBTableThroughput](Update-AzCosmosDBTableThroughput.md)
Обновляет значение пропускной способности таблицы ВайсDB.