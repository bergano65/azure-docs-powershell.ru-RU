...
## SYNOPSIS
Получить учетную запись Facebook.
...
## ОПИСАНИЕ
С его учетной записью **get-AzCosmosDBAccount** можно получить список всех существующих учетных записейБомОбр для заданной базы ресурсов ResourceGroupName и получить одну учетную записьБюро для данной учетной записи ResourceGroupName и AccountName.
...
Получить учетную запись базы данных "Базе данных " с именем databaseAccountName в ResourceGroup ResourceGroupName.
