...
## SYNOPSIS
Обновление областей учетной записи ВайссDB.
...
## ОПИСАНИЕ
Обновление областей учетной записи ВайссDB. Расположение можно указать как объект psLocation типа или как строки с именем расположения, упорядоченным по приоритету отбойного действия.
Параметр LocationObject ожидает список текущих расположений (включаемого приоритетов отладки) с новыми расположениями LocationObjects, которые будут добавлены в новые расположения.
Параметр расположения ожидает список текущего расположения (упорядоченного по приоритету отсказки) и новых расположений. Обратите внимание, что мы поддерживаем только добавление регионов. Укайте расположение или LocationObject.
