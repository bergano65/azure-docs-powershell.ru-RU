...
## ОПИСАНИЕ
Для удаления контейнера Sql **AzCosmosDBSqlContainer** удаляется контейнер Sql, соответствующий заданным названиям группы ресурсов, AccountName, DatabaseName и ContainerName.
