...
## SYNOPSIS
Возвращает параметры пропускной способности, соответствующие контейнеру Sql Container в ПараметрахDb.
...
## ОПИСАНИЕ
Для этого с помощью cmdlet **get-AzCosmosDBSqlContainerThroughput** задаются параметры пропускной способности, соответствующие Sql Container для AzsDB. 
