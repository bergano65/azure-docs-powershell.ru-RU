...
## SYNOPSIS
Возвращает параметры пропускной способности, соответствующие базе данных SQLБББББ.
...
## ОПИСАНИЕ
Для этого с помощью cmdlet **get-AzCosmosDBSqlDatabaseThroughput** можно получить параметры пропускной способности, соответствующие базе данных Sql "Базой данных Sql".
