...
## SYNOPSIS
Получает значение пропускной способности для клавиши Александры.
...
## ОПИСАНИЕ
С **помощью cmdlet get-AzCosmosDBCassandraKeyspaceThroughput** можно получить объект пропускной способности, соответствующий заданной области клавиш.
