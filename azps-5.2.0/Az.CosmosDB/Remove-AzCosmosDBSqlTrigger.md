...
## ОПИСАНИЕ
Для **удаления SQL-триггера AzCosmosDBSqlTrigger** удаляется Sql-триггер ВайтсDB, соответствующий заданным названиям группы ресурсов, AccountName и DatabaseName.
