...
## ОПИСАНИЕ
Для создания новой конфигурации миграции с **запуском-azServiceBusMigration** запускается перенос сущностями из пространства имен Standard в premium.
...
Создает новую конфигурацию миграции для пространства имен TestingNamespaceStandardMigration в области имен TestingNamespacePremiumMigration.
...
### -PostMigrationName
Имя после миграции стандартного пространства имен в миграции
