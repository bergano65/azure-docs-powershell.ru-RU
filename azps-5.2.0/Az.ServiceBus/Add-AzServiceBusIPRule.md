...
```
Name : defaultAction : Allow Id : /subscriptions/SubscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.ServiceBus/namespaces/ServiceBus-Namespace-2389/networkRuleSets/default Type : Microsoft.ServiceBus/Namespaces/NetworkRuleSet IpRules : {11.22.33.44, Allow} VirtualNetworkRules : 

добавьте IPRule с IpMask "11.22.33.44" и action Allow на заданное пространство имен.
...
добавьте IPRule с IpMask "11.22.33.44" и action Allow fro the given namespace.
