...
## ОПИСАНИЕ
Проверка доступности предоставленного имени очереди или раздела для проверки доступности данной службы **AzServiceBusNameAvailability**
...
Возвращает "Истина", если $nameTopic недоступна, или false, если $nameTopic недоступна.
