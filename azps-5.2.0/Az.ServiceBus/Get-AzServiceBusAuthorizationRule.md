...
## ОПИСАНИЕ
Чтобы **получить описание** указанного правила авторизации в указанном пространстве имен, очереди или теме или псевдониме (GeoDR Configurations), можно получить описание указанного правила авторизации.
...
Возвращает описание указанного правила авторизации для указанного пространства имен.
...
Возвращает описание заданного правила авторизации для указанной очереди.
...
Возвращает описание указанного правила авторизации для указанного раздела.
...
Возвращает описание указанного правила авторизации для указанного пространства имен и псевдонима.
