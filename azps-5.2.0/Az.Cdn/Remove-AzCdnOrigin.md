...
## ОПИСАНИЕ
Remove-AzCdnOrigin будет удалено из данной конечной точки источник CDN. Если источник является единственным в пределах указанной конечной точки, удаление завершится сбой, так как требуется хотя бы один источник. 
...
```
Этот cmdlet удалит указанный источник из указанной конечной точки. 
