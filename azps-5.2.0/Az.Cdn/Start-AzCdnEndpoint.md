...
## ОПИСАНИЕ
Для запуска конечной точки сети доставки содержимого (CDN) Azure запускается конечная точка **Start-AzCdnEndpoint.**
...
### -CdnEndpoint
Указывает конечную точку, с которую запускается этот cmdlet.
...
### -EndpointName
Указывает имя конечной точки, с которую запускается этот cmdlet.
