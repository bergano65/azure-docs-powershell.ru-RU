...
Этот cmdlet запросит подтверждение, если не указать параметр *Force.*
...
Эта команда удаляет задачу с ИД задачи23 для задания с заданием 0000001.
