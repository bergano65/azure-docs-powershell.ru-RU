...
## ОПИСАНИЕ
**Новый-AzBatchApplication** добавляет приложение в указанную учетную запись Azure Batch.

## ПРИМЕРЫ

### Пример 1. Добавление пустого приложения в учетную запись пакета
```
...
Эта команда создает приложение Litware в учетной записи ContosoBatch.
Изначально приложение не содержит пакетов.

## PARAMETERS

### -AccountName
Имя учетной записи пакета, в которую этот cmdlet добавляет приложение.
