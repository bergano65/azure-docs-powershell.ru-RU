...
## ОПИСАНИЕ
При **этом учетная** запись пользователя удаляется из узла обработки пакетных вычислений Azure.
...
Эта команда удаляет пользователя с именем User14 из узла вычислений с именем ComputeNode01.
