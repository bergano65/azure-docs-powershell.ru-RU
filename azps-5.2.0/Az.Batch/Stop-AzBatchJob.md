...
## ОПИСАНИЕ
Из-за нее можно прекратить работу пакета Azure с использованием cmdlet **Stop-AzBatchJob.**
Эта команда пометит задание как выполненную.

## ПРИМЕРЫ

### Пример 1. Остановка пакета
```
PS C:\>Stop-AzBatchJob -Id "Job-000001" -TerminateReason "No more tasks to run" -BatchContext $Context
```

Эта команда останавливает задание с ИД-000001.
Эта команда указывает причину, по которой вы решили остановить задание.
...
### -Id
Определяет код задания, которое останавливает этот cmdlet.
...
### -TerminateReason
Указывает причину, по которой вы решили прекратить работу.
Этот cmdlet сохраняет этот текст как свойство **TerminateReason** задания.
