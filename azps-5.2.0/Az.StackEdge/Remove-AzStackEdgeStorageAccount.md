...
## ОПИСАНИЕ
Для устройства Stack Edge с его учетной записью удаляется связанная учетная запись хранилищ **AzStackEdgeStorageAccount.** Вы можете указать имя учетной записи edge Storage, которая будет удалена в качестве параметра в cmdlet.
