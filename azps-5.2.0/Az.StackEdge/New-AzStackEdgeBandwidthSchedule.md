...
## ОПИСАНИЕ
С **помощью cmdlet New-AzStackEdgeBandwidthSchedule** создается новое расписание полосы пропускания для устройства Stack Edge, помогающее управлять использованием полосы пропускания.
