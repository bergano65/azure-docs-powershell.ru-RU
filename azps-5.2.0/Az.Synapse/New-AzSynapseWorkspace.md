...
## ОПИСАНИЕ
Командлет **New-AzSynapseWorkspace** создает рабочее пространство Azure Synapse Analytics.
...
Эта команда создает рабочее пространство Synapse Analytics с именем ContosoWorkspace, использующее хранилище данных ContosoAdlGenStorage в группе ресурсов ContosoResourceGroup.
...
Имя учетной записи хранения ADLS Gen2 по умолчанию.
...
Файловая система ADLS gen2 по умолчанию.
...
### -Location
Регион Azure, в котором должен быть создан ресурс.
...
Имя виртуальной сети, управляемой Synapse, выделенной для рабочей области Azure Synapse.
...
SQL учетные данные администратора.
