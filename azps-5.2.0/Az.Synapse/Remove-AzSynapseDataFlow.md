...
## ОПИСАНИЕ
Чтобы **удалить поток данных из** рабочей области, удалите поток данных из рабочей области.
...
Эта команда удаляет поток данных ContosoDataFlow из рабочей области с именем ContosoWorkspace.
