...
## ОПИСАНИЕ
**Спарклет Invoke-AzSynapseSparkStatement** вызывает спарк-отчет Synapse Analytics.
...
Эти команды запускают сеанс спарклайнов, а затем вызовют в конвейере спарк-линию с помощью inline Spark.
