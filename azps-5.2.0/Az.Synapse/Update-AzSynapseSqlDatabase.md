...
## SYNOPSIS
Обновляет базу данных Synapse Analytics SQL.
...
## ОПИСАНИЕ
Для базы данных Azure Synapse Analytics обновляется SQL синтаксис **Update-AzSynapseSqlDatabase.**
...
Эта команда обновляет базу данных Azure Synapse Analytics SQL.
