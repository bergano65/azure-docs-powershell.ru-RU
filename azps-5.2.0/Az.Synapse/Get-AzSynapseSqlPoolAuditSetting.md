...
Эта команда получает параметры аудита для пула SQL ContosoSqlPool в рабочей области ContosoWorkspace.
...
Эта команда получает параметры аудита для пула SQL ContosoSqlPool в рабочей области ContosoWorkspace через канал.
