...
## ОПИСАНИЕ
При **настройке Reset-AzSynapseSqlAdvancedThreatProtectionSetting** параметры advanced threat protection удаляются из рабочей области Azure Synapse Analytics.
...
Эта команда удаляет дополнительные параметры защиты от угроз из рабочей области ContosoWorkspace.
