...
## ОПИСАНИЕ
Cmdlet **Get-AzSynapseIntegrationRuntimeMetric** получает метрические данные об интеграции рабочего времени в рабочей области.
...
Эта команда отображает метрические данные об интегрированном рабочем времени "test-selfhost-ir" в рабочей области ContosoWorkspace.
