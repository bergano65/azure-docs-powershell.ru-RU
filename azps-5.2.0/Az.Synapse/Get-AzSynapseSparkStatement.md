...
## ОПИСАНИЕ
**Спарклет Get-AzSynapseSparkStatement** получает сведения о спарк-отчете Azure Synapse Analytics.
...
Эта команда получает все выписки по спарк-сеансу.
...
Эта команда получает выписку по спарку с указанным livy ID.
...
Эта команда получает все выписки спарк-спарк-сеанса по конвейеру.
