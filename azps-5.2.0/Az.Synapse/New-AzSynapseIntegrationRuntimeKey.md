...
## ОПИСАНИЕ
Cmdlet **New-AzSynapseIntegrationRuntimeKey** повторно сгенерирует ключ интеграции runtime с именем ключа, заданным параметром KeyName. Предыдущий ключ недействителен.
