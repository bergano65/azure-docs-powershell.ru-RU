...
## ОПИСАНИЕ
Для создания или обновления существующего набора данных в рабочей области будет создан или обновлен набор данных **Set-AzSynapseDataset.**
...
Эта команда создает набор данных с именем ContosoDataset в рабочей области с именем ContosoWorkspace.
Эта команда будет базой данных на данных из Dataset.jsфайла.
