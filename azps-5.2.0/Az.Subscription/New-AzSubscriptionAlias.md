...
## ОПИСАНИЕ
Для создания нового псевдонима и подписки будет создаваться новый псевдоним и подписка на **New-AzSubscriptionAlias.**
