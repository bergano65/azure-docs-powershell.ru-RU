...
### Пример 1. Создание коллекции "Перемещение".
```powershell
...
Создайте новую коллекцию перемещения в рамках подписки.
...
### -IdentityPrincipalId
Получает или задает основной id.
...
### -IdentityTenantId
Возвращает или задает ид клиента.
