...
Чтобы построить новую таблицу, см. раздел "ЗАМЕТКИ" для свойств DEPENDSONOVERRIDE и создание hash table.
...
### -SourceId
Возвращает или задает исходный ARM ИД ресурса.
...
DEPENDSONOVERRIDE <IMoveResourceDependencyOverride[]>: получает или устанавливает переопределения зависимостей перемещения ресурсов.
  - `[Id <String>]`: возвращает или задает ARM ИД зависимого ресурса.
