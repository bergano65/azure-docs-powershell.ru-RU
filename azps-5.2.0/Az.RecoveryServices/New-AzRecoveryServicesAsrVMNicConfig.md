...
## SYNOPSIS
Создает конфигурацию ASR NIC, которая содержит сведения о конфигурации от сбойов и тестирования.
...
Создает конфигурацию ASR NIC, которая содержит сведения о конфигурации от сбойов и тестирования. (autogenerated)
...
Определяет IDs of backend address pools for the recovery NIC .ids of backend address pools for the recovery NIC.
...
### -RecoveryNicName
Указывает имя NIC восстановления.
