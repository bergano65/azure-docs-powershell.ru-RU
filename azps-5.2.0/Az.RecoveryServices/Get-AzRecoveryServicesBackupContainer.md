...
Чтобы получить контейнер резервной копии, получается проектлет **Get-AzRecoveryServicesBackupContainer.**
Контейнер резервного копирования— это источники данных, моделируются как элементы резервной копии.
