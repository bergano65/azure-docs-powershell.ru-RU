...
Определяет ИД учетной записи хранения Azure конечного адреса репликации. Используется в качестве целевой учетной записи хранения для репликации, если альтернатива не предоставляется, при включая репликацию с помощью New-AzRecoveryServicesASRReplicationProtectedItem-New-AzRecoveryServicesASRReplicationProtectedItem.
