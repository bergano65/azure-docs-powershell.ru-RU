...
## SYNOPSIS
Удаляет указанную ткань для восстановления сайта Azure из хранилища служб восстановления.
...
### -InputObject
Объект ввода для удаления: объект asR-ткань, соответствующий удаляемой тканью.
