...
### -Account
Запуск в качестве ИД учетной записи, который будет использоваться для push-обновления. Должен быть один из списков запуска в качестве учетных записей в материале ASR, который соответствует обновляемой машине.
...
Элемент, защищенный репликацией сайтов Azure, который нужно обновить.
