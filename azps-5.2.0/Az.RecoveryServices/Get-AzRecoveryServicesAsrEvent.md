...
## ОПИСАНИЕ
**Get-AzRecoveryServicesAsrEvent** получает список событий в хранилище на основе указанных фильтров выбора.
...
Список событий для затронутых объектов.
...
Список событий между временем начала и временем окончания, критической серьезности и типа VmHealth.

## PARAMETERS

### -AffectedObjectFriendlyName
Определяет затронутыйОбыватель friendlyName для поиска.
...
### -EndTime
Время окончания окна поиска. Используйте этот параметр, чтобы получить только те события, которые произошли до указанного времени.
...
### -Ткань
Отфильтровать события по указанному материалу.
...
### -FabricId
Определяет, что нужно отфильтровать fabricId.
...
### -Name
Указывает имя события, которое будет искаться.
...
### -ResourceId
Определяет событие ResourceId события.
...
### -Severity
Серьезность отфильтрованного события.
...
### -StartTime
Время начала окна поиска. Используйте этот параметр, чтобы получить только те события, которые произошли после указанного времени.
