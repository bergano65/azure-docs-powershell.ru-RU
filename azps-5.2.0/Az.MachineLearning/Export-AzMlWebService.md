...
## ОПИСАНИЕ
Экспорт объекта определения для указанной веб-службы в виде строки в формате JSON.
Вы можете сразу же вернуть строку или сохранить ее в файл.

## ПРИМЕРЫ

### Пример 1. Экспорт в качестве строки
```
...
### -OutputFile
Путь к файлу для экспортируемой определения.
...
### -ToJsonString
Указывает, что определение будет экспортироваться как строка JSON.
...
### -WebService
Объект определения веб-службы, который нужно экспортировать.
