...
## ОПИСАНИЕ
Удаляет веб-службу машинного обучения Azure, на которые ссылается группа ресурсов и имя.
