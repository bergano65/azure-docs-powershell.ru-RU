...
Эта команда содержит список всех источников событий в указанных средах.

### Пример 2. Получить указанный источник события по имени
```powershell
...
Эта команда получает определенный источник события.

### Пример 3. Получить источник заданного события для объекта
```powershell
