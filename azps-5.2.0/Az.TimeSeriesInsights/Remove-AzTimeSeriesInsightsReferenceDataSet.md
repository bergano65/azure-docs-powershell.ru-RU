...
### Пример 1. Удаление указанного набора данных ссылки по имени
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Эта команда удаляет указанный набор справочных данных.

### Пример 2. Удаление указанной ссылки на данные, заданную объектом
```powershell
