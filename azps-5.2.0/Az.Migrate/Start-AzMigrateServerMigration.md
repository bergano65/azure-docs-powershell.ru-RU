...
INPUTOBJECT: сервер репликации, для которого <IMigrationItem> нужно инициировать миграцию. Объект сервера можно извлечь с помощью Get-AzMigrateServerReplication.
