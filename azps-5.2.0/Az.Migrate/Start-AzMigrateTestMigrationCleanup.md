...
## SYNOPSIS
Очистка тестовой миграции для сервера репликации.
...
### -InputObject
Указывает сервер репликации, для которого нужно инициировать проверку миграции.
Объект сервера можно получить с помощью Get-AzMigrateServerReplication-Get-AzMigrateServerReplication Чтобы построить, см. раздел "ЗАМЕТКИ" для свойств INPUTOBJECT и создание hash table.
...
INPUTOBJECT: сервер репликации, для которого нужно инициировать проверку <IMigrationItem> миграции. Объект сервера можно извлечь с помощью Get-AzMigrateServerReplication-управления
