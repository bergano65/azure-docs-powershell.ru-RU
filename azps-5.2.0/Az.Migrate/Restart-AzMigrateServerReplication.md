...
## SYNOPSIS
Перезапуск репликации для указанного сервера.
...
### -TargetObjectID
Указывает реплицирующий сервер, для которого нужно инициировать повторную проверку.
