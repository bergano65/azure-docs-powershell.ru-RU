...
### -PerformAutoResync
Указывает, будет ли репликация автоматически восстановлена в случае потери отслеживания изменений для исходных серверов в режиме репликации.
...
### -TargetVMName
Указывает имя создаемого VM-azure.
...
### -TargetVMSize
Определяет SKU созда создаемого VM Azure.
