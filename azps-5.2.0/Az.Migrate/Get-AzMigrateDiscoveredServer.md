...
## SYNOPSIS
Получите все обнаруженные серверы в проекте миграции.
...
Получить все серверы в проекте миграции.
...
Получите сервер в проекте миграции по имени.
Имя — это уникальный параметр для сервера.

### Пример 3. Список в устройстве
```powershell
...
Укаймь все серверы для устройства в проекте.
...
Получите сервер для устройства в проекте.
Имя — это уникальный параметр для сервера.

### Пример 5. Список и фильтрация по отображаемом имени
```powershell
...
Серверы списков в миграции проектов и фильтрация ответов с отображаемым именем.

### Пример 6. Список в устройстве и фильтр по отображаемом имени
```powershell
...
Серверы списков для устройства в проекте миграции и фильтрация ответов с отображаемым именем.

## PARAMETERS

### -ИмяПриемка
Указывает имя устройства.
Это внутренних карты с сайтом.
...
### -DisplayName
Указывает отображаемого имени компьютера VMWARE.
...
### -Name
Указывает имя компьютера VMWARE.
Это внутреннее имя.
Для пользователей используйте отображаемом имени.
...
### -ProjectName
Указывает имя переносимого проекта.
...
### Microsoft.Azure.PowerShell.Cmdlets.Migrate.Models.Api202001.IVMwareMa modelse
