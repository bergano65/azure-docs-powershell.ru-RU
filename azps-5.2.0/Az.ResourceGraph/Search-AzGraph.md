...
## SYNOPSIS
Запросы ресурсов, управляемых Диспетчером ресурсов Azure.
...
## ОПИСАНИЕ
Подробнее о синтаксисе запроса можно узнать здесь: https://aka.ms/resource-graph/learntoquery
...
Простой запрос ресурсов, запрашивающий подмножество полей ресурсов.
...
Сложный запрос к ресурсам с выделением полей, фильтрацией и обобщением данных.
...
```
Запрос со всеми виртуальными компьютерами, которые не используют управляемые диски и содержит отображаемые имена подписок.
...
```
Запрос, отображающий количество ресурсов по именам клиента и подписки.
...
### -First
Максимальное количество возвращаемых объектов. Разрешенные значения: 1–5000.
