...
## ОПИСАНИЕ
Этот **проектлет Restart-AzHDInsightHost** перезапустит определенные hosts of HDInsight.
...
Эта команда перезапускет два хлама кластера: worknode1, worknode2.
...
Эта команда показывает, как работать вместе с командлетом Get-AzHDInsightHost.
...
Возвращает или задает имя хоста.
