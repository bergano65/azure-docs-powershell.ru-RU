...
## ОПИСАНИЕ
В этом списке перечислены hosts кластера HDInsight для **Get-AzHDInsightHost.**
...
Этот список команд содержит названия групп кластеров.
...
В этом списке команд перечислены hosts кластера с конвейером.
