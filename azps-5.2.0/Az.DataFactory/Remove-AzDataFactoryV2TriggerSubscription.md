...
## ОПИСАНИЕ
Эта команда отписывает триггер события к указанным событиям внешней службы из триггера.
...
Эта команда отвязывает триггер BlobEnetTrigger1 к указанным событиям триггера.
...
### -PassThru
Если он задан, при успешном удалении возвращается "Истина".
