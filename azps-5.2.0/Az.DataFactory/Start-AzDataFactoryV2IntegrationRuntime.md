...
## ОПИСАНИЕ
Для запуска управляемой выделенной интеграции запускается **cmdlet Start-AzDataFactoryV2IntegrationRuntime.** Ресурс будет подготовка, а после операции состояние "Запущено".

## ПРИМЕРЫ

### Пример 1. Запуск интеграции
```
...
Этот cmdlet запускает управляемое интегрированное время интеграции с именем test-dedicated-ir.
