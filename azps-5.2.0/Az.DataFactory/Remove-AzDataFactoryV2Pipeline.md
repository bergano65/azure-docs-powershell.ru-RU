...
## ОПИСАНИЕ
Новый Remove-AzDataFactoryV2Pipeline удаляет конвейер из фабрики данных Azure.
...
Этот cmdlet удаляет канал DPWikisample из фабрики данных с именем WikiADF.
...
### -InputObject
Определяет объект конвейера.
Этот cmdlet удаляет канал, указанный этим параметром.
...
### -ResourceId
ИД ресурса Azure для конвейера, который нужно удалить.
