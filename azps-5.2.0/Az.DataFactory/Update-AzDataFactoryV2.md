...
## ОПИСАНИЕ
Командлет **Update-AzDataFactoryV2** обновляет теги или свойства удостоверений фабрики данных.
...
Эта команда обновляет теги в фабрике WikiADF до словаря, содержащего тег myNewTagName со значением myTagValue.
