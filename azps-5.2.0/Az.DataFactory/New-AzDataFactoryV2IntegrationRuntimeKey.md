...
## ОПИСАНИЕ
Cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey** повторно сгенерирует ключ интеграции runtime с именем ключа, заданным параметром KeyName. Предыдущий ключ недействителен.

## ПРИМЕРЫ

### Пример 1. Создание нового ключа для интегрированного времени запуска
```
...
Этот cmdlet повторно сгенерирует ключ authKey2 для интеграции runtime test-selfhost-ir.
...
### -KeyName
Имя ключа проверки подлинности для самостоятельной интеграции с runtime.
