...
## ОПИСАНИЕ
Этот Get-AzDataFactoryV2IntegrationRuntime получает сведения о времени интеграции с фабрикой данных.
Если указать имя времени запуска интеграции, этот cmdlet получит сведения об этом времени запуска интеграции.
Если имя не указано, этот cmdlet получает сведения обо всех рабочих процессах интеграции в фабрике данных.

## ПРИМЕРЫ

### Пример 1. Список всех рабочих процессов интеграции в фабрике данных
```
...
Перечислите все время интеграции с фабрикой данных test-df-eu2.

### Пример 2. Запуск управляемой специализированной интеграции
```
...
Эта команда отображает сведения об интеграции runtime "test-dedicated-ir" в подписке для группы ресурсов с именем "rg-test-dfv2" и фабрики данных "test-df-eu2".

### Пример 3. Запуск управляемой специализированной интеграции с подробным состоянием
```
...
### Пример 4. Запуск самостоятельной интеграции
```
...
### Пример 5. Запуск самостоятельной интеграции с подробным состоянием
```
...
### -Status
Состояние подробных подробностей об интеграции.
