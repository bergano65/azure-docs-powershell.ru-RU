...
## ОПИСАНИЕ
Для **удаления фабрики данных удаляется cmdlet Remove-AzDataFactory.**
...
### -DataFactory
Определяет объект **PSDataFactory,** который нужно удалить.
...
### -Force
Указывает на то, что этот cmdlet удаляет фабрику данных без запроса подтверждения.
...
### -Name
Название фабрики данных, который нужно удалить.
...
Этот cmdlet удаляет фабрику данных из группы, указанной этим параметром.
