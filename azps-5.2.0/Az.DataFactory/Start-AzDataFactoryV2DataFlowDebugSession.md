...
## ОПИСАНИЕ
Эта длинная команда запускает сеанс отлагки потока данных для команд отлагки. Эту команду можно прикрепить к определению времени запуска интеграции, чтобы настроить размер и тип кластера сеанса отложений.
...
Начало сеанса отбивки с флагом AsJob.
