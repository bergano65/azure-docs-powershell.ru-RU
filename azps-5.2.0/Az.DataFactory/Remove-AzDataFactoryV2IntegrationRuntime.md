...
## ОПИСАНИЕ
Этот Remove-AzDataFactoryV2IntegrationRuntime удаляет время интеграции.

## ПРИМЕРЫ

### Пример 1. Удаление времени запуска интеграции
```
...
Эта команда удаляет время интеграции с именем test-reserved-ir из фабрики данных test-df.
...
Название связанной фабрики данных.
