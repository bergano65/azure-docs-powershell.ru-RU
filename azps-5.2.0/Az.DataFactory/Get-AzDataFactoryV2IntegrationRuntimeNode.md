...
### Пример 1. Возвращает подробные сведения об узле времени запуска интеграции.
```
...
Он получает сведения о узле Node_1 в режиме самостоятельной интеграции "test-selfhost-ir" в фабрике данных test-df-eu2.
