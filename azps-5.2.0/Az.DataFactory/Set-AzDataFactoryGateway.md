...
## ОПИСАНИЕ
Для указанного шлюза в фабрике данных Azure заданы инструкции для шлюза **Set-AzDataFactoryGateway.**

## ПРИМЕРЫ

### Пример 1. Настройка описания шлюза
```
...
Эта команда задает описание шлюза ContosoGateway в фабрике данных с именем WikiADF.
Параметр Description определяет новое описание.

## PARAMETERS

### -DataFactory
Указывает объект **PSDataFactory.**
Этот cmdlet задает описание шлюза в фабрике данных, заданном этим параметром.
...
Этот cmdlet задает описание шлюза в фабрике данных, указанном этим параметром.
...
### -Name
Указывает имя шлюза, для которого нужно установить описание.
...
Этот cmdlet задает описание шлюза, который принадлежит к группе, указанной этим параметром.
