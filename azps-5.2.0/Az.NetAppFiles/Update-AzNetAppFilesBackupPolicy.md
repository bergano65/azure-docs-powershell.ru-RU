...
## ОПИСАНИЕ
Для **обновления-AzNetAppFilesBackupPolicy** изменяется политика резервного копирования ANF.
...
Эта команда изменяет политику резервного копирования ANF "MyBackupPolicy" на заданный DailyBackupsToKeep.
...
### -AccountObject
Объект Account, содержащий обновляемую политику резервного копирования
