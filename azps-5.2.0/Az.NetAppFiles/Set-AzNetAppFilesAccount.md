...
## ОПИСАНИЕ
Для **учетной записи ANF изменяется cmdlet Set-AzNetAppFilesAccount.**
...
Эта команда выполняет обновление для учетной записи. Отсутствие активного каталога означает, что он будет удален из учетной записи.
