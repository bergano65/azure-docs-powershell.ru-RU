...
## SYNOPSIS
Обновляет конфигурацию active directory Azure NetApp Files (ANF) с использованием необязательных модификаторов.
...
Эта команда выполняет обновление в конфигурации активной службы каталогов, внося изменения в имя пользователя в этой конфигурации.
