...
## ОПИСАНИЕ
Для **удаления пула ANF будет удален cmdlet Remove-AzNetAppFilesPool.**
...
### -AccountObject
Объект учетной записи, содержащий пул для удаления
...
### -PassThru
Возврат, был ли указанный пул успешно удален
