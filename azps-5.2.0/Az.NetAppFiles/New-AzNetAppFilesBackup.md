...
## ОПИСАНИЕ
Для создания тома ANF создается резервная копия для **new-AzNetAppFilesBackup.**
...
Эта команда создает новую резервную копию ANF для тома с именем учетной записи "MyVolume".
...
### -VolumeObject
Громкость нового объекта резервной копии
