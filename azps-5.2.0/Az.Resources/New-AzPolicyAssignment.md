...
### -AssignIdentity
Создание и назначение удостоверения Azure Active Directory для этого назначения политики. Удостоверение будет использоваться при развертывании политик развертыванияIfNotExists. При назначении удостоверения требуется расположение.
