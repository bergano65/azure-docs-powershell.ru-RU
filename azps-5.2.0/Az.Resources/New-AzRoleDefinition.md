...
3) Действия: набор операций, к которым пользовательская роль предоставляет доступ.
