...
## ОПИСАНИЕ
Для получения всех назначений политики или определенных назначений будет выполняться **cmdlet Get-AzPolicyAssignment.**
Определите назначение политики, которое нужно получить по имени, области или по ИД.
