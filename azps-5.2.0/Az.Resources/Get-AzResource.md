...
### Пример 6. Получить все ресурсы данного типа ресурсов
...
Эта команда получает все ресурсы из текущих подписок, которые являются виртуальными компьютерами.
