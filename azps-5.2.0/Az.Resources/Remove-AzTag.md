...
## SYNOPSIS
Удаление предопределеных тегов и значений Azure | Удаляет весь набор тегов для ресурса или подписки.
...
Если тег был применен к ресурсам или группам ресурсов, команда не будет применена.
...
Чтобы удалить выбранные значения, но не удалить тег, используйте параметр *Value.*
