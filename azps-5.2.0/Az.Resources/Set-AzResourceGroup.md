...
Эта команда применяет тег Department со значением ИТ к группе ресурсов, у нее нет тегов.
