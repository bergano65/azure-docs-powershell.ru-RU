...
### Пример 2. Список глав служб AD с помощью разведки

```powershell
PS C:\> Get-AzADServicePrincipal -First 100
```

Список первых 100 основных лиц службЫ AD в клиенте.
...
Получает приложение AD с ид объекта 39e64ec6-569b-4030-8e1c-c3c519a05d69' и передает его в Get-AzADServicePrincipal-Get-AzADServicePrincipal для списка всех участников-служб для этого приложения.
