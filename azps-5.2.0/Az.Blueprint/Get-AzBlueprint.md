...
Получите определение схемы в рамках указанной подписки и иерархию группы управления в этой подписке.
...
Определение документа с указанным именем и версией в указанной группе управления.
