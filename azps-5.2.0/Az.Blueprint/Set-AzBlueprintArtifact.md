...
## ОПИСАНИЕ
Обновление артефакта. Существует два способа обновления артефакта: с помощью артефакта JSON в качестве входного файла или путем предоставления вводимых параметров артефакта. Хотя метод JSON не требует предоставления артефакта в виде inline, пользователь должен предоставить тип артефакта с помощью параметра -Type.
