...
## ОПИСАНИЕ
Создание артефакта. Существует два способа создать артефакт: с помощью артефакта JSON в качестве входного файла или путем предоставления вводимых параметров артефакта. Хотя метод JSON не требует предоставления артефакта в виде inline, пользователь должен предоставить тип артефакта с помощью параметра -Type.
...
Создать новый артефакт с помощью JSON-файла артефакта.
...
Создание артефакта с помощью inline parameters.
...
Создайте новый артефакт с помощью ARM шаблона.
