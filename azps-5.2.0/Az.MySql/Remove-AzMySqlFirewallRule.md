...
Этот cmdlet удаляет правило брандмауэра MySql по имени.

### Пример 2. Удаление правила брандмауэра MySql по удостоверениям
```powershell
...
Эти cmdlets remove MySql Firewall Rule by identity.
