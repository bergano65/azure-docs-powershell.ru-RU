...
Обновление конфигурации непрерывного экспорта "jlTFEiBg1rkDXOCIeJQ2mB2TxZg=" из группы ресурсов "testgroup" для экспорта документов Request и Trace в контейнер хранилища testcontainer в "testtorageaccount". Маркер SAS должен быть действительным и иметь разрешение на написание контейнера, иначе функция непрерывного экспорта не будет работать. Если срок действия маркера SAS истек, функция непрерывного экспорта перестанет работать.
