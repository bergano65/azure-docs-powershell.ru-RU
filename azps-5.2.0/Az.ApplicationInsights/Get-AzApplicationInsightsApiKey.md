...
### Пример 1. Получение ключей API для ресурса, анализного приложения
```
...
Получите ключи API аналитики приложений для "тестирования" ресурсов в группе ресурсов testGroup.

### Пример 2. Получение определенного ключа API для ресурса, анализного приложения
```
...
Получите ключ API конкретного приложения с ид "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" для "test" в группе ресурсов "testGroup".

## PARAMETERS

### -ApiKeyId
ИД ключа API application Insights.
