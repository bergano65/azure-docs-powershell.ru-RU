...
Объект локального профиля можно обновить с помощью Add-AzTrafficManagerEndpointConfig.
...
### -MonitorPort
Указывает порт TCP, используемый для отслеживания состояния конечных точек.
Допустимые значения — это значения от 1 до 65 535.
...
Этот cmdlet создает профиль Диспетчера трафика в группе, указанной этим параметром.
