...
В этом примере мы получаем журнал потока и состояние аналитики трафика для группы безопасности сети. В указанном NSG включено ведение журнала потока и включена аналитическая трафик, и не задана политика хранения.
