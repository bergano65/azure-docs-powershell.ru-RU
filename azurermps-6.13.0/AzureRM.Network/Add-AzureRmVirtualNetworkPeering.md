...
## NОПИСАНИЕ
Командлет **Add-AzureRmVirtualNetworkPeering** создает одноранговую сеть из двух виртуальных сетей.
...
Параметры: VirtualNetwork (ByValue)

### System. String
Параметры: RemoteVirtualNetworkId (ByValue)
