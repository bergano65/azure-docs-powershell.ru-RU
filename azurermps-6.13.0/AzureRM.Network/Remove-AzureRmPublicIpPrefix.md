...
## NОПИСАНИЕ
Командлет "* * Remove-AzureRmPublicIpPrefix" удаляет префикс общедоступного IP-адреса Azure, так как у него нет общедоступных IP-адресов, выделены от него.
...
Удаление префикса общедоступного IP-адреса с именем $prefixName из группы ресурсов $rgName
...
### -ResourceId
ResourceId для ресурса, который нужно удалить.
