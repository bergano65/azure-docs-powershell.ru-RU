...
## КРАТКИй обзор
Обновляет объект VpnConnection до состояния цели.
...
После создания шлюза он подключается к VpnSite с помощью команды New-AzureRmVpnConnection.

После этого соединение обновится и появится новая IpSecPolicy с помощью команды Set-AzureRmVpnConnection.
