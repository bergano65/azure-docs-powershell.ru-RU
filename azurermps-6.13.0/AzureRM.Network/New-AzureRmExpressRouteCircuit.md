...
## NОПИСАНИЕ
Командлет **New-AzureRmExpressRouteCircuit** создает цепь маршрутов Azure Express.
...
### Пример 2: создание новой цепи ExpressRoute на ExpressRoutePort
```
$parameters = @{
    Name='ExpressRouteCircuit'
    ResourceGroupName='ExpressRouteResourceGroup'
...
### -BandwidthInGbps
Пропускная способность канала при подготовке канала на ресурсе ExpressRoutePort.
...
### -ExpressRoutePort
Ссылка на ресурс ExpressRoutePort, когда канал подготовлен на ресурсе ExpressRoutePort.
...
### -ServiceProviderName
Имя поставщика услуг цепи. Оно должно совпадать с именем, указанным в командлете Get-AzureRmExpressRouteServiceProvider.
