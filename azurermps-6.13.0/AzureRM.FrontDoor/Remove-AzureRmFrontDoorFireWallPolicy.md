...
## NОПИСАНИЕ
Командлет **Remove-AzureRmFrontDoor** УДАЛЯЕТ политику WAF в рамках текущей подписки.
...
Удалите политику WAF с именем $name в $resourceGroup.
...
Удалите все WAF политики в $resourceGroup.
