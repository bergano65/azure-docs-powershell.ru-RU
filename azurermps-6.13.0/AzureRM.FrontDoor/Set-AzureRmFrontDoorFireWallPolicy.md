...
## NОПИСАНИЕ
Командлет **Set-AzureRmFrontDoor** обновляет СУЩЕСТВУЮЩУЮ политику WAF. Если входные параметры не предоставлены, будут использоваться старые параметры существующей политики WAF.

## ИЛЛЮСТРИРУЮТ

### Пример 1: обновление существующей политики WAF
```powershell
...
Обновление существующей политики WAF

### Пример 2: обновление существующей политики WAF
```powershell
...
### Пример 3: обновление существующей политики WAF
```powershell
...
### Пример 4: обновление всех политик WAF в $resourceGroup
```powershell
...
обновление всех политик WAF в $resourceGroup
