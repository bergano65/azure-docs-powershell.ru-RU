...
### -HyperV
Укажите, что план служб приложений будет запускать контейнеры Windows
...
### Microsoft. Azure. Management. website. Models. AppServicePlan
Параметры: AppServicePlan (ByValue)
