...
## NОПИСАНИЕ
Командлет **New-AzureRmOperationalInsightsLinuxPerformanceObjectDataSource** добавляет счетчики производительности, с помощью которых оперативная аналитика Azure собирает данные на все компьютеры Linux в рабочей области.
...
### -CounterNames
Указывает массив имен счетчиков.
