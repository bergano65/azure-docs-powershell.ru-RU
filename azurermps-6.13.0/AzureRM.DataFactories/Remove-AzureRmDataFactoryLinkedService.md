...
## NОПИСАНИЕ
Командлет **Remove-AzureRmDataFactoryLinkedService** Удаляет связанную службу из фабрики данных Azure.
...
### -Force
Указывает на то, что этот командлет удаляет связанную службу без запроса подтверждения.
