...
## NОПИСАНИЕ
Командлет Set-AzureRMEnvironment задает конечные точки и метаданные для подключения к экземпляру Azure.
...
DNS-суффикс конечных точек служб Analysis Services для Azure
...
### -Name (имя)
Указывает имя среды, которую нужно изменить.
