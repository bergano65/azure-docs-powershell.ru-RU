...
## NОПИСАНИЕ
Командлет New-AzureRmConsumptionBudget создает бюджет либо в подписке, либо в группе ресурсов.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание бюджетных затрат с именем бюджета на уровне подписки
```powershell
...
### Пример 2: создание бюджетных затрат с использованием названия бюджета на уровне группы ресурсов
```powershell
