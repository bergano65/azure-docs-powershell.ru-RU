...
## NОПИСАНИЕ
Командлет **Get-AzureRmConsumptionReservationSummay** получает сведения о резервировании для ежедневного или ежемесячного гранка.
...
### -Зернистость
Временные части сводки резервирования могут быть ежедневно или ежемесячными.
