...
## NОПИСАНИЕ
Командлет Set-AzureRmDataLakeAnalyticsCatalogCredential изменяет пароль учетных данных, связанный с каталогом Azure Data Lake Analytics.

## ИЛЛЮСТРИРУЮТ

### Пример 1: изменение пароля учетных данных, связанного с учетной записью
```
...
Эта команда задает пароль учетной записи, указанный в NewPassword.
...
### -Credential
Указывает имя и текущий пароль учетных данных, которые нужно изменить.
...
### -DatabaseName
Указывает имя базы данных в учетной записи Data Lake Analytics, содержащей учетные данные.
...
### -NewPassword
Указывает новый пароль для учетных данных.
