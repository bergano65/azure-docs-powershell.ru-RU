...
## NОПИСАНИЕ
Командлет **Wait-AzureRmHDInsightJob** ожидает завершения или сбоя задания Azure HDInsight.

## ИЛЛЮСТРИРУЮТ

### Пример 1: ожидание завершения или сбоя задания
```
PS C:\># Cluster info
...
Эта команда ожидает завершения или сбоя задания.
...
### -TimeoutInSeconds
Общее время ожидания завершения задания (в секундах).
...
Время ожидания между проверками состояния задания (в секундах).
