...
## NОПИСАНИЕ
Командлет **Set-AzureRmPolicySetDefinition** изменяет определение политики.
...
Первая команда получает определение политики с помощью командлета Get-AzureRmPolicySetDefinition.
