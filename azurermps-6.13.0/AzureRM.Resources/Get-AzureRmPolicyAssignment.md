...
## NОПИСАНИЕ
Командлет **Get-AzureRmPolicyAssignment** получает все назначения политик или конкретные назначения.
...
Первая команда получает группу ресурсов с именем ResourceGroup11, используя Get-AzureRMResourceGroup cmdletand сохраняет ее в переменной $ResourceGroup.
