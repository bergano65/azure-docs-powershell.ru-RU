...
## NОПИСАНИЕ
Командлет **New-AzureRmServiceBusRule** создает новое правило для данной подписки.
...
Командлет New-AzureRmServiceBusRule создает новое правило для указанной подписки.
...
Командлет New-AzureRmServiceBusRule создает новое правило для указанной подписки с помощью ActionFilter.

## ПАРАМЕТРЫ

### -ActionSqlExpression
Выражение SqlFillter действия
...
Действие требует предварительной обработки
