...
## NОПИСАНИЕ
Командлет **Start-AzureRmServiceBusMigration** создает новую конфигурацию миграции и начинает миграцию сущностей из стандартных в расширенные пространства имен.
