...
## NОПИСАНИЕ
Командлет **Remove-AzureStorageContainer** удаляет указанный контейнер хранилища в Azure.
...
### -Context
Задает контекст для контейнера, который вы хотите удалить.
...
### -Name (имя)
Указывает имя контейнера, который нужно удалить.
