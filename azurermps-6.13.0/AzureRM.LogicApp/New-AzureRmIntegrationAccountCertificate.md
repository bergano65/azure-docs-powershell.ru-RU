...
## NОПИСАНИЕ
Командлет **New-AzureRmIntegrationAccountCertificate** создает сертификат учетной записи интеграции.
Этот командлет возвращает объект, представляющий сертификат учетной записи интеграции.
Укажите имя учетной записи интеграции, имя группы ресурсов, имя сертификата, имя ключа, версию ключа и идентификатор хранилища ключей.
...
### Пример 1: создание сертификата учетной записи интеграции
```
...
Эта команда создает сертификат учетной записи интеграции в указанной группе ресурсов.
...
### -KeyName
Задает имя ключа сертификата в хранилище ключей.
...
### -KeyVaultId
Указывает идентификатор хранилища ключей.
...
### -KeyVersion
Указывает версию ключа сертификата в хранилище ключей.
...
### -Metadata
Указывает объект метаданных для сертификата.
...
Указывает путь к общедоступному файлу сертификата (CER).
