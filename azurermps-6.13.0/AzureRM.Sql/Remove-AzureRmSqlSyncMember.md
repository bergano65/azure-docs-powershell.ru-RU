...
## NОПИСАНИЕ
Командлет **Remove-AzureRmSqlSyncMember** удаляет элемент синхронизации базы данных SQL Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Удаление члена синхронизации
```
...
Эта команда удаляет член синхронизации базы данных SQL Azure с именем syncMember01.
...
### -PassThru
Определяет, возвращают ли удаленный элемент синхронизации
