...
## NОПИСАНИЕ
Командлет **Stop-AzureRmSqlDatabaseActivity** отменяет операцию асинхронных обновлений для базы данных.

## ИЛЛЮСТРИРУЮТ

### Пример 1: отмена операции асинхронных обновлений для базы данных
```
...
Эта команда отменяет операцию асинхронных обновлений для базы данных.
...
### -ElasticPoolName
Имя пула эластичных БД SQL Azure.
