...
## NОПИСАНИЕ
Командлет **New-AzureRmSqlElasticPool** создает пул эластичных баз данных для базы данных SQL Azure.
...
### Пример 1: создание эластичного пула
```
...
### -DatabaseVCoreMax
Maxmium VCore число, которое может использовать любая SqlAzure база данных в пуле.
