...
## NОПИСАНИЕ
Командлет **Enable-AzureRmSqlServerAdvancedThreatProtection** включает Advanced Threat Protection на сервере.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Включение расширенной защиты от угроз для сервера
```powershell
...
### Пример 2: Включение Advanced Threat protection из серверного ресурса
```powershell
...
### -InputObject
Объект сервера для использования с расширенной операцией политики защиты от угроз
