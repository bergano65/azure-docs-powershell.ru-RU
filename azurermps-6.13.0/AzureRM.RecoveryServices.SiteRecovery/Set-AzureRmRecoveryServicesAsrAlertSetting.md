...
## NОПИСАНИЕ
Командлет **Set-AzureRmRecoveryServicesAsrNotificationSetting** настраивает параметры уведомлений Azure Site Recovery (уведомление по электронной почте) для хранилища.
...
### -LocaleID
Язык электронной почты для оповещения/notifcation пользователя (Поддерживаемые коды языка и региональных параметров от Microsoft). 
