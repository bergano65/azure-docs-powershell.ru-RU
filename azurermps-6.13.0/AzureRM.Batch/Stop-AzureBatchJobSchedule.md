...
## NОПИСАНИЕ
Командлет **Stop-AzureBatchJobSchedule** прекращает выполнение пакетного задания Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: остановка расписания задания
```
PS C:\>Stop-AzureBatchJobSchedule -Id "JobSchedule17" -BatchContext $Context
```

Эта команда останавливает расписание задач с ИДЕНТИФИКАТОРом JobSchedule17.
...
### -ID
Указывает идентификатор расписания задания, которое останавливает этот командлет.
