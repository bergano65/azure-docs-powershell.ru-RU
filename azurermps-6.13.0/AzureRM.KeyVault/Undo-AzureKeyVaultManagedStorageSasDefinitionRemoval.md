...
## NОПИСАНИЕ
Команда **Undo-AzureKeyVaultManagedStorageSasDefinitionRemoval** восстанавливает ранее удаленное определение управляемого сопоставления безопасности хранилища при условии, что для этого хранилища включена функция обратимого удаления, и что попытка восстановления выполняется в течение интервала восстановления.
