...
## NОПИСАНИЕ
Командлет **RESTORE-AzureKeyVaultManagedStorageAccount** создает управляемую учетную запись хранения в указанном хранилище ключей из файла резервной копии.
