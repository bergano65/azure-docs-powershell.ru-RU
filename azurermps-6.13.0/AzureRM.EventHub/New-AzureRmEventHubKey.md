...
## NОПИСАНИЕ
Командлет New-AzureRmEventHubKey повторно создает первичный или дополнительный ключ SAS для указанного правила авторизации концентраторов событий.

## ИЛЛЮСТРИРУЮТ

### Пример 1,1-Namespace-AuthorizationRule PrimaryKey
```
...
Повторно создает первичный ключ для правила авторизации \` MyAuthRuleName \` .

### Пример 1,2-EventHub-AuthorizationRule PrimaryKey
```
...
### Пример 2,1-Namespace-AuthorizationRule SecondaryKey
```
...
### Пример 2,2-EventHub-AuthorizationRule SecondaryKey
```
...
Повторно создает вторичный ключ для правила авторизации \` MyAuthRuleName \` .
