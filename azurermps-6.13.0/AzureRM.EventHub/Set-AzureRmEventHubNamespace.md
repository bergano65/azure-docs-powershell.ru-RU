...
## NОПИСАНИЕ
Командлет Set-AzureRmEventHubNamespace обновляет свойства указанного пространства имен концентраторов событий.
...
Обновляет состояние пространства имен \` MyNamespaceName \` для создания.
...
### System. Nullable "1 [[Microsoft. Azure. Commands. eventhub. System. NamespaceState, Microsoft. Azure. Commands. EventHub, Version = 0.6.7.0, культура = нейтрально, PublicKeyToken = NULL]]
