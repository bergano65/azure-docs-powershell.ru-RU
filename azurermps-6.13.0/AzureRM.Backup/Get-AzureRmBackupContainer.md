...
- Инфраструктура Azure в качестве виртуальной машины службы (IaaS) до создания резервной копии базы данных или элемента может быть зарегистрирована в службе резервного копирования Azure.
