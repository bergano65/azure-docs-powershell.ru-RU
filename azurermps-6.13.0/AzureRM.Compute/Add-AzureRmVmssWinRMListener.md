...
## NОПИСАНИЕ
Командлет **Add-AzureRmVmssWinRMListener** добавляет прослушиватель удаленного управления Windows (WinRM) в наборе масштабов виртуальных машин (VMSS).
...
### System. Nullable "1 [[Microsoft. Azure. Management. COMPUTE. Model. ProtocolTypes, Microsoft. Azure. Management. COMPUTE, Version = 21.0.0.0, культура =" нейтрально ", PublicKeyToken = 31bf3856ad364e35]]
