...
## КРАТКИй обзор
Добавляет диск с данными на виртуальную машину или Vmss ВМ.
...
## NОПИСАНИЕ
Командлет **Add-AzureRmVMDataDisk** добавляет диск с данными в виртуальную машину или Vmss VM.
...
Первая команда получает виртуальную машину с именем VirtualMachine07 с помощью командлета [Get-AzureRmVM](./Get-AzureRmVM.md) .
...
### Пример 5: Добавление управляемого диска с данными к виртуальной машине Vmss.
```
