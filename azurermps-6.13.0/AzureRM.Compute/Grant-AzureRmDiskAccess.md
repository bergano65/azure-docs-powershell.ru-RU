...
## NОПИСАНИЕ
Командлет **Grant-AzureRmDiskAccess** предоставляет доступ к диску.
...
Предоставление доступа для чтения к диску с именем "Disk01" в группе ресурсов с именем "ResourceGroup01" для 60 секунд.
