...
В этом примере показано, как включить шифрование без указания учетных данных рекламы.
...
В этом примере показано, как отправить параметры с помощью конвейера ввода, чтобы включить шифрование без указания учетных данных Active Directory.
...
Допустимые значения для виртуальных машин Linux следующие: все, ОС и данные, поддерживаемые дистрибутивом Linux.
