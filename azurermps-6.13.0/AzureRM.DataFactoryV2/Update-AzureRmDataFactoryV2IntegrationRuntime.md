...
## NОПИСАНИЕ
Командлет **Update-AzureRmDataFactoryV2IntegrationRuntime** обновляет свойства среды выполнения интеграции. В настоящее время командлет поддерживает обновление "автоматическое обновление" и "AutoUpdateDelayOffset" для самостоятельной среды интеграции.

## ИЛЛЮСТРИРУЮТ

### Пример 1: обновление среды выполнения интеграции
```
...
Командлет обновляет саморазмещенную среду интеграции с именем Test-SelfHost-IR.

## ПАРАМЕТРЫ

### -Автоматическое обновление
Включите или отключите автоматическое обновление среды выполнения интеграции с самостоятельным размещением.
...
Время в часах для автоматического обновления среды выполнения интеграции с самостоятельным размещением.
