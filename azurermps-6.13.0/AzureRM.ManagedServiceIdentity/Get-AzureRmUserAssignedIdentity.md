...
## КРАТКИй обзор
Возвращает пользователей, которым назначены идентификаторы и удостоверения.
...
## NОПИСАНИЕ
**Get-AzureRmUserAssignedIdentity** получает идентификаторы существующих пользователей, которым они назначены.

## ИЛЛЮСТРИРУЮТ

### Пример 1
В этом примере командлет получает имя пользователя, которому назначена идентификация, с именем **id1** в группе ресурсов **PSRG**
...
### Пример 2
В этом примере командлет получает всех пользователей, которым назначены учетные данные в группе ресурсов **PSRG**
...
### Пример 3
В этом примере командлет получает все удостоверения, назначенные пользователю в рамках подписки.
