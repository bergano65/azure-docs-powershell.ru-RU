...
### System. String
Параметры: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue); KeyVaultName (ByValue), KeyVaultResouceGroupName (ByValue), Location (ByValue), Name (ByValue), ParameterFile (ByValue), SecondaryCertificateFile (ByValue), SecretIdentifier (ByValue)

### System. Security. SecureString
Параметры: CertificatePassword (ByValue), SecondaryCertificatePassword (ByValue)

### System. Int32
Параметры: ClusterSize (ByValue)
