...
### System. String
Параметры: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), KeyVaultName (ByValue), KeyVaultResouceGroupName (ByValue)

### System. Security. SecureString
Параметры: CertificatePassword (ByValue)
