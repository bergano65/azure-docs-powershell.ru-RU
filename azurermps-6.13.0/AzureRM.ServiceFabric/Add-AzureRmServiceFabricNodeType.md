...
### -VmPassword
Пароль для входа на виртуальную машину.
...
### System. String
Параметры: NodeType (ByValue), Tier (ByValue), VmSku (ByValue), VmUserName (ByValue)

### System. Int32
Параметры: Capacity (ByValue)

### System. Security. SecureString
Параметры: VmPassword (ByValue)
