...
## NОПИСАНИЕ
Командлет **Remove-AzureRmApiManagementApi** УДАЛЯЕТ существующий API.
...
Эта команда удаляет API с указанным ИДЕНТИФИКАТОРом.

## ПАРАМЕТРЫ

### -ApiId
Указывает идентификатор API Remove.
