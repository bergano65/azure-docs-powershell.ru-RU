...
Командлет **New-AzureRmApiManagementApiRevision** создает редакцию API для существующего API в контексте управления API.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание редакции API для API
```powershell
