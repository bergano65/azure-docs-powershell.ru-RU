...
## NОПИСАНИЕ
Командлет **Set-AzureRmSchedulerHttpJob** изменяет задание HTTP в планировщике Azure.
...
### -Частота
Указывает максимальную частоту для задания.
Для этого параметра допустимы следующие значения:
- До 
- Часовой 
- Дневных 
...
### -Method
Указывает метод для типов действий для этого задания.
Для этого параметра допустимы следующие значения:
- Получить 
- Установка 
- Поместить 
