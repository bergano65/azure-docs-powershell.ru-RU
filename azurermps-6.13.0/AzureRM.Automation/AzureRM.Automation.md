...
---
# Модуль AzureRM. Automation
## Nописание
В этом разделе отображаются разделы справки по командлетам автоматизации Azure.

## Командлеты AzureRM. Automation
...
Экспортирует Runbook автоматизации.
...
Возвращает развертывание конфигурации узла DSC в автоматизации.
...
Возвращает расписание заданий развертывания конфигурации узла DSC в автоматизации.
...
Возвращает расписание автоматизации.
...
Получает список конфигураций обновлений программного обеспечения службы автоматизации Azure.
...
Получает выходные данные задания синхронизации для системы управления версиями Azure Automation.
...
Создает элемент управления источником автоматизации.
...
### [Регистрация — AzureRmAutomationScheduledRunbook](Register-AzureRmAutomationScheduledRunbook.md)
...
Удаляет подключение автоматизации.
...
Удаляет метаданные из конфигураций узла DSC в автоматизации.
...
Удаляет конфигурацию обновления программного обеспечения Azure Automation.

### [Remove-AzureRmAutomationSourceControl](Remove-AzureRmAutomationSourceControl.md)
Удаляет элемент управления источником автоматизации Azure.
...
Изменяет конфигурацию узла, с которой сопоставлен узел DSC.

### [Set-AzureRmAutomationModule](Set-AzureRmAutomationModule.md)
Обновляет модуль в автоматизации.

### [Set-AzureRmAutomationRunbook](Set-AzureRmAutomationRunbook.md)
Изменение модуля Runbook.
...
### [Остановить-AzureRmAutomationDscNodeConfigurationDeployment](Stop-AzureRmAutomationDscNodeConfigurationDeployment.md)
...
Обновляет элемент управления источником автоматизации Azure.
