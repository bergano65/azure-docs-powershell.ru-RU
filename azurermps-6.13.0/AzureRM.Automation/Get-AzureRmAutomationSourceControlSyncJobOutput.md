...
## NОПИСАНИЕ
Командлет **Get-AzureRmAutomationSourceControlSyncJobOutput** получает выходные данные для задания синхронизации системы управления версиями для Azure Automation.
