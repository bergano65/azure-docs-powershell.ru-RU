...
## NОПИСАНИЕ
Командлет Get-AzureRmAutomationSourceControlSyncJob получает задания синхронизации управления источниками для Azure Automation. Чтобы получить определенное задание синхронизации системы управления версиями, укажите его идентификатор.
