...
## NОПИСАНИЕ
Командлет Disable-AzureRmRecoveryServicesBackupRPMountScript размонтирует файлы точки восстановления, которые были подключены ранее с помощью командлета Get-AzureRmRecoveryServicesBackupRPMountScript.
