...
ms.locfileid: "93554615"
---
# Модуль AzureRM. COMPUTE. ManagedService
## Nописание
В этом разделе отображаются разделы справки по командлетам COMPUTE для Azure.

## Командлеты AzureRM. COMPUTE. ManagedService
### [ConvertTo-AzureRmVhd](ConvertTo-AzureRmVhd.md)
Преобразование виртуальной машины Hyper-V в Azure файлы виртуальных жестких дисков поддерживаются
