...
## NОПИСАНИЕ
Командлет **Get-AzBillingProfile** получает профили выставления счетов в соответствии с указанным счетом выставления счетов. 
...
Получить все профили выставления счетов в соответствии с заданным счетом выставления счета.
...
Получение профиля выставления счетов с указанным именем.
...
Получить все профили выставления счетов в указанном счете, а затем включить в результат разделы счета.
...
Получить профиль выставления счетов с указанным именем и включить в результат разделы счета-фактуры.
...
Включение разделов "счета" в разделе "профиль выставления счетов".
...
### Microsoft. Azure. Commands. Bill. Models. PSBillingProfile
