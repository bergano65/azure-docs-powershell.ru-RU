...
## NОПИСАНИЕ
Командлет Get-AzConsumptionBudget возвращает список бюджетов либо в подписке, либо в группе ресурсов.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение списка бюджетов на уровне подписки
```powershell
...
### Пример 2: получение списка бюджетов на уровне группы ресурсов
```powershell
...
### Пример 3: получение бюджета с использованием названия бюджета на уровне подписки
```powershell
...
### Пример 4: получение бюджета с использованием названия бюджета на уровне группы ресурсов
```powershell
