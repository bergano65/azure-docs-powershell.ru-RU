...
## NОПИСАНИЕ
Командлет **Remove-AzDataBoxJob** используется для удаления завершенного задания databox из списка заданий databox.
...
Удаляет указанное задание databox
...
Принудительно удаляет указанное задание databox, не требуя подтверждения
