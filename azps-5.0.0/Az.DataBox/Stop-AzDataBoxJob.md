...
## NОПИСАНИЕ
Командлет **Stop-AzDataBoxJob** используется для отмены задания databox.
...
Отменяет указанное задание databox
...
Отменяет указанное задание databox принудительно без подтверждения
