...
## NОПИСАНИЕ
Этот командлет удаляет приложение из кластера. Это приведет к удалению всех служб, если таковые имеются, под ресурсом приложения.
...
В этом примере удаляется приложение "testApp" в группе ресурсов "testRG" и кластере "testCluster".
