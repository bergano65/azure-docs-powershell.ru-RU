...
Удаление сертификата клиента по обычному имени.
...
Удаление сертификата клиента по отпечатку.
...
Удаление сертификата клиента по отпечатку с помощью трубопроводов.
