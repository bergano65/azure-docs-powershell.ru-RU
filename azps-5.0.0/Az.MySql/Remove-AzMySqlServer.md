...
### Пример 1: Удаление сервера MySql по группе ресурсов и имени сервера
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Этот командлет удаляет сервер MySql по группе resourceGroup и имени сервера.

### Пример 2: Удаление сервера MySql по удостоверению
```powershell
...
Эти командлеты удаляют сервер MySql по идентификаторам.
