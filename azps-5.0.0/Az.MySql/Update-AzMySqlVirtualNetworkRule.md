...
Этот командлет обновляет правило виртуальной сети MySql по имени.

### Пример 2: обновление правила виртуальной сети MySql по удостоверению.
```powershell
...
Эти командлеты обновляют правило виртуальной сети MySql по идентификаторам.
