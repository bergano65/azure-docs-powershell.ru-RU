...
### Пример 1: Удаление правила виртуальной сети сервера MySql по имени
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Этот командлет удаляет правило виртуальной сети сервера MySql по имени.

### Пример 2: Удаление правила виртуальной сети сервера MySql по удостоверению
```powershell
...
Эти командлеты удаляют правило виртуальной сети MySql Server по удостоверению.
