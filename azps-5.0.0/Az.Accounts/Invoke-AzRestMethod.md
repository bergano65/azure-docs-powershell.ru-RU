...
Получение рабочей области для службы аналитики журналов по пути
...
### -Полезные данные
Полезные данные в формате JSON
