...
В следующем примере создается строка подключения с именем myConnectionString для веб-приложения ContosoWebApp. Это заменяет все существующие строки подключения для веб-приложения ContosoWebApp.
