...
## NОПИСАНИЕ
Командлет **RESTORE-AzWebAppBackup** восстанавливает резервную копию веб-приложения Azure.
...
Командлет Restore-AzWebAppBackup восстанавливает резервную копию веб-приложения Azure. (автоматически сформированные)
