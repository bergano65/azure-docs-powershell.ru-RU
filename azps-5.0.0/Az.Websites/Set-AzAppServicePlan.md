...
## NОПИСАНИЕ
Командлет **Set-AzAppServicePlan** задает план служб приложений Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: изменение плана служб приложений
```powershell
...
Задает план служб приложений Azure. (автоматически сформированные)
