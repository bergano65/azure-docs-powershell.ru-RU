...
## NОПИСАНИЕ
Командлет **Get-AzDiskAccess** получает свойства доступа к диску.

## ИЛЛЮСТРИРУЮТ

### Пример 1: использование параметра по умолчанию 
```
...
Эта команда получает свойства ресурса доступа к диску с именем "DiskAccess01" в группе ресурсов "ResourceGroup01".
...
Эта команда получает свойства всех обращений к дискам в группе ресурсов "ResourceGroup01".


### Пример 3: получение доступа ко всем дискам
```
...
Эта команда получает свойства всех обращений к дискам в рамках подписки.

### Пример 4: получение доступа ко всем дискам с помощью подстановочных знаков
```
...
Эта команда получает свойства всех обращений к дискам под именем подписки, начинающейся с "DiskAccessMicrosoft".

### Пример 5: получение доступа к диску с помощью ResourceId.
```
...
Эта команда получает свойства доступа к диску с данным ИД ресурса.
