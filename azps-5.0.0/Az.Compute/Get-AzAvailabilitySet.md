...
## NОПИСАНИЕ
Командлет **Get-AzAvailabilitySet** получает наборы доступности Azure в группе ресурсов.
...
Эта команда получает группу доступности с именем AvailabilitySet03 в группе ресурсов с именем ResourceGroup11.
...
### Пример 3: получение всех наборов доступности с фильтрацией
```
...
Эта команда получает все наборы доступности в группе ресурсов с именем ResourceGroup11, которая начинается с "AvailabilitySet0".

### Пример 4: получение всех наборов доступности с именем, начинающимся с AvailabilitySet0
```
