...
Получить доступ к параметру шифрования диска "enc1"
...
Получить все наборы шифрования дисков в группе ресурсов "Rg1".
...
Получение всех наборов шифрования дисков в подписке.
