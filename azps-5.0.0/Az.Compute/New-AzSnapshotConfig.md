...
## NОПИСАНИЕ
Командлет **New-AzSnapshotConfig** создает настраиваемый объект снимка.
...
Создание настраиваемого объекта снимка. (автоматически сформированные)
...
### -DiskAccessId
Возвращает или задает идентификатор ARM ресурса DiskAccess для использования закрытых конечных точек.
...
### -Инкрементное
Задает инкрементный снимок. Добавочные снимки на том же диске занимают меньше места, чем полные снимки, и могут быть непонятными.
