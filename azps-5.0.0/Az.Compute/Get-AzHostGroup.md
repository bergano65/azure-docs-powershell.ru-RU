...
## NОПИСАНИЕ
Этот командлет получит группу узлов.
Этот командлет также перечисляет все группы узлов в группе ресурсов, если не задано имя группы узлов.
Этот командлет также перечисляет все группы узлов в подписке, если не заданы ни имя группы узлов, ни имя группы ресурсов.
...
Эта команда возвращает группу узлов.
...
Эта команда возвращает все группы узлов в заданной группе ресурсов.
...
Эта команда возвращает все группы узлов в подписке.
...
### -InstanceView
Разверните возвращенный объект, чтобы также отобразить представления экземпляра узла. 
