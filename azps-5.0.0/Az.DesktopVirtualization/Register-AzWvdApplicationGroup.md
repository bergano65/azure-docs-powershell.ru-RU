...
### Пример 1: регистрация группы приложений виртуальных рабочих столов Windows
```powershell
...
Эта команда регистрирует группу приложений виртуальных рабочих столов Windows в рабочей области.

## ПАРАМЕТРЫ

### -ApplicationGroupPath
ApplicationGroupPath путь
