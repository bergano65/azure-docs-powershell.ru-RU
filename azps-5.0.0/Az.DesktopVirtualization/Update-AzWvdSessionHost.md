...
### Пример 1: Обновление виртуального рабочего стола Windows SessionHost по имени
```powershell
...
Эта команда обновляет SessionHost виртуальных рабочих столов Windows в пуле узлов.

## ПАРАМЕТРЫ

### -AllowNewSession
Разрешите новый сеанс.
