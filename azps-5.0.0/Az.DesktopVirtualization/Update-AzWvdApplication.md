...
### Пример 1: обновление приложения виртуального рабочего стола Windows
```powershell
...
Эта команда обновляет приложение виртуальных рабочих столов Windows в группе applicaton.
