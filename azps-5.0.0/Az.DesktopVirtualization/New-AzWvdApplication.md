...
### Пример 1: создание приложения виртуальных рабочих столов Windows
```powershell
...
Эта команда создает приложение виртуальных рабочих столов для Windows в группе applicaton.
...
### -CommandLineSetting
Указывает, может ли опубликованное приложение запускаться с помощью аргументов командной строки, предоставленных клиентом, аргументов командной строки, заданных во время публикации, или вообще без аргументов командной строки.
...
### -FilePath
Задает путь к исполняемому файлу для приложения.
...
### -ShowInPortal
Указывает, нужно ли отображать удаленное приложение RemoteApp на сервере веб-доступа к удаленному рабочему столу.
