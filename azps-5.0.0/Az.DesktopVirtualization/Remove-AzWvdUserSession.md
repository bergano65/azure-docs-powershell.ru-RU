...
### Пример 1: Удаление виртуального рабочего стола Windows UserSession по имени
```powershell
...
Эта команда удаляет UserSession виртуальных рабочих столов Windows на узле сеансов.
...
### -Force
Принудительная Пометка для входа в userSession.
