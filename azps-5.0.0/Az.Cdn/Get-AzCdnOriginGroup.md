...
## NОПИСАНИЕ
Командлет Get-AzCdnOriginGroup извлекает группу источников сети CDN.
...
Эта команда получит группу источника в указанной конечной точке.
...
### -ResourceId
Идентификатор ресурса для начальной группы
