...
## NОПИСАНИЕ
Командлет **Enable-AzCdnCustomDomainHttps** обеспечивает защищенную доставку HTTPS для настраиваемого домена CDN.
...
Включите безопасную доставку настраиваемого домена.

## ПАРАМЕТРЫ

### -CustomDomainName
Отображаемое имя настраиваемого домена CDN в службе Azure.
...
### -PassThru
Возвращаемый объект, если он указан.
...
### -ResourceId
ResourceId для настраиваемого домена
