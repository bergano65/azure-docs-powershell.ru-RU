...
## NОПИСАНИЕ
Remove-AzCdnOrigin удалит источник CDN из данной конечной точки. Если источником является единственный источник в пределах указанной конечной точки, удаление завершится сбоем, так как требуется по крайней мере 1 источник. 
...
```
Этот командлет удалит указанный источник из данной конечной точки. 
