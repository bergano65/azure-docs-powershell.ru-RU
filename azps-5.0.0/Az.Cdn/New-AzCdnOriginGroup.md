...
## КРАТКИй обзор
Создание новой группы происхождения сети CDN
...
## NОПИСАНИЕ
New-AzCdnOriginGroup создаст новую группу начала в пределах указанной конечной точки. Если это первая группа источника для конечной точки, необходимо также задать свойство DefaultOriginGroup.
...
```
Этот командлет создаст новую группу начала в указанной конечной точке. Он будет использовать заданные идентификаторы происхождения в качестве набора источников.
