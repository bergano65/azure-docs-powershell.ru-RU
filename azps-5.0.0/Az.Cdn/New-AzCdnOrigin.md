...
## КРАТКИй обзор
Создание нового источника сети CDN
...
## NОПИСАНИЕ
New-AzCdnOrigin создаст новый источник CDN в пределах указанной конечной точки.
...
Этот командлет создаст новый источник CDN для указанной конечной точки. Он будет использовать предоставленное имя узла в качестве источника. 

## ПАРАМЕТРЫ

### -CdnOrigin
Объект источника CDN.
...
### -OriginHostHeader
Заголовок узла источника CDN Azure.
