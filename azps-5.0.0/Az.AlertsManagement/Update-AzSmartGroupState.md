...
## NОПИСАНИЕ
Командлет **Update-AzSmartGroupState** обновляет состояние Smart Group.
...
Этот командлет обновляет состояние Smart Group до acknowleged.
...
### -SmartGroupId
Уникальный идентификатор Smart Group/ResourceId для Smart Group.
...
### -State
Обновлено состояние Smart Group
