...
Добавление нового ресурса Application Insights с именем "тест" в группе ресурсов "testgroup" с обозначением "Java"
...
Тип сетевого доступа для получения доступа к Application Insights. Значение должно быть "включено" или "отключено"
...
Тип сетевого доступа для доступа к запросу Application Insights. Значение должно быть "включено" или "отключено"
