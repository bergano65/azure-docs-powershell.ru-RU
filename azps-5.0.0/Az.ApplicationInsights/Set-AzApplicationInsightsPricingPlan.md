...
### Пример 1. Установка плана ценообразования и сведений о ежедневных объемах данных для ресурса Application Insights
```
...
Установка для плана цен значения "Basic", установка для ежедневного объема данных 400GB в день и прекращение отправки уведомлений при попадании на прописные буквы для ресурсов "тест" в группе ресурсов "testgroup"
...
Прекращение отправки уведомлений при попадании курсора на прописные.
...
### -PricingPlan
Название плана ценообразования.
