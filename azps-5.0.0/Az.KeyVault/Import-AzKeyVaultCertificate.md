...
- Используется `Add-AzKeyVaultCertificate` для создания запроса подписи сертификата и его отправки в центр сертификации. Обнаружить https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
[Создание и слияние CSR в ключевом хранилище](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)