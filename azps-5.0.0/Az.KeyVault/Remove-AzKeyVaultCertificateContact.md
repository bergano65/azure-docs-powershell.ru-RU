...
## NОПИСАНИЕ
Командлет **Remove-AzKeyVaultCertificateContact** удаляет контакт, зарегистрированный для уведомлений о сертификате из хранилища ключей.
...
Эта команда удаляет Patti Белова в качестве контакта сертификата для хранилища ключей Contoso01.  Если указана функция PassThru, командлет возвращает список остальных контактов сертификата.
