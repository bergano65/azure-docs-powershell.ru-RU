...
### Пример 1: создание PSRoutingRuleObject для создания передней дверцы с помощью правила переадресации
```powershell
...
### Пример 2: создание PSRoutingRuleObject для создания передней дверцы с помощью правила перенаправления
```powershell
...
### -RulesEngineName
Ссылка на определенную конфигурацию обработчика правил, которую нужно применить к этому маршруту.
