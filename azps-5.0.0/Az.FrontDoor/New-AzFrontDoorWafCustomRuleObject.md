...
### -Action (действие)
Тип действий.
Возможные значения: "разрешить", "блок", "журнал"
...
### -EnabledState
Включенное состояние. Возможные значения: "включено", "отключено".
...
Продолжительность ограничения нормы. По умолчанию — 1 минута
