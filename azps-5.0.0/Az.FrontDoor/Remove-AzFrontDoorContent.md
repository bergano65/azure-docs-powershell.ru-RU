...
## NОПИСАНИЕ
Remove-AzFrontDoorContent удаляет кэшированное содержимое на передней дверце
...
### -ContentPath
Пути к содержимому, которое нужно очистить.
...
### -ResourceGroupName
Название группы ресурсов передней дверцы
