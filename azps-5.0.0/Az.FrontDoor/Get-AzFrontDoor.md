...
## NОПИСАНИЕ
CmdletGet **Get-AzFrontDoor** возвращает все существующие передние двери в текущей подписке, соответствующие указанным сведениям.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение всех FrontDoors в текущей подписке.
```powershell
...
Получение всех FrontDoors в текущей подписке.

### Пример 2: получение всех FrontDoors в группе ресурсов "Rg1" в текущей подписке.
```powershell
...
### Пример 3: получение FrontDoors в группе ресурсов "Rg1" с именем "frontDoor1" в текущей подписке.
```powershell
...
Получить FrontDoors в группе ресурсов "Rg1" с именем "frontDoor1" в текущей подписке.
