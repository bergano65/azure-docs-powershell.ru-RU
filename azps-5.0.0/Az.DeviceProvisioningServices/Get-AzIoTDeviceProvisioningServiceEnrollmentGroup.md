...
## NОПИСАНИЕ
Получение сведений о группе регистрации или список всех групп регистрации в службе подготовки устройств центра для Azure IoT.
...
Получить группу регистрации устройств в службе подготовки устройств центра для Azure IoT.
...
Список всех групп регистрации устройств в службе подготовки устройств центра для Azure IoT.
