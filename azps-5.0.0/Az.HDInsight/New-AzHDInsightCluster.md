...
### Пример 7: Создание кластера HDInsight Azure с помощью прокси-сервера Kafka RESTful.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Пример 8: Создание кластера HDInsight Azure с хранилищем Azure Data Lake Gen2.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Пример 9: Создание кластера HDInsight Azure с пакетом безопасности Enterprise (ESP) и включение брокера ИДЕНТИФИКАТОРов HDInsight.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### -EnableIDBroker
Включает компонент Брокер удостоверений HDInsight.
...
### -KafkaClientGroupId
Возвращает или задает идентификатор клиентской группы для доступа к прокси-серверу Kafka RESTful.
...
Возвращает или задает имя клиентской группы для доступа к прокси-серверу Kafka RESTful.
...
### -StorageAccountKey
Возвращает или задает ключ доступа учетной записи хранения для учетной записи хранения.
...
### -StorageContainer
Возвращает или задает имя StorageContainer для учетной записи хранения Azure по умолчанию.
...
### -StorageFileSystem
Возвращает или задает файловую систему для учетной записи Gen2 Azure Data Lake Storage.
...
### -StorageRootPath
Возвращает или задает путь к корню кластера в учетной записи Data Lake Store по умолчанию.
