...
### Пример 1: Добавление профиля безопасности в объект конфигурации кластера
```
...
Эта команда добавляет значение профиля безопасности в кластер с именем "-Hadoop-001".
...
### -DomainResourceId
Идентификатор ресурса домена Active Directory для кластера.
