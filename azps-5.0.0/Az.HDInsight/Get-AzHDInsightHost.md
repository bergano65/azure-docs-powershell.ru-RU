...
## NОПИСАНИЕ
Командлет **Get-AzHDInsightHost** содержит список узлов кластера HDInsight.
...
Эта команда перечисляет узлы кластера с именем кластера.
...
Эта команда перечисляет узлы кластера с конвейером.
