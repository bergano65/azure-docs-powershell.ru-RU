...
## Nописание
В этом разделе отображаются разделы справки по командлетам управления API Azure.

## Командлеты AZ. ApiManagement
### [Add-AzApiManagementApiToGateway](Add-AzApiManagementApiToGateway.md)
Подключает интерфейс API к шлюзу.
...
Резервное копирование службы управления API.
...
Получение подробных сведений о всех редакциях API для API

### [Get-AzApiManagementApiSchema](Get-AzApiManagementApiSchema.md)
Получение подробных сведений о схеме API
...
Получает секретный ключ клиента сервера авторизации управления API-интерфейсом.
...
Возвращает сертификаты управления API, настроенные для взаимной проверки подлинности с помощью внутреннего сервера в службе.

### [Get-AzApiManagementDiagnostic](Get-AzApiManagementDiagnostic.md)
Получение подробных сведений о диагностике, настроенном на уровне обслуживания или API. Диагностика используется для регистрации запросов и ответов от шлюза управления API.

### [Get-AzApiManagementGateway](Get-AzApiManagementGateway.md)
Возвращает все или конкретные шлюзы управления API.

### [Get-AzApiManagementGatewayHostnameConfiguration](Get-AzApiManagementGatewayHostnameConfiguration.md)
Возвращает для существующего шлюза все или определенную конфигурацию имени узла.

### [Get-AzApiManagementGatewayKey](Get-AzApiManagementGatewayKey.md)
Возвращает ключи существующего шлюза.
...
Возвращает список или определенное именованное значение.

### [Get-AzApiManagementNamedValueSecretValue](Get-AzApiManagementNamedValueSecretValue.md)
Возвращает секретное значение определенного именованного значения.

### [Get-AzApiManagementNetworkStatus](Get-AzApiManagementNetworkStatus.md)
Возвращает состояние подключения к внешним ресурсам, от которых зависит служба управления API в облачной службе. Это также возвращает DNS-серверы, видимые для CloudService.
...
Создает выпустку API для редакции API.
...
Создайте параметры диагностики для входящих и исходящих HTTP-сообщений на шлюзе.
...
Создайте новый контракт о расположении ресурсов (используется в шлюзах).
...
Удалена определенная версия API
...
Удаляет именованное значение для управления API.
...
Восстанавливает службу управления API из указанного блоба хранилища Azure.

### [Сохранить — AzApiManagementTenantGitConfiguration](Save-AzApiManagementTenantGitConfiguration.md)
...
Обновляет наборы API в контексте управления API.
...
Настройка шлюза управления API.
