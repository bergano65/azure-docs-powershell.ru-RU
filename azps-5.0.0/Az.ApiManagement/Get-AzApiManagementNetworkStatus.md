...
## NОПИСАНИЕ
Возвращает состояние сети для своей службы управления API.
...
Возвращает состояние подключения различных ресурсов, от которых зависит служба ApiManagement.
...
### -ResourceGroupName
Имя группы ресурсов, в которой есть управление API.
