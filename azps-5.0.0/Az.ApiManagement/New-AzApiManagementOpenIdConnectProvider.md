...
## NОПИСАНИЕ
Командлет **New-AzApiManagementOpenIdConnectProvider** создает поставщик OpenID Connect в управлении API Azure.
...
Эта команда создает **поставщик** подключений OpenID, именуемый поставщиком Contoso OpenID Connect

### Пример 2

Создает поставщик подключений OpenID. (автоматически сформированные)
...
Указывает идентификатор поставщика.
