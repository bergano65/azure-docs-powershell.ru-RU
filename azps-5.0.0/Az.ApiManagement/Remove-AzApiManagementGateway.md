...
## NОПИСАНИЕ
Командлет **Remove-AzApiManagementGateway** отключает API-интерфейс от шлюза.

## ИЛЛЮСТРИРУЮТ

### Пример 1: удаление существующего шлюза
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementGateway -Context $apimContext -GatewayId "g0001" -Force
```

Эта команда удаляет существующий шлюз и не запрашивает подтверждение у пользователя.
