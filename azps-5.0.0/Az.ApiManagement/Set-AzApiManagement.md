...
Командлет **Set-AzApiManagement** обновляет службу управления API Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение службы управления API и масштабирование ее до версии Premium и добавление региона
```powershell
...
### Пример 4: обновление электронной почты издателя, NotificationSender электронной почты и названия организации
```powershell
