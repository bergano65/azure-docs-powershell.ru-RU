...
### Пример 1: Настройка политики репликации объектов для конечной и исходной учетной записи.
```
...
Эта команда задает для политики репликации объектов конечную и исходную учетную запись.
Сначала создайте правила политики репликации объектов 2 и настройте политику, указав 2 правила для конечной учетной записи. Затем настройте политику репликации объектов от конечной учетной записи на исходную учетную запись.
...
### -InputObject
Объект политики репликации объектов для задания указанной учетной записи.
...
### -PolicyId
Идентификатор политики репликации объектов. Это должен быть GUID или "default".
Если PolicyId не введено, будет использоваться значение по умолчанию, которое означает, что вы можете создать новую политику, и идентификатор новой политики будет возвращен в созданной политике.
