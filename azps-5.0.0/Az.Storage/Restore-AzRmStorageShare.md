...
## NОПИСАНИЕ
Командлет **RESTORE-AzRmStorageShare** восстанавливает удаленную общую папку в течение допустимых дней хранения, если включено программное удаление общего доступа.

## ИЛЛЮСТРИРУЮТ

### Пример 1: удаление и восстановление общего доступа
```powershell
...
Эта команда сначала удаляет файловый ресурс, а затем список общих ресурсов и просмотр удаленной версии общего доступа, а затем снова восстановите ее в обычном общем доступе. Перед удалением общего доступа необходимо включить программное удаление с помощью Update-AzStorageFileServiceProperty.
...
### -DeletedShareVersion
Удалена версия общего доступа, из которой будет восстановлено.
...
### -Name (имя)
Удаленное имя общего доступа, которое будет восстановлено.
