...
## NОПИСАНИЕ
Командлет New-AzSqlElasticJob создает новое задание.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание нового задания
```powershell
...
Создает новое задание. (автоматически сформированные)
...
### -Enable (включить)
Пометка, показывающая, что клиент хочет включить это задание.
...
### -IntervalCount
Количество повторяющихся интервалов расписания
...
### -IntervalType
Тип интервала повторения расписания — может быть: минуты, часы, дни, недели, месяцы
...
### -RunOnce
Флаг, указывающий, что задание будет выполняться один раз
