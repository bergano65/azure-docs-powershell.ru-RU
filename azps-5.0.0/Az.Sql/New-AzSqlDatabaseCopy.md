...
Примечание. Используйте командлет New-AzSqlDatabaseSecondary, чтобы настроить георепликацию для базы данных.
...
Создает копию базы данных SQL, в которой используется моментальный снимок в настоящее время. (автоматически сформированные)
...
### -ComputeGeneration
Вычислено поколение, назначаемое новой копии.
...
### -Теги
Задает пары "ключ-значение" в форме хэш-таблицы, которую нужно связать с копией базы данных SQL Azure. Например: @ {Key0 = "value0"; key1 = $null; key2 = "значение2"}
...
### -VCore
Vcore номера копий базы данных SQL Azure.
