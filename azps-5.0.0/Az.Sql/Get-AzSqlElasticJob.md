...
## NОПИСАНИЕ
Командлет Get-AzSqlElasticJob получает одно или несколько заданий.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение задания
```powershell
...
Получает одно или несколько заданий. (автоматически сформированные)
