...
## NОПИСАНИЕ
Командлет Enable-AzSqlDatabaseSensitivityRecommendation включает рекомендации по отметкам для столбцов в базе данных.

## ИЛЛЮСТРИРУЮТ

### Пример 1: включение рекомендаций по чувствительности для определенного столбца в базе данных SQL Azure.
```powershell
...
### Пример 2: Включите рекомендации по чувствительности для заданной гистограммы базы данных Azure SQL с использованием конвейера.
```powershell
