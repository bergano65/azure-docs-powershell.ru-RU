...
## КРАТКИй обзор
Создает одноранговую сеть vNet для рабочей области.
...
### Пример 1: создание однорангового соединения vnet для кирпичей
```powershell
...
Эта команда создает одноранговый элемент vnet для кирпичей.

## ПАРАМЕТРЫ

### -AllowForwardedTraffic
Будет ли переадресованный трафик из виртуальных машин в локальной виртуальной сети разрешен и запрещен в удаленной виртуальной сети.
...
### -AllowGatewayTransit
Если вы можете использовать ссылки на шлюзы в удаленных виртуальных сетях, чтобы добавить ссылку на эту виртуальную сеть.
...
Смогут ли виртуальные машины в локальной виртуальной сети иметь доступ к виртуальным машинам в удаленной виртуальной сети.
...
Идентификатор виртуальной сети данных о модулях данных.
...
Идентификатор удаленной виртуальной сети.
...
### -UseRemoteGateway
Если удаленные шлюзы можно использовать в этой виртуальной сети.
