...
## NОПИСАНИЕ
Командлет Disable-AzRecoveryServicesBackupRPMountScript размонтирует файлы точки восстановления, которые были подключены ранее с помощью командлета Get-AzRecoveryServicesBackupRPMountScript.

## ИЛЛЮСТРИРУЮТ

### Пример 1: отключение точки восстановления
```powershell
...
Отключение всех файлов точки восстановления. (автоматически сформированные)
...
### -PassThru
Возвращает точку восстановления.
