...
## NОПИСАНИЕ
Командлет **Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** добавьте диск для защиты для уже защищенной виртуальной машины Azure.
...
Начните операцию, чтобы добавить указанную конфигурацию диска для защиты.
...
Начните операцию, чтобы добавить указанную конфигурацию диска для защиты. Элемент, защищенный входной репликацией трубопроводов.

## ПАРАМЕТРЫ

### -AzureToAzureDiskReplicationConfiguration
Указывает конфигурацию диска, используемую в сценарии аварийного восстановления с помощью Azure to Azure.
...
### -InputObject
Входной объект для командлета: объект элемента, защищенного репликацией ASR, соответствующий необходимо защитить новый диск.
