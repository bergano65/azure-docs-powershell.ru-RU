...
## NОПИСАНИЕ
Командлет **New-AzRecoveryServicesAsrRecoveryPlan** создает восстановление сайта Azure, план восстановления в хранилище служб восстановления.
...
Запускает операцию создания плана восстановления для зоны Azure с реплицированными элементами зоны и возвращает задание ASR, используемое для отслеживания операции.

## ПАРАМЕТРЫ

### -Azure
Параметр Switch задает сценарий для восстановления с помощью Azure для Azure, создание плана восстановления.
...
### -AzureZoneToZone
Параметр Switch указывает на необходимость создания реплицируемого элемента в зоне Azure для зоны.
...
### -PrimaryZone
Указывает основную зону availabilty для элементов, защищенных репликацией, которые будут входить в этот план восстановления.
