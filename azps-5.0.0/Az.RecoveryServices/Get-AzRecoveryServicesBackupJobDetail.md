...
Первая команда извлекает подходящее хранилище. Вторая команда получает массив невыполненных заданий в хранилище, а затем сохраняет их в массиве $Jobs.
Третья команда получает сведения о задании для 1-го невыполненного задания в $Jobs, а затем сохраняет их в переменной $JobDetails.
