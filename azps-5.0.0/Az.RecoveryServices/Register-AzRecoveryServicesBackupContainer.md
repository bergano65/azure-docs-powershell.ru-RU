...
Командлет регистрирует виртуальную машину Azure в качестве контейнера для рабочей нагрузки MSSQL.
...
### -WorkloadType
Тип рабочей нагрузки ресурса. Текущая поддерживаемая стоимость: AzureVM, WindowsServer, AzureFiles, MSSQL
