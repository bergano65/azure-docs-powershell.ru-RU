...
## NОПИСАНИЕ
Командлет **Update-AzRecoveryServicesAsrProtectionContainerMapping** обновляет указанное сопоставление контейнера защиты для Azure Site Recovery.
...
Запустите операцию, чтобы отключить автоматическое обновление для контейнера.
...
Запустите операцию, чтобы отключить функцию включения автоматического обновления для контейнера.

## ПАРАМЕТРЫ

### -AutomationAccountId
Указывает accountId автоматизации, используемую для автоматического UDPATE.
...
### -DisableAutoUpdate
Параметр Switch, чтобы отключить автоматическое обновление.
...
### -EnableAutoUpdate
Параметр Switch, чтобы включить автоматическое обновление.
...
### -InputObject
Объект для сопоставления контейнера защиты.
