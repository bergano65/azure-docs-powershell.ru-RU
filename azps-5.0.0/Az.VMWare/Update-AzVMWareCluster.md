...
### Пример 1: Обновление размера кластера по названию
```powershell
...
Обновление размера кластера по названию

### Пример 2: Обновление размера кластера по объекту ввода
```powershell
...
Обновление размера кластера по объекту ввода
...
### Microsoft. Azure. PowerShell. командлеты. VMWare. Models. Api20200320. ICluster
