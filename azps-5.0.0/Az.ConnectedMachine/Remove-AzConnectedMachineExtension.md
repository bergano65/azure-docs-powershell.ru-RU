...
### Пример 1: удаление расширения компьютера.
```powershell
PS C:\> Remove-AzConnectedMachineExtension -MachineName myMachine -ResourceGroupName myRG -Name custom

```

Удаляет расширение на компьютере.

### Пример 2: удаление расширения через конвейер
```powershell
PS C:\> Get-AzConnectedMachineExtension -ResourceGroupName contoso-connected-machines -MachineName myMachine | Remove-AzConnectedMachineExtension

```

Удаление всех расширений на указанном компьютере.
...
### -MachineName
Имя компьютера, на котором должно быть удалено расширение.
