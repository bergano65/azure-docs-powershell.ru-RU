...
## NОПИСАНИЕ
Командлет **Get-AzDataBoxEdgeStorageContainer** получает контейнер хранилища для учетной записи пограничного хранилища на пограничном устройстве поля данных. Вы можете указать имя в качестве параметра в командлете, чтобы получить сведения об определенном контейнере хранилища. 
