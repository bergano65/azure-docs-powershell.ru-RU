...
## NОПИСАНИЕ
Командлет **Get-AzDataBoxEdgeShare** получает доступные общие ресурсы для пограничного устройства поля данных. Если указано имя, будет получен общий доступ по имени.
