...
## NОПИСАНИЕ
Командлет **Update-AzSubscription** обновляет подписку на Azure
...
### -Action (действие)
Действие, которое нужно выполнить для подписки
...
### -SubscriptionId
Идентификатор подписки для обновления
