...
## КРАТКИй обзор
Создание нового псевдонима и подписки
...
## NОПИСАНИЕ
Командлет **New-AzSubscriptionAlias** создает новый псевдоним и подписку.
...
### -SubscriptionId
Идентификатор существующей подписки
