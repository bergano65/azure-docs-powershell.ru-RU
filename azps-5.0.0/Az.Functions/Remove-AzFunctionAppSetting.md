...
### Пример 1: удаление параметров приложения в приложении функции.
```powershell
...
Эта команда удаляет параметры приложения в приложении функции.

## ПАРАМЕТРЫ

### -AppSettingName
Список параметров приложения для функций, которые нужно удалить из приложения "функция".
...
### -Force
Принудительное удаление параметра функционального приложения командлетом без запроса подтверждения.
