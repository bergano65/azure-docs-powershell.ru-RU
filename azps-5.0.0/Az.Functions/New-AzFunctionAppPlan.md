...
### Пример 1: создание плана приложений для Windows Premium в Западной Европы с возможностью разбивки на 10 экземпляров.
```powershell
...
Эта команда создает план приложений для Windows Premium в Западной Европе с возможностью разбивки до 10 экземпляров.
