...
## NОПИСАНИЕ
Командлет **Stop-AzBatchCertificateDeletion** отменяет сбой при удалении сертификата в пакетной службе Azure.
Вы можете прекратить удаление только в том случае, если сертификат находится в состоянии **DeleteFailed** .
Этот командлет восстанавливает сертификат в **активном** состоянии.
