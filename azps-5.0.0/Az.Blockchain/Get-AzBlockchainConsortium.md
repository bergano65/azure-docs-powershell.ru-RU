...
### Пример 1: получение Blockchainных консорциумов.
```powershell
PS C:\> Get-AzBlockchainConsortium -Location eastus

```

Эта команда перечисляет консорциумы по подписке для определенного местоположения.
...
### Microsoft. Azure. PowerShell. командлеты. Blockchain. Models. Api20180601Preview. IConsortium
