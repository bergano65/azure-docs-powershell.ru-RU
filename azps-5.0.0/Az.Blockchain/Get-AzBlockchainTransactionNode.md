...
### Пример 1: список узлов транзакций для элемента blockchain
```powershell
...
Эта команда перечисляет узлы транзакций для элемента blockchain.

### Пример 2: получение узла транзакции
```powershell
...
### Пример 3: получение узла транзакции
```powershell
