...
### Пример 1: создание нового участника blockchain
```powershell
...
Эта команда создает новый элемент blockchain.
...
### -Consortium
Возвращает или задает консорциума для элемента blockchain.
...
Задает пароль учетной записи управляемого консорциума для управления.
...
Возвращает отображаемое имя элемента в консорциуме.
...
### -ConsortiumRole
Получает роль элемента в консорциуме.
...
### -FirewallRule
Возвращает или задает правила брандмауэра для создания свойств FIREWALLRULE и создания хэш-таблицы.
...
### -Location
Географическое расположение службы blockchain.
...
### -Password (пароль)
Задает основной пароль для проверки подлинности участника blockchain.
...
### -Protocol (протокол)
Возвращает или задает протокол blockchain.
...
### -SkuTier
Возвращает или задает уровень SKU.
...
### -Тег
Теги службы, представляющие собой список пар "ключ-значение", описывающих ресурс.
...
Возвращает или задает емкость узлов.
