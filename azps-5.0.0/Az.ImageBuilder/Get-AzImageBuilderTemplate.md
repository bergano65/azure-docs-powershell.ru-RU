...
### Пример 1: список всех шаблонов в рамках подписки
```powershell
...
В этой команде перечислены все шаблоны в рамках подписки.

### Пример 2: список всех шаблонов в группе ресурсов
```powershell
...
В этой команде перечислены все шаблоны в группе ресурсов.

### Пример 3: получение шаблона в группе ресурсов
```powershell
...
Эта команда получает шаблон в группе ресурсов.

### Пример 4: получение шаблона в группе ресурсов
```powershell
