...
### Пример 1: Проверка Dependecies перед запуском Move для ресурсов.
```powershell
...
Проверка Dependecies перед инициированием перемещения для ресурсов.

### Пример 2: initiate Move для набора ресурсов в коллекции Move с использованием "MoveResource Name" в качестве входных данных
```powershell
...
Инициация перемещения для набора ресурсов в коллекции Move с помощью "MoveResource Name" в качестве входных данных.

### Пример 3: Начало перемещения для набора ресурсов в коллекции Move с помощью "SourceARMID" в качестве входных данных
```powershell
...
Инициация перемещения для набора ресурсов в коллекции Move с использованием "SourceARMID" в качестве входных данных.
...
### -MoveResource
Возвращает или задает список идентификаторов ресурсов по умолчанию, который принимает идентификатор ресурса Move, если только тип ввода не переключается с помощью свойства moveResourceInputType.
...
Определяет тип ввода ресурсов перемещения.
...
### -ValidateOnly
Возвращает или задает значение, показывающее, требуется ли операции запуск только предварительных требований.
...
### Microsoft. Azure. PowerShell. командлеты. ResourceMover. Models. Api20191001Preview. IOperationStatus
