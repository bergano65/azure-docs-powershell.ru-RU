...
### Пример 1: получение сведений обо всех коллекциях перемещения в подписке
```powershell
...
Получение сведений обо всех коллекциях перемещения в подписке.

### Пример 2: получение сведений о коллекции Move с указанным именем коллекции для перемещения в подписке
```powershell
...
Получение подробных сведений о коллекции перемещения с указанным именем перемещения коллекции в подписке.

### Пример 3: получение сведений о коллекции Move с указанным именем группы ресурсов в подписке
```powershell
...
Получение сведений о коллекции Move с указанным именем группы ресурсов в подписке.
