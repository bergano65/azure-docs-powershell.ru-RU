...
### Пример 1: Проверка Dependecies перед тем, как подготовиться к ресурсам
```powershell
...
Проверьте Dependecies перед тем, как подготовиться к ресурсам.

### Пример 2: initiate подготовка для набора ресурсов в коллекции Move с помощью "MoveResource Name" в качестве входных данных
```powershell
...
Инициируйте подготовку к набору ресурсов в коллекции перемещения, используя в качестве входных данных "MoveResource Name".

### Пример 3: initiate подготовка для набора ресурсов в коллекции Move с помощью "SourceARMID"
```powershell
