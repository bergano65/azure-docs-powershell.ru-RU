...
## NОПИСАНИЕ
Командлет **Update-AzManagementGroup** обновляет **ParentID** или **DisplayName** для группы управления.

## ИЛЛЮСТРИРУЮТ

### Пример 1: обновление отображаемого имени группы управления
```
...
### Пример 2: обновление родительского элемента группы управления
```
...
### Пример 3: Обновление группы управления с помощью объекта трубопроводов PSManagementGroup
```
...
### Пример 4: обновление родительского элемента группы управления с помощью ParentObject
```
