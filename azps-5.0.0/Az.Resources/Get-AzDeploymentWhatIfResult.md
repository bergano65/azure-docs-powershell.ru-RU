...
Эта команда возвращает What-If результат в текущей области подписки с помощью настраиваемого файла шаблона и файла параметров на диске.
...
### Пример 2: получение результата What-If в области подписки с помощью ResourceIdOnly
```powershell
PS C:\> Get-AzDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
