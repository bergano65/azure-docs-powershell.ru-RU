...
## NОПИСАНИЕ
Командлет **Remove-AzPolicyDefinition** удаляет определение политики.
...
### -InputObject
Объект определения политики, который должен быть использован для удаления вывода из другого командлета.
...
### -SubscriptionId
Идентификатор подписки определения политики, которую нужно удалить.
