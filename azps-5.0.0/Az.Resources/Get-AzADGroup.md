...
### Пример 2: список всех групп рекламных объявлений с помощью разбиения по страницам
...
### Пример 3: получение группы рекламных объявлений по идентификатору объекта
