...
### -InputObject
Задает сервер репликации, для которого необходимо инициировать тестовую миграцию.
...
### -TestNetworkID
Обновление идентификатора виртуальной сети в конечной подписке Azure для использования при тестировании миграции.
...
INPUTOBJECT <IMigrationItem> : определяет сервер репликации, для которого необходимо инициировать тестовую миграцию. Объект сервера можно получить с помощью командлета Get-AzMigrateServerReplication.
