...
### Пример 1: получение всех поставщиков в хранилище
```powershell
...
### -ProviderName
Имя поставщика служб восстановления
...
### Microsoft. Azure. PowerShell. командлеты. remigrate. Models. Api20180110. IRecoveryServicesProvider
