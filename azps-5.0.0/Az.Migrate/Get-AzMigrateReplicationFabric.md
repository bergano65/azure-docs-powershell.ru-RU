...
### Пример 1: получение всех структур по группе ресурсов и имени хранилища
```powershell
...
Получение всех структур в группе ресурсов и в хранилище

### Пример 2: получение структуры по группе ресурсов, имени хранилища и имени структуры
```powershell
...
Получить определенную структуру
...
### Microsoft. Azure. PowerShell. командлеты. remigrate. Models. Api20180110. IFabric
