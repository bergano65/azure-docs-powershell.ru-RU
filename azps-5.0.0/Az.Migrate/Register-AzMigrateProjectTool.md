...
### Пример 1: регистрация инструмента.
```powershell
...
### -AcceptLanguage
Стандартный заголовок запроса.
Используется службой для ответа на клиента на нужном языке.
...
### -Инструмент
Возвращает или задает средство, которое нужно зарегистрировать.
