...
Перечислите все учетные записи запуска от имени на сайте.
...
Получить учетную запись запуска от имени.

## ПАРАМЕТРЫ

### -Имя_учетной_записи
Название учетной записи запуска от имени.
...
### Microsoft. Azure. PowerShell. командлеты. remigrate. Models. Api202001. IVMwareRunAsAccount
