...
Подготовьте миграцию решения проекта по имени.
...
### -MigrateProjectName
Имя проекта для миграции Azure.
...
### -Name (имя)
Уникальное имя решения для миграции в рамках миграции проекта.
...
### -ResourceGroupName
Имя группы ресурсов Azure, в состав которой входит переносимый проект.
...
### Microsoft. Azure. PowerShell. командлеты. remigrate. Models. Api20180901Preview. ISolution
