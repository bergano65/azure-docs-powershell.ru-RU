...
### Пример 1: список всех контейнеров защиты в хранилище и структуре
```powershell
...
### Microsoft. Azure. PowerShell. командлеты. remigrate. Models. Api20180110. IProtectionContainer
