...
## NОПИСАНИЕ
Командлет **Get-AzDataShareDataSetMapping** получает сведения о конкретном сопоставлении набора данных, если указано его имя. В противном случае он получает сведения обо всех сопоставлениях наборов данных в подписке на общий доступ. 
...
```
 ...
 Эта команда отображает сведения обо всех сопоставлениях наборов данных в подписке на общий доступ.
...
### -Name (имя)
Имя сопоставления для Set данных Azure.
...
### -ResourceId
Идентификатор ресурса для сопоставления набора данных Azure.
