...
Эта команда создает общий ресурс данных с именем AdsShare из CopyBased в учетной записи для общего доступа к данным, WikiAdsAccount в разделе Реклама в группах ресурсов, с описанием и условиями использования.
...
### -Описание
Описание общего доступа к данным Azure
...
### -TermsOfUse
Условия использования для общего доступа к данным Azure
