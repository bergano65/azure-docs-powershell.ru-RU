...
## NОПИСАНИЕ
Командлет **New-AzDataShareInvitation** отправляет приглашение целевому потребителю, используя сведения об общем доступе поставщика. 
...
Эта команда создает приглашение AdsInvitation для предоставления общего доступа к AdsShare и отправляет его в целевую почту adstest@microsoft.com .
...
### -TargetEmail
Идентификатор целевого объекта электронной почты
