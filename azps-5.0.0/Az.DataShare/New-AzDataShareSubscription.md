...
## NОПИСАНИЕ
Командлет **New-AzDataShareSubscription** создает подписку на общий доступ в указанной учетной записи данных и идентификаторе приглашения.
...
Эти команды создают новую подписку на общий доступ AdsShareSubscription для invitaionId в разделе Учетная запись общего доступа к данным WikiAds.
...
### -InvitationId
InvitationId общего доступа к данным Azure
...
### -SourceShareLocation
Расположение общего ресурса данных Azure
