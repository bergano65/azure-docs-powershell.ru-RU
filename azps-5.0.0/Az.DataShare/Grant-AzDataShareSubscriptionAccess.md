...
## NОПИСАНИЕ
Командлет **Grant-AzDataShareSubscriptionAccess** предоставляет доступ к подписке для общего доступа к исходной общей папке
...
Предоставление доступа к подписке, идентифицированной с помощью идентификатора 8ee6e6fd-b4a1-49a4-bb66-f187f38e0e12
