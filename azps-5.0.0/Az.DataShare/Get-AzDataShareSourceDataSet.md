...
## NОПИСАНИЕ
Командлет **Get-AzDataShareSourceDataSet** содержит сведения о наборах исходных данных в подписке "общий доступ". 
...
Возвращает наборы данных, доступные в исходном общем доступе.
