...
## КРАТКИй обзор
Возвращает конфигурацию внутреннего адреса подсистемы балансировки нагрузки. 
...
### Пример 1
### Пример 2: Новая конфигурация адреса подсистемы балансировки нагрузки со ссылкой на виртуальную сеть
```powershell
...
### -IpAddress
IP-адрес, который нужно добавить в пул серверной части
...
### -Name (имя)
Имя конфигурации серверного адреса
...
### -VirtualNetworkId
Виртуальная сеть, связанная с конфигурацией адресного сервера
