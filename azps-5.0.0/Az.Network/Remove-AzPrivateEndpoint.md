...
## NОПИСАНИЕ
Командлет **Remove-AzPrivateEndpoint** удаляет закрытую конечную точку. 
...
В этом примере удаляется частная конечная точка с именем MyPrivateEndpoint1.
...
### -ResourceGroupName
Имя группы ресурсов для частной конечной точки.
