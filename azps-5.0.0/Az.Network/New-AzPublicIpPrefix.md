...
## NОПИСАНИЕ
Командлет **New-AzPublicIpPrefix** создает префикс общедоступного IP-адреса.

## ИЛЛЮСТРИРУЮТ

### Пример 1: создание нового префикса общедоступного IP-адреса
```powershell
PS C:\> $publicIpPrefix = New-AzPublicIpPrefix -Name $prefixName -ResourceGroupName $rgName -PrefixLength 30
```

Эта команда создает новый ресурс префикса общедоступного IP-адреса. 
...
### -Location
Расположение префикса общедоступного IP-адреса.
...
### -SKU
Имя SKU префикса общедоступного IP-адреса.
