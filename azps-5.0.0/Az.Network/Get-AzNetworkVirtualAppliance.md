...
## КРАТКИй обзор
Получить или Просмотреть виртуальные сетевые устройства.
...
## NОПИСАНИЕ
Команды Get-AzNetworkVirtualAppliance выводят на экран сетевые устройства виртуальных устройств.
