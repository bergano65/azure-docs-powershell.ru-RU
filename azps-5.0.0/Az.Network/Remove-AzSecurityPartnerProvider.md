...
## NОПИСАНИЕ
Командлет **Remove-AzSecurityPartnerProvider** удаляет Azure SecurityPartnerProvider
...
### -ResourceId
Идентификатор ресурса securityPartnerProvider.
...
Объект ввода securityPartnerProvider.
