...
## NОПИСАНИЕ
Командлет **Get-Bastion** получает один или несколько Bastions в группе ресурсов или в subscritption.
...
### -ResourceId
Идентификатор ресурса Azure Bastion
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. Commands. Network.. PSBastion, Microsoft. Azure. PowerShell. командлеты. Network, Version = 1.13.0.0, культура = Neutral, PublicKeyToken = NULL]]
