...
## NОПИСАНИЕ
Командлет **Update-AzVirtualRouterPeer** обновляет одноранговый узел VirtualRouter до Azure VirtualRouter
...
### -ResourceId
Идентификатор однорангового ресурса виртуального маршрутизатора.
