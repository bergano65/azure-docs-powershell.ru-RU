...
## NОПИСАНИЕ
С помощью командлета **Update-AzP2sVpnGateway** можно обновить существующий P2SVpnGateway в разделе VirtualHub с новым VpnClientAddressPool или новым VpnServerConfiguration или изменить VpnGatewayScaleUnit.
...
Командлет **Update-AzP2sVpnGateway** позволяет обновлять существующий P2SVpnGateway в разделе VirtualHub с новым VpnClientAddressPool. Когда клиент сайта подключается к этому P2SVpnGateway, один из IP-адресов этого VpnClientAddressPool становится выделенным для этого клиента.

### Пример 2

Обновите существующий P2SVpnGateway в разделе VirtualHub для подключения к сайту. (автоматически сформированные)
...
Отключить флаг безопасности Интернета для этого подключения P2SVpnGateway
