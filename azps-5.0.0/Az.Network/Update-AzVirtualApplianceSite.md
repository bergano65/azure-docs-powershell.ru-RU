...
## КРАТКИй обзор
Изменение или изменение сайта виртуального устройства, подключенного к ресурсу сетевого виртуального устройства.
...
## NОПИСАНИЕ
Команда Update-AzVirtualApplianceSite изменяет ресурс сайта виртуального устройства.
...
Измените префикс адреса ресурса сайта виртуального устройства.
...
Сетевое устройство, к которому подключен этот сайт.
