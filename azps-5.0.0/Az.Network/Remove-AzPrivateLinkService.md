...
## NОПИСАНИЕ
Командлет **Remove-AzPrivateLinkService** Удаляет службу частной ссылки
...
В этом примере удаляется служба частной ссылки с именем TestPrivateLinkService.
...
### -ResourceGroupName
Имя группы ресурсов для службы частной ссылки.
