...
Сначала мы создаем объект маршрутизатора виртуального концентратора и используем его для создания ресурса таблицы виртуального маршрутизатора. Затем мы устанавливаем этот ресурс таблицы маршрутов на виртуальный концентратор с помощью команды "Set-AzVirtualHub".
...
### -RouteTable
Таблицы маршрутов, связанные с этим виртуальным концентратором.
