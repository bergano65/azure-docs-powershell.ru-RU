...
## NОПИСАНИЕ
Командлет New-AzRadiusServer создает конфигурацию внешнего сервера RADIUS для использования в конфигурации шлюза виртуальной сети и VPN-сервера.
...
Создание нескольких внешних конфигураций RADIUS-серверов, используемых для настройки P2S на новом шлюзе виртуальной сети.
...
### -RadiusServerScore
Оценка внешнего RADIUS-сервера
