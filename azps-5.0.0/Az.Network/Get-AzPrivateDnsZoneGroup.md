...
## NОПИСАНИЕ
Командлет **Get-AzPrivateDnsZoneGroup** получает одну или несколько закрытых групп зон DNS.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение конфиденциальной группы зон DNS
```powershell
...
В приведенном выше примере вы возвращаете зону частной зоны DNS с именем dnsgroup1 в группе ресурсов RG.
