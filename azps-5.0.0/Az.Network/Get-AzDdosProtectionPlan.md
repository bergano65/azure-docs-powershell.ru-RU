...
## NОПИСАНИЕ
Командлет Get-AzDdosProtectionPlan получает план защиты Distributed.
...
### Пример 3: получение всех планов защиты Distributed в подписке
```
...
### Пример 4: получение всех планов защиты Distributed в подписке
```
...
Этот командлет возвращает все DdosProtectionPlans, которые начинаются с "Test".
