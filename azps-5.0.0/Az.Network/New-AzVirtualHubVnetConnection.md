...
```
В описанном выше примере будет создана новая настройка маршрутизации и в конфигурации маршрутизации будут создаваться статические маршруты с помощью следующего прыжка в качестве указанного IP-адреса. Эту конфигурацию маршрутизации затем можно передать в команду New-AzVirtualHubVnetConnection в качестве параметра-RoutingConfiguration.
