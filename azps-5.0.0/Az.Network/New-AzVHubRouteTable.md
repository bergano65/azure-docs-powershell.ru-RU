...
## КРАТКИй обзор
Создает ресурс таблицы узлового маршрута, связанный с VirtualHub.
...
## NОПИСАНИЕ
Создает указанную таблицу маршрутов, связанную с указанным виртуальным концентратором, с предоставленными маршрутами и метками.
...
Эта команда создает таблицу маршрутов Hub виртуального концентратора.
