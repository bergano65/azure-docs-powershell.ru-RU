...
## NОПИСАНИЕ
Командлет **Set-AzLoadBalancerProbeConfig** обновляет конфигурацию пробной версии для подсистемы балансировки нагрузки.
...
Вторая команда использует оператор Pipeline для передачи балансировщика нагрузки в $slb на Add-AzLoadBalancerProbeConfig, который добавляет в нее новую конфигурацию зонда.
Третья команда передает подсистему балансировки нагрузки в **Set-AzLoadBalancerProbeConfig** , задающую новую конфигурацию.
...
Этот командлет обновляет конфигурацию пробной версии для подсистемы балансировки нагрузки, которую указывает этот параметр.
