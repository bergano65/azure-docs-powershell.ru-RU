...
## NОПИСАНИЕ
Командлет **Get-AzVpnServerConfiguration** возвращает существующий VpnServerConfiguration для подключения к сайту.
...
В приведенной выше команде будет получено существующее VpnServerConfiguration.
