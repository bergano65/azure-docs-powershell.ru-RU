...
## NОПИСАНИЕ
Командлет **Set-AzFirewallPolicyRuleCollectionGroup** обновляет группы коллекций правил в политике брандмауэра Azure.
...
Этот пример обновляет группу коллекции правил в политике брандмауэра $fp

### Пример 2

Сохранение измененной группы набора правил политики брандмауэра Azure. (автоматически сформированные)
