...
## КРАТКИй обзор
Маршруты списка, объявляемые определенным одноранговым узлом виртуального маршрутизатора
...
## NОПИСАНИЕ
С помощью виртуального маршрутизатора, вызываемого по имени или объекту, перечислите маршруты, объявляемые этому одноранговому узлу, с помощью определенного виртуального маршрутизатора.
