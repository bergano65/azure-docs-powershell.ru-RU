...
## NОПИСАНИЕ
Командлет **Set-AzPrivateDnsZoneGroup** обновляет группу зоны DNS.
...
В приведенном выше примере в группу зон DNS с именем dnsgroup1 будет указана новая версия для ссылки на другую зону DNS.
