...
## КРАТКИй обзор
Удаление ресурса таблицы узлового маршрута, связанного с VirtualHub.

## Максимальное

### ByVHubRouteTableName (по умолчанию)
```powershell
...
## NОПИСАНИЕ
Обновляет указанную таблицу маршрутов, связанную с указанным виртуальным концентратором, с предоставленными маршрутами или наклейками.
...
Эта команда удаляет таблицу "разветвитель маршрута" виртуального концентратора.
...
### -InputObject
Ресурс vhubroutetable, который нужно обновить.
...
### -ParentObject
Родительский объект виртуального концентратора для этого ресурса.
...
### -ResourceId
Идентификатор ресурса для ресурса vhubroutetable, который нужно обновить.
