...
## NОПИСАНИЕ
Командлет **New-AzApplicationGatewayRewriteRuleSet** создает набор правил перезаписи для шлюза приложений Azure.
...
Эта команда создает набор правил перезаписи с именем ruleset1 и сохраняет результат в переменной с именем $ruleset.
