...
## NОПИСАНИЕ
Создает ресурс Bastion. Для этого вам понадобятся общедоступные IP-адреса и VirtualNetwork. В этом VirtualNetwork должна быть подсеть с именем AzureBastionSubnet. IP-адрес pubic должен быть создан с использованием стандартного SKU.
...
### -PublicIpAddress
Объект общедоступного IP-адреса для Bastion.
...
### -PublicIpAddressId
Идентификатор ресурса Azure общедоступного IP-адреса для Bastion.
...
### -PublicIpAddressName
Имя ресурса общедоступного IP-адреса для Bastion.
...
Имя группы ресурсов "общедоступный IP-адрес" для Bastion.
...
### -ResourceGroupName
Имя группы ресурсов, в которой необходимо создать Bastion.
...
### -VirtualNetwork
Объект виртуальной сети для Bastion.
...
### -VirtualNetworkId
Идентификатор ресурса Azure виртуальной сети для Bastion.
...
### -VirtualNetworkName
Имя ресурса виртуальной сети для Bastion.
...
Имя группы ресурсов виртуальной сети для Bastion.
