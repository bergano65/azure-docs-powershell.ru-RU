...
## NОПИСАНИЕ
Удаляет указанную таблицу маршрутов Hub, связанную с указанным виртуальным концентратором.
...
### -InputObject
Ресурс vhubroutetable, который нужно удалить.
...
### -ResourceId
Идентификатор ресурса для ресурса vhubroutetable, который нужно удалить.
