...
## NОПИСАНИЕ
Командлет **Get-AzFirewall** получает один или несколько брандмауэров в группе ресурсов.
...
### 3. получение всех брандмауэров с фильтрацией
```
...
В этом примере извлекаются все брандмауэры, которые начинаются с "azFw".

### 4. получение доступа к брандмауэру и Добавление набора правил приложения в брандмауэр
```
...
### 5. Извлеките брандмауэр и добавьте в брандмауэр коллекцию сетевых правил.
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 6. получение доступа к брандмауэру и получение набора правил приложения по имени из брандмауэра
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 7. получение брандмауэра и получение из него коллекции сетевых правил по имени.
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 8. получение брандмауэра и удаление набора правил приложения по имени из брандмауэра
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 9. Извлеките брандмауэр и удалите из него коллекцию сетевых правил по имени.
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 10: получение брандмауэра и его выделение
```
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. Commands. Network.. PSAzureFirewall, Microsoft. Azure. PowerShell. командлеты. Network, Version = 1.0.0.0, культура = независимая, PublicKeyToken = NULL]]
