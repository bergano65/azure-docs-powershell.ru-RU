...
## КРАТКИй обзор
Создание элемента области с областью конечной точки монитора подключений.
...
## NОПИСАНИЕ
Командлет New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject создает элемент области действия конечной точки.
