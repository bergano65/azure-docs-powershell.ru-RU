...
В примере выше будет создана группа ресурсов, Виртуальная глобальная сеть в Восточной США в группе ресурсов "nonlinkSite" в Azure. 

Затем он создает VpnSite для представления ветви клиента и связывает ее с виртуальной глобальной сетью.

Подключение IPSec можно настроить с помощью этой ветви и VpnGateway, используя команду "New-AzVpnConnection".
...
В описанном выше примере вы создадите группу ресурсов, виртуальную глобальную сеть и VpnSite с 1 VpnSiteLinks в группе ресурсов "многоканальная связь" в Azure.

### Пример 3

Создание нового ресурса Azure VpnSite. (автоматически сформированные)
