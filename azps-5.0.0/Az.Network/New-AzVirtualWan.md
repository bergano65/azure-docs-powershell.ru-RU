...
## NОПИСАНИЕ
Создание нового ресурса Azure VirtualWAN.
...
В описанном выше примере создается группа ресурсов "testRG" в регионе "Западная часть США" и Виртуальная глобальная сеть Azure с разделом трафика для филиалов, разрешенных в этой группе ресурсов в Azure.

## ПАРАМЕТРЫ

### -AllowBranchToBranchTraffic
Разрешить переход к трафику ветвления для VirtualWan.
...
Разрешите трафик vnet на виртуальную сеть для VirtualWan.
...
### -VirtualWANType
Тип виртуальной глобальной сети.
