...
## NОПИСАНИЕ
Командлет **New-AzExpressRoutePort** создает Azure ExpressRoutePort
...
### -BandwidthInGbps
Пропускная способность приобретенных портов в Гбит/с
...
### -Инкапсуляция
Метод инкапсуляции на физических портах.
...
### -Identity
Идентификационные данные, назначенные пользователю для чтения MacSec конфигурации
...
### -Link
Набор физических ссылок на ресурс ExpressRoutePort
...
### -PeeringLocation
Имя расположения пиринга, которое физически сопоставлено ExpressRoutePort.
