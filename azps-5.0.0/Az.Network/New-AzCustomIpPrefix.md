...
## NОПИСАНИЕ
Командлет **New-AzCustomIpPrefix** создает ресурс CustomIpPrefix.
...
Эта команда создает новый ресурс CustomIpPrefix с именем $prefixName в группе ресурсов $rgName с CIDR 40.40.40.0/24 в westus
