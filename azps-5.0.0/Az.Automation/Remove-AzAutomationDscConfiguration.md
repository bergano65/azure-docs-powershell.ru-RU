...
## NОПИСАНИЕ
Командлет **Remove-AzAutomationDscConfiguration** удаляет из Azure Automation параметры необходимой конфигурации состояния (DSC).

## ИЛЛЮСТРИРУЮТ

### Пример 1

Удаляет конфигурации DSC из автоматизации. (автоматически сформированные)
...
Указывает имя учетной записи автоматизации, которая содержит конфигурации DSC, которые удаляются этим командлетом.
...
### -Name (имя)
Указывает имя конфигурации DSC, которую удаляет этот командлет.
