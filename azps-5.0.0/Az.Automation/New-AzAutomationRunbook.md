...
## NОПИСАНИЕ
Командлет **New-AzAutomationRunbook** создает пустой Runbook службы автоматизации Azure с помощью ТД.
...
Создает Runbook автоматизации. (автоматически сформированные)
...
- Виде
- Python2 значение графика устарело.
