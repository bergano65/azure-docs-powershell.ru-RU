...
## NОПИСАНИЕ
Командлет **Get-AzStackEdgeUser** содержит список пользователей, настроенных для пограничного устройства в стопке. Вы можете упомянуть имя в параметрах, чтобы получить сведения о конкретном пользователе.
