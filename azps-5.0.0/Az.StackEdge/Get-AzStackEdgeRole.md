...
## NОПИСАНИЕ
Командлет **Get-AzStackEdgeRole** извлекает доступные роли IOT для краевого устройства стека. Вы можете упомянуть о параметре name, чтобы получить сведения о конкретной роли Интернета вещей.
