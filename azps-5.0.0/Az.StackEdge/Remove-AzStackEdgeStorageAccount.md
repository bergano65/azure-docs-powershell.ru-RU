...
## NОПИСАНИЕ
Командлет **Remove-AzStackEdgeStorageAccount** Удаляет связанную учетную запись хранилища для краевого устройства стека. Вы можете указать имя учетной записи хранения EDGE, которую нужно удалить как параметр в командлете.
