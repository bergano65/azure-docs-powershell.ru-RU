...
## КРАТКИй обзор
Возвращает свойства пропускной способности CosmosDB для базы данных MongoDB.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBMongoDBDatabaseThroughput** получает свойства пропускной способности базы данных MongoDB.
