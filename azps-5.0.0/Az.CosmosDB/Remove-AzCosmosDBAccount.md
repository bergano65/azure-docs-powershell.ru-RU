...
## NОПИСАНИЕ
Удаление учетной записи CosmosDB с указанным именем в заданной группе ресурсов.
...
Учетная запись с именем учетной записи dbname в группе ResourceGroup RG удаляется. 
...
### -InputObject
Объект учетной записи базы данных
