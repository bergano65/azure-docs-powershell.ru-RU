...
## КРАТКИй обзор
Возвращает пропускную способность CosmosDB базы данных Gremlin.
...
## NОПИСАНИЕ
Командлет **Get-AzCosmosDBGremlinDatabaseThroughput** возвращает пропускную способность базы данных CosmosDB Gremlin.
