...
## КРАТКИй обзор
Создает новый ключ кластера CosmosDB Cassandra.
...
## NОПИСАНИЕ
**New-AzCosmosDBCassandraClusterKey** создает новый ключ кластера CosmosDB Cassandra.
...
### -OrderBy
Упорядочение ключа кластера Cassandra.
