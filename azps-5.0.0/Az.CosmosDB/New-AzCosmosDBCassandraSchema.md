...
## КРАТКИй обзор
Создание новой схемы CosmosDB Cassandra.
...
## NОПИСАНИЕ
**New-AzCosmosDBCassandraSchema** создает новую схему CosmosDB Cassandra.
...
### -PartitionKey
Массив строк, содержащий ключи секционирования.
