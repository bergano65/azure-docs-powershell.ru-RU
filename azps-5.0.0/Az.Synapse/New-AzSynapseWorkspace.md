...
## NОПИСАНИЕ
Командлет **New-AzSynapseWorkspace** создает рабочую область Azure Synapse Analytics.
...
Эта команда создает рабочую область аналитики Synapse с именем ContosoWorkspace, которая использует хранилище данных ContosoAdlGenStorage, в группе ресурсов с именем ContosoResourceGroup.
...
Файловая система по умолчанию ADLS Gen2.
...
### -Location
Регион Azure, в котором нужно создать ресурс.
...
Имя Synapse-управляемой виртуальной сети, выделенной для рабочей области Synapse Azure.
...
Учетные данные администратора SQL.
