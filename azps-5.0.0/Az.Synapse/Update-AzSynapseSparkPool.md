...
## NОПИСАНИЕ
Командлет **Update-AzSynapseSparkPool** обновляет пул Azure Synapse Analytics Spark.
...
Эта команда обновляет пул Azure Synapse Analytics Spark.
...
Эта команда обновляет пул Azure Synapse Analytics Spark с помощью конвейера.
...
Эта команда обновляет пул Azure Synapse Analytics Spark с ИД ресурса.
...
Эта команда включает автоматическое масштабирование для пула Azure Synapse Analytics Spark.
...
Эта команда отключает автоматическое масштабирование для пула Azure Synapse Analytics Spark.
...
Эта команда включает функцию автоматического приостановки для пула Azure Synapse Analytics Spark.
...
Эта команда отключает функцию автоматического приостановки для пула Azure Synapse Analytics Spark.
...
Количество минут бездействия. Этот параметр должен быть указан, если включена функция приостановки.
...
Максимальное количество узлов, которые должны быть выделены в указанном пуле Spark.
Этот параметр должен быть указан, если включено автоматическое масштабирование.
...
Минимальное количество узлов, которые должны быть выделены в указанном пуле Spark.
Этот параметр должен быть указан, если включено автоматическое масштабирование.
...
### -EnableAutoPause
Указывает, следует ли включить функцию автоматического приостановки.
...
Файл конфигурации среды (выводится сообщение "закрепить от PIP").
...
### -NodeCount
Количество узлов, которые должны быть выделены в указанном пуле Spark.
...
### -NodeSize
Количество ядер и памяти, которые будут использоваться для узлов, выделенных в указанном пуле Spark.
Этот параметр должен быть указан, если отключено автоматическое масштабирование
...
### -ResourceId
Идентификатор ресурса для пула Spark Synapse.
