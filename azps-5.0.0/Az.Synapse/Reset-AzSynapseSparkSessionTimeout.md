...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseSparkSessionTimeout** сбрасывает время ожидания сеанса службы Synapse Analytics.
...
Эта команда сбрасывает время ожидания сеанса Synapse Analytics Spark с указанным ИДЕНТИФИКАТОРом Livy.
...
Эта команда сбрасывает время ожидания сеанса Synapse Analytics Spark с указанным ИДЕНТИФИКАТОРом Livy с помощью конвейера.
