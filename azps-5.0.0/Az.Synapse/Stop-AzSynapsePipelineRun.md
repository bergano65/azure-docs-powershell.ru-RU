...
## NОПИСАНИЕ
Командлет **Stop-AzSynapsePipelineRun** останавливает выполнение конвейера в рабочей области, ЗАданной идентификатором запуска конвейера.
...
Эта команда останавливает конвейер с ИД b9730a13-AA12-4926-a8b3-8e3a974ab0bd в рабочей области ContosoWorkspace.
...
Эта команда останавливает процесс конвейера с идентификатором b9730a13-AA12-4926-a8b3-8e3a974ab0bd в рабочей области ContosoWorkspace с помощью конвейера.
