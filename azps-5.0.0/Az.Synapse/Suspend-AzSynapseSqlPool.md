...
## КРАТКИй обзор
Приостанавливает использование пула SQL Analytics Synapse.
...
## NОПИСАНИЕ
Командлет **Suspend-AzSynapseSqlPool** приостанавливает работу пула Azure SYNAPSE Analytics SQL.
...
Эта команда приостанавливает активный пул SQL Azure Synapse Analytics.
