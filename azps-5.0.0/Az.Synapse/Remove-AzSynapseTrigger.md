...
## NОПИСАНИЕ
Командлет **Remove-AzSynapseTrigger** удаляет триггер из рабочей области.
...
Удалите триггер с именем ContosoTrigger из рабочей области ContosoWorkspace.
...
Удалите триггер с именем ContosoTrigger из рабочей области ContosoWorkspace с помощью конвейера.
