...
## КРАТКИй обзор
Извлекает различные точки восстановления, из которых может быть восстановлен пул SQL Analytics Synapse.
...
## NОПИСАНИЕ
Командлет **Get-AzSynapseSqlPoolRestorePoint** извлекает отдельные точки восстановления, из которых может быть восстановлен пул SQL Azure Synapse Analytics.
...
Эта команда возвращает все доступные точки восстановления для пула SQL Azure Synapse Analytics с именем ContosoSqlPool.
