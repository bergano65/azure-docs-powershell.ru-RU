...
## КРАТКИй обзор
Возобновление пула SQL Analytics Synapse.

## Максимальное

### ResumeByNameParameterSet (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет **Resume-AzSynapseSqlPool** возобновляет работу пула SQL Azure Synapse Analytics.
...
Эта команда возобновляет приостановленный пул SQL Azure Synapse Analytics.
