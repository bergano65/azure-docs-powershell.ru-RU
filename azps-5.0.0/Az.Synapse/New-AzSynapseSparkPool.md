...
Эта команда создает пул Azure Synapse Analytics Spark.
...
Эта команда создает пул Azure Synapse Analytics Spark с включенной функцией автоматического масштабирования.
...
Эта команда создает пул Azure Synapse Analytics Spark через конвейер.
...
Эта команда создает пул Azure Synapse Analytics Spark с включенным автоматическим масштабированием через конвейер.
