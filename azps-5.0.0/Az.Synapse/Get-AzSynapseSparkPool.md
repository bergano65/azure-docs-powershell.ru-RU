...
## NОПИСАНИЕ
Командлет **Get-AzSynapseSparkPool** получает сведения о пуле Azure Synapse Analytics Spark.
...
Эта команда получает список всех пулов Spark в рабочей области.
...
Эта команда получает пул Spark из рабочей области ContosoWorkspace с именем ContosoSparkPool.
...
Эта команда получает доступ ко всем пулам Spark из рабочей области с помощью конвейера.
...
Эта команда получает пул Spark с указанным ИДЕНТИФИКАТОРом ресурса.
