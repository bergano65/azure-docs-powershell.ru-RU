...
## NОПИСАНИЕ
Командлет **Get-AzSynapseSparkSession** получает сведения о сеансе Azure Synapse Analytics Spark.
...
Эта команда получает все сеансы Spark из указанного пула Spark.
...
Эта команда получает сеанс Spark с указанным ИДЕНТИФИКАТОРом Livy.
...
Эта команда получает все сеансы Spark из указанного пула Spark с помощью конвейера.
