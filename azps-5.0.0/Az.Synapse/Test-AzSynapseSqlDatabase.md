...
## КРАТКИй обзор
Проверка существования базы данных SQL Analytics Synapse.
...
## NОПИСАНИЕ
Командлет **Test-AzSynapseSqlDatabase** проверяет наличие базы данных SQL Analytics Synapse.
...
Эта команда проверяет существование указанной базы данных SQL.
