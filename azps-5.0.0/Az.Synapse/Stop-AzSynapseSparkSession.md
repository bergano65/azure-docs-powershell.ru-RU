...
## NОПИСАНИЕ
Командлет **Stop-AzSynapseSparkSession** останавливает сеанс Synapse Analytics Spark.
...
Эта команда останавливает сеанс Synapse Analytics Spark.
...
Эта команда останавливает сеанс Synapse Analytics Spark с помощью конвейера.
