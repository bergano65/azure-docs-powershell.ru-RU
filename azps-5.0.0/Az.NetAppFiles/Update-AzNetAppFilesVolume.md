...
## NОПИСАНИЕ
Командлет **Update-AzNetAppFilesVolume** ОБНОВЛЯЕТ том ANF.
...
Эта команда обновляет ANF Volume "MyAnfVolume" с новым размером UsageThreshold.
...
### -PoolObject
Объект пула, содержащий том, который нужно обновить.
