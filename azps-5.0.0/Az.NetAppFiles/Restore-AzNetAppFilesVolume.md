...
## КРАТКИй обзор
Восстановление или возврат тома в один из его снимков
...
## NОПИСАНИЕ
Восстановление или возврат тома в снимок, указанный в SnapshotId
...
Эта команда восстанавливает и возвращает MyVolume тома на один из его снимков с помощью snapshotId из 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -PassThru
Возвращает значение, показывающее, успешно восстановлен или отменен указанный том
...
### -SnapshotId
SnapshotId снимка.
Идентификатор UUID V4 используется для идентификации снимка
