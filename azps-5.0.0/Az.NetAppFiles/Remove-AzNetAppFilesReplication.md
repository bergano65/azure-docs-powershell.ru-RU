...
Эта команда удаляет подключение репликации ANF на томе "MyDestinationAnfVolume".
...
### -InputObject
Конечный том ANF с удаляемой репликацией
...
### -PassThru
Возвращает значение, указывающее, успешно ли удалена указанная репликация ANF
