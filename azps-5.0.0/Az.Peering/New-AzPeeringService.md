...
Создает объект службы пиринга с расположением поставщика и пиринга. Использование в conjuction с `Get-AzPeeringServiceProvider` и `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Физическое расположение отличается от региона Azure. Использование Get-AzPeeringServiceLocation [-Country <country> ]
...
Имя поставщика услуг пиринга.
Использование Get-AzPeeringServiceProvider командлета для списка
...
### -Тег
Теги, связываемые со службой Microsoft InputObject.
