...
### -MicrosoftNetwork
Выберите сеть Microsoft, с которой вы хотите добавить коллегу.
...
Используйте Get-AzPeeringLocation, чтобы \<kind\> использовать название города в качестве ключа.
