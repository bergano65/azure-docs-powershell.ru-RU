...
## NОПИСАНИЕ
Perminently удалить ресурс пиринга.
...
Удаление однорангового соединения по идентификатору ресурса.
...
### -InputObject
Чтобы получить этот объект, используйте Get-AzPeering.
...
### -PassThru
Возвращает значение истина, если завершено
