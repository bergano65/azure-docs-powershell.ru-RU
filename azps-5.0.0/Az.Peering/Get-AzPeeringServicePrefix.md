...
## NОПИСАНИЕ
Список префиксов службы пиринга для объектов службы пиринга
...
Получает префиксы для службы пиринга на основе команд трубопроводов.
...
Получает определенный префикс для службы пиринга по идентификатору ресурса.
...
Возвращает определенный префикс для службы пиринга с развернутыми атрибутами.
...
### -Expand
Просмотр событий для префикса службы пиринга
...
### -PeeringServiceName
Имя службы пиринга. Используйте New-AzPeeringService командлет для новой службы пиринга или Get-AzPeeringService для списка.
...
Использование Get-AzPeeringService
