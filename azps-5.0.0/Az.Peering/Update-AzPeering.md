...
## NОПИСАНИЕ
Задает объект PSPeering

## ИЛЛЮСТРИРУЮТ

### Обновить ключ проверки подлинности Md5
```powershell
...
Задает ключ проверки подлинности Md5

### Обновить UseForPeeringService
```powershell
...
Задает флаг службы "использовать для пиринга"

### Обновление IPv4-адреса для пиринга Exchange
```powershell
...
Задает IPv4-адрес для пиринга Exchange с использованием ResourceId.
...
### -DirectConnection
Создайте новые прямые подключения с помощью New-AzDirectPeeringConnectionObject и канала к этой команде.
...
### -ExchangeConnection
Создайте новое подключение Exchange с помощью New-AzExchangePeeringConnectionObject и канала к этой команде.
