...
Получение и перечисление связанной службы для рабочей области

### [Get-AzOperationalInsightsLinkedStorageAccount](Get-AzOperationalInsightsLinkedStorageAccount.md)
Получение или перечисление связанной учетной записи хранения
...
Несвязанная служба для рабочей области
