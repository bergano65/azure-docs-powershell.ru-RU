...
### Пример 1: список всех правил виртуальных сетей в указанном сервере PostgreSql
```powershell
...
Этот командлет перечисление всех правил виртуальных сетей в указанном сервере PostgreSql.

### Пример 2: получение правила виртуальной сети по имени
```powershell
...
Этот командлет получает правило виртуальной сети по имени.

### Пример 3: получение правила для виртуальной сети по удостоверению
```powershell
...
Этот командлет получает правило виртуальной сети по удостоверению.
...
### Microsoft. Azure. PowerShell. командлеты. PostgreSql. Models. Api20171201. IVirtualNetworkRule
