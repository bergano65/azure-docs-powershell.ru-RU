...
### Пример 1: обновление сервера PostgreSql по группе ресурсов и имени сервера
```powershell
...
### Пример 2: обновление сервера PostgreSql по идентификатору.
```powershell
...
Этот командлет обновляет сервер PostgreSql по идентификатору.
