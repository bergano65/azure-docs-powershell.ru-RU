...
### UpdateBlueprintBySubscription (по умолчанию)
```
...
## NОПИСАНИЕ
Обновите определение чертежа и сохраните его в указанной подписке или группе управления.
...
Обновление определения схемы с использованием новых параметров.
