...
## NОПИСАНИЕ
Получение одного или нескольких определений чертежей. Определения чертежей находятся в области группы управления или подписки.
...
Получение определений чертежей в текущей подписке и иерархии групп управления для подписки.
...
Получение определений чертежей в заданной группе управления.
...
Получение определений чертежей в указанной подписке и иерархии групп управления для подписки.
...
Получение определения плана с заданным именем в указанной подписке.
...
Получение определения чертежа с заданным именем и версией в указанной группе управления.
...
Получение последнего опубликованного определения чертежа с заданным именем в указанной группе управления.
...
### -LatestPublished
Последний опубликованный флаг определения чертежей.
Если этот параметр установлен, выполнение возвращает последнюю опубликованную версию определения чертежа.
...
### -ManagementGroupId
Идентификатор группы управления, в которой хранится определение чертежа.
...
### -SubscriptionId
Идентификатор подписки, в которой сохраняется определение.
...
### -Version
Версия определений опубликованных чертежей.
