...
### Пример 1: список по подписке или группе ресурсов
```powershell
...
### Пример 2: получение с помощью имени правила
```powershell
...
### Пример 3: получение с помощью идентификатора ресурса
```powershell
