...
## NОПИСАНИЕ
Командлет **Get-AzAutoscaleSetting** получает все параметры автомасштабирования, связанные с группой ресурсов или с указанным параметром автомасштабирования.
