...
## NОПИСАНИЕ
Обновляет правило оповещения в журнале, переключая семантику.
...
### Пример 2: Настройка с помощью объекта ввода
```powershell
...
### Пример 3: Настройка по идентификатору ресурса
```powershell
...
### -Action (действие)
Действие предупреждения запланированного правила запроса
...
### -Location
Расположение для этого оповещения.
...
### -Планирование
Запланированное расписание для правила запроса
...
### -Source (источник)
Запланированный источник правил запроса
