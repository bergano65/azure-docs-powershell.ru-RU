...
Получает назначение регистрации по имени без сведений о определении регистрации.
...
Возвращает назначение регистрации по имени с подробными сведениями об определении регистрации.
