...
Получает определения всех регистраций в области по умолчанию.
...
Получает определение регистрации по имени в области по умолчанию.
...
### -Scope
Область, в которой создано определение регистрации.
