...
Создает назначение регистрации в области по умолчанию, используя идентификатор определения регистрации.
...
Создает назначение регистрации с объектом определения регистрации в качестве входных данных.
...
Обновляет назначение регистрации с помощью идентификатора определения регистрации и имени.
...
### -Name (имя)
Уникальное имя назначения регистрации.
...
Полный идентификатор ресурса для определения регистрации.
