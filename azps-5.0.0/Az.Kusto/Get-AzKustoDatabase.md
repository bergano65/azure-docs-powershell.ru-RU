...
### Пример 1: список всех баз данных Kusto в кластере по имени
```powershell
...
### Пример 2: получение определенной базы данных Kusto по имени
```powershell
...
Вышеприведенная команда возвращает базу данных Kusto с именем "mykustodatabase" в кластере "testnewkustocluster", которая находится в группе ресурсов "testrg".
