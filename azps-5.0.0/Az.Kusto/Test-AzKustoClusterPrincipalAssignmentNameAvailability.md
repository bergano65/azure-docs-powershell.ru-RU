...
### Пример 1: Проверка доступности имени кластера, используемого principalassignment
```powershell
...
Указанная выше команда возвращает значение, указывающее, существует ли PrincipalAssignment с именем "MyPrincipal" в кластере "testnewkustocluster".

### Пример 2: Проверка доступности неиспользуемого principalassignmentного имени кластера
```powershell
...
Указанная выше команда возвращает значение, указывающее, существует ли PrincipalAssignment с именем "newprincipal" в кластере "testnewkustocluster".
...
### -Type (тип)
Тип ресурсов, Microsoft. Kusto/Clusters/principalAssignments.
