...
### Пример 1: создание нового AttachedDatabaseConfiguration
```powershell
...
Вышеприведенная команда создает базу данных ReadOnly "mykustodatabase" в Cluster "testnewkustoclusterf".
Оно следует за базой данных "mykustodatabase" из кластера "testnewkustocluster"
...
### -ClusterResourceId
Идентификатор ресурса кластера, на котором находятся базы данных, которые вы хотите прикрепить.
...
### -DatabaseName
Имя базы данных, которую вы хотите прикрепить, используйте *, если вы хотите подписаться на все текущие и будущие базы данных.
...
Изменение типов участников по умолчанию
