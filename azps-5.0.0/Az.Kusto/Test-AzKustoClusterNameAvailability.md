...
Указанная выше команда возвращает значение, указывающее, существует ли кластер Kusto с именем "testnewkustocluster" в регионе "Восток США".
...
Указанная выше команда возвращает значение, указывающее, существует ли кластер Kusto с именем "availablekustocluster" в регионе "Восток США".
...
### -Type (тип)
Тип ресурсов (Microsoft. Kusto/Clusters).
