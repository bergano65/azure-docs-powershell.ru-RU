...
### Пример 1: список всех отслеживаемых баз данных
```powershell
...
В приведенной выше команде перечислены все базы данных, которыми владеет этот кластер, и они следуют другим кластером.
...
### Microsoft. Azure. PowerShell. командлеты. Kusto. Models. Api20200614. IFollowerDatabaseDefinition
