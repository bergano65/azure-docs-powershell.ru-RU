...
### Пример 1: список участников базы данных, указанных в кластере и базе данных Kusto
```powershell
...
Вышеприведенная команда возвращает список участников базы данных, указанных в кластере и базе данных Kusto.
