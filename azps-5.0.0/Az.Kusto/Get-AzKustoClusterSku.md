...
### Пример 1: список подходящих конфигураций
```powershell
...
В приведенной выше команде перечислены доступные SKU.

### Пример 2: список подходящих конфигураций для определенного кластера
```powershell
...
В приведенной выше команде перечислены доступные SKU для определенного кластера
...
### Microsoft. Azure. PowerShell. командлеты. Kusto. Models. Api20200614. IAzureResourceSku

### Microsoft. Azure. PowerShell. командлеты. Kusto. Models. Api20200614. ISkuDescription
