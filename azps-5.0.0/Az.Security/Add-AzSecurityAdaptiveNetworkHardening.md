...
## КРАТКИй обзор
Применяет заданные правила для NSG (ов), перечисленных в запросе
...
## NОПИСАНИЕ
Адаптивные ограничения сети автоматически рассчитываются центром безопасности Azure, используйте этот командлет для принудительного применения заданных правил на NSG (-ов), перечисленных в запросе.
...
Имя адаптивного ресурса усиления защиты сети.
...
### -Правила
Правила для принудительного применения.
...
Идентификаторы ресурсов Azure для эффективных сетевых групп безопасности, которые будут обновляться с учетом созданных правил безопасности из адаптивных правил защиты сети.
