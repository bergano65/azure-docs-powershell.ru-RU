...
## NОПИСАНИЕ
Командлет Get-AzIotSecurityAnalyticsAggregatedAlert возвращает один или несколько обобщенных рекомендаций на устройствах центра Интернета вещей. Имя агрегатной рекомендации — ее тип
...
Получение обобщенной рекомендации "IoT_OpenPorts" в решении для безопасности "MySolution" и "MyResourceGroup"
...
Получение списка обобщенных рекомендаций в решениях для обеспечения безопасности "MySolution" и "Группа ресурсов" MyResourceGroup "
