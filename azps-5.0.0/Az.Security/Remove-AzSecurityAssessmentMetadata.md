...
## КРАТКИй обзор
Удаление метаданных оценки безопасности из подписки.
...
## NОПИСАНИЕ
Удаление метаданных оценки безопасности из подписки. Это действие удалит тип оценки и все необходимые результаты оценки подписки.
