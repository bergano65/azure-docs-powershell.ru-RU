...
### Пример 1: Удаление панели мониторинга
```powershell
PS C:\td\> Remove-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02
```

Удаление Dashbaord с помощью имени группы ресурсов и имени панели мониторинга.

### Пример 2: Удаление панели мониторинга с помощью конвейера
```powershell
PS C:\> Get-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02 | Remove-AzPortalDashboard
```

Удаление панели мониторинга, возвращенной из вызова Get-AzDashboard.
