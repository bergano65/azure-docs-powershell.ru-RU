...
### Пример 1: удаление пружинной облачной службы по названию.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Удалить пружинную облачную службу по названию.

### Пример 2: удаление пружинной облачной службы из канала.
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Удалить пружинную облачную службу из канала.
