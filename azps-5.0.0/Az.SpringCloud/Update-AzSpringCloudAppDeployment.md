...
### Пример 1: обновление облачного развертывания весны по имени.
```powershell
...
Обновите облачное развертывание для весны по имени.

### Пример 2: Обновление развертывания в облаке с пружиной из канала.
```powershell
...
Обновите облачное развертывание для весны в канале.
...
### -SourceArtifactSelector
Селектор для артефакта, который будет использоваться для развертывания проектов с несколькими модулями.
Это должен Bethe относительный путь к целевому модулю или проекту.
...
### Microsoft. Azure. PowerShell. командлеты. SpringCloud. Models. Api20200701. IDeploymentResource
