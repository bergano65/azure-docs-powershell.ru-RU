...
### Пример 1: обновление облачного приложения весны по имени.
```powershell
...
Обновите облачное приложение весны по имени.

### Пример 2. Обновите облачное приложение пружины в канале.
```powershell
...
Обновите облачное приложение весны из канала.
...
### -HttpsOnly
Укажите, разрешено ли использование HTTPS.
...
### -Location
Географическое расположение приложения, которое всегда одинаково с родительским ресурсом
...
Путь к временному диску для подключения
