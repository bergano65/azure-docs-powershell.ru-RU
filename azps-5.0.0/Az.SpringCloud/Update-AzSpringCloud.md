...
### Пример 1: обновление пружинной облачной службы по названию.
```powershell
...
Обновите облачную службу весны по названию.

### Пример 2: обновление пружинной облачной службы из канала.
```powershell
...
Обновите облачную службу весны из канала.
...
### -TraceAppInsightInstrumentationKey
Ключ инструментария Application Insights для конечного приложения
...
### -TraceEnabled
Указывает, включена ли функция трассировки
...
### Microsoft. Azure. PowerShell. командлеты. SpringCloud. Models. Api20200701. IServiceResource
