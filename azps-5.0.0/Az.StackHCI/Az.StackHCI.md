...
# AZ. StackHCI Module
## Nописание
Командлеты Microsoft Azure PowerShell: StackHCI

## Командлеты AZ. StackHCI
### [Регистрация — AzStackHCI](Register-AzStackHCI.md)
...
### [Отмена регистрации — AzStackHCI](Unregister-AzStackHCI.md)
