...
## КРАТКИй обзор
Создание или обновление множества сетевых правил. Наборы правил можно применять только к реестру Premium.
...
## NОПИСАНИЕ
Создание или обновление множества сетевых правил
...
Создание нового комплекта сетевых правил.

## ПАРАМЕТРЫ

### -DefaultAction
Действие по умолчанию — "разрешить" или "запретить"
