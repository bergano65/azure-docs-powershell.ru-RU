...
## NОПИСАНИЕ
Создание объекта сетевого правила в текущем сеансе PowerShell.
...
Создание virtualnetwork правила.
...
### -IPAddressOrRange
Указывает диапазон IP-адресов или IP-адресов в формате CIDR.
Разрешен только адрес IPV4.
...
### -IPRule
Укажите, что нужно сделать, чтобы создать IPRule.
...
Идентификатор ресурса подсети, например:/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
...
### -VirtualNetworkRule
Укажите, что нужно сделать, чтобы создать VirtualNetworkRule.
