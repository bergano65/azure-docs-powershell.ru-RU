...
## NОПИСАНИЕ
Командлет New-AzAvailabilityGroupListener создает новый прослушиватель группы доступности.
...
Создание нового прослушивателя группы доступности AgListener01 для группы доступности AvailabilityGroup01 в группе "виртуальная машина SQL" SqlVmGroup01.
...
Идентификатор подсистемы балансировки нагрузки
...
### -Port (порт)
Номер порта для прослушивателя AG. Значение по умолчанию — 1433.
...
### -SqlVirtualMachineId
Список идентификаторов ресурсов виртуальной машины SQL
