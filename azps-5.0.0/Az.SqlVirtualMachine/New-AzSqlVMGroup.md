...
## NОПИСАНИЕ
Командлет New-AzSqlVMGroup создает группу виртуальных машин Azure SQL.
...
Создание новой группы виртуальных машин SQL Azure с помощью виртуальной машины группы тестов в группе ресурсов ResourceGroup01.
$profile является объектом типа Microsoft. Azure. Management. SqlVirtualMachine. Models. WsfcDomainProfile
...
### -Location
Расположение группы виртуальных машин SQL.
...
### -Предложение
Предложение группы виртуальных машин SQL.
...
### -SKU
Тип выпуска группы виртуальных машин SQL.
