...
## NОПИСАНИЕ
Командлет Update-AzAvailabilityGroupListener обновляет прослушиватель группы доступности.
...
Обновляет виртуальные машины SQL списка для прослушивателя группы доступности.
