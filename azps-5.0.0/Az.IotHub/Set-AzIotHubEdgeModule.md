...
## NОПИСАНИЕ
Применяет содержимое конфигурации указанных модулей к указанному пограничному устройству.
Примечание. при выполнении команды будет выводиться коллекция модулей, примененных к устройству.
...
Тестирование модулей EDGE во время разработки путем настройки модулей на целевом устройстве.
...
### -DeviceId
Идентификатор целевого устройства с оконечными краями.
...
### -ModulesContent
Содержимое конфигурации модулей для устройств с границами Интернет вещей.
