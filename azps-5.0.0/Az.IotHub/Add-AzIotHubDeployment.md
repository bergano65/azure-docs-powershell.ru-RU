...
## NОПИСАНИЕ
Развертывание пограничного сервера можно создать с помощью метрик, определенных пользователем, для оценки спроса.
...
Создание развертывания Edge с метаданными по умолчанию.
...
Создайте развертывание пограничного сервера с приоритетом 3, которое применяется к условию, если устройство помечено в здании 9, а среда — "тест".
...
Создайте развертывание пограничного сервера с метриками пользователей.
...
Создайте развертывание пограничного сервера с метками.
...
Создание пограничного развертывания с содержимым.
...
### -ModulesContent
Развертывание модулей для устройств с границами Интернет вещей.
