...
## NОПИСАНИЕ
Запросите центр Интернета вещей с помощью мощного языкового языка SQL для получения информации о устройствах и Twins, заданиях и маршрутизации сообщений.
https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-languageДля получения дополнительных сведений ознакомьтесь с дополнительными сведениями.
...
Запросите данные двойной устройств в центре Azure IoT.
...
Запросите первые 2 модуля двойной данные на целевом устройстве.
...
### -Query
Пользовательский запрос для выполнения.
...
По умолчанию запрос не имеет политики.
