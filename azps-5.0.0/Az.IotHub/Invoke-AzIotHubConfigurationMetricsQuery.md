...
## NОПИСАНИЕ
Оцените целевую пользовательскую или системную метрику, определенную в конфигурации устройства IoT.
...
- "Targeted" указывает число Twins устройств, соответствующих целевому условию.
- "Применено" указывает число Twins устройств, измененных конфигурацией. 
...
Оценка метрики "применяется система".
