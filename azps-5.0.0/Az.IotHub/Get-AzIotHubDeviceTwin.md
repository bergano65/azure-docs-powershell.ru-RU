...
## NОПИСАНИЕ
Возвращает двойной устройства. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twinsДля получения дополнительных сведений ознакомьтесь с дополнительными сведениями.
...
Возвращает объект двойной устройства.
