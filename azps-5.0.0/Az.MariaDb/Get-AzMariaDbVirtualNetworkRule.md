...
### Пример 1: список всех виртуальных сетевых правил в MariaDB
```powershell
...
В этой команде перечислены все правила для всех виртуальных сетей в MariaDB.

### Пример 2: получение правила виртуальной сети для MariaDB
```powershell
...
Эта команда получает правило виртуальной сети в разделе MariaDB.
...
### Microsoft. Azure. PowerShell. командлеты. MariaDb. Models. Api20180601Preview. IVirtualNetworkRule
