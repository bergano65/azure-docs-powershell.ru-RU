...
### Пример 1: список всех конфигураций в MariaDB
```powershell
...
Эта команда выводит все настройки в MariaDB.

### Пример 2: получение конфигурации MariaDB
```powershell
...
Эта команда возвращает конфигурацию MariaDB.
