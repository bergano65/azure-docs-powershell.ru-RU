...
### Пример 1: список всех MariaDB в рамках подписки
```powershell
...
Эта команда выводит список всех MariaDB в рамках подписок.

### Пример 2: список всех MariaDB в группе ресурсов
```powershell
...
Эта команда выводит список всех MariaDB в группе ресурсов.

### Пример 3: получение MariaDB
```powershell
...
Эта команда возвращает MariaDB.
