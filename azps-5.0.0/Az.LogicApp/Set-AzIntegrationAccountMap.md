...
## NОПИСАНИЕ
Командлет **Set-AzIntegrationAccountMap** изменяет карту учетной записи интеграции.
...
Изменяет карту учетной записи интеграции. (автоматически сформированные)
...
### -MapFilePath
Задает путь к файлу определения для карты учетной записи интеграции.
