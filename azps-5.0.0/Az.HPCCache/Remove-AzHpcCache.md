...
## NОПИСАНИЕ
Командлет **Remove-AzHpcCache** удаляет кэш Azure HPC.
...
### -Force
Указывает на то, что командлет не запрашивает подтверждение. По умолчанию этот командлет предлагает подтвердить удаление кэша.
...
### -ResourceGroupName
Имя группы ресурсов, в которой вы хотите удалить кэш.
