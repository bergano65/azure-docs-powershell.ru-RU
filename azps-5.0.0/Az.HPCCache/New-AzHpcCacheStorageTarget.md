...
## NОПИСАНИЕ
Командлет **New-AzHpcCacheStorageTarget** добавляет целевое хранилище в кэш Azure HPC.
...
### -CLFS
Обновите тип целевого хранилища CLFS.
...
### -Force
Указывает на то, что командлет не запрашивает подтверждение. По умолчанию этот командлет предлагает подтвердить сброс кэша.
...
### -NFS
Обновите тип целевого хранилища NFS.
...
### -ResourceGroupName
"Имя группы ресурсов, в которой вы хотите создать цель хранилища для данного кэша.
...
### Microsoft. Azure. PowerShell. командлеты. HPCCache. Models. PsHpcStorageTarget
