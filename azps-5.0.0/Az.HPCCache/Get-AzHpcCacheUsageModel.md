...
## NОПИСАНИЕ
Командлет **Get-AzHpcCacheUsageModel** возвращает список моделей использования для целевого хранилища NFS.
...
### Microsoft. Azure. PowerShell. командлеты. HPCCache. Models. PSHpcUsageModels
