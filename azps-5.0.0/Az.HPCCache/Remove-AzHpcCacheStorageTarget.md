...
## NОПИСАНИЕ
Командлет **Remove-AzHpcCacheStorageTarget** Удаляет целевое хранилище из кэша Azure HPC Cache.
...
### -Force
Указывает на то, что командлет не запрашивает подтверждение. По умолчанию этот командлет предлагает подтвердить необходимость удаления целевого объекта хранилища.
...
### -ResourceGroupName
Имя группы ресурсов, в которой вы хотите удалить цель хранилища из кэша.
