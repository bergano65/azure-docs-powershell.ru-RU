...
### Пример 1: Удаление указанного эталонных данных по имени
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Эта команда удаляет указанный набор эталонных данных.

### Пример 2: Удаление указанного эталонных данных, заданного объектом
```powershell
