...
## NОПИСАНИЕ
Командлет Get-AzDataFactoryV2IntegrationRuntime получает сведения о средах выполнения интеграции в фабрике данных.
...
### Пример 5: получение самостоятельно размещенной среды выполнения интеграции с подробным состоянием
```
