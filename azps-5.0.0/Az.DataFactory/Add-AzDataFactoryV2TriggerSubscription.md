...
## NОПИСАНИЕ
Эта команда осуществляет подписку триггера событий на указанные внешние события службы из определения триггера.
...
Эта команда будет подписаться на BlobEnetTrigger1 триггер к указанным событиям из определения триггера.
