...
## КРАТКИй обзор
Остановка запуска триггера в фабрике данных.
...
## NОПИСАНИЕ
Командлет **Stop-AzDataFactoryV2TriggerRun** останавливает выполнение триггера в фабрике данных, указанной с именем триггера и идентификатором запуска триггера.
В настоящее время поддерживается только для TumblingWindowTriggers в WaitingOnDependency состоянии.
...
Эта команда останавливает запуск триггера с идентификатором "08586002468005888497807248799CU16" в WikiADF Factory.
...
### -PassThru
При успешном указании командлета записать истинную операцию в case.
