...
## NОПИСАНИЕ
Командлет **New-AzDataFactoryV2IntegrationRuntimeKey** повторно создает ключ среды выполнения Integration с именем ключа, заданным параметром keyName. Предыдущий ключ не является допустимым.
