...
## NОПИСАНИЕ
Эта команда останавливает сеанс отладки, в противном случае сеанс автоматически отключается в соответствии с настройками времени сеанса отладки в течение срока жизни.
...
```
Остановка сеанса отладки потока данных "fd76cd0d-8b37-4DC0-A370-3f9d43ac686d" в фабрике данных "WikiADF"
