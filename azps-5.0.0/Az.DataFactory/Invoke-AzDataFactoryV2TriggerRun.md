...
## NОПИСАНИЕ
Команда **Invoke-AzDataFactoryV2TriggerRun** запускает еще один экземпляр триггера с новым идентификатором запуска триггера.
...
```
Запуск другого экземпляра триггера с новым идентификатором запуска триггера и сохранением того же windowStartTime и windowEndTime в качестве исходного запуска триггера.
