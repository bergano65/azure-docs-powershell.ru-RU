...
### [Сохранить — AzureRmDeploymentTemplate](Save-AzureRmDeploymentTemplate.md)
Получает шаблон развертывания в области подписки.

### [Сохранить — AzureRmResourceGroupDeploymentTemplate](Save-AzureRmResourceGroupDeploymentTemplate.md)
...
### [Остановить-AzureRmDeployment](Stop-AzureRmDeployment.md)
