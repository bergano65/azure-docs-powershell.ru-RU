...
## NОПИСАНИЕ
Командлет **Add-AzureRmRouteConfig** добавляет маршрут к таблице маршрута Azure.
...
Текущий командлет добавляет маршрут с именем Route02 и передает результат в командлет **Set-AzureRmRouteTable** , который обновляет таблицу, чтобы отразить изменения.
