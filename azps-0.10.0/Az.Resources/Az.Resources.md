...
Получает развертывание в области подписки.

### [Get-AzDeploymentOperation](Get-AzDeploymentOperation.md)
Возвращает операции развертывания для развертывания в области подписки.
...
Создает новое развертывание в области подписки.
...
Удаление развертывания в области подписки.
...
Получает шаблон развертывания в области подписки.
...
Отменяет запущенное развертывание в области подписки.
...
Проверяет шаблон развертывания и параметры в области подписок.
