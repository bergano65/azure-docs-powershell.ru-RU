...
### Пример 1. Создание нового пользователя с AD
```
...
### -ImmutableId
Его нужно укадрять только в том случае, если вы используете федератный домен в качестве свойства имени пользователя (upn).
