...
## NОПИСАНИЕ
Командлет **Get-AzDataBoxEdgeRole** извлекает доступные роли IOT для поля данных, расположенного на пограничном устройстве. Вы можете упомянуть о параметре name, чтобы получить сведения о конкретной роли Интернета вещей.
