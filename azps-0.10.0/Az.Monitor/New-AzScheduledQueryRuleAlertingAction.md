...
## NОПИСАНИЕ
Создает объект типа "действие оповещения". Этот объект будет передан команде, которая создает правило оповещения в журнале.
...
### -Серьезность
Уровень важности для этого оповещения.
...
### -ThrottlingInMinutes
Продолжительность (в минутах), за которую следует регулировать оповещение
