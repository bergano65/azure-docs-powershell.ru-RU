...
## NОПИСАНИЕ
Командлет **New-AzNetworkSecurityGroup** создает группу сетевой безопасности Azure.

## ИЛЛЮСТРИРУЮТ

### 1: создание новой группы оптимального сети
```
New-AzNetworkSecurityGroup -Name "nsg1" -ResourceGroupName "rg1"  -Location  "westus"
```

Эта команда ceates новую группу сетевой безопасности Azure с именем "nsg1" в группе ресурсов "Rg1" в расположении "westus".
