...
## NОПИСАНИЕ
Командлет New-AzNetworkWatcherConnectionMonitor rcreates монитор подключений для определенного источника и места назначения.

## ИЛЛЮСТРИРУЮТ

### ---------------Пример 1: Создание монитора подключений для виртуальной машины и назначения в Интернете---------------
```
...
Командлет New-AzNetworkWatcherConnectionMonitor создает монитор подключений для определенного источника и назначения.
