...
## NОПИСАНИЕ
Получает сведения о задании IotHub.
Задание IotHub создается, когда операция импорта или экспорта инициализируется с помощью команд New-AzIotHubExportDevices или New-AzIotHubImportDevices.
