...
## NОПИСАНИЕ
Создание нового IotHub.
Вы можете создать IotHub со свойствами по умолчанию или задать входные свойства.
