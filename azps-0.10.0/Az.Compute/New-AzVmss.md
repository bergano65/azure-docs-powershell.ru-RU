...
### -FrontendPoolName
Имя пула адресных интерфейсов, usein locad подсистемы балансировки нагрузки.  Если значение не задано, будет создан новый пул адресных веб-интерфейсов с тем же именем, что и в наборе масштабов.
