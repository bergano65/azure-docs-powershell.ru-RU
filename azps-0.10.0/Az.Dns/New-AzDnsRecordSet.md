...
Чтобы указать, будет ли этот командлет запрашивать comfirmation, используйте параметр *Confirm* .
...
Записи SOA создаются автоматически при создании зоны и не могут быть созданы вручную.
...
Этот командлет возвращает объект **набора записей** .
