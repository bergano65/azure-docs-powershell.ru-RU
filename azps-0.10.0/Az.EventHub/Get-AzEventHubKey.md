...
## NОПИСАНИЕ
Командлет Get-AzEventHubKey возвращает первичные и вторичные ConnectionString и сведения о нем для указанного пространства имен, концентраторов событий и псевдонимов.
