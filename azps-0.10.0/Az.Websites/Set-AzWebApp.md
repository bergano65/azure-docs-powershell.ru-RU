...
### -AssignIdentity
Включение и отключение MSI для существующих Azure webapp или functionapp [Предварительная версия]
...
### Int32
Параметр "NumberOfWorkers" принимает значение типа Int32 из конвейера.
