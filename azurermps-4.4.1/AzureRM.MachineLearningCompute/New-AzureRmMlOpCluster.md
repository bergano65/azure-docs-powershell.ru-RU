...
### Создайте новый кластер выопераций из определения экземпляра OperationalizationCluster.
```
New-AzureRmMlOpCluster -ResourceGroupName <String> -Name <String> -InputObject <PSOperationalizationCluster>
 [-WhatIf] [-Confirm]
```

### Создание нового кластера для выоперационных операций из входных параметров командлета.
```
