...
## NОПИСАНИЕ
Командлет **Join-AzureRmDataLakeStoreItem** присоединяется к одному или нескольким файлам для создания одного файла в Data Lake Store.

## ИЛЛЮСТРИРУЮТ

### Пример 1: объединение двух элементов
```
...
Эта команда присоединяет File01.txt и File02.txt для создания файла CombinedFile.txt.
...
### -Destination
Указывает путь к Data Lake Store для присоединенного элемента, начиная с корневого каталога (/).
...
### -Paths
Указывает массив путей к Data Lake Store для файлов, которые нужно объединить, начиная с корневого каталога (/).
...
### подстрок
Полный путь к полученному файлу из связанных файлов.
