...
Добавляет управляемую учетную запись хранения KeyVault в хранилище ключей.
...
### [Остановить-AzureKeyVaultCertificateOperation](Stop-AzureKeyVaultCertificateOperation.md)
