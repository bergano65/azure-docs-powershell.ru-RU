...
## NОПИСАНИЕ
Командлет **Set-AzureRmVmssStorageProfile** задает свойства профиля хранения для набора масштабов виртуальных машин (VMSS).
...
Чтобы получить объект, используйте объект New-AzureRmVmssConfig.
