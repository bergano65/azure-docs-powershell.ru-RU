...
## NОПИСАНИЕ
Командлет **Remove-AzureRmSnapshot** удаляет моментальный снимок.
...
Эта команда удаляет моментальный снимок с именем "Snapshot01" в группе ресурсов "ResourceGroup01".
