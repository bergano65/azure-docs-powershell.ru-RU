...
## NОПИСАНИЕ
Командлет **Set-AzureRmAutomationRunbook** изменяет конфигурацию Azure Automation RUNBOOK в ТД.
...
### -Теги
Указывает словарь тегов для замены текущих тегов измененного Runbook.
