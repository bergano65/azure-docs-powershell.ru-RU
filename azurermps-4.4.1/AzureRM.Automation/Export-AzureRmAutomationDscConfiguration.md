...
## NОПИСАНИЕ
Командлет **Export-AzureRmAutomationDscConfiguration** экспортирует конфигурацию нужной конфигурации ТД из Azure Automation в локальный файл.
...
Значение по умолчанию — Опубликовано.
