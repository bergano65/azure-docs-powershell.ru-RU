...
## NОПИСАНИЕ
Командлет **Start-AzureRmDataFactoryV2IntegrationRuntime** запускает управляемую выделенную среду выполнения интеграции. Ресурс подготовлен к работе и после операции с состоянием "начато".

## ИЛЛЮСТРИРУЮТ

### Пример 1: запуск среды выполнения интеграции
```
...
Этот командлет запускает управляемую выделенную среду выполнения для интеграции с именем "тест-выделенный"-"IR".
...
[Остановить-AzureRmDataFactoryV2IntegrationRuntime]()
