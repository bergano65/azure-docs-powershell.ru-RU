...
## NОПИСАНИЕ
Командлет Remove-AzureRmDataFactoryV2IntegrationRuntimeNode удаляет узел в среде выполнения интеграции.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Удаление узла из среды выполнения интеграции
```
...
Эта команда удаляет узел с именем "Node_1" в среде выполнения интеграции с именем "Test-SelfHost-IR" в подписке для группы ресурсов с именем "Test-DF-Eu2".
