...
## NОПИСАНИЕ
Командлет **Get-AzureRMCdnProfile** получает профиль сети доставки содержимого (CDN) для Azure и связанную с ней информацию.
...
###  
Этот командлет возвращает объект профиля.
