...
## NОПИСАНИЕ
Командлет **Get-AzureRmServiceBusQueue** Возвращает описание указанной очереди служебной шины.
