...
## NОПИСАНИЕ
Командлет **Get-AzureRmServiceBusNamespaceAuthorizationRule** получает описание указанного правила авторизации в заданном пространстве имен.
...
### -Name (имя)
Имя AuthorizationRule пространства имен ServiceBus.
