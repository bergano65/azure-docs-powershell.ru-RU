...
## NОПИСАНИЕ
Командлет **Set-AzureRmServiceBusTopic** обновляет объект описания для темы служебной шины в указанном пространстве имен служебной шины.
...
Обновляет указанную тему с помощью нового описания в указанном пространстве имен. В этом примере свойство **EnableExpress** обновляется на **true**. 
...
### -InputObject
Определение раздела ServiceBus.
