...
## NОПИСАНИЕ
Командлет **Set-AzureRmServiceBusTopicAuthorizationRule** обновляет описание указанного правила авторизации для данной темы служебной шины.
...
Добавляет **Управление** правами доступа для правила авторизации `SBTopicAuthoRule1` в разделе `SB-Topic_exampl1` .
...
### -Права
Администратора Например, @ ("прослушать", "Отправить", "Управление"). Обязательно, если не указан аргумент **-AuthruleObj** .
...
### -InputObj
Объект AuthorizationRule темы ServiceBus.
