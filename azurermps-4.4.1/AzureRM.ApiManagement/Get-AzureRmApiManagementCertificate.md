...
### Получить все сертификаты (по умолчанию)
```
...
## NОПИСАНИЕ
Командлет **Get-AzureRmApiManagementCertificate** получает все указанные вами сертификаты управления API Azure или сертификаты.
