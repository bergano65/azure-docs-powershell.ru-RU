...
## NОПИСАНИЕ
Командлет **New-AzureRmApplicationGatewayRedirectConfiguration** создает конфигурацию перенаправления для шлюза приложений.
...
### -TargetListener
HTTPListener перенаправить запрос на
...
### -TargetListenerID
Идентификатор прослушивателя, на который нужно перенаправить запрос
