...
## NОПИСАНИЕ
Командлет **Set-AzureRmSchedulerServiceBusTopicJob** изменяет тему задания служебной шины в планировщике Azure.
...
### -ServiceBusMessage
Указывает сообщение о теме служебной шины.
...
### -ServiceBusTopicPath
Указывает путь к разделу служебной шины.
