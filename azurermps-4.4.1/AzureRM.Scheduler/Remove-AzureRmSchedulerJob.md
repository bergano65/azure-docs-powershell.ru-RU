...
## NОПИСАНИЕ
Командлет **Remove-AzureRmSchedulerJob** удаляет задание планировщика Azure.
...
### -JobCollectionName
Указывает имя коллекции заданий, которая содержит задание, которое нужно удалить.
...
### -JobName
Указывает имя задания, которое нужно удалить.
...
### -PassThru
Указывает на то, что этот командлет возвращает значение успеха при успешном выполнении.
...
### -ResourceGroupName
Указывает группу ресурсов для задания, которое нужно удалить.
