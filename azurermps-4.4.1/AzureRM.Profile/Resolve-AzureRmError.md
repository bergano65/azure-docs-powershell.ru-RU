...
Сведения об ошибке PowerShell, которая не связана с excpetion.

### Microsoft. Azure. Commands. Profile. Errors. AzureExceptionRecord
Сведения об ошибке, в том числе подробные сведения об исключении, которое вызывает ошибку.

### Microsoft. Azure. Commands. Profile. Errors. AzureRestExceptionRecord
Сведения об ошибках в cleint/серверных соединениях.  Часто они содержат важную информацию об ошибке сервера.
