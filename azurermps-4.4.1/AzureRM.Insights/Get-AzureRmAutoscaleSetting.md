...
## NОПИСАНИЕ
Командлет **Get-AzureRmAutoscaleSetting** получает все параметры автомасштабирования, связанные с группой ресурсов или с указанным параметром автомасштабирования.

## ИЛЛЮСТРИРУЮТ

### Пример 1: получение параметров автомасштабирования
```
...
Эта команда получает параметры автомасштабирования, назначенные группе ресурсов Default-Web-EastUS.

### Пример 2: получение параметров автомасштабирования по имени
```
...
Эта команда получает параметр автомасштабирования с именем DefaultServerFarm-Default-Web-EastUS.

## ПАРАМЕТРЫ

### -DetailedOutput
Указывает на то, что эта операция отображает полные сведения в выходных данных.
...
### -Name (имя)
Указывает имя получаемого параметра.
...
### System. Collections. Generic. List "1 [Microsoft. Azure. Management.. Models. AutoscaleSettingResource]
