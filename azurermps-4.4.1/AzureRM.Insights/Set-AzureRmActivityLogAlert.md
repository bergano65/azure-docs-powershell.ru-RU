...
### Параметры по умолчанию для уведомления о настройке журнала активности
```
...
### Параметры для настройки предупреждений журнала активности, принимающего значение ResourceId из канала
```
...
### Параметры для настройки уведомлений журнала активности, принимающего значение из канала
```
