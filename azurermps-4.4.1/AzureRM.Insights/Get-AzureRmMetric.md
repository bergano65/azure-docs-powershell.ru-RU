...
### Параметры для Get-AzureRmMetric командлета в режиме по умолчанию
```
Get-AzureRmMetric [-ResourceId] <String> [-MetricNames <String[]>] [-DetailedOutput]
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### Параметры для Get-AzureRmMetric командлета в режиме полного множества параметров
```
...
### -AggregationType
Тип статистической обработки для Quer
