...
## КРАТКИй обзор
Получает состояние перемещения эластичных баз данных.
...
## NОПИСАНИЕ
Командлет **Get-AzureRmSqlDatabaseActivity** возвращает состояние эластичных баз данных, которые перемещаются в пул эластичных баз данных Azure SQL Server или из него.
...
### -ИмяСервера
Указывает имя сервера Microsoft SQL Server, на котором размещается пул эластичных баз данных.
