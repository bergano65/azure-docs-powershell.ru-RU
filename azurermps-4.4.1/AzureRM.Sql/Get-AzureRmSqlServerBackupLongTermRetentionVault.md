...
## NОПИСАНИЕ
Командлет **Get-AzureRmSqlServerBackupLongTermRetentionVault** получает долгосрочное хранилище, которое зарегистрировано для этого сервера.
...
### -ИмяСервера
Указывает сервер, для которого этот командлет получает хранилище.
