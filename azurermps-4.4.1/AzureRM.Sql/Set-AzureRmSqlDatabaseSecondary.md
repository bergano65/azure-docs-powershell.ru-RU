...
###  
Вы можете создать канал для экземпляра объекта **базы данных** для базы данных получателя, чтобы выполнить переход на другой элемент, а затем сделать его базой данных PRIMARY.
