...
## NОПИСАНИЕ
Командлет **Remove-AzureRmSiteRecoveryProtectionContainerMapping** удаляет сопоставление контейнера защиты для Azure Site Recovery.
...
Указывает объект сопоставления контейнера защиты для Azure Site Recovery.
...
Параметр "ProtectionContainerMapping" принимает значение типа "ASRProtectionContainerMapping" из конвейера.
