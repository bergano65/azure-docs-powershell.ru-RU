...
## NОПИСАНИЕ
Командлет **Get-AzureRmSiteRecoveryStorageClassification** возвращает классификацию хранилища в Azure Site Recovery.
...
### -FriendlyName
Указывает понятное имя для классификации хранилища, которое получает этот командлет.
...
### -Name (имя)
Указывает имя классификации хранилища, которое получает этот командлет.
