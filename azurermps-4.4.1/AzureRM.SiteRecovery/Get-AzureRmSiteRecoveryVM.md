...
## NОПИСАНИЕ
Командлет **Get-AzureRmSiteRecoveryVM** получает сведения о виртуальных машинах, управляемых в Azure Site Recovery.
...
### -FriendlyName
Указывает понятное имя виртуальной машины.
