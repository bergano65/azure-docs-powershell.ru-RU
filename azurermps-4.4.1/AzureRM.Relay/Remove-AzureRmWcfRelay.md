...
## NОПИСАНИЕ
Командлет **Remove-AzureRmWcfRelay** удаляет WcfRelay из указанного пространства имен ретрансляции.
...
Удаляет WcfRelay `TestWCFRelay1` из пространства имен `TestNameSpace-Relay1` .
