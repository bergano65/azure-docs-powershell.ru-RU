...
Обновляет свойства существующего приложения Azure Active Directory с objectId "fb7b3405-CA44-4b5b-8584-12392f5d96d7".
...
Обновление отображаемого имени существующего приложения Azure Active Directory с objectId "fb7b3405-CA44-4b5b-8584-12392f5d96d7".

## ПАРАМЕТРЫ

### -ApplicationId
Идентификатор обновляемого приложения.
...
Значение, указывающее, будет ли приложение обновляться как один клиент или несколько клиентов.
...
### -DisplayName
Новое отображаемое имя приложения.
...
### -Главная страница
Новый URL-адрес домашней страницы приложения.
...
### -IdentifierUris
Новые универсальные коды ресурсов (URI), обозначающие приложение.
...
### -ReplyUrls
Новые URL-адреса для ответа для приложения.
