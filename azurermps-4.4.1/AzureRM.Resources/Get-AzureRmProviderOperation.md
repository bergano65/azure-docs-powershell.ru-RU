...
### --------------------------Получить все действия для всех поставщиков--------------------------
```
PS C:\> Get-AzureRmProviderOperation *
```

### --------------------------Получить действия для определенного поставщика ресурсов--------------------------
```
PS C:\> Get-AzureRmProviderOperation Microsoft.Insights/*
```

### --------------------------Получить все действия, которые можно выполнять на виртуальных машинах--------------------------
```
