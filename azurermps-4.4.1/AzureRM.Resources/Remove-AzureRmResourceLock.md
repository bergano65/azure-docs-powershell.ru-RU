...
### Блокировка по идентификатору. (по умолчанию)
```
...
### Блокировка в области действия группы ресурсов.
```
...
### Блокировка в области ресурсов "Группа ресурсов".
```
...
### Блокировка на указанном уровне.
```
...
### Блокировка в области ресурсов подписки.
```
Remove-AzureRmResourceLock -LockName <String> [-Force] -ResourceName <String> -ResourceType <String>
...
### Блокировка в области ресурсов клиента.
```
Remove-AzureRmResourceLock -LockName <String> [-Force] -ResourceName <String> -ResourceType <String>
...
## NОПИСАНИЕ
Командлет **Remove-AzureRmResourceLock** удаляет блокировку ресурса Azure.

## ИЛЛЮСТРИРУЮТ

### Пример 1: снятие блокировки
```
...
Эта команда удаляет блокировку с именем ContosoSiteLock.
...
### -LockId
Указывает идентификатор блокировки, которую удаляет этот командлет.
...
### -LockName
Указывает имя блокировки, которую удаляет этот командлет.
