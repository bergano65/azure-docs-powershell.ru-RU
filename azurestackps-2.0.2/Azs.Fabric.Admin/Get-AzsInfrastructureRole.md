...
Получение списка всех ролей инфраструктуры.
...
Получить роль инфраструктуры на основе имени.
...
### Microsoft. Azure. PowerShell. командлеты. FabricAdmin. Models. Api20160501. IInfraRole
