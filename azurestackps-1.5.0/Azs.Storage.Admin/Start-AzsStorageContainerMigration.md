...
UNC-путь к целевой общей папке для миграции.
...
### -ResourceGroupName
Имя группы ресурсов, в которой зарегистрирован поставщик ресурсов хранилища.
...
### -Имя_общего_ресурса
Имя общего доступа, содержащего контейнер, указанный для миграции.
...
### -StorageAccountName
Имя учетной записи хранилища, в которой находится контейнер.
