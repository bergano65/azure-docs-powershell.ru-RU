...
Для работы с Azure PowerShell версии 6.0.0 требуется версия PowerShell 5.0 и выше. Для работы с предыдущими версиями Azure PowerShell требуется _по крайней мере_ версия PowerShell 3.0 (для выполнения любого командлета). Сведения об обновлении до версии PowerShell 5.0 см. в [этой таблице](/powershell/scripting/setup/installing-windows-powershell?view=powershell-6#upgrading-existing-windows-powershell).
