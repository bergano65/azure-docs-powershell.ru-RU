...
В PowerShell 5 проверку и администрирование хранилища сертификатов можно осуществлять с помощью модуля [PKI](/powershell/module/pkiclient). В PowerShell 6 это не настолько просто. Приведенные ниже скрипты демонстрируют, как импортировать существующий сертификат в хранилище сертификатов, к которому имеет доступ PowerShell.

#### <a name="import-a-certificate-in-powershell-5"></a>Импорт сертификата в PowerShell 5
...
#### <a name="import-a-certificate-in-powershell-6"></a>Импорт сертификата в PowerShell 6
