...
В этом примере показано, как получить список виртуальных машин Azure в подписке по умолчанию.  По умолчанию выходные данные команды `Get-AzVM` представлены в табличном формате.
