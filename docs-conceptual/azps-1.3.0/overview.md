...
Вы можете установить Azure PowerShell на любую платформу, которая поддерживает PowerShell 5.x или PowerShell 6.x, либо запустить среду в Azure Cloud Shell.
