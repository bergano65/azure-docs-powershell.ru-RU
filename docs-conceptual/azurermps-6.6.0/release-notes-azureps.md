...
* Обновлена библиотека Common.Strategy: теперь можно проверить, совместима ли текущая конфигурация ресурса с целевым ресурсом. По умолчанию всегда используется значение true.
* В Common.Storage добавлены типы ps1xml.

#### <a name="azurestorage"></a>Azure.Storage;
* Служба поддержки теперь может получать контекст хранилища из DefaulfProfile.
