...
#### <a name="azurermprofile"></a><span data-ttu-id="36c61-145">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="36c61-145">AzureRM.Profile</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="36c61-161">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="36c61-161">AzureRM.TrafficManager</span></span>
...
#### <a name="azurestorage"></a><span data-ttu-id="36c61-177">Azure.Storage;</span><span class="sxs-lookup"><span data-stu-id="36c61-177">Azure.Storage</span></span>
...
#### <a name="azurermbatch"></a><span data-ttu-id="36c61-192">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="36c61-192">AzureRM.Batch</span></span>
...
#### <a name="azurermcontainerinstance"></a><span data-ttu-id="36c61-208">AzureRM.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="36c61-208">AzureRM.ContainerInstance</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="36c61-223">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="36c61-223">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermlogicapp"></a><span data-ttu-id="36c61-239">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="36c61-239">AzureRM.LogicApp</span></span>
...
* <span data-ttu-id="36c61-272">Обновление до последней версии Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="36c61-272">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
* <span data-ttu-id="36c61-294">Обновление до последней версии Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="36c61-294">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="36c61-309">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="36c61-309">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="36c61-324">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="36c61-324">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="36c61-342">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="36c61-342">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="36c61-358">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="36c61-358">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="36c61-373">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="36c61-373">AzureRM.Storage</span></span>
...
#### <a name="azurermautomation"></a><span data-ttu-id="36c61-390">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="36c61-390">AzureRM.Automation</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="36c61-404">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="36c61-404">AzureRM.Network</span></span>
...
* <span data-ttu-id="36c61-421">Добавлены командлеты для перехода с пространства имен ценовой категории "Стандартный" на пространство ценовой категории "Премиум":</span><span class="sxs-lookup"><span data-stu-id="36c61-421">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    ...
    - <span data-ttu-id="36c61-424">Complete-AzureRmServiceBusMigration;</span><span class="sxs-lookup"><span data-stu-id="36c61-424">Complete-AzureRmServiceBusMigration</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="36c61-441">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="36c61-441">AzureRM.Profile</span></span>
...
* <span data-ttu-id="36c61-460">Исправлено расположение тестовых данных для командлетов DataLake.</span><span class="sxs-lookup"><span data-stu-id="36c61-460">Fix location of test of DataLake cmdlets</span></span>
...
* <span data-ttu-id="36c61-470">Добавлены новые команды для функции поддержки партнерских API для ExpressRoute, развертываемых с помощью ARM:</span><span class="sxs-lookup"><span data-stu-id="36c61-470">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    ...
    - <span data-ttu-id="36c61-477">добавлена команда Get-AzureRMExpressRouteCrossConnectionRouteTable;</span><span class="sxs-lookup"><span data-stu-id="36c61-477">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="36c61-478">добавлена команда Get-AzureRMExpressRouteCrossConnectionRouteTableSummary.</span><span class="sxs-lookup"><span data-stu-id="36c61-478">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="36c61-479">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="36c61-479">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="36c61-480">Добавлен командлет Get-AzureRmRecoveryServicesBackupStatus.</span><span class="sxs-lookup"><span data-stu-id="36c61-480">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="36c61-481">Этот командлет принимает идентификатор виртуальной машины и проверяет, защищена ли виртуальная машина с помощью какого-либо хранилища в подписке.</span><span class="sxs-lookup"><span data-stu-id="36c61-481">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="36c61-482">Если такое хранилище существует, командлет выводит данные о нем.</span><span class="sxs-lookup"><span data-stu-id="36c61-482">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="36c61-483">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="36c61-483">AzureRM.Resources</span></span>
* <span data-ttu-id="36c61-484">Обновлены командлеты Get-AzureRmPolicyAssignment:</span><span class="sxs-lookup"><span data-stu-id="36c61-484">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="36c61-485">Добавлена поддержка вывода списка значений параметра -Scope на уровне группы управления.</span><span class="sxs-lookup"><span data-stu-id="36c61-485">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="36c61-486">Добавлена поддержка для получения отдельных назначений со значениями -Scope на уровне группы управления.</span><span class="sxs-lookup"><span data-stu-id="36c61-486">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="36c61-487">Для параметра управления добавлены параметры -Effective и -All.</span><span class="sxs-lookup"><span data-stu-id="36c61-487">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="36c61-488">Обновлены командлеты Get/New/Remove/Set-AzureRmPolicyDefinition.</span><span class="sxs-lookup"><span data-stu-id="36c61-488">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="36c61-489">Добавлен параметр -ManagementGroupName для применения операций к заданной группе управления.</span><span class="sxs-lookup"><span data-stu-id="36c61-489">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="36c61-490">Добавлен параметр -SubscriptionId для применения операций к заданной подписке.</span><span class="sxs-lookup"><span data-stu-id="36c61-490">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="36c61-491">Обновлены командлеты Get/New/Remove/Set-AzureRmPolicySetDefinition.</span><span class="sxs-lookup"><span data-stu-id="36c61-491">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="36c61-492">Добавлен параметр -ManagementGroupName для применения операций к заданной группе управления.</span><span class="sxs-lookup"><span data-stu-id="36c61-492">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="36c61-493">Добавлен параметр -SubscriptionId для применения операций к заданной подписке.</span><span class="sxs-lookup"><span data-stu-id="36c61-493">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="36c61-494">Добавлена поддержка ссылок на секрет KeyVault в параметрах при использовании TemplateParameterObject в New-AzureRmResourceGroupDeployment.</span><span class="sxs-lookup"><span data-stu-id="36c61-494">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="36c61-495">Устранена проблема, из-за которой параметр -EndDate игнорировался в New-AzureRmADAppCredential.</span><span class="sxs-lookup"><span data-stu-id="36c61-495">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="36c61-496">Устранена проблема, из-за которой в Add-AzureRmADGroupMember использовался неверный URL-адрес для запроса.</span><span class="sxs-lookup"><span data-stu-id="36c61-496">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="36c61-497">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="36c61-497">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="36c61-498">Для командлета New-AzureRmServiceBusKey добавлен необязательный параметр -KeyValue, который позволяет пользователю предоставить значение ключа.</span><span class="sxs-lookup"><span data-stu-id="36c61-498">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="36c61-499">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="36c61-499">AzureRM.Sql</span></span>
* <span data-ttu-id="36c61-500">В справке по New-AzureRmSqlDatabaseRestorePoint добавлено описание определяемых пользователем точек восстановления для хранилища данных SQL.</span><span class="sxs-lookup"><span data-stu-id="36c61-500">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="36c61-501">Обновлена документация по параметру -ComputeGeneration, используемого в нескольких командлетах.</span><span class="sxs-lookup"><span data-stu-id="36c61-501">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="36c61-502">6.3.0 — июнь 2018 г.</span><span class="sxs-lookup"><span data-stu-id="36c61-502">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="36c61-503">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="36c61-503">AzureRM.Profile</span></span>
* <span data-ttu-id="36c61-504">Обновлены сообщения об ошибках для Enable-AzureRmContextAutoSave.</span><span class="sxs-lookup"><span data-stu-id="36c61-504">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="36c61-505">Создание контекста для каждой подписки при выполнении Connect-AzureRmAccount без предыдущего контекста.</span><span class="sxs-lookup"><span data-stu-id="36c61-505">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="36c61-506">Azure.Storage;</span><span class="sxs-lookup"><span data-stu-id="36c61-506">Azure.Storage</span></span>
* <span data-ttu-id="36c61-507">В файлы справки добавлены дополнительные сведения о параметре -Permissions.</span><span class="sxs-lookup"><span data-stu-id="36c61-507">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="36c61-508">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="36c61-508">AzureRM.Compute</span></span>
* <span data-ttu-id="36c61-509">Get-AzureRmVmDiskEncryptionStatus устраняет проблему, которая наблюдалась на виртуальных машинах без дисков данных.</span><span class="sxs-lookup"><span data-stu-id="36c61-509">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="36c61-510">Обновлена версия клиентской библиотеки Compute для исправления следующих командлетов:</span><span class="sxs-lookup"><span data-stu-id="36c61-510">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="36c61-511">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="36c61-511">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="36c61-512">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="36c61-512">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="36c61-513">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="36c61-513">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="36c61-514">В следующих командлетах исправлено отображение неправильных значений operation ID и operation status:</span><span class="sxs-lookup"><span data-stu-id="36c61-514">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="36c61-515">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="36c61-515">Start-AzureRmVM</span></span>
    - <span data-ttu-id="36c61-516">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="36c61-516">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="36c61-517">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="36c61-517">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="36c61-518">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="36c61-518">Set-AzureRmVM</span></span>
    - <span data-ttu-id="36c61-519">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="36c61-519">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="36c61-520">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="36c61-520">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="36c61-521">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="36c61-521">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="36c61-522">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="36c61-522">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="36c61-523">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="36c61-523">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="36c61-524">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="36c61-524">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="36c61-525">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="36c61-525">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="36c61-526">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="36c61-526">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="36c61-527">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="36c61-527">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="36c61-528">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="36c61-528">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="36c61-529">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="36c61-529">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="36c61-530">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="36c61-530">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="36c61-531">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="36c61-531">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="36c61-532">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="36c61-532">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="36c61-533">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="36c61-533">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="36c61-534">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="36c61-534">AzureRM.EventGrid</span></span>
* <span data-ttu-id="36c61-535">Удалены условия проверки ValidateNotNullOrEmpty для SubjectBeginsWith/SubjectEndsWith в командлете Update-AzureRmEventGridSubscription, что позволяет при необходимости заменять эти параметры пустой строкой.</span><span class="sxs-lookup"><span data-stu-id="36c61-535">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="36c61-536">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="36c61-536">AzureRM.KeyVault</span></span>
* <span data-ttu-id="36c61-537">Исправлена ошибка, когда при выполнении командлета Get-AzureRmKeyVault -Tag не возвращается ни один тег.</span><span class="sxs-lookup"><span data-stu-id="36c61-537">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="36c61-538">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="36c61-538">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="36c61-539">Общедоступный выпуск командлетов Policy Insights.</span><span class="sxs-lookup"><span data-stu-id="36c61-539">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="36c61-540">Используется API версии 2018-04-04.</span><span class="sxs-lookup"><span data-stu-id="36c61-540">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="36c61-541">К результатам Get-AzureRmPolicyStateSummary добавлено PolicyDefinitionReferenceId.</span><span class="sxs-lookup"><span data-stu-id="36c61-541">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="36c61-542">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="36c61-542">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="36c61-543">Для командлетов RecoveryServices.Backup добавлен параметр -Vault.</span><span class="sxs-lookup"><span data-stu-id="36c61-543">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="36c61-544">Передача этого параметра переопределяет командлет Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="36c61-544">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="36c61-545">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="36c61-545">AzureRM.Sql</span></span>
* <span data-ttu-id="36c61-546">В файле справки обновлен пример для командлета Get-AzureRmSqlDatabaseExpanded.</span><span class="sxs-lookup"><span data-stu-id="36c61-546">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="36c61-547">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="36c61-547">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="36c61-548">Обновлен файл справки для командлета Add-AzureRmTrafficManagerEndpointConfig.</span><span class="sxs-lookup"><span data-stu-id="36c61-548">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="36c61-549">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="36c61-549">AzureRM.Websites</span></span>
* <span data-ttu-id="36c61-550">Изменено действие командлета Set-AzureRmWebApp. Теперь он не перезаписывает AppSettings, если используется параметр -AssignIdentity.</span><span class="sxs-lookup"><span data-stu-id="36c61-550">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="36c61-551">Командлет New-AzureRmWebAppSlot теперь учитывает дополнительный параметр AppServicePlan.</span><span class="sxs-lookup"><span data-stu-id="36c61-551">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="36c61-552">6.2.1 — июнь 2018 г.</span><span class="sxs-lookup"><span data-stu-id="36c61-552">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="36c61-553">AzureRM.OperationalInsights;</span><span class="sxs-lookup"><span data-stu-id="36c61-553">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="36c61-554">В обновленной модели PSWorkspace Network может использовать type в качестве параметра.</span><span class="sxs-lookup"><span data-stu-id="36c61-554">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="36c61-555">6.2.0 — июнь 2018 г.</span><span class="sxs-lookup"><span data-stu-id="36c61-555">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="36c61-556">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="36c61-556">AzureRM.Profile</span></span>
* <span data-ttu-id="36c61-557">Исправлена ошибка с загрузкой Newtonsoft.Json версии 10.0.3 во время импорта модуля.</span><span class="sxs-lookup"><span data-stu-id="36c61-557">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="36c61-558">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="36c61-558">AzureRM.Compute</span></span>
* <span data-ttu-id="36c61-559">Функция обновления виртуальных машин VMSS.</span><span class="sxs-lookup"><span data-stu-id="36c61-559">VMSS VM Update feature</span></span>
    - <span data-ttu-id="36c61-560">Добавлены командлеты Update-AzureRmVmssVM и New-AzureRmVMDataDisk.</span><span class="sxs-lookup"><span data-stu-id="36c61-560">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="36c61-561">В командлет Add-AzureRmVMDataDisk добавлен параметр VirtualMachineScaleSetVM, который позволяет добавлять диски данных в виртуальные машины VMSS.</span><span class="sxs-lookup"><span data-stu-id="36c61-561">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="36c61-562">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="36c61-562">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="36c61-563">Пакет SDK для ADF .NET обновлен до версии 0.8.0-preview. Новая версия содержит такие изменения:</span><span class="sxs-lookup"><span data-stu-id="36c61-563">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="36c61-564">добавлена операция для настройки репозитория фабрики;</span><span class="sxs-lookup"><span data-stu-id="36c61-564">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="36c61-565">связанная служба QuickBooks LinkedService теперь предоставляет свойства consumerKey и consumerSecret;</span><span class="sxs-lookup"><span data-stu-id="36c61-565">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="36c61-566">тип нескольких моделей изменен с SecretBase на Object;</span><span class="sxs-lookup"><span data-stu-id="36c61-566">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="36c61-567">добавлен триггер событий BLOB-объектов.</span><span class="sxs-lookup"><span data-stu-id="36c61-567">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="36c61-568">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="36c61-568">AzureRM.KeyVault</span></span>
* <span data-ttu-id="36c61-569">В документацию добавлены примеры выходных данных.</span><span class="sxs-lookup"><span data-stu-id="36c61-569">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="36c61-570">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="36c61-570">AzureRM.Network</span></span>
* <span data-ttu-id="36c61-571">В командлеты Наблюдателя за сетями добавлены параметры Аналитики трафика.</span><span class="sxs-lookup"><span data-stu-id="36c61-571">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="36c61-572">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="36c61-572">AzureRM.Resources</span></span>
* <span data-ttu-id="36c61-573">Исправлена ошибка, когда командлет Get-AzureRmResource возвращает свойство Properties объектов PSResource.</span><span class="sxs-lookup"><span data-stu-id="36c61-573">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="36c61-574">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="36c61-574">AzureRM.Scheduler</span></span>
* <span data-ttu-id="36c61-575">Исправлена ошибка, когда обновление ServiceBusQueueJob не задает новые значения для проверки подлинности.</span><span class="sxs-lookup"><span data-stu-id="36c61-575">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="36c61-576">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="36c61-576">AzureRM.Sql</span></span>
* <span data-ttu-id="36c61-577">В перечисленные ниже командлеты добавлен необязательный параметр LicenseType.</span><span class="sxs-lookup"><span data-stu-id="36c61-577">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="36c61-578">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase;</span><span class="sxs-lookup"><span data-stu-id="36c61-578">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="36c61-579">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool;</span><span class="sxs-lookup"><span data-stu-id="36c61-579">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="36c61-580">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="36c61-580">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="36c61-581">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="36c61-581">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="36c61-582">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="36c61-582">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="36c61-583">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="36c61-583">AzureRM.Websites</span></span>
* <span data-ttu-id="36c61-584">Командлет New-AzureRMWebApp теперь использует общие алгоритмы из библиотеки Strategy.</span><span class="sxs-lookup"><span data-stu-id="36c61-584">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="36c61-585">6.1.0 — май 2018 г.</span><span class="sxs-lookup"><span data-stu-id="36c61-585">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="36c61-586">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="36c61-586">AzureRM.Profile</span></span>
* <span data-ttu-id="36c61-587">Устранена проблема с выполнением Clear-AzureRmContext, при которой сохранялся пустой контекст с именем предыдущего контекста по умолчанию, что не позволяло пользователю создать новый контекст со старым именем.</span><span class="sxs-lookup"><span data-stu-id="36c61-587">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="36c61-588">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="36c61-588">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="36c61-589">Включены операции связывания и отмены связи в автономной системе.</span><span class="sxs-lookup"><span data-stu-id="36c61-589">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="36c61-590">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="36c61-590">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="36c61-591">Добавлена поддержка ApiVersions, ApiReleases и ApiRevisions.</span><span class="sxs-lookup"><span data-stu-id="36c61-591">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="36c61-592">Добавлена поддержка серверной части ServiceFabric.</span><span class="sxs-lookup"><span data-stu-id="36c61-592">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="36c61-593">Добавлена поддержка средства ведения журнала Application Insights.</span><span class="sxs-lookup"><span data-stu-id="36c61-593">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="36c61-594">Добавлена поддержка для распознавания номера SKU уровня "Базовый" как допустимого номера SKU службы управления API.</span><span class="sxs-lookup"><span data-stu-id="36c61-594">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="36c61-595">Добавлена поддержка установки сертификатов, выданных частным центром сертификации в качестве корневого или обычного ЦС.</span><span class="sxs-lookup"><span data-stu-id="36c61-595">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="36c61-596">Добавлена поддержка для приема пользовательских SSL-сертификатов с помощью KeyVault и нескольких имен узлов прокси-сервера.</span><span class="sxs-lookup"><span data-stu-id="36c61-596">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="36c61-597">Добавлена поддержка для удостоверения MSI.</span><span class="sxs-lookup"><span data-stu-id="36c61-597">Added support for MSI identity</span></span>
* <span data-ttu-id="36c61-598">Добавлена поддержка для принятия политик с помощью URL-адреса. Примечание. Указанные ниже командлеты в следующей версии будут отмечены как нерекомендуемые.</span><span class="sxs-lookup"><span data-stu-id="36c61-598">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="36c61-599">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="36c61-599">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="36c61-600">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="36c61-600">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="36c61-601">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="36c61-601">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="36c61-602">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="36c61-602">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="36c61-603">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="36c61-603">AzureRM.Batch</span></span>
* <span data-ttu-id="36c61-604">Выпущен новый командлет Get-AzureBatchPoolNodeCounts.</span><span class="sxs-lookup"><span data-stu-id="36c61-604">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="36c61-605">Выпущен новый командлет Start-AzureBatchComputeNodeServiceLogUpload.</span><span class="sxs-lookup"><span data-stu-id="36c61-605">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="36c61-606">AzureRM.Consumption:</span><span class="sxs-lookup"><span data-stu-id="36c61-606">AzureRM.Consumption</span></span>
* <span data-ttu-id="36c61-607">Добавлены новые параметры Expand, ResourceGroup, InstanceName, InstanceId, Tags и командлет высшего уровня Get-AzureRmConsumptionUsageDetail.</span><span class="sxs-lookup"><span data-stu-id="36c61-607">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="36c61-608">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="36c61-608">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="36c61-609">Исправлен пример для Export-AzureRmDataLakeStoreChildItemProperties.</span><span class="sxs-lookup"><span data-stu-id="36c61-609">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="36c61-610">Исправлено исключение параметра NULL при использовании рекурсии в Set-AzureRmDataLakeStoreItemAclEntry.</span><span class="sxs-lookup"><span data-stu-id="36c61-610">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="36c61-611">Исправлены файлы справки для Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl и Remove-AzureRmDataLakeStoreItemAclEntry.</span><span class="sxs-lookup"><span data-stu-id="36c61-611">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="36c61-612">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="36c61-612">AzureRM.Network</span></span>
* <span data-ttu-id="36c61-613">Пакет SDK для сети обновлен с предварительной версии 18.0.0 до предварительной версии 19.0.0.</span><span class="sxs-lookup"><span data-stu-id="36c61-613">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="36c61-614">Добавлен командлет для создания конфигурации протокола.</span><span class="sxs-lookup"><span data-stu-id="36c61-614">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="36c61-615">New-AzureRmNetworkWatcherProtocolConfiguration.</span><span class="sxs-lookup"><span data-stu-id="36c61-615">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="36c61-616">Добавлен командлет для добавления нового подключения канала к существующему каналу ExpressRoute.</span><span class="sxs-lookup"><span data-stu-id="36c61-616">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="36c61-617">Add-AzureRmExpressRouteCircuitConnectionConfig.</span><span class="sxs-lookup"><span data-stu-id="36c61-617">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="36c61-618">Добавлен командлет для удаления подключения канала к существующему каналу ExpressRoute.</span><span class="sxs-lookup"><span data-stu-id="36c61-618">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="36c61-619">Remove-AzureRmExpressRouteCircuitConnectionConfig.</span><span class="sxs-lookup"><span data-stu-id="36c61-619">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="36c61-620">Добавлен командлет для получения подключения канала.</span><span class="sxs-lookup"><span data-stu-id="36c61-620">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="36c61-621">Get-AzureRmExpressRouteCircuitConnectionConfig.</span><span class="sxs-lookup"><span data-stu-id="36c61-621">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="36c61-622">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="36c61-622">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="36c61-623">Исправлена процедура аутентификации сервера с использованием созданных сертификатов (проблема № 5998).</span><span class="sxs-lookup"><span data-stu-id="36c61-623">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="36c61-624">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="36c61-624">AzureRM.Sql</span></span>
* <span data-ttu-id="36c61-625">Обновлены командлеты аудита, которые теперь позволяют удалять AuditActions или AuditActionGroups.</span><span class="sxs-lookup"><span data-stu-id="36c61-625">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="36c61-626">Исправлена проблема с Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy, при которой установка новой гибкой политики хранения завершалась ошибкой с сообщением "Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span><span class="sxs-lookup"><span data-stu-id="36c61-626">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="36c61-627">Please submit request with the new flexible retention policy" (Настройка политики долгосрочного хранения с помощью хранилища и политики служб восстановления Azure больше не поддерживается. Отправьте запрос с использованием новой гибкой политики хранения).</span><span class="sxs-lookup"><span data-stu-id="36c61-627">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="36c61-628">Обновлены все командлеты, связанные со службой "База данных SQL Azure", с созданием эластичных пулов и обновлением. Теперь используются новые API баз данных с поддержкой свойства номеров SKU для обеспечения масштабируемости и связанных с уровнями возможностей.</span><span class="sxs-lookup"><span data-stu-id="36c61-628">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="36c61-629">Обновлены командлеты, в том числе:</span><span class="sxs-lookup"><span data-stu-id="36c61-629">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="36c61-630">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase;</span><span class="sxs-lookup"><span data-stu-id="36c61-630">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="36c61-631">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool;</span><span class="sxs-lookup"><span data-stu-id="36c61-631">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="36c61-632">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="36c61-632">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="36c61-633">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="36c61-633">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="36c61-634">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="36c61-634">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="36c61-635">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="36c61-635">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="36c61-636">Обновлены параметры для Get-AzureRmTrafficManagerProfile. Теперь при использовании параметра -Name требуется параметр -ResourceGroupName.</span><span class="sxs-lookup"><span data-stu-id="36c61-636">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
