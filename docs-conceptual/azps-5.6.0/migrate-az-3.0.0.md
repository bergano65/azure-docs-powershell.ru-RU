...
Псевдоним `Get-AzSqlDatabaseIndexRecommendations` удален. Взамен рекомендуется использовать `Get-AzSqlDatabaseIndexRecommendation`.

### `Get-AzSqlDatabaseRestorePoints`
Псевдоним `Get-AzSqlDatabaseRestorePoints` удален. Взамен рекомендуется использовать `Get-AzSqlDatabaseRestorePoint`.
