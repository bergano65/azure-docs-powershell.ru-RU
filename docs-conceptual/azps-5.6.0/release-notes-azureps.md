...
## <a name="560---march-2021"></a>5.6.0 — март 2021 г.
#### <a name="azaccounts"></a>Az.Accounts
* Выполнено обновление Azure.Identity для исправления проблемы, которая приводила к сбою Connect-AzAccount при использовании учетных данных ADFS [№ 13560].

#### <a name="azautomation"></a>Az.Automation
* Исправлена проблема, из-за которой не удавалось корректно сериализовать строку. [№ 14215]
* Добавлена поддержка для типа runbook Python 3.

#### <a name="azcompute"></a>Az.Compute
* Добавлен параметр -EnableHotpatching к командлету Set-AzVMOperatingSystem для компьютеров Windows. 
* Добавлен параметр -PatchMode к набору параметров Linux в командлете Set-AzVMOperatingSystem. 
* [Критическое изменение] Критические изменения для пользователей, использующих общедоступную предварительную версию функции для обновления гостевых виртуальных машин.
    - Удалено свойство RebootStatus из объекта Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary. 
    - Удалено свойство StartedBy из объекта Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary.
    - Свойство Kbid переименовано в KbId в объекте Microsoft.Azure.Management.Compute.Models.VirtualMachineSoftwarePatchProperties. 
    - Свойство patches переименовано в availablePatches в объекте Microsoft.Azure.Management.Compute.Models.VirtualMachineAssessPatchesResult. 
    - Объект Microsoft.Azure.Management.Compute.Models.SoftwareUpdateRebootBehavior переименован в Microsoft.Azure.Management.Compute.Models.VMGuestPatchRebootBehavior.
    - Объект Microsoft.Azure.Management.Compute.Models.InGuestPatchMode переименован в Microsoft.Azure.Management.Compute.Models.WindowsVMGuestPatchMode.
* [Критическое изменение] Удалены все командлеты ContainerService. Поддержка API службы контейнеров прекращена в январе 2020 г. 
...
* Исправлена проверка подлинности для `Connect-AzContainerRegistry`.

#### <a name="azcosmosdb"></a>Az.CosmosDB
* Добавлены NetworkAclBypass и NetworkAclBypassResourceIds для командлетов учетной записи базы данных.
* Добавлен параметр ServerVersion к Update-AzCosmosDBAccount.
* Добавлены BackupInterval и BackupRetention для командлетов Database Account.

#### <a name="azdatafactory"></a>Az.DataFactory
* Обновлена версия пакета SDK .NET ADF до 4.14.0.

#### <a name="azmigrate"></a>Az.Migrate
* Выпущена общедоступная версия Az.Migrate.
* Добавлен Initialize-AzMigrateReplicationInfrastructure в виде командлета в модуле Az.Migrate (из внешнего скрипта, который выполняется в настоящее время).
* Для некоторых параметров New-AzMigrateServerReplication, New-AzMigrateDiskMapping отключена чувствительность к регистру.
* Добавлена поддержка для изменения устройства масштабирования с целью обработки новых ключей версии 3.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Добавлена проверка значений NULL для целевой учетной записи хранения при восстановлении общей папки.

#### <a name="azresources"></a>Az.Resources
* Добавлена поддержка для развертывания ресурсов Azure в языке Bicep.
* Исправлены проблемы с развертываниями TemplateSpec в New-AzTenantDeployment и New-AzManagementGroupDeployment.
* Добавлена поддержка параметра -QueryString в командлетах Test-Az*Deployments.
* Исправлена проблема с динамическими параметрами при использовании New-Az*Deployments с -QueryString.
* Добавлена поддержка параметра -TemplateParameterObject при использовании параметра -TemplateSpecId в командлетах New-Az*Deployments.
* Исправлено неверное сообщение об ошибке, отображаемое при попытке развернуть несуществующую спецификацию шаблона.

#### <a name="azstorage"></a>Az.Storage
* Для Microsoft.Azure.Management.Storage выполнено обновление до версии 19.0.0 для поддержки новой версии API 2021-01-01.
* Поддерживается правило доступа к ресурсам в NetworkRuleSet.
    - Update-AzStorageAccountNetworkRuleSet;
    - Add-AzStorageAccountNetworkRule.
    - Remove-AzStorageAccountNetworkRule
* Поддерживается версия BLOB-объектов и тип добавочных BLOB-объектов в политике управления.
    - Add-AzStorageAccountManagementPolicyAction
    - New-AzStorageAccountManagementPolicyFilter
    - Set-AzStorageAccountManagementPolicy
* Поддерживается создание и обновление учетной записи с помощью AllowSharedKeyAccess.
    - New-AzStorageAccount
    - Set-AzStorageAccount
* Поддерживается создание области шифрования с помощью RequireInfrastructureEncryption.
    - New-AzStorageEncryptionScope;
* Поддерживается синхронное копирование блочного BLOB-объекта с областью шифрования.
    - Copy-AzStorageBlob
* Исправлена проблема, при которой Get-AzStorageBlobContent использовал неправильный символ разделителя каталогов в Linux и MacOS [№ 14234].

#### <a name="azwebsites"></a>Az.Websites
* Добавлена возможность задать настраиваемое время ожидания для Publish-AzWebApp. 
* Добавлена поддержка для Среды службы приложений.
...
* @alunmj, небольшие исправления орфографии и форматирования (№ 14155).
* @chakra146, обновление файла Add-AzLoadBalancerInboundNatPoolConfig.md (№ 14231).
* Мартин Эрнст (Martin Ehrnst) (@ehrnst), исправлена опечатка в командлете (№ 14112).
* Ян Дэвид Наркивич (Jan David Narkiewicz) (@jdnark).
  * В примерах используется New-AzAks, который является устаревшим командлетом и псевдонимом для New-AzAksCluster. Примеры изменены для использования New-AzAksCluster, который является командлетом, указанным на этой странице документации. (№ 14088)
  * Исправление опечатки: SshKeyVaule изменено на SshKeyValue (№ 14087).
* Иван Кулезич (Ivan Kulezic) (@kukislav), добавлены примеры конфигурации обслуживания sql mi (№ 14216).
* @webguynj, обновление файла Set-AzNetworkSecurityRuleConfig.md (№ 14176).
* Янник Дилс (Yannick Dils) (@yannickdils), добавлен дополнительный запрос командной строки в пример, который применяет изменения к подсистеме балансировки нагрузки (№ 14185).

## <a name="550---february-2021"></a>5.5.0 — февраль 2021 г.
#### <a name="azaccounts"></a>Az.Accounts
* Отслежен код ошибки CloudError в исключении.
* Событие ContextCleared вызывается при выполнении Clear-AzContext.

#### <a name="azaks"></a>Az.Aks
* Уточнены сообщения об ошибках при сбое командлета.
* Обновлена обработка исключений для использования связанных с Azure PowerShell исключений.
* Исправлена проблема, из-за которой пользователь не мог использовать предоставленный субъект-службу для создания кластера Kubernetes. [№ 13938]

#### <a name="azautomation"></a>Az.Automation
* Исправлена проблема с обработкой PSCustomObject и Array.

#### <a name="azcompute"></a>Az.Compute
* Добавлен параметр -EnableAutomaticUpgrade к командлетам Set-AzVmExtension и Add-AzVmssExtension.
* Удален параметр FilterExpression из документации по командлету Get-AzVMImage. 
* Добавлено сообщение о прекращении поддержки в командлеты ContainerService:
    ...
    - Remove-AzContainerServiceAgentPoolProfile;
    - Update-AzContainerService.
* Добавлен параметр -BurstingEnabled к командлетам New-AzDiskConfig и New-AzDiskUpdateConfig.
* Добавлены параметры -GroupByApplicationId и -GroupByUserAgent к командлетам Export-AzLogAnalyticThrottledRequest и Export-AzLogAnalyticRequestRateByInterval.
* Добавлен набор параметров VMParameterSet к командлету Get-AzVMExtension. В этот набор параметров добавлен параметр -VM. 

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Добавлены командлеты для поддерживаемых операций репозитория, манифеста и тегов:
...
Реализована поддержка -EnableNoPublicIP при создании рабочей области Databricks.

#### <a name="azfrontdoor"></a>Az.FrontDoor
* Добавлено свойство FrontDoorId.
* Добавлена поддержка исключений JSON и RequestBodyCheck в управляемые правила.

#### <a name="azhdinsight"></a>Az.HDInsight
* Добавлены новые параметры -EnableComputeIsolation и -ComputeIsolationHostSku к командлету New-AzHDInsightCluster для поддержки функции изоляции вычислительных ресурсов.
* Добавлены свойства ComputeIsolationProperties и ConnectivityEndpoints к классу AzureHDInsightCluster.

#### <a name="azkeyvault"></a>Az.KeyVault
* Реализована поддержка указания типа ключа и имени кривой при импортировании ключей через собственный файл ключа (BYOK).

#### <a name="aznetwork"></a>Az.Network
* Добавлены новые командлеты для замены старого имени продукта virtual router новым именем route server в будущем:
    - New-AzRouteServer;
    - Get-AzRouteServer;
    ...
    - Добавлено предупреждение с атрибутом отмены поддержки в старые командлеты.
* Исправлена ошибка в MacSecConfig ExpressRouteLink. Добавлено новое свойство SciState в PSExpressRouteLinkMacSecConfig.
* Обновлен список форматов и представления таблиц форматов для Get-AzVirtualNetworkGatewayConnectionIkeSa.

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Отменены изменения в PowerShell, которые привели к увеличению ограничения на строки запросов. Удалено неверное утверждение по поддержке разбиения на страницы.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Изменены ограничения для проверки политики в соответствии с параметрами службы резервного копирования.
* Добавлена избыточность между зонами для хранилищ Служб восстановления. 
* Добавлена поддержка Site Recovery для группы размещения близкого взаимодействия для VMware в Azure и HyperV для поставщиков Azure.
* Добавлена поддержка Azure Site Recovery для зоны доступности для VMware в Azure и HyperV для поставщиков Azure.
* Добавлена поддержка Azure Site Recovery для UseManagedDisk для HyperV в поставщик Azure.

#### <a name="azresources"></a>Az.Resources
* Удален тип субъекта в командлетах New-AzRoleAssignment и Set-AzRoleAssignment, так как текущие сопоставления приводили к ошибкам в определенных сценариях.

#### <a name="azsql"></a>Az.Sql
* Добавлен MaintenanceConfigurationId к командлетам New-AzSqlDatabase, Set-AzSqlDatabase, New-AzSqlElasticPool и Set-AzSqlElasticPool.
* Исправлена регрессия в Set-AzSqlServerAudit при указании аргумента PredicateExpression.

#### <a name="azstorage"></a>Az.Storage
* Добавлены поддержка параметров RoutingPreference в операциях создания и обновления учетной записи хранения.
    - New-AzStorageAccount
    - Set-AzStorageAccount
* Обновлена версия Azure.Storage.Blobs до 12.8.0.
* Обновлена версия Azure.Storage.Files.Shares до 12.6.0.
* Обновлена версия Azure.Storage.Files.DataLake до 12.6.0.

#### <a name="azwebsites"></a>Az.Websites
* Добавлена поддержка для импорта сертификатов хранилища ключей в WebApp.

### <a name="thanks-to-our-community-contributors"></a>Благодарим наших участников сообщества
* @atul-ram, обновление Set-AzEventHub.md (№ 13921).
* Кристоф Бергмайстер (Christoph Bergmeister) [MVP] (@bergmeister), Set-AzDataLakeGen2AclRecursive.md — исправление опечатки (directiry -> directory) (№ 14082).
* Александр Шмидт (Alexander Schmidt) (@devdeer-alex), исправлена неработающая ссылка на рекомендации по добавлению изменений (№ 14009).
* @JiangYuchun, обновление Get-AzApplicationGatewayAuthenticationCertificate.md (№ 13972).
* Себастиан Олсен (Sebastian Olsen) (@Spacebjorn), исправление примера команды (№ 13901).

## <a name="540---january-2021"></a>5.4.0 — январь 2021 г.
#### <a name="azaccounts"></a>Az.Accounts
* Отображение правильного идентификатора запроса клиента в сообщении отладки [№ 13745].
* Добавлен общий тип исключений Azure PowerShell.
* Поддерживаемый API хранилища 2019-06-01.

#### <a name="azautomation"></a>Az.Automation
* Исправлена проблема, из-за которой описание не было заполнено для расписаний управления обновлениями.

#### <a name="azcosmosdb"></a>Az.CosmosDB
* Выпущена общедоступная версия модуля Az.CosmosDB.
* Ограничено действие командлета New-AzCosmosDBAccount, чтобы выполнять вызовы обновления к существующим учетным записям базы данных.
* Реализация AnalyticalStorageTTL в SqlContainer.

#### <a name="aziothub"></a>Az.IotHub
* Исправлена регрессия, связанная с созданием маркера SAS.

#### <a name="azkeyvault"></a>Az.KeyVault
* Исправлена проблема в модуле управления секретами.

#### <a name="azlogicapp"></a>Az.LogicApp
* Исправлена проблема, из-за которой Get-AzLogicAppTriggerHistory и Get-AzLogicAppRunAction получали только первую страницу результатов [№ 9141].

#### <a name="azmonitor"></a>Az.Monitor
* Добавлены командлеты для правил сбора данных: 
    - Get-AzDataCollectionRule
    - New-AzDataCollectionRule
    - Set-AzDataCollectionRule
    - Update-AzDataCollectionRule
    - Remove-AzDataCollectionRule
* Добавлены командлеты для связей правил сбора данных:
    - Get-AzDataCollectionRuleAssociation
    - New-AzDataCollectionRuleAssociation
    - Remove-AzDataCollectionRuleAssociation

#### <a name="aznetwork"></a>Az.Network
* Добавлены новые командлеты для CRUD VpnGatewayNATRule:
    - New-AzVpnGatewayNatRule;
    - Update-AzVpnGatewayNatRule;
    - Get-AzVpnGatewayNatRule;
    - Remove-AzVpnGatewayNatRule.  
* Обновлены командлеты, чтобы задать правило NATRule для ресурса VpnGateway и связать его с ресурсом VpnSiteLinkConnection:
    - New-AzVpnGateway
    - Update-AzVpnGateway 
    - New-AzVpnSiteLinkConnection
* Обновлены командлеты для включения ConnectionMode в подключениях шлюзов виртуальных сетей:
    - New-AzVirtualNetworkGatewayConnection
    - Set-AzVirtualNetworkGatewayConnection
* Обновлен командлет New-AzFirewallPolicyApplicationRule:
    - добавлен параметр TargetUrl;
    - добавлен параметр TerminateTLS.
* Добавлены новые командлеты для расширенных функций Брандмауэра Azure:
    - New-AzFirewallPolicyIntrusionDetection
    - New-AzFirewallPolicyIntrusionDetectionBypassTraffic
    - New-AzFirewallPolicyIntrusionDetectionSignatureOverride
* Обновлен командлет New-AzFirewallPolicy:
    - добавлен параметр -SkuTier;
    - добавлен параметр -Identity;
    - добавлен параметр -UserAssignedIdentityId;
    - добавлен параметр -IntrusionDetection;
    - добавлен параметр -TransportSecurityName;
    - добавлен параметр -TransportSecurityKeyVaultSecretId.
* Добавлен новый командлет для сбора данных о сопоставлениях безопасности IKE для подключений шлюза виртуальной сети:
    - Get-AzVirtualNetworkGatewayConnectionIkeSa
* Добавлена поддержка множественной проверки подлинности для p2sVpnGateway.
    - Обновлены командлеты New-AzVpnServerConfiguration и Update-AzVpnServerConfiguration, разрешающие настройку нескольких параметров проверки подлинности.
* Обновлены командлеты New-AzVpnGateway и New-AzP2sVpnGateway:
    - добавлен параметр EnableRoutingPreferenceInternetFlag.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Добавлена функция восстановления между регионами.  
* Заблокировано получение конфигурации рабочей нагрузки, когда целевой элемент является группой доступности.

#### <a name="azresources"></a>Az.Resources
* Включена поддержка параметра -QueryString в командлетах New-Az*Deployments.

#### <a name="azsql"></a>Az.Sql
* Командлет Start-AzSqlInstanceDatabaseLogReplay сделан синхронным и добавлен флаг -AsJob.

#### <a name="azstorage"></a>Az.Storage
* Исправлена проблема, из-за которой ContinuationToken никогда не имеет значение NULL при использовании большого двоичного объекта списка с параметром -IncludeVersion.
    - Get-AzStorageBlob

#### <a name="azwebsites"></a>Az.Websites
* Включена поддержка управляемых сертификатов Службы приложений:
    - New-AzWebAppCertificate
    - Remove-AzWebAppCertificate
* Исправлена проблема, из-за которой пароль Docker удалялся из appsettings в Set-AzWebApp и Set-AzWebAppSlot.

### <a name="thanks-to-our-community-contributors"></a>Благодарим наших участников сообщества
* Иван Акчеуров (Ivan Akcheurov) (@ivanakcheurov), обновление Set-AzSecurityWorkspaceSetting.md (№ 13877).
* @javiermarasco, пример обновления (№ 13837).
* @jhaprakash26, обновление Set-AzVirtualNetwork.md (№ 13857).
* Майкл Холмс (Michael Holmes) (@MichaelHolmesWP), обновление New-AzStorageTableStoredAccessPolicy.md (№ 13871).
* Майкл Джеймс (Michael James) (@mikejwhat), настройка Get-AzLogicAppTriggerHistory и Get-AzLogicAppRunAction на возвращение более 30 результатов (№ 13846).
* @Willem-J-an, исправление проблемы, из-за которой пароль Docker удалялся из appsettings в Set-AzWebApp(Slot) (№ 13866).

## <a name="530---december-2020"></a>5.3.0 — декабрь 2020 г.
#### <a name="azaccounts"></a>Az.Accounts
* Исправлена проблема, из-за которой прокси-сервер HTTP не учитывался в Windows PowerShell [№ 13647].
* Улучшен журнал отладки для длительных операций в созданных модулях.

#### <a name="azautomation"></a>Az.Automation
* Исправлена проблема, из-за которой упакованную строку PSObject не удавалось преобразовать в строку JSON с помощью параметров Start-AzAutomationRunbook [№ 13240].
* Исправлено средство заполнения расположения для командлета New-AzAutomationUpdateManagementAzureQuery.

#### <a name="azcompute"></a>Az.Compute
* В командлеты Get-AzVMDscExtensionStatus и Get-AzVMDscExtension добавлен новый параметр VM в новом наборе параметров VMParameterSet. 

#### <a name="azdatabricks"></a>Az.Databricks
* Исправлена проблема, из-за которой иногда возвращался результат New-AzDatabricksVNetPeering перед полной подготовкой (https://github.com/Azure/autorest.powershell/issues/610)

#### <a name="azdatafactory"></a>Az.DataFactory
* Исправлена команда Invoke-AzDataFactoryV2Pipeline для устранения проблемы с SupportsShouldProcess.

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* В пул узлов добавлено свойство StartVMOnConnect.

#### <a name="azhdinsight"></a>Az.HDInsight
* В класс AzureHDInsightHostInfo добавлены свойства Fqdn и EffectiveDiskEncryptionKeyUrl.

#### <a name="azkeyvault"></a>Az.KeyVault
* В Get-AzKeyVaultSecret добавлен новый параметр -AsPlainText для прямого возврата секрета в виде обычного текста [№ 13630].
* Поддерживается выборочное восстановление ключа из управляемой полной резервной копии HSM [№ 13526].
* Устранены некоторые незначительные проблемы [№ 13583] [№ 13584].
* В модуль SecretManagement добавлены отсутствующие возвращаемые объекты Get-Secret.
* Исправлена проблема, из-за которой хранилище иногда создавалось без политики доступа по умолчанию [№ 13687].

#### <a name="azkusto"></a>Az.Kusto
* Версия API обновлена до 2020-09-18.

#### <a name="aznetwork"></a>Az.Network
* Исправлена проблема с удалением пиринга и командлетом подключения для сценария ExpressRouteCircuit:
    - Remove-AzExpressRouteCircuitPeeringConfig и Remove-AzExpressRouteCircuitConnectionConfig.

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Добавлена поддержка возврата страничных результатов для Get-AzPolicyState.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Включена функция обратимого удаления для SQL.
* Исправлена проблема с восстановлением групп доступности AG и удалена проверка имени контейнера.
* Изменен формат имени контейнера для элемента резервного копирования Файлов Azure.
* Добавлена поддержка функции CMK для хранилища служб восстановления.

#### <a name="azresources"></a>Az.Resources
* Устранена проблема с исключением NullRef в New-AzureManagedApplication и Set-AzureManagedApplication.
* Обновлен пакет SDK Azure Resource Manager для использования последней общедоступной версии API DeploymentScripts: 2020-10-01.

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Внесены исправления в Add-AzServiceFabricNodeType. Добавлен тип узла, который можно использовать для кластера Service Fabric перед созданием масштабируемого набора виртуальных машин.

#### <a name="azsql"></a>Az.Sql
* Исправлено описание параметра для команды InstanceFailoverGroup.
* Обновлена логика, согласно которой данные типа schemaName, tableName и columnName извлекались из идентификатора команд классификации данных SQL.
* Исправлены поля Status и StatusMessage в Get-AzSqlDatabaseImportExportStatus, чтобы обеспечить соответствие документации.
* Добавлены командлеты аудита для операций поддержки Майкрософт (DevOps): Get-AzSqlServerMSSupportAudit, Set-AzSqlServerMSSupportAudit, Remove-AzSqlServerMSSupportAudit.

#### <a name="azstorage"></a>Az.Storage
* Поддерживаемые операции создания, обновления, получения и перечисления EncryptionScope учетной записи хранения:
    - New-AzStorageEncryptionScope;
    - Update-AzStorageEncryptionScope;
    - Get-AzStorageEncryptionScope.
* Поддерживаемые операции создания контейнера и отправки большого двоичного объекта с параметром области шифрования:
    - New-AzRmStorageContainer;
    - New-AzStorageContainer;
    - Set-AzStorageBlobContent

### <a name="thanks-to-our-community-contributors"></a>Благодарим наших участников сообщества
* Андреас Уолтер (Andreas Wolter) (@AndreasWolter), удален маркетинговый стиль, улучшен пример фильтра (№ 13671).
* Тиджани Белмансаур (Tidjani Belmansour) (@BelRarr), обновлен файл Get-AzBillingInvoice.md (№ 13634).
* Дэвид Клемпфнер (David Klempfner) (@DavidKlempfner):
  * исправлена орфографическая ошибка (№ 13677);
  * обновлен файл PSMetricNoDetails.cs (№ 13676).
* @kilobyte97, исправлена ошибка командлета для удаления конфигурации (№ 13655).
* @kongou-ae, обновлен файл Set-AzFirewall.md (№ 13727).
* @MasterKuat, исправлено переключение между заголовком и кодом в документации (№ 13666).
* NickT (@nukeulis), обновлен файл Set-AzContext.md (№ 13702).
* @PaulHCode, обновлен файл Start-AzJitNetworkAccessPolicy.md: исправлен пример для отображения правильного демонстрируемого командлета (№ 13713).
* Райан Борстельманн (Ryan Borstelmann) (@ryanborMSFT), удален идентификатор подписки (№ 13715).
* Шашикант Шакья (Shashikant Shakya) (@shshakya), обновлен файл Set-AzSqlDatabase.md (№ 13674).
* Себастиан Олсен (Sebastian Olsen) (@Spacebjorn),обновлен файл Get-AzRecoveryServicesBackupItem.md (№ 13719).

## <a name="520---december-2020"></a>5.2.0 — декабрь 2020 г.
#### <a name="azaccounts"></a>Az.Accounts
* Теперь выполняется анализ времени ExpiresOn из необработанного токена, если не удается получить эти данные из базовой библиотеки.
* Улучшено сообщение с предупреждением, если недоступна интерактивная аутентификация.

#### <a name="azapimanagement"></a>Az.ApiManagement
* [Критическое изменение] New-AzApiManagementProduct по умолчанию не имеет ограничения на подписку.

#### <a name="azcompute"></a>Az.Compute
* Изменен командлет Get-AzVm для фильтрации по параметру -Name до проверки регулирования вследствие большого числа ресурсов. 
* Добавлен новый командлет Start-AzVmssRollingExtensionUpgrade.

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Реализована поддержка параметра Name для Get-AzContainerRegistryUsage и значение из входных данных конвейера для этого командлета. [13605]
* Улучшены исключения для Connect-AzContainerRegistry.

#### <a name="azdatafactory"></a>Az.DataFactory
* Пакет SDK ADF для .NET обновлен до версии 4.13.0.

#### <a name="azhealthcareapis"></a>Az.HealthcareApis
* Добавлена поддержка ключей, управляемых клиентом.

#### <a name="aziothub"></a>Az.IotHub
* Исправлена ошибка маркера SAS.

#### <a name="azkeyvault"></a>Az.KeyVault
* Добавлена поддержка all в качестве параметра при настройке политик доступа для хранилища ключей.
* Реализована поддержка новой версии модуля SecretManagement [13366].
* Реализована поддержка ByteArray, String, PSCredential и Hashtable для SecretValue в SecretManagementModule [12190].
* [Критическое изменение] Перепроектирована контактная зона API командлетов, связанных с управляемым устройством HSM.

#### <a name="azmonitor"></a>Az.Monitor
* Изменен параметр Rule командлета New-AzAutoscaleProfile для приема пустого списка. [12903]
* Добавлены новые командлеты для более гибкой поддержки создания диагностических параметров:
    * Get-AzDiagnosticSettingCategory;
    * New-AzDiagnosticSetting;
    * New-AzDiagnosticDetailSetting.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Внесены изменения в текст справки и названия набора параметров для командлета Restore-AzRecoveryServicesBackupItem.

#### <a name="azresources"></a>Az.Resources
* Добавлена поддержка параметра -Tag в командлеты Set-AzTemplateSpec и New-AzTemplateSpec.
* Добавлена поддержка отображения тегов в форматировщик по умолчанию для функции "Спецификации шаблонов". 

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Добавлен пример в командлет Set-AzServiceFabricSetting с параметром SettingsSectionDescription.
* Обновлены связанные с приложениями командлеты для отображения сведений о том, что поддержка доступна только для ресурсов, развернутых через ARM.
* Помечены нерекомендуемыми командлеты сертификации кластера Add-AzureRmServiceFabricClusterCertificate и Remove-AzureRmServiceFabricClusterCertificate.

#### <a name="azsql"></a>Az.Sql
* Добавлен тип SecondaryType к следующим командлетам: 
    - New-AzSqlDatabase;
    - Set-AzSqlDatabase;
    - New-AzSqlDatabaseSecondary.
* Добавлен параметр HighAvailabilityReplicaCount к следующим командлетам: 
    - New-AzSqlDatabase;
    - Set-AzSqlDatabase.
* ReadReplicaCount теперь является псевдонимом HighAvailabilityReplicaCount для таких командлетов: 
    - New-AzSqlDatabase;
    - Set-AzSqlDatabase.

#### <a name="azstorage"></a>Az.Storage
* Реализована поддержка для отправки файла Azure размером до 4 TиБ.
    - Set-AzStorageFileContent;
* Версия Azure.Storage.Blobs обновлена до 12.7.0.
* Версия Azure.Storage.Files.Shares обновлена до 12.5.0.
* Версия Azure.Storage.Files.DataLake обновлена до 12.5.0.

#### <a name="azstoragesync"></a>Az.StorageSync
* Добавлена функция политики распределения по уровням в службе "Синхронизация файлов" с политикой скачивания и режимом локального кэша.

#### <a name="azwebsites"></a>Az.Websites
* Теперь предотвращается создание дубликатов для правил ограничения доступа.

### <a name="thanks-to-our-community-contributors"></a>Благодарим наших участников сообщества
* Эндрю Доусона (Andrew Dawson) (@dawsonar802) за обновление Get-AzKeyVaultCertificate.md (получение сертификата и его сохранение в виде раздела pfx для работы с PowerShell Core) (13557).
* @iviark за обновление BYOK Powershell в API для здравоохранения (13518).
* Джона Дакмантона (John Duckmanton) (@johnduckmanton) за исправление написания TagPatchOperation (13508).
* Майкла Джеймса (Michael James) (@mikejwhat):
  * за корректировку справки по Get-AzLogicAppRunHistory (13513).
* Ричарда де Цварта (Richard de Zwart) (@mountain65):
  * за обновление Update-AzAppConfigurationStore.md (13485);
  * за обновление Update New-AzCosmosDBAccount.md (13490).
* @SteppingRazor, New-AzApiManagementProduct: за изменение значения по умолчанию для параметра SubscriptionsLimit на None (13457).
* Стива Баркетта (Steve Burkett) (@SteveBurkettNZ) за исправление ошибки для параметра WorkspaceResourceId в примере (13589).

## <a name="510---november-2020"></a>5.1.0 — ноябрь 2020 г.
#### <a name="azaccounts"></a>Az.Accounts
* Исправлена проблема, из-за которой TenantId может не учитываться при использовании Connect-AzAccount -DeviceCode [№13477].
* Добавлен новый командлет Get-AzAccessToken.
* Исправлена проблема, которая возникает, если путь к профилю пользователя недоступен.
* Исправлена проблема, вызывающая ошибку записи объекта при использовании Connect-AzAccount [№13419].
* Добавлен параметр ContainerRegistryEndpointSuffix в Add-AzEnvironment и Set-AzEnvironment. 
* Поддерживается прерывание входа при нажатии клавиш <kbd>CTRL</kbd>+<kbd>C</kbd>.
* Исправлена проблема, из-за которой командлет Connect-AzAccount -KeyVaultAccessToken не работает [№13127].
* Исправлена пустая ссылка и обработка метода без учета регистра в Invoke-AzRestMethod.

#### <a name="azaks"></a>Az.Aks
* Исправлена проблема, из-за которой пользователь не может использовать субъект-службу для создания нового кластера Kubernetes. [№13012]

#### <a name="azappconfiguration"></a>Az.AppConfiguration
* Вышла общедоступная версия модуля Az.AppConfiguration.

#### <a name="azdatafactory"></a>Az.DataFactory
* Улучшено сообщение об ошибке для команды New-AzDataFactoryV2LinkedServiceEncryptedCredential.

#### <a name="azdatalakestore"></a>Az.DataLakeStore
* Обновлен отдельный пакет SDK ADLS до версии 1.2.4-alpha. Изменения: https://github.com/Azure/azure-data-lake-store-net/blob/preview-alpha/CHANGELOG.md#version-124-alpha

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Добавлены новые командлеты пакета MSIX и обновлены командлеты приложений.

#### <a name="azeventhub"></a>Az.EventHub
* Исправлены команды кластера для кластера EventHub без тегов.
* Обновлен текст справки для PartnerNamespace команд AzEventHubGeoDRConfiguration. 

#### <a name="azhdinsight"></a>Az.HDInsight
* Добавлены параметры ResourceProviderConnection и PrivateLink в командлет New-AzHDInsightCluster для включения поддержки исходящих подключений ретранслятора и приватного канала.
* В командлет New-AzHDInsightCluster добавлен параметр AmbariDatabase для включения поддержки пользовательской базы данных Ambari.
* В параметр MetastoreType командлета Add-AzHDInsightMetastore добавлено значение AmbariDatabase.

#### <a name="aziothub"></a>Az.IotHub
* Разрешены теги в командлете для создания Центра Интернета вещей.

#### <a name="azkeyvault"></a>Az.KeyVault
* Поддерживается обновление тега хранилища ключей.

#### <a name="azlogicapp"></a>Az.LogicApp
* Исправлена проблема, из-за которой командлет Get-AzLogicAppRunHistory получал только первую страницу результатов.

#### <a name="aznetwork"></a>Az.Network
* Обновлены следующие командлеты: 
    - New-AzLoadBalancerFrontendIpConfigCommand, Set-AzLoadBalancerFrontendIpConfigCommand, Add-AzLoadBalancerFrontendIpConfigCommand:
        - добавлено свойство PublicIpAddressPrefix;
        - добавлено свойство PublicIpAddressPrefixId.
* Добавлены новые свойства в следующие командлеты для включения глобальной балансировки нагрузки:
    - New-AzLoadBalancer:
        - добавлено свойство уровня SKU.
    - New-AzPuplicIpAddress:
        - добавлено свойство уровня SKU.
    - New-AzPublicIpPrefix:
        - добавлено свойство уровня SKU.
    - New-AzLoadBalancerBackendAddressConfig:
        - добавлено свойство LoadBalancerFrontendIPConfigurationId.
* Обновлены планы по включению сообщений о прекращении поддержки для следующих командлетов:   -New-AzVirtualHubRoute   -New-AzVirtualHubRouteTable   -Add-AzVirtualHubRoute   -Add-AzVirtualHubRouteTable   -Get-AzVirtualHubRouteTable   -Remove-AzVirtualHubRouteTable.
* Обновлены планы по включению сообщений о прекращении поддержки для аргумента RouteTable для следующих командлетов:   -New-AzVirtualHub   -Set-AzVirtualHub   -Update-AzVirtualHub.
* Аргументы -MinScaleUnits и -MaxScaleUnits в Set-AzExpressRouteGateway сделаны необязательными.
* Добавлены новые командлеты для включения взаимной проверки подлинности и профилей SSL в Шлюзе приложений:
...
#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Указано время в формате UTC для BackupTime политики.
* Изменено предупреждение о критическом изменении в командлете Get-AzRecoveryServicesBackupJobDetails.
* Обновлен примера текста справки для командлета Set-AzRecoveryServicesBackupProtectionPolicy.
...
* Обновлен командлет Export-AzResourceGroup для использования пакета SDK.
* Добавлены сведения о языке и региональных параметрах для методов синтаксического анализа.

#### <a name="azsql"></a>Az.Sql
* Исправлены проблемы, из-за которых командлет Set-AzSqlDatabaseAudit не поддерживал базу данных уровня "Гипермасштабирование" и не удавалось определить выпуск базы данных.
* В New-AzSqlInstance и Set-AzSqlInstance добавлен параметр MaintenanceConfigurationId.
* Исправлена ошибка в GetAzureSqlDatabaseReplicationLink.cs, где параметр PartnerServerName проверялся по значению, а не по ключу.

#### <a name="azwebsites"></a>Az.Websites
* Включена поддержка новых возможностей ограничения доступа: ServiceTag, multi-ip и http-headers.

### <a name="thanks-to-our-community-contributors"></a>Благодарим наших участников сообщества
* Джон К. Мартин (John Q. Martin) (@johnmart82), добавление сведений о предварительных требованиях для брандмауэра (№13385).
* Маникандан Дураисами (Manikandan Duraisamy) (@madurais-msft), исправление аргумента PublicSubnetName (№13417).
* @mahortas, обновление значений параметров для параметра -HostName (№13349).
* @MariachiForHire, добавлены поддерживаемые значения TrafficAnalyticsInterval (№13304).
* Майкл Джеймс (Michael James) (@mikejwhat), включена поддержка Get-AzLogicAppRunHistory для получения более 30 записей (№13393).
* Шашикант Шакья (Shashikant Shakya) (@shshakya), обновление файла Restore-AzSqlInstanceDatabase.md (№13404).

## <a name="500---october-2020"></a>5.0.0 — октябрь 2020 г.
#### <a name="azaccounts"></a>Az.Accounts
* [Критическое изменение] Удалены командлеты Get-AzProfile и Select-AzProfile.
* Библиотека проверки подлинности Azure Active Directory заменена библиотекой проверки подлинности Microsoft (MSAL).

#### <a name="azaks"></a>Az.Aks
* [Критическое изменение] Удален псевдоним параметра ClientIdAndSecret в командлетах New-AzAksCluster и Set-AzAksCluster.
* [Критическое изменение] Изменено значение по умолчанию NodeVmSetType в New-AzAksCluster с AvailabilitySet на VirtualMachineScaleSets.
* [Критическое изменение] Изменено значение по умолчанию NetworkPlugin в New-AzAksCluster с None на azure.
* [Критическое изменение] Удален параметр NodeOsType в New-AzAksCluster, так как поддерживается только одно значение Linux.

#### <a name="azbilling"></a>Az.Billing
* Добавлен командлет Get-AzBillingAccount.
* Добавлен командлет Get-AzBillingProfile.
* Добавлен командлет Get-AzInvoiceSection.
* Добавлены новые параметры в командлет Get-AzBillingInvoice.
* Удалены свойства DownloadUrlExpiry, Type и BillingPeriodNames из ответа командлета Get-AzBillingInvoice.

#### <a name="azcdn"></a>Az.Cdn
* Добавлены командлеты для включения функций с поддержкой нескольких источников и приватных каналов. 

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Обновлен пакет SDK до версии 7.4.0-preview.

#### <a name="azcompute"></a>Az.Compute
* Добавлен параметр -VmssId в командлет New-AzVm.
* Добавлен параметр PlatformFaultDomainCount в командлет New-AzVmss.
* Добавлен новый командлет Get-AzDiskEncryptionSetAssociatedResource.
* Добавлены необязательные параметры Tier и LogicalSectorSize в командлет New-AzDiskConfig. 
...
#### <a name="azdatabricks"></a>Az.Databricks
* Исправлена ошибка, которая может вызвать сбой при обновлении рабочей области Databricks без `-EncryptionKeyVersion`.

#### <a name="azdatafactory"></a>Az.DataFactory
* Пакет SDK ADF для .NET обновлен до версии 4.12.0.
* Пакет SDK клиента шифрования ADF обновлен до версии 4.14.7587.7.
* Добавлены команды Stop-AzDataFactoryV2TriggerRun и Invoke-AzDataFactoryV2TriggerRun.

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Требуется свойство Location для создания объектов ARM верхнего уровня.
        *`ApplicationGroupType` требуется для `New-AzWvdApplicationGroup`.
        *`HostPoolArmPath` требуется для `New-AzWvdApplicationGroup`.
        *Добавлен параметр `PreferredAppGroupType` для `New-AzWvdHostPool`.

#### <a name="azfunctions"></a>Az.Functions
* [Критическое изменение] Удален параметр-переключатель IncludeSlot из всех наборов параметров Get-AzFunctionApp, кроме одного. Командлет теперь поддерживает получение слотов развертывания в результатах, если указать IncludeSlot. 
* Обновлен командлет New-AzFunctionApp:
  - исправлена проблема с -DisableApplicationInsights, чтобы при указании этого параметра не создавался проект Application Insights. [№12728]
  - [Критическое изменение] Отключена поддержка создания приложений-функций PowerShell 6.2.
  - [Критическое изменение] Изменена версия среды выполнения по умолчанию (с версии 6.2 на 7.0) в Функциях версии 3 в Windows для приложений-функций PowerShell, если не указать параметр RuntimeVersion.
  - [Критическое изменение] Изменена версия среды выполнения по умолчанию (с версии 10 на 12) в Функциях версии 3 в Windows и Linux для приложений-функций Node, если не указать параметр RuntimeVersion.
  - [Критическое изменение] Изменена версия среды выполнения по умолчанию (с версии 3.7 на 3.8) в Функциях версии 3 в Linux для приложений-функций Python, если не указать параметр RuntimeVersion.

#### <a name="azhdinsight"></a>Az.HDInsight
 * Для командлета New-AzHDInsightCluster:
     - заменен параметр DefaultStorageAccountName на StorageAccountResourceId;
     - заменен параметр DefaultStorageAccountKey на StorageAccountKey;
     - заменен параметр DefaultStorageAccountType на StorageAccountType;
     - удален параметр PublicNetworkAccessType;
     - удален параметр OutboundPublicNetworkAccessType.
     - Добавлены новые параметры: StorageFileSystem и StorageAccountManagedIdentity для включения поддержки ADLS 2-го поколения.
     - Добавлен новый параметр EnableIDBroker для включения поддержки брокера удостоверений HDInsight.
     - Добавлены новые параметры: KafkaClientGroupId, KafkaClientGroupName и KafkaManagementNodeSize для включения поддержки прокси-сервера REST для Kafka.
 * Для командлета New-AzHDInsightClusterConfig:
     - заменен параметр DefaultStorageAccountName на StorageAccountResourceId;
     - заменен параметр DefaultStorageAccountKey на StorageAccountKey;
     - заменен параметр DefaultStorageAccountType на StorageAccountType;
     - удален параметр PublicNetworkAccessType;
     - удален параметр OutboundPublicNetworkAccessType.
* Для командлета Set-AzHDInsightDefaultStorage:
    - заменен параметр StorageAccountName на StorageAccountResourceId.
* Для командлета Add-AzHDInsightSecurityProfile:
    - заменен параметр Domain на DomainResourceId;
    - удалено обязательное требование использовать параметр OrganizationalUnitDN.

#### <a name="azkeyvault"></a>Az.KeyVault
* [Критическое изменение] Не рекомендуется использовать параметр DisableSoftDelete в командлете New-AzKeyVault и параметр EnableSoftDelete в командлете Update-AzKeyVault.
* [Критическое изменение] Удален атрибут SecretValueText, чтобы значение SecretValue не отображалось напрямую [№12266].
* Включена поддержка нового типа ресурса: управляемое устройство HSM.
    - CRUD управляемого устройства HSM и командлеты для работы с ключами на управляемом устройстве HSM.
    - Полное резервное копирование и восстановление HSM, создание ключа AES, резервное копирование и восстановление домена безопасности, RBAC.

#### <a name="azmanagedservices"></a>Az.ManagedServices
* [Критическое изменение] Обновлены соглашения об именовании параметров и связанные примеры.

#### <a name="aznetwork"></a>Az.Network
* [Критическое изменение] Удален параметр HostedSubnet и вместо него добавлен параметр Subnet.
* Добавлены новые командлеты для маршрутов пиринга виртуального маршрутизатора.
    - Get-AzVirtualRouterPeerLearnedRoute
    - Get-AzVirtualRouterPeerAdvertisedRoute
* Обновлен командлет New-AzFirewall:
    - добавлен параметр -SkuTier;
    - добавлен параметр -SkuName и номер SKU в качестве псевдонима;
    - удален параметр -Sku.
* [Критическое изменение] Сделан обязательным аргумент Connectionlink в командлетах Start-AzVpnConnectionPacketCapture и Stop-AzVpnConnectionPacketCapture.
* [Критическое изменение] В командлете New-AzNetworkWatcherConnectionMonitorEndPointObject удален параметр -Filter.
* [Критическое изменение] Заменен командлет New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject на New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject.
* Обновлен командлет New-AzNetworkWatcherConnectionMonitorEndPointObject:
    - добавлен параметр -Type;
    - добавлен параметр -CoverageLevel;
    - добавлен параметр -Scope.
* В командлет New-AzNetworkWatcherConnectionMonitorProtocolConfigurationObject добавлен новый параметр -DestinationPortBehavior.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Исправлена проблема с восстановлением рабочей нагрузки для разрешений участника.
* Добавлены новые наборы параметров и проверки для командлета Restore-AzRecoveryServicesBackupItem.

#### <a name="azresources"></a>Az.Resources
* Исправлена ошибка синтаксического анализа.
* Обновлены командлеты What-If шаблона ARM для удаления сообщения о предварительной версии из результатов.
* Исправлена ошибка, из-за которой командлеты развертывания шаблонов завершаются сбоем, если для параметра -WhatIf задана более высокая область [№13038].
* Исправлена ошибка, из-за которой командлеты развертывания шаблона не сохраняют регистр для параметров шаблона.
* Добавлена версия API по умолчанию для использования в командлете Export-AzResourceGroup.
* Добавлены командлеты для Спецификаций шаблонов (Get-AzTemplateSpec, Set-AzTemplateSpec, New-AzTemplateSpec, Remove-AzTemplateSpec, Export-AzTemplateSpec).
* Включена поддержка развертывания Спецификаций шаблонов с помощью существующих командлетов развертывания (с использованием нового параметра -TemplateSpecId). 
* Включена возможность использовать SDK в командлете Get-AzResourceGroupDeploymentOperation.
* Удален параметр -ApiVersion из командлетов *-AzDeployment.

#### <a name="azsql"></a>Az.Sql
* Исправлена ошибка, из-за которой выполнение командлета New-AzSqlDatabaseExport завершается сбоем, если не указать networkIsolation [№13097].
* Исправлена ошибка, из-за которой командлеты New-AzSqlDatabaseExport и New-AzSqlDatabaseImport не возвращали OperationStatusLink в результирующем объекте [№13097].
* Обновлены URL-адреса парных регионов Azure в предупреждениях об избыточности хранилища резервных копий. 

#### <a name="azstorage"></a>Az.Storage
* Удалено устаревшее свойство RestorePolicy.LastEnabledTime.
    - Enable-AzStorageBlobRestorePolicy
    - Disable-AzStorageBlobRestorePolicy
    - Get-AzStorageBlobServiceProperty
    - Update-AzStorageBlobServiceProperty
* Изменен тип DaysAfterModificationGreaterThan с целочисленного на целочисленный?
    - Set-AzStorageAccountManagementPolicy
    - Get-AzStorageAccountManagementPolicy
    - Add-AzStorageAccountManagementPolicyAction
    - New-AzStorageAccountManagementPolicyRule
* Поддерживается создание или обновление общей папки с уровнем доступа.
    - New-AzRmStorageShare
    - Update-AzRmStorageShare
* Поддерживается установка, обновление и удаление ACL рекурсивно для элемента Datalake 2-го поколения. 
    -  Set-AzDataLakeGen2AclRecursive 
    -  Update-AzDataLakeGen2AclRecursive 
    -  Remove-AzDataLakeGen2AclRecursive
* Включена поддержка политики доступа контейнеров с новым разрешением x,t.
    -  New-AzStorageContainerStoredAccessPolicy
    -  Set-AzStorageContainerStoredAccessPolicy
* Изменены выходные данные командлета политики доступа контейнера get/set путем изменения типа разрешения дочернего свойства с enum на string.
    -  Get-AzStorageContainerStoredAccessPolicy
    -  Set-AzStorageContainerStoredAccessPolicy
* Исправлена проблема с примером скрипта для политики управления наборами с помощью JSON.
    -  Set-AzStorageAccountManagementPolicy

#### <a name="azwebsites"></a>Az.Websites
* Включена поддержка ценовой категории "Премиум" версии 3.
* Пакет SDK для веб-сайтов обновлен до версии 3.1.0.

### <a name="thanks-to-our-community-contributors"></a>Благодарим наших участников сообщества
* @atul-ram, обновление Get-AzDelegation.md (№13176).
* @dineshreddy007, правильное назначение ролей приложения в случае регистрации Stack HCI с использованием токена WAC. (№13249).
* @kongou-ae, обновление New-AzOffice365PolicyProperty.md (№13217).
* Lohith Chowdary Chilukuri (@Lochiluk), обновление Set-AzApplicationGateway.md (№13150).
* Matthew Burleigh (@mburleigh):
  * добавление ссылок на командлеты PowerShell, указанные в документации (№13203);
  * добавление ссылок на командлеты PowerShell, указанные в документации (№13190);
  * добавление ссылок на командлеты PowerShell, указанные в документации (№13189);
  * добавление ссылок на указанные командлеты (№13137);
  * добавление ссылок на командлеты PowerShell, указанные в документации (№13204);
  * добавление ссылок на командлеты PowerShell, указанные в документации (№13205).

## <a name="480---october-2020"></a>4.8.0 — октябрь 2020 г.
#### <a name="azaccounts"></a>Az.Accounts
* Исправлена проблема с анализом фиксированных дат DateTime в общих библиотеках [№ 13045]

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Добавлен командлет New-AzCognitiveServicesAccountApiProperty.
* Добавлена поддержка параметра ApiProperty для New-AzCognitiveServicesAccount и Set-AzCognitiveServicesAccount.

#### <a name="azcompute"></a>Az.Compute
* Исправлена проблема в Update-ASRRecoveryPlan путем заполнения FailoverTypes.
* В командлет Get-AzVmImage добавлены необязательные параметры -Top и -OrderBy. 

#### <a name="azdatabricks"></a>Az.Databricks
* Вышла общедоступная версия модуля Az.Databricks.
* Добавлена поддержка пиринга между виртуальными сетями

#### <a name="azdatafactory"></a>Az.DataFactory
* Исправлена опечатка в выходных сообщениях

#### <a name="azeventhub"></a>Az.EventHub
* Добавлен необязательный параметр-переключатель TrustedServiceAccessEnabled в командлет Set-AzEventHubNetworkRuleSet

#### <a name="azhdinsight"></a>Az.HDInsight
* Добавлено предупреждающее сообщение о том, что планируется прекращение поддержки параметров PublicNetworkAccessType и OutboundPublicNetworkAccessType
* Добавлено предупреждающее сообщение о том, что планируется замена параметра DefaultStorageAccountName на StorageAccountResourceId
* Добавлено предупреждающее сообщение о том, что планируется замена параметра DefaultStorageAccountKey на StorageAccountKey
* Добавлено предупреждающее сообщение о том, что планируется замена параметра DefaultStorageAccountType на StorageAccountType
* Добавлено предупреждающее сообщение о том, что планируется замена параметра DefaultStorageContainer на StorageContainer
* Добавлено предупреждающее сообщение о том, что планируется замена параметра DefaultStorageRootPath на StorageRootPath

#### <a name="aziothub"></a>Az.IotHub
* Обновлен пакет SDK для устройств.

#### <a name="azkeyvault"></a>Az.KeyVault
* Указана точная дата удаления свойства SecretValueText

#### <a name="azmanagedservices"></a>Az.ManagedServices
* Изменены предупреждения о критических изменениях в командлетах назначения и определения управляемых служб.

#### <a name="azmonitor"></a>Az.Monitor
* Исправлена ошибка, не позволявшая подавить предупреждающие сообщения. [№ 12889]
* Добавлена поддержка параметра SkipMetricValidation в критериях правила генерации оповещений. Это позволяет создать правило генерации оповещений для пользовательской метрики, которая еще не создана, настроив пропуск проверки этой метрики.

#### <a name="aznetwork"></a>Az.Network
* Добавлена политика Office365 в ресурс VPNSite
    - New-AzO365PolicyProperty

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Добавлена проверка имени контейнера для резервного копирования рабочей нагрузки.
...
#### <a name="azsql"></a>Az.Sql
* Добавлен параметр BackupStorageRedundancy к следующим командлетам: 
    - Restore-AzureRmSqlDatabase;
    - New-AzSqlDatabaseCopy;
    - New-AzSqlDatabaseSecondary.
* Удален учет регистра для параметра BackupStorageRedundancy во всех ссылках на базы данных SQL 
* Обновлены имена в предупреждающем сообщении BackupStorageRedundancy

#### <a name="azstorage"></a>Az.Storage
* Добавлена поддержка включения, отключения и получения свойств обратимого удаления для общей папки в службе файлов учетной записи хранения
    - Update-AzStorageFileServiceProperty
    - Get-AzStorageFileServiceProperty
* Поддерживается вывод списка общих папок в учетной записи хранения, включая удаленные общие папки, а также добавлена возможность получить данные об использовании одной общей папки.
    - Get-AzRmStorageShare
* Добавлено восстановление удаленной общей папки
    - Restore-AzRmStorageShare
* Изменены командлеты для изменения свойств службы BLOB-объектов. Эти командлеты не получают свойства с сервера, а только сохраняют новые параметры на сервер.
    - Enable-AzStorageBlobDeleteRetentionPolicy
    - Disable-AzStorageBlobDeleteRetentionPolicy  
    - Enable-AzStorageBlobRestorePolicy
    - Disable-AzStorageBlobRestorePolicy
    - Update-AzStorageBlobServiceProperty
* Устранена проблема с получением справки для значения по умолчанию для параметра -Kind командлета New-AzStorageAccount [№ 12189]
* Устранена проблема путем добавления примера правильной настройки ContentType для отправки большого двоичного объекта [№ 12989]
...
#### <a name="azaccounts"></a>Az.Accounts
* Загружаются все общедоступные облачные среды, когда конечная точка обнаружения не возвращает AzureCloud по умолчанию или другие общедоступные среды [№ 12633]
* В Get-AzSubscription предоставлен параметр SubscriptionPolicies [№ 12551].

#### <a name="azautomation"></a>Az.Automation
* В Set-AzAutomationWebhook добавлен параметр -RunOn для определения группы гибридной рабочей роли.

#### <a name="azcompute"></a>Az.Compute
* В New-AzVm, New-AzVmss, New-AzVMConfig, New-AzVmssConfig, Update-AzVM и Update-AzVmss добавлен параметр -EncryptionAtHost.
* В возвращаемый объект Get-AzVM и Get-AzVmss добавлен параметр SecurityProfile.
* В Get-AzHostGroup добавлен необязательный параметр -InstanceView.
* Добавлен новый командлет Invoke-AzVmPatchAssessment.

#### <a name="azdatafactory"></a>Az.DataFactory
* В класс PSPipelineRun добавлены отсутствующие свойства.

#### <a name="azhdinsight"></a>Az.HDInsight
* Включена поддержка создания кластера с функцией шифрования на узле.

#### <a name="azkeyvault"></a>Az.KeyVault
* Добавлены предупреждающие сообщения для планирования отключения обратимого удаления.
* Добавлены предупреждающие сообщения для планирования удаления атрибута SecretValueText.

#### <a name="azmaintenance"></a>Az.Maintenance
* В New-AzMaintenanceConfiguration добавлены дополнительные поля, связанные с расписанием.
* Добавлен новый командлет для Get-AzMaintenancePublicConfiguration.

#### <a name="azmanagedservices"></a>Az.ManagedServices
* Добавлены предупреждения о критических изменениях в командлетах назначения и определения управляемых служб.

#### <a name="azmonitor"></a>Az.Monitor
* Расширен набор параметров, заданный в Set-AzDiagnosticSetting, для разделения включения журналов и метрик [№ 12482].
* Для Add-AzMetricAlertRuleV2 исправлена ошибка, возникающая при получении оповещения метрики из конвейера.

#### <a name="azresources"></a>Az.Resources
* Изменен ответ Get-AzPolicyAlias для включения сведений о том, изменяется ли этот псевдоним Политикой Azure.
* Создан новый командлет Set-AzRoleAssignment.
...
* Исправлены ошибки файлов справки Restart-AzSignalR и Update-AzSignalR.
* Добавлены командлеты Update-AzSignalRNetworkAcl, Set-AzSignalRUpstream.

#### <a name="azstorage"></a>Az.Storage
* Поддерживается ускорение запросов больших двоичных объектов:
    -  Get-AzStorageBlobQueryResult;
    -  New-AzStorageBlobQueryConfig.
* Обновлен файл справки; дополнено описание и исправлена опечатка.
    -  Start-AzStorageBlobCopy
    -  Get-AzDataLakeGen2Item
* Исправлена ошибка, из-за которой работа большого двоичного объекта завершается ошибкой, если связанный подкаталог не существует [№ 12592].
    -  Get-AzStorageBlobContent
* Включена поддержка задания, получения и удаления политики репликации объекта в учетных записях хранения:
    - New-AzStorageObjectReplicationPolicyRule;
    - Set-AzStorageObjectReplicationPolicy;
    - Get-AzStorageObjectReplicationPolicy;
    - Remove-AzStorageObjectReplicationPolicy.
* Включена поддержка включения и отключения канала изменений в службе BLOB-объектов учетной записи хранения:
    - Update-AzStorageBlobServiceProperty
...
#### <a name="azaks"></a>Az.Aks
* Заменено использование старого [API AccessProfile](/rest/api/aks/managedclusters/getaccessprofile) вызовами API [ListClusterAdmin](/rest/api/aks/managedclusters/listclusteradmincredentials) и [ListClusterUser](/rest/api/aks/managedclusters/listclusterusercredentials).
...
* **New-AzApiManagementProduct** _ и _ *Set-AzApiManagementProduct**
