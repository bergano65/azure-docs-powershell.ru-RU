...
Удаляет тему domain Topic1 сетки событий в разделе Domain Domain1 в группе \` \` ресурсов \` \` \` MyResourceGroupName. \`
...
### -ResourceId
Идентификатор ресурса, представляющий тему домена "Сетка мероприятий".
