...
### Пример 1. Удаление службы BotService по имени и ресурсу ResourceGroupName
```powershell
PS C:\> Remove-AzBotService -Name youri-bot -ResourceGroupName youriBotTest

```

Удаление службы BotService по имени и ресурсу ResourceGroupName

### Пример 2. Удаление ботслужбы по inputObject
```powershell
...
Удаление ботслужбы по inputObject
