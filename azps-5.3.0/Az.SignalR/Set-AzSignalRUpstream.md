...
Пример использования синтаксиса с синтаксисом splatting для переключения параметра шаблонов: @{UrlTemplate=' http://host-connections1.com ', HubPattern= 'chat'; EventPattern='broadcast' },@{UrlTemplate=' http://host-connections2.com '}
...
[Использование параметра splatting для управления параметрами в командах PowerShell](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
