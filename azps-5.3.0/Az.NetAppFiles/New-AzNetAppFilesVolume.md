...
Если включена (истина), то объем будет содержать доступный только для чтения .snapshot каталог, который предоставляет доступ к снимкам каждого тома (по умолчанию — true).
...
### -SubnetId
URI ресурса Azure для делегированной подсети
