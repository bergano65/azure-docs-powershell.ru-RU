...
## ОПИСАНИЕ
Для создания снимка ANF будет выбран новый **cmdlet AzNetAppFilesSnapshot.**
...
Эта команда создает новый снимок ANF "MyAnfSnapshot" в томе "MyAnfVolume".
...
### -VolumeObject
Громкость для нового объекта моментального снимка
