...
## ОПИСАНИЕ
Для учетной записи ANF создается новая политика моментального снимка с новыми данными **AzNetAppFilesActiveDirectory.**
...
Эта команда создает новую политику моментального снимка ANF для учетной записи ANF с именем "MyAccount".
