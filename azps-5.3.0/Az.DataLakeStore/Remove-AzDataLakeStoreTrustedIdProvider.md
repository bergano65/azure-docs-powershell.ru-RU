...
## ОПИСАНИЕ
Для удаления указанного надежного поставщика удостоверений из указанного магазина Data Lake Store удаляется **cmdlet Remove-AzDataLakeStoreTrustedIdProvider.**
...
### -Account
Учетная запись Data Lake Store для удаления надежного поставщика удостоверений из
...
### -ResourceGroupName
Имя группы ресурсов, содержаной учетную запись, из которого нужно удалить надежного поставщика удостоверений.
