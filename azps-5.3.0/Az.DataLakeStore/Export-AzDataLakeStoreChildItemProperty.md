...
Получите данные об использовании диска и использовании ACL для всех поднаправлений и файлов в папке /a. IncludeFile гарантирует также, что для файлов сообщается об использовании
