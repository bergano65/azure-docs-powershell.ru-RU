...
## ОПИСАНИЕ
При наложении на файл или папку из магазина Data Lake Store список управления доступом удаляется с учетом списка контроля доступа **(Remove-AzDataLakeStoreItemAcl).**
...
### -По умолчанию
Указывает на то, что этот cmdlet удаляет значение ACL по умолчанию для файла или папки.
