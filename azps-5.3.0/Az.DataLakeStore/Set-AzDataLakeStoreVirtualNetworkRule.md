...
## ОПИСАНИЕ
Командлет **Set-AzDataLakeStoreVirtualNetworkRule** изменяет указанное правило виртуальной сети в указанном Хранилище для озера данных.
...
Обновление id подсети виртуального правила сети "myVNET" в учетной записи "dls" на updatedId.

## PARAMETERS

### -Account
Учетная запись Data Lake Store для обновления правила виртуальной сети в
...
### -SubnetId
Начало допустимого диапазона IP-адресов для виртуального правила сети
