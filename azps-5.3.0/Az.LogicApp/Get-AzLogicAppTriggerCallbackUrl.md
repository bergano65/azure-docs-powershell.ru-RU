...
## ОПИСАНИЕ
**Cmdlet Get-AzLogicAppTriggerCallbackUrl получает URL-адрес** триггера вызова приложения Logic из группы ресурсов.
Этот cmdlet возвращает объект **WorkflowTriggerCallbackUrl,** представляютый URL-адресом обратного звонка.
