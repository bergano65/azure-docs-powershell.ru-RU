...
## ОПИСАНИЕ
**Cmdlet Get-AzIntegrationAccountCertificate** получает сертификаты учетных записей интеграции из группы ресурсов.
...
### Пример 1. Получить сертификат учетной записи интеграции
```
...
Эта команда получает сертификат учетной записи интеграции IntegrationAccountCertificate01.

### Пример 2. Получить сертификаты учетной записи интеграции по имени учетной записи интеграции
```
...
Эта команда получает сертификаты учетной записи интеграции для учетной записи IntegrationAccount31.
