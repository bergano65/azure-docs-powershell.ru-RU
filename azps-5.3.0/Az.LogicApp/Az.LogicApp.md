...
# Модуль Az.LogicApp
## Описание
В этой теме вы также можете найти разделы справки по приложениям логики.
...
Получает соглашение об интеграции с учетной записью.
...
Возвращает URL-адрес для интеграции с учетной записью.

### [Get-AzIntegrationAccountCertificate](Get-AzIntegrationAccountCertificate.md)
Получает сертификаты учетной записи интеграции из группы ресурсов.

### [Get-AzIntegrationAccountGeneratedIcn](Get-AzIntegrationAccountGeneratedIcn.md)
Этот cmdlet извлекает текущее значение сгенерированного номера управления для обмена в рамках соглашения.

### [Get-AzIntegrationAccountMap](Get-AzIntegrationAccountMap.md)
Возвращает интеграцию с картой учетной записи.

### [Get-AzIntegrationAccountPartner](Get-AzIntegrationAccountPartner.md)
Получает партнеров по интеграции с учетной записью.

### [Get-AzIntegrationAccountReceivedIcn](Get-AzIntegrationAccountReceivedIcn.md)
Этот cmdlet получает определенный полученный номер обмена для соглашения и значения номера.

### [Get-AzIntegrationAccountSchema](Get-AzIntegrationAccountSchema.md)
Интеграция схем учетных записей.

### [Get-AzLogicApp](Get-AzLogicApp.md)
Получает приложение логики из группы ресурсов.
...
Триггеры приложения логики.

### [Get-AzLogicAppTriggerCallbackUrl](Get-AzLogicAppTriggerCallbackUrl.md)
Получает URL-адрес запуска логики приложения для вызовите звонок.

### [Get-AzLogicAppTriggerHistory](Get-AzLogicAppTriggerHistory.md)
Возвращает историю триггеров в приложении логики.
...
Создает учетную запись интеграции.
...
Создает пакетную конфигурацию учетной записи интеграции.

### [New-AzIntegrationAccountCertificate](New-AzIntegrationAccountCertificate.md)
Создание сертификата учетной записи интеграции.
...
Создает партнера по интеграции с учетной записью.

### [New-AzIntegrationAccountSchema](New-AzIntegrationAccountSchema.md)
Создает схему интеграции учетной записи.
...
Удаляет соглашение об интеграции с учетной записью.
...
Удаляет сертификат учетной записи интеграции из группы ресурсов.

### [Remove-AzIntegrationAccountMap](Remove-AzIntegrationAccountMap.md)
Удаляет интеграцию с картой учетной записи.

### [Remove-AzIntegrationAccountPartner](Remove-AzIntegrationAccountPartner.md)
Удаляет партнера по интеграции с учетной записью.

### [Remove-AzIntegrationAccountReceivedIcn](Remove-AzIntegrationAccountReceivedIcn.md)
Этот cmdlet removes a specific received interchange control number per agreement and control number value.

### [Remove-AzIntegrationAccountSchema](Remove-AzIntegrationAccountSchema.md)
Удаляет схему интеграции учетной записи.
...
Изменяет сертификат учетной записи интеграции.

### [Set-AzIntegrationAccountGeneratedIcn](Set-AzIntegrationAccountGeneratedIcn.md)
Обновляет учетную запись интеграции, сгенерированную в группе ресурсов Azure.

### [Set-AzIntegrationAccountMap](Set-AzIntegrationAccountMap.md)
Изменяет карту учетной записи интеграции.
...
Обновляет учетную запись интеграции с полученным номером управления обмена (ICN) в группе ресурсов Azure.
...
Изменяет приложение логики в группе ресурсов.

### [Start-AzLogicApp](Start-AzLogicApp.md)
Запуск приложения логики в группе ресурсов.
