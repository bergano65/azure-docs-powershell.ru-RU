...
## ОПИСАНИЕ
**Cmdlet Set-AzIntegrationAccount** изменяет учетную запись интеграции.
Этот cmdlet возвращает объект, который представляет учетную запись интеграции.
...
Эта команда изменяет учетную запись интеграции IntegrationAccount31 в указанной группе ресурсов.
