...
## ОПИСАНИЕ
Этот cmdlet предназначен для использования в сценариях аварийного восстановления для удаления полученного номера средства обмена данными из учетной записи интеграции, чтобы соединитель B2B мог повторно обработать сообщение при включенной функции обнаружения повторяюх номеров.
В редких случаях полученный номер обмена обмена может быть зарезервирован незадолго до аварийного Скайп и до того, как соединитель B2B отклоняет обмен как ошибочный.
