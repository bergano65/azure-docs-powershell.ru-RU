...
## SYNOPSIS
Возвращает группы контейнеров.

## СИНТАКСИС

### ListContainerGroupParamSet (по умолчанию)
```
...
## ОПИСАНИЕ
Для получения указанной группы контейнеров или всех групп контейнеров в группе ресурсов или подписке будет задана группа контейнеров **Get-AzContainerGroup.**

## ПРИМЕРЫ

### Пример 1. Получает указанную группу контейнеров
```
...
Команда получает указанную группу контейнеров.

### Пример 2. Возвращает группы контейнеров в группе ресурсов
```
...
Команда получает группы контейнеров в группе `demo` ресурсов.

### Пример 3. Возвращает группы контейнеров в текущей подписке
```
...
Команда получает группы контейнеров в текущей подписке.

### Пример 4. Возвращает группы контейнеров с использованием ИД ресурсов.
```
...
Команда получает группу контейнеров с идом ресурса.
