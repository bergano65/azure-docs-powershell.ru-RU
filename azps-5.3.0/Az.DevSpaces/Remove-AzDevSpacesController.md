...
Удалите контроллер DevSpaces с именем devSpaceControllerName.
...
### -InputObject
Объект PSController, который обычно проходит через конвейер.
...
### -PassThru
Возвращает "Истина", если удаление успешно.
