...
### Пример 1. Список всех языковых расширений, установленных для кластера
```powershell
...
Эта команда возвращает список языковых расширений, которые можно выполнить в запросах KQL.
