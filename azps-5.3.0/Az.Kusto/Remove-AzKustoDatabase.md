...
### Пример 1. Удаление базы данных "Кузто" по имени
```powershell
PS C:\> Remove-AzKustoDatabase -ResourceGroupName testrg -ClusterName testnewkustocluster -Name mykustodatabase
```

При этом база данных "Кузто" с именем "mykustodatabase" в кластере testnewkustocluster, найденная в группе ресурсов testrg.
