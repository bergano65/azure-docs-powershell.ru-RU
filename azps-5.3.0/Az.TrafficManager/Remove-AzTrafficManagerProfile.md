...
## ОПИСАНИЕ
Для удаления профиля Диспетчера трафика Azure удаляется **cmdlet Remove-AzTrafficManagerProfile.**
...
Этот cmdlet удаляет профиль Диспетчера трафика в группе, указанной этим параметром.
