...
## ОПИСАНИЕ
Cmdlet **Add-AzTrafficManagerCustomHeaderToEndpoint** добавляет данные настраиваемого заголовок к локальному объекту конечной точки Диспетчера трафика Azure.
