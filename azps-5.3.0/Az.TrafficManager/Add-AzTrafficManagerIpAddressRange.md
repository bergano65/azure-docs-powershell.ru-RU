...
Четвертая команда проверяет, соответствует ли область размеру диапазона, а затем добавляет диапазон IP-адресов 12.13.14.0 к 12.13.14.31 к конечной точке, храняной в $TrafficManagerEndpoint.
