...
## ОПИСАНИЕ
**Cmdlet Stop-AzDataFactoryV2TriggerRun** останавливает запуск триггера в фабрике данных, заданном с именем триггера и именем триггера.
В настоящее время поддерживается только для TumblingWindowTriggers в области WaitingOnDependency.
...
Эта команда останавливает запуск триггера вместе с идом '08586002468005888497807248799CU16' на заводском wikiADF.
...
### -PassThru
Если для указанного cmdlet задано написание истина в случае успешного написания.
