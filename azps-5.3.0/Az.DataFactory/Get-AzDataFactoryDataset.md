...
Вы также можете назначить переменной результат из cmdlet **Get-AzDataFactoryDataset,** а затем использовать точку для просмотра свойства Location, связанного с объектом наборов данных, который хранится в этой переменной.
