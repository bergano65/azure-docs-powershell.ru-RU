...
## ОПИСАНИЕ
Cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey** повторно сгенерирует ключ времени интеграции с именем ключа, заданным параметром KeyName. Предыдущий ключ недействителен.
