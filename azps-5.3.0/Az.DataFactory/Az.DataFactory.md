...
---
# Модуль Az.DataFactory
## Описание
Фабрика данных Azure V2 — это платформа интеграции данных, которая выходит за рамки объединения и пакетной обработки данных журналов, а также пакетной обработки данных журналов, а также общего назначения модели приложения, поддерживающей современные шаблоны и сценарии хранения данных, переносимые и переносимые SAAS-приложения, а также приложения SaaS на основе данных. В масштабе можно составлять надежные и безопасные процессы интеграции данных и управлять ими. Используйте соединители данных ADF и runtimes Integration, чтобы перемещать и преобразовывать облачные и локальное данные, которые могут быть неструктурированными, полуконкретными и структурированными с Hadoop, Azure Data Lake, Spark, SQL Server, Решения DB и многими другими платформами данных.

## Az.DataFactory Cmdlets
### [Add-AzDataFactoryV2DataFlowDebugSessionPackage](Add-AzDataFactoryV2DataFlowDebugSessionPackage.md)
Добавьте ресурс потоков данных и его зависимости в определенный сеанс отлагожки потоков данных.
...
Получает сведения о логических шлюзах в фабрике данных Azure.

### [Get-AzDataFactoryGatewayAuthKey](Get-AzDataFactoryGatewayAuthKey.md)
Получает ключ автослона шлюза для фабрики данных Azure.
...
Получает сведения об наборе данных в фабрике данных.
...
Получите все активные сеансы отлагки потоков данных отлагововодской фабрики данных Azure.
...
Сведения о конвейерах в фабрике данных.
...
Получает сведения о триггерах в фабрике данных.
...
Действие вызова отлагки в сеансе отлагки потока данных.
...
Создает шлюз для фабрики данных Azure.

### [New-AzDataFactoryGatewayAuthKey](New-AzDataFactoryGatewayAuthKey.md)
Создает ключ для шлюза фабрики данных Azure.

### [New-AzDataFactoryHub](New-AzDataFactoryHub.md)
Создает концентратор для фабрики данных Azure.
...
Зашифровать учетные данные в связанной службе, заданную временную ацию интеграции.

### [Remove-AzDataFactory](Remove-AzDataFactory.md)
Удаляет фабрику данных.
...
Настраивает период активности для срезов данных.
...
Создает поток данных в фабрике данных.
...
Остановка сеанса отлагки потока данных в фабрике данных Azure.

### [Suspend-AzDataFactoryPipeline](Suspend-AzDataFactoryPipeline.md)
Приостановка конвейера в фабрике данных Azure.
