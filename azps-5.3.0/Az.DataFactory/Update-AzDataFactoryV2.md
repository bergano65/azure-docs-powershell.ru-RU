...
## ОПИСАНИЕ
Командлет **Update-AzDataFactoryV2** обновляет теги и свойства удостоверений фабрики данных.
...
Эта команда обновляет теги фабрики WikiADF в словарь, содержащий тег myNewTagName со значением myTagValue.
