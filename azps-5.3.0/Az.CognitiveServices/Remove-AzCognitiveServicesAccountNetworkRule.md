...
## ОПИСАНИЕ
Командлет **Remove-AzCognitiveServicesAccountNetworkRule** удаляет IpRules или VirtualNetworkRules из свойства NetWorkRule учетной записи Cognitive Services.
...
### Пример 2. Удаление объекта VirtualNetworkRule с помощью JSON с помощью объекта VirtualNetworkRule
```
