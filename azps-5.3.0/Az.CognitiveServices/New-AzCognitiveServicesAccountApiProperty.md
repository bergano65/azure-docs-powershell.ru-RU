...
## SYNOPSIS
Создание нового экземпляра API-свойств учетной записи службы
...
## ОПИСАНИЕ
Создание нового экземпляра API-свойств учетной записи службы.
Свойства API можно использовать при создании или обновлении существующей учетной записи.
Свойства API требуются для определенных типов учетных записей.
...
В примере выше будет создаваться учетная запись QnAMaker со свойством API "QnaRuntimeEndpoint".
