...
## ОПИСАНИЕ
**Переключение-AzWebAppSlot** переключает два слота, связанных с Azure Web App.
...
Эта команда переключает слот sourceslot с destinationslot на web App ContosoWebApp, связанный с группой ресурсов Default-Web-WestUS.
...
Обмен с помощью предварительного просмотра
