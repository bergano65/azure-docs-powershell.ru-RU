...
У пользователей или групп должен быть указан формат участников-пользователей, например user@contoso.com или groups@contoso.com
...
Чтобы повторно включить контейнер резервного BLOB-ля, предостерегайте Uri резервного BLOB-контейнера в качестве -BackupBlobContainerUri.
...
### -PassThru
Возвращает удаленные сведения о сервере, если операция успешно завершена.
