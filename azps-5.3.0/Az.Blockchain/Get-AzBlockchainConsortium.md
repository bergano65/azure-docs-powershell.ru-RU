...
### Пример 1. Получить Консорциумы.
```powershell
PS C:\> Get-AzBlockchainConsortium -Location eastus

```

Эта команда содержит список unis в рамках подписки на определенное место.
...
### Microsoft.Azure.PowerShell.Cmdlets.Models.Api20180601Preview.IConsortium
