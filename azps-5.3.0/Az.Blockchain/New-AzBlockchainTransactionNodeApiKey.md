...
### Пример 1. Повторное сгенерировать ключи API для узла транзакции с использованием имени.
```powershell
...
Эта команда создает ключи API для узла транзакции с использованием имени группы ресурсов.

### Пример 2. Повторное сгенерировать ключи API для узла транзакции
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
Эта команда создает ключи API для узла транзакции с использованием idenity.
