...
### Пример 1. Повторное сгенерировать клавиши API для участника группы с использованием имени
```powershell
...
Эта команда повторно сгенерирует ключи API для участника, используя имя группы ресурсов.

### Пример 2. Повторное сгенерировать клавиши API для участника группы с использованием idenity
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Эта команда повторно сгенерирует клавиши API для участника группы с использованием удостоверения.
