...
### Пример 1. Создание узла транзакции
```powershell
...
Эта команда создает узел транзакций.
...
Чтобы построить новую таблицу, см. раздел "ЗАМЕТКИ" для свойств FIREWALLRULE и создание hash table.
...
### -Location
Возвращает или устанавливает расположение узла транзакции.
