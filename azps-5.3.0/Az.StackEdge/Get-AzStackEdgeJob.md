...
## ОПИСАНИЕ
Для работы на устройстве Stack Edge можно получить активные задания для **get-AzStackEdgeJob.** Вы можете упомянуть параметр Name, чтобы получить сведения об определенном заданиях.
