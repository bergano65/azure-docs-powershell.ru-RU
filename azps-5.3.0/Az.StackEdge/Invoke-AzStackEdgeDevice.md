...
## ОПИСАНИЕ
**Cmdlet Invoke-AzStackEdgeDevice** вызывает действия для сканирования, скачивания и установки обновлений на устройстве Stack Edge. На устройстве ежедневно выполняется автоматическое сканирование, которое можно активировать явным образом с помощью этого cmdlet.
...
### -FetchUpdate
Скачивает обновления на устройстве с выходом из системы стека или шлюза.
...
### -InstallUpdate
Установка обновлений на устройстве Edge или шлюза Stack
...
### -ScanForUpdate
Проверяет, нет ли обновлений на устройстве с технологией "Стек" или "Шлюз".
