...
## ОПИСАНИЕ
Для создания новой доли на устройстве Stack Edge будет создаваться новый проектлет **New-AzStackEdgeShare.**
...
### -CloudShare
Предоставление имени ресурса существующего хранилищаAccountCredential
...
### -ContainerName
Имя контейнера (в зависимости от заданного формата данных, это имя azure Files/Pageblob/Block BLOB-файла)
...
### -NFS
AccessProtocol в случае создания "Поделиться"
...
### -UserAccessRight
предоставление доступа наряду с существующими именами пользователей для доступа к типам "Общий доступ к SMB" (например, @(@{"Имя пользователя"="имя пользователя-1";" AccessRight"="Read"}, @{"Username"="user-name-2";" AccessRight"="Read"}, @{"Username"="user-name-3";" AccessRight"="Custom"})
