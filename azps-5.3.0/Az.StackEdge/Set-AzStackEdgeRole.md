...
## ОПИСАНИЕ
Для устройства с Stack Edge роль IoT обновляется стеблицы **AzStackEdgeRole.** Старые установленные акции будут заменены новыми предоставленными в параметре ShareName.
