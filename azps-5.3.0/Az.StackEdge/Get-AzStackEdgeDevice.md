...
## ОПИСАНИЕ
Чтобы получить сведения о доступных устройствах Stack Edge, можно получить сведения **о cmdlet Get-AzStackEdgeDevice.** Вы можете указать имя устройства вместе с именем группы ресурсов, чтобы получить сведения о конкретном устройстве. 
...
### -Alert
Извлечение оповещений на устройстве Границы стека или шлюза
...
### -ExtendedInfo
Получает дополнительные сведения для указанного устройства Stack Edge или Stack Gateway.
...
### -NetworkSetting
Получает параметры сети для указанного устройства Stack Edge или Stack Gateway.
...
### -UpdateSummary
Сведения о доступности обновлений на основе последнего сканирования устройства. Она также получает сведения обо всех текущих заданиях скачивания и установки на устройстве.
