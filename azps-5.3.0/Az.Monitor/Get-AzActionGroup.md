...
## ОПИСАНИЕ
Для получения одной или более групп действий возвращается **cmdlet Get-AzActionGroup.**
...
В этой команде перечислены группы действий для заданной группы ресурсов.
