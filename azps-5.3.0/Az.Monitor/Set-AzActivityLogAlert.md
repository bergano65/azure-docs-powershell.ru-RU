...
**ПРИМЕЧАНИЕ.** В списке условий должно быть хотя бы одно с полем , равным "Категория". Если это условие не задано, в ответе на запрос к backend возвращается 400 (BadRequest).
