...
## ОПИСАНИЕ
Для создания профиля автомасштаби создается новый профиль **AzAutoscaleProfile.**
...
Вторая команда создает профиль с именем Profile01 с фиксированной датой с помощью правила в $Rule.
...
Первая команда создает правило авто шкалы с именем "Запросы", а затем сохраняет его в $Rule переменной.
Вторая команда создает профиль без расписания или фиксированной даты, а затем сохраняет его в переменной $Profile.
...
### -TimeWindowTimeZone
Определяет часовой пояс в часовом окне.
