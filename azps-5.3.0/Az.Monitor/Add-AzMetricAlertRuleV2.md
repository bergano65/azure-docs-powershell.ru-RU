...
## ОПИСАНИЕ
Добавляет или обновляет правило оповещения на основе **метрики версии 2 (нестандартной).** Добавленное правило связано с группой ресурсов и имеет имя. Этот cmdlet реализует шаблон ShouldProcess, то есть может запросить подтверждение у пользователя перед созданием, изменением или удалением ресурса.
...
При создании надстройки с помощью этих наборов можно создать правило метрических оповещений с измерениями.
