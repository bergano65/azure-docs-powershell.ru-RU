...
## ОПИСАНИЕ
Для получения правила метрического оповещения по имени или URI или всех правил метрических оповещений для указанной группы ресурсов или подписки возвращается правило метрического оповещения **Get-AzMetricAlertRuleV2.**

## ПРИМЕРЫ

### Пример 1. Все правила метрических оповещений в текущей подписке
```powershell
...
Эта команда получает все правила метрических оповещений в текущей подписке.

### Пример 2. Получите все правила метрических оповещений в группе ресурсов
...
Эта команда получает все правила метрических оповещений в группе ресурсов метрическаяAlertsRG.

### Пример 3. Получите правило метрических оповещений по имени
...
Эта команда получает правило метрических оповещений PS3182019 в группе ресурсов метрическаяAlertsRG.

### Пример 4. Получите правило метрических оповещений по ruleID
...
Эта команда получает правило метрических оповещений с заданным ИД ресурса.
