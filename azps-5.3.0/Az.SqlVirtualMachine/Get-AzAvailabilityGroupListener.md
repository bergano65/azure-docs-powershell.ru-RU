...
## ОПИСАНИЕ
Этот Get-AzAvailabilityGroupListener получает одного или несколько слушателей группы доступности из SQL Virtual Machine Group.
...
Эта команда получает сведения о слушателе группы доступности AgListener01 в группе SQL Virtual Machine Group SqlVmGroup01 и Resource Group ResourceGroup01.
...
Эта команда получает сведения обо всех группах доступности в группе SQL SqlVmGroup01 и группе ресурсов ResourceGroup01.
...
### -Name
Имя прослушки группы доступности.
