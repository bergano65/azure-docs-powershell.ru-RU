...
## ОПИСАНИЕ
С New-AzSqlVMGroup создается группа виртуальных машин Azure SQL machine.
...
Создает новую группу виртуальных SQL Azure с test-group vm в группе ресурсов ResourceGroup01.
$profile является объектом типа Microsoft.Azure.Management.SqlVirtualMa modelse.Models.WsfcDomainProfile
...
Имя, используемая для создания кластера
...
Имя, используемая для кластера операционных систем
...
Необязательный путь для fileshare
...
### -Location
SQL расположение группы виртуальных машин.
...
### -SKU
SQL выпуска группы виртуальных машин.
...
### -SqlServiceAccount
Имя, под SQL службы будут работать на всех SQL виртуальных машинах в кластере.
...
Первичный ключ учетной записи хранения
...
### -Tag
Теги, которые нужно связать с группой SQL машин.
...
### Microsoft.Azure.Commands.SqlVirtualMachine.SqlVirtualMavire.Model.AzureSqlVMGroupModel
