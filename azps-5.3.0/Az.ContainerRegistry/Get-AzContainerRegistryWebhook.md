...
### Пример 1. Получить указанный веб-сайт для реестра контейнеров
```powershell
...
Получить определенный веб-сайт реестра контейнеров
...
### Пример 3. Получите указанный веб-сайт реестра контейнера со сведениями о конфигурации
```powershell
...
Получить определенный веб-сайт реестра контейнера с подробными сведениями о конфигурации
