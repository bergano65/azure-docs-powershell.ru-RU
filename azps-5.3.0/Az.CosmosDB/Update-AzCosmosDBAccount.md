...
## SYNOPSIS
Обновив атрибуты учетной записи в ПараметрахDB.
...
## ОПИСАНИЕ
Обновив свойства учетной записи ВайссDB. Не удается обновить регионы учетной записи одновременно с другими свойствами.
...
Обновлено значение DefaultConsistencyLevel на "Strong", Enabled AutomaticFailover, Enabled MultipleWriteLocations и Enabled VirtualNetwork forБ учетной записи Скайп с именем учетной записи. 
...
Если используется согласованность связанных устаревших данных, это значение отражает величину устаревших данных (в периоде времени).
...
### Microsoft.Azure.Commands.ВацыDB.Models.PSCorsRule[]
