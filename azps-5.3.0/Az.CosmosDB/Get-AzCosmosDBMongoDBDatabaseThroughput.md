...
## SYNOPSIS
Получает свойства пропускной способности "Проект", задав свойства пропускной способности базы данных MongoDB.
...
## ОПИСАНИЕ
С помощью cmdlet **get-AzCosmosDBMongoDBDatabaseThroughput** можно получить свойства пропускной способности базы данных MongoDB.
