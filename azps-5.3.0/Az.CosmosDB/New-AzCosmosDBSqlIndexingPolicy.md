...
## SYNOPSIS
Создание объекта Sql IndexingPolicy в SqlDb.
...
## ОПИСАНИЕ
Для создания нового объекта типа **PSSqlIndexingPolicy** будет создаваться новый объект PSSqlIndexingPolicy.
