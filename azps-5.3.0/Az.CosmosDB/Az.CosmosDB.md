...
# Модуль Az.AzsDB
## Описание
В разделах этой статьи оговоряются о ARM Azure PowerShell для Azure Azure ARM DB. Командлеты существуют в области имен Microsoft.Azure.Commands.ВацыDB.

## Cmdlets Az.AzsDB
### [Get-AzCosmosDBAccount](Get-AzCosmosDBAccount.md)
Получает учетную запись "ЦыDB".
...
Возвращает значение ThroughputSettingsResource для существующего коллекции "ГоресDB" MongoDB.
...
Возвращает существующий контейнер SqlDb.
...
Возвращает значение ThroughputSettingsResource для существующей базы данных SqlDb.

### [Get-AzCosmosDBSqlStoredProcedure](Get-AzCosmosDBSqlStoredProcedure.md)
Получает существующую щипцы Sql StoredProcedure.
...
Возвращает существующую точки Sql UserDefinedFunction, существующие в Sql UserDefinedFunction.
...
Создает новую базу данных Вадима Гремлина (ПереуссDB).

### [New-AzCosmosDBGremlinGraph](New-AzCosmosDBGremlinGraph.md)
Создает новый Диаграмма Гремлин (Graph) вНося изменения в СхемуDb.
...
Создает локальный объект psGremlinSpatialSpec. 
...
Создает коллекцию "ЦыDB MongoDB".
...
Создает локальный объект psMongoDBIndex нового локального объекта.
...
Создает локальный объект psSqlIncludedPathIndex. 
...
Удалите КлючНая область Вадима Климова.
...
Удалите таблицу "ЦыDB".

### [Update-AzCosmosDBAccount](Update-AzCosmosDBAccount.md)
Обновив учетную запись ВайссDB. Выполняет исправление на стороне сервера.
...
Обновляет таблицу Климова Вадимова. Выполняет клиентскую операцию исправления, читая существующую таблицу.
...
Обновляет базу данных ВайсDB Гремлин. Выполняет обновление на стороне клиента, считыв существующую базу данных.
...
Обновляет Sql StoredProcedure вбокDb. Выполняет обновление на стороне клиента, считыв существующее исправление StoredProcedure.
...
Обновляет таблицу "Приобр". Выполняет клиентскую операцию исправления, читая существующую таблицу.
