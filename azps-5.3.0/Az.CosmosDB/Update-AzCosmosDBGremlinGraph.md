...
Объект ConflictResolutionPolicy типа PSConflictResolutionPolicy, если этот объект имеет тип ConflictResolutionPolicy контейнера.
...
### -IndexingPolicy
Объект политики индексации типа Microsoft.Azure.Commands.JonessDB.PSIndexingPolicy.
...
### -PartitionKeyPath
Путь к разделу, например "/адрес/почтовый индекс".
...
### -Throughput
Пропускная способность Гремлин Графа (RU/s).
...
### -UniqueKeyPolicy
Объект UniqueKeyPolicy типа Microsoft.Azure.Commands.ВапсDB.PSUniqueKeyPolicy.
...
### Microsoft.Azure.Commands.ВацыDB.Models.PSIndexingPolicy

### Microsoft.Azure.Commands.АsDB.Models.PSUniqueKeyPolicy

### Microsoft.Azure.Commands.ВацDB.Models.PSConflictResolutionPolicy
