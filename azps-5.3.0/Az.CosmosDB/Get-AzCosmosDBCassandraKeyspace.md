...
## SYNOPSIS
Получает ключ "КрасаВ", Климова и Климова.
...
## ОПИСАНИЕ
Для создания нового или обновления существующей клавишной области Вадима Кузьмина в **AzCosmosDBCassandraKeyspace.**
...
Get-AzCosmosDBCassandraKeyspace получает свойства существующего пространства В.И. Вы можете развернуть ресурс, чтобы получить _etag, _ts и _rid свойства.
