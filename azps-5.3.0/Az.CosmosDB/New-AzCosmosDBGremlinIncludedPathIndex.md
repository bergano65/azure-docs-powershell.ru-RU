...
## SYNOPSIS
Создает объект PSIndexes нового типа. Его можно передать в качестве значения параметра для Set-AzCosmosDBGremlinIncludedPath.
...
## ОПИСАНИЕ
Объект, соответствующий индексам IncludedPath в API Гремлина.
...
### -DataType
Тип данных, к которому применяется индексация.
Возможные значения: String, 'Number', 'Point', 'Polygon', 'LineString', 'MultiPolygon'
...
### -Kind
Указывает на тип индекса.
Возможные значения: 'Hash', 'Range', 'Spatial'
...
### Microsoft.Azure.Commands.ВацыDB.Models.PSIndexes
