...
## SYNOPSIS
Удаление Точки Sql UserDefinedFunction в SqlDb.
...
## ОПИСАНИЕ
Для удаления **AzCosmosDBSqlUserDefinedFunction** удаляется Sql UserDefinedFunction, соответствующий заданным названиям ресурсов, AccountName и DatabaseName.
