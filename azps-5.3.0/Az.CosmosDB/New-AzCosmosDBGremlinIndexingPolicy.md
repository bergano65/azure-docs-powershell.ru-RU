...
### -IncludedPath
Массив строк, содержащих includedPath (указывает путь в документе JSON, который будет включен в службу Azure Azure Azure DB).)
...
Возможные значения: "Последователь", "Высвея" и "Нет".
...
### -SpatialSpec
Массив объектов типа Microsoft.Azure.Commands.ВацDB.PSSpatialSpec
