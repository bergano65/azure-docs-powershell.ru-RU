...
## SYNOPSIS
Получает пропускную способность таблицы "Приобр".
...
## ОПИСАНИЕ
С **помощью cmdlet get-AzCosmosDBTableThroughput** можно получить пропускную способность таблицы Вадима Зуева.
