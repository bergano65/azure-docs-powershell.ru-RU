...
## ОПИСАНИЕ
Для обновления закладки в указанной рабочей области обновляется **cmdlet Update-AzSentinelAlertRuleAction.**
...
В этом примере **обновление alertRuleAction с помощью** объекта InputObject, заменив существующее действие новыми свойствами. 
