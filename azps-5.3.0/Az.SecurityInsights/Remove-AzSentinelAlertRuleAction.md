...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzSentinelAlertRuleAction** автоматический ответ удаляется из правила оповещения в указанной рабочей области.
Объект **AlertRuleAction** можно передать с помощью оператора конвейера или указать необходимые параметры.
