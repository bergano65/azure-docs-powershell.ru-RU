...
В этом примере **возвращается incidentComment** для указанного инцидента в указанной рабочей области, а затем он сохраняется в переменной $IncidentComment инцидента.
