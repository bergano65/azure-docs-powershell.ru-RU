...
## ОПИСАНИЕ
Для **обновления инцидента новый-azSentinelIncidentOwner** создает объект Incident Owner в памяти.
...
В этом примере создается **владелец** инцидентов и обновляется информация об инциденте для нового владельца.

## PARAMETERS

### -AssignedTo
Владелец инцидента — назначено
...
### -Электронная почта
Владелец инцидента — электронная почта
...
### -UserPrincipalName
Владелец инцидента— имя директора-пользователя
