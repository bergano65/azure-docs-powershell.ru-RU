...
## ОПИСАНИЕ
После New-AzCdnOrigin будет создаваться новый источник CDN в указанной конечной точке.
...
Этот cmdlet создаст новый источник CDN для указанной конечной точки. В качестве источника будет использовать предоставленное имя хознаб. 
