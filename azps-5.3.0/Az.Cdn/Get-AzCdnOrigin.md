...
## ОПИСАНИЕ
Для получения источника источник данных сети доставки содержимого (CDN) Azure и его данных конфигурации можно получить проектныйлет **Get-AzCdnOrigin.**
...
### -CdnEndpoint
Определяет объект конечной точки CDN, к которому относится источник.
...
### -EndpointName
Указывает имя конечной точки, к которой принадлежит сервер-источник.
...
### -OriginName
Указывает имя сервера-источника.
...
### -ResourceId
ИД ресурса источника CDN Azure.
