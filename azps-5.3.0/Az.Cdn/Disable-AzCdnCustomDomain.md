...
## ОПИСАНИЕ
**Cmdlet Disable-AzCdnCustomDomain** отключает защищенную доставку HTTPS пользовательского домена CDN.
...
Отключать доставку https для пользовательского домена.
