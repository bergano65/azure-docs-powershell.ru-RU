...
## SYNOPSIS
Создание учетной записи удаленной отрисовки
...
Создайте новый "пример" учетной записи удаленной отрисовки в текущей подписке, группе ресурсов "rg1" и Центральной сша.
