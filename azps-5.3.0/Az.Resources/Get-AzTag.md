...
**GetPredefinedTagSet:** командлет **Get-AzTag** получает предопределные теги Azure в вашей подписке.
...
Модуль "Теги Azure", который входит в **состав тега Get-AzTag,** помогает управлять предопределенами тегами Azure.
...
Чтобы применить предопределяный тег к группе ресурсов, используйте параметр *"Тег"* New-AzTag командлета.
...
### Пример 5. Получите весь набор тегов для ресурса
