...
## ОПИСАНИЕ
Журнал **Save-AzDeploymentScriptLog** сохраняет журнал выполнения сценария развертывания на диск.
...
Сохраняет журнал сценария развертывания с заданным именем и группой ресурсов.
...
Сохранение последних 3 строк журнала сценария развертывания с заданным именем и группой ресурсов.
...
### -Force
Переописывание существующего файла.
