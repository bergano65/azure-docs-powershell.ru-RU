...
При удалении существующих назначений ролей для настраиваемой роли удаление не удастся.
...
### -Force
Если за установлено, не вы запросит подтверждение перед удалением настраиваемой роли
