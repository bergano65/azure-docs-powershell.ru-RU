...
Получает приложение с ид объекта 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' и каналами к Update-AzADApplication, чтобы обновить отображаемого имени приложения на "MyNewDisplayName".
...
### -ReplyUrl
Определяет URL-адреса, на которые отправляются токены пользователей для регистрации, или ЮРИСов перенаправления, в которые отправляются коды авторизации oAuth 2.0 и маркеры доступа.
