...
## ОПИСАНИЕ
Создает новую версию шаблона с указанным содержимым шаблона ARM шаблона. Содержимое может быть либо из необработанных строк JSON (с помощью набора параметров **FromJsonStringParameterSet),** либо из указанного файла JSON (с помощью параметра **FromJsonFileParameterSet).**  
...
Создает новую версию спецификации шаблона "v2.0" в шаблоне Spec с именем myTemplateSpec. В качестве содержимого шаблона для указанной версии будет "myTemplateContent.jsARM".
