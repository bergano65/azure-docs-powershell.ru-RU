...
## ОПИСАНИЕ
Для развертывания в области клиента шаблон развертывания сохраняется в файле JSON с использованием cmdlet **Save-AzTenantDeploymentTemplate.**
...
Эта команда получает "RolesDeployment" развертывания в текущей области клиента и сохраняет его шаблон.
