...
## ОПИСАНИЕ
**Из-за настройки Stop-AzDeployment** развертывание отменяется в рамках подписки, которое началось, но не завершено.
...
Чтобы создать развертывание в рамках подписки, воспользуйтесь New-AzDeployment..
