...
## ОПИСАНИЕ
Параметр **Test-AzDeployment** определяет, допустим ли шаблон развертывания и его значения параметров.
...
### Пример 2. Тестирование развертывания с использованием настраиваемого объекта шаблона и файла параметров
```
...
Эта команда проверяет развертывание в текущей области подписки, используя в памяти файл, созданный из данного файла шаблона, и файл с параметрами.
