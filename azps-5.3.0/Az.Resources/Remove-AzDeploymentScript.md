...
## ОПИСАНИЕ
Для удаления сценария развертывания и связанных с ним ресурсов удаляется **cmdlet Remove-AzDeploymentScript.**
...
Удаляет сценарий развертывания с именем MyDeploymentScript в группе ресурсов DS-TestRG.
