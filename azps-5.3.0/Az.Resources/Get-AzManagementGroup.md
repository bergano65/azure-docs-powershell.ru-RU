...
## ОПИСАНИЕ
Этот Get-AzManagementGroup возвращает всю или определенную группу управления.

## ПРИМЕРЫ

### Пример 1. Получить все группы управления
```
...
### Пример 2. Получить конкретную группу управления
```
...
### Пример 3. Получить группу управления и первый уровень иерархии
```
...
С помощью `Expand` флажка можно перемещаться по массиву и получать сведения `Children` о каждом ребенке. Например, `Children[0]` вы можете предоставить сведения о группе с отображаемой именем. `TestGroup1DisplayName`

### Пример 4. Получите определенную группу управления и все уровни иерархии
```
...
### -Развернуть
Разорите выходные данные, чтобы вы выводить список детей группы управления
