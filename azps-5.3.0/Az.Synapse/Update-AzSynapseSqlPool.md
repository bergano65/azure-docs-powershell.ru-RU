...
## ОПИСАНИЕ
Для пула azure Synapse Analytics обновляется SQL **Update-AzSynapseSqlPool.**
...
Эта команда обновляет пул azure Synapse Analytics SQL.
...
Эта команда обновляет пул azure Synapse Analytics SQL по конвейеру.
...
Эта команда обновляет пул azure Synapse Analytics SQL с помощью ИД ресурса.
...
### -PerformanceLevel
Уровень SQL службы и уровень производительности, которые нужно назначить SQL пулу.
Например, DW2000c.
...
### -Версия
Версия SQL Synapse. Например, 2 или 3.
