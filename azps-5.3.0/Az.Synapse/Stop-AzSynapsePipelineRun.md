...
## ОПИСАНИЕ
С **помощью cmdlet Stop-AzSynapsePipelineRun** можно остановить запуск конвейера в рабочей области, заданной с кодом запуска конвейера.
...
Эта команда останавливает работу конвейера с помощью id b9730a13-aa12-4926-a8b3-8e3a974ab0bd в рабочей области ContosoWorkspace.
...
Эта команда останавливает работу конвейера с помощью id b9730a13-aa12-4926-a8b3-8e3a974ab0bd в рабочей области ContosoWorkspace через канал.
