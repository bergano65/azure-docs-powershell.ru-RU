...
## ОПИСАНИЕ
**Спарклет Get-AzSynapseSparkStatement** получает сведения об спарк-спарке Azure Synapse Analytics.
...
Эта команда получает все спарк-отчеты в конвейере спарк-сеанса.
