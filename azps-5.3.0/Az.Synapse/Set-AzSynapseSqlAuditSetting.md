...
## SYNOPSIS
Изменяет параметры аудита рабочей области Azure Synapse Analytics.
...
## ОПИСАНИЕ
Cmdlet **Set-AzSynapseSqlAuditSetting** изменяет параметры аудита рабочей области Azure Synapse Analytics.
