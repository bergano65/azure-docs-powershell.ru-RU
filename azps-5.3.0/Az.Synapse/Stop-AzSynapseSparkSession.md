...
## ОПИСАНИЕ
**Спарклет Stop-AzSynapseSparkSession** останавливает сеанс спаркпарков Synapse Analytics.
...
Эта команда останавливает сеанс спарк-сеанса Synapse Analytics.
...
Эта команда останавливает сеанс спаркпарков Synapse Analytics через конвейер.
