...
## ОПИСАНИЕ
Командлет **Update-AzSynapseWorkspace** обновляет рабочее пространство Azure Synapse Analytics.
...
Эта команда обновляет теги для указанной рабочей области Azure Synapse Analytics.
...
Эта команда обновляет теги указанной рабочей области Azure Synapse Analytics через конвейер.
...
Эта команда обновляет теги указанного рабочего пространства Azure Synapse Analytics через канал с ИД ресурса.
...
Новый пароль SQL администратора для рабочей области.
