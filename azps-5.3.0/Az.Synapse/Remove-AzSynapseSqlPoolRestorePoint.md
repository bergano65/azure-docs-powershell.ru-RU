...
## ОПИСАНИЕ
Cmdlet **Remove-AzSynapseSqlPoolRestorePoint** окончательно удаляет точку восстановления пула Azure Synapse Analytics SQL.
...
Эта команда удаляет точки восстановления пула SQL Azure Synapse Analytics.
...
Эта команда удаляет точки восстановления пула Azure Synapse Analytics SQL через канал.
...
Эта команда удаляет точки восстановления пула Azure Synapse Analytics SQL с указанным ИД ресурса.
...
### -InputObject
SQL создания точки восстановления пула входной объект времени создания, как правило, передается по конвейеру.
...
Имя синапсеи SQL даты создания точки восстановления.
...
### -SqlPoolObject
Входной объект SQL Pool обычно проходит через конвейер.
