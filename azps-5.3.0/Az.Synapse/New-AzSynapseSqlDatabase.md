...
## SYNOPSIS
Создает базу данных Synapse Analytics SQL.
...
## ОПИСАНИЕ
Чтобы получить сведения о базе данных Azure Synapse Analytics, можно получить сведения о SQL **Get-AzSynapseSqlDatabase.**
...
Эта команда создает базу данных Azure Synapse Analytics SQL.
...
### -Collation
Сортировка определяет правила сортировки и сравнения данных, и их невозможно изменить SQL создания пула.
По умолчанию для этого SQL_latin1_General_CP1_CI_AS.
