...
## ОПИСАНИЕ
Для **брандмауэра Update-AzSynapseFirewallRule** обновляется правило брандмауэра Azure Synapse Analytics.
...
Эта команда обновляет правило брандмауэра ContosoFirewallRule в рабочей области ContosoWorkspace с именем ContosoFirewallRule.
...
Эта команда обновляет правило брандмауэра ContosoFirewallRule в рабочей области через канал.
