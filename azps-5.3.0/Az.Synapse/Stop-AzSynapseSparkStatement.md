...
## ОПИСАНИЕ
Для отмены спарк-выписки по Synapse Analytics будет отменена **cmdlet Stop-AzSynapseSparkStatement.**
...
Эта команда отменяет выписку по спарку с указанным livy ID.
...
Эта команда отменяет команду спарка с указанным livy ID через канал.
...
### -LivyId
Идентификатор спарк-идентификатора.
