...
## ОПИСАНИЕ
При **этом** удаляется администратор Azure Active Directory (Azure AD) для Azure Synapse Analytics Workspace.
...
Эта команда удаляет администратор Azure AD для рабочей области ContosoWorkspace.
