...
## ОПИСАНИЕ
**Спарклет Update-AzSynapseSparkPool** обновляет пул спаркпарков Azure Synapse Analytics.
...
Эта команда обновляет пул спаркпарков Azure Synapse Analytics.
...
Эта команда обновляет пул спаркпарков Azure Synapse Analytics через канал.
...
Эта команда обновляет пул спаркпарков Azure Synapse Analytics с помощью ИД ресурсов.
...
Эта команда позволяет автоматически масштабировать пул спаркпарков Azure Synapse Analytics.
...
Эта команда отключает автоматический масштаб для пула спаркпарков Azure Synapse Analytics.
...
Эта команда позволяет автоматически приостановить пул спаркпарков Azure Synapse Analytics.
...
Эта команда отключает автоматическую паузу для пула спаркпарков Azure Synapse Analytics.
...
Количество неавиваиваемого времени (в минутах). Этот параметр должен быть указан, если включена автоматическая пауза.
...
### -EnableAutoScale
Указывает на то, должна ли быть включена автоматическая шкала.
