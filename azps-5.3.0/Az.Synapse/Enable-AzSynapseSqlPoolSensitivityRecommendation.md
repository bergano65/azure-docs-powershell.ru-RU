...
### Пример 1. Включить рекомендации по конфиденциальности для данного столбца в SQL Azure Synapse.
```powershell
...
### Пример 2. В качестве рекомендации по конфиденциальности для столбца Azure Synapse SQL с помощью Piping.
```powershell
