...
Эта команда создает рабочее пространство Synapse Analytics ContosoWorkspace, использующее хранилище данных ContosoAdlGenStorage в группе ресурсов ContosoResourceGroup.
...
Стандартное имя учетной записи хранения ADLS Gen2.
...
Имя виртуальной сети под управлением Synapse, выделенной для рабочей области Azure Synapse.
