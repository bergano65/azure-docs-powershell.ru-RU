...
## ОПИСАНИЕ
Чтобы получить сведения о администраторе Azure Active Directory (Azure AD) для рабочей области Azure Synapse Analytics в текущей подписке, можно получить сведения о том, как получить сведения о администраторе **Get-AzSynapseSqlActiveDirectoryAdministrator.**
