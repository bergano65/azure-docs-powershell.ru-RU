...
## ОПИСАНИЕ
Для рабочей области Azure Synapse Analytics можно получить расширенные параметры защиты от угроз с использованием **get-AzSynapseSqlAdvancedThreatProtectionSetting.**
