...
## ОПИСАНИЕ
Для узла runtime для самостоятельной интеграции в рабочей области обновляются свойства узла времени интеграции **Update-AzSynapseIntegrationRuntimeNode.** В настоящее время поддерживается только обновление "ConcurrentJobsLimit".
