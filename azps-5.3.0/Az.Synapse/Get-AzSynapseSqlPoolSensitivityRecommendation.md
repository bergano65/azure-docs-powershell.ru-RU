...
## ОПИСАНИЕ
Этот Get-AzSynapseSqlPoolSensitivityRecommendation возвращает рекомендуемые типы информации и метки конфиденциальности столбцов в SQL пуле.

## ПРИМЕРЫ

### Пример 1. Получите рекомендуемые типы данных и метки конфиденциальности для пула Azure Synapse SQL.
```powershell
...
### Пример 2. Получите рекомендуемые типы данных и метки конфиденциальности для пула Azure Synapse SQL с помощью Piping.
```powershell
