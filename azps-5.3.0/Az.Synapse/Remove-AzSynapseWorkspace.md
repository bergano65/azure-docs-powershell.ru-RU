...
## ОПИСАНИЕ
Командлет **Remove-AzSynapseWorkspace** окончательно удаляет рабочее пространство Azure Synapse Analytics.
...
Эта команда удаляет рабочее пространство Azure Synapse Analytics.
...
Эта команда удаляет через конвейер рабочей области Azure Synapse Analytics.
...
Эта команда удаляет рабочее пространство Azure Synapse Analytics через канал с указанным ИД ресурса.
