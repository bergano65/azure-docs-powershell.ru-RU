...
## ОПИСАНИЕ
Для пула Azure Synapse Analytics с SQL параметры аудита, задавающий параметры **Set-AzSynapseSqlPoolAuditSetting.**
...
В течение этого времени вы можете включить политику аудита хранилищ BLOB-SQL пула Azure Synapse Analytics с именем ContosoSqlPool с расширенными фильтрами с использованием предиктора T-SQL.
