...
## ОПИСАНИЕ
Для удаления триггера из рабочей области запускается **cmdlet Remove-AzSynapseTrigger.**
...
Удалите триггер ContosoTrigger из рабочей области ContosoWorkspace.
...
Удалите триггер ContosoTrigger из рабочей области ContosoWorkspace через канал.
