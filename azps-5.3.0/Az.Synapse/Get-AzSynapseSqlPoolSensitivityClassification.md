...
### SqlPoolObjectParameterSet (по умолчанию)
```
...
## ОПИСАНИЕ
Этот Get-AzSynapseSqlPoolSensitivityClassification возвращает текущие типы данных и метки конфиденциальности столбцов в SQL Azure Synapse.

## ПРИМЕРЫ

### Пример 1. Получите текущие типы данных и метки конфиденциальности для пула Azure Synapse SQL.
```powershell
...
### Пример 2. Получите текущие типы данных и метки конфиденциальности пула Azure Synapse SQL с Piping.
```powershell
...
### Пример 3. Получите текущий тип данных и метку конфиденциальности для определенного столбца в SQL Azure Synapse.
```powershell
...
### Пример 4. Получите текущий тип данных и метку конфиденциальности для определенного столбца в SQL Azure Synapse с помощью Piping.
```powershell
