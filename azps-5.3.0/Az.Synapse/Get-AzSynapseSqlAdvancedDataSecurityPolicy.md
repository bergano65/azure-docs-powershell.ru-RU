...
## ОПИСАНИЕ
Для получения политики Advanced Data Security рабочей области будет извлечена cmdlet **Get-AzSynapseSqlAdvancedDataSecurityPolicy.**
...
Эта команда получает advanced Data Security в рабочей области ContosoWorkspace.
...
Эта команда получает advanced Data Security в рабочей области ContosoWorkspace через канал.
