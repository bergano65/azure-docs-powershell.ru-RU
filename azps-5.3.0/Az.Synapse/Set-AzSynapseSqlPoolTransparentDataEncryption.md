...
## ОПИСАНИЕ
В этом режиме свойство **Set-AzSynapseSqlPoolTransparentDataEncryption** изменяет свойство прозрачного шифрования данных (TDE) пула azure Synapse Analytics SQL.
...
Эта команда включает TDE для SQL ContosoSqlPool в рабочей области с именем ContosoWorkspace.
...
### -State
Состояние прозрачного шифрования данных пула Sql Synapse Analytics Azure.
