...
## ОПИСАНИЕ
Cmdlet **Set-AzDtlVMsPerUserPolicy** задает виртуальную машину на пользователя в лабораторной, которая задает максимальное количество виртуальных машин, разрешенных для каждого пользователя.
...
### -Disable
Указывает на то, что этот cmdlet отключает политику для лабораторных анализов.
...
### -Enable
Указывает на то, что этот cmdlet включает политику для лабораторных анализов.
...
### -LabName
Задает имя лаборатории, для которой этот cmdlet задает виртуальные машины в политике пользователя.
