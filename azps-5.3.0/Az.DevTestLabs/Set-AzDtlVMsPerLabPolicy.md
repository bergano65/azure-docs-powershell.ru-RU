...
## ОПИСАНИЕ
Cmdlet **Set-AzDtlVMsPerLabPolicy** задает виртуальную машину в лабораторной политике, которая задает общее количество виртуальных машин, разрешенных в лабораторной.
