...
### Пример 1. Прежде чем инициировать перемещение ресурсов, проверьте инициировать их проверку.
```powershell
...
Прежде чем инициировать перемещение ресурсов, проверьте зависимость.

### Пример 2. Инициировать перемещение для набора ресурсов в коллекции Move, используя в качестве входных данных "Имя MoveResource"
```powershell
...
Инициировать перемещение для набора ресурсов в коллекции "Перемещение", используя в качестве входных данных "Имя MoveResource".

### Пример 3. Инициировать перемещение для набора ресурсов в коллекции "Перемещение", используя в качестве входных данных "SourceARMID"
```powershell
...
Инициировать перемещение для набора ресурсов в коллекции "Перемещение", используя в качестве входных данных "SourceARMID".
...
### -MoveResource
Возвращает или задает список ИД ресурсов, по умолчанию он принимает перемещение ид ресурса, если только тип ввода не был переключен с помощью свойства moveResourceInputType.
...
### -ValidateOnly
Возвращает или задает значение, указывающее, требуется ли только предварительный запуск операции.
