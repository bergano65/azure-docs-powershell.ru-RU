...
### Пример 1. Проверка зависимок перед удалением ресурсов.
```powershell
...
Проверьте зависимость перед удалением ресурсов.

### Пример 2. Удаляет перемещение ресурсов с использованием имени MoveResource в качестве входных данных
```powershell
...
Отклоняет перемещение ресурсов с использованием в качестве входных данных MoveResource Name.

### Пример 3. Удаляет перемещение ресурсов, используя в качестве входных данных "SourceARMID"
```powershell
...
Удаляет перемещение ресурсов, используя в качестве входных данных "SourceARMID".
