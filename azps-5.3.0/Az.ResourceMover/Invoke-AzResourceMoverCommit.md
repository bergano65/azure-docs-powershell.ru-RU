...
Прежде чем подтверждать, что ресурсы подтверждены, проверьте зависимость.
...
Зафиксировать набор ресурсов в коллекции перемещения, используя в качестве входных данных "Имя MoveResource"
