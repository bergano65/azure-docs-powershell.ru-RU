...
### Пример 1. Проверка зависимовлений перед подготовкой к ресурсам
```powershell
...
Прежде чем приготовьтесь к ресурсам, проверьте необходимые возможности.

### Пример 2. Инициировать подготовку к набору ресурсов в коллекции перемещения с использованием имени MoveResource в качестве входных данных
```powershell
...
Инициировать подготовку к набору ресурсов в коллекции перемещения, используя в качестве входных данных "Имя MoveResource".

### Пример 3. Инициировать подготовку к набору ресурсов в коллекции "Перемещение" с помощью "SourceARMID"
```powershell
...
Инициировать подготовку к набору ресурсов в коллекции "Перемещение" с помощью "SourceARMID".
