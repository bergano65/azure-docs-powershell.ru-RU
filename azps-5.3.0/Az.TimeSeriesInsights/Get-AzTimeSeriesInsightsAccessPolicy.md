...
### Пример 1. Список всех политик доступа в определенной среде
```powershell
...
Эта команда содержит список всех политик доступа, которые находятся в указанной среде.

### Пример 2. Получить указанную политику доступа по имени
```powershell
...
### Пример 3. Получить указанную политику доступа для объекта
```powershell
...
### -Name
Имя политики доступа "Time Series Insights", связанной с указанной средой.
