...
### Пример 1. Список всех наборов справочных данных в указанной среде
```powershell
...
Эта команда содержит список всех наборов справочных данных в указанной среде.

### Пример 2. Получить заданную ссылку на данные по имени
```powershell
...
Эта команда получает указанный набор справочных данных.

### Пример 3. Получить заданную ссылку на данные, заданную объектом
```powershell
...
### -Name
Имя набора справочных данных по time series Insights, связанного с указанной средой.
