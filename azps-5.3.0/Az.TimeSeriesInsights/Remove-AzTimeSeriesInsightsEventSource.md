...
### Пример 1. Удаление указанного источника события по имени
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEventSource -EnvironmentName tsitest001 -Name iots001 -ResourceGroupName testgroup

```

При этом удаляется определенный источник события.

### Пример 2. Удаление источника события, заданного объектом
```powershell
