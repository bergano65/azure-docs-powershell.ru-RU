...
## ОПИСАНИЕ
С **его** учетной записью создается триггер для подписки на совместное использование для указанного интервала повторения и времени синхронизации в учетной записи azure data share.
...
Эта команда создает новый триггер AdsTrigger для обмена подпиской AdsShareSubscription с интервалом ежедневного повторения в 9:00.
...
### -RecurrenceInterval
Интервал повторения триггера (день или час)
