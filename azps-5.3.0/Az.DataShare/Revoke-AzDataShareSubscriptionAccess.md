...
## ОПИСАНИЕ
**Cmdlet Revoke-AzDataShareSubscriptionAccess** предоставляет доступ к источнику
...
Отзыв доступа к подписке на совместное использования, означаемой id 8ee6e6fd-b4a1-49a4-bb66-f187f38e0e12
