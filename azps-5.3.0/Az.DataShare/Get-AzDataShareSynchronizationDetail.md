...
## ОПИСАНИЕ
**Cmdlet Get-AzDataShareSynchronizationDetail** предоставляет подробные сведения о синхронизации, начатой для поделиться.
...
Эта команда предоставляет сведения о синхронизации всех наборов данных, соответствующих предоставленному id синхронизации.
