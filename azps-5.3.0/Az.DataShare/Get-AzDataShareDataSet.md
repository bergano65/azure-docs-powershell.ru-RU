...
## ОПИСАНИЕ
Чтобы получить сведения о наборах данных, добавленных в обет в учетной записи azure, можно получить с его учетной записью **Get-AzDataShareDataSet.** Если указать имя набора данных, этот cmdlet получит сведения о наборе данных. Если имя не указано, этот cmdlet получает сведения обо всех наборах данных в области. I
...
Эта команда отображает сведения о наборе данных AdsDataSet в share AdsShare в Azure data account Share WikiAdsAccount и группа ресурсов ADS.
