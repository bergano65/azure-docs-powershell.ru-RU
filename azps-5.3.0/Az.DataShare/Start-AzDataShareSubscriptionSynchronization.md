...
## ОПИСАНИЕ
**Cmdlet Start-AzDataShareSubscriptionSynchronization** инициирует синхронизацию для подписки на доступ
...
Эти команды инициируют синхронизацию для публикации на сайте AdsShareSubscription в учетной записи WikiAds. 
...
### -SynchronizationMode
Режим синхронизации (fullSync или добавоченный)
