...
Этот коммант предоставляет сведения о приглашениях от потребителей.
...
### -Location
Расположение приглашения для передачи данных Azure.
