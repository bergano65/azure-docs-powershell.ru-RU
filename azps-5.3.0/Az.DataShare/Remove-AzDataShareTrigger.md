...
## ОПИСАНИЕ
Для **удаления триггера datashareTrigger Remove-AzDataShareTrigger** удаляется триггер datashare.
...
Эти команды удаляют триггер AdsTrigger из share subscription AdsShareSubscription. 
...
### -InputObject
Объект триггера передачи данных Azure
...
### -ResourceId
ИД ресурса триггера обмена данными Azure
