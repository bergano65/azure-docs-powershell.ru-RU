...
В этом примере вы извлекаете брандмауэр, а затем добавляет в брандмауэр коллекцию правил приложения с помощью метода вызова AddApplicationRuleCollection.
...
В этом примере мы извлекаем брандмауэр, а затем добавляем в брандмауэр коллекцию правил сети с помощью метода вызова AddNetworkRuleCollection.
...
В этом примере получается брандмауэр, а затем по имени получается коллекция правил методов GetNetworkRuleCollectionByName в объекте брандмауэра. Имя коллекции правил для метода GetNetworkRuleCollectionByName нечувствительно к делу.
...
В этом примере извлекает брандмауэр и вызывает "Выделить" в брандмауэре, чтобы запустить службу брандмауэра с использованием конфигурации (коллекций правил приложений и правил сети), связанной с брандмауэром.
