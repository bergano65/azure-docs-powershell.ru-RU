...
## ОПИСАНИЕ
Создает ресурс-базовую подпись. Для этого потребуется общедоступный IP-адрес и VirtualNetwork. В этой службе VirtualNetwork должна быть подсеть с именем AzureBastionSubnet. Ip-адрес pubic необходимо создать со стандартным SKU.
...
### -ResourceGroupName
Название группы ресурсов, для которой нужно создать базовую подпись.
