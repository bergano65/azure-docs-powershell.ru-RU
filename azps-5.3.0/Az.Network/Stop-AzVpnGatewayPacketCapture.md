...
## SYNOPSIS
Остановка операции захвата пакетов на VPN-шлюзе.
...
## ОПИСАНИЕ
Остановка операции захвата пакетов на VPN-шлюзе и отправка результата для заданного контейнера хранилища SasUrl.
...
### -InputObject
Объект Vpn Gateway, в котором нужно начать захват пакетов.
...
### -Name
Имя шлюза Vpn, в котором нужно начать захват пакетов.
...
### -ResourceId
Azure resource ID of the VpnGateway where packet capture to be started.
...
### -SasUrl
URL-адрес SAS для захвата пакетов на шлюзе Vpn.
