...
### Пример 1. Удаление указанного монитора подключения
```powershell
PS C:\> Remove-AzNetworkWatcherConnectionMonitor -Location centraluseuap -Name cm
```

В этом примере мы удаляем монитор, заданный по расположению и имени.

### Пример 2

"Удалить монитор подключения". (autogenerated)
