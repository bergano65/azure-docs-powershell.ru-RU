...
## ОПИСАНИЕ
Cmdlet **Get-AzVpnServerConfiguration** возвращает существующую структуру VpnServerConfiguration для подключения point к сайту.
...
С помощью этой команды вы получите существующую команду VpnServerConfiguration.
