...
## ОПИСАНИЕ
Для шлюза приложения с помощью **cmdlet Get-AzApplicationGatewayWebApplicationFirewallConfiguration** получает конфигурацию брандмауэра веб-приложения (WAF).
