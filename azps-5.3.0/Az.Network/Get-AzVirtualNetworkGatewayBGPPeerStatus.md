...
## ОПИСАНИЕ
Эта команда является одноранговой службой BGP, для настройки одноранговой связи с виртуальным сетевым шлюзом Azure. Также предоставляется состояние каждого из них.
