...
## SYNOPSIS
Извлекает ресурс таблицы маршрутов концентратора, связанный с VirtualHub.
...
## ОПИСАНИЕ
Возвращает указанную таблицу маршрутов концентратора, связанную с указанным виртуальным концентратором.
...
Эта команда получает таблицу маршрутов концентратора виртуального концентратора.
...
В этой команде перечислены все таблицы маршрутов концентратора в указанной службе VirtualHub.
...
### -ResourceId
ИД ресурса, который нужно получить.
