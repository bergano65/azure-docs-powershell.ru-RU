...
## ОПИСАНИЕ
С помощью cmdlet **get-AzP2sVpnGateway** можно получить существующий проект P2SVpnGateway в virtualHub.
...
С помощью **cmdlet get-AzP2sVpnGateway** можно получить в virtualHub уже существующую часть P2SVpnGateway, которая используется для подключения point к сайту.
