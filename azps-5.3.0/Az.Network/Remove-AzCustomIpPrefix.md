...
## ОПИСАНИЕ
Для **удаления customIpPrefix удаляется cmdlet Remove-AzCustomIpPrefix.**
...
Удаляет customIpPrefix с именем $prefixName из группы ресурсов $rgName
