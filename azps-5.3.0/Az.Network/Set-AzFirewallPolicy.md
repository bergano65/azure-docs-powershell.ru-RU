...
## ОПИСАНИЕ
**Cmdlet Set-AzFirewallPolicy** обновляет политику брандмауэра Azure.
...
В этом примере для политики брандмауэра за устанавливается значение новой политики брандмауэра.
...
В этом примере политика брандмауэра настраиваема в новом режиме intel-угрозы
...
В этом примере политика брандмауэра настраиваема с помощью нового списка intel угроз
