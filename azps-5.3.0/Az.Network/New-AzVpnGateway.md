...
New-AzVpnGateway создает масштабируемый VPN-шлюз. Это программное обеспечение, определяемое подключением сайта к подключениям к сайтам внутри VirtualHub. 

Размер и масштаб этого шлюза меняются в зависимости от единицы, указанной в этом или Set-AzVpnGateway блоке. 

Подключение устанавливается из ветви или сайта (VPNSite) к масштабируемого шлюзу. Каждое подключение состоит из 2 Active-Active.
