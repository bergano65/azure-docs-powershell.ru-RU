...
## SYNOPSIS
Скачайте документ авторизации для порта express route.
...
## ОПИСАНИЕ
New-AzExpressRoutePortLOA скачать документ авторизации в формате PDF для порта express route.
...
Скачайте документ авторизации для порта express route "myPort" и храните его в файле "loa.pdf".
...
### -CustomerName
Имя клиента, которому назначен этот порт Express Route.
...
### -Destination
Выходной файл, в котором будет храниться досье.
