...
## ОПИСАНИЕ
Для балансиирования нагрузки Azure добавляется пул адресов для дополнительных адресов **Add-AzLoadBalancerBackend.**

## ПРИМЕРЫ

### Пример 1. Добавление конфигурации пула адресов для дополнительных адресов в баланс
```powershell
PS C:\>Get-AzLoadBalancer -Name "MyLoadBalancer" -ResourceGroupName "myrg" | Add-AzLoadBalancerBackendAddressPoolConfig -Name "BackendAddressPool02" | Set-AzLoadBalancer
```

Эта команда получает балансир загрузки MyLoadBalancer, добавляет пул адресов backend с именем BackendAddressPool02 в MyLoadBalancer, а затем использует командлет **Set-AzLoadBalancer** для обновления MyLoadBalancer.
