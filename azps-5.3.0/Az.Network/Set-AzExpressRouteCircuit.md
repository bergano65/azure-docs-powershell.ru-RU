...
## ОПИСАНИЕ
**Cmdlet Set-AzExpressRouteCircuit** сохраняет измененный канал ExpressRoute в Azure.

## ПРИМЕРЫ

### Пример 1. Изменение ServiceKey в канале ExpressRoute
```
...
### -ExpressRouteCircuit
Определяет объект **ExpressRouteCircuit,** который изменяет этот cmdlet.
