...
Сначала мы создадим объект virtual Hub Route и используем его для создания ресурса таблицы маршрутов виртуальных концентраторов. Затем мы перенастроим этот ресурс таблицы маршрутов на виртуальный концентратор с помощью Set-AzVirtualHub управления.
...
### -RouteTable
Таблицы маршрутов, связанные с этим виртуальным центром.
