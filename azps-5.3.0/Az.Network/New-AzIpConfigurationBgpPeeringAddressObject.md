...
```
## ОПИСАНИЕ
С помощью **свойства New-AzIpConfigurationBgpPeeringAddressObject** создается объект IpConfigurationBgpPeeringAddressObject, который представляет свойство BgpPeeringAddresses в Bgpsettings виртуального сетевого шлюза.
...
Выше будет создаваться ipConfigurationBgpPeeringAddressObject.This new object will be to gw1ipconfBgp1.
...
### -CustomAddress
Список customAddress виртуального сетевого шлюза для BgpPeeringAddresses.
...
### -IpConfigurationId
Виртуальный сетевой шлюз IpConfigurationId для BgpPeeringAddresses.
