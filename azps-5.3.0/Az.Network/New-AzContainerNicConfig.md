...
Первая команда создает конфигурацию сетевого интерфейса пустого контейнера. Второй создает новый профиль сети, передавая ранее созданную конфигурацию сетевого интерфейса контейнера в качестве аргумента New-NetworkProfile-New-NetworkProfile.
