...
С помощью cmdlet **get-AzP2sVpnGatewayConnectionHealth** можно получить текущее агрегированное состояние точки на подключения к сайту из P2SVpnGateway. Команда "Сделать вывод" выше показывает, что количество точек с клиентами сайтов, подключенных к P2SVpnGateway, составляет 2. Общее количество ветвей в регрессии и регрессии, переданных через P2SVpnGateway, равно 100 и 200 соответственно. Для клиентов сайта выделены IP-адреса 192.168.2.1, "192.168.2.2".
