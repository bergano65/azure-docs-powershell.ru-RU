...
Последняя команда получает конфигурацию разрядки подключений из веб-параметров HTTP $Settings и сохраняет ее в переменной $ConnectionDraining подключения.
