...
## ОПИСАНИЕ
Для создания пользовательской ошибки будет создаваться новый **cmdlet New-AzApplicationGatewayCustomError.**
...
Эта команда создает настраиваемую ошибку http-кода состояния 403.
