...
## ОПИСАНИЕ
С **помощью cmdlet New-AzContainerNicConfigIpConfig создается** конфигурация IP-интерфейса контейнера. 
...
Первые две команды создают и инициализируют сети vnet и подсети. Третья команда создает профиль конфигурации контейнера nic, ссылающийся на созданную подсеть. Четвертая команда создает конфигурацию сетевого интерфейса контейнера с профилем конфигурации IP, созданным в предыдущей команде. Наконец, пятая команда создает профиль сети, инициализированный с конфигурацией сетевого интерфейса контейнера, храняной в $containerNicConfig.
...
### -Name
Имя профиля конфигурации конфигурации сетевого интерфейса контейнера.
