...
Вторая команда изменяет правило маршрутики запроса шлюза приложения, чтобы использовать back-end HTTP-параметры, указанные в переменной $Setting, http-прослушивание, указанное в переменной $Listener, и пул конечных адресов, заданный в переменной $Pool.
...
### -Name
Указывает имя правила маршрутики запроса, которое изменяет этот cmdlet.
