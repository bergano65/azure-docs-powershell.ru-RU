...
## SYNOPSIS
Списки маршрутов, объявленных определенным виртуальным маршрутизатором
...
## ОПИСАНИЕ
С учетом одноранговых виртуальных маршрутизаторов (по имени или по объекту) продумывка маршрутов, объявленных в этом пире с помощью определенного виртуального маршрутизатора.
...
### -ResourceGroupName
Имя группы виртуальных одноранговых ресурсов маршрутизатора
