...
### Пример 1. Изменение конфигурации перенаправрованного трафика виртуального сетевого пиринга
```
...
Однако для одноранговой сети VNet должен быть настроен шлюз, а у **allowGatewayTransit** должно быть значение, равное $True.
