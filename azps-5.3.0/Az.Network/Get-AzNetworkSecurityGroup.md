...
## SYNOPSIS
Получает группу безопасности сети.
...
### Пример 1. Извлечение существующей группы безопасности сети
```powershell
...
### Пример 2. Список существующих групп безопасности сети с помощью фильтрации
```powershell
...
### -Name
Указывает имя группы безопасности сети, которую получает этот cmdlet.
...
### -ResourceGroupName
Имя группы ресурсов, к которой относится группа безопасности сети.
