...
Выше будет создаваться объект маршрутов виртуального концентратора, который можно включить в таблицу маршрутов виртуального концентратора.

Виртуальный маршрут концентратора — это объект в памяти, который можно использовать для создания объекта VirtualHubRouteTable.
