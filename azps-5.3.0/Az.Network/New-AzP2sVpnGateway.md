...
## SYNOPSIS
Создайте новую веб-часть P2SVpnGateway в VirtualHub, чтобы указать на подключение к сайту.
...
## ОПИСАНИЕ
С помощью **cmdlet New-AzP2sVpnGateway** можно создать в VirtualHub новую технологию P2SVpnGateway для подключения point к сайту от Point к клиентам сайта к Azure VirtualWan.
...
С помощью **cmdlet New-AzP2sVpnGateway** можно создать в virtualHub новую технологию P2SVpnGateway для подключения point к сайту.
...
### -VirtualHub
С виртуальнойHub необходимо связана эта компания P2SVpnGateway.
