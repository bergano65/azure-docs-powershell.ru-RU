...
## ОПИСАНИЕ
С **помощью cmdlet New-AzFirewallPolicyNatRuleCollection** создается коллекция правил NAT для политики брандмауэра Azure.
...
В этом примере создается набор правил NAT с правилом сети.
