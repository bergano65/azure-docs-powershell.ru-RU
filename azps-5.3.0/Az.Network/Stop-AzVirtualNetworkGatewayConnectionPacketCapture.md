...
## ОПИСАНИЕ
Остановка операции захвата пакетов для подключения виртуального сетевого шлюза и отправка результата для заданного контейнера хранилища SasUrl.
...
### -Name
Имя подключения виртуального сетевого шлюза, для которого нужно начать захват пакетов.
...
### -ResourceId
ИД ресурса Azure в virtualNetworkGatewayConnection, в котором нужно начать захват пакетов.
...
### -SasUrl
URL-адрес SAS для остановки захвата пакетов на виртуальном сетевом шлюзе.
