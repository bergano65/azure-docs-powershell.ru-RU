...
## ОПИСАНИЕ
Для создания массива сопоставлений URL-путей с пулом серверов серверов создается массив сопоставлений **URL-адресов.**
...
Обратите внимание, что правила пути должны порядок и применяются в указанном порядке.
