...
Затем создается конфигурация WAF с отключенными правилами брандмауэра, настроенными в $disabledRuleGroup 1 и $disabledRuleGroup 2. Новая конфигурация WAF хранится в переменной $firewallConfig WAF.
