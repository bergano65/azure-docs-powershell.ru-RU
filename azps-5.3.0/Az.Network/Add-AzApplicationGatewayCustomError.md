...
## ОПИСАНИЕ
**Cmdlet Add-AzApplicationGatewayCustomError** добавляет настраиваемую ошибку на шлюз приложения.

## ПРИМЕРЫ

### Пример 1. Добавляет настраиваемую ошибку на уровень шлюза приложения
```powershell
...
Эта команда добавляет настраиваемую ошибку http status code 502 в шлюз приложения $appgw и возвращает обновленный шлюз.

### Пример 2. Добавляет настраиваемую ошибку на уровень прослушки шлюза приложения
```powershell
...
Эта команда добавляет настраиваемую ошибку http status code 502 в шлюз приложения $appgw на уровне слушателя и возвращает обновленный шлюз.
