...
Выше будет создание группы ресурсов, виртуальной WAN, виртуальной сети, виртуального концентратора в центральной части США в этой группе ресурсов в Azure. Также создается виртуальное сетевое подключение, которое является одноранговой сетью с виртуальным центром. Это виртуальное сетевое подключение будет обновлено для обеспечения безопасности в Интернете.
...
В этой службе можно включить безопасность Интернета для этого подключения.
