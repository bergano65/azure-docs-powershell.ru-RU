...
## ОПИСАНИЕ
**Новый-AzLoadBalancerOutboundRuleConfig** создает конфигурацию правил исходящие для балансиента нагрузки Azure.
...
Создает конфигурацию исходящие правила для балансиров нагрузки. (autogenerated)
