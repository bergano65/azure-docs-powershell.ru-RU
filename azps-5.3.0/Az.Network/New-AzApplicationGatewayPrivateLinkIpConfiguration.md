...
Эта команда создает конфигурацию IP-адреса PrivateLink с именем ipConfig01, в результате чего будет хранится переменная с именем $PrivateLinkIpConfiguration. 
