...
## ОПИСАНИЕ
С **помощью cmdlet Remove-AzApplicationGatewayHttpListener** http-прослушивание удаляется из шлюза приложения Azure.

## ПРИМЕРЫ

### Пример 1. Удаление http-прослушивание шлюза приложения
```
...
Вторая команда удаляет HTTP-прослушивание с именем Listener02 из шлюза приложения, $AppGw.

## PARAMETERS

### -ApplicationGateway
Указывает шлюз приложения, из которого необходимо удалить http-прослушивание.
...
### -Name
Указывает имя http-прослушивание, которое удаляет этот cmdlet.
