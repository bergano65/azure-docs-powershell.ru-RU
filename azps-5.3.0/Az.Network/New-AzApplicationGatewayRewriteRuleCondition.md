...
## ОПИСАНИЕ
**Cmdlet AzApplicationGatewayRewriteRuleCondition** создает условие правила переописи для шлюза приложения Azure.
...
```
Эта команда создает условие в правиле переписывание и сохраняет результат в переменной с $condition.
...
### -IgnoreCase
Как настроить этот флажок, чтобы игнорировать дело в шаблоне
...
### -Negate
Установите этот флажок, чтобы отменять проверку условий.
...
### -Pattern
Шаблон, который нужно найти в заглавной переменной
...
### -Variable
Имя заголовка, которое нужно настроить для него
