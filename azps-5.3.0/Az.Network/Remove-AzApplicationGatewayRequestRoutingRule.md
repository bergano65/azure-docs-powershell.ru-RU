...
## ОПИСАНИЕ
Cmdlet **Remove-AzApplicationGatewayRequestRoutingRule** удаляет правило маршрутизации запросов из шлюза приложения Azure.

## ПРИМЕРЫ

### Пример 1. Удаление правила маршрутки запроса из шлюза приложения
```
...
Вторая команда удаляет правило маршрутизов запроса "Правило02" из шлюза приложения, $AppGw.

## PARAMETERS

### -ApplicationGateway
Указывает шлюз приложения, из которого нужно удалить правило маршрутки запросов.
...
### -Name
Указывает имя правила маршрутки запроса, для которого этот cmdlet удаляется.
