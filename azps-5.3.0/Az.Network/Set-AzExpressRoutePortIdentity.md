...
## ОПИСАНИЕ
**Cmdlet Set-AzExpressRoutePortIdentity** обновляет локальный объект Azure ExpressRoutePort. Используйте **Set-AzExpressRoutePort,** чтобы назначить его ExpressRoutePort.
