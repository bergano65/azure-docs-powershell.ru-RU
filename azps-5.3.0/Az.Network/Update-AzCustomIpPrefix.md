...
## ОПИСАНИЕ
Командлет **Update-AzCustomIpPrefix** позволяет пользователю взимание комиссионных или списание customIpPrefix или изменение тегов ресурса.

## ПРИМЕРЫ

### Пример 1. Комиссионные для CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

С этой команды начинается процесс ввода в эксплуатацию customIpPrefix.
...
С этой команды начинается процесс декомиссии customIpPrefix.
...
При этом теги для customIpPrefix обновятся.
...
### -InputObject
Настраиваемый Префикс для настройки.
