...
## ОПИСАНИЕ
Для развертывания конфигурации узла APS в автоматизации Azure развертывается cmdlet **Get-AzAutomationDscNodeConfigurationDeployment.**
...
### Пример 2. Получите расписание развертывания
```
