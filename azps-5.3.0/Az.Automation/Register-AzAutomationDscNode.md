...
Определяет частоту в минутах, в течение которых локальный диспетчер конфигураций свяжется с сервером загрузки последней конфигурации узла автоматизации Azure.
