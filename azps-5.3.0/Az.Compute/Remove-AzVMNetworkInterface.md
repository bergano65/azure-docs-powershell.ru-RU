...
## ОПИСАНИЕ
Командлет **Remove-AzVMNetworkInterface** удаляет сетевой интерфейс виртуальной машины.
...
### -NetworkInterfaceIDs
Определяет массив кодов сетевого интерфейса, который удаляет этот cmdlet.
...
### -VM
Указывает виртуальную машину, с которой этот cmdlet удаляет сетевой интерфейс.
