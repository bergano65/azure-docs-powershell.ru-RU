...
## ОПИСАНИЕ
Для набора виртуальных машин (VMSS) задаются конкретные действия с набором масштаба **Set-AzVmss.**
...
### -Redeploy
Указывает на то, что при этом будет перезапись одной или более виртуальных машин в VMSS.
