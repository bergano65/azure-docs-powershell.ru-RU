...
Передайте этот объект New-AzContainerService для создания службы контейнеров.
...
Укажите объект в $Container *параметра ContainerService* из **New-AzContainerService.**
...
### -OrchestratorType
Определяет тип роторов для службы контейнеров.
