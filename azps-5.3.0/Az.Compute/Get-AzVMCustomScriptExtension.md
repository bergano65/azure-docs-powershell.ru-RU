...
## ОПИСАНИЕ
Чтобы получить сведения о расширении виртуальной машины на виртуальной машине, можно получить сведения о расширении настраиваемого сценария Виртуальной машины для **Get-AzVMCustomScriptExtension.**
...
Эта команда получает пользовательское расширение сценария ContosoCustomScript для виртуальной машины с именем VirtualMachine07.
