...
### -JoinOption
Определяет параметры присоединиться. Параметры присоединиться [см. в fJoinOptions](https://docs.microsoft.com/en-us/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
Введите полное различается имя ОО в кавычках.
...
### -TypeHandlerVersion
Определяет версию расширения домена.
