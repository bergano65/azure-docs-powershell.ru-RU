...
Оно загружается на виртуальную машину вместе с конфигурацией.
...
Она перезаписывается путем к данным конфигурации, заданным Set-AzVMDscExtension-м
...
Указывает суффикс для точки хранения.
