...
Указывает состояние шифрования диска экземпляра VM 1 в наборе масштаба VM (VMSS001), который принадлежит группе ресурсов "Группа001".
...
### -ExtensionName
Имя расширения.
Если этот параметр не указан, по умолчанию используются значения AzureDiskEncryption для windows VMs и AzureDiskEncryptionForLinux для VMs linux.
