...
Эта команда заставляет обновление материала службы ходить в обл. 0 для набора масштаба виртуальной машины, заданного с помощью имени группы ресурсов и имени набора масштаба.
...
Эта команда обновит материал службы и обновит версию на 1 для набора виртуальных машин, заданного объектом набора масштаба VM.
