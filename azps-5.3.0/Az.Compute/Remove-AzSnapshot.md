...
## ОПИСАНИЕ
Для **удаления снимка снимок удаляется cmdlet Remove-AzSnapshot.**
...
Эта команда удаляет моментальный снимок с именем "Моментальный снимок01" в группе ресурсов "Группа ресурсов01".
