...
## ОПИСАНИЕ
Для **этого можно получить представление** модели или экземпляра виртуальной машины Azure.
...
Эта команда получает представление модели и свойства экземпляра виртуальной машины с именем VirtualMa ветвь07.
...
### Пример 4. Получите все виртуальные машины в подписке
```
PS C:\> Get-AzVM
...
Эта команда возвращает все виртуальные машины в вашей подписке, которые начинаются с "тестового".
