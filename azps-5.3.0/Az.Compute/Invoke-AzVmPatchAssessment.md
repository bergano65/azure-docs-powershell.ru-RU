...
## ОПИСАНИЕ
Оценивает состояние исправлений для VM-системы и сообщает о всех обнаруженных исправлениях, доступных для установки.
...
### Microsoft.Azure.Commands.Compute.Automation.Models.PSVirtualMa modelsePatchAssessmentResult
