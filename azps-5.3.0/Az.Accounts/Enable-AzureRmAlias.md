...
## ОПИСАНИЕ
Включает псевдонимы префиксов AzureRm для модулей Az. Если указан модуль -, псевдонимы включены только в указанных модулях. В противном случае все псевдонимы AzureRm включены.
