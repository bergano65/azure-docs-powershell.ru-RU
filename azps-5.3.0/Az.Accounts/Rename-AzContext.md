...
Переименуем контекст с именем "Мой контекст" в "Работа".  После этой команды вы сможете использовать целевой контекст с помощью Select-AzContext трудоемких задач.
