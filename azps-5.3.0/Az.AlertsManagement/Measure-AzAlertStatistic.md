...
## ОПИСАНИЕ
**Измеритель-AzAlertStatistic** получает сводные сведения об оповещении.
...
Сгруппировать количество оповещений по серьезности и состояниям, отфильтрованным по состояниям активности.
