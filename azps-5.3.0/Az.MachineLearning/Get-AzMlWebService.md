...
В зависимости от переданных параметров он возвращает определение для конкретной веб-службы, набор определений веб-служб для указанной группы ресурсов в текущей подписке или набор определений для веб-служб в текущей подписке.
