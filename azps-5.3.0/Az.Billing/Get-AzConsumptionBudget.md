...
## ОПИСАНИЕ
С Get-AzConsumptionBudget или группы ресурсов возвращается список бюджетов в подписке или группе ресурсов.

## ПРИМЕРЫ

### Пример 1. Просмотр списка бюджетов на уровне подписки
```powershell
...
### Пример 2. Получить список бюджетов на уровне группы ресурсов
```powershell
...
### Пример 3. Получить бюджет с названием бюджета на уровне подписки
```powershell
...
### Пример 4. Получить бюджет с названием бюджета на уровне группы ресурсов
```powershell
