...
### Пример 1. Получите сведения о резервировании с помощью ИД заказа на резервирование для предоставленного диапазона дат
```powershell
...
### Пример 2. Получите сведения о резервировании с помощью ИД заказа на резервирование и ИД резервирования для предоставленного диапазона дат
```powershell
