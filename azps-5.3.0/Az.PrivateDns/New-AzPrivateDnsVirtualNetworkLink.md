...
Эта команда создает виртуальную сетевую связь, связанную с частной зоной DNS myzone.com и виртуальной сетью "myvirtualnetwork" (которая уже была создана в группе ресурсов) в указанной группе ресурсов, а затем сохраняет ее в переменной $Link.
