...
## SYNOPSIS
Создает новое удостоверение, назначенное пользователю, или обновляет существующее удостоверение.
...
### Пример 2
В этом примере создается новое назначенное удостоверение пользователя с **ИД1** в группе **ресурсов PSRG** в западной части региона.
