...
## ОПИСАНИЕ
Этот Set-AzEventHub обновляет свойства указанного концентратора событий.

## ПРИМЕРЫ

### Пример 1
Чтобы обновить свойства описания Eventhub, выполните следующие действия: 
...
Обновляет центр событий \` MyEventHubName, представленный объектом \` MyCreatedEventHub, устанавливая период хранения сообщения на 4 дня, количество разделов до 2 и свойства \` \` CaptureDescription.
...
Обновляет центр событий \` MyEventHubName, представленный объектом \` \` MyCreatedEventHub, устанавливая для периода хранения сообщений 4 дня и количество разделов \` — 2.
