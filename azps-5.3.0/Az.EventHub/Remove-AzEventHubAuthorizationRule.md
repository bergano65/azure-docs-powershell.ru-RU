...
## ОПИСАНИЕ
Этот Remove-AzEventHubAuthorizationRule удаляет указанное правило авторизации из данного концентратора событий.
...
Удаляет правило авторизации \` MyAuthRuleName \` из пространства имен \` MyNamespaceName. \`
