...
Обновите NetworkRuleSet, используя -ResourceId другого пространства имен.
...
### -InputObject
Объект Configuration NetworkruleSet
...
Указывает на то, включена ли trustedServiceAccessEnabled
