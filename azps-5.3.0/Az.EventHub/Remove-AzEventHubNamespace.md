...
## ОПИСАНИЕ
Этот Remove-AzEventHubNamespace удаляет указанное пространство имен концентраторов событий.
...
Удаляет пространство имен "Концентраторы \` событий" MyNamespaceName в группе ресурсов \` \` MyResourceGroupName. \`
...
### Пример 5. ResourceId — использование piping:
```powershell
PS C:\> Get-AzResource -ResourceType Microsoft.EventHub/Namespaces | Remove-AzEventHubNamespace
```

### Пример 6. ResourceId — использование строки:
```powershell
