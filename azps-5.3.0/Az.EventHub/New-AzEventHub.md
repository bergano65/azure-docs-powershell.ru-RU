...
Создает центр событий MyEventHubName с 3-дневной периодом хранения сообщений и двумя разделами в расположении WestUS и группой ресурсов \` \` \` \` \` MyResourceGroupName. \`
