...
Если предоставлен псевдоним (Аварийное восстановление), возвращаются сведения о правиле авторизации для настроенного пространства имен для псевдонима.
...
### Пример 5. AuthorizationRule для псевдонима (GeoRecovery Configuration)
```powershell
