...
## ОПИСАНИЕ
Для **параметра Set-AzHDInsightDefaultStorage** заданы параметры учетной записи хранения по умолчанию в объекте конфигурации кластера Azure HDInsight, созданном с помощью New-AzHDInsightClusterConfig.
...
### -StorageAccountKey
Указывает ключ учетной записи для используемой по умолчанию учетной записи хранилища Azure, которую будет использовать кластер HDInsight.
...
Имя учетной записи хранения, которая будет добавлена в новый кластер.
...
### -StorageAccountType
Возвращает или задает тип учетной записи хранения по умолчанию. Значения по умолчанию для AzureStorage
