...
## ОПИСАНИЕ
Этот Add-AzHDInsightComponentVersion добавляет версию для службы, запущенной в кластере, к объекту конфигурации Azure HDInsight, созданному New-AzHDInsightClusterConfig.

## ПРИМЕРЫ

### Пример 1. Добавление версии спарка к объекту конфигурации кластера.
```
...
Эта команда добавляет версию спарка в кластер HDInsight с именем "ваш-спарк-001".
