...
## ОПИСАНИЕ
Для работы с кластером HDInsight возвращается конфигурация автомасштабирования — **Get-AzHDInsightClusterAutoscaleConfiguration.**

## ПРИМЕРЫ

### Пример 1. Настройка автоматической настройки кластера HDInsight.
```powershell
...
Эта команда получает настройку автоматической настройки кластера HDInsight.
