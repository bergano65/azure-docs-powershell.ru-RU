...
## SYNOPSIS
Удаление настройки автомасштабы кластера HDInsight.
...
## ОПИСАНИЕ
Для удаления из кластера **HDInsightClusterAutoscaleConfiguration** удаляется настройка автомасштабирования кластера HDInsight.

## ПРИМЕРЫ

### Пример 1. Удаление настройки автомасштабы кластера HDInsight.
```powershell
...
Эта команда удаляет конфигурацию автоматической настройки кластера HDInsight.
