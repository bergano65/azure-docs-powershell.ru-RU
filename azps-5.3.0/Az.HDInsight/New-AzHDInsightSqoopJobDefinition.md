...
## ОПИСАНИЕ
Для использования с кластером Azure **HDInsightSqoopJobDefinition** определяется объект задания Sqoop.
...
### -LibDir
Определяет каталог библиотеки для задания Sqoop.
