...
## ОПИСАНИЕ
Для запуска указанного задания в кластере Azure **HDInsight** происходит остановка указанного задания.
...
Эта команда останавливает задание на кластере "ваш-hadoop-001".
