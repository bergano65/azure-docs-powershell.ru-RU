...
## ОПИСАНИЕ
Для получения состояния мониторинга установки в кластере Azure HDInsight возвращается состояние установки **Get-AzHDInsightMonitoring.** Если мониторинг включен, возвращается также id рабочей области для аналитики журналов.
