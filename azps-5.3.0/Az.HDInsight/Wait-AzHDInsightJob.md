...
## ОПИСАНИЕ
Для выполнения задания Azure HDInsight вы ожидаете завершения или сбоя задания **Wait-AzHDInsightJob.**
...
Эта команда ждет завершения или сбоя задания.
...
### -TimeoutInSeconds
Общее время, необходимое для завершения задания (в секундах).
...
Время, необходимое для проверки состояния задания (в секундах).
