...
Эта команда восстановит ключевое хранилище MyKeyVault, ранее удаленное из области eastus2 и группы ресурсов MyResourceGroup, в активное и можное состояние. Теги будут также заменяться новыми.
