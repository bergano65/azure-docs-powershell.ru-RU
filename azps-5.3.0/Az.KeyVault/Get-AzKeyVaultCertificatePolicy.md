...
## ОПИСАНИЕ
Cmdlet **Get-AzKeyVaultCertificatePolicy** получает политику сертификата в хранилище ключей Azure.

## ПРИМЕРЫ

### Пример 1. Получить политику сертификатов
```powershell
...
Эта команда получает политику сертификата TestCert01 в хранилище ключа ContosoKV01.
