...
При этом для этого хранилища включена защита от немедленного удаления. для включения неявного удаления требуется.
...
### -SKU
Указывает SKU экземпляра key vault. Сведения о том, какие возможности доступны для каждого SKU, см. на веб-сайте цены на ключ хранилища Azure ( https://go.microsoft.com/fwlink/?linkid=512521) .
