...
## ОПИСАНИЕ
Cmdlet **Remove-AzKeyVaultCertificateOperation** удаляет операцию сертификата из хранилища ключей.
...
Эта команда удаляет операцию сертификата TestCert01 из хранилища ключей ContosoKV01 без запроса на подтверждение.
