...
## ОПИСАНИЕ
Для указанного выпуска сертификата или всех его авторов в хранилище ключей Azure возвращается cmdlet **Get-AzKeyVaultCertificateIssuer.**
...
### -Name
Указывает имя выпуска сертификата, который нужно получить.
