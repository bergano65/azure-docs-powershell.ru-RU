...
Если не указано, существующее значение ключа автоматического повторного сгенерирования в управляемой учетной записи хранения не изменяется.
