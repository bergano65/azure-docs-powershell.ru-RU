...
Итоговая команда еще больше изменяет существующие разрешения на удаление всех PattiFuller@contoso.com разрешений для ключевых операций. Разрешения на секретные операции остаются без изменений после этой команды.
