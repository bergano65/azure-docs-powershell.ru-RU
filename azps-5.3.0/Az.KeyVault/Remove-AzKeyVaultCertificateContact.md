...
## ОПИСАНИЕ
**Cmdlet Remove-AzKeyVaultCertificateContact** удаляет контакт, зарегистрированный для уведомлений о сертификате, из хранилища ключей.
...
Эта команда удаляет Связь с Fuller в качестве контакта сертификата для хранилища ключей Contoso01.  Если задан passThru, cmdlet возвращает список оставшихся контактов сертификата.
...
### -EmailAddress
Определяет адрес электронной почты контакта, который нужно удалить.
