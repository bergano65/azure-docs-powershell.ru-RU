...
### Пример 2. Обновляет существующую службу healthcareapis с именем MyService в группе ресурсов MyResourceGroup с помощью uri ключа URI хранилища 500 и uri ключа хранилища uri "https:// \<my-keyvault> \<my-key> .vault.azure.net/keys/"
...
### -ThsOfferThroughput
HealthcareApis FhirServiceOughsOfferThroughput.
...
Отключать управляемые удостоверения.
