...
## SYNOPSIS
Получает пару ключей администратора для службы поиска Azure.
...
## ОПИСАНИЕ
Для получения ключевой пары службы поиска Azure используется cmdlet **Get-AzSearchAdminKeyPair.**
...
В этом примере используется пара ключей администратора для службы поиска Azure.
