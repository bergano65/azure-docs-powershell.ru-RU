...
## SYNOPSIS
Повторно сгенерирует ключ администратора службы поиска Azure.
...
## ОПИСАНИЕ
Для повторного сгенерации ключа администратора службы поиска Azure будет повторно сгенерироваться cmdlet **New-AzSearchAdminKey.**
...
В этом примере повторно сгенерирует первичный ключ службы поиска Azure.
...
### -KeyKind
Ключ администратора службы поиска (основной/дополнительный).
