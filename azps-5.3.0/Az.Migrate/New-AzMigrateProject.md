...
### Пример 1. Создание (по умолчанию)
```powershell
...
Способ создания проекта миграции.
...
Чтобы построить новую таблицу, см. раздел "ЗАМЕТКИ" для свойств и создание таблицы с hash.
...
СВОЙСТВО: <IMigrateProjectProperties> определяет свойства проекта.
  - `[ProvisioningState <ProvisioningState?>]`: подготовка проекта миграции.
  - `[RegisteredTool <String[]>]`: получает или задает список средств, зарегистрированных в проекте миграции.
