...
### Пример 1. Создание сопоставления
```powershell
...
### -MappingName
Имя сопоставления контейнера защиты.
...
Сведения о поставщике для сопряжения.
Чтобы создать, см. раздел "ПРИМЕЧАНИЯ" для свойств PROVIDERSPECIFICINPUT и создание hash table.
...
PROVIDERSPECIFICINPUT <IReplicationProviderSpecificContainerMappingInput> : входные данные поставщика для сопряжения.
