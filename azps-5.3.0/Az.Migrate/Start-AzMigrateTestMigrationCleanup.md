...
Объект сервера можно извлечь с помощью Get-AzMigrateServerReplication>Конструировать, см. раздел "ПРИМЕЧАНИЯ" для свойств INPUTOBJECT и создание hash table.
