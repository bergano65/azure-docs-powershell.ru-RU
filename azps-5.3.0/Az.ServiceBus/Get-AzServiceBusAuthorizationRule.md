...
## ОПИСАНИЕ
Для получения описания указанного правила авторизации в заданном пространстве имен, очереди, теме или псевдониме (GeoDR Configurations) можно получить описание указанного правила **авторизации.**
