...
## ОПИСАНИЕ
Для создания пространства имен рабочих автобусов создается **cmdlet New-AzServiceBusNamespace.** После создания манифеста ресурсов пространства имен будет неанимабельным. Эта операция является idempotent.
...
Создание нового пространства имен «Автобус обслуживания» в указанной группе ресурсов.
...
### -Location
Расположение пространства имен в автобусе обслуживания.
...
### -SkuCapacity
Единицы пропускной способности пространства имен «Шина обслуживания премиум, разрешенные значения 1 или 2 или 4).
...
### -SkuName
Имя SKU В области имен в области имен автобусов обслуживания.
