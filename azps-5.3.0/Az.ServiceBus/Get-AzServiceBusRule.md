...
## ОПИСАНИЕ
С **его учетом** можно получить описание указанного правила в указанной подписке на раздел.
...
Возвращает список описаний правил для указанной подписки.  По умолчанию возвращается 100 правил, если их больше 100, используйте параметр -MaxCount.
