...
## ОПИСАНИЕ
Для **указанного пространства имен автобусов** службы, очереди или раздела создается новое правило авторизации.
...
Создается `AuthoRule1` с **правами на** прослушивание и **отправку** для пространства `SB-Example1` имен.
...
Создается `AuthoRule1` с **правами на** прослушивание и **отправку** для очереди. `SBQueue`
...
Создается `AuthoRule1` с **правами** на прослушивание **и отправку** для данной темы. `SBTopic`
