...
## ОПИСАНИЕ
Для удаления очереди из указанного пространства имен "Служни" удаляется **cmdlet Remove-AzServiceBusQueue.**
...
Удаляет очередь "Обслуживание" в параметре $inputobject -InputObject.
