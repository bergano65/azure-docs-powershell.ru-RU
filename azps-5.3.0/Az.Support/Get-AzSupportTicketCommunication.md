...
| Получать сообщения, созданные после 20 декабря 2019 г.       | "CreatedDate gt 2019-12-20"                                |
...
### Пример 2. Извлечение одного сообщения по имени для билета в службу поддержки
```powershell
