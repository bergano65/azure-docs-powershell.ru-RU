...
### Пример 1. Все подключенные к интернету сети в рамках подписки
```powershell
...
Эта команда получает все подключенные к подписке куберсети.

### Пример 2. Все подключенные к кубберсети в группе ресурсов
```powershell
...
Эта команда получает все подключенные к группе ресурсов куберсети.

### Пример 3. Подключение к кубберсетям
```powershell
...
Эта команда получает подключенные куберсети.

### Пример 4. Подключение к кубберсетям по объектам
```powershell
...
Эта команда получает подключенные к объекту куберсети.
