...
Затем вторая команда использует эту ссылку на объект и командлет **Get-AzBatchSubtask** для возврата всех подзадач для myTask — задачи, которая выполняется в рамках задания 01.
