...
## ОПИСАНИЕ
Для отключения графика рабочих процессов Azure Batch отключается **cmdlet Disable-AzBatchJobSchedule.**
Если отключить расписание, задания не будут создаваться согласно этому расписанию.
Отключив расписание, вы сможете включить его позднее.

## ПРИМЕРЫ

### Пример 1. Отключение расписания работы
```
PS C:\>Disable-AzBatchJobSchedule -Id "JobSchedule17" -BatchContext $Context
```

Эта команда отключает расписание задания с расписанием задания ID JobSchedule17.
...
### -Id
Определяет код расписания задания, который этот cmdlet отключает.
