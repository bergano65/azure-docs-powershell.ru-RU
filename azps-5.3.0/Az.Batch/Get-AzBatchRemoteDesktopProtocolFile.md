...
Эта команда получает RDP-файл из узла вычислений, который содержит ID ComputeNode01 в пуле, который содержит пул ID Pool06.
...
Эта команда возвращает узел вычислений, который содержит ID ComputeNode02 в пуле, который содержит пул ID Pool06.
...
Вторая команда получает RDP-файл из узла вычислений, который содержит ID ComputeNode03 в пуле, который содержит пул ID Pool06.
