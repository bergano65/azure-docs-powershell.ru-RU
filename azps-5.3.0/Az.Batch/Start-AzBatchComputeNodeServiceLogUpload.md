...
## ОПИСАНИЕ
Этот cmdlet собирает файлы журнала пакетных служб Azure из узлов компьютеров, если вы столкнулись с ошибкой и хотите зайти в службу поддержки Azure. Чтобы решить проблемы с пакетной службой, необходимо делиться файлами журнала пакетной службы Azure со службой поддержки Azure. 
