...
Эта команда возвращает пакетные учетные записи, связанные с группой ресурсов CmdletExampleRG.
...
### -Tag
Пары значений ключа в виде hash table. Например: @{key0="value0";key1=$null;key2="value2"} Этот командлет получает учетные записи, содержащие теги, указанные этим параметром.
