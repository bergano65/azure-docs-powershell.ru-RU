...
## ОПИСАНИЕ
Для удаления источника данных из учетной записи Azure Data Lake Analytics удаляется cmdlet **Remove-AzDataLakeAnalyticsDataSource.**
...
Эта команда удаляет источник данных AzureStorage01 из учетной записи ContosoAdlAccount.
...
### -BLOB
Имя учетной записи хранилища AzureBlob, который нужно удалить.
...
### -DataLakeStore
Указывает имя учетной записи AzureData Lake Store, который нужно удалить.
