...
Начало операции обновления элемента, защищенного репликацией, выбранного без tc, включает ускорение работы сети при восстановлении VM-модели (при аварийном восстановлении из Azure в Azure).
...
### -NicSelectionType
Определяет свойства карточки сетевого интерфейса( NIC), задамые пользователем или заданные по умолчанию.
...
Доступность для элемента, защищенного репликацией, после отоятия.
...
Имя подсети в виртуальной сети Azure для восстановления, к которой во время отсещения должна быть подключена эта NIC защищенного элемента.
