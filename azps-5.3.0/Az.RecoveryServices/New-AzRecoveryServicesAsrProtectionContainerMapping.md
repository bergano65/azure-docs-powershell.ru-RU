...
## ОПИСАНИЕ
С помощью cmdlet **New-AzRecoveryServicesAsrProtectionContainerMapping** создается сопоставление контейнера Azure Site Recovery Protection Container, связывая указанную политику репликации с указанным контейнером защиты.
...
Определяет объект контейнера защиты ASR для контейнера защиты восстановления, который будет использоваться в сопоставлении (используется при репликации в расположение восстановления, не в azure).
