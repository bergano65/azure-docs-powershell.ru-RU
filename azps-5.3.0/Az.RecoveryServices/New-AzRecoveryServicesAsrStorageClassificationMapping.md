...
Начало операции создания сопоставления классификации хранилища с указанными параметрами и возврат задания asR, используемого для ее отслеживания.
...
### -Name
Указывает имя для сопоставления классификации хранилища ASR.
...
Указывает основной объект классификации хранилища ASR для сопоставления.
...
Определяет объект классификации хранилища asR восстановления для сопоставления.
