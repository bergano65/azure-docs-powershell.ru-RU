...
Создайте объект сопоставления дисков для дисковых дисков виртуальной машины vMWare, которые нужно реплицировать. Используется во время защиты компьютера vMWare.
