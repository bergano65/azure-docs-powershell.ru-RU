...
## ОПИСАНИЕ
Для защиты уже защищенной виртуальной машины Azure можно добавить диск с cmdlet **Add-AzRecoveryServicesAsrReplicationProtectedItemDisk.**
...
Начните операцию по добавлению указанной конфигурации диска для защиты. Пункт, защищенный репликацией входных данных в piping.
