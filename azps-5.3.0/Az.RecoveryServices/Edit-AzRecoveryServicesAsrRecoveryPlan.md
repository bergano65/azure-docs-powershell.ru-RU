...
### -AddProtectedItem
Список элементов, защищенных репликацией asR, которые нужно добавить в группу плана восстановления в объекте плана восстановления.
...
### -RemoveProtectedItem
Список элементов, защищенных репликацией ASR, которые нужно удалить из группы планов восстановления в объекте плана восстановления.
