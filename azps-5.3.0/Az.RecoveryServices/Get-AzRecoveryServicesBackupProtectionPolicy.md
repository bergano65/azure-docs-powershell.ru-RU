...
## ОПИСАНИЕ
Для **хранилища Скайп-AzRecoveryServicesBackupProtectionPolicy** получает политики защиты резервного копирования Azure.
...
Эта команда получает политику защиты с именем DefaultPolicy, а затем сохраняет ее в переменной $Pol безопасности.
