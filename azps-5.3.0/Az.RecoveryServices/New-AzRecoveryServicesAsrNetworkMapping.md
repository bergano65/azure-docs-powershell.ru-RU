...
Начало сопоставления сети для создания с использованием указанного имени, основных и восстановленных сетей и возврат задания asR для отслеживания операции (сценарий Azure в Azure).
