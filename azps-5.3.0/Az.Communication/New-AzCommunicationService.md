...
Создание ресурса ACS с использованием указанных параметров.
...
### -DataLocation
Расположение, в котором служба связи хранит неавтные данные.
...
### -Location
Расположение Azure, в котором запущена служба CommunicationService.
