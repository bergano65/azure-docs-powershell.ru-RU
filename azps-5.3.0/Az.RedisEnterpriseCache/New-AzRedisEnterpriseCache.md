...
### -ВуассионПолиция
Redis уличиваемая политика (по умолчанию — VolatileLRU).
...
MODULE <IModule[]>: необязательный набор модулей redis, которые можно включить в этой базе данных. Модули можно добавлять только во время создания.
