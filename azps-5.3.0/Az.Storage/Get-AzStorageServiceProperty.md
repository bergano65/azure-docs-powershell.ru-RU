...
## ОПИСАНИЕ
Для служб хранилища Azure свойства служб **Get-AzStorageServiceProperty** получаются.

## ПРИМЕРЫ

### Пример 1. Получить свойство служб хранилища Azure для службы BLOB-объектов
```
...
Эта команда получает свойство DefaultServiceVersion службы BLOB-объектов.
