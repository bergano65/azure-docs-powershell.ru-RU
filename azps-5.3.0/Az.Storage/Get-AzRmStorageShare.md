...
## ОПИСАНИЕ
Для получения или перечисления файлового пространства с его или иным списком можно выбрать один или несколько других файлов для **get-AzRmStorageShare.**
...
Эта команда получает папку хранилища с именем учетной записи хранения и именем в папке "Поделиться".

### Пример 2. Список всех файлов хранилища для учетной записи хранения
```
