...
## ОПИСАНИЕ
Для удаления файловой папки будет удалена из-за нее **cmdlet Remove-AzStorageShare.**

## ПРИМЕРЫ

### Пример 1. Удаление файловой папки
```
PS C:\>Remove-AzStorageShare -Name "ContosoShare06"
```

Эта команда удаляет файл с именем ContosoShare06.

### Пример 2. Удаление файловой папки и всех ее снимков
```
PS C:\>Remove-AzStorageShare -Name "ContosoShare06" -IncludeAllSnapshot
```

Эта команда удаляет файл с именем ContosoShare06 и все его моментальные снимки.
...
### -Force
Принудительно удалите обойму для всех моментальных снимков и всего содержимого.
...
### -IncludeAllSnapshot
Удаление файла "Поделиться" со всеми его снимками
...
### -Name
Имя файловой папки.
Этот cmdlet удаляет файловую папку, указанную этим параметром.
...
Этот cmdlet удаляет объект, указанный этим параметром.
