...
## ОПИСАНИЕ
Для создания файловой папки будет создаваться проект **New-AzStorageShare.**

## ПРИМЕРЫ

### Пример 1. Создание файловой папки
```
PS C:\>New-AzStorageShare -Name "ContosoShare06"
```

Эта команда создает папку с именем ContosoShare06.
...
### -Name
Имя файловой папки.
Этот cmdlet создает папку с именем, указанным этим параметром.
