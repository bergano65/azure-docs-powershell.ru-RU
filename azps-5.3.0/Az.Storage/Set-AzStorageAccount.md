...
Команда задает для уровня Access значение "Хорошо".
...
### Пример 11. Обновление учетной записи хранения путем обеспечения проверки подлинности доменной службы Files Active Directory и показа параметра проверки подлинности на основе удостоверений файлов
```
