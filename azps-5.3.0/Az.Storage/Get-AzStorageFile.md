...
## ОПИСАНИЕ
Для задаваемого списка каталогов можно задать список каталогов и файлов для задаваемой вами папки **Get-AzStorageFile.**
...
Он сначала извлекает файлы и каталоги,  передает их оператору конвейера, а затем удаляет объекты, тип которых не "AzureStorageFileDirectory".
...
Этот cmdlet получает файл или каталог из папки, заданной этим параметром.
