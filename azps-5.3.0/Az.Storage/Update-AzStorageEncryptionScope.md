...
## ОПИСАНИЕ
Для учетной записи хранения область шифрования изменяется с учетной записью **Update-AzStorageEncryptionScope.**
...
### -State
Состояние области обновления, возможные значения: "Enabled", "Disabled".
