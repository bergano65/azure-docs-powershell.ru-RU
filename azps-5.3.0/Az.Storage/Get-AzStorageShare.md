...
### Пример 1. Получить файловую папку
```
...
### Пример 3. Получить все файловые папки в заданный контекст
```
...
Вторая команда получает папки с файлами для контекстного объекта, $Context.

### Пример 4. Снимок файла с именем определенного файла и моментальный снимок
```
