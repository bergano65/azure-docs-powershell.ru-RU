...
## ОПИСАНИЕ
Для службы BLOB-объектов хранилища Azure свойства службы **Update-AzStorageBlobServiceProperty** изменяется.
...
Эта команда задает для службы BLOB-данных DefaultServiceVersion значение 2018-03-28.
...
Эта команда позволяет использовать Changefeed в службе BLOB-хранилищ службы поддержки веб-канала изменения учетной записи хранения хранилищ BLOB-устройств Azure, прослушивая учетную запись хранилища GPv2 или BLOB-хранилищ при создании, изменении или удалении. Затем он выводит упорядоченный журнал событий для BLOB-$blobchangefeed в учетной записи хранения. Последовательные изменения сохраняются в файле Apache Avro и обрабатываются асинхронно и пошагово.
...
### -EnableChangeFeed
Включите ведение журнала изменения веб-канала для учетной записи хранения, заключив $true, отключите ведение журнала "Изменить веб-канал", заключив для $false.
...
### -ResourceId
Ввести ИД ресурса учетной записи хранения или свойства службы BLOB-объектов.
