...
## ОПИСАНИЕ
Для **закрытия azStorageFileHandle** будут закрыты все файлы, хранимые в папке, каталоге или файле.
...
Эта команда содержит список всех файловых акций текущей учетной записи хранения и закроет все их обработки рекурсивно.
...
### Пример 4. Закроем все обрабатываемые папки в файле
```
