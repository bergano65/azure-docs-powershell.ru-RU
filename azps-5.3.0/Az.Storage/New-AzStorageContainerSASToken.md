...
В этом примере создается токен SAS контейнера с полным разрешением контейнера.
...
### Пример 3. Создание маркера SAS контейнера удостоверения пользователя с контекстом хранилища на основе проверки подлинности OAuth
```
...
Если не указаны ни время начала, ни срок действия, то для истечения установлено текущее время, равное одному часу.
