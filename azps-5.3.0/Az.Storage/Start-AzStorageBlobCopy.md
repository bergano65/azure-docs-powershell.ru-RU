...
Эта команда запускает операцию копирования BLOB-части блока в контейнер назначения с новым именем BLOB-части и настроит назначение BLOB-части StandardBlobTier как "Hot", RehydratePriority as High

## PARAMETERS

### -AbsoluteUri
Определяет абсолютный URI файла, который нужно скопировать в большой большой объем хранилища Azure.
