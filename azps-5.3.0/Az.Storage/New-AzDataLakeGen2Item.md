...
### Пример 1. Создание каталога с указанным разрешением, Propertiessk, свойств и метаданных
```
...
### -ConcurrentTaskCount
Общее количество одновременной работы с async. Значение по умолчанию — 10.
