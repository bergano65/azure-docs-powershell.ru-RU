...
## ОПИСАНИЕ
Для учетной записи хранения создается область шифрования **New-AzStorageEncryptionScope.**
...
### Пример 2. Создание области шифрования с помощью шифрования Keyvault
```
...
Эта команда создает область шифрования с помощью шифрования Keyvault.
