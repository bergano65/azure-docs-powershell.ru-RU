...
### Пример 1. Получить большой бизнес-бизнес с именем BLOB-имени
```
...
Для отображения итогового числа в последней команде используется команда **Echo.**
...
### -BLOB
Определяет имя или шаблон имени, который можно использовать для поиска поддиавных знаков.
...
### -IncludeDeleted
Include Deleted BLOB, по умолчанию get BLOB-то не включает удаленный BLOB-который.
...
### -MaxCount
Указывает максимальное количество объектов, которые возвращает этот cmdlet.
