...
## ОПИСАНИЕ
Для удаления очереди хранилища **удаляется cmdlet Remove-AzStorageQueue.**
...
Эта команда удаляет все очереди с именами, имена которых начинаются с Contoso.
...
### -Name
Указывает имя очереди, которая будет удаляться.
