...
## ОПИСАНИЕ
**Cmdlet Invoke-AzDataBoxEdgeShare** вызывает действие для обновления данных на устройстве Edge Data Box.
...
### -RefreshData
Обновление метаданных для обмена данными из облака
