...
## ОПИСАНИЕ
Для **устройства Edge Data Box** создается новый пользователь— новый пользователь. Поддерживается создание только пользователей `Share` разных типов.
...
### -Password
Пароль в качестве защищенной строки
