...
## ОПИСАНИЕ
С **его роли** извлекается доступ к ролям IoT для устройства Edge data Box. Вы можете упомянуть параметр Name, чтобы получить сведения о конкретной роли IoT.
