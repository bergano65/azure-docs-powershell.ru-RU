...
## ОПИСАНИЕ
Эта команда поддерживает отправку сообщений со свойствами приложения и системы.
...
Отправка mqtt-устройства в облачное сообщение.
...
### -Message
Текст сообщения для отправки в Центр IoT.
