...
## ОПИСАНИЕ
Получите сведения о конечной точке.
...
Получите все конечные точки из IoT-концентратора Myiothub.
...
Получите все конечные точки типа EventHub из IoT-концентратора Myiothub. 
...
Получите сведения о конечной точке из IoT Hub myiothub.
