...
Возвращает объект module device с обновленными свойствами.
...
Возвращает объект module device с обновленным свойством тегов.
...
Возвращает замененный объект модуля устройства.
