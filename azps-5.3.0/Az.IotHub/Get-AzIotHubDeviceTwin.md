...
## ОПИСАНИЕ
Возвращает дейс. Дополнительные https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins сведения см. в этой информации.
