...
Создание и обновление сертификата Azure IoT Hub.

### [Add-AzIotHubConfiguration](Add-AzIotHubConfiguration.md)
Добавление конфигурации автоматического управления устройствами из IoT в целевой центр IoT.

### [Add-AzIotHubDeployment](Add-AzIotHubDeployment.md)
Добавьте развертывание IoT Edge в целевой центр IoT.

### [Add-AzIotHubDevice](Add-AzIotHubDevice.md)
Создайте устройство в концентраторе IoT.

### [Add-AzIotHubDevice Темы](Add-AzIotHubDeviceChildren.md)
Добавляйте устройства, не скийи в качестве детей, на устройство границы.

### [Add-AzIotHubEventHubConsumerGroup](Add-AzIotHubEventHubConsumerGroup.md)
Создает группу eventhub для потребителей.

### [Add-AzIotHubKey](Add-AzIotHubKey.md)
Создает ключ IotHub.

### [Add-AzIotHubMessageEnrichment](Add-AzIotHubMessageEnrichment.md)
Обогащение сообщений для выбранных конечных точек в вашем центре IoT.

### [Add-AzIotHubModule](Add-AzIotHubModule.md)
Создайте модуль на целевом устройстве ioT в центре IoT.
...
Добавление конечной точки в концентратор IoT

### [Get-AziotHub](Get-AzIotHub.md)
Получает сведения об IotHubs в подписке.

### [Get-AzIotHubCertificate](Get-AzIotHubCertificate.md)
Список всех сертификатов или отдельных сертификатов, содержащихся в Центре Azure IoT. 

### [Get-AzIotHubCertificateVerificationCode](Get-AzIotHubCertificateVerificationCode.md)
Создает код проверки для сертификата Azure IoT Hub. 

### [Get-AzIotHubConfiguration](Get-AzIotHubConfiguration.md)
Здесь перечислены все или определенные настройки автоматического управления устройствами в режиме IoT.
...
Здесь перечислены все или только определенные развертывания IoT Edge.

### [Get-AzIotHubDevice](Get-AzIotHubDevice.md)
Список всех или отдельных устройств, содержащихся в Центре Azure IoT. 

### [Get-AzIotHubDevice Владислав](Get-AzIotHubDeviceChildren.md)
...
Получите строку подключения конечного устройства IoT в концентраторе IOT.

### [Get-AzIotHubDeviceParent](Get-AzIotHubDeviceParent.md)
Получите родительское устройство указанного устройства.

### [Get-AzIotHubDeviceTwin](Get-AzIotHubDeviceTwin.md)
Возвращает дейс.

### [Get-AzIotHubDistributedTracing](Get-AzIotHubDistributedTracing.md)
Получите параметры распределенной трассии для устройства.

### [Get-AzIotHubEventHubConsumerGroup](Get-AzIotHubEventHubConsumerGroup.md)
Возвращает все группы потребителей естрогов.

### [Get-AzIotHubJob](Get-AzIotHubJob.md)
Получает сведения о заданиях IotHub.

### [Get-AzIotHubKey](Get-AzIotHubKey.md)
Возвращает ключ IotHub.

### [Get-AzIotHubMessageEnrichment](Get-AzIotHubMessageEnrichment.md)
Здесь перечислены все обогащения сообщений или определенное обогащение сообщений для вашего концентратора IoT.

### [Get-AzIotHubModule](Get-AzIotHubModule.md)
Получите сведения о модуле устройства ioT или модулях списка, которые находятся на устройстве ioT в центре IoT.
...
Возвращает модуль устройства IoT.
...
Сведения о всех конечных точках для концентратора IoT
...
Вызов запроса метрики развертывания IoT Edge.
...
Вызов отступа для концентратора IoT в гео-сопряженном регионе аварийного восстановления.
...
Выполнив запрос к концентратору IoT, можно использовать SQL-язык.
...
Создает задание для устройств импорта.
...
Установите родительское устройство указанного устройства.
