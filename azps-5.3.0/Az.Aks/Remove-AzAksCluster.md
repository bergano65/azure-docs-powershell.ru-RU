...
### Удаление существующего управляемого кластера "Кубберсети"
```powershell
...
### -Force
Удаление управляемого кластера "Кубберсети" без запроса
...
### -PassThru
Возвращает "Истина" в случае успешного удаления.
