...
### Пример 1. Обновление решения для анализа журналов с именами
```powershell
...
Эта команда обновляет по имени решение для анализа журналов.

### Пример 2. Обновление решения для анализа журнала журнала за счет объектов
```powershell
