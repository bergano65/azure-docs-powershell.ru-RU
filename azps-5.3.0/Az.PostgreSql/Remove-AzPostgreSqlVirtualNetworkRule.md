...
Этот cmdlet removes PostgreSql server Virtual Network Rule by name.

### Пример 2. Удаление правила виртуальной сети PostgreSql server по удостоверениям
```powershell
...
Эти cmdlets remove PostgreSql server Virtual Network Rule by identity.
