...
### Пример 1. Обновление правила виртуальной сети PostgreSql по имени
```powershell
...
Этот cmdlet обновляет по имени виртуальное правило сети PostgreSql.

### Пример 2. Обновление виртуальных правил сети PostgreSql с помощью удостоверений.
```powershell
...
Эти cmdlets обновляют виртуальное правило сети PostgreSql по удостоверениям.
...
### -SubnetId
Это ARM ресурса виртуальной подсети сети.
