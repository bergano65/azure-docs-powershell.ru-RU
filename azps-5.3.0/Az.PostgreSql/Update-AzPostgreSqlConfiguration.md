...
Этот cmdlet обновляет конфигурацию PostgreSql по имени.

### Пример 2. Обновление конфигурации PostgreSql с помощью удостоверения.
```powershell
...
Эти cmdlets update PostgreSql configuration by identity.
