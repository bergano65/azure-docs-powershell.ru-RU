...
## ОПИСАНИЕ
Для удаления существующего пользователя будет удален **cmdlet Remove-AzApiManagementUser.**
...
Если этот параметр не указан и подписка существует, этот cmdlet выдвоит исключение.
