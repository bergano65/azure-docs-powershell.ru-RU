...
## ОПИСАНИЕ
Создает объект прокси-сервера серверов, который можно создать в канале при создании новой сущности backend.

## ПРИМЕРЫ

### Пример 1. Создание объекта прокси-сервера In-Memory сервера
```powershell
