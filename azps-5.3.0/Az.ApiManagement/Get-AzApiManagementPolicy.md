...
Эта команда получает политику на уровне клиента и сохраняет ее в файл с tenantpolicy.xml.

### Пример 2. Получить политику области продуктов
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Эта команда получает политику на область клиента в escape-формате non-XML.
...
Если этот параметр задан, будет возвращена политика области продукта.
