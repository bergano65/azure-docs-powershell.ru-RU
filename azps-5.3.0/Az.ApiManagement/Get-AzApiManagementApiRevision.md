...
## ОПИСАНИЕ
**Cmdlet Get-AzApiManagementApiRevision** получает сведения о всех редакциях API.

## ПРИМЕРЫ

### Пример 1. Все изменения API
```powershell
...
Эта команда получает все редакцию API указанного API для конкретного контекста ApiManagement.

## PARAMETERS

### -ApiId
Идентификатор API, редакции которого нужно перечислить.
