...
Эта команда получает службу SKU API Management Premium, регионы в юго-центральной части США и северной части США. Затем с помощью **"Set-AzApiManagement"** емкость региона "Северный Центр США" увеличивается до 2. Следующий cmdlet **Set-AzApiManagement** примещает изменение конфигурации к службе управления Api.
...
Передача $null удалит конфигурацию виртуальной сети для региона.
