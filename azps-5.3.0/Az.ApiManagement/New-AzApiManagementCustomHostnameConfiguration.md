...
Эта команда создает и инициализирует экземпляр **PsApiManagementCustomHostNameConfiguration** для портала. Затем создается новая служба ApiManagement с настраиваемой конфигурацией имени хоста.
