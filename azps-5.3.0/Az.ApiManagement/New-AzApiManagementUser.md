...
## ОПИСАНИЕ
Новый **пользователь регистрируется стебом New-AzApiManagementUser.**
...
Эта команда регистрирует нового пользователя с именем Николай Полномер.
...
Этот параметр является необязательным.
Если этот параметр не указан, этот cmdlet создает ИД пользователя.
