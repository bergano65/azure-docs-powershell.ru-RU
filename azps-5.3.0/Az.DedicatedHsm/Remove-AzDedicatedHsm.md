...
## SYNOPSIS
Удаляет указанную службу azure Dedicated HSM.
...
### Пример 1. Удаление выделенной HSM по имени
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Эта компания удаляет модуль безопасности оборудования (HSM) по имени.

### Пример 2. Удаление выделенной HSM-объекта
```powershell
...
Эта команда удаляет выделенный HSM-объект.
...
### -Name
Название выделенной HSM-части, удаляемой
...
### -ResourceGroupName
Имя группы ресурсов, к которой принадлежит выделенная HSM.
