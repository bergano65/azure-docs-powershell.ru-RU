...
## ОПИСАНИЕ
Этот Get-AzMapsAccount получает резервную учетную запись Azure Maps по группе ресурсов и имени либо по коду ресурса. Кроме того, она может вернуть список всех учетных записей в группе ресурсов или всех учетных записей Azure Maps для текущей подписки.
...
Возвращает учетную запись MyAccount в группе ресурсов MyResourceGroup, если она существует.
...
Получает все учетные записи Azure Maps в группе ресурсов MyResourceGroup.
...
Получает все учетные записи Azure Maps в текущей подписке.
...
Возвращает учетную запись "Карты", указанную в ИД ресурса.
