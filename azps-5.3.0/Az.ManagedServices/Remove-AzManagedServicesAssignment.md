...
## SYNOPSIS
Удаление регистрационного задания.
...
Удаление назначения регистрации по имени из области по умолчанию.
...
Удаление регистрационного назначения с помощью предоставленного объекта ввода.
...
Удаляет назначение регистрации по имени в заданной области.
...
### -Scope
Область назначения регистрации.
