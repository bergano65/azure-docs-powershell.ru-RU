...
Создает назначение регистрации по умолчанию с использованием идентификатора определения регистрации.
...
Создание назначения регистрации с объектом определения регистрации в качестве входных данных.
...
Обновляет назначение регистрации с помощью идентификатора и имени определения регистрации.
...
### -Name
Уникальное имя регистрационного назначения.
...
Объект ввода определения регистрации.
