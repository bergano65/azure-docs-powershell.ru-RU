...
## ОПИСАНИЕ
Позволяет обновлять контактные данные одноранговых пользователей в подписке.
...
Добавляет адрес электронной почты к одноранговой учетной записи
...
### -InputObject
{{ Заполнить описание inputObject }}
