...
Создайте прямое подключение пиринга без IP-адресов сеанса Bgp. Чтобы можно было настроить BGP-сеанс, одноранговой сеанс должен будет установить IP-адреса.
...
В этом флажке укаймь, что Корпорация Майкрософт будет предоставлять адреса сеанса BGP.
