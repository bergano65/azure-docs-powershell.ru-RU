...
Создание префикса из объекта службы пиринга
...
Создание префикса на ресурсах пиринга службы пиринга.
...
Создание префикса из имени и имени группы ресурсов службы пиринга
...
### -PeeringServiceName
Имя службы пиринга.
Используйте New-AzPeeringService для новой службы пиринга или Get-AzPeeringService для списка.
...
### -ServiceKey
Это уникальный GUID, предоставленный поставщиком услуг
