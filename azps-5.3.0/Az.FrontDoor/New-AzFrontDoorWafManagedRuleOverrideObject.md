...
## ОПИСАНИЕ
Создайте объект PSAzureManagedRuleOverride для управляемой группы правил WAF, переопределяйте создание объектов.

## ПРИМЕРЫ

### Пример 1
Создайте объект переопределения управляемого правила для правила 942250 (в группе SQLI).
