...
Включить HTTPS для пользовательского домена frontendpointname1-custom-xyz с ид ресурса $resourceId с помощью сертификата Front Door Managed.
...
### -VaultId
Ключ сейфа, содержащий SSL-сертификат
