...
Дополнительные задержки в миллисекундах для кеглей попадают в сегмент наименьшей задержки. Значение по умолчанию — 0
...
### -Name
имя параметра health в настройках.
...
### -SampleSize
Количество выборок, которые следует рассмотреть для принятия решений по балансировке нагрузки.
...
Количество выборок в течение примера, которые должны быть успешными, — 2
