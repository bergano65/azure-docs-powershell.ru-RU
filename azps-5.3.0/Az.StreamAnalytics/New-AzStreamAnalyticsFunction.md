...
## ОПИСАНИЕ
С его использованием новая **функция AzStreamAnalyticsFunction** создается в задание аналитики Azure Stream Analytics или заменяется существующей.
...
### -JobName
Указывает имя задания Stream Analytics, в котором этот cmdlet создает функцию Stream Analytics.
...
### -ResourceGroupName
Указывает имя группы ресурсов, в которой этот cmdlet создает функцию Stream Analytics.
