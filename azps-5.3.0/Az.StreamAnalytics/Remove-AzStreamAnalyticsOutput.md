...
## ОПИСАНИЕ
Асинхронно удалит выходной результат из задания Stream Analytics в Azure с использованием **cmdlet Remove-AzStreamAnalyticsOutput.**

## ПРИМЕРЫ

### ПРИМЕР 1. Удаление результата из задания
```
PS C:\>Remove-AzStreamAnalyticsOutput -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamingJob" -Name "Output"
```

Эта команда удаляет выходные данные из задания StreamingJob.
...
### -Name
Указывает имя выходных данных Azure Stream Analytics, которые нужно удалить.
