...
## ОПИСАНИЕ
Если **параметр RuleName** указан, то для **azure RedisCacheFirewallRule** можно получить подробные данные о заданном правиле брандмауэра в кэше Azure Redis. Если **задано только** имя, в кэше Redis доступны все правила брандмауэра.
