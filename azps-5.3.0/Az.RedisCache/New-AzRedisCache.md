...
### -EnableNonSslPort
Указывает на то, включен ли порт, не ключаный SSL.
...
Только премиум-уровень.
- RDB-частота резервного копирования.
...
Стандартные и премиум-уровни.
Дополнительные сведения см. в кэше Azure Redis cache с помощью Azure http://go.microsoft.com/fwlink/?LinkId=800051 http://go.microsoft.com/fwlink/?LinkId=800051) PowerShell.
...
### -ShardCount
Количество шардаев, которые нужно создать в кэше кластера Premium.
Допустимые значения этого параметра:
- 1
- 2
- 3
