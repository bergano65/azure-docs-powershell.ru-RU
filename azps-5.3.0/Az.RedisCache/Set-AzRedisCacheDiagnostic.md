...
## ОПИСАНИЕ
**Cmdlet Set-AzRedisCacheDiagnostic** обеспечивает диагностику кэша Azure Redis.

## ПРИМЕРЫ

### Пример 1. Включить диагностику
```
...
Эта команда обеспечивает диагностику кэша Azure Redis.
Эта команда включает диагностику или обновляет учетную запись хранения для всех кэшей Azure Redis в одном регионе для подписки.
...
### -StorageAccountId
Определяет ИД ресурса учетной записи хранения, используемой для хранения диагностических данных.
