...
## ОПИСАНИЕ
Для **AzureSQlServerActiveDirectoryOnlyAuthentication** для Azure Active Directory (Azure AD) требуется проверка подлинности только для AzureSQL Server в текущей подписке.
...
Эта команда обеспечивает проверку подлинности Azure Active Directory (Azure AD) только для сервера AzureSQL Server01, связанного с группой ресурсов ResourceGroup01.
