...
## ОПИСАНИЕ
**Cmdlet New-AzSqlDatabaseImport** импортирует файл bacpac из учетной записи хранилища Azure в новую базу данных Azure SQL.
...
### -Edition
Выпуск новой базы данных, в который нужно импортировать.
Допустимые значения этого параметра:
- Premium
- Базовая
- Стандартный
