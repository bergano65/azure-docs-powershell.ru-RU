...
## ОПИСАНИЕ
Этот Set-AzSqlServerTransparentDataEncryptionProtector задает защиту TDE для SQL сервера.
При изменении типа защиты TDE он будет повернут.
...
Эта команда обновляет тип защищенного TDE на сервере в service Managed.
...
Эта команда обновляет сервер, чтобы использовать ключ ключа сервера с ID ' в качестве защиты https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 TDE.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
Защита TDE базы данных Azure Sql.
