...
## ОПИСАНИЕ
Этот Remove-AzSqlServerKeyVaultKey удаляет ключ сейфа с указанного SQL сервера.
Обратите внимание SQL что разрешения сервера для хранилища ключа не меняются.
Чтобы изменить разрешения, используйте Set-AzKeyVaultAccessPolicy.
Обратите внимание, что этот cmdlet не изменяет хранилище ключей.
Чтобы удалить ключ из key Vault, используйте Remove-AzKeyVaultKey.

## ПРИМЕРЫ

### Пример 1. Удаление ключа сейфа
```
PS C:\> Remove-AzSqlServerKeyVaultKey -KeyId 'https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901' -ServerName 'ContosoServer' -ResourceGroupName 'ContosoResourceGroup'
```

Эта команда удаляет ключ сейфа с ИД https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' с указанного сервера.
