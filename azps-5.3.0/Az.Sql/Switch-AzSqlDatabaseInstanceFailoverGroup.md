...
Выдайте отбой, разрешив потерю данных путем перенаправки в группе отбойных экземпляров.
...
### -ResourceId
ИД ресурса группы отключателя экземпляра, который нужно переключить.
