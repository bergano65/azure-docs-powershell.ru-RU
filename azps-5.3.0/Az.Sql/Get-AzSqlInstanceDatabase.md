...
## ОПИСАНИЕ
Cmdlet **Get-AzSqlInstanceDatabase** получает одну или несколько баз данных Azure SQL из управляемого экземпляра SQL Azure.

## ПРИМЕРЫ

### Пример 1. Получить все базы данных в экземпляре
```
...
Эта команда получает все базы данных в экземпляре ManagedInstance1.

### Пример 2. Получить базу данных по имени в управляемом экземпляре
```
...
Эта команда получает базу данных с именем ManagedDatabase1 из экземпляра ManagedInstance1.

### Пример 3. Использование фильтрации для всех баз данных в экземпляре
```
...
Эта команда получает все базы данных из экземпляра ManagedInstance1, которые начинаются с "ManagedDatabase".
...
### -InstanceObject
Объект экземпляра, который используется для получения базы данных экземпляра
