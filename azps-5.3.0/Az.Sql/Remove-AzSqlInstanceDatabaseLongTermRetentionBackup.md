...
## ОПИСАНИЕ
Для удаления указанной резервной копии будет удалена указанная резервная копия, указанный при наступлении **azSqlInstanceDatabaseLongTermRetentionBackup.**
...
Удаляет резервную копию с именем 15be823c-7e2c-49d8-819f-a3fdcad92215;13226825055000000
...
### -DatabaseName
Имя управляемой базы данных, из которой создана резервная копия.
...
### -InstanceName
Имя управляемого экземпляра, под которым находится резервная копия.
...
### -Location
Расположение управляемого экземпляра резервной копии.
