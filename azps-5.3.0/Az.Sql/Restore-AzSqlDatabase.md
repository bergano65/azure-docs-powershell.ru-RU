...
Первая команда получает базу SQL Database01, а затем сохраняет ее в переменной $Database.
Вторая команда восстанавливает базу данных в $Database из указанной заданной заданной за данный момент времени резервной копии в базу данных SQL с именем RestoredDatabase в эластичном пуле, который называется 1.
...
С помощью Get-AzSqlDeletedDatabaseBackup можно получить резервную копию удаленной SQL базы данных.
