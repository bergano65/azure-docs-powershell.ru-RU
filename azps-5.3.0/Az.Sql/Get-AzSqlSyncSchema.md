...
## ОПИСАНИЕ
Командалет **Get-AzSqlSyncSchema** возвращает сведения о схеме синхронизации базы данных участника или центральной базы данных.
...
Эта команда получает схему синхронизации для базы данных концентратора в группе синхронизацииGroup01 и расширяет свойство "Таблицы".
