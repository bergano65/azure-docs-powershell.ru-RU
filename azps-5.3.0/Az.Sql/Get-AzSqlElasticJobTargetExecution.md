...
## ОПИСАНИЕ
Этот Get-AzSqlElasticJobTargetExecution получает одно или несколько целевых выполнения задания из выполнения задания

## ПРИМЕРЫ

### Пример 1. Возвращает одно или несколько целевых выполнения задания из выполнения задания
```powershell
...
### Пример 2. Возвращает одно или несколько целевых выполнения задания из выполнения задания — фильтрация по имени шага
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Count
Count возвращает большее количество выполнения.
...
### -EndTimeMax
Максимальное время фильтрации по времени окончания.
