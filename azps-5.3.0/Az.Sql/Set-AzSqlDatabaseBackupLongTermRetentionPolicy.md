...
Политика — это ресурс резервной копии Azure, используемый для определения политики резервного копирования.
...
В этом случае для сохранения полной резервной копии, сделанных 26-й неделей в течение 10 лет, в базе данных database01 будет заданной долгосрочный политика хранения.
...
В этом случае в базе данных01 устанавливается политика долгосрочного хранения для сохранения каждой полной резервной копии в течение 14 дней, первой полной резервной копии каждого месяца в течение 24 недель и полной резервной копии за 26-ю неделю года в течение 10 лет.
