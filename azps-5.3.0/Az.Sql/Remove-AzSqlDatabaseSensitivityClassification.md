...
## ОПИСАНИЕ
Этот Remove-AzSqlDatabaseSensitivityClassification удаляет типы информации и метки конфиденциальности столбцов в базе данных.
...
### Пример 3. Удаление типа данных и метки конфиденциальности столбца в базе данных Azure SQL с помощью Piping.
```powershell
