...
## ОПИСАНИЕ
С **его** использованием можно получить один или несколько помощников по SQL Azure SQL для эластичного пула Azure SQL.
...
Команда получает список всех консультантов по эластичным пулам с именем WiRunnerPool.
...
Эта команда получает всех консультантов по эластичности пула с рекомендуемыми действиями в ответе.
