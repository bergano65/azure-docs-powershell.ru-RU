...
## ОПИСАНИЕ
Этот Get-AzSqlInstanceOperation получает сведения об операциях с SQL управляемым экземпляром. Вы можете просмотреть все операции с управляемым экземпляром или конкретную операцию, укав ее имя.
