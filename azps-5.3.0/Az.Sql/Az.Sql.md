...
Отключение Advanced Threat Protection на сервере.
...
Возвращает рекомендуемые типы данных и метки конфиденциальности столбцов в базе данных.
...
Возвращает одно или несколько выполнения задания
...
Возвращает сведения о том, SQL базе данных управляемого экземпляра Azure является избыточной.
...
Возвращает SQL ключей хранилища экземпляра.
...
Возвращает коммуникационные связи для транзакций с эластичными базами данных между серверами баз данных.
...
Создает экземпляр, управляемый базой SQL Azure.
...
Удаляет пул экземпляров Azure SQL.
...
Удаляет параметры аудита сервера Azure SQL.
...
Удаляет ключ сейфа с SQL сервера.
...
Изменяет конфигурацию правила виртуальной SQL Server Azure.
...
Обновив схему синхронизации для базы данных ее участника или центральной базы данных синхронизации.
...
Если задана команда SyncMemberName, будет обновлена схема базы данных участника. Если нет, будет обновлена схема центральной базы данных.
