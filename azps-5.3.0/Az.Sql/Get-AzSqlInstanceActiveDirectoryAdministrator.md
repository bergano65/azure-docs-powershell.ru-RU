...
## ОПИСАНИЕ
Чтобы получить сведения об администраторе Azure Active Directory (Azure AD) для экземпляра AzureSQL, управляемого экземпляром в текущей подписке, можно получить сведения о его администраторе **Get-AzSqlActiveDirectoryAdministrator.**
