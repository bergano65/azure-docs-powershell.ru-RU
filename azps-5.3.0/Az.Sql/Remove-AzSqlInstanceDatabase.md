...
## ОПИСАНИЕ
Для удаления базы данных управляемого экземпляра Azure SQL удаляется SQL **AzSqlInstanceDatabase.**
...
### -InputObject
Удаляемый объект базы данных экземпляра
...
### -Name
Имя базы данных экземпляра Azure SQL для удаления.
...
### -ResourceId
ИД ресурса объекта базы данных экземпляра, который нужно удалить
