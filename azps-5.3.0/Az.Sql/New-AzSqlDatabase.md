...
## ОПИСАНИЕ
Для создания базы данных Azure SQL новый **azSqlDatabase.**
...
Эта команда создает базу данных "База данных02" в эластичном пуле Под названием "Проектный", который на сервере Server01.
...
### -Edition
Выпуск, который нужно назначить базе данных. Допустимые значения этого параметра:
- Нет
- Базовая
- Стандартный
- Premium
...
Количество реплицируемых реплицов, связанных с базой данных, в которую могут маршрутизироваться подключения с намерением приложения в чтение. Это свойство можно настроить только для баз данных hyperscale edition.
