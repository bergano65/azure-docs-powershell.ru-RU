...
## ОПИСАНИЕ
Состояние рекомендуемого действия azure обновляется с SQL Server Состояние на **cmdlet Set-AzSqlServerRecommendedActionState.**
Этот cmdlet применяет, возвращает или удаляет рекомендуемое действие в зависимости от нового состояния.

## ПРИМЕРЫ

### Пример1. Обновление состояния указанного рекомендуемого действия на "Ожидание ожидания"
```
...
Обновление состояния рекомендуемого действия сервера "IR_ \[ test_schema _ \] \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893" на \] "Ожидание".

## PARAMETERS

### -AdvisorName
Указывает имя консультанта, который содержит рекомендуемое действие.
