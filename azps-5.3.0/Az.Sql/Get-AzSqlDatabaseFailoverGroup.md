...
## ОПИСАНИЕ
Возвращает определенную группу SQL отбойной базы данных Azure или группы отбойных серверов на сервере.
...
### -ServerName
Имя сервера базы данных Azure SQL, из которого извлекать группу failover.
