...
## ОПИСАНИЕ
С **его** использованием можно настраивать дополнительные параметры защиты от угроз в базе данных Azure SQL.
...
### -EmailAdmins
Определяет, следует ли расширенные параметры защиты от угроз связываться с администраторами с помощью электронной почты.
...
### -StorageAccountName
Имя используемой учетной записи хранения. Поддиавные знаки не разрешены. Этот параметр не является нужным. Если этот параметр не задан, используется учетная запись хранения, которая была определена в параметрах advanced threat protection базы данных. Если в базе данных впервые заданы дополнительные параметры защиты от угроз и этот параметр не задан, сбой cmdlet.
