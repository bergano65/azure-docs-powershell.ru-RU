...
## ОПИСАНИЕ
Cmdlet **Set-AzSqlElasticPoolAdvisorAutoExecuteStatus** задает автоматическое выполнение свойства для помощника по SQL Azure.
...
## ПРИМЕЧАНИЯ
* Ключевые слова: azure, azurerm, arm, ресурс, управление, руководитель, sql, эластикальный пул, mssql, консультант
