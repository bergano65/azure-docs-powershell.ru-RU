...
## ОПИСАНИЕ
Для этого можно получить советы по обновлению сервера базы данных Azure SQL **AzSqlServerUpgradeHint.**
Подсказки могут содержать эластичный пул баз данных и автономные подсказки базы данных.
Базы данных, которые все еще находятся на уровнях цен на веб-сайты и бизнес, могут подсказок на обновление до новых уровней цен на базовый, стандартный или премиум либо перейти в эластичный пул баз данных.
