...
## ОПИСАНИЕ
Для этой базы данных зарегистрируется **краткое** сроки политики хранения, зарегистрированные для этой базы данных, с его учетом.
...
Эта команда задает краткосрочную политику хранения для всех удаленных баз данных с именем DB1 путем прокавки в удаленном объекте базы данных. Обратите внимание, что срок хранения только для удаленных баз данных можно сократить.
...
### -InputObject
Live или deleted database object to get/set the policy for.
