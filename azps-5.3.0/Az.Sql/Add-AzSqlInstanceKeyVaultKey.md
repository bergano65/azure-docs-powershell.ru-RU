...
## ОПИСАНИЕ
Этот Add-AzSqlInstanceKeyVaultKey добавляет ключ сейфа в предоставленный управляемый экземпляр. У управляемого экземпляра должны быть разрешения на доступ к хранилищу с помощью следующего сценария.
