...
## ОПИСАНИЕ
Получите одно или несколько определений схем. Определение схемы существует в составе группы управления или подписки.
...
Получите определение схемы в текущей подписке и иерархию группы управления подписки.
...
Получите определение схемы в пределах указанной группы управления.
...
Получите определение схемы в указанной подписке и иерархию групп управления в этой подписке.
...
Получите определение схемы с указанным именем в указанной подписке.
...
Получите определение документа с указанным именем и версией в указанной группе управления.
...
Получите последнее определение опубликованного чертежа с указанным именем в указанной группе управления.
...
### -LatestPublished
Последний опубликованный флаг определения схемы.
Если все настроено, то выполнение возвращает последнюю опубликованную версию определения документа.
...
### -ManagementGroupId
ИД группы управления, в которой сохранено определение схемы.
...
### -SubscriptionId
ИД подписки, в котором сохранено определение схемы.
...
### -Version
Опубликованная версия определения схемы.
