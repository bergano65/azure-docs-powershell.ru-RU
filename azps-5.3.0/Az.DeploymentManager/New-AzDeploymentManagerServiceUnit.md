...
Укажите единицу обслуживания по имени, названию службы, топологии службы, а также имени группы ресурсов. 
...
### -ServiceName
Название службы, в состав которого входит данный блок обслуживания.
...
### -ServiceTopologyName
Имя топологии службы, частью которого является этот блок службы.
...
### -TargetResourceGroup
Определяет, куда будут развернуты ресурсы из блока обслуживания.
