...
Создает шаг в группе ContosoResourceGroup с именем ContosoService1WaitStep, в качестве расположения которого находится центр США. Свойство Duration (Длительность) предоставляет длительность, которая будет выждать, прежде чем запускать следующий шаг.
