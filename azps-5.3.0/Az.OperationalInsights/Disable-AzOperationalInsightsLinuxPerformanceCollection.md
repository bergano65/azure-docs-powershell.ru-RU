...
## ОПИСАНИЕ
Cmdlet **Disable-AzOperationalInsightsLinuxPerformanceCollection** останавливает сбор счетчиков производительности с подключенных компьютеров Linux в рабочей области.
