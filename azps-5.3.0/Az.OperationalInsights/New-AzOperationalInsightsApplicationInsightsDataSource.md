...
Эта команда создает источник данных для анализа приложений в рабочей области аналитики журналов. Это позволяет получить журналы из данного приложения в область аналитики журналов.
