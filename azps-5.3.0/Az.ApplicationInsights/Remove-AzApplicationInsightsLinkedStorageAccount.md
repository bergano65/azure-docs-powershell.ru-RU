...
## SYNOPSIS
Удаление учетной записи хранилища, связанной с анализом приложений
...
Удаление связанной учетной записи хранения, связанной с компонентом "имя компонента" для анализа приложений
