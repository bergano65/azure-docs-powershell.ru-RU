...
## ОПИСАНИЕ
Создание ключей API для анализа приложений

## ПРИМЕРЫ

### Пример 1. Создание ключа API для ресурса, анализы приложения
```
...
Создайте описание ключа API аналитики приложений как testapiKey с разрешениями "ReadTelemetry", "WriteAnnotations" для ресурса test в группе ресурсов "testGroup".
...
### -Description
Описание для определения этого ключа API.
...
### -Разрешения
Разрешения, которые клавиша API разрешает приложениям.
