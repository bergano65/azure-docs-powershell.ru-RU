...
## ОПИСАНИЕ
Получение ресурсов статистики приложения в группе ресурсов или конкретном ресурсе

## ПРИМЕРЫ

### Пример 1. Получение информации о приложениях
```
...
Получение ресурса аналитики приложений с именем "тест" в группе ресурсов "testgroup"

### Пример 2. Получение сведений о приложениях с информацией о тарифных планах
```
...
Получение ресурса аналитики приложения и сведения о тарифных планах для ресурса с именем "тест" в группе ресурсов "тестовая группа"
...
### -Full
Если задан этот план, будет возвращаться тарифный план,суточная цена и состояние компонента "Сведения о приложении".
