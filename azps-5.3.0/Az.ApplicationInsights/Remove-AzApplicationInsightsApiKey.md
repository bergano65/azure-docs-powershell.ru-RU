...
### Пример 1. Удаление ключа API статистики приложения
```
...
Удалите определенный ключ API аналитики приложений с ид "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" для "test" в группе ресурсов "testGroup".
