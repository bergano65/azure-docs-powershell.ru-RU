...
## ОПИСАНИЕ
Указанный Remove-AzAttestation для этой проверки удаляется.
...
Удалите поставщика услуг attestation с именем *pshtest3* в группе ресурсов *psh-test-rg* из текущей подписки.
...
### -InputObject
Объект attestation, который нужно удалить.
...
### -Name
Указывает имя удаляемой проверки.
...
### -ResourceGroupName
Указывает имя группы ресурсов для azure, во время проверки которого нужно удалить.
