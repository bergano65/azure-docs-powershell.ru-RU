...
Подписывает доверенных подписателей для поставщика attestation Provider *pshtest2* в группе ресурсов *psh-test-rg.*  Обратите внимание, что для этого поставщика attestation имеется один надежный подписыватель.
...
Подписывает доверенных подписателей поставщика по умолчанию для проверки attestation в Центре *нахождения США.*  Обратите внимание, что надежных подписателей для поставщика по умолчанию для проверки attestation нет.
...
### -DefaultProvider
Указывает, что это запрос к поставщику услуг проверки по умолчанию.
