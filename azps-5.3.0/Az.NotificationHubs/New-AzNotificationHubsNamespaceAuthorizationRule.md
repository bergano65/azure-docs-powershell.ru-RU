...
## ОПИСАНИЕ
Для создания правила авторизации SAS создается правило авторизации SAS с новыми **именамиHubsNamespaceAuthorizationRule** и назначается областью имен концентратора уведомлений.
