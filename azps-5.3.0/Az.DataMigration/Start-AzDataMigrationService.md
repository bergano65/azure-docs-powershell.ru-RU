...
В примере выше запускается экземпляр службы миграции баз данных Azure Test Service с именем службы, переданным в качестве входных данных, в остановленном состоянии.
