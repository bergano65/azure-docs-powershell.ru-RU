...
Выходные данные, которые можно выдать, являются парой ключевых значений с именем коллекции и значением параметра. Выходные данные используются для сборки параметров миграции на уровне базы данных.
