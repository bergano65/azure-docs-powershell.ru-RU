...
## ОПИСАНИЕ
С New-AzDataMigrationFileShare создается объект FileShare, задав локализованную сетевую папку, в которую служба миграции базы данных Azure может использовать резервные копии. У учетной записи службы, запущенной SQL Server источника, должны быть права на запись в этой сетевой доли.
