...
### Пример 1. Удаление правила виртуальной сети mySql server по имени
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Этот cmdlet removes MySql Server Virtual Network Rule by name.

### Пример 2. Удаление виртуальных сетевых правил mySql server по удостоверениям
```powershell
...
Эти cmdlets remove MySql Server Virtual Network Rule by identity.
