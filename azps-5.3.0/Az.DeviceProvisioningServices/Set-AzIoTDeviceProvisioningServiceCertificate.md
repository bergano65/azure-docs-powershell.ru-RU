...
## ОПИСАНИЕ
Проверьте сертификат, загрузив сертификат проверки с кодом проверки, полученным с помощью звонка с кодом проверки подлинности. Это последний шаг в процессе проверки связи.
...
Проверьте право собственности на закрытый ключ mycertificate с помощью конвейера.
