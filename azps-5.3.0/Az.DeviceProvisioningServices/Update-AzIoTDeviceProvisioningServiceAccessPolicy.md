...
## ОПИСАНИЕ
Введение в службу по подготовкам устройств в Azure IoT Hub см. в https://docs.microsoft.com/en-us/azure/iot-dps/about-iot-dps .
...
Обновив политику доступа "mypolicy" в службе регистрации устройств в Azure IoT Hub, выполнив регистрацию справа.
...
Обновление политики доступа "mypolicy" в службе регистрации устройств в Azure IoT Hub с помощью pipeline.
...
### -Разрешения
Разрешения политики доступа к службе предварительного доступа к устройствам IoT
