...
Обновив политику выделения на "GeoLatency" службы по подготовкам устройств через Azure IoT Hub "myiotdps".
...
Добавьте теги в службу по подготовкам устройств azure IoT Hub "myiotdps".
...
Удалите теги и добавьте новые теги в службу по подготовкам устройств Azure IoT Hub "myiotdps" с помощью конвейера.
...
### -Reset
Сброс тегов службы подготовка устройств ioT
