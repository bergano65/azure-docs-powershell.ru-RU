...
### Пример 1. Получить все приложения функций.
```powershell
...
### Пример 2. Получить приложения функции по имени.
```powershell
...
### Пример 3. Получить приложения функций по имени группы ресурсов.
```powershell
...
### Пример 4. Получить приложения функций для заданной подписки.
```powershell
...
### Пример 5. Получить приложения функций по расположению.
```powershell
...
### -IncludeSlot
Используется для указания того, следует ли включать слоты развертывания в результаты.
...
### -Location
Расположение приложения функции.
