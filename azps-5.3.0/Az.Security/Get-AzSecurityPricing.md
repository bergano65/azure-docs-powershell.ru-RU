...
Сведения о ценах на определенный ИД ресурса. Где ResourceId — один из возвращаемого `Get-AzSecurityPricing` ИД.
...
Сведения о ценах для именоваемого плана Защитника Azure. Где `name` находится одно из имен, возвращенных `Get-AzSecurityPricing` .
