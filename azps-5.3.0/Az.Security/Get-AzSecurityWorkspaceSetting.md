...
## ОПИСАНИЕ
Этот cmdlet позволяет найти настроенную область, в которую будут вмещаться данные безопасности, собранные агентом безопасности, установленным в VMs в этой подписке.
