...
Создание нового порогового настраиваемого правила оповещения из типа "SomeRuleType" с значениями ant с поддержкой состояния для минимального и максимального пороговых значений
