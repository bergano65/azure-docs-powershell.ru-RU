...
### Пример 1. Удаление группы приложений Виртуального рабочего стола Windows по имени
```powershell
PS C:\> Remove-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName -Name ApplicationGroupName
```

Эта команда удаляет группу приложений Виртуального рабочего стола Windows в группе ресурсов.
