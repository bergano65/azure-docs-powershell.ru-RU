...
### Пример 1. Получить виртуальный рабочий стол Windows SessionHost по имени
```powershell
...
Эта команда получает виртуальный рабочий стол SessionHost Windows в пуле хостов.
...
Эта команда содержит список виртуальных рабочих окон SessionHosts в пуле хостов.
