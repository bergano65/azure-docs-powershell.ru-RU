...
Эта команда возвращает windows Virtual Desktop UserSession на рабочем столе.
...
Эта команда содержит список пользователей виртуального рабочего стола Windows на рабочем столе.
