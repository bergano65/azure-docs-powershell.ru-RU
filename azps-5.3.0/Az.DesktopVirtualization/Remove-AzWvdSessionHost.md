...
### Пример 1. Удаление виртуального рабочего стола Windows По имени
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Эта команда удаляет виртуальный рабочий стол SessionHost Windows из пула хостов.
...
### -Force
Принудительное пометка для принудительного удаления sessionHost даже при существования userSession.
