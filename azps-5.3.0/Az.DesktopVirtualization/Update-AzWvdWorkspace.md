...
### Пример 1. Обновление по имени виртуальной рабочей области рабочего стола Windows
```powershell
...
Эта команда обновляет рабочее пространство Виртуального рабочего стола Windows в группе ресурсов.

## PARAMETERS

### -ApplicationGroupReference
Список ссылок applicationGroup.
