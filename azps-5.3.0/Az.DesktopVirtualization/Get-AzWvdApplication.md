...
### Пример 1. Получение имени виртуального настольного приложения Windows
```powershell
...
Эта команда получает виртуальное настольное приложение Windows в соответствующей группе.

### Пример 2. Список виртуальных классических приложений Windows
```powershell
...
Эта команда содержит список виртуальных классических приложений Windows в соответствующей группе.
