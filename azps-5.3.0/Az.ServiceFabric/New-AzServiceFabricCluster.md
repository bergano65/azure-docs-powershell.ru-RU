...
Эта команда определяет только размер кластера, название темы сертификации и ос для развертывания кластера.
...
Эта команда позволит вам создать собственный сертификат и настраиваемый шаблон, а также создать новый кластер.
...
Имя ключа хранилища Azure, если его не задано, будет по умолчанию задано имя группы ресурсов.
