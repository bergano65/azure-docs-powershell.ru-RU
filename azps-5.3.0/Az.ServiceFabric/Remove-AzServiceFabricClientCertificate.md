...
## ОПИСАНИЕ
Используйте **Remove-AzServiceFabricClientCertificate,** чтобы удалить сертификаты клиентов или имена субъектов сертификатов, которые используются для проверки подлинности клиента на кластере.
