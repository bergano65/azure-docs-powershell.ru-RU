...
## SYNOPSIS
Получить сведения о типе версии приложения "Служивная ткань". Поддерживаются только ARM развернутые версии приложений.
...
В этом примере для приложения "testAppType" возвращается версия "v1", если ресурс не будет обнаружиться, будет выбрасываться исключение.
