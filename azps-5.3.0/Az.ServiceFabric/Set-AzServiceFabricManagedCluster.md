...
Обновив имя dns и порт клиентского подключения для кластера.
...
Обновив имя dns и порт клиентского подключения для кластера, перенастройку.
...
Порт, используемый для клиентских подключений к кластеру. Значение по умолчанию: 19 000.
...
### -CodeVersion
Версия кода кластера. Используйте этот режим только в режиме обновления вручную.
...
Порт, используемый для http-подключений к кластеру. Значение по умолчанию: 19080.
...
### -ResourceId
Управляемый ид ресурсов кластера
