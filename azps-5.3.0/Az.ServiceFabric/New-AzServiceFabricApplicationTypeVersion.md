...
В этом примере создается версия приложения "v1" в типе testAppType. Версия манифеста приложения, содержалась в пакете, должна иметь ту же версию, что и в -Version.
