...
## ОПИСАНИЕ
**Cmdlet Set-AzHpcCacheStorageTarget** обновляет целевой объект хранилища, подключенный к кэше HPC Azure.
...
### -ResourceGroupName
Имя группы ресурсов, для которой вы хотите обновить целевой объект хранилища.
