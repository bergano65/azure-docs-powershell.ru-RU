...
## ОПИСАНИЕ
При этом из кэша HPC Azure удаляется целевой объект хранилища **AzHpcCacheStorageTarget.**
...
### -Force
Указывает на то, что при этом не будет предложено подтвердить запрос. По умолчанию при этом вам будет предложено подтвердить удаление целевого хранилища.
...
### -ResourceGroupName
Имя группы ресурсов, для которой вы хотите удалить целевой объект хранилища из кэша.
