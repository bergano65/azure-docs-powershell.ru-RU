...
Эта команда содержит список всех шаблонов, которые указаны в подписке.
...
Эта команда содержит список всех шаблонов в группе ресурсов.

### Пример 3. Получить шаблон в группе ресурсов
```powershell
...
### Пример 4. Получить шаблон в группе ресурсов
```powershell
