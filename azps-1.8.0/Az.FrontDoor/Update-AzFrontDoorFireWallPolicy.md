...
## NОПИСАНИЕ
Командлет **Update-AzFrontDoorFireWallPolicy** обновляет СУЩЕСТВУЮЩУЮ политику WAF. Если входные параметры не предоставлены, будут использоваться старые параметры существующей политики WAF.
...
Обновление существующего кода состояния WAF политики.
...
Обновите существующий режим политики WAF.
...
Обновление состояния и режима действующей политики WAF.
...
### -Name (имя)
Имя FireWallPolicy для обновления.
...
### -ResourceId
ИД ресурса обновляемого FireWallPolicy
