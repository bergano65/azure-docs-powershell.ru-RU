...
ms.locfileid: "93719861"
---
# AZ. LogicApp Module
## Nописание
В этом разделе отображаются разделы справки для командлетов приложений логики.

## Командлеты AZ. LogicApp
...
Получает соглашение о учетной записи интеграции.
...
Возвращает историю выполнения приложения логики.

### [Get-AzLogicAppTrigger](Get-AzLogicAppTrigger.md)
Возвращает триггеры для приложения логики.

### [Get-AzLogicAppTriggerCallbackUrl](Get-AzLogicAppTriggerCallbackUrl.md)
Возвращает URL-адрес обратного вызова триггера приложения логики.

### [Get-AzLogicAppTriggerHistory](Get-AzLogicAppTriggerHistory.md)
Получает историю триггеров в логическом приложении.
...
Создание соглашения о учетной записи интеграции.

### [New-AzIntegrationAccountAssembly](New-AzIntegrationAccountAssembly.md)
Создание сборки учетной записи интеграции.
...
Создание карты учетной записи интеграции.
...
Этот командлет удаляет определенный полученный номер, указанный в параметрах управления обменом, для каждого соглашения и номера элемента управления.

### [Remove-AzIntegrationAccountSchema](Remove-AzIntegrationAccountSchema.md)
Удаляет схему учетной записи интеграции.

### [Remove-AzLogicApp](Remove-AzLogicApp.md)
Удаляет логическое приложение из группы ресурсов.
...
Изменение сборки учетной записи интеграции.
...
Изменение сертификата учетной записи интеграции.
...
Изменение партнера учетной записи интеграции.
...
Изменение схемы учетной записи интеграции.

### [Set-AzLogicApp](Set-AzLogicApp.md)
Изменение приложения логики в группе ресурсов.

### [Start-AzLogicApp](Start-AzLogicApp.md)
Запускает логическое приложение в группе ресурсов.

### [Остановить-AzLogicAppRun](Stop-AzLogicAppRun.md)
Отменяет выполнение логики приложения.

### [Test-AzLogicApp](Test-AzLogicApp.md)
Проверка определения логического приложения.
