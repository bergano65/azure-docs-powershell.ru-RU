...
Эта команда используется с командлетом **Update-AzApiManagementDeployment** .
...
В этом примере создается виртуальная сеть, после чего вызывается командлет **Update-AzApiManagementDeployment** .
