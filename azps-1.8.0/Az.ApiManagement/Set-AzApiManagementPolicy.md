...
### -Format
Задает формат политики. При использовании `application/vnd.ms-az-apim.policy+xml` выражения, содержащиеся в политике, должны быть преобразованы в XML-код. При использовании `application/vnd.ms-az-apim.policy.raw+xml` этого параметра **не** обязательно, чтобы политика была преобразована в XML-код.
Значение по умолчанию — `application/vnd.ms-az-apim.policy+xml` .
