...
### ResourceUpdateSet (по умолчанию)
```
...
Обновите политику выделения на "геозадержка" службы подготовки устройств центра Azure IoT ("myiotdps").
...
Добавьте " @tags " в тег службы подготовки устройств центра Azure IOT "myiotdps".
...
Удалите тег и добавьте новый " @tags " в тег "myiotdps" службы подготовки устройств центра Azure IOT с помощью конвейера.

## ПАРАМЕТРЫ

### -AllocationPolicy
Политика выделения услуг для службы подготовки устройств IoT
...
### -Reset (Сброс)
Сброс тегов службы подготовки устройств IoT
...
### -Тег
Коллекция тегов служб для подготовки устройства IoT
