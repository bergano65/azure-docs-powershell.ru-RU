...
Возвращает все оповещения системы безопасности, обнаруженные в resoruces в рамках подписки.
...
Возвращает все оповещения системы безопасности, обнаруженные в resoruces в группе ресурсов "myService1".
...
Получает особое предупреждение системы безопасности, обнаруженное в resoruces в группе ресурсов "myService1".
