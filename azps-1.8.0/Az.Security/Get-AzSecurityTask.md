...
## NОПИСАНИЕ
Центр безопасности Azure проверит ресурсы, чтобы выявить потенциальные проблемы с безопасностью.
Этот командлет позволяет найти задачи безопасности, которые предлагает центр безопасности Azure.
...
Возвращает все задачи безопасности, обнаруженные в ресурсах в рамках подписки.
...
Возвращает все задачи безопасности, обнаруженные в ресурсах в группе ресурсов.
...
Возвращает определенную задачу безопасности.
