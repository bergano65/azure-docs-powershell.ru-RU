...
## NОПИСАНИЕ
Командлет **New-AzSubscription** создает подписку на Azure.
...
Создает подписку Azure в указанной учетной записи с указанным типом предложения.
...
Имя учетной записи, которую следует использовать при создании подписки.
...
### -Name (имя)
Имя подписки, которую нужно создать.
...
### -OfferType
Тип предложения, которое следует использовать при создании подписки.
...
### -OwnerApplicationId
SPN приложения, которым необходимо предоставить доступ владельца к подписке.
...
### -OwnerObjectId
Учетные данные пользователей или групп (ов), которым будет предоставлен доступ владельца к подписке.
...
### -OwnerSignInName
Пользователи, которым необходимо предоставить доступ к подписке на владельца.
