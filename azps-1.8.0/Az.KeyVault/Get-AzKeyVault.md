...
Эта команда получает хранилище ключей с именем myvault в текущей подписке.
...
Эта команда получает удаленные сведения о хранилище ключей с именем myvault4 в текущей подписке и в westus регионе.

### Пример 6: Получение хранилища ключей с помощью фильтрации
```powershell
PS C:\> Get-AzKeyVault -VaultName 'myvault*'
...
Эта команда возвращает все хранилища ключей в подписке, которые начинаются с "myvault".
