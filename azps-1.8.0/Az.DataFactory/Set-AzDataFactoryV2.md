...
### Пример 2: Создание фабрики данных со сведениями о repoconfiguration с помощью существующего объекта фабрики.
```
...
### -HostName
Имя узла для конфигурации репозитория.
...
### -ProjectName
Название проекта для конфигурации репозитория.
...
### -TenantId
Идентификатор клиента для конфигурации репозитория.
