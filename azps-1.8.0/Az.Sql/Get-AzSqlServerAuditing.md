...
## NОПИСАНИЕ
Командлет **Get-AzSqlServerAuditing** получает параметры аудита для Azure SQL Server.
...
### Пример 1: получение параметров аудита хранилища BLOB-объектов для Azure SQL Server
```
...
### Пример 2: получение параметров аудита хранилища BLOB-объектов для Azure SQL Server
```
...
### Пример 3: Get, через конвейер, параметры аудита хранилища BLOB-объектов для Azure SQL Server
```
...
### Пример 4: получение параметров аудита центра событий для Azure SQL Server
```
...
### Пример 5: получение через конвейер, параметры аудита центра событий для Azure SQL Server
```
...
### Пример 6: получение параметров аудита для анализа журналов для Azure SQL Server
```
