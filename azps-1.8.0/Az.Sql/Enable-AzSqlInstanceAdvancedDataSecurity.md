...
## NОПИСАНИЕ
Командлет **Enable-AzSqlInstanceAdvancedDataSecurity** обеспечивает повышенную безопасность данных на управляемом экземпляре.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Включение расширенной защиты данных управляемого экземпляра
```powershell
