...
### Пример 2: получение мониторов подключений с помощью фильтрации
```
...
В этом примере мы получаем все мониторы соединений в NetworkWatcher_centraluseuap, которые начинаются с "cm"
