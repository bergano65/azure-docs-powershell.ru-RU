...
## NОПИСАНИЕ
**Set-AzNetworkInterfaceTapConfig** обновляет конфигурацию TAP для сетевого интерфейса.

## ИЛЛЮСТРИРУЮТ

### Пример 1: Установка TapConfiguration с обновленным именем TapConfig
```
...
NetworkInterface TAP configurtion
