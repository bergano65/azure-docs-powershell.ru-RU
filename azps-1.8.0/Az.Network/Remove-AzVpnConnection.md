...
То же, что и в примере 1, но теперь он удаляет подключение, используя объект, переданный из командлета Get-AzVpnConnection.
...
### -InputObject
Объект VpnConenction, который нужно обновить.
...
### -ResourceId
Идентификатор ресурса объекта VpnConenction, который нужно удалить.
