...
## NОПИСАНИЕ
Командлет **Set-AzApplicationGatewayAutoscaleConfiguration** изменяет существующую конфигурацию автомасштабирования для шлюза приложений.
...
Вторая команда обновляет конфигурацию автомасштабирования из шлюза applicationg.
...
### -MaxCapacity
Максимальная capcity для шлюза приложений.
...
### -MinCapacity
Минимальная capcity для шлюза приложений.
