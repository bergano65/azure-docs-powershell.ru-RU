...
## КРАТКИй обзор
Обновление пула файлов Azure NetApp (ANF) с помощью нового множества данных.
...
## NОПИСАНИЕ
Командлет **Update-AzNetAppFilesPool** изменяет пул ANF.

## ИЛЛЮСТРИРУЮТ

### Пример 1: изменение пула ANF
```
...
Эта команда изменяет для пула ANF "MyAnfPool" заданный размер и ServiceLevel.
...
### -AccountObject
Объект Account, содержащий пул для обновления.
...
### -InputObject
Объект пула, который нужно обновить.
