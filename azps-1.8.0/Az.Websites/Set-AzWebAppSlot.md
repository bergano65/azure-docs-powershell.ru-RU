...
Эта команда изменяет план appservice, связанный с Slot001, на webapp ContosoWebApp, связанном с группой ресурсов по умолчанию — Web-WestUS. Воспользуйтесь ссылкой для learm более подробного изменения плана appservice и ограничений, связанных с ним.
