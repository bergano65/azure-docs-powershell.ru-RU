...
Эта команда изменяет план appservice, связанный с веб-приложением ContosoWebApp, связанным с группой ресурсов по умолчанию — Web-WestUS. Воспользуйтесь ссылкой для learm более подробного изменения плана appservice и ограничений, связанных с ним.
