...
## NОПИСАНИЕ
Командлет **New-AzServiceBusNamespace** создает новое пространство имен служебной шины. Созданный манифест ресурсов пространства имен является неизменным. Эта операция является idempotent.
