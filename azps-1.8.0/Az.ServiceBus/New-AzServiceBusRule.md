...
## NОПИСАНИЕ
Командлет **New-AzServiceBusRule** создает новое правило для данной подписки.
...
Командлет New-AzServiceBusRule создает новое правило для указанной подписки.
...
Командлет New-AzServiceBusRule создает новое правило для указанной подписки с помощью ActionFilter.
