...
## NОПИСАНИЕ
Командлет Start-AzAutomationSourceControlSyncJob запускает задание синхронизации элемента управления Azure Automation исходных для заданного имени исходного элемента управления.
