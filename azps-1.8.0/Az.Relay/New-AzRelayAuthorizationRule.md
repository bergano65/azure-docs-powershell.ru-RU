...
## NОПИСАНИЕ
Командлет **New-AzRelayAuthorizationRule** создает новое правило авторизации для указанных ретранслируемых сущностей (пространство имен/WcfRelay/HybridConnection).
...
Создает `AuthoRule1` с правами **прослушивания** для гибридного подключения `TestHybridConnection` .
