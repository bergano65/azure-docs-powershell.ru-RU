...
## NОПИСАНИЕ
Командлет **New-AzRelayKey** создает первичные и дополнительные строки подключения для указанных ретранслируемых сущностей (пространство имен и WcfRelay/HybridConnection).
...
Повторно создает первичные или дополнительные строки подключения для указанной Relay-Namespace сущности.

### Пример 1,1-KeyValue пространства имен
```
...
создает первичные или дополнительные строки подключения для указанной сущности Relay-Namespace с указанным значением ключа.
...
Повторно создает первичные или дополнительные строки подключения для указанной Relay-WcfRelay сущности.

### Пример 2,1-WcfRelay KeyValue
```
...
создает первичные или дополнительные строки подключения для указанной сущности Relay-WcfRelay с указанным значением ключа.
...
### Пример 3,1-HybridConnection KeyValue
```
...
создает первичные или дополнительные строки подключения для указанной сущности Relay-HybridConnection с указанным значением ключа.
...
### -KeyValue
256-разрядный ключ в формате Base64 для подписывания и проверки маркера SAS.
