...
Эта команда создает источник данных Application-Insights для данного приложения в данной службе аналитики журнала workpsace. Это позволяет коллекции журналов из данного приложения в службе аналитики журнала workpsace.
