...
Включает функцию автоматического резервного копирования для защищенного элемента с указанной политикой защиты резервной копии.
...
Получить доступ к защищенным элементам из контейнера.
...
Получите резервные временные интервалы для элемента.
...
Получение плана восстановления для элемента резервного копирования.
...
Запрос на новый DBs в рабочей нагрузке.
...
Регистрирует защищенный контейнер.
