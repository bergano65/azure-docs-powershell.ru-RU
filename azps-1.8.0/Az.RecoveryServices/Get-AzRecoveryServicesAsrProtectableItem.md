...
## NОПИСАНИЕ
Командлет **Get-AzRecoveryServicesAsrProtectableItem** получает защищенные элементы в контейнере защиты Azure Site Recovery.
...
Получить защищенные элементы в указанном контейнере защиты ASR и с заданным понятным именем.
