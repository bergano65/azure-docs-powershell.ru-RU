...
### Пример 1: получение списка всех пулов шлюзов Edge.
```powershell
...
### Пример 2: получение пула определенного шлюза Edge.
```powershell
PS C:\> Get-AzsEdgeGatewayPool
...
### Microsoft. Azure. PowerShell. командлеты. FabricAdmin. Models. Api20160501. IEdgeGatewayPool
