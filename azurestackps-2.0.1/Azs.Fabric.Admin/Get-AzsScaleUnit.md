...
Возвращает список сведений о единицах шкалы.
...
Возвращают сведения о конкретном единице масштабирования.
...
### Microsoft. Azure. PowerShell. командлеты. FabricAdmin. Models. Api20160501. IScaleUnit
