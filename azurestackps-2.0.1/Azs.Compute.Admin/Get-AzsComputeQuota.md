...
### Пример 1: получение всех расчетных квот
```powershell
...
Выполняйте без `Get-AzsComputeQuota` параметров, чтобы получить список всех расчетных квот.

### Пример 2: получение вычислительной квоты по имени
```powershell
...
Укажите имя квоты в командной строке, чтобы получить определенную квоту.
