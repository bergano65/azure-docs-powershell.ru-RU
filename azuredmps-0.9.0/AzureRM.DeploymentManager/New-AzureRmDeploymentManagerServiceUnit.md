...
## NОПИСАНИЕ
Командлет **New-AzureRmDeploymentManagerServiceUnit** создает службу в рамках службы в топологии службы и возвращает объект, который представляет этот модуль обслуживания.
Укажите единицу обслуживания, указав ее имя, имя службы, топологию службы и имя группы ресурсов. 

Командлет возвращает объект ServiceUnit. Вы можете локально изменить этот объект, а затем применить изменения к службе с помощью командлета Set-AzureRmDeploymentManagerService.
